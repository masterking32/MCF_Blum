...
const ce = {
        ...
        script: [{
          ...
          onload: () => {
            ...
            window.turnstile.render(c.value, {
              sitekey: J().public.CF_TURNSTILE_SITE_KEY,
  ...
  pe = E({
    ...
    emits: j(["submit"], ["update:modelValue"]),
    setup(h, {
      emit: l
    }) {
    ...
    setup(h) {
      ...
      return (t, u) => {
        ...
        return v(), V(Z, {
          ...
          "onUpdate:modelValue": u[1] || (u[1] = U => e(n).options.email.modals.isWaitVisible = U),
          onClose: d
        }, {
          default: r(() => [f($, null, {
            header: r(() => [y("img", {
              src: ("imgResolver" in t ? t.imgResolver : e(P))("emoji/SeeNoEvilMonkey"),
              alt: "",
              class: "icon"
            }, null, 8, he)]),
            ...
            subTitle: r(() => [e(o) ? (v(), V(b, {
              ...
              resend: r(() => [y("a", {
                href: "#",
                class: "link",
                onClick: u[0] || (u[0] = ne(U => a(), ["prevent"]))
    ...
    setup(h) {
      ...
      return (o, m) => {
        ...
        return v(), V(i, {
          ...
          default: r(() => [f(a, null, {
            header: r(() => [y("img", {
              src: ("imgResolver" in o ? o.imgResolver : e(P))("special/big-green-check-transparent", "svg"),
              alt: "",
              class: "icon"
            }, null, 8, be)]),
    ...
    setup(h) {
      ...
      return (o, m) => {
        ...
        return v(), V(i, {
          ...
          default: r(() => [f(a, null, {
            header: r(() => [y("img", {
              src: ("imgResolver" in o ? o.imgResolver : e(P))("special/big-red-cross", "svg"),
              alt: "",
              class: "icon"
            }, null, 8, Ve)]),
