...
const xt = {
  ...
  Nt = re({
    ...
    setup(n, {
      ...
      return We(() => {
        ...
        }, D(("getMmSsFromMs" in c ? c.getMmSsFromMs : d(at))(d(u))), 3), h("div", $t, [(f(!0), R(W, null, Re(d(w), m => (f(), R("div", {
          key: m.icon,
          class: me(["item", {
            "is-scaled": m.scaled,
            "is-bomb": m.bomb
  ...
  qt = re({
    ...
    setup(n) {
      return (e, t) => {
        const s = Ve;
        return f(), R("div", Ut, [h("div", Wt, [F(s, {
          name: e.logo,
          class: "icon"
        }, null, 8, ["name"])]), h("div", Ht, D(e.name), 1), h("div", jt, [h("div", Yt, D(e.value), 1), e.description ? (f(), R("div", Kt, D(e.description), 1)) : $("", !0)])])
      }
    }
  }),
  Zt = ie(qt, [
    ...
    setup(n) {
      ...
      return (i, g) => {
        ...
        return f(), R("div", Xt, [i.backgroundImage ? (f(), R("img", {
          ...
          class: "message",
          innerHTML: i.message
        }, null, 8, tn), h("div", nn, [(L = i.additionalRewardItems) != null && L.length ? (f(), R("div", sn, [h("div", on, [(f(!0), R(W, null, Re(i.additionalRewardItems, T => (f(), V(w, xe({
          key: T.name,
          ref_for: !0
        }, T), null, 16))), 128))])])) : $("", !0), h("div", rn, [(m = i.additionalRewardItems) != null && m.length ? (f(), R("div", an, D(("t" in i ? i.t : d(y))("game.end.total_earned_label")), 1)) : $("", !0), h("div", cn, [(f(!0), R(W, null, Re(d(t), T => (f(), V(w, xe({
          key: T.name,
          ref_for: !0
    ...
    setup(n, {
      ...
      return We(() => {
        ...
        return f(), R("div", {
          ...
          name: "logo-token",
          class: "token-img"
        }), h("div", vn, D(d(w)), 1)], 512)]), h("div", An, D(("t" in m ? m.t : d(y))("base.rewards")), 1)])]), h("div", Rn, [(f(!0), R(W, null, Re(d(L), (x, fe) => (f(), V(J, {
          key: fe,
          type: x.type,
          link: x.to,
          size: d(te).LARGE,
          ...
          default: N(() => [typeof x.label == "string" ? (f(), R(W, {
            key: 0
          ...
          const L = ((J = E.bp) == null ? void 0 : J.value) ?? 0,
            m = (() => {
              ...
              if (p.HARRIS in c && c[p.HARRIS]) {
                const Q = (x = w.gameOptions.assets.find(H => H.assetType === p.HARRIS)) == null ? void 0 : x.clickValue;
                if (Q !== void 0) {
              ...
              if (p.TRUMP in c && c[p.TRUMP]) {
                const Q = (fe = w.gameOptions.assets.find(H => H.assetType === p.TRUMP)) == null ? void 0 : fe.clickValue;
                if (Q !== void 0) {
