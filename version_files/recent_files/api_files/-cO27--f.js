  ...
  ze = te({
    ...
    setup(Ue) {
      const v = se(),
        ...
        K = m(() => [f.TELEGRAM, f.TWITTER, f.INSTAGRAM, f.WEBSITE].map(e => ({
          ...
          return {
            ...
            type: e.type,
            display: e.display,
            onClick: n ? () => Z(e.type, n.url) : void 0
          }
      ...
      return (e, n) => {
        ...
        return l(), u("div", he, [s("div", {
        ...
        }, [s("div", ke, [w(a(t(o).description) + " ", 1), s("span", null, [t(E) && t(h) ? (l(), u("button", {
          key: 0,
          type: "button",
          class: "reset less-btn",
          onClick: n[1] || (n[1] = d => h.value = !1)
        }, a(("t" in e ? e.t : t(r))("memepad.about.description.less")), 1)) : g("", !0)])]), t(E) && !t(h) ? (l(), u("div", je, [n[4] || (n[4] = s("div", {
          class: "shadow"
        }, null, -1)), s("button", {
          type: "button",
          class: "reset more-btn",
          onClick: n[2] || (n[2] = d => h.value = !0)
          ...
          name: "stop-sign",
          class: "icon"
        }), s("span", Te, a(("t" in e ? e.t : t(r))("memepad.jetton.nsfw")), 1)])) : g("", !0)]), t(L) && (t(b).status === "in_progress" || t(b).status === "ready" && t(b).data.isMyAgent && t(b).data.status !== t(F).MEMEPAD_AI_AGENT_STATUS.OFFLINE) ? (l(), u("div", Ie, [s("div", we, [i(p, {
          jetton: t(o),
          size: 36
        }, null, 8, ["jetton"])]), s("div", Fe, a(("t" in e ? e.t : t(r))("memepad.jetton.about.agent_banner.label", {
          ticker: t(o).ticker
        })), 1), t(b).status === "in_progress" ? (l(), u("div", Ne, [i(c, {
          name: "calendar-clock",
          class: "icon"
        }), s("div", Re, a(("t" in e ? e.t : t(r))("memepad.jetton.about.agent_banner.in_progress")), 1)])) : t(b).data.status === t(F).MEMEPAD_AI_AGENT_STATUS.ONLINE ? (l(), j(A, {
          key: 1,
