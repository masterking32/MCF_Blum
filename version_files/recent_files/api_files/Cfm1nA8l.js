...
const pl = {
  ...
  vl = nt({
    ...
    setup(s) {
      return (t, e) => {
        const i = Ot;
        return _(), T("div", pl, [R(i, {
          name: "wallet",
          class: "icon"
        }), S("span", ml, A(t.balance), 1)])
      }
    }
  }),
  ko = lt(vl, [
    ...
    setup(s) {
      return (t, e) => {
        const i = yo,
          n = Ot,
          o = _o;
        return _(), T("div", gl, [t.errorMessage ? (_(), W(i, {
          key: 0,
          "error-message": t.errorMessage
        }, null, 8, ["error-message"])) : t.details && t.totalLabel ? (_(), T("div", bl, [t.details.length ? (_(), W(o, {
          key: 0,
          "text-min-width": 155,
          alignment: m(Pr).TOP
        }, {
          ...
          inner: Z(() => [S("div", yl, [(_(!0), T(ut, null, de(t.details, (r, l) => (_(), T(ut, {
            key: r.label
          }, [S("span", null, A(r.label), 1), l !== t.details.length - 1 ? (_(), T("br", _l)) : ht("", !0)], 64))), 128))])]),
          _: 1
        }, 8, ["alignment"])) : ht("", !0), S("span", wl, A(t.totalLabel), 1)])) : ht("", !0)])
      }
    }
  }),
  xo = lt(Sl, [
    ...
    setup(s, {
      ...
      return We(() => {
        ...
        const f = ko,
          ...
          b = wo,
          y = te;
        return _(), T("div", Ml, [S("div", kl, [m(i).balanceLabel ? (_(), W(f, {
          key: 0,
          balance: m(i).balanceLabel
        }, null, 8, ["balance"])) : (_(), W(p, {
          key: 1,
          class: "skeleton"
        })), m(i).feesInfo ? (_(), W(v, {
          key: 2,
        ...
        }, null, 8, ["details", "total-label", "error-message"])) : (_(), W(p, {
          key: 3,
          class: "skeleton"
        }))]), ((x = m(i).error) == null ? void 0 : x.type) === ("MEMEPAD_UNLOCK_ERRORS" in u ? u.MEMEPAD_UNLOCK_ERRORS : m(ll)).NOT_ENOUGH_TOKEN ? (_(), W(b, {
          key: 0,
        ...
        }, null, 8, ["jetton-shortname", "jetton-address", "details", "source", "value-balance"])) : (_(), W(y, {
          key: 1,
          fill: "",
          icon: "lock-open",
          "icon-align": "left",
          ...
          default: Z(() => [S("div", xl, A(("t" in u ? u.t : m(O))("memepad.jetton.unlock_btn", {
  ...
  Ll = nt({
    ...
    setup(s) {
      const t = s,
        e = it(!1);
      return cl("memepad-jetton-moving-to-dex"), (i, n) => {
        const o = ol,
          r = Lr,
          l = fo,
          a = Ts,
          ...
          u = hl,
          d = jr;
        return _(), T("div", El, [R(o), S("div", Tl, [S("div", zl, [R(r, {
          size: 342,
          ...
          size: 80
        }, null, 8, ["src"])]), S("div", Il, A(("t" in i ? i.t : m(O))("memepad.moving_to_dex.title")), 1), S("div", $l, A(("t" in i ? i.t : m(O))("memepad.moving_to_dex.subtitle", {
          ticker: i.jetton.ticker
        })), 1)]), R(u, null, {
          default: Z(() => [S("div", Pl, [R(c, {
            "force-loading": i.unlockEnabled === void 0
          }, {
            default: Z(() => [i.unlockEnabled ? (_(), W(a, {
              key: 0,
              jetton: i.jetton,
            ...
            }, null, 8, ["jetton", "jetton-information", "jetton-sdk", "balances"])) : (_(), W(h, {
              key: 1,
          ...
          modelValue: m(e),
          "onUpdate:modelValue": n[2] || (n[2] = f => yt(e) ? e.value = f : null),
  ...
  Kl = nt({
    ...
    setup(s) {
      ...
      return (i, n) => {
        const o = ul,
          r = Ot;
        return _(), T("div", Rl, [S("div", Al, [R(o, {
          jetton: i.jetton
        }, null, 8, ["jetton"]), S("div", Ol, [S("div", Dl, [S("div", Vl, A(i.jetton.ticker), 1), i.jettonInformation.stream.online ? (_(), T("div", Wl, n[2] || (n[2] = [S("div", {
          class: "dot"
        }, null, -1)]))) : ht("", !0), i.jettonInformation.inSpotlight ? (_(), T("div", Nl, [R(r, {
          name: "fire",
          class: "icon"
        }), n[3] || (n[3] = S("span", {
          class: "label"
        }, "Spotlight", -1))])) : ht("", !0)]), S("div", Bl, A(m(e)), 1)])]), S("div", Fl, [S("button", {
          type: "button",
          class: "reset copy",
          ...
          name: "edit-copy",
          class: "icon"
        }), S("span", Ul, A(("sliceWalletAddress" in i ? i.sliceWalletAddress : m(Rr))(i.jetton.address, 3)), 1)]), S("button", {
          type: "button",
          class: "reset share",
...
function Gl(s) {
  const t = s;
  et.document = t.document, et.DocumentFragment = t.DocumentFragment || se, et.SVGElement = t.SVGElement || se, et.SVGSVGElement = t.SVGSVGElement || se, et.SVGElementInstance = t.SVGElementInstance || se, et.Element = t.Element || se, et.HTMLElement = t.HTMLElement || et.Element, et.Event = t.Event, et.Touch = t.Touch || se, et.PointerEvent = t.PointerEvent || t.MSPointerEvent
}
...
const Zl = s => s === ee || Co(s),
  ql = s => wi(s) && s.nodeType === 11,
  wi = s => !!s && typeof s == "object",
  zo = s => typeof s == "function",
  Ql = s => typeof s == "number",
  ta = s => typeof s == "boolean",
  ea = s => typeof s == "string",
  ia = s => {
  ...
  sa = s => wi(s) && !!s.constructor && /function Object\b/.test(s.constructor.toString()),
  na = s => wi(s) && typeof s.length < "u" && zo(s.splice);
var w = {
  window: Zl,
  docFrag: ql,
  object: wi,
...
function oa(s) {
  const t = et.Element,
    e = s.navigator || {};
  st.supportsTouch = "ontouchstart" in s || w.func(s.DocumentTouch) && et.document instanceof s.DocumentTouch, st.supportsPointerEvent = e.pointerEnabled !== !1 && !!et.PointerEvent, st.isIOS = /iP(hone|od|ad)/.test(e.platform), st.isIOS7 = /iP(hone|od|ad)/.test(e.platform) && /OS 7[^\d]/.test(e.appVersion), st.isIe9 = /MSIE 9/.test(e.userAgent), st.isOperaMobile = e.appName === "Opera" && st.supportsTouch && /Presto/.test(e.userAgent), st.prefixedMatchesSelector = "matches" in t.prototype ? "matches" : "webkitMatchesSelector" in t.prototype ? "webkitMatchesSelector" : "mozMatchesSelector" in t.prototype ? "mozMatchesSelector" : "oMatchesSelector" in t.prototype ? "oMatchesSelector" : "msMatchesSelector", st.pEventTypes = st.supportsPointerEvent ? et.PointerEvent === s.MSPointerEvent ? {
    up: "MSPointerUp",
    down: "MSPointerDown",
    over: "mouseover",
    out: "mouseout",
  ...
  } : null, st.wheelEvent = et.document && "onmousewheel" in et.document ? "mousewheel" : "wheel"
}
...
function Jt(s, t) {
  return ee !== Eo && (t = t.replace(/\/deep\//g, " ")), s[st.prefixedMatchesSelector](t)
}

function cs(s, t, e) {
  for (; w.element(s);) {
    if (Jt(s, t)) return !0;
    if (s = zt(s), s === e) return Jt(s, t)
  }
  return !1
}
...
function $o(s) {
  const t = s instanceof et.SVGElement ? s.getBoundingClientRect() : s.getClientRects()[0];
  return t && {
    left: t.left,
    right: t.right,
    top: t.top,
...
function sn(s) {
  return w.string(s) ? (et.document.querySelector(s), !0) : !1
}
...
function la(s) {
  ...
  t.prototype.getAction = function(i, n, o, r) {
    const l = aa(this, n, o, r, s);
    return this.options.actionChecker ? this.options.actionChecker(i, n, l, this, r, o) : l
  }, t.prototype.ignoreFrom = Pe(function(e) {
    return this._backCompatOption("ignoreFrom", e)
  }, "Interactable.ignoreFrom() has been deprecated. Use Interactble.draggable({ignoreFrom: newValue})."), t.prototype.allowFrom = Pe(function(e) {
    return this._backCompatOption("allowFrom", e)
  }, "Interactable.allowFrom() has been deprecated. Use Interactble.draggable({allowFrom: newValue})."), t.prototype.actionChecker = ca, t.prototype.styleCursor = ha
}
...
function da(s) {
  ...
  s.usePlugin(ua), e.base.actionChecker = null, e.base.styleCursor = !0, $(e.perAction, {
    manualStart: !1,
    max: 1 / 0,
    maxPerElement: 1,
    allowFrom: null,
...
const $s = {
  ...
  install: da,
  listeners: {
    "interactions:down": fa,
    "interactions:move": (s, t) => {
      pa(s, t), ma(s, t)
    },
    "interactions:stop": va
  },
  maxInteractions: Ao,
  withinInteractionLimit: Si,
  validateAction: Lo
  ...
  if (e.prepared.axis = a.lockAxis === "start" ? c[0] : a.lockAxis, c !== "xy" && h !== "xy" && h !== c) {
    ...
    const d = function(f) {
      ...
      if (!p.manualStart && f.testIgnoreAllow(p, u, i)) {
        ...
        if (v && v.name === "drag" && ya(c, f) && $s.validateAction(v, f, u, i, t)) return f
      }
    };
    for (; w.element(u);) {
...
function wa(s) {
  ...
  s.usePlugin($s), t.perAction.hold = 0, t.perAction.delay = 0
}
...
var Ma = {
  id: "auto-start",
  install(s) {
    s.usePlugin($s), s.usePlugin(Sa), s.usePlugin(_a)
  }
};
const ka = (s, t) => s.splice(s.indexOf(t), 1),
  Do = (s, t) => {
...
class Wo {
  constructor(t) {
    this.options = void 0, this.types = {}, this.propagationStopped = !1, this.immediatePropagationStopped = !1, this.global = void 0, this.options = $({}, t || {})
  }
  fire(t) {
    let e;
    const i = this.global;
...
function fi(s, t) {
  s.__set || (s.__set = {});
  for (const e in t) Ca.some(i => e.indexOf(i) === 0) || typeof s[e] != "function" && e !== "__set" && Object.defineProperty(s, e, {
    get() {
...
function Bo(s) {
  return s instanceof et.Event || s instanceof et.Touch
}
...
function za(s, t) {
  return t = t || {
    x: 0,
    y: 0
  }, st.isOperaMobile && Bo(s) ? (pi("screen", s, t), t.x += window.scrollX, t.y += window.scrollY) : pi("page", s, t), t
}

function Ia(s, t) {
  return t = t || {}, st.isOperaMobile && Bo(s) ? pi("screen", s, t) : pi("client", s, t), t
}
...
function $a(s, t, e) {
  ...
  za(i, s.page), Ia(i, s.client), s.timeStamp = e
}
...
function Uo(s) {
  return w.string(s.pointerType) ? s.pointerType : w.number(s.pointerType) ? [void 0, void 0, "touch", "pen", "mouse"][s.pointerType] : /touch/.test(s.type || "") || s instanceof et.Touch ? "touch" : "mouse"
}
      ...
      for (k = g.length - 1; k >= 0; k--) {
        ...
        if (I.selector === d && I.context === f) {
          ...
          for (let L = N.length - 1; L >= 0; L--) {
            const P = N[L];
            if (P.func === v && Ke(P.options, y)) {
              N.splice(L, 1), N.length || (g.splice(k, 1), l(f, p, c), l(f, p, u, !0)), x = !0;
              break
            }
          }
          if (x) break
  ...
  function c(d, f) {
    ...
    for (; w.element(g);) {
      for (let x = 0; x < b.length; x++) {
        ...
        if (Jt(g, I) && Kt(N, y) && Kt(N, g)) {
          const {
            listeners: L
          } = k;
          v.currentTarget = g;
          for (const P of L) Ke(P.options, p) && P.func(v)
        }
      }
      g = zt(g)
    }
...
function Wa(s, t, e) {
  ...
  if (i !== "never") {
    ...
    /^(mouse|pointer|touch)*(down|start)/i.test(e.type) || w.element(e.target) && Jt(e.target, "input,select,textarea,[contenteditable=true],[contenteditable=true] *") || e.preventDefault()
  }
}
...
function Ba(s) {
  ...
  t.prototype.preventDefault = Va, t.prototype.checkAndPreventDefault = function(e) {
    return Wa(this, s, e)
...
var Fa = {
  ...
  install: Ba,
  listeners: ["down", "move", "up", "cancel"].reduce((s, t) => (s[`interactions:${t}`] = Na, s), {})
};
...
function je(s, t, e, i) {
  let n = s;
  return w.string(n) ? n = Ua(n, t, e) : w.func(n) && (n = n(...i)), w.element(n) && (n = zs(n)), n
}
...
function Ka(s) {
  return s && !("left" in s && "top" in s) && (s = $({}, s), s.left = s.x || 0, s.top = s.y || 0, s.right = s.right || s.left + s.width, s.bottom = s.bottom || s.top + s.height), s
}

function fs(s) {
  return s && !("x" in s && "y" in s) && (s = $({}, s), s.x = s.left || 0, s.y = s.top || 0, s.width = s.width || (s.right || 0) - s.x, s.height = s.height || (s.bottom || 0) - s.y), s
}
...
class Ya {
  ...
  constructor(t) {
    this.interactable = null, this.element = null, this.rect = null, this._rects = void 0, this.edges = null, this._scopeFire = void 0, this.prepared = {
      ...
      event: null,
      eventTarget: null
    }, this.prevEvent = null, this.pointerIsDown = !1, this.pointerWasMoved = !1, this._interacting = !1, this._ending = !1, this._stopped = !0, this._proxy = void 0, this.simulation = null, this.doMove = Pe(function(o) {
      this.move(o)
    ...
    const n = this;
    this._proxy = {};
    for (const o in Xa) Object.defineProperty(this._proxy, o, {
      get() {
        return n[o]
      }
    });
    for (const o in Xo) Object.defineProperty(this._proxy, o, {
      value: function() {
  ...
  start(t, e, i) {
    return this.interacting() || !this.pointerIsDown || this.pointers.length < (t.name === "gesture" ? 2 : 1) || !e.options[t.name].enabled ? !1 : (Is(this.prepared, t), this.interactable = e, this.element = i, this.rect = e.getRect(i), this.edges = this.prepared.edges ? $({}, this.prepared.edges) : {
      left: !0,
      right: !0,
      top: !0,
      bottom: !0
  ...
  pointerMove(t, e, i) {
    ...
    n || Ta(this.coords.velocity, this.coords.delta), this._scopeFire("interactions:move", a), !n && !this.simulation && (this.interacting() && (a.type = null, this.move(a)), this.pointerWasMoved && oi(this.coords.prev, this.coords.cur))
  }
  move(t) {
    (!t || !t.event) && No(this.coords.delta), t = $({
...
const Jo = ["pointerDown", "pointerMove", "pointerUp", "updatePointer", "removePointer", "windowBlur"];

function Ga(s) {
  const t = {};
  for (const o of Jo) t[o] = Yo(o, s);
  const e = st.pEventTypes;
  let i;
  et.PointerEvent ? i = [{
    type: e.down,
    listener: n
  ...
  }), s.prevTouchTime = 0, s.Interaction = class extends Ya {
    get pointerMoveTolerance() {
...
function Yo(s, t) {
  return function(e) {
    ...
    if (/^touch/.test(e.type)) {
      ...
      let a = !1;
      if (!st.supportsPointerEvent && /mouse/.test(e.type)) {
...
class qa {
  ...
  updatePerActionListeners(t, e, i) {
    ...
    (w.array(e) || w.object(e)) && this._onOff(Pt.Off, t, e, void 0, r), (w.array(i) || w.object(i)) && this._onOff(Pt.On, t, i, void 0, r)
  }
  setPerAction(t, e) {
    ...
    for (const n in e) {
      const o = n,
        r = this.options[t],
        l = e[o];
      o === "listeners" && this.updatePerActionListeners(t, r.listeners, l), w.array(l) ? r[o] = Vo(l) : w.plainObject(l) ? (r[o] = $(r[o] || {}, me(l)), w.object(i.perAction[o]) && "enabled" in i.perAction[o] && (r[o].enabled = l.enabled !== !1)) : w.bool(l) && w.object(i.perAction[o]) ? r[o].enabled = l : r[o] = l
    }
  }
  getRect(t) {
  ...
  _onOff(t, e, i, n, o) {
    ...
    const r = ce(e, i, o);
    for (let l in r) {
      l === "wheel" && (l = st.wheelEvent);
      for (const a of r[l]) mi(l, this._actions) ? this.events[t === Pt.On ? "on" : "off"](l, a) : w.string(this.target) ? this._scopeEvents[t === Pt.On ? "addDelegate" : "removeDelegate"](this.target, this._context, l, a, n) : this._scopeEvents[t === Pt.On ? "add" : "remove"](this.target, l, a, n)
    }
    return this
  }
  on(t, e, i) {
    return this._onOff(Pt.On, t, e, i)
  }
  off(t, e, i) {
    return this._onOff(Pt.Off, t, e, i)
  }
  set(t) {
    ...
    for (const i in this._actions.methodDict) {
      ...
      this.options[n] = {}, this.setPerAction(n, $($({}, e.perAction), e.actions[n])), this[o](t[n])
    }
    for (const i in t) {
      if (i === "getRect") {
...
class Qa {
  ...
  forEachMatch(t, e) {
    for (const i of this.list) {
      let n;
      if ((w.string(i.target) ? w.element(t) && Jt(t, i.target) : t === i.target) && i.inContext(t) && (n = e(i)), n !== void 0) return n
    }
  }
}
...
function th(s) {
  ...
  return t.getPointerAverage = Fo, t.getTouchBBox = Pa, t.getTouchDistance = La, t.getTouchAngle = ja, t.getElementRect = zs, t.getElementClientRect = $o, t.matchesSelector = Jt, t.closest = Io, t.globalEvents = {}, t.version = "1.10.27", t.scope = s, t.use = function(e, i) {
    return this.scope.usePlugin(e, i), this
  }, t.isSet = function(e, i) {
    return !!this.scope.interactables.get(e, i && i.context)
  }, t.on = Pe(function(i, n, o) {
  ...
  }, "The interact.on() method is being deprecated"), t.off = Pe(function(i, n, o) {
    if (w.string(i) && i.search(" ") !== -1 && (i = i.trim().split(/ +/)), w.array(i)) {
...
class eh {
  constructor() {
    this.id = `__interact_scope_${Math.floor(Math.random()*100)}`, this.isInitialized = !1, this.listenerMaps = [], this.browser = st, this.defaults = me(Ho), this.Eventable = Wo, this.actions = {
      map: {},
      phases: {
        start: !0,
        move: !0,
      ...
      methodDict: {},
      phaselessTypes: {}
    }, this.interactStatic = th(this), this.InteractEvent = js, this.Interactable = void 0, this.interactables = new Qa(this), this._win = void 0, this.document = void 0, this.window = void 0, this.documents = [], this._plugins = {
      list: [],
      map: {}
    }, this.onWindowUnload = e => this.removeDocument(e.target);
    const t = this;
    this.Interactable = class extends qa {
      get _defaults() {
        return t.defaults
      }
      set(e) {
  ...
  init(t) {
    return this.isInitialized ? this : ih(this, t)
  }
  pluginIsInstalled(t) {
    const {
      id: e
...
function ih(s, t) {
  return s.isInitialized = !0, w.window(t) && To(t), et.init(t), st.init(t), ds.init(t), s.window = t, s.document = t.document, s.usePlugin(Za), s.usePlugin(Da), s
}
...
const Go = new eh,
  ...
  sh = typeof globalThis < "u" ? globalThis : window;
Go.init(sh);
vt.use(Ma);
class Rs {
  constructor(t) {
  ...
  start(t, e) {
    ...
    this.prepareStates(o), this.startEdges = $({}, n.edges), this.edges = $({}, this.startEdges), this.startOffset = oh(n.rect, e), this.startDelta = {
      x: 0,
      y: 0
    };
  ...
  setAll(t) {
    ...
    t.coords = $({}, t.pageCoords), t.rect = $({}, o), t.edges = $({}, r);
    ...
    $(this.edges, t.edges), a.delta.x = t.coords.x - t.pageCoords.x, a.delta.y = t.coords.y - t.pageCoords.y, a.rectDelta.left = t.rect.left - o.left, a.rectDelta.right = t.rect.right - o.right, a.rectDelta.top = t.rect.top - o.top, a.rectDelta.bottom = t.rect.bottom - o.bottom;
  ...
  applyToInteraction(t) {
    ...
    i === "start" && $(this.startDelta, r.delta);
    for (const [u, d] of [
        [o, l],
        [n, a]
  ...
  copyFrom(t) {
    this.startOffset = t.startOffset, this.startDelta = t.startDelta, this.startEdges = t.startEdges, this.edges = t.edges, this.states = t.states.map(e => me(e)), this.result = He($({}, t.result.coords), $({}, t.result.rect))
  }
  destroy() {
...
const uh = {
  ...
  install(s) {
    s.Interaction.prototype.offsetBy = hh
  },
  listeners: {
    "interactions:new": s => {
      let {
    ...
    "interactions:before-action-end": lh,
    "interactions:stop": ah
  }
};
...
function dh(s) {
  ...
  s.usePlugin(uh), s.usePlugin(Zo), s.actions.phases.inertiastart = !0, s.actions.phases.resume = !0, t.perAction.inertia = {
    enabled: !1,
    resistance: 10,
    minSpeed: 100,
    endSpeed: 10,
...
class fh {
  ...
  inertiaTick() {
    const {
      interaction: t
    } = this, i = Xe(t).resistance, n = (t._now() - this.t0) / 1e3;
    if (n < this.te) {
      const o = 1 - (Math.exp(-i * n) - this.lambda_v0) / this.one_ve_v0;
      let r;
      this.isModified ? r = bh(0, 0, this.targetOffset.x, this.targetOffset.y, this.modifiedOffset.x, this.modifiedOffset.y, o) : r = {
...
const gh = {
  ...
  listeners: {
    ...
    "interactions:before-action-end": ph,
    "interactions:down": mh,
    "interactions:stop": vh,
...
function wh(s) {
  ...
  Ct.cursors = xh(e), Ct.defaultMargin = e.supportsTouch || e.supportsPointerEvent ? 20 : 10, i.prototype.resizable = function(o) {
    return Mh(this, o, s)
...
function Sh(s) {
  ...
  if (!(!(l && l.enabled) || t.pointerIsDown && /mouse|pointer/.test(t.pointerType) && !(o & l.mouseButtons))) {
    if (w.object(l.edges)) {
      ...
      for (const h in a) a[h] = kh(h, l.edges[h], r, t._latestPointer.eventTarget, i, n, l.margin || Ct.defaultMargin);
...
const Lh = {
    ...
    install(s) {
      ...
      t.snappers = $(t.snappers || {}, Ph), t.createSnapGrid = t.snappers.grid
    }
  },
  jh = {
    start(s) {
      ...
      o === "preserve" && (o = e.width / e.height), t.startCoords = $({}, n), t.startRect = $({}, e), t.ratio = o, t.equalDelta = l;
      ...
      if (r !== !1 && $(i, h), !(a != null && a.length)) return;
    ...
    set(s) {
      const {
        ...
        linkedEdges: n
      } = t, o = $({}, i), r = t.equalDelta ? Rh : Ah;
      if ($(s.edges, n), r(t, t.xIsPrimaryAxis, i, e), !t.subModification) return null;
      const l = $({}, e);
      xi(n, l, {
        x: i.x - o.x,
        y: i.y - o.y
      ...
      if (a.changed) {
        ...
        r(t, c, a.coords, a.rect), $(i, a.coords)
      }
      return a.eventProps
    },
    defaults: {
...
function qh(s) {
  ...
  if (!n) return;
  const r = fs(Yt(o.min, t, s.coords)) || Yh,
    l = fs(Yt(o.max, t, s.coords)) || Gh;
  e.options = {
    endOnly: o.endOnly,
    inner: $({}, xe.noInner),
    outer: $({}, xe.noOuter)
...
function sc(s) {
  const {
    ...
    options: n,
    offsets: o
  } = i, r = Ci(t.interactable, t.element, t.prepared.name), l = $({}, e), a = [];
...
const pc = {
  ...
  install(s) {
    ...
    s.usePlugin(Zo), s.usePlugin(Lh), t.modifiers = Vi;
    for (const e in Vi) {
      const {
        _defaults: i,
        _methods: n
...
const mc = {
  ...
  Ce = {
    ...
    listeners: {
      "interactions:new": vc,
      "interactions:update-pointer": gc,
      "interactions:move": bc,
...
function wc(s) {
  s.pointerEvents = Ce, s.defaults.actions.pointerEvents = Ce.defaults, $(s.actions.phaselessTypes, Ce.types)
}
...
const Ec = {
  ...
  install: Mc,
  listeners: ["move", "up", "cancel", "endall"].reduce((s, t) => (s[`pointerEvents:${t}`] = Cc, s), {
    "pointerEvents:new": kc,
    "pointerEvents:fired": xc
  })
};
...
function Tc(s) {
  ...
  t.prototype.pointerEvents = function(i) {
    return $(this.events.options, i), this
  };
...
const zc = {
    ...
    listeners: {
      ...
      "interactable:set": (s, t) => {
        ...
        $(e.events.options, t.pointerEvents.defaults), $(e.events.options, i.pointerEvents || {})
      }
    }
  },
  Ic = {
    id: "pointer-events",
    install(s) {
      s.usePlugin(Sc), s.usePlugin(Ec), s.usePlugin(zc)
    }
  };
vt.use(Ic);
...
const jc = {
  ...
  listeners: {
    "interactions:stop": (s, t) => {
      ...
      e.pointerType === "reflow" && (e._reflowResolve && e._reflowResolve(), ka(t.interactions.list, e))
    }
  }
};
vt.use(jc);
  ...
  Ac = (s, t) => {
    ...
    const r = it(!1),
      ...
      k = () => {
        var G;
        const E = N(),
          V = Math.ceil(((((G = window.visualViewport) == null ? void 0 : G.width) ?? window.innerWidth) - E) / 2);
        return {
          left: V,
          right: V
        }
      ...
      I = () => {
        const E = document.querySelector(".tabs"),
          V = document.querySelector(".memepad-jetton-header"),
          G = (E == null ? void 0 : E.offsetHeight) ?? 0;
        return {
          top: V instanceof HTMLElement ? Math.ceil(V.offsetTop + parseInt(getComputedStyle(V).marginTop) + parseInt(getComputedStyle(V).borderTop) + parseInt(getComputedStyle(V).paddingTop)) : 0,
          bottom: G
        }
      },
      N = () => {
      ...
      L = () => {
        ...
        return Math.ceil((((G = window.visualViewport) == null ? void 0 : G.height) ?? window.innerHeight) - E - V)
      },
      P = () => {
        const E = N(),
          V = L();
        return E < V ? E : E > V ? Math.ceil(V * x()) : Math.ceil(E / 2)
      },
      z = () => {
        const E = N(),
          V = L();
        return E < V ? Math.ceil(E / x()) : E > V ? V : Math.ceil(V / 2)
      },
      D = () => {
        var E, V;
        return (((E = s.value) == null ? void 0 : E.offsetWidth) ?? 174) > 174 && (((V = s.value) == null ? void 0 : V.offsetHeight) ?? 98) > 98
      },
      U = () => {
        ...
        const E = N(),
          ...
          G = E - V < 0 ? 0 : Math.ceil(E - V),
          gt = 0;
        p.position.x = G, p.position.y = gt, s.value.style.transform = `translate(${G}px, ${gt}px)`
      },
      C = () => {
        s.value !== null && (s.value.style.height = "98px", s.value.style.width = "174px")
      },
      B = (E, V) => {
        s.value !== null && (E === void 0 && V === void 0 || (E !== void 0 && (s.value.style.width = E), V !== void 0 && (s.value.style.height = V)))
      },
      K = async () => {
        U(), await d(n)
      }, X = () => {
        requestAnimationFrame(async () => {
          D() ? (pt(), await Q(), B(`${P()}px`, `${z()}px`)) : C(), await d(n)
        })
      }, F = () => {
        window.addEventListener("resize", K), window.screen && "orientation" in window.screen ? window.screen.orientation.addEventListener("change", X) : window.addEventListener("orientationchange", X)
      }, J = () => {
        window.removeEventListener("resize", K), window.screen && "orientation" in window.screen ? window.screen.orientation.removeEventListener("change", X) : window.removeEventListener("orientationchange", X)
      }, Y = l({
        ratio: x(),
        minHeight: 98,
        minWidth: 174
        ...
        onmove(E) {
          var V, G;
          p.position.x += ((V = E.deltaRect) == null ? void 0 : V.left) ?? 0, p.position.y += ((G = E.deltaRect) == null ? void 0 : G.top) ?? 0, E.target.style.height = `${E.rect.height}px`, E.target.style.transform = `translate(${p.position.x}px, ${p.position.y}px)`, E.target.style.width = `${E.rect.width}px`
        },
        onstart: u,
        onend(E) {
          const V = P(),
            G = z();
          E.rect.width > V || E.rect.height > G ? (E.target.style.height = `${G}px`, E.target.style.width = `${V}px`, d(n).then(() => c(E))) : c(E)
        }
      }, Q = async () => {
        var E, V, G;
        b(), v(), C(), U(), n = (V = (E = a(s.value)) == null ? void 0 : E.draggable(at)) == null ? void 0 : V.resizable(H), o = (G = a(t.value)) == null ? void 0 : G.on("doubletap", async gt => {
          D() ? C() : B(`${P()}px`, `${z()}px`), await d(n), gt.preventDefault()
        }), await d(n), F(), r.value = !0
      }, pt = () => {
        J(), f(n), f(o), g(), y(), r.value = !1
      };
    return Ar(pt), {
      destroy: pt,
      init: Q,
    ...
    setup(s, {
      ...
      return (g, x) => {
        ...
        return _(), T("div", {
          ...
          ref: r,
          class: "bg"
        }, null, 512), S("div", Vc, [S("div", Wc, [R(k, {
          name: "user-voice",
          class: "icon"
        }), S("span", Nc, A(e.stream.viewers), 1)]), S("div", Bc, [R(k, {
          name: "calendar-clock",
          class: "icon"
        }), S("span", Fc, A(m(a).label), 1)])]), Ft(S("div", Uc, [S("button", {
          type: "button",
    ...
    setup(s) {
      const t = s,
        ...
        i = async () => {
          ...
          if (!bt(r)) throw ks("Failed to generate stream key");
          e.value = {
            status: "loaded",
            streamKey: r.data
          }
        ...
        }), o = () => $e().$webApp.openLink("https://www.blum.io/post/videostream-quick-start-guide");
      return (r, l) => {
        const a = Ot,
          h = Ne,
          c = po("I18nT"),
          u = te,
          d = mo;
        return _(), T("div", Xc, [S("button", {
          type: "button",
          class: "reset button",
          onClick: i
        }, A(("t" in r ? r.t : m(O))("memepad.jetton.start_stream_button")), 1), R(d, {
          modelValue: m(n),
          "onUpdate:modelValue": l[2] || (l[2] = f => yt(n) ? n.value = f : null)
        }, {
          default: Z(() => [S("div", Jc, [S("div", Yc, A(("t" in r ? r.t : m(O))("memepad.jetton.steam.start_sheet.title")), 1), S("div", Gc, A(("t" in r ? r.t : m(O))("memepad.jetton.steam.start_sheet.subtitle")), 1), S("div", Zc, [m(e).status === "loaded" ? (_(), T("button", {
            key: 0,
            type: "button",
            class: "reset",
            onClick: l[0] || (l[0] = f => ("useCopy" in r ? r.useCopy : m(Dr))().copy(m(e).streamKey))
          }, [S("div", qc, A(m(e).streamKey), 1), R(a, {
            name: "edit-copy",
            class: "icon"
          })])) : (_(), W(h, {
            key: 1,
    ...
    setup(s) {
      const t = s,
        ...
        i = async () => {
          ...
          return Mt(r)
        }, n = () => $e().$webApp.openLink("https://www.blum.io/post/videostream-quick-start-guide#:~:text=Blum%20Memepad%20Videostream%20Terms%20%26%C2%A0Conditions");
      return (o, r) => {
        const l = Yl,
          a = Hc,
          h = tu;
        return o.jettonInformation.stream.isBanned ? (_(), W(l, {
          key: 0,
          onOpenRules: n
        })) : o.jettonInformation.stream.online ? (_(), T(ut, {
          key: 1
        }, [m(e) ? (_(), T("button", {
          key: 0,
          type: "button",
        ...
        }, A(("t" in o ? o.t : m(O))("memepad.jetton.show_stream_button")), 1)) : (_(), W(a, {
          key: 1,
          stream: o.jettonInformation.stream,
          onHide: r[1] || (r[1] = c => e.value = !0)
        }, null, 8, ["stream"]))], 64)) : o.jettonInformation.stream.creator ? (_(), W(h, {
          key: 2,
    ...
    setup(s) {
      ...
      return (i, n) => {
        ...
        const o = Ne,
          r = Ot,
          l = _o;
        return _(), T("div", su, [i.isReleased ? ht("", !0) : (_(), T("div", nu, [S("div", ou, [S("div", ru, [i.total !== void 0 && i.collected !== void 0 || i.percent ? (_(), T(ut, {
          key: 1
        }, [i.percent !== void 0 ? (_(), T("span", lu, A(`${i.percent.toFixed(2)}%`), 1)) : ht("", !0), i.total !== void 0 && i.collected !== void 0 ? (_(), T("span", au, A(`${("formatTon"in i?i.formatTon:m(Ys))(i.collected,{trim:!0})}/${("formatTon"in i?i.formatTon:m(Ys))(i.total,{trim:!0,rounding:m(ci).ROUND_UP})} TON`), 1)) : ht("", !0)], 64)) : (_(), W(o, {
          key: 0,
          class: "skeleton"
        }))]), (a = i.marketDetails) != null && a.statistics ? (_(), T("div", hu, [S("div", cu, [R(r, {
          name: "personal",
          class: "icon"
        }), i.marketDetails.statistics.holdersCount ? (_(), T("span", uu, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.statistics.holdersCount, {
          accuracy: 0
        }).full), 1)) : (_(), T("span", du, "—"))]), S("div", fu, [R(r, {
          name: "transfer",
          class: "icon"
        }), i.marketDetails.statistics.transactionsCount ? (_(), T("span", pu, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.statistics.transactionsCount, {
          accuracy: 0
        }).full), 1)) : (_(), T("span", mu, "—"))]), S("div", vu, [i.marketDetails.statistics.marketCap ? (_(), T(ut, {
          key: 0
        }, [S("span", gu, A(("t" in i ? i.t : m(O))("memepad.jetton.stats.market_cap")), 1), S("span", bu, A(`$${("formatCount"in i?i.formatCount:m(Wt))(i.marketDetails.statistics.marketCap).full}`), 1)], 64)) : (_(), T("span", yu, "—"))])])) : (_(), W(l, {
          key: 1,
          text: ("t" in i ? i.t : m(O))("memepad.jetton.market_info_tooltip.text"),
          "text-min-width": 155,
          "text-max-width": 155
        }, {
          default: Z(() => [S("button", _u, [R(r, {
            name: "circle-help",
            class: "icon"
          }), S("span", wu, A(("t" in i ? i.t : m(O))("memepad.jetton.market_info_tooltip.label")), 1)])]),
          _: 1
        }, 8, ["text"]))]), S("div", Su, [S("div", {
          class: "line",
          style: ls({
            width: `${i.percent}%`
          })
        }, null, 4)])])), m(e).length ? (_(), T("div", Mu, [S("div", ku, [S("div", xu, A(("t" in i ? i.t : m(O))("memepad.jetton.market_cap")), 1), (h = i.marketDetails) != null && h.marketCap ? (_(), T("div", Cu, [n[0] || (n[0] = S("span", {
          class: "dollar"
        }, "$", -1)), S("span", null, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.marketCap).full), 1)])) : (_(), W(o, {
          key: 1,
          class: "skeleton"
        }))]), S("div", Eu, [(_(!0), T(ut, null, de(m(e), c => (_(), T("div", {
          key: c.title,
          class: "item"
        }, [S("span", Tu, A(c.title), 1), c.value === void 0 ? (_(), W(o, {
          key: 0,
          class: "skeleton"
        })) : (_(), T("span", zu, [typeof c.value == "string" ? (_(), T(ut, {
          key: 0
        }, [Gs(A(c.value), 1)], 64)) : c.value === null ? (_(), T(ut, {
          key: 1
        }, [Gs(" — ")], 64)) : (_(), T(ut, {
          key: 2
        }, [c.value.prefix ? (_(), T("span", Iu, A(c.value.prefix), 1)) : ht("", !0), S("span", null, A(c.value.value), 1), c.value.postfix ? (_(), T("span", $u, A(c.value.postfix), 1)) : ht("", !0)], 64))]))]))), 128))])])) : ht("", !0)])
      }
    }
  }),
  Lu = lt(Pu, [
...
var Au = function() {
  function s(t, e, i) {
    var n;
    this._canvasElement = null, this._bitmapSizeChangedListeners = [], this._suggestedBitmapSize = null, this._suggestedBitmapSizeChangedListeners = [], this._devicePixelRatioObservable = null, this._canvasElementResizeObserver = null, this._canvasElement = t, this._canvasElementClientSize = q({
  ...
  return s.prototype.dispose = function() {
    ...
    this._canvasElementClientSize = q(t), this.canvasElement.style.width = "".concat(this._canvasElementClientSize.width, "px"), this.canvasElement.style.height = "".concat(this._canvasElementClientSize.height, "px"), this._invalidateBitmapSize()
    ...
    var e = this._suggestedBitmapSize,
      i = q(this._transformBitmapSize(t, this._canvasElementClientSize)),
    ...
    if (this._canvasElement !== null) {
      ...
      this._devicePixelRatioObservable = Ru(e), this._devicePixelRatioObservable.subscribe(function() {
...
function Ou(s, t) {
  if (t.type === "device-pixel-content-box") return new Au(s, t.transform, t.options);
...
function Gt(s, t) {
  ...
  return n === null ? null : new Wu(n, e, i)
}
/*!
 * @license
...
const Xu = /^#([0-9a-f])([0-9a-f])([0-9a-f])([0-9a-f])?$/i,
  Ju = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?$/i,
  Yu = /^rgb\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*\)$/,
  Gu = /^rgba\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d*\.?\d+)\s*\)$/;

function Re(s) {
  (s = s.toLowerCase()) in bn && (s = bn[s]);
  {
    const t = Gu.exec(s) || Yu.exec(s);
...
function _t(s, ...t) {
  for (const e of t)
    for (const i in e) e[i] !== void 0 && (typeof e[i] != "object" || s[i] === void 0 || Array.isArray(e[i]) ? s[i] = e[i] : _t(s[i], e[i]));
  return s
}
...
class id {
  ...
  bt(t) {
    const e = this.F.wt();
    e.length !== this.ct.length && (this.dt = e.map(td), this.ct = this.dt.map(i => {
      const n = new Qu;
      return n.J(i), n
  ...
  Mt() {
    ...
    e.forEach((o, r) => {
      ...
      const c = M(o.Ct());
      a.lt = h.Tt, a.ht = h.ht, a.et = h.Pt, a.it[0]._t = h._t, a.it[0].st = o.Dt().Rt(h._t, c.Vt), a.rt = (l = h.Ot) !== null && l !== void 0 ? l : this.F.Bt(a.it[0].st / o.Dt().At()), a.it[0].ot = i, a.it[0].nt = n.It(i), a.tt = ed
    })
  }
}
class sd extends wt {
...
class nd {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      nt: 0,
      st: 0
    }, this.Wt = new sd(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
...
class wn {
  ...
  Gt(t, e, i, n) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, f = e.L + this.Xt.wi, p = e.B + this.Xt.gi, v = e.A, b = e.I, y = this.zt.Kt, g = e.P, x = i.Mi(r, y), k = Math.ceil(i.xi(r, y)), I = g + f + p, N = e.C + v + b + k + u, L = Math.max(1, Math.floor(c));
    let P = Math.round(I * c);
    P % 2 != L % 2 && (P += 1);
    const z = d > 0 ? Math.max(1, Math.floor(d * h)) : 0,
      D = Math.round(N * h),
      U = Math.round(u * h),
      C = (o = this.Xt.Si) !== null && o !== void 0 ? o : this.Xt.ki,
      B = Math.round(C * c) - Math.floor(.5 * c),
      K = Math.floor(B + L / 2 - P / 2),
      X = K + P,
      F = n === "right",
      J = F ? a.width - d : d,
      Y = F ? l.width - z : z;
    let ot, at, H;
    return F ? (ot = Y - D, at = Y - U, H = J - u - v - d) : (ot = Y + D, at = Y + U, H = J + u + v), {
      Qt: F,
      Jt: {
        ii: K,
        li: B,
...
class hr {
  ...
  X(t, e) {
    ...
    const i = t.useMediaCoordinateSpace(({
      context: d
    }) => (d.font = e.R, Math.round(e.Wi.xi(d, M(this.zt).Kt, ld))));
    if (i <= 0) return;
    const n = e.ji,
      o = i + 2 * n,
      r = o / 2,
    ...
    t.useBitmapCoordinateSpace(({
      ...
      if (d.beginPath(), d.moveTo(b, y), d.lineTo(b, x - k), d.arcTo(b, x, b + k, x, k), d.lineTo(g - k, x), d.arcTo(g, x, g, x - k, k), d.lineTo(g, y), d.fill(), v.hi) {
        const I = Math.round(v.ki * f),
          N = y,
          L = Math.round((N + e.T) * p);
        d.fillStyle = v.V;
        const P = Math.max(1, Math.floor(f)),
          z = Math.floor(.5 * f);
        d.fillRect(I - z, N, P, L - N)
      }
    }), t.useMediaCoordinateSpace(({
      context: d
    }) => {
...
class hd extends Vs {
  constructor(t, e) {
    super(), this.tn = null, this.nn = NaN, this.sn = 0, this.en = !0, this.rn = new Map, this.hn = !1, this.ln = NaN, this.an = NaN, this._n = NaN, this.un = NaN, this.$i = t, this.cn = e, this.dn = new id(t, this), this.fn = ((n, o) => r => {
      const l = o(),
        a = n();
    ...
    this.bn = new ad(this, t, i), this.wn = new nd(this)
  }
  W() {
    return this.cn
  }
  ...
  Tn() {
    const t = this.$i.wt().map(i => i.In().An()).filter(Zu),
      e = t.length === 0 ? null : Math.max(...t);
    this.sn = e !== null ? e : NaN
  }
  Dn(t, e, i) {
    let n = t.get(e);
    return n === void 0 && (n = new rd(this, e, i), t.set(e, n)), n
  }
}
...
class dr extends wt {
  ...
  K(t) {
    ...
    if (n === null) return;
    const c = t.context;
    c.lineCap = "butt", c.lineJoin = "round", c.lineWidth = r, Zt(c, l), c.lineWidth = 1, ur(t, i, a, n, o, this.ps.bind(this), dd.bind(null, h))
  }
}
...
class pr extends wt {
  ...
  K(t) {
    ...
    o !== void 0 && ur(t, e, o, i, n, c, pd), a && function(u, d, f, p, v) {
      const {
      ...
      for (let N = p.to - 1; N >= p.from; --N) {
        ...
        if (L) {
          const P = v(u, L);
          P !== x && (g.beginPath(), x !== null && g.fill(), g.fillStyle = P, x = P);
          const z = Math.round(L.nt * b) + k,
            D = L.st * y;
          g.moveTo(z, D), g.arc(z, D, I, 0, 2 * Math.PI)
        }
      }
      g.fill()
    }(t, e, a, i, c)
...
class gd extends Pi {
  constructor(t, e) {
    super(t, e), this.Ws = new Ds, this.ee = new fd, this.re = new mr, this.Ws.Z([this.ee, this.re])
  }
  ne(t, e, i) {
  ...
  K({
    ...
    for (let r = this.zt.tt.from; r < this.zt.tt.to; ++r) {
      ...
      if (o) {
        if (this.zt.fe) {
          const N = h - g;
          let L = Math.max(v, Math.round(l.ve * i) - a),
            P = L + u - 1;
          P > v + y - 1 && (P = v + y - 1, L = P - u + 1), t.fillRect(N, L, c - N, P - L + 1)
        }
        const x = h + g;
...
class yd extends yr {
  constructor() {
    super(...arguments), this.Ws = new bd
  }
  ne(t, e, i) {
...
class Sd extends Pi {
  constructor(t, e) {
    super(t, e), this.Ws = new Ds, this.De = new _d, this.Ve = new wd, this.Ws.Z([this.De, this.Ve])
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class Md extends wt {
  ...
  Ae(t, e, i) {
    ...
    for (let c = i.from; c < i.to; c++) {
      ...
      if (h !== null && (d = Math.max(h + 1, d), d = Math.min(d, f)), this.zt.he * o > 2 * a) od(n, d, p, f - d + 1, v - p + 1, a);
      else {
        const b = f - d + 1;
...
class kd extends yr {
  constructor() {
    super(...arguments), this.Ws = new Md
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.be(t, e, i)), i.Hs(t))
  }
...
class Ni extends Ns {
  constructor(t, e, i) {
    super(t, e, !1), this.wn = i, this.Ws = new xd(this.wn.renderer(), n => {
      const o = t.Ct();
...
class Td extends Pi {
  constructor() {
    super(...arguments), this.Ws = new Ed
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class De {
  ...
  nr(t, e, i) {
    ...
    if (this.Qe.has(o)) return dt(this.Qe.get(o)).sr;
    if (this.Xe === this.tr) {
...
class _r {
  constructor(t, e, i) {
    this._r = t, this.lr = new De(50), this.ur = e, this.F = i, this.j = -1, this.Wt = new $d(this.lr)
  }
  gt() {
...
class Ad {
  constructor(t) {
    this.Wt = new jd, this.ft = !0, this.Er = !0, this.Nr = performance.now(), this.Fr = this.Nr - 1, this.Wr = t
  }
  jr() {
  ...
  K({
    ...
    if (this.zt !== null && this.zt.tt !== null) {
      ...
      for (let r = this.zt.tt.from; r < this.zt.tt.to; r++) {
        ...
        l.Kt !== void 0 && (l.Kt.Hi = this.lr.xi(t, l.Kt.th), l.Kt.At = this.j, l.Kt.nt = l.nt - l.Kt.Hi / 2), Vd(l, t, e, i)
      }
    }
  }
}
...
function Wd(s, t, e) {
  return !(s.Kt === void 0 || ! function(i, n, o, r, l, a) {
    ...
    switch (i.ih) {
      case "arrowDown":
      case "arrowUp":
        return Od(0, i.nt, i.st, i.Xs, n, o);
      case "circle":
...
class Bd {
  constructor(t, e) {
    this.ft = !0, this.eh = !0, this.rh = !0, this.hh = null, this.ah = null, this.Wt = new Dd, this.Wr = t, this.$i = e, this.zt = {
      it: [],
      tt: null
    }
  }
  ...
  oh() {
    ...
    for (let c = this.zt.tt.from; c < this.zt.tt.to; c++) {
      ...
      f !== null && Nd(d, u, f, h, n.fontSize, a, t, e, r.Vt)
    }
    this.ft = !1
  }
}
...
class ft {
  ...
  ts(t) {
    return t === null ? this : new ft(In(Math.min, this.Th(), t.Th(), -1 / 0), In(Math.max, this.Ph(), t.Ph(), 1 / 0))
  }
  Dh(t) {
  ...
  static Bh(t) {
    return t === null ? null : new ft(t.minValue, t.maxValue)
  }
}
class yi {
  constructor(t, e) {
  ...
  static Bh(t) {
    return t === null ? null : new yi(ft.Bh(t.priceRange), t.margins)
  }
}
class Kd extends Bs {
  constructor(t, e) {
...
class Xd {
  constructor(t, e) {
    this.Wr = t, this.cn = e, this.Wh = new Kd(t, this), this._r = new Hd(t, this), this.jh = new _r(this._r, t, t.$t())
  }
  Hh(t) {
...
class Gd {
  constructor(t) {
    this.Xh = (e, i) => i !== void 0 ? i.Vt : this.Wr.In().Kh(e), this.Wr = t, this.Gh = Yd[t.Jh()]
  }
  Hs(t, e) {
...
class Zd {
  ...
  ol(t, e, i) {
    ...
    for (let d = Math.max(h + 1, l); d < c; d += $t) {
...
class Fs extends Jd {
  constructor(t, e, i, n, o) {
    super(t), this.zt = new Zd, this.Wh = new Fd(this), this.Il = [], this.zl = new Ld(this), this.Ll = null, this.El = null, this.Nl = [], this.Fl = [], this.Wl = null, this.jl = [], this.cn = e, this.Hl = i;
    const r = new Ud(this);
    this.rn = [r], this.jh = new _r(r, this, t), i !== "Area" && i !== "Line" && i !== "Baseline" || (this.Ll = new Ad(this)), this.$l(), this.Ul(o)
  }
  S() {
  ...
  $s() {
    return this.El !== null || (this.El = new Gd(this)), this.El
  }
  W() {
    return this.cn
  }
  ...
  va(t, e) {
    ...
    const i = this.Hl === "Line" || this.Hl === "Area" || this.Hl === "Baseline" || this.Hl === "Histogram" ? [3] : [2, 1],
      n = this.zt.al(t, e, i);
    let o = n !== null ? new ft(n.pl, n.ml) : null;
    ...
    return this.jl.forEach(l => {
      ...
      if (a != null && a.priceRange) {
        const f = new ft(a.priceRange.minValue, a.priceRange.maxValue);
        o = o !== null ? o.ts(f) : f
      }
      var h, c, u, d;
  ...
  $l() {
    switch (this.cn.priceFormat.type) {
      case "custom":
        ...
        break;
      case "volume":
        this.ba = new cd(this.cn.priceFormat.precision);
        break;
      case "percent":
      ...
      default: {
        ...
        this.ba = new $i(t, this.cn.priceFormat.minMove * t)
      }
    }
  ...
  Ul(t) {
    switch (this.dn = new Bd(this, this.$t()), this.Hl) {
      case "Bar":
        this.wn = new yd(this, this.$t());
        break;
      case "Candlestick":
        this.wn = new kd(this, this.$t());
        break;
      case "Line":
        this.wn = new zd(this, this.$t());
        break;
      case "Custom":
        this.wn = new Ni(this, this.$t(), dt(t));
        break;
      case "Area":
        this.wn = new gd(this, this.$t());
        break;
      case "Baseline":
        this.wn = new Sd(this, this.$t());
        break;
      case "Histogram":
...
class lf {
  constructor(t) {
    this.Wt = new rf, this.ft = !0, this.tn = t
  }
  bt() {
    this.ft = !0
  }
...
class Pn {
  ...
  Za(t, e) {
    ...
    const i = this.Li.At(),
      n = (t - e) * this.Ja() / i,
      o = new Xi(this.Ua, [2, 2.5, 2]),
      r = new Xi(this.Ua, [2, 2, 2.5]),
      l = new Xi(this.Ua, [2.5, 2, 2]),
      a = [];
...
class uf {
  constructor(t, e, i, n) {
    this.ro = 0, this.ho = null, this.Ah = null, this.lo = null, this.ao = {
      oo: !1,
      _o: null
    }, this.uo = 0, this.co = 0, this.do = new rt, this.fo = new rt, this.vo = [], this.po = null, this.mo = null, this.bo = null, this.wo = null, this.ba = Rn, this.Mo = Hi(null), this.xo = t, this.cn = e, this.So = i, this.ko = n, this.yo = new Pn(this, 100, this.Co.bind(this), this.To.bind(this))
  }
  Ta() {
    return this.xo
  }
  ...
  Hh(t) {
    if (_t(this.cn, t), this.Pa(), t.mode !== void 0 && this.Po({
      ...
      const e = dt(t.scaleMargins.top),
        i = dt(t.scaleMargins.bottom);
  ...
  Pa() {
    ...
    const t = this.s_();
    let e = 100;
    t !== null && (e = Math.round(1 / t.pa())), this.ba = Rn, this.gh() ? (this.ba = jn, e = 100) : this.Vo() ? (this.ba = new $i(100, 1), e = 100) : t !== null && (this.ba = t.ma()), this.yo = new Pn(this, e, this.Co.bind(this), this.To.bind(this)), this.yo.Qa()
  }
  qo() {
    this.po = null
  }
  ...
  h_() {
    ...
    if (n === this.uo && o === this.co || (this.uo = n, this.co = o, this.mo = null, this.Ro()), e !== null) {
      if (e.Th() === e.Ph()) {
        ...
        this.eo() && (e = Ze(e, this.Mo)), e = new ft(e.Th() - h, e.Ph() + h), this.eo() && (e = _e(e, this.Mo))
      }
      if (this.eo()) {
      ...
      this.Bo(e)
    } else this.Ah === null && (this.Bo(new ft(-.5, .5)), this.Mo = Hi(null));
    var r, l;
    this.ao.oo = !0
  }
  jo() {
...
class df {
  constructor(t, e) {
    this.vo = [], this.a_ = new Map, this.ro = 0, this.o_ = 0, this.__ = 1e3, this.po = null, this.u_ = new rt, this.kl = t, this.$i = e, this.c_ = new af(this);
    const i = e.W();
  ...
  b_(t) {
    ...
    return this.a_.has(t) ? dt(this.a_.get(t))[0].Dt() : null
  }
  S() {
  ...
  f_(t, e) {
    const i = Object.assign({
      ...
      n = new uf(t, i, this.$i.W().layout, this.$i.W().localization);
...
class ff {
  ...
  q_(t) {
    ...
    if (this.Xe === this.tr) {
      ...
      this.Je.delete(this.Ge), this.Qe.delete(dt(r)), this.Ge++, this.Xe--
    }
    const o = this.H_(t);
...
class vf {
  ...
  Hh(t, e) {
    var i;
    _t(this.cn, t), this.cn.fixLeftEdge && this.Cu(), this.cn.fixRightEdge && this.Tu(), t.barSpacing !== void 0 && this.$i.Gn(t.barSpacing), t.rightOffset !== void 0 && this.$i.Jn(t.rightOffset), t.minBarSpacing !== void 0 && this.$i.Gn((i = t.barSpacing) !== null && i !== void 0 ? i : this.xu), this.yu(), this.Su(), this.mu.m()
  }
  mn(t) {
    var e, i;
  ...
  $u(t) {
    ...
    return e === void 0 && (e = new ff(i => this.dc(i), this.U_), this.cu.set(t.weight, e)), e.q_(t)
  }
  dc(t) {
...
class yf {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      gc: "center",
      Mc: "center"
    }, this.Wt = new bf(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
...
class _f extends Vs {
  constructor(t, e) {
    super(), this.cn = e, this.wn = new yf(this)
  }
  Rn() {
    return []
  }
...
class wf {
  constructor(t, e, i) {
    this.kc = [], this.yc = [], this.o_ = 0, this.Cc = null, this.Tc = new rt, this.Pc = new rt, this.Rc = null, this.Dc = t, this.cn = e, this.U_ = i, this.Vc = new qu(this), this.kl = new vf(this, e.timeScale, this.cn.localization, i), this.vt = new hd(this, e.crosshair), this.Oc = new of(e.crosshair), this.Bc = new _f(this, e.watermark), this.Ac(), this.kc[0].M_(2e3), this.Ic = this.zc(0), this.Lc = this.zc(1)
  }
  Xl() {
    this.Ec(ct.es())
  }
...
class xf {
  constructor(t = {}) {
    const e = Object.assign(Object.assign({}, kf), t);
    this.Cd = new Cr(e.xd, e.yd), this.Td = new Mf(e.Sd), this.Pd = e.kd
  }
  q_(t) {
...
class Xn {
  ...
  updateFormatter(t) {
    ...
    this.cn.timeScale.timeVisible ? this.Bd = new xf({
      xd: e,
...
class Ks {
  ...
  Af(t) {
    if (t.button !== 0) return;
    const e = this.Lf(t);
    if (this.ff = null, this.Rf = !1, this.Sf && (this.Sf(), this.Sf = null), Jn() && this.Yf.ownerDocument.documentElement.removeEventListener("mouseleave", this.Bf), !this.zf(t))
  ...
  pv(t) {
    ...
    Jn() && e.addEventListener("mouseleave", this.Bf), this.mf = !1, this.ff = St(t), this.Sf && (this.Sf(), this.Sf = null);
    {
  ...
  Zf() {
    ...
    Gi() && (this.Mf = () => {
      ...
      passive: !0
    }), Tf(this.Yf), this.Yf.addEventListener("mousedown", this.pv.bind(this)), this.gv(), this.Yf.addEventListener("touchmove", () => {}, {
      passive: !1
    })
  }
  gv() {
...
class Zn {
  constructor(t, e, i, n) {
    this.Li = null, this.Lv = null, this.Ev = !1, this.Nv = new De(200), this.Jr = null, this.Fv = 0, this.Wv = !1, this.jv = () => {
      ...
      this.Wv || this.tn.Hv().$t().$h()
    }, this.tn = t, this.cn = e, this.So = e.layout, this.Vc = i, this.Uv = n === "left", this.qv = ts("normal", n), this.Yv = ts("top", n), this.Zv = ts("bottom", n), this.Xv = document.createElement("div"), this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Xv.style.width = "25px", this.Xv.style.left = "0", this.Xv.style.position = "relative", this.Kv = qt(this.Xv, q({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const o = this.Kv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "1", o.style.left = "0", o.style.top = "0", this.Gv = qt(this.Xv, q({
      width: 16,
      height: 16
...
class Hs {
  constructor(t, e) {
    ...
    i.style.width = "100%", i.style.height = "100%", i.style.position = "relative", i.style.overflow = "hidden", this.Wp = document.createElement("td"), this.Wp.style.padding = "0", this.jp = document.createElement("td"), this.jp.style.padding = "0", this.Fp.appendChild(i), this.Kv = qt(i, q({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const n = this.Kv.canvasElement;
    n.style.position = "absolute", n.style.zIndex = "1", n.style.left = "0", n.style.top = "0", this.Gv = qt(i, q({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
  ...
  Up(t) {
    var e, i;
    this.Ep !== null && this.Ep.F_().p(this), this.Ep = t, this.Ep !== null && this.Ep.F_().l(Hs.prototype.Np.bind(this), this, !0), this.$p(), this.Jd.qp().indexOf(this) === this.Jd.qp().length - 1 ? (this.Tp = (e = this.Tp) !== null && e !== void 0 ? e : new Ef(this.Fp, this.Jd), this.Tp.bt()) : ((i = this.Tp) === null || i === void 0 || i.tf(), this.Tp = null)
  }
  Hv() {
    return this.Jd
  }
  ...
  fp(t) {
    ...
    if (t > 1 && this.um(), this.yp !== null && this.yp.fp(t), this.Cp !== null && this.Cp.fp(t), t !== 1) {
      ...
      i !== null && (i.useBitmapCoordinateSpace(n => {
        this.pp(n)
      }), this.Ep && (this.dm(i, If), this.fm(i), this.vm(i), this.dm(i, ii), this.dm(i, $f)))
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Gt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
  ...
  im(t) {
    ...
    if (this.Pp !== null || this.Mm(t) || (this.Pp = {
      ...
      if (t.Rv && r.touch || !t.Rv && r.mouse) {
        const h = i.he();
        this.Lp = new Cf(.2 / h, 7 / h, .997, 15 / h), this.Lp.qd(i.ju(), this.Pp.Vd)
      } else this.Lp = null;
...
class qn {
  constructor(t, e, i, n, o) {
    this.ft = !0, this.Lv = q({
      width: 0,
      height: 0
    }), this.jv = () => this.fp(3), this.Uv = t === "left", this.Vc = i._d, this.cn = e, this.Cm = n, this.Tm = o, this.Xv = document.createElement("div"), this.Xv.style.width = "25px", this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Kv = qt(this.Xv, q({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv)
  }
...
class Af {
  constructor(t, e) {
    this.Pm = null, this.Rm = null, this.k = null, this.Dm = !1, this.Lv = q({
      width: 0,
      height: 0
  ...
  Nm(t, e, i) {
    Ht(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.Vm.m(t)), this.Pm !== null && this.Pm.up(q({
      width: e,
      height: t.height
    })), this.Rm !== null && this.Rm.up(q({
      width: i,
      height: t.height
    }))
  }
  ...
  fp(t) {
    ...
    if (t !== 1) {
      ...
      const i = Gt(this.Kv);
      i !== null && (i.useBitmapCoordinateSpace(n => {
        this.pp(n), this.Ae(n), this.Hm(i, Rf)
      }), this.bp(i), this.Hm(i, Lf)), this.Pm !== null && this.Pm.fp(t), this.Rm !== null && this.Rm.fp(t)
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Gt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
      ...
      i.clearRect(0, 0, n.width, n.height)
    }), this.$m([...this.Jd.$t().wt(), this.Jd.$t().Yc()], e), this.Hm(e, jf))
  }
  Hm(t, e) {
...
const Of = !!ge && !!navigator.userAgentData && navigator.userAgentData.brands.some(s => s.brand.includes("Chromium")) && !!ge && (!((es = navigator == null ? void 0 : navigator.userAgentData) === null || es === void 0) && es.platform ? navigator.userAgentData.platform === "Windows" : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
var es;
class Df {
  constructor(t, e, i) {
    var n;
    this.Zm = [], this.Xm = 0, this.ro = 0, this.o_ = 0, this.Km = 0, this.Gm = 0, this.Jm = null, this.Qm = !1, this.Dp = new rt, this.Vp = new rt, this.Pc = new rt, this.tb = null, this.ib = null, this.Gd = t, this.cn = e, this.U_ = i, this.Zd = document.createElement("div"), this.Zd.classList.add("tv-lightweight-charts"), this.Zd.style.overflow = "hidden", this.Zd.style.direction = "ltr", this.Zd.style.width = "100%", this.Zd.style.height = "100%", (n = this.Zd).style.userSelect = "none", n.style.webkitUserSelect = "none", n.style.msUserSelect = "none", n.style.MozUserSelect = "none", n.style.webkitTapHighlightColor = "transparent", this.nb = document.createElement("table"), this.nb.setAttribute("cellspacing", "0"), this.Zd.appendChild(this.nb), this.sb = this.eb.bind(this), is(this.cn) && this.rb(!0), this.$i = new wf(this.Dc.bind(this), this.cn, i), this.$t().Zc().l(this.hb.bind(this), this), this.lb = new Af(this, this.U_), this.nb.appendChild(this.lb.hp());
  ...
  ob(t, e, i = !1) {
    ...
    const o = this.ro + "px",
      r = this.o_ + "px";
    M(this.Zd).style.height = o, M(this.Zd).style.width = r, this.nb.style.height = o, this.nb.style.width = r, i ? this.pb(ct.es(), performance.now()) : this.$i.Xl()
  }
  fp(t) {
    t === void 0 && (t = ct.es());
  ...
  Tb() {
    ...
    for (let p = 0; p < this.Zm.length; ++p) {
      ...
      let b = 0,
        y = 0;
      y = p === this.Zm.length - 1 ? u - f : Math.round(v.g_() * d), b = Math.max(y, 2), f += b, v.up(q({
        width: r,
        height: b
  ...
  Pb(t) {
    ...
    return Of ? 1 / window.devicePixelRatio : 1
  }
  eb(t) {
...
function ao(s) {
  return function(t) {
    if (Je(t.handleScale)) {
      ...
      Je(i) && (t.handleScale.axisPressedMouseMove = {
        time: i,
        price: i
      }), Je(n) && (t.handleScale.axisDoubleClickReset = {
        time: n,
        price: n
      })
    }
...
class ap {
  constructor(t, e, i) {
    this.xw = new Map, this.Sw = new Map, this.kw = new rt, this.yw = new rt, this.Cw = new rt, this.Tw = new Kf(e);
    const n = i === void 0 ? Et(ro()) : _t(Et(ro()), ao(i));
    this.U_ = e, this.lw = new Df(t, n, e), this.lw.hm().l(r => {
    ...
    const o = this.lw.$t();
    this.Rw = new rp(o, this.lw.cb(), this.U_)
  }
  remove() {
  ...
  addAreaSeries(t) {
    return this.Dw("Area", Uu, t)
  }
  addBaselineSeries(t) {
    return this.Dw("Baseline", Ku, t)
  }
  addBarSeries(t) {
    return this.Dw("Bar", Bu, t)
  }
  addCandlestickSeries(t = {}) {
    ...
    }(t), this.Dw("Candlestick", Nu, t)
  }
  addHistogramSeries(t) {
    return this.Dw("Histogram", Hu, t)
  }
  addLineSeries(t) {
    return this.Dw("Line", Fu, t)
  }
  removeSeries(t) {
    const e = dt(this.xw.get(t)),
      i = this.Tw.fd(e);
  ...
  Dw(t, e, i = {}, n) {
    lp(i.priceFormat);
    const o = _t(Et(nr), Et(e), i),
      r = this.lw.$t().ud(t, o, n),
      l = new op(r, this, this, this, this.U_);
...
function hp(s, t, e) {
  ...
  const n = new ap(i, t, e);
  return t.setOptions(n.options()), n
}

function cp(s, t) {
  return hp(s, new Xn, Xn.Ad(t))
}
...
const ho = "chart-series-type-storage-key",
  zr = s => {
    const t = It("$iBkM1fJygO"),
      ...
      n = It(() => {
        ...
        return $e().$webApp.storage.local.get(ho) ?? g
      }, "$HolymaTkRj"),
      ...
      u = g => {
        n.value = g, $e().$webApp.storage.local.set(ho, g)
      },
      d = g => {
        const x = i.value,
          k = e.value,
        ...
        const N = g.points.filter(P => I.data.points.some(z => z.timestamp === P.timestamp)),
          L = g.points.filter(P => !I.data.points.some(z => z.timestamp === P.timestamp));
        return {
          type: x,
          interval: k,
          data: {
            points: [...L, ...I.data.points.map(P => N.find(z => z.timestamp === P.timestamp) || P)]
          }
        }
      },
      f = async g => {
        ...
        k.aborted || (bt(I) ? t.value = d(I.data) : r.value = x)
      }, p = It(() => Wr(async () => {
    ...
    setup(s) {
      const t = s,
        ...
        x = new ResizeObserver(() => {
          var D;
          const z = c.value;
          z && ((D = u.value) == null || D.resize(z.clientWidth, z.clientHeight))
        }),
        k = () => {
          const z = c.value;
          z && x.observe(z)
      ...
      const L = (z, D, U) => {
          var X;
          const C = (X = $e().$webApp.dataUnsafe.user) == null ? void 0 : X.language_code;
          u.value || (u.value = cp(D, {
            localization: {
              timeFormatter: F => {
                const J = ot => String(ot).padStart(2, "0"),
                  Y = new Date(F * 1e3);
                return `${J(Y.getUTCHours())}:${J(Y.getUTCMinutes())}`
              },
              priceFormatter: F => {
                if (g.value === Lt.MARKET_CAP) return `$${Ut(F,{accuracy:0})}`;
                {
                  if (Math.abs(F) < 1e-9) return "$0";
                  const [J, Y] = F.toFixed(9).split("."), ot = Y[0], H = Y.slice(1).match(/^0+/), Q = H ? H[0].length : 0, pt = Q > 0 ? String.fromCharCode(8321 + Q) : "", E = Y.slice(Q + 1).replace(/0+$/, "").slice(0, 3);
                  return `$${J}.${ot}${pt}${E}`
                }
              },
              locale: C
          ...
          const B = z.map(F => ({
            time: (() => {
              const J = new Date(F.timestamp);
              return (J.getTime() - J.getTimezoneOffset() * 60 * 1e3) / 1e3
            })(),
            open: F.open.toNumber(),
            high: F.high.toNumber(),
            low: F.low.toNumber(),
            close: F.close.toNumber(),
            value: F.price.toNumber()
          })).sort((F, J) => F.time - J.time);
          (!d.value || N !== U) && (d.value && u.value.removeSeries(d.value), U === oe.CANDLESTICK ? d.value = u.value.addCandlestickSeries({
            upColor: "#C4F85C",
            downColor: "#FF00C7",
            baseLineWidth: 2,
            ...
            priceFormat: {
              type: "price",
              precision: g.value === Lt.MARKET_CAP ? 0 : 9,
              minMove: 1e-9
            }
          ...
          }), N = U, u.value.timeScale().subscribeVisibleLogicalRangeChange(F => {
            var at, H, Q, pt;
            if (!F || F.from >= 0) return;
            const J = (H = (at = d.value) == null ? void 0 : at.dataByIndex(0)) == null ? void 0 : H.time,
              Y = (pt = (Q = u.value) == null ? void 0 : Q.timeScale().getVisibleRange()) == null ? void 0 : pt.from;
            if (!J || J !== Y) return;
            const ot = (() => {
              const E = new Date(Y * 1e3);
              return (E.getTime() + E.getTimezoneOffset() * 60 * 1e3) / 1e3
            })();
            h(ot)
          })), d.value.setData(B);
          const K = f.value !== i.value ? "interval" : p.value !== n.value ? "type" : "other";
          f.value = i.value, p.value = n.value, (K === "interval" || K === "type") && u.value.timeScale().fitContent()
        },
        P = j(() => {
          var U;
          if (!((U = t.jettonPnl) != null && U.hasPnL)) return;
          const z = Br(t.jettonPnl.pnlAbsoluteUSD, {
              accuracy: 2,
              trim: !0
            }),
            D = dl(t.jettonPnl.pnlPercent);
          return {
            label: `P&L ${z} ${D.formatted}`,
            cls: D.cls
          }
        });
      return he(() => {
        ...
        !z.container || !z.chart || L(z.chart.points, z.container, z.chartSeriesType)
      }, {
        immediate: !0
      }), he(c, z => z && k(), {
        immediate: !0
        ...
        const U = Ot;
        return _(), T("div", up, [S("div", dp, [S("div", {
          class: "section",
          style: ls({
            "grid-template-columns": `repeat(${m(b).length}, 1fr)`
          })
        }, [(_(!0), T(ut, null, de(m(b), C => (_(), T("label", {
          key: C.value,
          class: ae(["item", {
            "is-active": m(n) === C.value
          }])
        }, [Ft(S("input", {
          "onUpdate:modelValue": D[0] || (D[0] = B => yt(g) ? g.value = B : null),
          type: "radio",
          name: "chart-type",
          value: C.value
        }, null, 8, fp), [
          [as, m(g)]
        ]), S("span", pp, A(C.label), 1)], 2))), 128))], 4), S("div", {
          class: "section",
          style: ls({
            "grid-template-columns": `repeat(${m(v).length}, 1fr)`
          })
        }, [(_(!0), T(ut, null, de(m(v), C => (_(), T("label", {
          key: C.value,
          class: ae(["item", {
            "is-active": m(i) === C.value
          }])
        }, [Ft(S("input", {
          "onUpdate:modelValue": D[1] || (D[1] = B => yt(y) ? y.value = B : null),
          type: "radio",
          name: "chart-interval",
          value: C.value
        }, null, 8, mp), [
          [as, m(y)]
        ]), S("span", vp, A(C.label), 1)], 2))), 128))], 4), S("button", {
          type: "button",
          class: "reset chart-type",
          onClick: D[2] || (D[2] = C => m(a)(m(o) === m(oe).LINEAR ? m(oe).CANDLESTICK : m(oe).LINEAR))
        }, [m(o) === m(oe).CANDLESTICK ? (_(), W(U, {
          key: 0,
          name: "chart-line",
          class: "icon"
        })) : (_(), W(U, {
          ...
          name: "candle-chart",
          class: "icon"
        }))])]), !m(e) || !m(e).data.points.length ? (_(), T("div", gp, [D[4] || (D[4] = S("img", {
          src: Zs,
          class: "lines"
        }, null, -1)), D[5] || (D[5] = S("img", {
          src: Fr,
          class: "empty"
        }, null, -1)), S("div", bp, [D[3] || (D[3] = S("div", {
          class: "dot"
        }, null, -1)), S("div", yp, A(("t" in z ? z.t : m(O))("memepad.jetton.chart.coming_text")), 1)])])) : (_(), T("div", _p, [m(P) ? (_(), T("div", {
          key: 0,
          class: ae(["pnl-label", m(P).cls])
        }, A(m(P).label), 3)) : ht("", !0), S("div", {
          ref_key: "container",
          ref: c,
          class: "chart-container"
        }, null, 512), D[6] || (D[6] = S("img", {
          src: Zs,
          class: "lines"
        }, null, -1))]))])
      }
    ...
    setup(s) {
      ...
      return (n, o) => {
        ...
        return _(), T(ut, null, [R(r, {
          ...
          default: Z(() => [S("div", Mp, A(("t" in n ? n.t : m(O))("memepad.jetton.unlock.btn")), 1)]),
          _: 1
        }, 8, ["type"]), R(h, {
          modelValue: m(e),
          "onUpdate:modelValue": o[1] || (o[1] = c => yt(e) ? e.value = c : null)
        }, {
          default: Z(() => [S("div", kp, [S("div", xp, [R(l, {
            src: m(uo)(n.jetton.iconFileKey),
            size: 80
          }, null, 8, ["src"])]), S("div", Cp, A(("t" in n ? n.t : m(O))("memepad.jetton.unlock.sheet.title", {
            ticker: n.jetton.ticker
          })), 1), S("div", Ep, A(("t" in n ? n.t : m(O))("memepad.jetton.unlock.sheet.subtitle", {
            ticker: n.jetton.ticker
          })), 1), S("div", Tp, [R(a, {
            jetton: n.jetton,
  ...
  Lp = nt({
    ...
    setup(s) {
      ...
      return (o, r) => (_(), T("label", {
        class: ae(["kit-tab", [`is-${m(i).toLowerCase()}`, {
          "is-active": m(n)
        }]])
      }, [S("span", $p, A(s.label), 1), Ft(S("input", {
        "onUpdate:modelValue": r[0] || (r[0] = l => yt(n) ? n.value = l : null),
        type: "radio",
        value: s.value,
        name: m(e).name
      }, null, 8, Pp), [
  ...
  Rp = nt({
    ...
    setup(s) {
      ...
      return Kr(go, {
        ...
        const r = Ir,
          l = Xr("horizontal-wheel-scroll");
        return _(), T("div", {
          class: ae(["kit-tabs", `is-${s.type.toLowerCase()}`])
        }, [Ft((_(), T("div", jp, [Jr(n.$slots, "default", {}, void 0, !0), (_(!0), T(ut, null, de(m(i), a => (_(), W(r, {
          key: a.value,
          label: a.label,
          value: a.value,
          type: s.type
  ...
  Np = nt({
    ...
    emits: ["trade", "open-payment-sheet"],
    setup(s) {
      const t = s,
      ...
      return (l, a) => {
        ...
        const h = ko,
          ...
          d = wo,
          f = te;
        return _(), T("div", Op, [S("div", Dp, [l.inputState ? (_(), T(ut, {
          key: 0
        }, [l.inputState.balanceLabel ? (_(), W(h, {
          key: 0,
          balance: l.inputState.balanceLabel
        }, null, 8, ["balance"])) : (_(), W(c, {
          key: 1,
          class: "skeleton"
        })), l.inputState.error || l.inputState.feesInfo ? (_(), W(u, {
          key: 2,
        ...
        }, null, 8, ["details", "total-label", "error-message"])) : (_(), W(c, {
          key: 3,
          class: "skeleton"
        }))], 64)) : (_(), T(ut, {
          key: 1
          ...
          class: "skeleton"
        })], 64))]), ((g = (y = l.inputState) == null ? void 0 : y.error) == null ? void 0 : g.type) === ("MEMEPAD_TRADE_ERRORS" in l ? l.MEMEPAD_TRADE_ERRORS : m(al)).NOT_ENOUGH_TOKEN ? (_(), W(d, {
          key: 0,
          "jetton-shortname": l.jetton.shortname,
          "jetton-address": l.jetton.address,
          details: l.inputState.error.details,
          "input-value": l.tab === m(tt).BUY ? m(i).toNumber() : void 0,
          ...
          source: l.tab === m(tt).BUY ? ("ANALYTICS_MEMEPAD_OPERATION_SOURCE" in l ? l.ANALYTICS_MEMEPAD_OPERATION_SOURCE : m(fe)).BUY : ("ANALYTICS_MEMEPAD_OPERATION_SOURCE" in l ? l.ANALYTICS_MEMEPAD_OPERATION_SOURCE : m(fe)).SELL,
          onOpenPaymentSheet: a[0] || (a[0] = I => l.$emit("open-payment-sheet"))
        }, null, 8, ["jetton-shortname", "jetton-address", "details", "input-value", "value-balance", "need-more-value", "source"])) : (_(), T("div", {
          key: 1,
          onPointerdown: a[3] || (a[3] = () => m(r) && e())
        }, [l.tab === m(tt).BUY ? (_(), W(f, {
          key: 0,
          fill: "",
          size: m(Xt).LARGE,
          type: m(Rt).HIGHLIGHT,
          ...
          default: Z(() => [S("div", Vp, A(("t" in l ? l.t : m(O))("memepad.jetton.buy_button_label", {
            ticker: l.jetton.ticker
          })), 1)]),
          _: 1
        }, 8, ["size", "type", "loading", "disabled"])) : ht("", !0), l.tab === m(tt).SELL ? (_(), W(f, {
          key: 1,
          fill: "",
          size: m(Xt).LARGE,
          type: m(Rt).PINK,
          loading: m(o),
          disabled: m(r),
          onClick: a[2] || (a[2] = I => l.$emit("trade"))
        }, {
          default: Z(() => [S("div", Wp, A(("t" in l ? l.t : m(O))("memepad.jetton.sell_button_label", {
            ticker: l.jetton.ticker
          })), 1)]),
          _: 1
    ...
    setup(s) {
      const t = s,
        ...
        i = j(() => {
          ...
          return t.tab === tt.BUY ? [n(1), n(5), n(10), o(100, r)] : [o(25, l == null ? void 0 : l.mul(.25)), o(50, l == null ? void 0 : l.mul(.5)), o(75, l == null ? void 0 : l.mul(.75)), o(100, l)]
        });
      return (n, o) => (_(), T("div", Fp, [(_(!0), T(ut, null, de(m(i), r => (_(), T("button", {
        key: r.label,
        type: "button",
        class: "item reset",
  ...
  Zp = nt({
    ...
    setup(s, {
      ...
      const e = s,
        ...
        f = j(() => Yr(e.jetton.networkType)),
        {
          state: p,
          updateInputState: v
        } = D(),
        {
          useWalletOperationsErrorsStack: b,
          getTokenUsdValue: y
        } = Es(),
        g = U(),
        x = () => {
      ...
      const I = j(() => {
          if (!(!p.value || p.value.loading)) {
            if (h.value.isZero()) return n.value === tt.BUY ? `0 ${e.jetton.ticker}` : "0 TON";
            if (!p.value.feesInfo || !p.value.ready) return "";
            if (n.value === tt.SELL) {
              const C = p.value.tradeInfo.maxReceive,
                B = `${qs(C)} TON`,
                K = y({
        ...
        N = j(() => {
          ...
          if (!C) return;
          const B = e.jettonSdk.getMaxBuyAmount({
            tokenBalance: C
          });
          return ni(B, "TON")
        });
      ...
      he(() => [a.value, e.balances], () => v(), {
        deep: !0
      });
      const z = Qs(C => Bt().memepad.memepadJettonTradeInputUpdate(C), 300).debouncedFunction;
      he(h, C => z({
        value: C.toNumber(),
        type: n.value
      })), We(() => {
      ...
      function D() {
        const C = j(() => e.jettonSdk.tradeStateControls.getImmediateState({
          ...
          B = it(e.jettonSdk.tradeStateControls.getEmptyState({
            operation: n.value
          })),
          K = j(() => C.value || B.value);
        ...
        const F = () => {
          ...
          },
          {
            ...
            const {
              signal: ot
            } = X, at = await e.jettonSdk.tradeStateControls.getState({
              operation: n.value,
              amount: h.value
            });
            ot.aborted || (B.value = at)
          }, 600);
        return {
          state: K,
          updateInputState: () => {
      ...
      function U() {
        const C = Bt(),
          {
            addErrorToStackAndCheck: B
          } = b();
        return async () => {
          if (!p.value || !p.value.ready) return;
          const K = n.value,
            X = new ci(h.value),
            F = p.value.tradeInfo,
            J = e.jetton.ticker,
            Y = e.jetton.id,
            ot = e.jetton.address,
            at = e.jetton.shortname;
          await (async () => {
            o.value[K] = !0;
            const H = () => {
                const G = ni(K === tt.BUY ? F.minReceive : X, J),
                  gt = ni(K === tt.BUY ? X : F.minReceive, "TON"),
                  $r = K === tt.BUY ? O("memepad.jetton.buy.failed_alert", {
                    askLabel: G.frontendWithSymbol,
                    offerLabel: gt.frontendWithSymbol
              ...
              Q = await (K === tt.BUY ? e.jettonSdk.buyJetton({
                tons: X,
                tradeInfoParams: F
            ...
            if (Q.err) {
              Gr().error("Memepad jetton trade error", Q.extra), o.value[K] = !1, H(), B({
                value: X.toFixed(),
                operation: K
              }, {
                source: K === tt.BUY ? fe.BUY : fe.SELL
              });
              return
            }
            i("trade"), L = K === tt.BUY ? e.jettonSdk.getWaitForBuyStatus() : e.jettonSdk.getWaitForSellStatus(), await co(5e3);
            const pt = await L.exec({
                transactionHash: Q.data
              }),
              E = pt ? "success" : "failed";
            if (K === tt.BUY ? C.memepad.memepadJettonBuy({
                status: E,
                jettonId: Y,
                jettonShortname: at,
                jettonAddress: ot,
                purchaseAmount: X.toNumber()
              }) : C.memepad.memepadJettonSell({
                status: E,
                jettonId: Y,
                jettonShortname: at,
                jettonAddress: ot,
                purchaseAmount: F.maxReceive.toNumber()
              }), !pt) {
              o.value[K] = !1, H();
              return
            }
            const V = K === tt.BUY ? O("memepad.jetton.buy.success_alert", {
              ticker: J,
              label: `${qs(X)} TON`
            }) : O("memepad.jetton.sell.success_alert", {
              label: `${Wt(X).full} ${J}`
            });
            ai().success(V), o.value[K] = !1, e.tradeSuccessCallback()
          })()
        }
      }
      return (C, B) => {
        ...
        return _(), W(pt, {
          ...
          inner: Z(() => [S("div", Xp, [(_(), W(F, {
            ref_key: "actionControlsInputComp",
            ref: r,
            key: n.value,
            modelValue: m(c),
            "onUpdate:modelValue": B[1] || (B[1] = E => yt(c) ? c.value = E : null),
            postfix: n.value === "buy" ? "TON" : C.jetton.ticker,
            modifier: k,
            centered: "",
            onBlur: x
          }, null, 8, ["modelValue", "postfix"])), S("div", Jp, [m(I) ? (_(), T("span", Yp, A(m(I)), 1)) : m(I) === void 0 ? (_(), W(J, {
            key: 1,
            class: "skeleton"
          })) : ht("", !0)]), S("button", {
            type: "button",
            ...
            onClick: P
          }, [S("span", Gp, A(`${("t"in C?C.t:m(O))("memepad.jetton.slippage_btn")} ${m(l)}%`), 1), R(Y, {
          ...
          "bottom-action": Z(() => [R(H, {
            ...
            default: Z(() => [C.unlockEnabled ? (_(), W(ot, {
              key: 0,
              jetton: C.jetton,
              "jetton-information": C.jettonInformation,
              "jetton-sdk": C.jettonSdk,
              balances: C.balances,
              onUnlocked: B[2] || (B[2] = E => C.$emit("unlock-success"))
            }, null, 8, ["jetton", "jetton-information", "jetton-sdk", "balances"])) : (_(), W(at, {
              key: 1,
              value: m(a),
              tab: n.value,
              jetton: C.jetton,
              ...
              "input-state": m(p),
              onTrade: m(g),
              onOpenPaymentSheet: d
            }, null, 8, ["value", "tab", "jetton", "trade-pendings", "balances", "input-state", "onTrade"]))]),
            _: 1
          }, 8, ["force-loading"])]),
          "bottom-helpers": Z(() => [R(Q, {
            modelValue: m(u),
            "onUpdate:modelValue": B[3] || (B[3] = E => yt(u) ? u.value = E : null),
            tab: n.value,
            balances: C.balances,
            "token-balance": m(N),
  ...
  om = nt({
    ...
    setup(s, {
      ...
      const e = s,
        ...
        r = it(e.jettonSdk.getSlippage().toString()),
        l = j(() => Cs(r.value)),
        a = j(() => l.value.lt(sm) ? O("memepad.jetton.slippage.error_message.too_low") : l.value.gt(nm) ? O("memepad.jetton.slippage.error_message.too_high") : ""),
        h = () => {
          if (a.value) return;
      ...
      return bo().initHandler(() => {
        ...
        return _(), W(v, {
          ...
          "top-center": Z(() => [S("div", Qp, A(("t" in c ? c.t : m(O))("memepad.jetton.slippage.title")), 1)]),
          inner: Z(() => [S("div", tm, [R(d, {
            ref_key: "actionControlsInputComp",
            ref: n,
            modelValue: m(r),
            "onUpdate:modelValue": u[0] || (u[0] = b => yt(r) ? r.value = b : null),
            postfix: "%",
          ...
          "bottom-action": Z(() => [S("div", em, [m(a) ? (_(), W(f, {
            key: 0,
            "error-message": m(a)
          }, null, 8, ["error-message"])) : (_(), T("div", im, A(("t" in c ? c.t : m(O))("memepad.jetton.slippage.text")), 1)), R(p, {
  ...
  cm = nt({
    ...
    setup(s, {
      ...
      return (r, l) => {
        const a = te;
        return _(), T("div", lm, [R(a, {
          class: "buy-button",
          type: m(Rt).HIGHLIGHT,
          loading: r.tradePendings[m(tt).BUY],
          onClick: n
        }, {
          default: Z(() => [S("span", am, A(("t" in r ? r.t : m(O))("memepad.jetton.buy_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"]), R(a, {
          class: "sell-button",
          type: m(Rt).PINK,
          loading: r.tradePendings[m(tt).SELL],
          onClick: o
        }, {
          default: Z(() => [S("span", hm, A(("t" in r ? r.t : m(O))("memepad.jetton.sell_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"])])
      }
    }
    ...
    setup(s, {
      ...
      return (c, u) => {
        const d = Ip,
          ...
          v = um,
          b = xs;
        return _(), T("div", dm, [R(b, {
          "force-loading": c.unlockEnabled === void 0 && c.isReleased,
          "button-size": m(Xt).MEDIUM
        }, {
          default: Z(() => [c.unlockEnabled ? (_(), W(d, {
            key: 0,
            jetton: c.jetton,
            "jetton-information": c.jettonInformation,
            "jetton-sdk": c.jettonSdk,
            ...
            balances: c.balances
          }, null, 8, ["jetton", "jetton-information", "jetton-sdk", "balances"])) : (_(), T(ut, {
            key: 1
          }, [m(o) === "trade" ? (_(), W(f, {
            key: 0,
            modelValue: m(i),
            "onUpdate:modelValue": u[0] || (u[0] = y => yt(i) ? i.value = y : null),
            "trade-pendings": m(n),
            "onUpdate:tradePendings": u[1] || (u[1] = y => yt(n) ? n.value = y : null),
            jetton: c.jetton,
            "jetton-information": c.jettonInformation,
          ...
          }, null, 8, ["modelValue", "trade-pendings", "jetton", "jetton-information", "jetton-bcl-data", "balances", "is-released", "unlock-enabled", "jetton-sdk"])) : ht("", !0), m(o) === "slippage" ? (_(), W(p, {
            key: 1,
            "jetton-sdk": c.jettonSdk,
    ...
    setup(s) {
      ...
      return (n, o) => {
        ...
        return _(), T("div", mm, [R(r, {
          ...
          jetton: n.jetton,
          "jetton-information": n.jettonInformation
        }, null, 8, ["jetton", "jetton-information"]), R(a, qr(Qr(m(i))), null, 16), R(h, {
  ...
  Am = nt({
    ...
    setup(s) {
      const t = tl(),
        ...
        o = j(() => el.Address.parse(e.value.address).equals(e.value.masterContractAddress)),
        r = j(() => {
          var L;
          return (L = il().getters.getUser.value) == null ? void 0 : L.referrerToken
        }),
        {
          addresses: l,
      ...
      function N() {
        ...
        function K() {
          const Y = () => !x.value || h.value.status !== "connected" ? ie() : Mt({
            jettonSdk: x.value
          });
          os(Y, () => {
            D = Ri(async () => {
              const H = Y();
              if (!bt(H)) return ie();
              const Q = await H.data.jettonSdk.getUserJettonBalance();
              return Mt((bt(Q) ? Q.data : L.value) || L.value)
            }, H => L.value = H, B.BALANCE_UPDATE), D.exec()
          });
          const ot = () => !x.value || !n.value || h.value.status !== "connected" || !L.value || !n.value.isReleased ? ie() : Mt({
            jettonSdk: x.value,
            balance: L.value,
          ...
          os(ot, () => {
            U = Ri(async () => {
              ...
              if (P.value === !1) return Mt(!1);
              const H = ot();
              if (!bt(H)) return ie();
              const Q = await H.data.jettonSdk.getUnlockEnabled();
              return Mt(bt(Q) ? Q.data : P.value)
            }, H => P.value = H, B.UNLOCK_ENABLED_UPDATE), U == null || U.exec()
          });
          const at = () => !n.value || h.value.status !== "connected" ? ie() : Mt({
          ...
          os(at, () => {
            C = Ri(async () => {
              const H = at();
              if (!bt(H)) return ie();
              const Q = await hi.getMemepadJettonPnl(H.data.jettonShortname, H.data.walletAddress);
              return Mt((bt(Q) ? Q.data : z.value) || z.value)
            }, H => z.value = H, B.PNL_UPDATE), C == null || C.exec()
          })
        }
        return {
          init: K,
          destroy: () => {
            D == null || D.destroy(), U == null || U.destroy(), C == null || C.destroy(), L.value = void 0, P.value = void 0, z.value = void 0
          },
          update: () => {
            D == null || D.exec(), U == null || U.exec(), C == null || C.exec()
          },
          resetAndUpdateUnlocked: () => {
            P.value = void 0, U == null || U.exec()
          },
          jettonBalance: j(() => L.value),
      ...
      return (L, P) => {
        const z = nl,
          D = jl,
          U = gm;
        return !m(n) || !m(l) || !m(x) || m(n).status === m(tn).IN_PROGRESS ? (_(), W(z, {
          key: 0
        })) : m(n).status === m(tn).LISTED_TO_DEX ? (_(), W(D, {
          key: 1,
          jetton: m(e),
          ...
          "jetton-sdk": m(x),
          balances: m(g)
        }, null, 8, ["jetton", "jetton-information", "unlock-enabled", "jetton-sdk", "balances"])) : (_(), W(U, {
          key: 2,
          jetton: m(e),
          "jetton-information": m(n),
          "jetton-pnl": m(d),
          ...
          onTradeSuccess: b,
          onUnlockSuccess: y,
          onShare: P[0] || (P[0] = C => L.$emit("share", "trade")),
          onCopy: P[1] || (P[1] = C => L.$emit("copy", "trade"))
