...
const st = e => {
    ...
    setup(e) {
      ...
      return (c, o) => {
        ...
        return a(), r("div", le, [_("div", {
          ...
          modelValue: s(t),
          "onUpdate:modelValue": o[0] || (o[0] = p => G(t) ? t.value = p : null),
          address: e.address
  ...
  ue = f({
    ...
    setup(e) {
      return (n, t) => {
        const c = A;
        return a(), r("div", re, [(a(!0), r(N, null, W(e.items, o => (a(), r("div", {
          key: o.text,
          class: S(["item", {
            "is-active": o.active
          }])
  ...
  ke = f({
    ...
    setup(e) {
      ...
      return (t, c) => {
        const o = Z,
          l = R;
        return a(), r("div", we, [_("div", be, [u(o), _("div", {
          class: "title",
...
const Ue = h(Ee, [
    ...
    setup(e) {
      ...
      return (c, o) => {
        ...
        return s(t) ? (a(), r("div", {
          ...
          name: s(t).icon,
          class: "icon"
        }, null, 8, ["name"]), _("div", De, v(s(t).label), 1)], 2)) : g("", !0)
      }
    }
  }),
  Be = h(Le, [
    ...
    setup(e) {
      ...
      return (l, p) => {
        ...
        return a(), r("div", Re, [u(m, {
          ...
          key: 0
        }, [s(o).type === "text" ? (a(), r("div", Ye, v(s(o).text), 1)) : s(o).type === "status" ? (a(), d(b, {
          key: 1,
          status: s(o).status,
          class: "status"
  ...
  Qe = f({
    ...
    setup(e) {
      return (n, t) => {
        const c = Fe;
        return a(), r("div", qe, [(a(!0), r(N, null, W(e.history, (o, l) => (a(), r(N, {
          key: l
    ...
    setup(e) {
      ...
      return (c, o) => {
        ...
        return a(), r("div", Je, [_("div", {
          ...
          modelValue: s(n),
          "onUpdate:modelValue": o[1] || (o[1] = m => G(n) ? n.value = m : null),
          title: e.title,
          banner: e.banner
        }, {
...
const an = h(sn, [
  ...
  In = f({
    ...
    setup(e, {
      ...
      return (m, b) => {
        const I = Et;
        return a(), r("div", fn, [(a(!0), r(N, null, W(s(p), ($, L) => (a(), r("button", {
          key: L,
          ...
          alt: `${$.label} icon`
        }, null, 8, gn))]), _("div", kn, v($.label), 1)], 10, wn))), 128))])
      }
    }
  }),
  $n = h(In, [
  ...
  Cn = f({
    ...
    setup(e) {
      ...
      return (c, o) => {
        const l = Rt;
        return a(), r("div", Un, [(a(!0), r(N, null, W(s(t), p => (a(), d(l, Ct({
          key: p.id,
          ref_for: !0
        }, p), null, 16))), 128))])
      }
...
const Gn = f({
    ...
    setup(e) {
      ...
      return j(p, () => Wt().meta.key = p.value), (m, b) => {
        const I = ht,
          $ = Gt,
          L = Jt,
          M = fe,
          ...
          pt = Dn,
          mt = Qn;
        return a(), r("div", zn, [s(t).wallet.value.status === "loading" || !s(c).availableInfo.value ? (a(), d(I, {
          key: 0
          ...
          notification: s(t).walletNotification.value,
          "onShow:points": b[0] || (b[0] = yt => l.value = "points"),
          "onShow:tokensHistory": b[1] || (b[1] = yt => l.value = "tokens_history")
