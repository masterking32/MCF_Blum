...
const Lt = {
  ...
  Wt = j({
    ...
    setup(p, {
      ...
      const {
        $webApp: r
      } = ye(), n = p, o = t, l = Pe(p, "modelValue"), m = A(!n.dontShowStorageKey), d = A(!1), s = I({
        get: () => l.value && m.value,
        set: k => {
          l.value = k, d.value && n.dontShowStorageKey && r.storage.local.set(n.dontShowStorageKey, "true")
        }
      });
      (() => {
      ...
      return (k, E) => {
        ...
        return i(), L(f, {
          ...
          default: K(() => [a("div", jt, [g(R, {
            ...
            name: "arrow-right",
            class: "icon"
          })]))]), a("div", Vt, [k.dontShowStorageKey ? (i(), _("div", xt, [a("div", Gt, [g(y, {
            modelValue: e(d),
  ...
  Yt = j({
    ...
    setup(p, {
      ...
      const {
        $webApp: r
      } = ye(), n = t, o = A(!1), l = A(r.storage.local.get($e) ? "watched" : "unwatched"), m = () => {
  ...
  ns = j({
    ...
    setup(p) {
      ...
      return (l, m) => {
        ...
        return i(), L(C, {
          to: e(n),
          class: ee(["memepad-explore-event", `is-${l.event.type.toLowerCase()}`])
        }, {
          default: K(() => [l.event.user.avatarUrl ? (i(), _("img", {
            ...
            name: "space-invader",
            class: "icon"
          })])), a("div", zt, [l.event.user.nickname ? (i(), _("span", qt, h(l.event.user.nickname), 1)) : (i(), _("span", Zt, h(("sliceWalletAddress" in l ? l.sliceWalletAddress : e(et))(l.event.user.address)), 1)), a("span", Qt, h(e(r)), 1), l.event.amount ? (i(), L(s, {
            key: 2,
            keypath: "memepad.explore.event.amount_of",
            tag: "div",
            class: "amount-of"
          }, {
            amount: K(() => [a("span", es, h(`${("formatTon"in l?l.formatTon:e(tt))(l.event.amount)} TON`), 1)]),
            _: 1
          })) : P("", !0)]), g(u, {
            src: e(Ie)(l.event.iconFileKey),
            size: 16,
            class: "jetton-image"
          }, null, 8, ["src"]), a("span", ts, h(l.event.ticker), 1), a("span", ss, h(e(o)), 1)]),
          _: 1
        }, 8, ["to", "class"])
      }
    }
    ...
    setup(p) {
      return (t, r) => {
        ...
        return i(), _("div", {
          ...
          default: K(() => {
            var l;
            return [((l = t.moveDirection) == null ? void 0 : l.direction) === "up" ? (i(), _("div", Es, [g(n, {
          ...
          default: K(() => {
            var l;
            return [((l = t.moveDirection) == null ? void 0 : l.direction) === "down" ? (i(), _("div", Ss, [g(n, {
              name: "memepad/direction-arrows",
              class: "icon"
            }), g(n, {
              name: "memepad/direction-arrows",
        ...
        const D = A(),
          ...
          V = ue(async () => await t.getReactions(s.value.shortname), le => {
            ...
            const {
              user: Dn,
              ...Ve
            } = D.value, Se = Object.entries(Ve).reduce((x, [F, _e]) => {
              const Fe = Be[F],
                Ye = _e,
            ...
            }, {}), xe = 5e3 / Object.values(Se).reduce((x, F) => x + F, 0), Ge = f, We = x => ({
              id: nt(),
              image: ot(x),
              position: {
                x: he(0, 20) - 10,
            ...
            Object.entries(Se).reduce((x, [F, _e]) => x.concat(Array(_e).fill(F)), []).sort(() => Math.random() - .5).forEach((x, F) => {
              T.push(setTimeout(() => {
                Ge === f && w.value.push(We(x))
              }, xe * F))
            })
          }, 5e3),
          N = async () => {
  ...
  on = j({
    ...
    setup(p) {
      const t = p,
        ...
        l = I(() => Oe(t.jetton.releaseTimestamp).label),
      ...
      return (u, C) => {
        ...
        return i(), L(k, {
          ...
          default: K(() => {
            ...
            return [g(b, {
            ...
            }, null, 8, ["image", "collected-percent", "is-released", "stream-online"]), a("div", Vs, [a("div", xs, h(u.jetton.ticker), 1), u.mode === e(X).BASE ? (i(), _("div", Gs, [u.jetton.stats.holdersCount !== void 0 ? (i(), _("div", Ws, [g(O, {
              name: "personal",
              class: "icon"
              ...
              class: "icon"
            }), a("span", tn, h(e(l)), 1)])])) : u.mode === e(X).MY_TOKENS ? (i(), _("div", sn, [a("div", nn, h(e(d)), 1), a("div", {
  ...
  hn = j({
    ...
    setup(p) {
      const t = Pe(p, "modelValue"),
        ...
        m = I(() => t.value === c.MY_TOKENS ? X.MY_TOKENS : X.BASE);
      return (d, s) => {
        const u = Q,
          C = gt,
          b = Ne,
        ...
        return i(), _("div", cn, [a("div", rn, [g(C, {
          ...
          _: 1
        }, 8, ["modelValue", "items"])]), (e(r).wallet.value.status === "must_reconnect" || e(r).wallet.value.status === "not_found") && t.value === e(c).MY_TOKENS ? (i(), _("div", un, [a("div", mn, h(("t" in d ? d.t : e($))("memepad.explore.my_tokens.connect_text")), 1), a("button", {
          type: "button",
          class: "reset",
          onClick: s[2] || (s[2] = R => e(n).runConnectionFlow())
        }, h(("t" in d ? d.t : e($))("wallet.connect.btn")), 1)])) : e(r).wallet.value.status === "loading" && t.value === e(c).MY_TOKENS ? (i(), _("div", pn, [g(b, {
          type: e(we).LIGHT
          ...
          default: K(() => [d.items.length ? (i(), L(O, {
            ...
            mode: e(m)
          }, null, 8, ["items", "analytics-source", "mode"])) : t.value === e(c).MY_TOKENS ? (i(), _("div", _n, [g(u, {
    ...
    setup(p, {
      ...
      return oe(m, u), ie().memepad.memepadSearchOpen(), ct().initHandler(() => r("close"), "memepad-search"), (b, O) => {
        ...
        return i(), _("div", fn, [g(k, {
          ...
          class: "events",
          "analytics-source": ("ANALYTICS_MEMEPAD_JETTONPAGE_SOURCE" in b ? b.ANALYTICS_MEMEPAD_JETTONPAGE_SOURCE : e(G)).SEARCH
  ...
  Ke = (p, t, r) => {
    const n = Math.max(0, p.length - 1),
      ...
      d = I(() => {
        const E = Math.max(0, l.value - r + 1),
          R = Math.min(l.value + 1, o.value.length);
        return [...o.value].slice(E, R).reverse()
      }),
      s = I(() => [...o.value].reverse()[l.value]);
    let u;
    return {
      init: () => {
      ...
      destroy: () => {
        o.value = [], l.value = 0, clearInterval(u)
      },
      addItems: E => {
        o.value.push(...[...E].reverse())
      },
      setItems: E => {
        o.value = E, l.value = E.length - 1
      },
      items: I(() => o.value),
      appearedItems: d,
  ...
  Sn = () => {
    ...
    const o = {
        ...
        [c.LIVE]: "list",
        [c.HOT]: "list",
        [c.BLUMING]: "pagination-list",
        [c.DEX]: "pagination-list",
        [c.MCAP]: "pagination-list",
        [c.MY_TOKENS]: "list",
        [c.LISTINGS]: "pagination-list"
      },
      l = async ({
        type: S,
        pageToken: y
        ...
        const v = {
            [c.NEW]: J.CREATED_AT,
            [c.HOT]: J.HOT,
            [c.LIVE]: J.LIVE_STREAMS,
            [c.BLUMING]: J.NEAREST_TO_LISTING,
            [c.MCAP]: J.MARKET_CAP,
            [c.DEX]: J.PUBLISHED_AT,
            [c.LISTINGS]: J.IS_LISTED_ON_BLUM
          },
          f = {
            [c.NEW]: H.EXCLUDE,
            [c.HOT]: H.INCLUDE,
            [c.LIVE]: H.INCLUDE,
            [c.BLUMING]: H.INCLUDE_LISTED,
            [c.MCAP]: H.INCLUDE,
            [c.DEX]: H.ONLY,
            [c.LISTINGS]: H.INCLUDE
          },
          T = v[S],
          M = f[S];
        return await te.getMemepadJettonsSection(T, M, y)
      }, m = ce(() => c.NEW, "$SbGDXlzgsy"), d = () => {
        const S = m.value;
        switch (o[S]) {
          case "step-list":
            return {
              type: "step-list", stepList: void 0, interval: ue(async () => await l({
                type: S
              }), v => {
                var T;
          ...
          case "list":
            return {
              type: "list", data: void 0, interval: ue(async () => await l({
                type: S
              }), v => {
                var f;
  ...
  Pn = j({
    ...
    setup(p) {
      ...
      return ie().memepad.memepadExploreOpen(), (l, m) => {
        const d = He,
          s = Nt,
          u = wn;
