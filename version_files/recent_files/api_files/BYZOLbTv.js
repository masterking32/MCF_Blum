...
(function(s, l) {
  ...
  function V(e, t) {
    if ((0, g.default)(e), t = (0, n.default)(t, i), t.require_display_name || t.allow_display_name) {
      ...
      if (d) {
        var m = d[1];
        if (e = e.replace(m, "").replace(/(^<|>$)/g, ""), m.endsWith(" ") && (m = m.slice(0, -1)), !E(m)) return !1
    ...
    if (!(0, u.default)($, {
      ...
      if (!(0, o.default)($)) {
        ...
        var P = $.slice(1, -1);
        if (P.length === 0 || !(0, o.default)(P)) return !1
      }
    }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function V(e, t) {
    ...
    return t.host_whitelist ? E(F, t.host_whitelist) : F === "" && !t.require_host ? !0 : !(!(0, u.default)(F) && !(0, _.default)(F, t) && (!R || !(0, u.default)(R, 6)) || (F = F || R, t.host_blacklist && E(F, t.host_blacklist)))
  }
  s.exports = l.default, s.exports.default = l.default
})(Z, Z.exports);
var Re = Z.exports;
...
const Ie = {
  ...
  Ue = J({
    ...
    setup(s) {
      ...
      return (r, i) => (S(), q("div", Ie, [k(g) ? (S(), q("div", Te, [T(r.$slots, "header", {}, void 0, !0)])) : A("", !0), k(_) ? (S(), q("div", Le, [T(r.$slots, "title", {}, void 0, !0)])) : A("", !0), k(u) ? (S(), q("div", Pe, [T(r.$slots, "subTitle", {}, void 0, !0)])) : A("", !0), k(o) ? (S(), q("div", Me, [T(r.$slots, "footer", {}, void 0, !0)])) : A("", !0)]))
    }
  }),
  je = Y(Ue, [
  ...
  ze = J({
    ...
    setup(s, {
      ...
      return se(o, () => {
        ...
        }, null, 8, ["title", "is-optional"]), f.errorCaption ? (S(), q("div", Oe, [y[3] || (y[3] = B("img", {
          src: de,
          alt: "Warning icon"
        }, null, -1)), B("div", null, _e(f.errorCaption), 1)])) : f.maxLength ? (S(), N(E, {
          key: 1,
          value: o.value,
...
var D = (s => (s.STRING = "STRING", s.TEXTAREA = "TEXTAREA", s))(D || {});
const Ke = J({
    __name: "KitForm",
    props: {
      modelValue: {
    ...
    setup(s, {
      ...
      const o = () => {},
        ...
        r = I(() => _.value.every(a => i(a).length === 0));
      ...
      const i = a => {
          ...
          switch (a.type) {
            ...
            case D.TEXTAREA: {
              ...
              if (a.type === D.STRING && ((c = a.validators) != null && c.url)) {
              ...
              a.type === D.STRING && ((V = a.validators) != null && V.email) && (Ae(a.value) || b.push({
      ...
      return re(() => g("channel", {
        ...
        }, [(S(!0), q(xe, null, ye(_.value, c => {
          var E, V, e, t, d, m, F, $;
          return S(), q("div", {
            key: c.key,
            class: "field"
          }, [c.type === k(D).STRING ? (S(), N(f, ae({
            key: 0,
            modelValue: c.value,
            ...
            "error-caption": x(c),
            "is-error": v(c),
            "max-length": (V = (E = c.validators) == null ? void 0 : E.maxLength) == null ? void 0 : V.value,
            class: "input",
            onChange: w => n(c),
            ...
            _: 2
          }, 1040, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur"])) : A("", !0), c.type === k(D).TEXTAREA ? (S(), N(y, ae({
            key: 1,
            modelValue: c.value,
            "onUpdate:modelValue": w => c.value = w,
            ref_for: !0
...
export {
  D as F, je as _, Ae as a, Ge as b, Ze as c, De as i
};