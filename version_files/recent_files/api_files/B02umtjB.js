    ...
    setup(p, {
      ...
      const b = R(!1),
        $ = C(() => {
          var v;
          return {
            jettonBalance: te(new W(0), t.state.step1.ticker),
        ...
        g = C(() => {
          ...
          if (!n.value.overview) {
            if (new W(n.value.share).isZero()) {
              const x = te(new W(0), t.state.step1.ticker);
          ...
          const v = te(new W(n.value.overview.minReceive), t.state.step1.ticker);
