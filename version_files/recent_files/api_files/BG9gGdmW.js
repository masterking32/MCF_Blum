    ...
    setup(n, {
      ...
      return ke(() => {
        ...
        return M(), P("div", Yn, [k("div", Zn, [v(i).balanceLabel ? (M(), I(f, {
          ...
          key: 3,
          class: "skeleton"
        }))]), (j = v(i).error) != null && j.notEnoughtTon ? (M(), I(_, {
          key: 0,
          ...
          default: q(() => [k("div", Gn, J(("t" in d ? d.t : v(V))("memepad.jetton.unlock_btn", {
    ...
    setup(n) {
      ...
      return (i, s) => {
        ...
        return M(), P("div", Qn, [E(o), k("div", to, [k("div", eo, [E(h, {
          ...
          size: 80
        }, null, 8, ["src"])]), k("div", io, J(("t" in i ? i.t : v(V))("memepad.moving_to_dex.title")), 1), k("div", so, J(("t" in i ? i.t : v(V))("memepad.moving_to_dex.subtitle", {
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return M(), P("div", ro, [k("div", lo, [E(h, {
          ...
          jetton: s.jetton
        }, null, 8, ["jetton-modal-controls", "jetton"]), k("div", ao, [k("div", co, [k("div", uo, J(s.jetton.ticker), 1), (l = s.jettonInformation) != null && l.inSpotlight ? (M(), P("div", fo, [E(r, {
          name: "fire",
          class: "icon"
        }), o[1] || (o[1] = k("span", {
          class: "label"
        }, "Spotlight", -1))])) : St("", !0)]), k("div", mo, J(v(e)), 1)])]), k("div", po, [k("button", {
          type: "button",
          class: "reset copy",
          onClick: i
        }, [E(r, {
          name: "edit-copy",
          class: "icon"
        }), k("span", vo, J(("sliceWalletAddress" in s ? s.sliceWalletAddress : v(vn))(s.jetton.address, 3)), 1)]), k("button", {
          type: "button",
          class: "reset share",
...
class Ii {
  ...
  Gt(t, e, i, s) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, p = e.L + this.Xt.wi, f = e.B + this.Xt.gi, m = e.A, g = e.I, _ = this.zt.Kt, S = e.P, z = i.Mi(h, _), j = Math.ceil(i.xi(h, _)), A = S + p + f, O = e.C + m + g + j + u, y = Math.max(1, Math.floor(c));
    let C = Math.round(A * c);
    C % 2 != y % 2 && (C += 1);
    const w = d > 0 ? Math.max(1, Math.floor(d * a)) : 0,
      U = Math.round(O * a),
      T = Math.round(u * a),
      K = (o = this.Xt.Si) !== null && o !== void 0 ? o : this.Xt.ki,
      tt = Math.round(K * c) - Math.floor(.5 * c),
  ...
  X(t, e) {
    ...
    t.useBitmapCoordinateSpace(({
      ...
      const g = Math.round(a * p),
        ...
        z = Math.round(u * f),
        j = Math.round(2 * p);
      if (d.beginPath(), d.moveTo(g, _), d.lineTo(g, z - j), d.arcTo(g, z, g + j, z, j), d.lineTo(S - j, z), d.arcTo(S, z, S, z - j, j), d.lineTo(S, _), d.fill(), m.hi) {
    ...
    o !== void 0 && Fs(t, e, o, i, s, c, Qo), l && function(u, d, p, f, m) {
      ...
      for (let O = f.to - 1; O >= f.from; --O) {
        ...
        if (y) {
          ...
          const w = Math.round(y.nt * g) + j,
            U = y.st * _;
          S.moveTo(w, U), S.arc(w, U, A, 0, 2 * Math.PI)
        }
      }
      S.fill()
    }(t, e, l, i, c)
      ...
      if (o) {
        if (this.zt.fe) {
          ...
          let y = Math.max(m, Math.round(r.ve * i) - l),
            C = y + u - 1;
          C > m + _ - 1 && (C = m + _ - 1, y = C - u + 1), t.fillRect(O, y, c - O, C - y + 1)
        }
        const z = a + S;
        let j = Math.max(m, Math.round(r.pe * i) - l),
          A = j + u - 1;
        A > m + _ - 1 && (A = m + _ - 1, j = A - u + 1), t.fillRect(d + 1, j, z - d, A - j + 1)
      }
    }
  }
  oe(t) {
...
class lh extends ft {
  ...
  Be(t, e, i) {
    ...
    for (let u = i.from; u < i.to; u++) {
      ...
      const z = S - _ + 1;
      s.fillRect(_, m, z, p - m), s.fillRect(_, f + 1, z, g - f), c = S
    }
  }
  Ie(t) {
...
class yh {
  constructor(t) {
    this.Wt = new _h, this.ft = !0, this.Er = !0, this.Nr = performance.now(), this.Fr = this.Nr - 1, this.Wr = t
  }
  jr() {
...
class Ih {
  ...
  ol(t, e, i) {
    ...
    const o = b(this.sl()),
      ...
      l = Math.min(e, h),
      a = Math.ceil(r / wt) * wt,
      c = Math.max(a, Math.floor(l / wt) * wt);
    {
      const d = this.dl(r),
    ...
    for (let d = Math.max(a + 1, r); d < c; d += wt) {
...
class Xi {
  ...
  Qa() {
    ...
    for (let g = a - d; g > c; g -= u) {
      ...
      f !== null && Math.abs(_ - f) < this.Ja() || _ < r || _ > l || (m < this.Xa.length ? (this.Xa[m].La = _, this.Xa[m].no = t.so(g)) : this.Xa.push({
        La: _,
        no: t.so(g)
      }), m++, f = _, t.eo() && (u = this.Za(g * p, c)))
    }
    this.Xa.length = m
  }
  ja() {
  ...
  me(t, e, i) {
    ...
    for (let f = u; f < d; f++) {
      ...
      let g = m.we,
        ...
        S = m.Me,
        z = m.xe;
      p !== null && (g = p(m.we, e), _ = p(m.ge, e), S = p(m.Me, e), z = p(m.xe, e));
      let j = s + c * (g - h),
        A = a ? j : this.ro - 1 - j;
      m.ve = A, j = s + c * (_ - h), A = a ? j : this.ro - 1 - j, m.ce = A, j = s + c * (S - h), A = a ? j : this.ro - 1 - j, m.de = A, j = s + c * (z - h), A = a ? j : this.ro - 1 - j, m.pe = A
    }
  }
  pn(t, e) {
    const i = this.Co(t, e);
...
function Oe(n) {
  let t = n;
  if (se(n) && (t = _i(n)), !oi(t)) throw new Error("time must be of type BusinessDay");
...
class ls {
  ...
  convertHorzItemToInternal(t) {
    return on(e = t) ? hs(e) : oi(e) ? Oe(e) : Oe(_i(e));
    var e
  }
  updateFormatter(t) {
    if (!this.cn) return;
      ...
      const r = s.$o(),
        l = function(a, c, u) {
          ...
          for (const S of a) {
            ...
            for (const j of z) g = j.zOrder, (!(_ = f == null ? void 0 : f.zOrder) || g === "top" && _ !== "top" || g === "normal" && _ === "bottom") && (f = j, m = S)
          }
          var g, _;
          return f && m ? {
            Iv: f,
...
class wr {
  ...
  fp(t) {
    ...
    if (t !== 1) {
      ...
      const i = xt(this.Kv);
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s), this.Ae(s), this.Hm(i, _r)
...
class Mr {
  ...
  Tb() {
    ...
    for (let f = 0; f < this.Zm.length; ++f) {
      ...
      let g = 0,
        _ = 0;
      _ = f === this.Zm.length - 1 ? u - p : Math.round(m.g_() * d), g = Math.max(_, 2), p += g, m.up(D({
        width: h,
        height: g
    ...
    if (e.length !== 0) {
      ...
      h = e.map((p, f) => {
        const m = a(p.time),
          g = this.U_.key(m);
        let _ = this.Ub.get(g);
        _ === void 0 && (_ = bs(m), this.Ub.set(g, _), s = !0);
        const S = c(m, _.se, p, l[f], u, d);
...
const Yr = {
  ...
  ol = nt({
    ...
    setup(n) {
      const t = n,
        ...
        d = (f, m) => {
          var y, C;
          const g = (y = wn().$webApp.dataUnsafe.user) == null ? void 0 : y.language_code,
            _ = (C = i.value) == null ? void 0 : C.timeScale().getVisibleLogicalRange();
          s.value && i.value && i.value.removeSeries(s.value), m.innerHTML = "";
          const z = Hr(m, {
            localization: {
              timeFormatter: w => {
                const U = K => String(K).padStart(2, "0"),
                  T = new Date(w * 1e3);
                return `${U(T.getUTCHours())}:${U(T.getUTCMinutes())}`
              },
              priceFormatter: w => {
                if (a.value === Jt.MARKET_CAP) return `$${we(w,{accuracy:0})}`;
                {
                  if (Math.abs(w) < 1e-9) return "$0";
                  const [U, T] = w.toFixed(9).split("."), K = T[0], $ = T.slice(1).match(/^0+/), x = $ ? $[0].length : 0, W = x > 0 ? String.fromCharCode(8321 + x) : "", F = T.slice(x + 1).replace(/0+$/, "").slice(0, 3);
                  return `$${U}.${K}${W}${F}`
                }
              },
              locale: g
          ...
          const j = z.addLineSeries({
            ...
            A = f.map(w => {
              const U = new Date(w.timestamp);
              return {
                time: (U.getTime() - U.getTimezoneOffset() * 60 * 1e3) / 1e3,
                value: w.price.toNumber()
              }
            }).sort((w, U) => w.time - U.time);
          j.setData(A);
          const O = o.value === t.chartInterval;
          _ && O ? z.timeScale().setVisibleLogicalRange(_) : z.timeScale().fitContent(), o.value = t.chartInterval
        },
        p = L(() => {
          var g;
      ...
      return Mt(() => ({
        ...
        "onUpdate:modelValue": m[0] || (m[0] = _ => bt(a) ? a.value = _ : null),
        type: "radio",
        name: "chart-type",
        value: g.value
      }, null, 8, Gr), [
        [qe, v(a)]
      ]), k("span", qr, J(g.label), 1)], 2))), 128))], 4), k("div", {
        class: "section",
        style: ji({
        ...
        "onUpdate:modelValue": m[1] || (m[1] = _ => bt(l) ? l.value = _ : null),
        type: "radio",
        name: "chart-interval",
        value: g.value
      }, null, 8, Qr), [
        [qe, v(l)]
      ]), k("span", tl, J(g.label), 1)], 2))), 128))], 4)]), !f.chart || !f.chart.points.length ? (M(), P("div", el, [m[3] || (m[3] = k("img", {
        src: zi,
        class: "lines"
        ...
        class: "dot"
      }, null, -1)), k("div", sl, J(("t" in f ? f.t : v(V))("memepad.jetton.chart.coming_text")), 1)])])) : (M(), P("div", nl, [v(p) ? (M(), P("div", {
        key: 0,
        class: Wt(["pnl-label", v(p).cls])
      }, J(v(p).label), 3)) : St("", !0), k("div", {
        ref_key: "container",
        ref: e,
        style: {
          width: "100%",
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return M(), P("div", rl, [v(e) ? (M(!0), P(vt, {
          ...
          src: r.image
        }, null, 8, al), r.count.isZero() ? St("", !0) : (M(), P("div", cl, J(r.label.full), 1))], 10, ll))), 128)) : (M(), P(vt, {
          key: 0
        }, Gt(3, r => E(h, {
          key: r,
          class: "skeleton"
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return M(), P(vt, null, [E(h, {
          ...
          default: q(() => [k("div", fl, J(("t" in s ? s.t : v(V))("memepad.jetton.unlock.btn")), 1)]),
          _: 1
        }, 8, ["type"]), E(a, {
          modelValue: v(e),
          ...
          default: q(() => [k("div", ml, [k("div", pl, [E(r, {
            ...
            size: 80
          }, null, 8, ["src"])]), k("div", vl, J(("t" in s ? s.t : v(V))("memepad.jetton.unlock.sheet.title", {
            ticker: s.jetton.ticker
          })), 1), k("div", bl, J(("t" in s ? s.t : v(V))("memepad.jetton.unlock.sheet.subtitle", {
            ticker: s.jetton.ticker
          })), 1), k("div", gl, [E(l, {
            jetton: s.jetton,
  ...
  Sl = nt({
    ...
    setup(n) {
      ...
      }, [k("span", yl, J(n.label), 1), _e(k("input", {
  ...
  kl = nt({
    ...
    setup(n) {
      ...
      return kn(Es, {
        ...
        }, [_e((M(), P("div", Cl, [Ln(s.$slots, "default", {}, void 0, !0), (M(!0), P(vt, null, Gt(v(i), l => (M(), I(h, {
          key: l.value,
          label: l.label,
          value: l.value,
          type: n.type
    ...
    setup(n) {
      ...
      return (h, r) => {
        ...
        return M(), P("div", zl, [k("div", Ll, [h.inputState ? (M(), P(vt, {
          ...
          class: "skeleton"
        })], 64))]), (_ = (g = h.inputState) == null ? void 0 : g.error) != null && _.notEnoughtTon ? (M(), I(u, {
          key: 0,
          ...
          default: q(() => [k("div", xl, J(("t" in h ? h.t : v(V))("memepad.jetton.buy_button_label", {
          ...
          default: q(() => [k("div", El, J(("t" in h ? h.t : v(V))("memepad.jetton.sell_button_label", {
            ticker: h.jetton.ticker
          })), 1)]),
          _: 1
      ...
      const S = L(() => {
          if (!(!l.value || l.value.loading)) {
            ...
            if (s.value === Y.SELL) {
              ...
              const w = xn(e.tonUsdRate.mul(y));
              return `${C} (≈$${w})`
            } else {
              const y = l.value.tradeInfo.maxReceive;
              return `≈${we(y,{accuracy:0})} ${e.jetton.ticker}`
            }
          }
        }),
      ...
      function O() {
        ...
        return async () => {
          ...
          await (async () => {
            o.value[T] = !0;
            const B = () => {
                const G = ii(T === Y.BUY ? tt.minReceive : K, $),
                  oe = ii(T === Y.BUY ? K : tt.minReceive, "TON"),
              ...
              N = await (T === Y.BUY ? e.jettonTrading.buyJetton(K, tt) : e.jettonTrading.sellJetton(K, tt));
            if (N.err) {
              En().error("Memepad jetton trade error", N.extra), o.value[T] = !1, B(), w(K, T);
              return
            }
            i("trade");
            const Z = N.data;
      ...
      return (y, C) => {
        ...
        return M(), I(R, {
          ...
          default: q(() => [k("div", Pl, [(M(), I(T, {
            ...
            modifier: m,
            onBlur: u
          }, null, 8, ["modelValue", "postfix"])), k("div", Vl, [v(S) ? (M(), P("span", Rl, J(v(S)), 1)) : v(S) === void 0 ? (M(), I(K, {
            key: 1,
            class: "skeleton"
          })) : St("", !0)]), k("button", {
            type: "button",
          ...
          }, [k("span", Il, J(`${("t"in y?y.t:v(V))("memepad.jetton.slippage_btn")} ${v(d)}%`), 1), E(tt, {
          ...
          "bottom-helpers": q(() => [E(F, {
            ...
            ref: p,
            modelValue: v(_),
            "onUpdate:modelValue": C[4] || (C[4] = B => bt(_) ? _.value = B : null),
            tab: s.value,
            balances: y.balances
  ...
  Jl = nt({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        h = X(e.jettonTrading.slippage.toString()),
      ...
      return (c, u) => {
        ...
        return M(), I(m, {
          ...
          "top-center": q(() => [k("div", Dl, J(("t" in c ? c.t : v(V))("memepad.jetton.slippage.title")), 1)]),
          ...
          "bottom-action": q(() => [k("div", Nl, [v(l) ? (M(), I(p, {
            key: 0,
            "error-message": v(l)
          }, null, 8, ["error-message"])) : (M(), P("div", Ol, J(("t" in c ? c.t : v(V))("memepad.jetton.slippage.text")), 1)), E(f, {
    ...
    setup(n) {
      return (t, e) => {
        ...
        return M(), P("div", Xl, [E(i, {
          ...
          default: q(() => [k("span", Hl, J(("t" in t ? t.t : v(V))("memepad.jetton.buy_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"]), E(i, {
          class: "sell-button",
          type: v(Lt).PINK,
          ...
          default: q(() => [k("span", Yl, J(("t" in t ? t.t : v(V))("memepad.jetton.sell_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"])])
      }
    }
      ...
      return (c, u) => {
        ...
        return M(), P("div", ql, [E(g, {
          ...
          default: q(() => [c.unlockEnabled ? (M(), I(d, {
            ...
            key: 0,
            modelValue: v(s),
            "onUpdate:modelValue": u[0] || (u[0] = _ => bt(s) ? s.value = _ : null),
            "trade-pendings": v(o),
            "onUpdate:tradePendings": u[1] || (u[1] = _ => bt(o) ? o.value = _ : null),
            jetton: c.jetton,
            "jetton-information": c.jettonInformation,
            ...
            onOpenSlippage: u[3] || (u[3] = _ => c.jettonModalControls.add(v(yt).SLIPPAGE))
            ...
            "jetton-trading": c.jettonTrading,
            "jetton-modal-controls": c.jettonModalControls,
            onSlippageUpdated: u[4] || (u[4] = _ => c.jettonModalControls.set(v(yt).TRADE))
  ...
  wa = nt({
    ...
    setup(n) {
      ...
      Kn(L(() => w.value.status === "moving_to_dex"), "memepad-jetton-trade-status");
      const U = () => {
          z.init(), O.init()
        },
        T = () => {
        ...
        function oe() {
          B = Mt(w, lt => {
            lt.status === "loading" || R || lt.jettonManagement && (B == null || B(), R = Ut(async () => {
              if (w.value.status === "loading") return ut(void 0);
              const it = w.value.jetton.address,
                kt = await w.value.jettonManagement.getJettonBclData(it);
            ...
            lt.status === "loading" || N || !lt.jettonTrading || f.value !== "connected" || (Z == null || Z(), N = Ut(async () => {
              if (w.value.status === "loading" || !w.value.jettonTrading || f.value !== "connected") return ut(void 0);
              const it = w.value.jetton.address,
                kt = await w.value.jettonTrading.getUserJettonBalance(it);
            ...
            lt.status === "loading" || Q || !lt.jetton || !lt.balances.jettonBalance || !lt.isReleased || f.value !== "connected" || (ct == null || ct(), Q = Ut(async () => {
              if (w.value.status === "loading" || !w.value.balances.jettonBalance || !w.value.isReleased || f.value !== "connected") return ut(void 0);
              if (w.value.balances.jettonBalance.value.isZero()) return ut(!1);
            ...
            lt.status === "loading" || ot || p.wallet.value.status === "connected" && (G == null || G(), ot = Ut(async () => {
              if (w.value.status === "loading" || p.wallet.value.status !== "connected") return ut(void 0);
      ...
      return ($, x) => {
        const W = cn,
          F = ho,
          R = sa;
        return v(w).status === "loading" ? (M(), I(W, {
          key: 0
        })) : v(w).status === "moving_to_dex" ? (M(), I(F, {
          key: 1,
          jetton: v(w).jetton,
