...
var u = (r, e, t) => dr(r, typeof e != "symbol" ? e + "" : e, t);
import {
  d as ot,
  a9 as hr,
  h as yr,
...
const go = ot({
    ...
    setup(r) {
      ...
      const o = () => {
        ...
        a = gr(() => t.memepad.memepadShowTopupButton({
          flowType: e.flowType,
      ...
      return Is(() => {
        ...
        const y = xs;
        return be(), Fe(y, {
          label: ("t" in i ? i.t : Z(Ft))("memepad.top_up_wallet_button"),
          fill: "",
          size: Z(Fs).LARGE,
          onClick: o
        }, null, 8, ["label", "size"])
  ...
  Lr = ot({
    ...
    setup(r) {
      ...
      return (s, n) => {
        const o = xs,
          a = Ir;
        return Z(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in s ? s.WALLET_LOCAL_AND_REMOTE_STATUS : Z(We)).DISCONNECTED ? (be(), Fe(o, {
          key: 0,
          label: ("t" in s ? s.t : Z(Ft))("wallet.connect.btn"),
          fill: "",
          size: s.buttonSize,
          onClick: n[0] || (n[0] = i => Z(t).runConnectionFlow())
        }, null, 8, ["label", "size"])) : Z(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in s ? s.WALLET_LOCAL_AND_REMOTE_STATUS : Z(We)).MUST_RECONNECT ? (be(), Fe(o, {
          key: 1,
          label: ("t" in s ? s.t : Z(Ft))("wallet.reconnect.btn"),
          fill: "",
          size: s.buttonSize,
          onClick: n[1] || (n[1] = i => Z(t).runConnectionFlow())
        }, null, 8, ["label", "size"])) : Z(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in s ? s.WALLET_LOCAL_AND_REMOTE_STATUS : Z(We)).LOADING || s.forceLoading ? (be(), Fe(a, {
          key: 2,
          class: Lt(["skeleton", `is-${s.buttonSize.toLowerCase()}`])
        }, null, 8, ["class"])) : Z(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in s ? s.WALLET_LOCAL_AND_REMOTE_STATUS : Z(We)).CONNECTED ? ye(s.$slots, "default", {
          key: 3
        }, void 0, !0) : Jt("", !0)
      }
    }
  ...
  Jr = ot({
    ...
    setup(r, {
      ...
      const N = () => {
        ...
        I = async () => {
          const k = new FontFace("RoobertPro", `url(${Fr})`, {
            weight: "700"
          });
      ...
      return (() => {
        ...
        ref: "input",
        "onUpdate:modelValue": R[0] || (R[0] = B => kr(y) ? y.value = B : null),
        type: "text",
        inputmode: "decimal",
        style: is(Z(f)),
        ...
        class: "label",
        style: is(Z(f))
      }, Tr(k.postfix), 5)) : Jt("", !0)], 2))
    }
  }),
  bo = Wt(Jr, [
    ["__scopeId", "data-v-44264923"]
  ]),
  vo = r => new C(r.replaceAll(",", "") || "0"),
  Wr = {
    class: "top"
  },
  Kr = {
    ...
    setup(r) {
      return (e, t) => {
        ...
        return be(), Fe(n, {
          ...
          default: cs(() => [ye(e.$slots, "top", {}, () => [he("div", Wr, [t[0] || (t[0] = he("div", {
            class: "left"
          }, null, -1)), he("div", Kr, [ye(e.$slots, "top-center", {}, void 0, !0)]), he("div", Hr, [ye(e.$slots, "top-right", {}, void 0, !0)])])], !0), ye(e.$slots, "default", {}, () => [he("div", zr, [ye(e.$slots, "inner", {}, void 0, !0)])], !0), Sr(s, {
            "ignore-tabs": "",
            "hide-space": ""
          }, {
            default: cs(() => [he("div", {
            ...
            }, [he("div", Vr, [ye(e.$slots, "bottom-action", {}, void 0, !0)]), e.$slots["bottom-helpers"] ? (be(), xt("div", Yr, [ye(e.$slots, "bottom-helpers", {}, void 0, !0)])) : Jt("", !0)], 2)]),
            _: 3
          })]),
          _: 3
        })
...
const Ot = $,
  ...
  $t = r => (0, en.default)(r, (e, t) => typeof t == "bigint" ? (0, Zr.default)(t.toString()) : t);
class sn {
  constructor(e = {}) {
    ...
    u(this, "request", async ({
      ...
      return this.customFetch(`${i||this.baseUrl||""}${s}${N?`?${N}`:""}`, {
        ...
        const K = k === "json" ? "text" : k,
          H = K ? await R[K]().then(O => (B.ok ? B.data = k === "json" ? tn(O) : O : B.error = O, B)).catch(O => (B.error = O, B)) : B;
...
var cn = class {
  ...
  open(r) {
    return $.openContract(r, e => Dt(this.tonapi, e.address, e.init))
  }
  provider(r, e) {
    return Dt(this.tonapi, r, e || null)
  }
};
...
function Dt(r, e, t) {
  return {
    async getState() {
      const s = await r.blockchain.getBlockchainRawAccount(e).catch(async a => {
        ...
        n = s.lastTransactionHash !== void 0 && s.lastTransactionLt !== void 0 ? {
          ...
          hash: jr.from(s.lastTransactionHash, "base64")
        } : null,
        o = {
          active: a => {
            var i, p;
    ...
    async internal(s, n) {
      ...
      let i;
      typeof n.value == "string" ? i = $.toNano(n.value) : i = n.value;
      let p = null;
    ...
    open(s) {
      return $.openContract(s, n => Dt(r, n.address, n.init))
    },
    getTransactions(s, n, o, a) {
      return console.info("hash param in getTransactions action ignored, beacause not supported", o.toString("hex")), r.blockchain.getBlockchainAccountTransactions(s, {
        ...
        transactions: i
      }) => i.map(p => $.loadTransaction(p.raw.asSlice())))
    }
  }
}
...
function un(r) {
  ...
  for (const t in r) {
    ...
    e.set((0, ln.sha256_sync)(t), s.endCell())
  }
  return (0, le.beginCell)().storeUint(0, 8).storeDict(e).endCell()
}
var Js = Ae.internalOnchainContentToCell = un;
...
function ce(r) {
  return "__private_" + hn++ + "_" + r
}
var yn = function() {
    function r(t) {
      this.api = void 0, this.adapter = void 0;
      var s = new Gs(t);
      this.api = new Us(s), this.adapter = new cn(this.api)
    }
    var e = r.prototype;
    ...
    return e.sendDeployJetton = function(t, s, n, o, a, i, p, y, f) {
      ...
      try {
        return p === void 0 && (p = 0n), Promise.resolve(t.internal(s, {
          value: n,
          body: $.beginCell().storeUint(Ws.deployJetton, 32).storeUint(f, 64).storeUint(o, 1).storeRef(a).storeBit(i).storeCoins(p).storeMaybeRef(y).endCell()
        })).then(function() {})
      } catch (h) {
    ...
    return e.getWalletAddress = function(t, s) {
      ...
      try {
        return Promise.resolve(t.internal(s, {
          value: n + te.buyGas,
          body: $.beginCell().storeUint(Ks.buy, 32).storeUint(p, 64).storeCoins(o).storeAddress(a).storeMaybeRef(i).endCell()
        })).then(function() {})
      } catch (y) {
...
var Mt = function() {
  ...
  gn = function() {
    ...
    return e.tonSupply = function(t) {
      return D(this, me)[me](t)
    }, e.calculateJettonAmount = function(t, s) {
      var n = D(this, me)[me](t);
      return D(this, Bt)[Bt](n + s) - t
    }, e.calculateTonAmount = function(t, s) {
      return D(this, me)[me](t) - D(this, me)[me](t - s)
      ...
      return this.calculatePrice(t) * D(this, Pt)[Pt](zs)
    }, r
  }();
...
function bn(r) {
  if (r == 0n) return 0n;
  var e = 10n ** 9n;
  return D(this, Ut)[Ut](r * e * e) * this.curveA / e
}
    ...
    try {
      ...
      return Promise.resolve(r(s)).then(function() {
        ...
        return e.init && (o.stateInit = $.beginCell().store($.storeStateInit(e.init)).endCell().toBoc().toString("base64")), {
          ...
          network: D(t, Oe)[Oe] ? ps.TESTNET : ps.MAINNET,
          messages: [o]
        }
      })
    } catch (n) {
  ...
  An = function() {
    function r(t, s, n) {
      s === void 0 && (s = !1), n === void 0 && (n = !1), Object.defineProperty(this, Rt, {
        ...
        writable: !0,
        value: void 0
      }), this.client = void 0, D(this, Oe)[Oe] = s;
      var o = n ? 16000000000000n : 653197264742n;
      D(this, se)[se] = new gn(o), this.client = new yn({
    ...
    return e.sendDeployJetton = function(t, s, n, o, a, i, p, y) {
      ...
      try {
        ...
        return Promise.resolve(f.getConfig()).then(function(h) {
          var N = h.deployFee + te.deployJettonGas + te.initialGas;
          a && (N += h.agentDeployFee), i > 0n && (N += i + te.buyGas);
          var I = Js(o);
      ...
      try {
        return Promise.resolve(D(this, de)[de](s).sendBuy(t, n, o, null, a, i)).then(function() {})
      } catch (p) {
      ...
      a === void 0 && (a = null), i === void 0 && (i = 0);
      try {
        var p = Mt.createFromAddress(s),
          y = this.client.open(p);
        return Promise.resolve(y.sendSell(t, te.sellGas, n, o, a, i)).then(function() {})
      } catch (f) {
      ...
      return D(this, se)[se].tonSupply(st)
    }, e.getTonSupply = function(t) {
      return D(this, se)[se].tonSupply(t)
    }, e.getMaxSupply = function() {
      return zs
    }, e.getThresholdSupply = function() {
      return st
    }, e.getPrice = function(t) {
      return D(this, se)[se].calculatePrice(t)
    }, e.getMarketCap = function(t) {
      return D(this, se)[se].calculateMarketCap(t)
    }, e.getBuyAmount = function(t, s, n) {
      return D(this, se)[se].calculateBuyAmount(t, s, n)
    }, e.getSellAmount = function(t, s, n) {
      return D(this, se)[se].calculateSellAmount(t, s, n)
    }, e.getWalletAddress = function(t, s) {
      try {
        return Promise.resolve(D(this, de)[de](t).getWalletAddress(s))
      } catch (n) {
        return Promise.reject(n)
      }
    }, e.getTotalSupply = function(t) {
      ...
      try {
        return Promise.resolve(D(this, Rt)[Rt](t).getUnlocked())
      } catch (s) {
        return Promise.reject(s)
      }
...
const Vs = () => {
    const {
      ...
      isProd: f
    } = Er(), h = new An(n, !1, !f.value), N = l => +String(l) / 1e4, I = {
      ...
      const {
        buyFeeBasis: q
      } = w.data, P = A.div(new C(1).minus(N(q))).toDecimalPlaces(9, C.ROUND_UP), M = w.data, V = S(w.data.agentDeployFee);
      return x({
      ...
      const {
        buyFeeBasis: V
      } = M.data, X = S(h.getBuyAmount(0n, _, V)), ke = X, je = X, Ne = w.minus(ke), pe = S(h.getTonSupply(U(ke))), ns = new C(h.getPrice(U(ke))), cr = new C(ns).times(P), pr = pe.div(A).times(100), lr = X.div(w).times(100), mr = new C(m).minus(pe);
      return x({
        share: new C(m),
        tokenForDexWithFees: q,
        tokenForDex: A,
      ...
      jettonAddress: l,
      userAddress: m
    }) => await W(async () => await h.getJettonWalletAddress(r(l), r(m)))()), we = async ({
      masterAddress: l,
      form: m,
      tonConnectUI: _,
      referrerToken: d
      ...
      const X = d ? K({
        ...
        ke = m.aiAgentEnable,
        je = await W(async () => await h.sendDeployJetton(q, r(l), M, V, ke, U(new C(m.share)), X, P))();
      if (!j(je)) return je;
      ...
      const {
        buyFeeBasis: q
      } = w.data, P = S(h.getBuyAmount(U(A), U(l), q)), M = P, V = i(P), X = l.times(N(q));
      return x({
        maxReceive: M,
        minReceive: V,
        platformFee: X,
      ...
      const {
        sellFeeBasis: q
      } = w.data, P = S(h.getSellAmount(U(A), U(l), q)), M = P, V = i(P), X = P.div(1 - N(q)).minus(P);
      return x({
        maxReceive: M,
        minReceive: V,
        platformFee: X,
      ...
      const w = e(d),
        ...
        P = await W(async () => await h.sendBuy(w, r(m), U(l), U(_.minReceive), q))();
      return j(P) ? x((await w.getResult()).hash) : P
    }, At = async ({
      jettons: l,
      jettonAddress: m,
      tradeInfoParams: _,
      ...
      if (!j(M)) return M;
      const V = M.data,
        X = await W(async () => await h.sendSell(q, V, U(l), U(_.minReceive), P))();
      return j(X) ? x((await q.getResult()).hash) : X
    }, St = () => Ce(({
      transactionHash: l
    }) => o({
      transactionHash: l
      ...
      if (!j(A)) return A;
      const w = A.data,
        q = await W(async () => await h.sendUnlock(d, w))();
      return j(q) ? x((await d.getResult()).hash) : q
    }, g = ({
      transactionHash: l
    }) => o({
      transactionHash: l
    ...
    return {
      ...
      getMaxShareAmount: ({
        ...
        const {
          ...
          hasShare: !0
        }), w = S(m.bclData.factoryConfig.deployFee), q = l.value.minus(A.plus(w).plus(d).plus(_)), P = m.bclData.tokenForDexWithFees;
        return P.lt(q) ? P : q.gte(0) ? q : new C(0)
      },
      getMaxBuyAmount: ({
        tokenBalance: l
      }) => {
  ...
  qn = ({
    ...
    const {
      ...
      getMaxShareAmount: a,
      getReviewInfo: i
    } = Vs(), p = r.masterAddresses[at.STONFI], y = Me().tonConnectUI.value;
    return {
      getJettonOverview: ({
        tons: f
      }) => s({
  ...
  En = ({
    ...
    const {
      ...
      getMaxBuyAmount: K,
      fees: H
    } = Vs(), O = r.address, z = r.masterContractAddress, ne = Me().tonConnectUI.value, re = o(), oe = a({
      getFees: () => H
    });
    return {
      getUserJettonBalance: () => i({
...
class Nn {
  constructor(e) {
    ...
    }, this.endpoint = e.endpoint, this.httpProvider = e.httpProvider ?? new Rn.OfetchHttpProvider
  }
}
ht.BclClient = Nn;
var Pe = {},
...
function Fn() {
  ...
  for (let r = 0; r < 256; r++) {
    let e = r;
    for (let t = 8; t > 0; --t) e = e & 1 ? e >>> 1 ^ In : e >>> 1;
    rt[r] = e
  }
}
...
class Qt {
  ...
  async sendBuy(e, t, s) {
    ...
    s.buyerAddress && n.storeAddress(s.buyerAddress), await e.internal(t, {
      value: s.tons + On.Constants.CoinBuyGas,
...
const Un = Br(),
  Gn = r => BigInt("0x" + (0, Un.createHash)("sha256").update(r).digest().toString("hex"));
gt.sha256ToBigint = Gn;
Object.defineProperty(Re, "__esModule", {
  value: !0
});
Re.storeSnakeContentData = Zs;
Re.loadSnakeContentData = er;
Re.storeTokenOnchainContent = Jn;
Re.loadTokenOnchainContent = Wn;
const nt = Ms,
  Ln = gt,
  Qs = 0,
  Xs = 0;
...
function Jn(r) {
  return e => {
    ...
    for (const s in r) r[s] && t.set((0, Ln.sha256ToBigint)(s), r[s]);
...
class Xt {
  ...
  async sendDeployCoin(e, t, s, n) {
    let o = (0, Ee.beginCell)().store((0, Kn.storeTokenOnchainContent)({
        name: s.name,
    ...
    let y = p + As.Constants.CoinDeploymentGas;
    n != null && n.firstBuy && (y += As.Constants.CoinBuyGas + n.firstBuy.tons), await e.internal(t, {
      value: y,
...
class Zt {
  constructor(e) {
    this.apiProvider = e.apiProvider, this.api = new Hn.BclClient(e.clientOptions), this.masterAddress = e.masterAddress
  }
  openCoin(e) {
    return this.apiProvider.open(zn.BclJetton.createFromAddress(e))
  }
...
const Zn = () => Math.floor(Date.now() / 1e3);
Be.unixtime = Zn;
const eo = r => new Promise(e => {
  setTimeout(() => e(), r)
});
Be.delay = eo;
...
bt.packReferralConfig = no;
bt.unpackReferralConfig = oo;
const ro = Ms,
  ar = ve;

function no(r) {
  let e = (0, ro.beginCell)().storeUint((0, ar.crc32str)("ref_v1"), 32).storeAddress(r.partner);
...
const ir = () => {
    const {
      ...
      tons: g,
      masterAddress: b
    }) => await W(async () => await F(b).getFirstCoinsForTons(U(new C(g))))()), z = p(({
      tons: g,
      masterAddress: b
      ...
      const {
        ...
        bclSupply: m,
        maxSupply: _
      } = T.data, d = await (async () => new C(E).isZero() ? x({
        fees: U(new C(0)),
        coins: U(new C(0))
      }) : await H({
        tons: g,
      ...
      const q = w.data,
        ...
        V = new C(S(A.fees)),
        X = new C(E).minus(V),
        ke = X.div(v).times(100),
        je = M.div(m).times(100),
        Ne = new C(m).sub(M);
      return x({
        share: E,
        tokenForDexWithFees: l,
      ...
      const w = {
          ...
          referral: ae.packReferralConfig({
            partner: r(d.partnerAddress),
            platformTag: r(d.referral)
          }),
          queryId: $.toNano(d.queryId),
          extraMetadata: A
        },
        q = {
          firstBuy: m.isZero() ? void 0 : {
            tons: d.share,
            minReceive: d.minReceive,
            referral: ae.packReferralConfig({
              partner: r(d.partnerAddress)
            }),
            buyerAddress: r(b)
        ...
        P = e(T),
        M = await W(async () => await F(E).deployCoin(P, w, q))();
      return j(M) ? x({
        queryId: l.data.queryId,
      ...
      if (!j(v)) return ((m = v.extra) == null ? void 0 : m.status) === 404 && ((d = (_ = v.extra) == null ? void 0 : _.error) == null ? void 0 : d.error) === "entity not found" ? x(!1) : v;
      const l = v.data;
      return x(l)
    }, J = async ({
      jettonAddress: g,
      ...
      const m = await F(T).openCoin(r(E)).getUserWallet(r(v)),
        _ = e(l),
        d = await W(async () => await m.sendSellCoins(_, {
          amount: U(g),
          minReceive: U(b.minReceive),
          referral: ae.packReferralConfig({
            partner: r(b.additionalInfo.partnerAddress)
      ...
      return j(d) ? x((await _.getResult()).hash) : d
    }, At = () => Ce(({
      transactionHash: g
    }) => o({
      transactionHash: g
  ...
  ao = ({
    ...
    const {
      ...
      getMaxShareAmount: a,
      getReviewInfo: i
    } = ir(), p = r.masterAddresses[at.STONFI_TON_FUN], y = Me().tonConnectUI.value;
    return {
      getJettonOverview: ({
        tons: f
      }) => s({
  ...
  io = ({
    ...
    const {
      ...
      getMaxBuyAmount: K,
      fees: H
    } = ir(), O = e.address, z = e.masterContractAddress, ne = r.partnerAddress, re = Me().tonConnectUI.value, oe = a({
      getFees: () => H
    }), Y = o();
    return {
      getUserJettonBalance: () => p({
...
export {
  go as _, _o as a, bo as b, wo as c, To as d, vo as f, Ao as g
};