...
var _ = (e => (e.TOKEN_INFO = "TOKEN_INFO", e.PERSONALIZE_TOKEN = "PERSONALIZE_TOKEN", e.REVIEW = "REVIEW", e))(_ || {});
const g = e => {
    switch (e) {
      case r.TELEGRAM:
        return {
  ...
  f = () => {
    ...
    return Object.fromEntries(e.map(o => [o, g(o)]))
  },
  K = () => {
...
export {
  _ as M, h as _, W as a, x as b, f as g, g as m, L as r, P as s
};