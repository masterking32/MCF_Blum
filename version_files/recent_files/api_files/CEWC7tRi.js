...
`).reduce((r, p) => {
      ...
      return (S, r) => {
        ...
        return o(), h(f, {
          ...
          }, "Disclaimer"), r[7] || (r[7] = be("."))])])])) : O("", !0), a(c).state === "details" ? (o(), T("div", qt, [(o(), h(Ke(a(v))))])) : O("", !0)]),
...
const xt = w(Lt, [
  ...
  Ee = N({
    ...
    setup(e, {
      ...
      const t = e,
        ...
        l = () => {
          if ([K.SOCIAL_MEDIA_CHECK, K.SOCIAL_SUBSCRIPTION].includes(t.task.type) && t.task.socialSubscription) {
            ...
            t.task.socialSubscription.openInTelegram ? X().$webApp.openTelegramLink(b) : b.startsWith("http") ? X().$webApp.openLink(b) : Ae().push(b)
          }
          ...
          if (t.task.type === K.ONCHAIN_TRANSACTION) {
            const b = async () => {
              ...
              const _ = je().getters.mustGetUser.value.id,
                A = `${t.task.id}:${_}`;
      ...
      return me(D, b => Ie().meta.back = b), (b, u) => {
        ...
        const _ = Mt,
          A = Ht;
        return o(), T(L, null, [j(b.$slots, "default", Ye(We(a(C)))), I(_, {
          "model-value": !!a(r),
  ...
  Ea = N({
    ...
    setup(e) {
      ...
      return Re(() => clearTimeout(s)), (i, k) => a(t) ? j(i.$slots, "default", {
        key: 0
      }) : O("", !0)
    }
  }),
  ...
  Ga = N({
    ...
    setup(e) {
      const d = $(() => Ie().query.openTaskSheetId),
        ...
        s = M(),
        i = M({}),
        c = st(async () => lt(await ue.getTasksSections(X().$webApp.dataUnsafe.query.ref)), f => s.value = f, 15e3),
        l = (f, y) => {
          if (s.value)
