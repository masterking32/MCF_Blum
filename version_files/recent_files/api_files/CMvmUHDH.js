...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function _(p, h) {
    if (p) {
      ...
      if (x === "Object" && p.constructor && (x = p.constructor.name), x === "Map" || x === "Set") return Array.from(p);
      if (x === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(x)) return y(p, h)
    }
  }

  function y(p, h) {
    (h == null || h > p.length) && (h = p.length);
    for (var x = 0, M = new Array(h); x < h; x++) M[x] = p[x];
    return M
  }
  ...
  function l(p, h) {
    if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(p)))) {
      var x = [],
        ...
        I = void 0;
      try {
        for (var T = p[Symbol.iterator](), O; !(M = (O = T.next()).done) && (x.push(O.value), !(h && x.length === h)); M = !0);
      } catch (P) {
        w = !0, I = P
      } finally {
        try {
  ...
  function E(p, h) {
    ...
    var x, M, w, I, T, O, P, q;
    if (P = p.split("#"), p = P.shift(), P = p.split("?"), p = P.shift(), P = p.split("://"), P.length > 1) {
      if (x = P.shift().toLowerCase(), h.require_valid_protocol && h.protocols.indexOf(x) === -1) return !1
    } else {
    ...
    if (p = P.join("://"), p === "") return !1;
    if (P = p.split("/"), p = P.shift(), p === "" && !h.require_host) return !0;
    if (P = p.split("@"), P.length > 1) {
      if (h.disallow_auth || P[0] === "" || (M = P.shift(), M.indexOf(":") >= 0 && M.split(":").length > 2)) return !1;
      var G = M.split(":"),
        ee = e(G, 2),
        re = ee[0],
        ie = ee[1];
    ...
    I = P.join("@"), O = null, q = null;
    var J = I.match(F);
    if (J ? (w = "", q = J[1], O = J[2] || null) : (P = I.split(":"), w = P.shift(), P.length && (O = P.join(":"))), O !== null && O.length > 0) {
...
const Bt = {
  ...
  Jt = U({
    ...
    setup(d) {
      ...
      return (i, m) => (c(), k("div", Gt, [b("div", Wt, $(t(a).step), 1), b("div", zt, $(t(a).label), 1)]))
    }
  }),
  le = N(Jt, [
    ...
    setup(d) {
      ...
      return (n, e) => {
        ...
        return c(), k("div", Ht, [b("div", Qt, [t(r) ? (c(), k("div", {
          ...
          type: t(Me).LIGHT,
          size: 16
        }, null, 8, ["type"])) : (c(), k("img", Zt))])), b("div", Yt, [b("div", Xt, $(("t" in n ? n.t : t(A))("memepad.new.step_1.field_icon.label")), 1), b("div", en, $(("t" in n ? n.t : t(A))("memepad.new.step_1.field_icon.description", {
    ...
    setup(d, {
      ...
      return Se(r, () => {
        ...
        return c(), k("div", {
          ...
          key: 0,
          for: t(m)
        }, [b("span", null, $(v.label), 1), v.errorCaption ? (c(), k("div", on, [F[3] || (F[3] = b("img", {
          src: Qe,
          alt: "Warning icon"
        }, null, -1)), b("div", null, $(v.errorCaption), 1)])) : v.maxLength ? (c(), V(s, {
          key: 1,
          value: r.value,
    ...
    setup(d, {
      ...
      const u = l => {
          ...
          switch (l.type) {
            ...
            case B.TEXTAREA: {
              if ((v = l.validators) != null && v.required && !l.value && g.push({
                ...
                const E = l.validators.maxLength.value - l.value.length;
                E < 0 && g.push({
                  msg: `${E*-1} over`,
                  isVisible: !1
                })
              ...
              if (l.type === B.STRING && ((s = l.validators) != null && s.url)) {
                const E = l.validators.url.includePrefix && ((f = l.props) != null && f.prefix) ? `${l.props.prefix}${l.value}` : l.value;
                qt(E) || g.push({
                  msg: "Invalid URL",
                  isVisible: !0
                })
          ...
          if (l.customValidator) {
            const E = l.customValidator(l.value);
            E && g.push({
              msg: E,
              isVisible: !0
            })
      ...
      return ne(() => a("channel", {
        ...
        return c(), k("form", {
          ...
          return c(), k("div", {
            ...
            "error-caption": _(s),
            "is-error": y(s),
            "max-length": (E = (f = s.validators) == null ? void 0 : f.maxLength) == null ? void 0 : E.value,
            class: "input",
            onChange: T => n(s),
            ...
            "error-caption": _(s),
            "is-error": y(s),
            "max-length": (M = (x = s.validators) == null ? void 0 : x.maxLength) == null ? void 0 : M.value,
            class: "textarea",
            onChange: T => n(s),
    ...
    setup(d) {
      return (o, a) => {
        ...
        return c(), k("div", mn, [d.iconName ? (c(), V(i, {
          ...
          name: d.iconName,
          class: "icon"
        }, null, 8, ["name"])) : C("", !0), b("div", _n, [b("span", fn, $(d.title), 1), d.isOptional ? (c(), k("span", vn, $(` ${("t"in o?o.t:t(A))("base.optional")}`), 1)) : C("", !0)])])
      }
    }
  }),
  We = N(gn, [
    ...
    setup(d) {
      ...
      return (n, e) => {
        ...
        return c(), k("div", hn, [S(u, {
          ...
          type: t(Me).LIGHT,
          size: 16
        }, null, 8, ["type"]), b("div", yn, $(("t" in n ? n.t : t(A))("memepad.new.step_1.field_banner.uploading")), 1)])) : (c(), k("div", {
          key: 2,
          ...
          src: et,
          alt: "Add"
        }, null, -1)), b("div", wn, [b("div", kn, $(("t" in n ? n.t : t(A))("memepad.new.step_1.field_banner.description", {
  ...
  Vn = U({
    ...
    setup(d, {
      ...
      const a = yt(),
        ...
        m = o,
        r = R([{
          provider: xe.TELEGRAM,
          isValid: !1,
          optional: !1
        }]),
        n = j(() => Object.values(xe).filter(_ => !r.value.find(y => y.provider === _))),
        e = _ => r.value.push({
          provider: _,
          isValid: !1,
          optional: !0
      ...
      return ne(() => {
        ...
        const l = xn,
          g = X;
        return c(), k("div", Pn, [b("div", En, [S(at, {
          name: "list-shuffle-transition"
        }, {
          default: L(() => [(c(!0), k(K, null, Z(t(r), (v, F) => (c(), V(l, {
            key: v.provider,
          ...
          default: L(() => [t(n).length > 0 ? (c(), k("div", $n, [S(g, {
            name: "plus",
            class: "plus-icon"
          }), b("div", Mn, [(c(!0), k(K, null, Z(t(n), v => (c(), k("div", {
            key: v,
            class: "provider"
          }, [S(g, {
            name: t(a)[v].icon,
  ...
  qn = U({
    ...
    setup(d) {
      ...
      return (a, i) => {
        const m = Tn,
          r = $t;
        return c(), k("div", Ln, [b("div", jn, [b("div", On, $(("t" in a ? a.t : t(A))("memepad.new.step_1.field_nsfw.label")), 1), S(m, {
          modelValue: o.value,
          ...
          const w = (() => {
            ...
            I = {
              ...
              details: [{
                ...
                label: `${A("memepad.jetton.fees_platform")}: ${de((P=n.value.overview)==null?void 0:P.platformFee,2)} TON`
              }] : []]
            },
            T = (() => {
              if (!w.value) return;
      ...
      return Se(() => n.value.share, () => {
        ...
        return c(), V(J, {
          ...
          default: L(() => [b("div", zn, [S(O, {
            ...
            modifier: e,
            onBlur: E
          }, null, 8, ["modelValue"]), b("div", Jn, [t(s) ? (c(), k("span", Hn, $(t(s)), 1)) : t(s) === void 0 ? (c(), V(P, {
            key: 1,
            class: "skeleton"
          })) : C("", !0)])])]),
          "bottom-action": L(() => [b("div", Qn, [t(f).showInfo ? (c(), k("div", Zn, [t(f).tonBalance.label && !t(f).loading ? (c(), V(q, {
            ...
            default: L(() => [b("div", Yn, $(("t" in w ? w.t : t(A))("memepad.new.step_3.next_btn")), 1)]),
            _: 1
  ...
  la = U({
    ...
    setup(d) {
      return (o, a) => (c(), k("div", ta, [b("img", {
        ...
        alt: "Jetton logo"
      }, null, 8, na), b("div", aa, [b("div", oa, $(o.ticker), 1), b("div", sa, $(o.name), 1)])]))
    }
  }),
  ra = N(la, [
  ...
  ba = U({
    ...
    setup(d) {
      return (o, a) => {
        const i = X,
          m = Vt;
        return c(), k("div", ia, [(c(!0), k(K, null, Z(o.details.sections, r => (c(), k("div", {
          key: r.title,
          class: "row"
        }, [b("div", ua, $(r.title), 1), b("div", ca, [S(m, null, {
          default: L(() => [S(i, {
            name: "circle-help",
            class: "memepad-new-price-details-tooltip-icon"
          })]),
          inner: L(() => [b("div", da, [(c(!0), k(K, null, Z(r.details, n => (c(), k("span", {
            key: n.label,
            class: Ne({
          ...
          _: 2
        }, 1024), b("span", pa, $(r.label), 1)])]))), 128)), o.details.totalSection ? (c(), k(K, {
          key: 0
        }, [a[0] || (a[0] = b("div", {
          class: "divider"
        }, null, -1)), b("div", ma, [b("div", _a, $(o.details.totalSection.title), 1), o.notEnoughBalance ? (c(), k("div", fa, [S(i, {
          name: "circle-help",
          class: "icon"
        }), b("span", va, $(("t" in o ? o.t : t(A))("memepad.jetton.not_enough_error", {
          ticker: "TON"
        })), 1)])) : (c(), k("div", ga, [b("span", ha, $(o.details.totalSection.label), 1)]))])], 64)) : C("", !0)])
      }
    }
  }),
  ya = N(ba, [
    ...
    setup(d, {
      ...
      return (g, v) => {
        ...
        return c(), k("div", wa, [S(F, {
          ...
          class: "banner"
        }, null, 8, ["banner-file-key"]), S(E, ct(dt(t(e))), null, 16), S(w, null, {
          default: L(() => [S(p, {
    ...
    setup(d, {
      ...
      return mt(() => {
        ...
        const y = Rt,
          ...
          v = se,
          F = _t;
        return c(), k("div", Fa, [S(y), t(i) === "ERROR" ? (c(), k(K, {
          key: 0
        }, [b("div", Ia, [b("div", xa, [b("div", Pa, [S(l, {
          name: "warning",
          class: "icon"
        })])]), b("div", Ea, $(("t" in u ? u.t : t(A))("memepad.new.failed.title", {
          ticker: u.form.ticker
        })), 1), b("div", $a, $(("t" in u ? u.t : t(A))("memepad.new.failed.subtitle")), 1)]), S(v, null, {
          default: L(() => [S(g, {
            fill: "",
          ...
          width: "80",
          height: "80"
        }, null, 8, Ra)]), b("div", Ua, $(("t" in u ? u.t : t(A))("memepad.new.step_launch.title")), 1), b("div", Na, $(("t" in u ? u.t : t(A))("memepad.new.step_launch.subtitle")), 1)]), t(i) === "ROCKET" ? (c(), k("div", Ta, [S(F, {
  ...
  qa = U({
    ...
    setup(d) {
      ...
      const n = o.jettonManagement.getWaitForCreateStatus(),
        e = R(o.retryPayload ? Et(o.retryPayload) : {
          step: 1,
          step1: pe.step1(),
          step2: pe.step2(),
          step3: pe.step3()
      ...
      const _ = (s, f) => {
          ...
          e.value = E, a.memepad.memepadJettonStepPersonalise()
        },
        y = (s, f) => {
          const E = {
            step: 3,
          ...
          e.value = E, a.memepad.memepadJettonStepShare()
        },
        l = (s, f) => {
          const E = {
            step: 4,
          ...
          e.value = E, a.memepad.memepadJettonStepOverview()
        },
        g = (s, f) => {
          e.value = {
            ...s,
      ...
      return (s, f) => {
        const E = Dt,
          ...
          M = Aa,
          w = ja;
        return c(), k("div", Oa, [t(e).step !== 5 ? (c(), V(E, {
          key: 0,
          step: t(e).step,
          "count-steps": 4
        ...
        }, null, 8, ["state"])) : C("", !0), t(e).step === 3 ? (c(), V(x, {
          key: 3,
          state: t(e),
