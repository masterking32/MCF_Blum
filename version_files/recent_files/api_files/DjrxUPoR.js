      ...
      return (i, o) => {
        ...
        return rt(), Gt(C, {
          ...
          default: xt(() => [i.state.type !== "loading" ? (rt(), ut("div", la, [Y("div", ua, [at(u, {
            ...
            src: i.state.asset.imageUrl
          }, null, 8, Ka)]), Y("div", ja, ot(i.state.asset.symbol), 1), Y("div", $a, ot(r(i.state.amount, i.state.asset.symbol)), 1)]), at(h, {
...
(function(n) {
  var t = tt && tt.__awaiter || function(p, C, b, A) {
      ...
      return new(b || (b = Promise))(function(f, w) {
        ...
        function v(m) {
          m.done ? f(m.value) : I(m.value).then(j, y)
        }
  ...
  var _ = function(p, C) {
    ...
    return t(void 0, s([p, C], b, !0), void 0, function(I, f, w) {
      ...
      return w === void 0 && (w = "10000000"), e(this, function($) {
        switch ($.label) {
          case 0:
            j = r.Address.parseFriendly(I).address.toRawString(), $.label = 1;
          case 1:
            return $.trys.push([1, 4, , 7]), v = new f.Contract(o.AirdropFactoryAbiV1, new i.Address(j)), [4, v.fields._codeAirdrop()];
          case 2:
          ...
          case 4:
            return y = $.sent(), console.warn(y), v = new f.Contract(o.AirdropFactoryAbiV2, new i.Address(j)), [4, v.methods.getAirdropCode().call()];
          case 5:
    ...
    A = function() {
      ...
      return I.prototype.destory = function() {
        ...
        return r(this, void 0, void 0, function() {
          var f, w, j, y, v, m, F, $, B, l, d, g, P, T, O, N;
...
function Yo(n, t, e, s, r, i, o) {
  try {
    ...
    var u = wt(i) ? 0 : V(i, c.__wbindgen_malloc, c.__wbindgen_realloc),
      _ = H;
    c.executeLocal(b, A, I, f, w, j, y, s, r, u, _, !wt(o), wt(o) ? 0 : o);
...
function Sc(n, t, e, s, r, i, o) {
  try {
    ...
    var u = wt(r) ? 0 : V(r, c.__wbindgen_malloc, c.__wbindgen_realloc),
      _ = H;
    c.createExternalMessageWithoutSignature(b, n.__wbg_ptr, A, I, f, w, j, y, u, _, Q(i), o);
    var h = R().getInt32(b + 4 * 0, !0),
      p = R().getInt32(b + 4 * 1, !0),
      C = R().getInt32(b + 4 * 2, !0);
    if (C) throw W(p);
...
function Cc(n, t, e, s, r, i, o, u) {
  try {
    ...
    const m = V(o, c.__wbindgen_malloc, c.__wbindgen_realloc),
      F = H;
    c.createExternalMessage(A, n.__wbg_ptr, I, f, w, j, y, v, _, h, Q(i), m, F, u);
...
function Br(n) {
  ...
  function y(l, d) {
    ...
    if (d == null) {
      ...
      if ((k = typeof l == "number") && l * 0 == 0) {
        ...
        if (!pl.test(K = String(l))) return s(L, K, k);
      ...
      if (Ct(d, 2, w.length, "Base"), d == 10 && j) return L = new y(l), $(L, o + L.e + 1, u);
      if (K = String(l), k = typeof l == "number") {
        if (l * 0 != 0) return s(L, K, k, d);
        if (L.s = 1 / l < 0 ? (K = K.slice(1), -1) : 1, y.DEBUG && K.replace(/^0\.0*|\./, "").length > 15) throw Error(Zs + l)
  ...
  y.clone = Br, y.ROUND_UP = 0, y.ROUND_DOWN = 1, y.ROUND_CEIL = 2, y.ROUND_FLOOR = 3, y.ROUND_HALF_UP = 4, y.ROUND_HALF_DOWN = 5, y.ROUND_HALF_EVEN = 6, y.ROUND_HALF_CEIL = 7, y.ROUND_HALF_FLOOR = 8, y.EUCLID = 9, y.config = y.set = function(l) {
    ...
    return function(g) {
      ...
      if (g == null ? g = o : Ct(g, 0, Ft), N = Yn(g / it), b)
        if (crypto.getRandomValues) {
          for (P = crypto.getRandomValues(new Uint32Array(N *= 2)); M < N;) k = P[M] * 131072 + (P[M + 1] >>> 11), k >= 9e15 ? (T = crypto.getRandomValues(new Uint32Array(2)), P[M] = T[0], P[M + 1] = T[1]) : (K.push(k % 1e14), M += 2);
          M = N / 2
      ...
      for (N = K[--M], g %= it, N && g && (k = qn[it - g], K[M] = ee(N / k) * k); K[M] === 0; K.pop(), M--);
      if (M < 0) K = [O = 0];
      else {
    ...
    function d(g, P, T, O) {
      for (var N, k = [0], M, K = 0, L = g.length; K < L;) {
        ...
        for (k[0] += O.indexOf(g.charAt(K++)), N = 0; N < k.length; N++) k[N] > T - 1 && (k[N + 1] == null && (k[N + 1] = 0), k[N + 1] += k[N] / T | 0, k[N] %= T)
      }
      return k.reverse()
    }
    return function(g, P, T, O, N) {
      var k, M, K, L, z, et, nt, _t, vt = g.indexOf("."),
        Pt = o,
        dt = u;
      for (vt >= 0 && (L = I, I = 0, g = g.replace(".", ""), _t = new y(P), et = _t.pow(g.length - vt), I = L, _t.c = d(de(te(et.c), et.e, "0"), 10, T, l), _t.e = _t.c.length), nt = d(g, P, T, N ? (k = w, l) : (k = l, w)), K = L = nt.length; nt[--L] == 0; nt.pop());
      if (!nt[0]) return k.charAt(0);
      if (vt < 0 ? --K : (et.c = nt, et.e = K, et.s = O, et = t(et, _t, Pt, dt, T), nt = et.c, z = et.r, K = et.e), M = K + Pt + 1, vt = nt[M], L = T / 2, z = z || M < 0 || nt[M + 1] != null, z = dt < 4 ? (vt != null || z) && (dt == 0 || dt == (et.s < 0 ? 3 : 2)) : vt > L || vt == L && (dt == 4 || z || dt == 6 && nt[M - 1] & 1 || dt == (et.s < 0 ? 8 : 7)), M < 1 || !nt[0]) g = z ? de(k.charAt(1), -Pt, k.charAt(0)) : k.charAt(0);
      else {
        if (nt.length = M, z)
    ...
    return function(P, T, O, N, k) {
      ...
      for (vt = new y(Vt), Pt = vt.c = [], K = P.e - T.e, Vt = O + K + 1, k || (k = ie, K = ne(P.e / it) - ne(T.e / it), Vt = Vt / it | 0), L = 0; At[L] == (Nt[L] || 0); L++);
  ...
  function $(l, d, g, P) {
    ...
    if (z) {
      t: {
        ...
        l;
        if (O == 0 ? (z.length = K, k = 1, K--) : (z.length = K + 1, k = et[it - O], z[K] = N > 0 ? ee(M / et[T - N] % et[N]) * k : 0), P)
          for (;;)
            if (K == 0) {
  ...
  return r.absoluteValue = r.abs = function() {
    ...
    for (k ? (g = new y(.5), M && (l.s = 1), K = _n(l)) : (T = Math.abs(+B(l)), K = T % 2), L = new y(i);;) {
      if (K) {
    ...
    if (M = ne(M), K = ne(K), L = L.slice(), k = M - K) {
      for ((O = k < 0) ? (k = -k, T = L) : (K = M, T = z), T.reverse(), d = k; d--; T.push(0));
      T.reverse()
    } else
    ...
    var g, P, T, O, N, k, M, K, L, z, et, nt, _t, vt, Pt, dt = this,
      ht = dt.c,
      Rt = (l = new y(l, d)).c;
    ...
    for (vt = ie, Pt = be, T = z; --T >= 0;) {
      for (g = 0, et = Rt[T] % Pt, nt = Rt[T] / Pt | 0, N = M, O = T + N; O > T;) K = ht[--N] % Pt, L = ht[N] / Pt | 0, k = nt * K + L * et, K = et * K + k % Pt * Pt + _t[O] + g, g = (K / vt | 0) + (k / Pt | 0) + nt * L, _t[O--] = K % vt;
      _t[O] = g
    }
    ...
    if (k = Math.sqrt(+B(O)), k == 0 || k == 1 / 0 ? (d = te(N), (d.length + M) % 2 == 0 && (d += "0"), k = Math.sqrt(+d), M = ne((M + 1) / 2) - (M < 0 || M % 2), k == 1 / 0 ? d = "5e" + M : (d = k.toExponential(), d = d.slice(0, d.indexOf("e") + 1) + M), g = new y(d)) : g = new y(k + ""), g.c[0]) {
      for (M = g.e, k = M + K, k < 3 && (k = 0);;)
        if (T = g, g = L.times(T.plus(t(O, T, K, 1))), te(T.c).slice(0, k) === (d = te(g.c)).slice(0, k))
    ...
    var d, g, P, T, O, N, k, M, K, L, z, et, nt = this,
      _t = nt.c;
    ...
    for (d = new y(i), K = g = new y(i), P = M = new y(i), et = te(_t), O = d.e = et.length - nt.e - 1, d.c[0] = qn[(N = O % it) < 0 ? it + N : N], l = !l || k.comparedTo(d) > 0 ? O > 0 ? d : K : k, N = C, C = 1 / 0, k = new y(et), M.c[0] = 0; L = t(k, d, 0, 1), T = g.plus(L.times(P)), T.comparedTo(l) != 1;) g = P, P = T, K = M.plus(L.times(T = K)), M = T, d = k.minus(L.times(T = d)), k = T;
    ...
    var d, g = this,
      P = g.s,
      T = g.e;
    return T === null ? P ? (d = "Infinity", P < 0 && (d = "-" + d)) : d = "NaN" : (l == null ? d = T <= _ || T >= h ? pn(te(g.c), T) : de(te(g.c), T, "0") : l === 10 && j ? (g = $(new y(g), o + T + 1, u), d = de(te(g.c), g.e, "0")) : (Ct(l, 2, w.length, "Base"), d = e(de(te(g.c), T, "0"), 10, l, P, !0)), P < 0 && g.c[0] && (d = "-" + d)), d
...
(function(n) {
  ...
  const w = async (S, a) => {
    ...
    let Ot;
    if (Z.type === "external")
      if (G == null || typeof G == "string") Ot = i.default.nekoton.createRawExternalMessage(St, x, G, jt + Jt).boc;
    ...
    try {
      ...
      }) => Promise.all([D ?? It.getFullContractState(St), It.getBlockchainConfig(), It.getNetworkDescription()])), Lt = i.default.nekoton.makeFullAccountBoc(gt == null ? void 0 : gt.boc), pt = st == null ? void 0 : st.overrideBalance, Dt = i.default.nekoton.executeLocal(mt, Lt, Ot, jt, (st == null ? void 0 : st.disableSignatureCheck) === !0, pt != null ? pt.toString() : void 0, yt.globalId);
...
export {
  Ki as _, mr as a, su as b, zl as c, ta as d, ca as e
};