...
const ft = N({
    ...
    setup(e) {
      ...
      return (t, s) => {
        const i = qe;
        return o(), h(i, {
          icon: ("imgResolver" in t ? t.imgResolver : a(Be))("emoji/Construction"),
          title: "Maintenance",
  ...
  ht = N({
    ...
    setup(e) {
      ...
      return (t, s) => (o(), T("div", pt, [e.title ? (o(), T("div", yt, B(e.title), 1)) : O("", !0), e.subtitle ? (o(), T("div", gt, B(e.subtitle), 1)) : O("", !0), a(d) ? (o(), T("div", Tt)) : O("", !0)]))
    }
  }),
  Ct = w(ht, [
    ...
    setup(e) {
      ...
      return (s, i) => {
        ...
        return a(t) ? (o(), h(k, {
          ...
          default: q(() => [j(s.$slots, "default", {}, void 0, !0)]),
          _: 3
    ...
    setup(e, {
      ...
      return (l, n) => {
        ...
        return o(), h(r, {
          ...
          default: q(() => [a(c).label ? (o(), T("div", It, B(a(c).label), 1)) : a(c).icon ? (o(), h(v, {
            key: 1,
            name: a(c).icon,
            class: "icon"
...
`).reduce((r, p) => {
      ...
      return (S, r) => {
        ...
        return o(), h(f, {
          ...
          title: q(() => [a(c).state === "general" ? (o(), T("span", Rt, [se(g("img", {
            src: e.iconUrl,
            alt: "Task icon"
          }, null, 8, Et), [
            [y]
          ]), g("span", null, B(e.productName), 1)])) : O("", !0), a(c).state === "details" ? (o(), T("span", Nt, "Disclaimer")) : O("", !0)]),
          default: q(() => [a(c).state === "general" ? (o(), T("div", wt, [r[8] || (r[8] = g("div", {
            class: "text"
          ...
          }, "Disclaimer"), r[7] || (r[7] = be("."))])])])) : O("", !0), a(c).state === "details" ? (o(), T("div", Bt, [(o(), h(xe(a(v))))])) : O("", !0)]),
          footer: q(() => [a(c).state === "general" ? (o(), h(m, {
            key: 0,
    ...
    setup(e, {
      ...
      return (n, v) => {
        const S = Q,
          ...
          y = ae("img-error");
        return o(), h(f, null, {
          default: q(() => [g("div", Kt, [g("div", Vt, [se(g("img", {
            src: a(ie)(e.task.iconFileKey),
            alt: "Task icon",
            class: "task-icon"
          }, null, 8, Gt), [
            [y]
          ]), g("div", Yt, B(e.task.title), 1), I(S, {
            name: "external-link",
            class: "link-icon",
        ...
        return o(), h(k, {
          ...
          default: q(({
            ...
            return [g("div", je({
              ...
              [c]
            ]), g("div", Xt, [g("div", Zt, B(S.value), 1), r.value || n.value ? (o(), T("div", Jt, [(m = r.value) != null && m.label ? (o(), T("span", ea, B(`${r.value.label}${r.value.postfix}`) + B(n.value ? ", " : ""), 1)) : O("", !0), n.value ? (o(), T("span", ta, B(n.value), 1)) : O("", !0)])) : O("", !0)]), e.task.status ? (o(), h(i, {
              key: 0,
              "claim-override": d.value,
      ...
      return (l, n) => {
        ...
        return o(), h(p, {
          ...
          default: q(({
            ...
            [m]
          ])), 128))])) : O("", !0), g("div", ca, B(C.value), 1), u.value ? (o(), T("div", ua, B(u.value), 1)) : O("", !0), g("div", da, [e.task.status ? (o(), h(v, {
            key: 0,
            "claim-override": k.value,
      ...
      return Ne().onOpenTaskSheet(d.task, () => {
        ...
        return o(), T(L, null, [I(D, {
          ...
          default: q(() => [g("div", {
            ...
            alt: "Task banner",
            class: "banner"
          }, null, 8, ["url"])) : O("", !0), e.task.description ? (o(), T("div", fa, B(e.task.description), 1)) : O("", !0)])) : O("", !0), e.task.subTasks ? (o(), h(ye, {
            key: 2,
            tag: "div",
            name: "list-shuffle-transition",
            class: "nested-tasks"
          }, {
            default: q(() => [(o(!0), T(L, null, Y(e.task.subTasks, (u, _) => (o(), h(y, {
              key: u.id,
          ...
          name: "footer",
          fn: q(() => [e.task.status && !a(te)(e.task.status, s.value[e.task.id]) ? (o(), h(C, {
            key: 0,
    ...
    setup(e) {
      ...
      return (t, s) => {
        ...
        return se((o(), h(ye, {
          ...
          default: q(() => [(o(!0), T(L, null, Y(e.tasks, (c, l) => (o(), h(i, {
            key: c.id,
    ...
    setup(e) {
      ...
      return (l, n) => {
        ...
        return a(k).length ? (o(), T("div", Ca, [I(v, {
          ...
          default: q(() => [(o(!0), T(L, null, Y(a(k), p => (o(), h(r, {
            key: p.id,
    ...
    setup(e) {
      ...
      return (async () => {
        ...
        return o(), T("div", Pa, [a(t) ? (o(), h(C, {
          ...
          key: 1
        }, [g("div", xa, [g("span", Ka, [be(B(("t" in f ? f.t : a(E))("earn.title")) + " ", 1), g("sup", null, B(a(p)), 1)])]), g("div", Va, [(o(!0), T(L, null, Y(a(s), (u, _) => (o(), h(D, {
          key: _,
