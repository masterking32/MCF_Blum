...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function l(o, c) {
    if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(o)))) {
      var S = [],
        ...
        E = void 0;
      try {
        for (var N = o[Symbol.iterator](), j; !($ = (j = N.next()).done) && (S.push(j.value), !(c && S.length === c)); $ = !0);
      } catch (P) {
        v = !0, E = P
      } finally {
        try {
  ...
  function R(o, c) {
    ...
    var S, $, v, E, N, j, P, B;
    if (P = o.split("#"), o = P.shift(), P = o.split("?"), o = P.shift(), P = o.split("://"), P.length > 1) {
      if (S = P.shift().toLowerCase(), c.require_valid_protocol && c.protocols.indexOf(S) === -1) return !1
    } else {
    ...
    if (o = P.join("://"), o === "") return !1;
    if (P = o.split("/"), o = P.shift(), o === "" && !c.require_host) return !0;
    if (P = o.split("@"), P.length > 1) {
      if (c.disallow_auth || P[0] === "" || ($ = P.shift(), $.indexOf(":") >= 0 && $.split(":").length > 2)) return !1;
      var G = $.split(":"),
        ee = n(G, 2),
        re = ee[0],
        ie = ee[1];
    ...
    E = P.join("@"), j = null, B = null;
    var Q = E.match(F);
    if (Q ? (v = "", B = Q[1], j = Q[2] || null) : (P = E.split(":"), v = P.shift(), P.length && (j = P.join(":"))), j !== null && j.length > 0) {
      if (N = parseInt(j, 10), !/^[0-9]+$/.test(j) || N <= 0 || N > 65535) return !1
    } else if (c.require_port) return !1;
    return c.host_whitelist ? I(v, c.host_whitelist) : v === "" && !c.require_host ? !0 : !(!(0, _.default)(v) && !(0, m.default)(v, c) && (!B || !(0, _.default)(B, 6)) || (v = v || B, c.host_blacklist && I(v, c.host_blacklist)))
  }
  p.exports = s.default, p.exports.default = s.default
})(ye, ye.exports);
var Bt = ye.exports;
...
const Kt = {
  ...
  Ht = U({
    ...
    setup(p) {
      ...
      return (m, _) => (d(), w("div", zt, [f("div", Jt, M(e(a).step), 1), f("div", Qt, M(e(a).label), 1)]))
    }
  }),
  le = C(Ht, [
    ...
    setup(p) {
      ...
      return (t, n) => {
        ...
        return d(), w("div", Zt, [f("div", Yt, [e(u) ? (d(), w("div", {
          ...
          onClick: n[0] || (n[0] = l => m())
        }, [((i = e(_)) == null ? void 0 : i.status) === e(me).UPLOADING ? (d(), V(r, {
          key: 0,
          type: e(Re).LIGHT,
          size: 16
        }, null, 8, ["type"])) : (d(), w("img", Xt))])), f("div", en, [f("div", tn, M(("t" in t ? t.t : e(A))("memepad.new.step_1.field_icon.label")), 1), f("div", nn, M(("t" in t ? t.t : e(A))("memepad.new.step_1.field_icon.description", {
    ...
    setup(p, {
      ...
      return Se(u, () => {
        ...
        return d(), w("div", {
          ...
          key: 0,
          for: e(_)
        }, [f("span", null, M(b.label), 1), b.errorCaption ? (d(), w("div", ln, [F[3] || (F[3] = f("img", {
          src: He,
          alt: "Warning icon"
        }, null, -1)), f("div", null, M(b.errorCaption), 1)])) : b.maxLength ? (d(), V(g, {
          key: 1,
          value: u.value,
          ...
          onChange: F[1] || (F[1] = I => b.$emit("change")),
          onInput: F[2] || (F[2] = I => b.$emit("input")),
          onFocus: r,
          onBlur: h
        }, null, 40, rn), [
          [Ze, u.value]
...
const dn = U({
          ...
          switch (l.type) {
            ...
            case q.TEXTAREA: {
              ...
              if (l.type === q.STRING && ((g = l.validators) != null && g.url)) {
                const R = l.validators.url.includePrefix && ((I = l.props) != null && I.prefix) ? `${l.props.prefix}${l.value}` : l.value;
                Dt(R) || y.push({
                  msg: "Invalid URL",
                  isVisible: !0
                })
      ...
      return ne(() => a("channel", {
        ...
        return d(), w("form", {
          ...
          return d(), w("div", {
            ...
            "error-caption": h(g),
            "is-error": i(g),
            "max-length": (R = (I = g.validators) == null ? void 0 : I.maxLength) == null ? void 0 : R.value,
            class: "input",
            onChange: N => t(g),
            onFocus: (o = g.eventHandlers) == null ? void 0 : o.onFocus,
            onBlur: (c = g.eventHandlers) == null ? void 0 : c.onBlur
          }), {
            label: L(() => [Ie(l.$slots, `${g.key}-label`, {}, void 0, !0)]),
            _: 2
          }, 1040, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur"])) : T("", !0), g.type === e(q).TEXTAREA ? (d(), V(F, $e({
            key: 1,
            modelValue: g.value,
            "onUpdate:modelValue": N => g.value = N,
            ref_for: !0
          ...
          }), null, 16, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur"])) : T("", !0), Ie(l.$slots, `${g.key}-after`, {}, void 0, !0)])
        }), 128))], 32)
      }
    }
  }),
    ...
    setup(p, {
      ...
      return (h, i) => {
        ...
        return d(), w("div", pn, [k(l, {
          ...
          "onUpdate:modelValue": i[0] || (i[0] = I => e(m).iconFileKey = I)
        }, null, 8, ["modelValue"]), k(b, {
          modelValue: e(u),
          "onUpdate:modelValue": i[1] || (i[1] = I => ae(u) ? u.value = I : null),
          onChannel: i[2] || (i[2] = I => t.value = I)
  ...
  bn = U({
    ...
    setup(p) {
      return (s, a) => {
        const m = X;
        return d(), w("div", fn, [p.iconName ? (d(), V(m, {
          key: 0,
          name: p.iconName,
          class: "icon"
        }, null, 8, ["name"])) : T("", !0), f("div", vn, [f("span", gn, M(p.title), 1), p.isOptional ? (d(), w("span", hn, M(` ${("t"in s?s.t:e(A))("base.optional")}`), 1)) : T("", !0)])])
      }
    }
  }),
  We = C(bn, [
    ...
    setup(p) {
      ...
      return (t, n) => {
        ...
        return d(), w("div", yn, [k(r, {
          ...
          type: e(Re).LIGHT,
          size: 16
        }, null, 8, ["type"]), f("div", kn, M(("t" in t ? t.t : e(A))("memepad.new.step_1.field_banner.uploading")), 1)])) : (d(), w("div", {
          key: 2,
          ...
          src: et,
          alt: "Add"
        }, null, -1)), f("div", Sn, [f("div", An, M(("t" in t ? t.t : e(A))("memepad.new.step_1.field_banner.description", {
  ...
  Nn = U({
    ...
    setup(p, {
      ...
      return ne(() => {
        ...
        const l = En,
          y = X;
        return d(), w("div", Mn, [f("div", Vn, [k(at, {
          name: "list-shuffle-transition"
        }, {
          default: L(() => [(d(!0), w(D, null, Z(e(u), (b, F) => (d(), V(l, {
            key: b.provider,
          ...
          default: L(() => [e(t).length > 0 ? (d(), w("div", xn, [k(y, {
            name: "plus",
            class: "plus-icon"
  ...
  Dn = U({
    ...
    setup(p) {
      ...
      return (a, m) => {
        const _ = Ln,
          u = Ft;
        return d(), w("div", jn, [f("div", Bn, [f("div", qn, M(("t" in a ? a.t : e(A))("memepad.new.step_1.field_nsfw.label")), 1), k(_, {
          modelValue: s.value,
  ...
  ta = U({
    ...
    setup(p, {
      ...
      const n = v => it(v, {
        ...
        l = Le(),
        y = Ae(),
        b = () => Oe().bottom.success(A("memepad.jetton.new.error_alert"));
      y.onConnectError(b);
      const F = x(!1),
        g = O(() => {
          ...
          const v = (() => {
            ...
            E = {
              ...
              details: [{
                ...
                label: `${A("memepad.jetton.fees_platform")}: ${de((P=t.value.overview)==null?void 0:P.platformFee,2)} TON`
              }] : []]
            },
            N = (() => {
              if (!v.value) return;
        ...
        o = () => {
          I.value.errorMessage || S()
        },
        c = async () => {
          if (I.value.errorMessage) return;
      ...
      return Se(() => t.value.share, () => {
        ...
        return d(), V(Q, {
          ...
          default: L(() => [f("div", Qn, [k(j, {
            ...
            modifier: n,
            onBlur: R
          }, null, 8, ["modelValue"]), f("div", Hn, [e(g) ? (d(), w("span", Zn, M(e(g)), 1)) : e(g) === void 0 ? (d(), V(P, {
            key: 1,
            class: "skeleton"
          })) : T("", !0)])])]),
          "bottom-action": L(() => [f("div", Yn, [e(I).showInfo ? (d(), w("div", Xn, [e(I).tonBalance.label && !e(I).loading ? (d(), V(B, {
            key: 0,
            balance: e(I).tonBalance.label
          }, null, 8, ["balance"])) : (d(), V(P, {
            key: 1,
            class: "skeleton"
          })), e(I).loading ? (d(), V(P, {
            key: 3,
            ...
            key: 2,
            details: e(I).fees.details,
            "total-label": e(I).fees.label,
            "error-message": e(I).errorMessage
          }, null, 8, ["details", "total-label", "error-message"]))])) : T("", !0), e(I).isEnoughTon ? (d(), V(re, {
            key: 2,
            fill: "",
            size: e(J).LARGE,
            loading: e(I).loading,
            ...
            default: L(() => [f("div", ea, M(("t" in v ? v.t : e(A))("memepad.new.step_3.next_btn")), 1)]),
            _: 1
          }, 8, ["size", "loading"])) : (d(), V(ee, {
            key: 1
          }))])]),
  ...
  ia = U({
    ...
    setup(p) {
      return (s, a) => (d(), w("div", aa, [f("img", {
        ...
        alt: "Jetton logo"
      }, null, 8, oa), f("div", sa, [f("div", la, M(s.ticker), 1), f("div", ra, M(s.name), 1)])]))
    }
  }),
  ua = C(ia, [
    ...
    setup(p) {
      return (s, a) => {
        ...
        return d(), w("div", ca, [(d(!0), w(D, null, Z(s.details.sections, u => (d(), w("div", {
          key: u.title,
          class: "row"
        }, [f("div", da, M(u.title), 1), f("div", pa, [k(_, null, {
          default: L(() => [k(m, {
            name: "circle-help",
            class: "tooltip-icon"
          })]),
          ...
          _: 2
        }, 1024), f("span", _a, M(u.label), 1)])]))), 128)), s.details.totalSection ? (d(), w(D, {
          key: 0
        }, [a[0] || (a[0] = f("div", {
          class: "divider"
        }, null, -1)), f("div", fa, [f("div", va, M(s.details.totalSection.title), 1), s.notEnoughBalance ? (d(), w("div", ga, [k(m, {
          name: "circle-help",
          class: "icon"
        }), f("span", ha, M(("t" in s ? s.t : e(A))("memepad.jetton.not_enough_error", {
          ticker: "TON"
        })), 1)])) : (d(), w("div", ba, [f("span", ya, M(s.details.totalSection.label), 1)]))])], 64)) : T("", !0)])
      }
    }
  }),
  ka = C(wa, [
  ...
  Fa = U({
    ...
    setup(p, {
      ...
      const a = p,
        ...
        _ = Le(),
        u = Ae(),
        t = () => Oe().bottom.success(A("memepad.jetton.new.error_alert"));
      u.onConnectError(t);
      const n = O(() => {
      ...
      return (y, b) => {
        ...
        return d(), w("div", Sa, [k(F, {
          ...
          name: y.form.name,
          class: "logo-ticker"
        }, null, 8, ["logo-file-key", "ticker", "name"]), k(I, {
    ...
    setup(p, {
      ...
      return mt(() => {
        ...
        const y = Ut,
          ...
          g = se,
          I = vt;
        return d(), w("div", Ia, [k(y), e(_) === "ERROR" ? (d(), w(D, {
          key: 0
        }, [f("div", $a, [f("div", Ea, [f("div", Ma, [k(b, {
          name: "warning",
          class: "icon"
        })])]), f("div", Va, M(("t" in i ? i.t : e(A))("memepad.new.failed.title", {
          ticker: i.form.ticker
        })), 1), f("div", xa, M(("t" in i ? i.t : e(A))("memepad.new.failed.subtitle")), 1)]), k(g, null, {
          default: L(() => [k(F, {
            fill: "",
          ...
          class: "dot"
        }, null, -1)), f("div", Ta, M(("t" in i ? i.t : e(A))("memepad.new.step_launch.title")), 1)]), f("div", La, M(("t" in i ? i.t : e(A))("memepad.new.step_launch.subtitle")), 1)]), e(_) === "ROCKET" ? (d(), w("div", Oa, [k(I, {
          name: "animations/Rocket",
          size: 348
        })])) : T("", !0), k(g, null, {
          default: L(() => [f("div", ja, [f("div", Ba, [f("div", qa, M(("t" in i ? i.t : e(A))("cabal_arena_banner.title")), 1), f("div", Da, M(("t" in i ? i.t : e(A))("cabal_arena_banner.subtitle")), 1), f("button", {
            type: "button",
            class: "reset",
            onClick: h
          }, M(("t" in i ? i.t : e(A))("cabal_arena_banner.btn_label")), 1), l[3] || (l[3] = f("img", {
            src: _t
          }, null, -1))]), k(F, {
            fill: "",
  ...
  Ja = U({
    ...
    setup(p) {
      ...
      const n = s.jettonManagement.getWaitForCreateStatus(),
        r = x(s.retryPayload ? At(s.retryPayload) : {
          step: 1,
          step1: pe.step1(),
          step2: pe.step2(),
          step3: pe.step3()
      ...
      const I = o => {
        ...
        R = async o => {
          ...
          })(), !0) : (c.extra && c.extra instanceof Error && c.extra instanceof gt && a.memepad.memepadJettonLaunchWalletUiError(), I(o), !1)
        };
      return (o, c) => {
        const S = Wt,
          $ = _n,
          ...
          N = Pa,
          j = Wa;
        return d(), w("div", za, [e(r).step !== 5 ? (d(), V(S, {
          key: 0,
          step: e(r).step,
          "count-steps": 4
        }, null, 8, ["step"])) : T("", !0), e(r).step === 1 ? (d(), V($, {
          key: 1,
          state: e(r),
          onContinue: c[0] || (c[0] = P => i(e(r), P))
        }, null, 8, ["state"])) : T("", !0), e(r).step === 2 ? (d(), V(v, {
          key: 2,
          state: e(r),
          onContinue: c[1] || (c[1] = P => l(e(r), P))
        }, null, 8, ["state"])) : T("", !0), e(r).step === 3 ? (d(), V(E, {
          key: 3,
          state: e(r),
          "jetton-management": s.jettonManagement,
          onContinue: c[2] || (c[2] = P => y(e(r), P)),
          onUpdate: c[3] || (c[3] = P => b(e(r), P))
        }, null, 8, ["state", "jetton-management"])) : T("", !0), e(r).step === 4 ? (d(), V(N, {
          key: 4,
          form: e(Me)(e(r)),
          "jetton-management": s.jettonManagement,
          "ton-usd-rate": o.tonUsdRate,
          "launch-callback": R,
          onContinue: c[4] || (c[4] = P => F(e(r)))
        }, null, 8, ["form", "jetton-management", "ton-usd-rate"])) : T("", !0), e(r).step === 5 ? (d(), V(j, {
          key: 5,
  ...
  Za = U({
    ...
    setup(p) {
      ...
      return (() => {
        ...
        const r = Qa,
          h = Tt;
        return d(), w("div", Ha, [e(m) ? (d(), V(r, {
          key: 0,
          "ton-usd-rate": e(a),
          "retry-payload": e(s)(),
          "jetton-management": e(m)
        }, null, 8, ["ton-usd-rate", "retry-payload", "jetton-management"])) : (d(), V(h, {
          key: 1
        }))])
      }
    }
