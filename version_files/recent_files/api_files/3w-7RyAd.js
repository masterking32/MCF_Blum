...
const St = {
    ...
    setup(u) {
      return (t, l) => {
        ...
        return c(), _("div", St, [n("div", Ct, [v(s, {
          ...
          class: "background"
        }), n("div", $t, h(("t" in t ? t.t : e(k))("memepad.intro.title")), 1), n("button", {
          type: "button",
          class: "reset",
          onClick: l[0] || (l[0] = i => t.$emit("start"))
        }, h(("t" in t ? t.t : e(k))("memepad.intro.button_text")), 1)]), v(o, {
          "no-background": ""
        }, {
          default: B(() => [n("div", Tt, h(("t" in t ? t.t : e(k))("memepad.intro.note")), 1)]),
          _: 1
        })])
      }
    }
      ...
      return (g, T) => {
        ...
        return c(), L(I, {
          ...
          default: B(() => [n("div", kt, [v(C, {
            ...
            onClick: f
          }, [n("span", wt, h(("t" in g ? g.t : e(k))("base.read_more")), 1), v(y, {
            name: "arrow-right",
            class: "icon"
          ...
          }, h(("t" in g ? g.t : e(k))("memepad.sheet.dont_show_again_label")), 1)])])) : A("", !0), v($, {
            label: g.buttonText,
            fill: "",
            size: e(We).LARGE,
            onClick: S
  ...
  jt = D({
    ...
    setup(u, {
      ...
      const {
        $webApp: l
      } = ge(), s = t, o = b(!1), i = b(l.storage.local.get(ke) ? "watched" : "unwatched"), m = () => {
      ...
      return (r, d) => {
        ...
        return c(), _(V, null, [n("button", {
          ...
          class: "seedling"
        }, null, -1)), Xe(" " + h(("t" in r ? r.t : e(k))("memepad.explore.launch.button_text")), 1)]), v(f, {
          modelValue: e(o),
          "onUpdate:modelValue": d[0] || (d[0] = M => de(o) ? o.value = M : null),
          title: ("t" in r ? r.t : e(k))("memepad.explore.launch_modal.title"),
          subtitle: ("t" in r ? r.t : e(k))("memepad.explore.launch_modal.subtitle"),
          "button-text": ("t" in r ? r.t : e(k))("memepad.explore.launch_modal.button_text"),
          "hide-read-more": "",
  ...
  Wt = D({
    ...
    setup(u) {
      const t = u,
        l = E(() => k(`memepad.explore.event.kind.${t.event.type.toLowerCase()}`).toLowerCase()),
        s = E(() => z().resolve({
    ...
    setup(u) {
      ...
      return ($, I) => {
        ...
        return c(), _("div", vs, [n("div", hs, [e(l).isLowEndDevice.value ? A("", !0) : (c(), _("img", {
          ...
          size: 28
        }), n("div", Ss, h(("t" in $ ? $.t : e(k))("memepad.explore.spotlight.title")), 1)]), t.list.length > 1 ? (c(), _("div", {
          key: 0,
          class: "controls",
          style: se({
        ...
        return c(), L(g, {
          ...
          default: B(() => {
            ...
            return [v(M, {
              ...
              accuracy: 0
            }).full), 1)])) : A("", !0)])) : d.mode === e(G).MY_TOKENS ? (c(), _("div", Os, [n("div", js, h(e(m)), 1)])) : A("", !0)]), d.mode === e(G).BASE ? (c(), _("div", Us, [n("div", Ks, [n("span", Bs, h(("t" in d ? d.t : e(k))("memepad.jetton.stats.market_cap")), 1), n("span", Fs, h(d.jetton.stats.marketCap ? `$${("formatCount"in d?d.formatCount:e(W))(d.jetton.stats.marketCap,{accuracy:o(d.jetton.stats.marketCap)}).full}` : "-"), 1)]), n("div", Vs, [v(S, {
    ...
    setup(u) {
      ...
      return (a, r) => {
        ...
        return c(), _("div", qs, [n("div", zs, [v(f, {
          ...
          _: 1
        }, 8, ["modelValue", "items"])]), (e(l).wallet.value.status === "must_reconnect" || e(l).wallet.value.status === "not_found") && t.value === e(p).MY_TOKENS ? (c(), _("div", Qs, [n("div", Zs, h(("t" in a ? a.t : e(k))("memepad.explore.my_tokens.connect_text")), 1), n("button", {
          type: "button",
          class: "reset",
          onClick: r[2] || (r[2] = T => e(s).runConnectionFlow())
        }, h(("t" in a ? a.t : e(k))("wallet.connect.btn")), 1)])) : e(l).wallet.value.status === "loading" && t.value === e(p).MY_TOKENS ? (c(), _("div", ea, [v(M, {
          type: e(lt).LIGHT
          ...
          class: "icon"
        }), n("div", sa, h(("t" in a ? a.t : e(k))("memepad.explore.my_tokens.empty_text")), 1)])) : A("", !0)], 64)) : (c(), _(V, {
          key: 3
        }, oe(6, T => n("div", {
          key: T,
          class: "skeleton"
    ...
    setup(u, {
      ...
      return ae(a, f), Se().memepad.memepadSearchOpen(), Et(async () => {
        ...
        return c(), _("div", la, [v(T, {
          ...
          placeholder: ("t" in S ? S.t : e(k))("memepad.search.input_placeholder"),
          activated: e(m),
          autofocus: "",
          "is-loading": e(o).isSearching.value
        }, null, 8, ["modelValue", "placeholder", "activated", "is-loading"]), e(o).data.value ? (c(), _(V, {
          key: 0
        }, [e(o).data.value.length === 0 ? (c(), _("div", ca, h(("t" in S ? S.t : e(k))("memepad.search.empty_text")), 1)) : (c(), L(C, {
          key: 1,
  ...
  da = () => {
    ...
    let M;
    const S = async () => {
      await f.value.exec(), M = ae(r, async C => {
        var w;
      ...
      var C, y;
      f.value.destroy(), (C = a.value) == null || C.stepList.destroy(), a.value = void 0, (y = l.value) == null || y.destroy(), l.value = void 0, M == null || M()
    };
    u.onConnected(() => {
    ...
    setup(u) {
      ...
      return (T, C) => {
        ...
        const y = Ut,
          ...
          N = yt,
          U = ra;
        return c(), _(V, null, [e(d) ? (c(), _("div", _a, [n("div", va, [n("div", ha, h(("t" in T ? T.t : e(k))("memepad.explore.title")), 1), v(y, {
          onLaunch: M
        })]), e(t) ? (c(), L(w, {
          key: 0,
          event: e(t),
