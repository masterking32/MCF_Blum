    ...
    try {
      for (var c = e.widgetMap[Symbol.iterator](), l; !(t = (l = c.next()).done); t = !0) {
        ...
        if (!(s.isComplete || s.isFailed || s.isResetting)) {
          var T = s.watchcat.seq - 1 - Pr,
            k = s.watchcat.lastAckedSeq < T,
            O = s.watchcat.seq - 1 - Vr,
      ...
      T = function(n, i) {
        ...
        if (V) {
          ...
          if (!(!Ae || !pe)) {
            ...
            et || g("Turnstile Initialization Error ", 3606), j.style.display = "none", j.style.border = "none", j.style.overflow = "hidden", j.setAttribute("src", Rt(Ae, H, f, K, !1, "g", z.New, _t(et))), j.onerror = function() {
              if (Y) {
            ...
            var rt;
            j.tabIndex = (rt = f.tabindex) !== null && rt !== void 0 ? rt : 0, j.title = "Widget containing a Cloudflare security challenge", Vt.appendChild(j);
        ...
        if (!(!n.widgetId || !y.widgetMap.has(n.widgetId))) {
          ...
          if (!(!i || !r)) switch (n.event) {
            case "init": {
              ...
              d || g("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074), r.mode = n.mode, r.nextRcV = n.nextRcV, r.mode === q.Invisible && r.params["refresh-expired"] === Z.Manual && x("refresh-expired=manual is impossible in invisible mode, consider using '".concat(Z.Auto, "' or '").concat(Z.Never, ".'")), r.mode !== q.Managed && r.params["refresh-timeout"] !== ce.Auto && x("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."), r.params.appearance === Q.Always || r.isExecuting && r.params.appearance === Q.Execute ? Mt(d, r) : xr(d), d.style.display = "";
            ...
            case "closeFeedbackReportIframe": {
              ...
              _e || g("Received state for an unknown widget: ".concat(n.widgetId), 3078), vr("".concat(i, "-fr"));
              break
            }
            case "tokenExpired": {
              var ie, be = n.token;
              r.isExpired = !0, (ie = r.cbExpired) === null || ie === void 0 || ie.call(r, be), r.params["refresh-expired"] === Z.Auto && !r.isResetting && _(z.AutoExpire, i);
              break
            }
            ...
            case "refreshRequest": {
              c(r, K, n.widgetId), _(z.ManualRefresh, i);
              break
            }
            case "reloadRequest": {
            ...
            case "interactiveBegin": {
              var we, Ne = r.shadow.getElementById(i);
              Ne || g("Cannot layout widget, Element not found (#".concat(i, ")."), 3076), (we = r.cbBeforeInteractive) === null || we === void 0 || we.call(r), r.params.appearance === Q.InteractionOnly && Mt(Ne, r);
              break
            }
            case "interactiveEnd": {
              var Ee;
            ...
            case "requestExtraParams": {
              ...
              var Je = {},
                ...
                Se = U() - Re;
              (Te = Y.contentWindow) === null || Te === void 0 || Te.postMessage(Pe({
                source: W,
                widgetId: n.widgetId,
                event: "extraParams",
                action: r.action,
