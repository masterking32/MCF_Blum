      ...
      T = function(n, i) {
        ...
        if (V) {
          ...
          if (!(!Ie || !pe)) {
            ...
            et || g("Turnstile Initialization Error ", 3606), j.style.display = "none", j.style.border = "none", j.style.overflow = "hidden", j.setAttribute("src", Rt(Ie, H, f, K, !1, "b", z.New, _t(et))), j.onerror = function() {
              if (Y) {
        ...
        return Ve(this, function(V) {
          switch (V.label) {
            case 0:
              ...
              m = "h/".concat("b", "/"), w = new URL(d), E = "https", S = "", D = "".concat(E, "://").concat(w.host, "/cdn-cgi/challenge-platform/").concat(m, "rc/").concat(r).concat(S), V.label = 1;
            case 1:
      ...
      if (n.source === W) {
        ...
        if (!(!n.widgetId || !y.widgetMap.has(n.widgetId))) {
          ...
          if (!(!i || !r)) switch (n.event) {
            ...
            case "tokenExpired": {
              var ie, xe = n.token;
              r.isExpired = !0, (ie = r.cbExpired) === null || ie === void 0 || ie.call(r, xe), r.params["refresh-expired"] === Z.Auto && !r.isResetting && _(z.AutoExpire, i);
              break
            }
