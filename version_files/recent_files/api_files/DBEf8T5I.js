      ...
      return (i, o) => {
        ...
        return rt(), ut("div", xi, [at(l, {
          ...
          default: Nt(() => [Y("div", zi, ot(("t" in i ? i.t : U(ct))("wallet.points.meme_modal.title")), 1), Y("div", Ui, [(rt(!0), ut(je, null, fs(U(s), (b, S) => (rt(), ut("div", {
            ...
            name: "chevron-right",
            class: "icon"
          })]), Y("div", Vi, [b.reward ? (rt(), ut("span", Ji, ot(r(b.reward)), 1)) : ce("", !0), b.postfix ? (rt(), ut("span", Qi, ot(" " + b.postfix), 1)) : ce("", !0)])]), at(f, {
            name: b.icon,
            class: "image"
  ...
  Ao = Xt({
    ...
    setup(n, {
      ...
      return t({
        ...
        }, [U(e).status === "loading" ? (rt(), ut("div", Qa, [at(p)])) : U(e).status === "waiting" ? (rt(), ut("div", Xa, [at(T), Y("div", Ya, ot(("t" in _ ? _.t : U(ct))("wallet.drop.queue_page.waiting.title")), 1), at(s, {
  ...
  start() {
    this.isRunning || this.promise != null || (this.isRunning = !0, this.promise = (async () => {
      ...
      for (; this.isRunning && !e.complete;) try {
        ...
        const i = s.filter(l => (t.fromLt == null || Qe.LT_COLLATOR.compare(l.id.lt, t.fromLt) > 0) && (t.fromUtime == null || l.createdAt > t.fromUtime));
        if (i.length == 0) {
          e.complete = !0;
          break
        }
...
class Ro {
  constructor(t, e) {
    this.provider = t, this.params = e, this.queue = new bs, this.isRunning = !1, this.semaphore = new Qe.Semaphore(10)
  }
  start() {
...
function Wo(n, t, e, s, r, i, o) {
  try {
    ...
    const T = V(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      ...
      w = H;
    c.runLocal(p, n.__wbg_ptr, T, b, S, A, h, w, Q(r), i, !wt(o), wt(o) ? 0 : o);
...
function Xo(n, t, e, s, r) {
  try {
    ...
    var i = wt(s) ? 0 : V(s, c.__wbindgen_malloc, c.__wbindgen_realloc),
      o = H;
    c.getExpectedAddress(p, T, b, S, A, e, i, o, Q(r));
    var l = R().getInt32(p + 4 * 0, !0),
      _ = R().getInt32(p + 4 * 1, !0),
      f = R().getInt32(p + 4 * 2, !0);
    if (f) throw W(_);
...
function ec(n, t, e, s) {
  try {
    ...
    var r = wt(s) ? 0 : V(s, c.__wbindgen_malloc, c.__wbindgen_realloc),
      i = H;
    c.unpackFromCell(f, Q(n), p, T, e, r, i);
...
function lc(n, t, e) {
  ...
  try {
    const T = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      h = H;
    c.encodeInternalInput(T, b, S, A, h, Q(e));
    var i = R().getInt32(T + 4 * 0, !0),
      o = R().getInt32(T + 4 * 1, !0),
      l = R().getInt32(T + 4 * 2, !0),
      _ = R().getInt32(T + 4 * 3, !0),
...
function kc(n, t, e, s, r, i, o) {
  try {
    ...
    var l = wt(r) ? 0 : V(r, c.__wbindgen_malloc, c.__wbindgen_realloc),
      _ = H;
    c.createExternalMessageWithoutSignature(b, n.__wbg_ptr, S, A, h, w, $, y, l, _, Q(i), o);
    var f = R().getInt32(b + 4 * 0, !0),
      p = R().getInt32(b + 4 * 1, !0),
      T = R().getInt32(b + 4 * 2, !0);
    if (T) throw W(p);
...
function Sc(n, t, e, s, r, i, o, l) {
  try {
    ...
    const m = V(o, c.__wbindgen_malloc, c.__wbindgen_realloc),
      F = H;
    c.createExternalMessage(S, n.__wbg_ptr, A, h, w, $, y, v, _, f, Q(i), m, F, l);
  ...
  async subscribeToContract(t, e, s) {
    return this._subscriptionsMutex.use(async () => {
      ...
      if (s == null) o = r(i.client);
        ...
        p != null ? (o = r(p), Qs(o) && i.internal.delete(s)) : o = r({
          state: !1,
          transactions: !1
        })
      }
      ...
      if (Qs(l)) return this._subscriptionStates.delete(t), await this._tryUnsubscribe(t), {
        ...l
      };
...
var Ln = {},
  ...
  ee = Math.floor,
  Qt = "[BigNumber Error] ",
  Xs = Qt + "Number primitive has more than 15 significant digits: ",
  ie = 1e14,
  it = 14,
  Qn = 9007199254740991,
...
function Kr(n) {
  ...
  function y(u, d) {
    ...
    if (K = K.slice(N, ++M)) {
      if (M -= N, k && y.DEBUG && M > 15 && (u > Qn || u !== ee(u))) throw Error(Xs + L.s * u);
  ...
  return r.absoluteValue = r.abs = function() {
    ...
    var d, g, P, C, O, N, k, M, K, L, z, et, nt = this,
      _t = nt.c;
    if (u != null && (k = new y(u), !k.isInteger() && (k.c || k.s !== 1) || k.lt(i))) throw Error(Qt + "Argument " + (k.isInteger() ? "out of range: " : "not an integer: ") + B(k));
...
(function(n) {
  ...
  const w = async (I, a) => {
    ...
    if (Z == null && (jt(a, I), Z = await I.connectionController.use(async ({
      ...
      }) => St.getFullContractState(E))), Z == null) throw J(a, "Account not found");
    ...
    let Ot;
    if (Z.type === "external")
      if (G == null || typeof G == "string") Ot = i.default.nekoton.createRawExternalMessage(It, x, G, $t + Jt).boc;
    ...
    const pt = async re => {
      try {
        return Lt.prepareMessage({
          ...
          timeout: ~~re,
          signatureId: ft
        }, new f.AccountsStorageContext(St, Jt, i.default.nekoton, Ot))
      } catch (zn) {
    ...
    try {
      ...
      Lt = await pt.prepareMessage({
        ...
        timeout: 60,
        signatureId: ft
      }, new f.AccountsStorageContext(St, $t, i.default.nekoton, Jt))
    } catch (pt) {
      throw J(a, pt.toString())
    }
  ...
  const J = (I, a, E) => new si(2, `${I.method}: ${a}`, E);
