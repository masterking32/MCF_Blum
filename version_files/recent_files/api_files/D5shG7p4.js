...
`, r), i && i(r, n)
  ...
  function Ze() {
    ...
    const e = t => {
      ...
      }), (!xe || t - xe > 64) && (Y = window.scrollY || window.pageYOffset, _e = Y - qe, qe = Y, xe = t, (_e > 1e3 || _e < 0 && !qe && !Y) && Ke()), s ? (hs(), ye = requestAnimationFrame(e)) : cancelAnimationFrame(ye)
    };
...
` && w.push(F);
  ...
  class ls {
    ...
    destroy() {
      ...
      (e = this.curtain) != null && e.gl && (this.curtain.dispose(), this.curtain = null), this.element && (this.element.removeAttribute("data-us-initialized"), this.element.removeAttribute("data-scene-id"), (t = this.element.querySelector("canvas")) == null || t.remove(), this.element.querySelectorAll("[data-us-text]").forEach(s => {
        s.remove()
      })), this.layers.filter(s => s.dispose).forEach(s => s.dispose()), this.layers = [], f.scenes = f.scenes.filter(s => s.id !== this.id), f.scenes.length || Je()
    }
    resize() {
  ...
  f.addScene = xt, f.destroy = ps, f.init = fs, f.unbindEvents = Je, Object.defineProperty(f, Symbol.toStringTag, {
    value: "Module"
  })
});
const zs = {
