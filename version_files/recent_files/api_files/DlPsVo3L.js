...
const sn = {
      ...
      const s = b,
        ...
        r = Ue(() => {
          ...
          const v = p.value.children[0].offsetHeight + 10,
            g = p.value.scrollTop;
          Math.round(g / v) === 0 ? n.value = S.MP : n.value = S.BP
    ...
    setup(b) {
      const s = b,
        ...
        n = B(() => s.type === "points" ? [{
          ...
          value: `${x(s.percentFromFriends,{trim:!0})}%`,
          text: [{
          ...
          value: `${x(s.percentFromFriendsOfFriends,{trim:!0})}%`,
          text: [{
    ...
    setup(b, {
      ...
      const o = b,
        ...
        p = async () => {
          ...
          const r = Se(o.canClaimAt - F.ms100ticker.value, "letters");
    ...
    setup(b) {
      return (s, o) => {
        const n = M,
          F = q,
          l = Oe("img-loader");
        return a(), d("div", ts, [t("div", os, [t("div", as, m(s.fren.letterAvatar), 1), s.fren.avatarUrl ? Ke((a(), d("img", {
          key: 0,
  ...
  gs = $({
    ...
    setup(b, {
      ...
      const o = s;
      return Ne().initHandler(() => o("close"), "frens-referral-modal"), (n, F) => {
        const l = us,
          p = Xe;
        return a(), I(p, null, {
      ...
      return Le(s, o => {
        ...
        return a(), I(p, {
          ...
          default: k(() => [t("div", bs, [i(F, {
            ...
            src: ("imgResolver" in o ? o.imgResolver : e(Re))("frens/leaderboards-intro-sheet", "webp")
    ...
    setup(b) {
      ...
      const r = () => {
        ...
        w = async () => oe(await N.getFrens({
          ...
          if (!ae(f)) return f;
          if (!f.data.enableNewBalance) return H({
            frensUsing: f.data,
          ...
          if (!l.value) throw We("Frens data is not loaded");
          if (!l.value.enableNewBalance) {
            const y = await N.claimFrens();
            return y.err ? y : (K.exec(), H(y.data.claimBalance))
          }
          const u = await N.claimWalletFrensBalance();
          return u.err ? u : (K.exec(), H(u.data.amount))
        }, V = f => {
          Ve().makeConfetti();
          const u = Y(f);
          De().success(c("base.you_got_bp", {
            bp: u
          })), ze().friendsInvite.frensClaimed(f), setTimeout(() => {
            K.exec(), se().update()
          }, 5e3)
      ...
      return (async () => {
        ...
        const y = un,
          ...
          Be = ks,
          Ae = nn;
        return a(), d("div", ws, [e(F) && e(l) && e(p) && e(R) && e(n) ? (a(), d(O, {
          key: 0
        }, [i(y, {
          my: e(n)
          ...
          points: k(() => [i(he, {
            "amount-for-claim": e(R).amountForClaim,
            "can-claim": e(R).canClaim,
            "can-claim-at": e(R).canClaimAt,
