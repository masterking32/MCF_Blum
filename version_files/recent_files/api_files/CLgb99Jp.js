...
const Be = h(Se, [
    ...
    setup(e) {
      ...
      return (n, r) => {
        ...
        return d(), _("div", Ee, [m("div", Ae, [c(t), c(l, {
          ...
          key: 0,
          class: "score",
          to: ("useRouter" in n ? n.useRouter : a(U))().resolve({
            name: "tribe-top"
          })
        }, {
          default: V(() => [c(o, {
            ...
            class: "left-wing"
          }), m("span", Fe, S(("formatFloatLine" in n ? n.formatFloatLine : a(W))(e.rank, {
            accuracy: 0
          })), 1), c(o, {
            name: "chevron-right",
            class: "icon"
  ...
  ze = w({
    ...
    setup(e) {
      ...
      }, [m("div", Ke, S(e.label), 1), m("div", He, [ie(n.$slots, "default", {}, () => [P(S(e.value), 1)], !0)])], 2))
    }
  }),
  Ge = h(ze, [
  ...
  Ze = w({
    ...
    setup(e, {
      ...
      const s = e,
        n = $(() => H(s.rank));
      $(() => le(s.perk)), $(() => H(s.userRank)), $(() => v(`tribes.item.summary.perks.value_${(s.perk??z.FARMING10).toLowerCase()}`));
      ...
      return (t, l) => {
        const o = ee,
          ...
          g = J,
          T = Y;
        return d(), _("div", We, [c(o, {
          label: ("t" in t ? t.t : a(v))("tribes.item.summary.title"),
          to: ("useRouter" in t ? t.useRouter : a(U))().resolve({
            name: "tribe-top"
          }).fullPath
        }, null, 8, ["label", "to"]), m("div", De, [e.role ? (d(), k(u, {
          key: 0,
          ...
          value: ("formatFloatLine" in t ? t.formatFloatLine : a(W))(s.countMembers, {
            accuracy: 0
          })
        }, null, 8, ["label", "value"])])])
      }
  ...
  st = w({
    ...
    setup(e) {
      const i = e,
        ...
        n = $(() => {
          if (!(!i.leaderboard || !i.leaderboard.items.length)) return U().resolve({
  ...
  it = w({
    ...
    setup(e) {
      const i = e,
        s = O(e, "modelValue"),
        n = $(() => i.role === F.OWNER ? v("tribes.item.share.text_owner", {
          title: i.title
      ...
      return (t, l) => {
        ...
        return d(), k(o, {
          ...
          startapp: a(r),
          "share-text": a(n),
          onCopyLink: l[1] || (l[1] = u => ("useAnalytics" in t ? t.useAnalytics : a(G))().tribes.tribeInviteSent({
            method: "copy"
          })),
          onShareLink: l[2] || (l[2] = u => ("useAnalytics" in t ? t.useAnalytics : a(G))().tribes.tribeInviteSent({
            method: "share"
          }))
  ...
  At = w({
    ...
    setup(e, {
      ...
      const n = e,
        ...
        g = L(!1),
        T = L(),
        b = $(() => !!(o.value || n.myTribe && n.myTribe.role === F.OWNER && n.myTribe.countMembers > 1)),
        y = () => {
          o.value = !0, R()
        },
        R = () => {
          ...
          if (n.variant === "list") {
            ...
            const f = [{
              ...
              p = `tribes.leave.popup.message_${(F.OWNER??F.MEMBER).toLowerCase()}`;
