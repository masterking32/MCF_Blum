...
const Se = v(Ie, [
    ...
    setup(e) {
      ...
      return (a, o) => {
        ...
        return s(t) ? (l(), d("div", {
          ...
          name: s(t).icon,
          class: "icon"
        }, null, 8, ["name"]), _("div", xe, f(s(t).label), 1)], 2)) : w("", !0)
      }
    }
  }),
  Ke = v(Ee, [
    ...
    setup(e) {
      const n = e,
        ...
        o = h(() => {
          ...
          if (t.value.status !== K.STATUS.OK) return {
            type: "status",
      ...
      return (i, c) => {
        ...
        return l(), d("div", De, [y(u, {
          icon: s(t).icon
        }, null, 8, ["icon"]), _("div", Oe, [_("div", Be, f(s(t).title), 1), s(a) ? (l(), d("div", Ve, f(s(a)), 1)) : w("", !0)]), s(o) ? (l(), d(I, {
          key: 0
        }, [s(o).type === "text" ? (l(), d("div", Le, f(s(o).text), 1)) : s(o).type === "status" ? (l(), p(b, {
          key: 1,
          status: s(o).status,
          class: "status"
  ...
  je = g({
    ...
    setup(e, {
      ...
      return St(() => a.value && o.observe(a.value)), Ut(() => o.disconnect()), (i, c) => (l(), d("div", Fe, [O(i.$slots, "default", {}, void 0, !0), _("div", {
        ref_key: "endRef",
        ref: a,
        class: "end"
      }, null, 512)]))
...
const pn = v(un, [
    ...
    setup(e) {
      ...
      return (i, c) => {
        ...
        return l(), d("div", Tn, [(l(!0), d(I, null, A(s(t), m => (l(), p(u, ot({
          ...
          onClick: U => {
            var W;
            return (W = o(m.symbol)) == null ? void 0 : W()
          }
  ...
  Un = g({
    ...
    setup(e) {
      const n = e,
        t = F(e, "modelValue");
      D(t, () => Et().$webApp.HapticFeedback.impactOccurred("light"));
      const a = h(() => {
      ...
      return (c, u) => {
        ...
        return l(), d("div", An, [y(b, {
          ...
          default: N(() => [(l(!0), d(I, null, A(c.tabs, m => (l(), d(I, {
            key: m.key
          }, [m.key === s(t) ? (l(), d("div", Wn, [O(c.$slots, m.key, {}, void 0, !0)])) : w("", !0)], 64))), 128))]),
          _: 3
        }, 8, ["name"])])
      }
    }
    ...
    setup(e) {
      ...
      return (t, a) => {
        const o = $e,
          ...
          m = Pn,
          U = En;
        return l(), d("div", Kn, [_("div", Dn, [_("div", On, f(("t" in t ? t.t : s(r))("wallet.points.title")), 1), y(o, {
    ...
    setup(e) {
      return (n, t) => {
        ...
        return l(), d("div", cs, [y(a, {
          ...
          "onShow:points": t[0] || (t[0] = W => n.$emit("show:points")),
          "onShow:tokensHistory": t[1] || (t[1] = W => n.$emit("show:tokens-history"))
    ...
    setup(e) {
      ...
      return D(c, () => Y().meta.key = c.value), (u, b) => {
        ...
        return l(), d("div", $s, [s(t).wallet.value.status === "loading" ? (l(), p(m, {
          key: 0
        })) : s(t).wallet.value.status === "must_reconnect" ? (l(), p(U, {
          key: 1
        })) : (l(), d(I, {
          key: 2
          ...
          key: 0
        }, [s(t).wallet.value.status === "not_found" ? (l(), p(W, {
          key: 0
