...
const pt = {
  ...
  Nt = O({
    ...
    setup(b, {
      ...
      const {
        $webApp: d
      } = de(), o = b, a = t, l = $e(b, "modelValue"), v = N(!o.dontShowStorageKey), i = N(!1), c = L({
        get: () => l.value && v.value,
        set: f => {
      ...
      return (f, C) => {
        ...
        return n(), g(T, {
          ...
          default: B(() => [s("div", St, [u(w, {
            name: f.lottie,
            size: 116
          }, null, 8, ["name"]), s("div", bt, p(f.title), 1), s("div", null, [s("div", At, p(f.subtitle), 1), f.hideReadMore ? I("", !0) : (n(), r("button", {
            key: 0,
            type: "button",
    ...
    setup(b) {
      ...
      return (h, _) => {
        ...
        return n(), r("div", po, [s("div", _o, [e(d).isLowEndDevice.value ? I("", !0) : (n(), r("img", {
          ...
          ref: v,
          class: "list",
          onScroll: _[0] || (_[0] = (...S) => e(i) && e(i)(...S)),
          onTouchmove: _[1] || (_[1] = (...S) => e(i) && e(i)(...S))
        }, [(n(!0), r(W, null, ce(t.list, (S, Y) => (n(), g(M, {
          key: S.id,
          index: Y,
          jetton: S,
          class: "item"
        ...
        }, [(n(!0), r(W, null, ce(e(K), S => (n(), r("img", {
          key: S.id,
          src: S.image,
          class: te(`animation-${S.animationType}`),
          style: ie({
            "--x-offset": S.position.x + "px",
            "--y-offset": S.position.y + "px"
          })
        }, null, 14, $o))), 128))], 4)])])
      }
    }
    ...
    setup(b) {
      ...
      return (i, c) => {
        const y = H,
          ...
          f = ct,
          C = rt;
        return n(), r("div", bo, [s("div", Ao, [u(A, {
          modelValue: t.value,
  ...
  Bo = O({
    ...
    setup(b) {
      ...
      return (T, E) => {
        ...
        }, null, 8, ["modelValue", "items", "onScrolled"])])) : (n(), g(S, {
          key: 1
        })), e(w) ? (n(), g(Y, {
          key: 2,
          onClose: _
