...
const Be = h(Se, [
  ...
  We = w({
    ...
    setup(e) {
      ...
      }, [m("div", Ke, S(e.label), 1), m("div", He, [le(n.$slots, "default", {}, () => [P(S(e.value), 1)], !0)])], 2))
    }
  }),
  ze = h(We, [
  ...
  Xe = w({
    ...
    setup(e, {
      ...
      const s = e,
        n = $(() => z(s.rank));
      $(() => ue(s.perk)), $(() => z(s.userRank)), $(() => v(`tribes.item.summary.perks.value_${(s.perk??H.FARMING10).toLowerCase()}`));
  ...
  Ut = w({
    ...
    setup(e) {
      const {
        ...
        usersLeaderboard: s,
        isMyTribe: n
      } = ye(), r = ke(), t = I(), l = I(!1), o = () => t.value && t.value.run(), u = async b => {
