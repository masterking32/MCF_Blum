  ...
  qe = se({
    ...
    setup(Qe) {
      const b = ne(),
        ...
        U = () => (y().memepad.memepadJettonAiSocialsActivate({
          source: "tokenpage"
        }), $(o.value.shortname)),
        V = () => (y().memepad.memepadJettonAiFineTuneButtonClick(), H(o.value.shortname)),
        z = c(() => [f.TELEGRAM, f.TWITTER, f.INSTAGRAM, f.WEBSITE].map(e => ({
          ...Z(e),
          type: e
        })).map(e => {
          var _;
      ...
      return (e, n) => {
        ...
        return r(), d("div", Ae, [s("div", {
        ...
        }, a(("t" in e ? e.t : t(l))("memepad.about.description.more")), 1)])) : v("", !0)], 2), s("div", Ce, [(r(!0), d(re, null, le(t(z), p => (r(), d("button", {
          key: p.type,
          type: "button",
          class: "item reset",
          disabled: !p.onClick,
          ...
          default: R(() => [s("div", Ue, a(("t" in e ? e.t : t(l))("memepad.jetton.holders")), 1), i(m, {
            name: "chevron-right",
            class: "icon"
          })]),
          _: 1
          ...
          preview: ""
        }, null, 8, ["jetton", "jetton-holders", "jetton-information"])])) : v("", !0), t(C) ? (r(), d("div", Ve, [i(I, {
          to: ("useRouter" in e ? e.useRouter : t(D))().resolve({
          ...
          default: R(() => [s("div", ze, a(("t" in e ? e.t : t(l))("memepad.jetton.transactions")), 1), i(m, {
            name: "chevron-right",
            class: "icon"
          })]),
          _: 1
          ...
          "jetton-information": t(S),
          preview: ""
        }, null, 8, ["transactions", "jetton-information"])])) : v("", !0), s("div", Ge, [F(a(("t" in e ? e.t : t(l))("memepad.about.disclaimer")) + " ", 1), n[5] || (n[5] = s("i", {
          class: "warning"
        }, null, -1))])])
      }
    }
