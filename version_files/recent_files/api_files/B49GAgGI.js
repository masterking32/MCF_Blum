    ...
    setup(e) {
      ...
      return c(() => n.value = !1), (o, l) => {
        ...
        return a(), u(y, {
          ...
          default: T(() => [_("div", Zt, [_("div", Xt, [_("div", Jt, f(e.address.short), 1), _("div", te, [p(d, {
...
const Ae = h(Ne, [
    ...
    setup(e) {
      ...
      return (c, o) => {
        ...
        return s(t) ? (a(), r("div", {
          ...
          name: s(t).icon,
          class: "icon"
        }, null, 8, ["name"]), _("div", Ke, f(s(t).label), 1)], 2)) : g("", !0)
      }
    }
  }),
  We = h(De, [
  ...
  Qe = w({
    ...
    setup(e) {
      const t = J(async c => {
        const o = await z.getPointsHistory(c);
    ...
    setup(e) {
      ...
      return (c, o) => {
        ...
        return a(), r("div", Ge, [_("div", {
          ...
          src: e.image,
          alt: "Image"
        }, null, 8, Xe)) : g("", !0)], !0)])) : g("", !0), _("div", Je, f(e.text), 1), p(l, {
          name: "chevron-right",
          class: "icon"
        })], 2), p(d, {
          modelValue: s(n),
...
const Rn = h(Dn, [
  ...
  Fn = w({
    ...
    setup(e) {
      const t = J(async c => {
        const o = await z.getTokensHistory(c);
...
const Qn = w({
    ...
    setup(e) {
      ...
      return F(d, () => Ot().meta.key = d.value), (v, y) => {
        const I = Ct,
          S = Qt,
          U = Gt,
          dt = he,
