    ...
    setup(a) {
      ...
      return (e, _) => {
        ...
        const o = pe,
          p = q,
          v = ue;
        return s(), l("div", Xe, [e.isReleased ? S("", !0) : (s(), l("div", Ye, [n("div", Ze, [n("div", He, [e.total !== void 0 && e.collected !== void 0 || e.percent ? (s(), l(I, {
          key: 1
          ...
          for (let b = 0; b <= Q; b++) {
            ...
            for (let $ = 0; $ < c.length - 1; $++)
              if (m > c[$] && m < c[$ + 1]) {
                ...
                const N = i[y],
                  H = i[O];
                R = "value" in N ? N.value : N.percent, U = "value" in H ? H.value : H.percent;
                break
...
export {
  Gt as _, qt as a, Xt as b, Yt as c, Zt as d, ss as e, ns as f, os as g, Oe as h, ts as i, Jt as j, Qt as k, xt as l, Pe as m, es as r, Ht as s
};