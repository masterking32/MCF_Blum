    ...
    setup(p) {
      ...
      return (o, a) => {
        ...
        return s(), r("div", {
          ...
          name: "edit-copy",
          class: "icon"
        })])), i(c) ? (s(), r("div", $e, v(i(c)), 1)) : B("", !0)]), d("div", Ce, [d("div", Pe, v(i(m)), 1), d("div", be, v(i(n)), 1)])], 2)
      }
    }
  }),
  Le = w(ge, [
    ...
    setup(p) {
      ...
      return (o, a) => {
        ...
        return s(), r("div", je, [d("div", He, [(_ = o.user) != null && _.avatarUrl ? (s(), r("img", {
          ...
          type: "button",
          onClick: a[0] || (a[0] = I => u())
        }, [d("div", Be, v(o.user.nickname), 1), f(h, {
          name: "edit-copy",
          class: "icon"
        })])) : (s(), r("button", {
          key: 1,
          ...
          type: "button",
          onClick: a[1] || (a[1] = I => u())
        }, [d("div", Te, v(i(l)), 1), f(h, {
          name: "edit-copy",
          class: "icon"
        })])), i(c) ? (s(), r("div", Oe, v(i(c)), 1)) : B("", !0)]), d("div", Re, [d("div", De, v(i(m)), 1), d("div", Ee, v(i(n)), 1)])])
      }
    }
  }),
  Ye = w(Fe, [
    ...
    return {
      getHoldersInfo: n => {
        ...
        const o = y(() => {
          ...
          const h = (e, $) => R.Address.parse(e).equals(R.Address.parse($)),
  ...
  Ve = L({
    ...
    setup(p) {
      ...
      return (m, n) => {
        ...
        }, null, 8, ["items"]), m.preview ? B("", !0) : (s(), r("div", Qe, [f(o, {
          items: i(c).items
