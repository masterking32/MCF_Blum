  ...
  oe = B({
    ...
    setup(a) {
      ...
      return (n, s) => {
        ...
        }, null, 8, ["label", "to"]), r("div", ie, [(o(!0), _(T, null, E(a.leaderboard.slice(0, 3), (c, f) => (o(), b(d, {
          key: c.id,
          tribe: c,
          rank: f + 1
        }, null, 8, ["tribe", "rank"]))), 128))])])) : w("", !0)])]), m(p, {
          modelValue: e(l),
          "onUpdate:modelValue": s[0] || (s[0] = c => L(l) ? l.value = c : null)
  ...
  pe = B({
    ...
    setup(a) {
      ...
      const s = n.emitter("created", () => l.value = !0),
        u = C(() => n.myTribeRes.value),
        t = C(() => n.tribeValidationBot.value);
      return A(() => n.tribeOrUndefined.value && !l.value && v().replace({
        name: "tribe-slug"
      })), D().meta.back = () => v().push({
        name: "index"
      }), F(() => s()), (d, p) => {
