...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function i(s, d) {
    if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(s)))) {
      var F = [],
        ...
        C = void 0;
      try {
        for (var U = s[Symbol.iterator](), V; !(y = (V = U.next()).done) && (F.push(V.value), !(d && F.length === d)); y = !0);
      } catch (E) {
        S = !0, C = E
      } finally {
        try {
  ...
  function N(s, d) {
    ...
    if (B ? (S = "", D = B[1], V = B[2] || null) : (E = C.split(":"), S = E.shift(), E.length && (V = E.join(":"))), V !== null && V.length > 0) {
      if (U = parseInt(V, 10), !/^[0-9]+$/.test(V) || U <= 0 || U > 65535) return !1
  ...
  cn = R({
    ...
    setup(m, {
      ...
      return we(t, () => {
        ...
        }, null, 8, ["value", "max-length"])) : O("", !0)], 8, ln)) : O("", !0), Ue(b("textarea", {
          id: e(_),
          ref_key: "textareaRef",
          ref: r,
...
const pn = R({
    ...
    setup(m, {
      ...
      return ae(() => {
        ...
        return p(), w("div", In, [b("div", Rn, [k(at, {
          ...
          default: L(() => [e(r).length > 0 ? (p(), w("div", Tn, [k(h, {
            name: "plus",
            class: "plus-icon"
          }), b("div", Un, [(p(!0), w(G, null, Q(e(r), v => (p(), w("div", {
            key: v,
            class: "provider"
          }, [k(h, {
            name: e(a)[v].icon,
  ...
  On = R({
    ...
    setup(m) {
      const l = W(m, "modelValue");
      return (a, c) => (p(), w("div", Cn, [Ue(b("input", {
  ...
  Ba = R({
    ...
    setup(m, {
      ...
      return mt(() => {
        ...
        })), 1), b("div", Ta, x(("t" in n ? n.t : e(A))("memepad.new.failed.subtitle")), 1)]), k(v, null, {
          default: L(() => [k(h, {
            fill: "",
  ...
  Ga = R({
    ...
    setup(m) {
      ...
      const o = l.jettonManagement.getWaitForCreateStatus(),
        n = I(l.retryPayload ? Ft(l.retryPayload) : {
          step: 1,
          step1: de.step1(),
          step2: de.step2(),
          step3: de.step3()
      ...
      return (s, d) => {
        ...
        }, null, 8, ["state", "jetton-management", "bcl-data"])) : O("", !0), e(n).step === 4 ? (p(), M(U, {
          key: 4,
          form: e(xe)(e(n)),
          "jetton-management": l.jettonManagement,
  ...
  Ja = R({
    ...
    setup(m) {
      ...
      return (() => {
        const o = yt("memepadNewFrom", Pe) ?? Pe.NA;
