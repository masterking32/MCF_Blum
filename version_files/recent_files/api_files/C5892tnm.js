...
var p = (r, e, t) => ii(r, typeof e != "symbol" ? e + "" : e, t);
import {
  bh as O,
  c1 as ci,
  c2 as di,
...
var Hd = Z,
  ...
  ae = function(r, e) {
    var t = r.target,
      ...
      d = c.prototype,
      u, a, m, h, y, A, w, _, v;
    for (h in e) u = rl(s ? h : t + (n ? "." : "#") + h, r.forced), a = !u && i && on(i, h), A = c[h], a && (r.dontCallGetSet ? (v = tl(i, h), w = v && v.value) : w = i[h]), y = a && w ? w : e[h], !(!u && !o && typeof A == typeof y) && (r.bind && a ? _ = sl(y, Ce) : r.wrap && a ? _ = nl(y) : o && el(y) ? _ = Xd(y) : _ = y, (r.sham || y && y.sham || A && A.sham) && Ae(_, "sham", !0), Ae(c, h, _), o && (m = t + "Prototype", on(we, m) || Ae(we, m, {}), Ae(we[m], h, y), r.real && d && (u || !d[h]) && Ae(d, h, y)))
  },
  ol = Math.ceil,
  al = Math.floor,
  ...
  mr = function(r, e, t, s) {
    ...
    if (su(n)) {
      ...
      if (h)
        ...
        for (d = lu(n), u = pn(d), a = 0; a < u; a++) m = d[a], yn(n, m, mr(n, m, t, ou(y, m) ? y[m] : void 0))
    }
    return ru(t, r, e, n, i)
  },
  yn = function(r, e, t) {
  ...
  stringify: function(e, t, s) {
    ...
    for (var c = "", d = i.length, u = 0; u < d; u++) {
      ...
      if (a === '"') {
        var m = Hp(i, ++u).end - 1,
          h = tr(i, u, m);
        c += tr(h, 0, Cn) === br ? o[tr(h, Cn)] : '"' + h + '"', u = m
      } else c += a
    }
    return c
  }
    ...
    p(this, "request", async ({
      ...
      return this.customFetch(`${c||this.baseUrl||""}${s}${h?`?${h}`:""}`, {
        ...
        const j = w === "json" ? "text" : w,
          E = j ? await _[j]().then(N => (v.ok ? v.data = w === "json" ? sh(N) : N : v.error = N, v)).catch(N => (v.error = N, v)) : v;
...
class dh {
  constructor() {
    ...
    p(this, "createGetWaitForLaunchStatusUntilOk", e => () => cr((() => {
      let t, s;
      return async ({
        queryId: n,
...
const Ia = r => typeof r == "object" && r !== null,
  ...
  $r = (r, e, t, s = new WeakMap) => {
    ...
    for (const [i, c] of Object.entries(r)) {
      ...
      u !== "__proto__" && (t.deep && m && eo(a) && (a = Array.isArray(a) ? o(a) : $r(a, e, t, s)), n[u] = a)
    }
    return n
  };
es.exports = (r, e, t) => {
...
const Ra = r => typeof r == "object" && r !== null,
  ...
  kr = (r, e, t, s = new WeakMap) => {
    ...
    for (const [i, c] of Object.entries(r)) {
      ...
      u !== "__proto__" && (t.deep && m && oo(a) && (a = Array.isArray(a) ? o(a) : kr(a, e, t, s)), n[u] = a)
    }
    return n
  };
...
class Nf extends dh {
  constructor({
    ...
    p(this, "getWaitForBuyStatus", () => cr(this.getTradeTransactionStatus.bind(this), () => {}, 12e3));
    p(this, "getWaitForSellStatus", () => cr(this.getTradeTransactionStatus.bind(this), () => {}, 12e3));
    this.jettonAddress = t, this.referrerToken = s, this.REFERRAL_ADDRESS = ho().public.STONFI_REFERRAL_ADDRESS
  }
  async getRouter(t) {
