  ...
  Ie = z({
    ...
    setup(Me) {
      ...
      return (e, o) => {
        ...
        return _(), h("div", ae, [s("div", {
        ...
        }, [s("div", de, [S(n(t(i).description) + " ", 1), s("span", null, [t(C) && t(b) ? (_(), h("button", {
          key: 0,
          type: "button",
          ...
          default: E(() => [s("div", we, n(("t" in e ? e.t : t(l))("memepad.jetton.holders")), 1), a(c, {
            name: "chevron-right",
            class: "icon"
          })]),
          _: 1
          ...
          preview: ""
        }, null, 8, ["jetton", "jetton-holders", "jetton-information"])]), s("div", Se, [a(R, {
          to: ("useRouter" in e ? e.useRouter : t(A))().resolve({
          ...
          default: E(() => [s("div", Ee, n(("t" in e ? e.t : t(l))("memepad.jetton.transactions")), 1), a(c, {
            name: "chevron-right",
            class: "icon"
          })]),
          _: 1
          ...
          "jetton-information": t(g),
          preview: ""
        }, null, 8, ["transactions", "jetton-information"])]), s("div", Ae, [S(n(("t" in e ? e.t : t(l))("memepad.about.disclaimer")) + " ", 1), o[5] || (o[5] = s("i", {
          class: "warning"
        }, null, -1))])])
      }
    }
