...
const oe = {
  ...
  de = E({
    ...
    setup(f) {
      ...
      return (r, u) => (a(), i("div", {
        class: T(["kit-input-over", [`is-${t(s).type}`]])
    ...
    setup(f, {
      ...
      return (e, d) => {
        ...
        return a(), i("div", {
          ...
          default: R(() => [e.errorCaption || e.caption ? (a(), i("p", Te, _(e.errorCaption || e.caption), 1)) : o("", !0)]),
          _: 1
        })], 2)
      }
    }
