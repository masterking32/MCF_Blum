...
const St = {
  ...
  Mt = T({
    ...
    setup(f) {
      ...
      return (p, r) => (n(), v("div", Nt, [a("div", Tt, A(e(o).step), 1), a("div", Ft, A(e(o).label), 1)]))
    }
  }),
  oe = F(Mt, [
    ...
    setup(f) {
      return (t, o) => {
        ...
        return n(), v("div", Gt, [f.iconName ? (n(), E(p, {
          ...
          name: f.iconName,
          class: "icon"
        }, null, 8, ["name"])) : L("", !0), a("div", Wt, [a("span", xt, A(f.title), 1), f.isOptional ? (n(), v("span", Jt, A(` ${("t"in t?t.t:e(h))("base.optional")}`), 1)) : L("", !0)])])
      }
    }
  }),
  Ne = F(zt, [
    ...
    setup(f) {
      ...
      return (m, l) => {
        ...
        return n(), v("div", qt, [u(c, {
          ...
          alt: "Trash icon",
          class: "icon"
        }, null, -1)]))], 4)) : ((g = e(r)) == null ? void 0 : g.status) === e(ae).UPLOADING ? (n(), v("div", jt, [u(d, {
          type: e(fe).LIGHT,
          size: 16
  ...
  po = T({
    ...
    setup(f) {
      const t = J(f, "modelValue");
      return (o, p) => (n(), v("div", co, [Le(a("input", {
    ...
    setup(f, {
      ...
      const o = f,
        ...
        i = async () => {
          ...
          !new de(k).eq(r.value.share) || !j(C) || (r.value = {
            status: "loaded",
            share: k,
            overview: C.data
          }, p("update", {
            share: k,
            overview: j(C) ? C.data : void 0
          }))
        }, {
          debouncedFunction: S
        } = xe(M, 400);
      return De(() => r.value.share, () => {
        ...
        return n(), E(V, {
          ...
          "bottom-action": I(() => {
            var U, $;
            return [a("div", Po, [a("div", No, [e(s).balance && !e(l) ? (n(), E(G, {
              key: 0,
              balance: e(s).balance
              ...
              "value-balance": ($ = k.balances.tokenBalance) == null ? void 0 : $.value.toNumber(),
  ...
  jo = T({
    ...
    setup(f) {
      return (t, o) => {
        const p = Q,
          r = wt;
        return n(), v("div", Lo, [(n(!0), v(D, null, X(t.details.sections, _ => (n(), v("div", {
          key: _.title,
          class: "row"
        }, [a("div", $o, A(_.title), 1), a("div", Ko, [u(r, null, {
          default: I(() => [u(p, {
            name: "circle-help",
            class: "tooltip-icon"
          })]),
          ...
          name: "circle-help",
          class: "icon"
        }), a("span", Jo, A(("t" in t ? t.t : e(h))("memepad.jetton.not_enough_error", {
          ticker: "TON"
        })), 1)])) : (n(), v("div", zo, [a("span", qo, A(t.details.totalSection.label), 1)]))])], 64)) : L("", !0)])
      }
    }
  }),
  Ho = F(jo, [
    ...
    setup(f, {
      ...
      const o = f,
        ...
        d = async () => {
          ...
          j(s) ? p("continue") : we().success(h("memepad.jetton.new.error_alert")), c.value = !1
        };
      return (s, g) => {
        const i = oe,
          y = Vo,
        ...
        return n(), v("div", Qo, [u(i, {
          ...
          class: "banner"
        }, null, 8, ["banner-file-key"]), u(S, ze(qe(e(_))), null, 16), u(B, null, {
          default: I(() => [u(k, {
            "with-share": !!s.form.share,
            details: e(m),
            "not-enough-balance": e(l) === !1
          }, null, 8, ["with-share", "details", "not-enough-balance"]), a("div", Zo, [u(q, null, {
            default: I(() => {
              var G;
              return [e(l) ? (n(), E(z, {
                key: 1,
    ...
    setup(f) {
      ...
      const {
        ...
        const R = async ({
          ...
          const O = await w.getWaitForCreateStatus().exec($);
      ...
      return (w, b) => {
        ...
        return n(), v("div", bn, [e(i).step !== 5 ? (n(), E(R, {
          ...
          step: e(i).step,
          "count-steps": 4
        }, null, 8, ["step"])) : L("", !0), e(i).step === 1 ? (n(), E(V, {
          key: 1,
          state: e(i),
          onContinue: b[0] || (b[0] = K => k(e(i), K))
        }, null, 8, ["state"])) : e(M) ? e(i).step === 2 ? (n(), E($, {
          key: 3,
          state: e(i),
          ...
          balances: e(y),
          "launch-controls": e(M),
          onContinue: b[2] || (b[2] = K => z(e(i), K)),
          onUpdate: b[3] || (b[3] = K => q(e(i), K))
        }, null, 8, ["state", "balances", "launch-controls"])) : e(i).step === 4 ? (n(), E(Te, {
          key: 5,
          form: e(me)(e(i)),
          balances: e(y),
          "launch-controls": e(M),
          ...
          form: e(me)(e(i)),
          "retry-callback": e(p)
        }, null, 8, ["form", "retry-callback"])) : L("", !0) : (n(), E(U, {
          key: 2
        }))])
      }
    }
