    ...
    setup(U, {
      ...
      return B(l, c => r("update:lock-by-avatar-uploading", !!c)), (c, a) => {
        const e = D,
          n = ce,
          p = x("activate");
        return f(), N("div", de, [k("div", me, [_(e, {
          "override-avatar-url": o(m),
          onOnImageError: a[0] || (a[0] = d => s.value = void 0)
        }, null, 8, ["override-avatar-url"]), H((f(), N("div", pe, [a[4] || (a[4] = k("img", {
          src: z,
          alt: "Edit icon"
    ...
    setup(U, {
      ...
      return (e, n) => {
        const p = _e,
          ...
          T = L,
          v = re;
        return f(), N("div", ge, [k("div", {
          class: "title",
          innerHTML: ("t" in e ? e.t : o(i))("welcome.title")
        }, null, 8, Ae), o(a) ? (f(), N("img", ke)) : O("", !0), k("div", Ne, [_(p, {
  ...
  Ie = b({
    ...
    setup(U) {
      ...
      return (a, e) => {
        const n = be,
          p = le;
        return f(), N("div", Ee, [o(t) === "USERNAME" ? (f(), S(n, {
          key: "onboarding",
          "tg-avatar-url": o(m),
