    ...
    setup(c) {
      ...
      const w = i(!1),
        ...
        p = new IntersectionObserver(([s]) => {
          ...
          s.target.classList.contains("start") ? y.value = !e : w.value = !e
        }, {
          threshold: k
        });
      q(() => {
      ...
      return (s, e) => {
        ...
        return n(), r("div", {
          ...
          "data-tab": l.value
        }, [l.pingDot ? (n(), r("div", O)) : U("", !0), t("span", P, W(l.label), 1), e[1] || (e[1] = t("div", {
          class: "dot"
        }, null, -1)), h(t("input", {
          ...
          ref: u,
          class: "end"
        }, null, 512)]), N(s.$slots, "after", {}, void 0, !0)])), [
          [_]
        ])], 2)
      }
    }
