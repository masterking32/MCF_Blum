    ...
    setup(v) {
      ...
      return P(() => _.value, a => {
        ...
        return o(), l("div", ee, [y("div", te, [(o(), l(d, null, k(U, e => y("div", {
          ...
          key: m
        }, [e.type === "TOGGLE" ? (o(), l("label", le, [E(r(e.key) + " ", 1), T(y("input", {
          "onUpdate:modelValue": u => e.value = u,
          type: "checkbox",
          label: e.key
        }, null, 8, ne), [
          [$, e.value]
        ])])) : i("", !0), e.type === "STRING" || e.type === "NUMBER" ? (o(), l("label", ue, [E(r(e.key) + " ", 1), T(y("input", {
          "onUpdate:modelValue": u => e.value = u,
          type: e.type === "NUMBER" ? "number" : "text",
          placeholder: e.key
        }, null, 8, ce), [
          [J, e.value]
        ])])) : i("", !0), e.type === "ENUM" || e.type === "ENUM_ARRAY" ? (o(), l("label", ye, [E(r(e.key) + " ", 1), T(y("select", {
          "onUpdate:modelValue": u => e.value = u,
