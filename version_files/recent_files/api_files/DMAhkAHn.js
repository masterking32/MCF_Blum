  ...
  qn = nt({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        c = async () => {
          if (u.value) return;
          const d = () => _e().bottom.error(E("memepad.jetton.unlock.failed_alert", {
              ticker: e.jetton.ticker
            })),
            p = () => {
              a.value.push(e.jetton.address), a.value = a.value.slice(-3), a.value.length === 3 && a.value.every(y => y === a.value[0]) && (h.disconnect(), a.value = [])
            },
            f = w => {
          ...
          await Es(2e4), await l.exec(m.data) ? (f("success"), s("unlocked"), _e().bottom.success(E("memepad.jetton.unlock.success_alert", {
            ticker: e.jetton.ticker
      ...
      return je(() => {
        ...
        const f = Vs,
          ...
          w = Is,
          y = Vt;
        return C(), V("div", Yn, [S("div", Gn, [v(i).balanceLabel ? (C(), W(f, {
          key: 0,
          ...
          "error-message": (k = v(i).error) == null ? void 0 : k.message
        }, null, 8, ["details", "total-label", "error-message"])) : (C(), W(m, {
          key: 3,
          class: "skeleton"
        }))]), (j = v(i).error) != null && j.notEnoughtTon ? (C(), W(w, {
          key: 0,
          "jetton-shortname": d.jetton.shortname,
          "jetton-address": d.jetton.address
        }, null, 8, ["jetton-shortname", "jetton-address"])) : (C(), W(y, {
          key: 1,
          fill: "",
          icon: "lock-open",
          "icon-align": "left",
          ...
          default: X(() => [S("div", Zn, N(("t" in d ? d.t : v(E))("memepad.jetton.unlock_btn", {
    ...
    setup(n) {
      ...
      return (i, s) => {
        const o = pn,
          ...
          u = As,
          d = xs;
        return C(), V("div", Qn, [L(o), S("div", to, [S("div", eo, [L(h, {
          size: 342,
          ...
          size: 80
        }, null, 8, ["src"])]), S("div", io, N(("t" in i ? i.t : v(E))("memepad.moving_to_dex.title")), 1), S("div", so, N(("t" in i ? i.t : v(E))("memepad.moving_to_dex.subtitle", {
          ticker: i.jetton.ticker
        })), 1)]), L(u, null, {
          default: X(() => [S("div", no, [L(c, {
    ...
    setup(n, {
      ...
      return (l, a) => {
        ...
        return C(), W(f, {
          ...
          title: X(() => [S("div", ro, [L(c, {
            src: v(ai)(l.jetton.iconFileKey),
            size: 24
          }, null, 8, ["src"]), S("span", lo, N(l.jetton.name), 1)])]),
          default: X(() => {
            var m;
            return [S("div", ao, [l.jetton.bannerFileKey ? (C(), V("div", co, [L(u, {
              "banner-file-key": l.jetton.bannerFileKey,
              class: "banner"
            }, null, 8, ["banner-file-key"])])) : vt("", !0), S("div", uo, [S("div", fo, [S("span", mo, N(("t" in l ? l.t : v(E))("memepad.jetton.info_sheet.address_label", {
              address: ("sliceWalletAddress" in l ? l.sliceWalletAddress : v(_n))(l.jetton.address)
            })), 1), S("button", {
              type: "button",
              ...
              name: "edit-copy",
              class: "icon"
            })])]), l.jetton.isNSFW ? (C(), V("div", po, [L(d, {
              name: "circle-check-white",
              class: "icon"
            }), S("span", vo, N(("t" in l ? l.t : v(E))("memepad.jetton.nsfw")), 1)])) : vt("", !0)]), S("div", bo, N(l.jetton.description), 1), (m = v(s)) != null && m.length ? (C(), V("div", go, [(C(!0), V(bt, null, ye(v(s), b => (C(), V("button", {
              key: b.type,
              type: "button",
              class: "item reset",
              onClick: w => v(Dn)(b.type, b.url)
            }, [L(d, {
              name: b.icon,
              class: "icon"
            }, null, 8, ["name"]), S("div", wo, N(b.url), 1)], 8, _o))), 128))])) : vt("", !0), S("div", yo, [L(p, {
              label: ("t" in l ? l.t : v(E))("memepad.jetton.share_token_link"),
              fill: "",
              size: v(St).LARGE,
              type: v(Ct).SECONDARY,
              onClick: r
            }, null, 8, ["label", "size", "type"]), L(p, {
  ...
  To = nt({
    ...
    setup(n) {
      const t = n,
        e = U(!1),
        i = z(() => {
          const s = wn(t.jetton.releaseTimestamp).label;
      ...
      return (s, o) => {
        ...
        const h = Kn,
          r = ui,
          l = So;
        return C(), V("div", Co, [S("div", ko, [L(h, {
          "jetton-modal-controls": s.jettonModalControls,
          jetton: s.jetton
        }, null, 8, ["jetton-modal-controls", "jetton"]), S("div", jo, [S("div", zo, [S("div", Lo, N(s.jetton.ticker), 1), (a = s.jettonInformation) != null && a.inSpotlight ? (C(), V("div", Eo, [L(r, {
          name: "fire",
          class: "icon"
        }), o[4] || (o[4] = S("span", {
          class: "label"
        }, "Spotlight", -1))])) : vt("", !0)]), S("div", xo, N(v(i)), 1)])]), S("div", $o, [S("button", {
          type: "button",
          class: "reset share",
...
var Io = function() {
  ...
  return n.prototype.dispose = function() {
    ...
    if (this._canvasElement !== null) {
      ...
      this._devicePixelRatioObservable = Ro(e), this._devicePixelRatioObservable.subscribe(function() {
...
function Wo(n, t) {
  if (t.type === "device-pixel-content-box") return new Io(n, t.transform, t.options);
...
function xt(n, t) {
  ...
  return s === null ? null : new Do(s, e, i)
}
/*!
 * @license
...
const Xo = /^#([0-9a-f])([0-9a-f])([0-9a-f])([0-9a-f])?$/i,
  Ho = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?$/i,
  Yo = /^rgb\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*\)$/,
  Go = /^rgba\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d*\.?\d+)\s*\)$/;

function Qt(n) {
  (n = n.toLowerCase()) in Ii && (n = Ii[n]);
  {
    const t = Go.exec(n) || Yo.exec(n);
    if (t) return [lt(parseInt(t[1], 10)), lt(parseInt(t[2], 10)), lt(parseInt(t[3], 10)), Us(t.length < 5 ? 1 : parseFloat(t[4]))]
  } {
    const t = Ho.exec(n);
...
class qo {
  ...
  W() {
    const t = this.k,
      e = this.j(),
      i = this.H();
    return t.P === e && t.D === i || (t.P = e, t.D = i, t.R = Dt(e, i), t.L = 2.5 / 12 * e, t.B = t.L, t.A = e / 12 * t.T, t.I = e / 12 * t.T, t.N = 0), t.V = this.$(), t.O = this.U(), this.k
  }
  $() {
...
class ih {
  ...
  bt(t) {
    const e = this.F.wt();
    e.length !== this.ct.length && (this.dt = e.map(th), this.ct = this.dt.map(i => {
      const s = new Qo;
      return s.J(i), s
  ...
  Mt() {
    ...
    e.forEach((o, h) => {
      ...
      const c = _(o.Ct());
      l.lt = a.Tt, l.ht = a.ht, l.et = a.Pt, l.it[0]._t = a._t, l.it[0].st = o.Dt().Rt(a._t, c.Vt), l.rt = (r = a.Ot) !== null && r !== void 0 ? r : this.F.Bt(l.it[0].st / o.Dt().At()), l.it[0].ot = i, l.it[0].nt = s.It(i), l.tt = eh
    })
  }
}
class sh extends ft {
  ...
  K({
    ...
    t.lineCap = "butt", o && r >= 0 && (t.lineWidth = Math.floor(this.zt.Lt.et * i), t.strokeStyle = this.zt.Lt.V, t.fillStyle = this.zt.Lt.V, $t(t, this.zt.Lt.Nt), function(a, c, u, d) {
      a.beginPath();
      const p = a.lineWidth % 2 ? .5 : 0;
      a.moveTo(c + p, u), a.lineTo(c + p, d), a.stroke()
    }(t, r, 0, e.height)), h && l >= 0 && (t.lineWidth = Math.floor(this.zt.Et.et * s), t.strokeStyle = this.zt.Et.V, t.fillStyle = this.zt.Et.V, $t(t, this.zt.Et.Nt), Os(t, l, 0, e.width))
  }
}
class nh {
  constructor(t) {
...
class Ai {
  ...
  Gt(t, e, i, s) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, p = e.L + this.Xt.wi, f = e.B + this.Xt.gi, m = e.A, b = e.I, w = this.zt.Kt, y = e.P, k = i.Mi(h, w), j = Math.ceil(i.xi(h, w)), B = y + p + f, q = e.C + m + b + j + u, M = Math.max(1, Math.floor(c));
    let g = Math.round(B * c);
    g % 2 != M % 2 && (g += 1);
    const $ = d > 0 ? Math.max(1, Math.floor(d * a)) : 0,
      F = Math.round(q * a),
      x = Math.round(u * a),
      J = (o = this.Xt.Si) !== null && o !== void 0 ? o : this.Xt.ki,
      T = Math.round(J * c) - Math.floor(.5 * c),
      I = Math.floor(T + M / 2 - g / 2),
      P = I + g,
      A = s === "right",
      D = A ? l.width - d : d,
      K = A ? r.width - $ : $;
    let R, H, Y;
    return A ? (R = K - F, H = K - x, Y = D - u - m - d) : (R = K + F, H = K + x, Y = D + u + m), {
      Qt: A,
      Jt: {
        ii: I,
        li: T,
...
class Js {
  ...
  X(t, e) {
    ...
    const i = t.useMediaCoordinateSpace(({
      context: d
    }) => (d.font = e.R, Math.round(e.Wi.xi(d, _(this.zt).Kt, rh))));
    if (i <= 0) return;
    const s = e.ji,
      o = i + 2 * s,
      h = o / 2,
    ...
    t.useBitmapCoordinateSpace(({
      ...
      const b = Math.round(a * p),
        ...
        k = Math.round(u * f),
        j = Math.round(2 * p);
      if (d.beginPath(), d.moveTo(b, w), d.lineTo(b, k - j), d.arcTo(b, k, b + j, k, j), d.lineTo(y - j, k), d.arcTo(y, k, y, k - j, j), d.lineTo(y, w), d.fill(), m.hi) {
        const B = Math.round(m.ki * p),
          q = w,
          M = Math.round((q + e.T) * f);
        d.fillStyle = m.V;
        const g = Math.max(1, Math.floor(p)),
          $ = Math.floor(.5 * p);
        d.fillRect(B - $, q, g, M - q)
      }
    }), t.useMediaCoordinateSpace(({
      context: d
    }) => {
...
class ah extends bi {
  constructor(t, e) {
    super(), this.tn = null, this.nn = NaN, this.sn = 0, this.en = !0, this.rn = new Map, this.hn = !1, this.ln = NaN, this.an = NaN, this._n = NaN, this.un = NaN, this.$i = t, this.cn = e, this.dn = new ih(t, this), this.fn = ((s, o) => h => {
      const r = o(),
        l = s();
    ...
    this.bn = new lh(this, t, i), this.wn = new nh(this)
  }
  W() {
    return this.cn
  }
  ...
  Tn() {
    const t = this.$i.wt().map(i => i.In().An()).filter(Zo),
      e = t.length === 0 ? null : Math.max(...t);
    this.sn = e !== null ? e : NaN
  }
  Dn(t, e, i) {
    let s = t.get(e);
    return s === void 0 && (s = new hh(this, e, i), t.set(e, s)), s
  }
}
    ...
    for (let m = i.from + 1; m < i.to; ++m) {
      ...
      switch (e) {
        case 0:
          ...
          break;
        case 1:
          r.lineTo(f.nt * l, t[m - 1].st * a), b !== u && (p(b, f), r.lineTo(f.nt * l, t[m - 1].st * a)), r.lineTo(f.nt * l, f.st * a);
          break;
        case 2: {
          const [w, y] = uh(t, m - 1, m);
          r.bezierCurveTo(w.nt * l, w.st * a, y.nt * l, y.st * a, f.nt * l, f.st * a);
          break
        }
      }
      e !== 1 && b !== u && (p(b, f), r.moveTo(f.nt * l, f.st * a))
...
class Ys extends ft {
  ...
  K(t) {
    ...
    if (s === null) return;
    const c = t.context;
    c.lineCap = "butt", c.lineJoin = "round", c.lineWidth = h, $t(c, r), c.lineWidth = 1, Hs(t, i, l, s, o, this.ps.bind(this), dh.bind(null, a))
  }
}
...
class Zs extends ft {
  ...
  K(t) {
    ...
    o !== void 0 && Hs(t, e, o, i, s, c, mh), l && function(u, d, p, f, m) {
      const {
      ...
      for (let q = f.to - 1; q >= f.from; --q) {
        ...
        if (M) {
          const g = m(u, M);
          g !== k && (y.beginPath(), k !== null && y.fill(), y.fillStyle = g, k = g);
          const $ = Math.round(M.nt * b) + j,
            F = M.st * w;
          y.moveTo($, F), y.arc($, F, B, 0, 2 * Math.PI)
        }
      }
      y.fill()
    }(t, e, l, i, c)
...
class bh extends Te {
  constructor(t, e) {
    super(t, e), this.Ws = new vi, this.ee = new fh, this.re = new qs, this.Ws.Z([this.ee, this.re])
  }
  ne(t, e, i) {
  ...
  K({
    ...
    for (let h = this.zt.tt.from; h < this.zt.tt.to; ++h) {
      ...
      if (o) {
        if (this.zt.fe) {
          const q = a - y;
          let M = Math.max(m, Math.round(r.ve * i) - l),
            g = M + u - 1;
          g > m + w - 1 && (g = m + w - 1, M = g - u + 1), t.fillRect(q, M, c - q, g - M + 1)
        }
        const k = a + y;
        let j = Math.max(m, Math.round(r.pe * i) - l),
          B = j + u - 1;
        B > m + w - 1 && (B = m + w - 1, j = B - u + 1), t.fillRect(d + 1, j, k - d, B - j + 1)
      }
    }
  }
  oe(t) {
...
class _h extends sn {
  constructor() {
    super(...arguments), this.Ws = new gh
  }
  ne(t, e, i) {
...
class Mh extends Te {
  constructor(t, e) {
    super(t, e), this.Ws = new vi, this.De = new wh, this.Ve = new yh, this.Ws.Z([this.De, this.Ve])
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class Sh extends ft {
  ...
  Be(t, e, i) {
    ...
    for (let u = i.from; u < i.to; u++) {
      ...
      const y = w + l - 1;
      c !== null && (w = Math.max(c + 1, w), w = Math.min(w, y));
      const k = y - w + 1;
      s.fillRect(w, m, k, p - m), s.fillRect(w, f + 1, k, b - f), c = y
    }
  }
  Ie(t) {
  ...
  Ae(t, e, i) {
    ...
    for (let c = i.from; c < i.to; c++) {
      ...
      if (a !== null && (d = Math.max(a + 1, d), d = Math.min(d, p)), this.zt.he * o > 2 * l) oh(s, d, f, p - d + 1, m - f + 1, l);
      else {
        const b = p - d + 1;
...
class Lh extends Te {
  constructor() {
    super(...arguments), this.Ws = new zh
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class nn {
  constructor(t, e, i) {
    this._r = t, this.lr = new ie(50), this.ur = e, this.F = i, this.j = -1, this.Wt = new $h(this.lr)
  }
  gt() {
...
class Th extends ft {
  ...
  K({
    ...
    o < 0 || o > e.height || (t.lineCap = "butt", t.strokeStyle = this.zt.V, t.lineWidth = Math.floor(this.zt.et * i), $t(t, this.zt.Nt), Os(t, o, 0, e.width))
  }
}
class wi {
  constructor(t) {
    this.Mr = {
      ...
      Nt: 0,
      yt: !1
    }, this.Sr = new Th, this.ft = !0, this.Ls = t, this.Es = t.$t(), this.Sr.J(this.Mr)
  }
  bt() {
    this.ft = !0
  }
...
class Ih {
  constructor(t) {
    this.Wt = new Vh, this.ft = !0, this.Er = !0, this.Nr = performance.now(), this.Fr = this.Nr - 1, this.Wr = t
  }
  jr() {
...
class Bh extends ft {
  ...
  ar(t, e) {
    this.j === t && this.H === e || (this.j = t, this.H = e, this.Jr = Dt(t, e), this.lr.ir())
  }
  br(t, e) {
  ...
  K({
    ...
    if (this.zt !== null && this.zt.tt !== null) {
      ...
      for (let h = this.zt.tt.from; h < this.zt.tt.to; h++) {
        ...
        r.Kt !== void 0 && (r.Kt.Hi = this.lr.xi(t, r.Kt.th), r.Kt.At = this.j, r.Kt.nt = r.nt - r.Kt.Hi / 2), Ah(r, t, e, i)
      }
    }
  }
}
...
function Dh(n, t, e) {
  return !(n.Kt === void 0 || ! function(i, s, o, h, r, l) {
    ...
    switch (i.ih) {
      case "arrowDown":
      case "arrowUp":
        return Wh(0, i.nt, i.st, i.Xs, s, o);
      case "circle":
...
class Oh {
  ...
  oh() {
    ...
    for (let c = this.zt.tt.from; c < this.zt.tt.to; c++) {
      ...
      p !== null && Nh(d, u, p, a, s.fontSize, l, t, e, h.Vt)
    }
    this.ft = !1
  }
}
...
class Xh {
  constructor(t, e) {
    this.Wr = t, this.cn = e, this.Wh = new Kh(t, this), this._r = new Jh(t, this), this.jh = new nn(this._r, t, t.$t())
  }
  Hh(t) {
...
class Gh {
  constructor(t) {
    this.Xh = (e, i) => i !== void 0 ? i.Vt : this.Wr.In().Kh(e), this.Wr = t, this.Gh = Yh[t.Jh()]
  }
  Hs(t, e) {
...
class yi extends Hh {
  constructor(t, e, i, s, o) {
    super(t), this.zt = new Zh, this.Wh = new Uh(this), this.Il = [], this.zl = new Ph(this), this.Ll = null, this.El = null, this.Nl = [], this.Fl = [], this.Wl = null, this.jl = [], this.cn = e, this.Hl = i;
    const h = new Fh(this);
    this.rn = [h], this.jh = new nn(h, this, t), i !== "Area" && i !== "Line" && i !== "Baseline" || (this.Ll = new Ih(this)), this.$l(), this.Ul(o)
  }
  S() {
  ...
  $s() {
    return this.El !== null || (this.El = new Gh(this)), this.El
  }
  W() {
    return this.cn
  }
  ...
  $l() {
    switch (this.cn.priceFormat.type) {
      case "custom":
        ...
        break;
      case "volume":
        this.ba = new ch(this.cn.priceFormat.precision);
        break;
      case "percent":
  ...
  Ul(t) {
    switch (this.dn = new Oh(this, this.$t()), this.Hl) {
      case "Bar":
...
class nr {
  ...
  Va(t, e, i) {
    ...
    if (h === null) return s;
    const r = o.Rt(t, h),
      l = i.Oa().filter(c => c instanceof yi).reduce((c, u) => {
...
class hr {
  constructor(t) {
    this.Wt = new or, this.ft = !0, this.tn = t
  }
  bt() {
    this.ft = !0
  }
...
class cr {
  ...
  me(t, e, i) {
    ...
    for (let f = u; f < d; f++) {
      ...
      let b = m.we,
        ...
        y = m.Me,
        k = m.xe;
      p !== null && (b = p(m.we, e), w = p(m.ge, e), y = p(m.Me, e), k = p(m.xe, e));
      let j = s + c * (b - h),
        B = a ? j : this.ro - 1 - j;
      m.ve = B, j = s + c * (w - h), B = a ? j : this.ro - 1 - j, m.ce = B, j = s + c * (y - h), B = a ? j : this.ro - 1 - j, m.de = B, j = s + c * (k - h), B = a ? j : this.ro - 1 - j, m.pe = B
    }
  }
  pn(t, e) {
    const i = this.Co(t, e);
    ...
    if (s === this.uo && o === this.co || (this.uo = s, this.co = o, this.mo = null, this.Ro()), e !== null) {
      ...
      if (this.eo()) {
        ...
        if (h = a, r = this.Mo, h.Ha !== r.Ha || h.$a !== r.$a) {
          ...
          this.Mo = a, e = Ut(l, a), c !== null && (this.lo = Ut(c, a))
        }
      }
      this.Bo(e)
  ...
  jo() {
    return this.gh() ? Bt : this.Vo() ? Ht : this.eo() ? t => ke(t, this.Mo) : null
  }
  l_(t, e, i) {
...
class ur {
  constructor(t, e) {
    this.vo = [], this.a_ = new Map, this.ro = 0, this.o_ = 0, this.__ = 1e3, this.po = null, this.u_ = new G, this.kl = t, this.$i = e, this.c_ = new rr(this);
    const i = e.W();
  ...
  f_(t, e) {
    const i = Object.assign({
      ...
      s = new cr(t, i, this.$i.W().layout, this.$i.W().localization);
...
class pr {
  ...
  $u(t) {
    ...
    return e === void 0 && (e = new dr(i => this.dc(i), this.U_), this.cu.set(t.weight, e)), e.q_(t)
  }
  dc(t) {
...
class gr {
  ...
  Mt() {
    ...
    e.yt = t.visible, e.yt && (e.V = t.color, e.Mc = t.horzAlign, e.gc = t.vertAlign, e.mc = [{
      Kt: t.text,
      R: Dt(t.fontSize, t.fontFamily, t.fontStyle),
      wc: 1.2 * t.fontSize,
      xc: 0,
      Yu: 0
    }])
...
class _r extends bi {
  constructor(t, e) {
    super(), this.cn = e, this.wn = new gr(this)
  }
  Rn() {
    return []
  }
...
class wr {
  constructor(t, e, i) {
    this.kc = [], this.yc = [], this.o_ = 0, this.Cc = null, this.Tc = new G, this.Pc = new G, this.Rc = null, this.Dc = t, this.cn = e, this.U_ = i, this.Vc = new qo(this), this.kl = new pr(this, e.timeScale, this.cn.localization, i), this.vt = new ah(this, e.crosshair), this.Oc = new nr(e.crosshair), this.Bc = new _r(this, e.watermark), this.Ac(), this.kc[0].M_(2e3), this.Ic = this.zc(0), this.Lc = this.zc(1)
  }
  Xl() {
    this.Ec(tt.es())
  }
  ...
  Bt(t) {
    ...
    const s = function(o, h, r) {
      const [l, a, c, u] = Qt(o), [d, p, f, m] = Qt(h), b = [lt(l + r * (d - l)), lt(a + r * (p - a)), lt(c + r * (f - c)), Us(u + r * (m - u))];
...
class Cr {
  constructor(t = {}) {
    const e = Object.assign(Object.assign({}, Sr), t);
    this.Cd = new cn(e.xd, e.yd), this.Td = new Mr(e.Sd), this.Pd = e.kd
  }
  q_(t) {
...
function Ue(n) {
  let t = n;
  if (ne(n) && (t = Mi(n)), !ni(t)) throw new Error("time must be of type BusinessDay");
...
class us {
  ...
  createConverterToInternalObj(t) {
    return _(function(e) {
      return e.length === 0 ? null : ni(e[0].time) || ne(e[0].time) ? Ue : as
    }(t))
  }
  key(t) {
  ...
  convertHorzItemToInternal(t) {
    return an(e = t) ? as(e) : ni(e) ? Ue(e) : Ue(Mi(e));
    var e
  }
  updateFormatter(t) {
    if (!this.cn) return;
...
class Si {
  ...
  Zf() {
    ...
    Fe() && (this.Mf = () => {
      ...
      passive: !0
    }), zr(this.Yf), this.Yf.addEventListener("mousedown", this.pv.bind(this)), this.gv(), this.Yf.addEventListener("touchmove", () => {}, {
      passive: !1
    })
  }
  gv() {
...
class ps {
  constructor(t, e, i, s) {
    this.Li = null, this.Lv = null, this.Ev = !1, this.Nv = new ie(200), this.Jr = null, this.Fv = 0, this.Wv = !1, this.jv = () => {
      ...
      this.Wv || this.tn.Hv().$t().$h()
    }, this.tn = t, this.cn = e, this.So = e.layout, this.Vc = i, this.Uv = s === "left", this.qv = He("normal", s), this.Yv = He("top", s), this.Zv = He("bottom", s), this.Xv = document.createElement("div"), this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Xv.style.width = "25px", this.Xv.style.left = "0", this.Xv.style.position = "relative", this.Kv = Tt(this.Xv, O({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const o = this.Kv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "1", o.style.left = "0", o.style.top = "0", this.Gv = Tt(this.Xv, O({
      width: 16,
      height: 16
  ...
  pp({
    ...
    h === r ? Le(t, 0, 0, i, s, h) : Ks(t, 0, 0, i, s, h, r)
  }
  Ae({
    context: t,
    bitmapSize: e,
  ...
  op() {
    return Dt(this.So.fontSize, this.So.fontFamily)
  }
}
...
class Ci {
  constructor(t, e) {
    ...
    i.style.width = "100%", i.style.height = "100%", i.style.position = "relative", i.style.overflow = "hidden", this.Wp = document.createElement("td"), this.Wp.style.padding = "0", this.jp = document.createElement("td"), this.jp.style.padding = "0", this.Fp.appendChild(i), this.Kv = Tt(i, O({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const s = this.Kv.canvasElement;
    s.style.position = "absolute", s.style.zIndex = "1", s.style.left = "0", s.style.top = "0", this.Gv = Tt(i, O({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
  ...
  Up(t) {
    var e, i;
    this.Ep !== null && this.Ep.F_().p(this), this.Ep = t, this.Ep !== null && this.Ep.F_().l(Ci.prototype.Np.bind(this), this, !0), this.$p(), this.Jd.qp().indexOf(this) === this.Jd.qp().length - 1 ? (this.Tp = (e = this.Tp) !== null && e !== void 0 ? e : new jr(this.Fp, this.Jd), this.Tp.bt()) : ((i = this.Tp) === null || i === void 0 || i.tf(), this.Tp = null)
  }
  Hv() {
    return this.Jd
  }
    ...
    return i === null ? null : function(s, o, h) {
      const r = s.$o(),
        l = function(a, c, u) {
          ...
          let f, m;
          for (const y of a) {
            const k = (p = (d = y.fa) === null || d === void 0 ? void 0 : d.call(y, c, u)) !== null && p !== void 0 ? p : [];
            for (const j of k) b = j.zOrder, (!(w = f == null ? void 0 : f.zOrder) || b === "top" && w !== "top" || b === "normal" && w === "bottom") && (f = j, m = y)
          }
          var b, w;
          return f && m ? {
            Iv: f,
  ...
  fp(t) {
    ...
    if (t > 1 && this.um(), this.yp !== null && this.yp.fp(t), this.Cp !== null && this.Cp.fp(t), t !== 1) {
      ...
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s)
      }), this.Ep && (this.dm(i, Er), this.fm(i), this.vm(i), this.dm(i, ve), this.dm(i, xr)))
    }
    this.Gv.applySuggestedBitmapSize();
    const e = xt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
  ...
  pp({
    ...
    h === r ? Le(t, 0, 0, i, s, r) : Ks(t, 0, 0, i, s, h, r)
  }
  fm(t) {
  ...
  vm(t) {
    const e = this.$i().qc();
    this.gm(t, ve, hi, e), this.gm(t, ve, ge, e)
  }
  pm(t) {
...
class vs {
  constructor(t, e, i, s, o) {
    this.ft = !0, this.Lv = O({
      width: 0,
      height: 0
    }), this.jv = () => this.fp(3), this.Uv = t === "left", this.Vc = i._d, this.cn = e, this.Cm = s, this.Tm = o, this.Xv = document.createElement("div"), this.Xv.style.width = "25px", this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Kv = Tt(this.Xv, O({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv)
  }
...
class Rr {
  ...
  fp(t) {
    ...
    if (t !== 1) {
      ...
      const i = xt(this.Kv);
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s), this.Ae(s), this.Hm(i, Vr)
      }), this.bp(i), this.Hm(i, Tr)), this.Pm !== null && this.Pm.fp(t), this.Rm !== null && this.Rm.fp(t)
    }
    this.Gv.applySuggestedBitmapSize();
    const e = xt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
      ...
      i.clearRect(0, 0, s.width, s.height)
    }), this.$m([...this.Jd.$t().wt(), this.Jd.$t().Yc()], e), this.Hm(e, Pr))
  }
  Hm(t, e) {
    const i = this.Jd.$t().wt();
    for (const s of i) ri(e, o => hi(o, t, !1, void 0), s, void 0);
    for (const s of i) ri(e, o => ge(o, t, !1, void 0), s, void 0)
  }
  pp({
    context: t,
    bitmapSize: e
  ...
  op() {
    return Dt(this.j(), this.cn.fontFamily)
  }
  Ym() {
    return Dt(this.j(), this.cn.fontFamily, "bold")
  }
  Wm() {
    this.k === null && (this.k = {
      C: 1,
...
class Wr {
  ...
  Tb() {
    ...
    for (let f = 0; f < this.Zm.length; ++f) {
      ...
      let b = 0,
        w = 0;
      w = f === this.Zm.length - 1 ? u - p : Math.round(m.g_() * d), b = Math.max(w, 2), p += b, m.up(O({
        width: h,
        height: b
  ...
  Pb(t) {
    ...
    return Ir ? 1 / window.devicePixelRatio : 1
  }
  eb(t) {
...
class Fr {
  ...
  tw(t, e) {
    ...
    const p = {
      ...
      f = oe(this.Zb, this.U_.key(p.time), (m, b) => this.U_.key(m.time) < b);
...
class rl {
  constructor(t, e, i) {
    this.xw = new Map, this.Sw = new Map, this.kw = new G, this.yw = new G, this.Cw = new G, this.Tw = new Fr(e);
    const s = i === void 0 ? gt(Cs()) : dt(gt(Cs()), js(i));
    this.U_ = e, this.lw = new Wr(t, s, e), this.lw.hm().l(h => {
    ...
    const o = this.lw.$t();
    this.Rw = new ol(o, this.lw.cb(), this.U_)
  }
  remove() {
  ...
  addAreaSeries(t) {
    return this.Dw("Area", Fo, t)
  }
  addBaselineSeries(t) {
    return this.Dw("Baseline", Ko, t)
  }
  addBarSeries(t) {
    return this.Dw("Bar", Oo, t)
  }
  addCandlestickSeries(t = {}) {
    ...
    }(t), this.Dw("Candlestick", No, t)
  }
  addHistogramSeries(t) {
    return this.Dw("Histogram", Jo, t)
  }
  addLineSeries(t) {
    return this.Dw("Line", Uo, t)
  }
  removeSeries(t) {
  ...
  Dw(t, e, i = {}, s) {
    hl(i.priceFormat);
    const o = dt(gt(Ns), gt(e), i),
      h = this.lw.$t().ud(t, o, s),
      r = new nl(h, this, this, this, this.U_);
...
function ll(n, t, e) {
  ...
  const s = new rl(i, t, e);
  return t.setOptions(s.options()), s
}

function al(n, t) {
  return ll(n, new us, us.Ad(t))
}
...
const cl = {
  ...
  wl = nt({
    ...
    setup(n) {
      const t = n,
        ...
        d = (f, m) => {
          var M, g;
          const b = (M = Mn().$webApp.dataUnsafe.user) == null ? void 0 : M.language_code,
          ...
          i.value = k, k.timeScale().applyOptions({
            borderColor: "transparent",
            secondsVisible: !0,
            timeVisible: !0,
            ticksVisible: !0,
          ...
          w && q ? k.timeScale().setVisibleLogicalRange(w) : k.timeScale().fitContent(), o.value = t.chartInterval
        },
        p = z(() => {
          const f = t.jettonPnl;
          if (!(f != null && f.hasPnL)) return;
          const m = new Lt(f.pnlPercent).gte(0),
            b = (() => {
              const k = Math.min(new Lt(f.pnlAbsoluteUSD.abs().toFixed(2)).decimalPlaces(), 2);
              return Ts(f.pnlAbsoluteUSD.abs(), k)
            })(),
            w = (() => {
              const k = Math.min(new Lt(f.pnlPercent.abs().toFixed(2)).decimalPlaces(), 2);
      ...
      return Mt(() => ({
        ...
        immediate: !0
      }), je(u), (f, m) => (C(), V("div", cl, [S("div", ul, [S("div", {
        class: "section",
        style: Ei({
          "grid-template-columns": `repeat(${v(r).length}, 1fr)`
        })
      }, [(C(!0), V(bt, null, ye(v(r), b => (C(), V("label", {
        key: b.value,
        class: Jt(["item", {
        ...
        [Qe, v(a)]
      ]), S("span", fl, N(b.label), 1)], 2))), 128))], 4), S("div", {
        class: "section",
        style: Ei({
          "grid-template-columns": `repeat(${v(h).length}, 1fr)`
        })
      }, [(C(!0), V(bt, null, ye(v(h), b => (C(), V("label", {
        key: b.value,
        class: Jt(["item", {
        ...
        [Qe, v(l)]
      ]), S("span", pl, N(b.label), 1)], 2))), 128))], 4)]), !f.chart || !f.chart.points.length ? (C(), V("div", vl, [m[3] || (m[3] = S("img", {
        src: xi,
        class: "lines"
      }, null, -1)), m[4] || (m[4] = S("img", {
        src: yn,
        class: "empty"
      }, null, -1)), S("div", bl, [m[2] || (m[2] = S("div", {
        class: "dot"
      }, null, -1)), S("div", gl, N(("t" in f ? f.t : v(E))("memepad.jetton.chart.coming_text")), 1)])])) : (C(), V("div", _l, [v(p) ? (C(), V("div", {
        key: 0,
        class: Jt(["pnl-label", `is-${v(p).direction}`])
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return C(), V(bt, null, [L(h, {
          ...
          default: X(() => [S("div", Ml, N(("t" in s ? s.t : v(E))("memepad.jetton.unlock.btn")), 1)]),
          _: 1
        }, 8, ["type"]), L(a, {
          modelValue: v(e),
          "onUpdate:modelValue": o[1] || (o[1] = c => at(e) ? e.value = c : null)
        }, {
          default: X(() => [S("div", Sl, [S("div", Cl, [L(r, {
            src: v(ai)(s.jetton.iconFileKey),
            size: 80
          }, null, 8, ["src"])]), S("div", kl, N(("t" in s ? s.t : v(E))("memepad.jetton.unlock.sheet.title", {
            ticker: s.jetton.ticker
          })), 1), S("div", jl, N(("t" in s ? s.t : v(E))("memepad.jetton.unlock.sheet.subtitle", {
            ticker: s.jetton.ticker
          })), 1), S("div", zl, [L(l, {
            jetton: s.jetton,
  ...
  Tl = nt({
    ...
    setup(n) {
      ...
      }, [S("span", xl, N(n.label), 1), Me(S("input", {
  ...
  Vl = nt({
    ...
    setup(n) {
      ...
      return kn(Ps, {
        ...
        }, [Me((C(), V("div", Pl, [Ln(s.$slots, "default", {}, void 0, !0), (C(!0), V(bt, null, ye(v(i), l => (C(), W(h, {
          key: l.value,
          label: l.label,
          value: l.value,
          type: n.type
    ...
    setup(n) {
      ...
      return (h, r) => {
        ...
        const l = Vs,
          ...
          u = Is,
          d = Vt;
        return C(), V("div", Il, [S("div", Wl, [h.inputState ? (C(), V(bt, {
          key: 0
          ...
          key: 1,
          class: "skeleton"
        })), h.inputState.error || h.inputState.feesInfo ? (C(), W(c, {
          key: 2,
          ...
          class: "skeleton"
        })], 64))]), (w = (b = h.inputState) == null ? void 0 : b.error) != null && w.notEnoughtTon ? (C(), W(u, {
          key: 0,
          ...
          default: X(() => [S("div", Bl, N(("t" in h ? h.t : v(E))("memepad.jetton.buy_button_label", {
          ...
          default: X(() => [S("div", Al, N(("t" in h ? h.t : v(E))("memepad.jetton.sell_button_label", {
            ticker: h.jetton.ticker
          })), 1)]),
          _: 1
  ...
  Jl = nt({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        u = () => {
          var M;
          e.jettonModalControls.value.value === yt.TRADE && ((M = h.value) == null || M.focusOnInput())
        },
        d = U(e.jettonTrading.slippage);
      Mt(() => e.jettonModalControls.isOpened(yt.SLIPPAGE), M => {
        var g;
        d.value = e.jettonTrading.slippage, a(), M || (g = h.value) == null || g.focusOnInput()
      });
      const p = U(),
        f = U("0"),
        m = M => qt(M, {
      ...
      Mt(() => s.value, () => {
        f.value = "0", $i(() => {
          var M;
          return (M = p.value) == null ? void 0 : M.applyNearestValue()
        })
      });
      const y = z(() => {
          if (!(!l.value || l.value.loading)) {
            if (k.value.isZero()) return s.value === Z.BUY ? `0 ${e.jetton.ticker}` : "0 TON";
            if (!l.value.feesInfo || !l.value.ready) return "";
            if (s.value === Z.SELL) {
              const M = l.value.tradeInfo.maxReceive,
                g = `${Ti(M)} TON`;
              if (!e.tonUsdRate) return g;
              const $ = Ts(e.tonUsdRate.mul(M));
              return `${g} (≈$${$})`
            } else {
              const M = l.value.tradeInfo.maxReceive;
              return `≈${qt(M,{accuracy:0})} ${e.jetton.ticker}`
            }
          }
        }),
        k = z(() => new Lt(f.value.replaceAll(",", "") || "0"));
      let j;
      ...
      function q() {
        ...
        return async () => {
          ...
          await (async () => {
            ...
            if (H.err) {
              En().error("Memepad jetton trade error", H.extra), o.value[x] = !1, R(), $(J, x);
              return
            }
            i("trade");
            const Y = H.data;
            j = x === Z.BUY ? e.jettonTrading.getWaitForBuyStatus() : e.jettonTrading.getWaitForSellStatus(), await Es(2e4);
            const ct = await j.exec({
                jettonAddress: D,
                transactionHash: Y
              }),
              it = ct ? "success" : "failed";
            if (x === Z.BUY ? M.memepad.memepadJettonBuy({
                status: it,
                jettonId: P,
                jettonShortname: K,
                jettonAddress: A,
            ...
            _e().bottom.success(Q), o.value[x] = !1, e.tradeSuccessCallback()
          })()
        }
      }
      return (M, g) => {
        ...
        return C(), W(K, {
          ...
          default: X(() => [S("div", Ol, [(C(), W(x, {
            ...
            modifier: m,
            onBlur: u
          }, null, 8, ["modelValue", "postfix"])), S("div", Ul, [v(y) ? (C(), V("span", Fl, N(v(y)), 1)) : v(y) === void 0 ? (C(), W(J, {
            key: 1,
            class: "skeleton"
          })) : vt("", !0)]), S("button", {
            type: "button",
            class: "reset slippage-btn",
            onClick: g[2] || (g[2] = R => M.$emit("open-slippage"))
          }, [S("span", Kl, N(`${("t"in M?M.t:v(E))("memepad.jetton.slippage_btn")} ${v(d)}%`), 1), L(T, {
  ...
  ta = nt({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        l = z(() => r.value.lt(ql) ? E("memepad.jetton.slippage.error_message.too_low") : r.value.gt(Ql) ? E("memepad.jetton.slippage.error_message.too_high") : ""),
        a = () => {
      ...
      return (c, u) => {
        ...
        return C(), W(m, {
          ...
          "top-center": X(() => [S("div", Hl, N(("t" in c ? c.t : v(E))("memepad.jetton.slippage.title")), 1)]),
          default: X(() => [S("div", Yl, [L(d, {
            ref_key: "actionControlsInputComp",
            ref: s,
            modelValue: v(h),
            "onUpdate:modelValue": u[0] || (u[0] = b => at(h) ? h.value = b : null),
            postfix: "%",
            modifier: b => ("formatFloatLine" in c ? c.formatFloatLine : v(qt))(b, {
              join: "emptyFractional"
            }),
            onBlur: o
          ...
          "bottom-action": X(() => [S("div", Gl, [v(l) ? (C(), W(p, {
            key: 0,
            "error-message": v(l)
          }, null, 8, ["error-message"])) : (C(), V("div", Zl, N(("t" in c ? c.t : v(E))("memepad.jetton.slippage.text")), 1)), L(f, {
  ...
  oa = nt({
    ...
    setup(n) {
      return (t, e) => {
        const i = Vt;
        return C(), V("div", ia, [L(i, {
          class: "buy-button",
          type: v(Ct).HIGHLIGHT,
          loading: t.tradePendings[v(Z).BUY],
          onClick: e[0] || (e[0] = s => t.$emit("click", v(Z).BUY))
        }, {
          default: X(() => [S("span", sa, N(("t" in t ? t.t : v(E))("memepad.jetton.buy_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"]), L(i, {
          class: "sell-button",
          type: v(Ct).PINK,
          ...
          default: X(() => [S("span", na, N(("t" in t ? t.t : v(E))("memepad.jetton.sell_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"])])
      }
    }
        ...
        return C(), V("div", ra, [L(w, null, {
          default: X(() => [L(b, {
            ...
            default: X(() => [c.unlockEnabled ? (C(), W(d, {
              ...
              key: 1
            }, [c.jettonModalControls.isOpened(v(yt).TRADE) ? (C(), W(p, {
              key: 0,
              modelValue: v(s),
              "onUpdate:modelValue": u[0] || (u[0] = y => at(s) ? s.value = y : null),
              "trade-pendings": v(o),
              "onUpdate:tradePendings": u[1] || (u[1] = y => at(o) ? o.value = y : null),
              jetton: c.jetton,
              "jetton-information": c.jettonInformation,
              ...
              onOpenSlippage: u[3] || (u[3] = y => c.jettonModalControls.add(v(yt).SLIPPAGE))
            }, null, 8, ["modelValue", "trade-pendings", "jetton", "jetton-information", "jetton-bcl-data", "balances", "jetton-management", "jetton-trading", "is-released", "unlock-enabled", "ton-usd-rate", "jetton-modal-controls"])) : vt("", !0), c.jettonModalControls.isOpened(v(yt).SLIPPAGE) ? (C(), W(f, {
              key: 1,
              "jetton-trading": c.jettonTrading,
              "jetton-modal-controls": c.jettonModalControls,
              onSlippageUpdated: u[4] || (u[4] = y => c.jettonModalControls.set(v(yt).TRADE))
            }, null, 8, ["jetton-trading", "jetton-modal-controls"])) : vt("", !0), L(m, {
              "trade-pendings": v(o),
              onClick: h
    ...
    setup(n) {
      ...
      return (s, o) => {
        const h = Po,
          ...
          a = aa,
          c = xs;
        return C(), V(bt, null, [S("div", ca, [L(h, {
          jetton: s.jetton,
          "jetton-information": s.jettonInformation,
          "is-released": s.isReleased,
          "jetton-modal-controls": s.jettonModalControls,
          onShare: o[0] || (o[0] = u => e.value = !0)
        }, null, 8, ["jetton", "jetton-information", "is-released", "jetton-modal-controls"]), L(r, Pn(v(i), {
          class: "details"
        }), null, 16), L(l, {
          chart: s.jettonChart,
        ...
        }, null, 8, ["jetton", "jetton-information", "is-released", "unlock-enabled", "balances", "jetton-management", "jetton-trading", "ton-usd-rate", "jetton-modal-controls"])]), L(c, {
          modelValue: v(e),
  ...
  ja = nt({
    ...
    setup(n) {
      const t = Vn(),
        ...
        {
          jettonChart: k,
          jettonChartInterval: j,
          ...B
        } = x(),
        q = async () => {
          await Promise.all([d.update(), h.value.update(), B.update(), y.update()])
        }, M = async () => {
          ...
          const T = e.value.address,
            I = [re.PUBLISHED_ON_DEX, re.LISTED_TO_DEX].includes(o.value.status),
            P = {
      ...
      Hn(z(() => g.value.status === "moving_to_dex"), "memepad-jetton-trade-status");
      const $ = () => {
          y.init(), B.init()
        },
        F = () => {
      ...
      function x() {
        ...
        const D = () => {
          ...
          H = Ot(async () => {
            ...
            return A.signal.aborted ? ut(T.value) : ut((It(Q) ? Q.data : T.value) || T.value)
          }, Q => T.value = Q, 5e3);
        return {
          init: async () => await H.exec(),
          destroy: () => {
            H.destroy(), T.value = void 0, I.value = Kt.ONE_MINUTE
          },
          update: async () => await H.exec(),
          updateChartInterval: K,
          updateChartType: R,
          jettonChartInterval: z(() => I.value),
          jettonChartType: z(() => P.value),
          jettonChart: z(() => T.value)
        }
      }
      ...
      function J() {
        const T = U(),
          ...
          P = U(),
          A = U();
        let D, K, R, H, Y, ct, it, Q;

        function he() {
          K = Mt(g, rt => {
            rt.status === "loading" || D || rt.jettonManagement && (K == null || K(), D = Ot(async () => {
              if (g.value.status === "loading") return ut(void 0);
              const et = g.value.jetton.address,
                jt = await g.value.jettonManagement.getJettonBclData(et);
              return ut((It(jt) ? jt.data : T.value) || T.value)
            }, et => T.value = et, 6e4), D == null || D.exec())
          }, {
            immediate: !0
          }), H = Mt(g, rt => {
            rt.status === "loading" || R || !rt.jettonTrading || p.value !== "connected" || (H == null || H(), R = Ot(async () => {
              if (g.value.status === "loading" || !g.value.jettonTrading || p.value !== "connected") return ut(void 0);
              const et = g.value.jetton.address,
                jt = await g.value.jettonTrading.getUserJettonBalance(et);
              return ut((It(jt) ? jt.data : I.value) || I.value)
            }, et => I.value = et, 6e4), R == null || R.exec())
          }, {
            immediate: !0
          }), ct = Mt(g, rt => {
            rt.status === "loading" || Y || !rt.jetton || !rt.balances.jettonBalance || !rt.isReleased || p.value !== "connected" || (ct == null || ct(), Y = Ot(async () => {
              if (g.value.status === "loading" || !g.value.balances.jettonBalance || !g.value.isReleased || p.value !== "connected") return ut(void 0);
              if (g.value.balances.jettonBalance.value.isZero()) return ut(!1);
              const et = await g.value.jettonManagement.getUnlockEnabled(g.value.jetton.address);
              return ut(It(et) ? et.data : P.value)
            }, et => P.value = et, 6e4), Y == null || Y.exec())
          }, {
            immediate: !0
          }), Q = Mt(g, rt => {
            rt.status === "loading" || it || d.wallet.value.status === "connected" && (Q == null || Q(), it = Ot(async () => {
              if (g.value.status === "loading" || d.wallet.value.status !== "connected") return ut(void 0);
              const et = g.value.jetton.shortname,
                jt = d.wallet.value.address.default,
                Li = await Pi.getMemepadJettonPnl(et, jt);
              return ut((It(Li) ? Li.data : A.value) || A.value)
        ...
        return {
          init: he,
          destroy: () => {
            K == null || K(), D == null || D.destroy(), H == null || H(), R == null || R.destroy(), ct == null || ct(), Y == null || Y.destroy(), Q == null || Q(), it == null || it.destroy(), T.value = void 0, I.value = void 0, P.value = void 0, A.value = void 0
          },
          update: async () => {
          ...
          jettonBclData: z(() => T.value),
          jettonBalance: z(() => I.value),
