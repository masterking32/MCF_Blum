...
const Dt = {
  ...
  Qt = U({
    ...
    setup(l) {
      ...
      }, [rt(s.$slots, "tooltip", {}, void 0, !0)], 4)) : Y("", !0)]), Te(f("input", {
    ...
    setup(l, {
      ...
      return (o, r) => {
        ...
        return e(c) ? (d(), L(a, {
          ...
          loading: o.pending,
          onClick: s
        }, null, 8, ["label", "size", "type", "loading"])) : Y("", !0)
      }
    }
  }),
  ve = V(on, [
    ...
    setup(l, {
      ...
      return x(() => o.value.isSheetVisible, async g => {
        ...
        return d(), L($, {
          ...
          default: B(() => [f("div", Fn, [e(R) ? (d(), L(z, {
            key: 0
          })) : Y("", !0), e(C) ? (d(), L(q, {
            key: 1,
            items: e(c)
          }, null, 8, ["items"])) : Y("", !0), Te(f("div", Mn, [(d(!0), b(j, null, te(e(o).result, (ae, Ge) => (d(), b("div", {
            key: Ge
          }, [f("img", {
            alt: "",
            src: ae.imageUrl,
            ...
            title: B(() => [qe(K(("t" in g ? g.t : e(A))("memepad.new.ai_agent.generation_failed_error")), 1)]),
            _: 1
          })) : Y("", !0), e(S) ? (d(), L(M, {
            key: 3,
            "once-generated": "",
            ...
            onClick: v
          }, null, 8, ["analytics-type", "analytics-page", "analytics-stage"])) : Y("", !0)])]),
          _: 1
  ...
  lt = async l => {
    ...
    setup(l, {
      ...
      return Oe(() => {
        ...
        return d(), b("div", ta, [f("div", na, [w(Et, {
          ...
          default: B(() => [(d(!0), b(j, null, te(e(s), (S, P) => (d(), L(R, {
            key: S.provider,
          ...
          default: B(() => [e(o).length > 0 ? (d(), b("div", aa, [w(C, {
            name: "plus",
            class: "plus-icon"
    ...
    setup(l, {
      ...
      return x(() => E.value.isSheetVisible, async u => {
        ...
        return d(), L(g, {
          ...
          default: B(() => [f("div", Aa, [e(a) ? (d(), L(v, {
            key: 0
          })) : Y("", !0), Te(f("div", ga, [(d(!0), b(j, null, te(e(E).result, (G, z) => (d(), L(k, {
            key: z,
            ...
            title: B(() => [qe(K(("t" in u ? u.t : e(A))("memepad.new.ai_agent.generation_failed_error")), 1)]),
            _: 1
          })) : Y("", !0), e(_) ? (d(), L(m, {
            key: 2,
            "once-generated": "",
    ...
    setup(l) {
      ...
      return (t, p) => {
        ...
        return d(), b("div", wa, [f("button", {
          ...
          key: s.title,
          class: "row"
        }, [f("div", ka, [f("div", Oa, K(s.title), 1), s.badge ? (d(), b("div", La, K(s.badge.label), 1)) : Y("", !0)]), f("div", Pa, [s.tooltip ? (d(), L(E, Se({
          key: 0,
          ref_for: !0
        }, s.tooltip.props), {
          default: B(() => [w(c, {
          ...
          inner: B(() => [f("div", Ga, ["details" in s.tooltip ? (d(!0), b(j, {
            key: 0
          ...
          }, K(o.label), 3)) : Y("", !0)], 64))), 128)) : (d(), b("span", {
            key: 1,
            class: fe({
          ...
          _: 2
        }, 1040)) : Y("", !0), f("span", Fa, K(s.label), 1)])]))), 128))], 64)) : Y("", !0)])
      }
    }
  }), Ua = V(Ma, [
      ...
      return x(() => c.value.share, () => {
        ...
        return d(), L(Q, {
          ...
          default: B(() => [f("div", Ka, [w(k, {
            ...
            default: B(() => T[2] || (T[2] = [f("div", {
              class: "label"
            }, "MAX", -1)])),
            _: 1
          }, 8, ["type", "size"])) : Y("", !0)])])])]),
          "bottom-action": B(() => [f("div", za, [e(N) ? (d(), L(G, {
            key: 0,
    ...
    setup(l) {
      ...
      return (i, m) => {
        ...
        }, null, 8, ["state", "step-number", "balances", "launch-controls", "launch-callback"])) : Y("", !0) : (d(), L(q, {
          key: 2
        }))])
      }
    }
