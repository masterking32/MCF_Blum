...
(function(e, t) {
  ...
  function c(n, i) {
    ...
    var p = n.split("."),
      f = p[p.length - 1];
    return i.require_tld && (p.length < 2 || !i.allow_numeric_tld && !/^([a-z\u00A1-\u00A8\u00AA-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]{2,}|xn[a-z0-9-]{2,})$/i.test(f) || /\s/.test(f)) || !i.allow_numeric_tld && /^\d+$/.test(f) ? !1 : p.every(function(u) {
...
(function(e, t) {
  ...
  function p(f) {
    ...
    return (0, s.default)(f), u = String(u), u ? u === "4" ? c.test(f) : u === "6" ? i.test(f) : !1 : p(f, 4) || p(f, 6)
  }
  e.exports = t.default, e.exports.default = t.default
})(pe, pe.exports);
var Ut = pe.exports,
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function p(v, y) {
    if (v) {
      ...
      if (M === "Object" && v.constructor && (M = v.constructor.name), M === "Map" || M === "Set") return Array.from(v);
      if (M === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(M)) return f(v, y)
    }
  }

  function f(v, y) {
    (y == null || y > v.length) && (y = v.length);
    for (var M = 0, V = new Array(y); M < y; M++) V[M] = v[M];
    return V
  }
  ...
  function u(v, y) {
    if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(v)))) {
      var M = [],
        ...
        R = void 0;
      try {
        for (var C = v[Symbol.iterator](), B; !(V = (B = C.next()).done) && (M.push(B.value), !(y && M.length === y)); V = !0);
      } catch (A) {
        F = !0, R = A
      } finally {
        try {
  ...
  function h(v, y) {
    for (var M = 0; M < y.length; M++) {
      var V = y[M];
      if (v === V || d(V) && V.test(v)) return !0
    }
    return !1
  }

  function x(v, y) {
    if ((0, s.default)(v), !v || /[\s<>]/.test(v) || v.indexOf("mailto:") === 0 || (y = (0, a.default)(y, b), y.validate_length && v.length >= 2083) || !y.allow_fragments && v.includes("#") || !y.allow_query_components && (v.includes("?") || v.includes("&"))) return !1;
    var M, V, F, R, C, B, A, H;
    ...
    if (v = A.join("://"), v === "") return !1;
    if (A = v.split("/"), v = A.shift(), v === "" && !y.require_host) return !0;
...
const Nt = {
  ...
  Wt = E({
    ...
    setup(e) {
      ...
      return (r, l) => (m(), w("div", jt, [_("div", qt, $(o(s).step), 1), _("div", Kt, $(o(s).label), 1)]))
    }
  }),
  oe = P(Wt, [
  ...
  Yt = E({
    ...
    setup(e) {
      ...
      return (c, n) => {
        ...
        const i = Ae,
          p = Ne;
        return m(), w("div", zt, [_("div", Gt, [o(a) ? (m(), w("div", {
          key: 0,
          ...
          onClick: n[0] || (n[0] = u => r())
        }, [((f = o(l)) == null ? void 0 : f.status) === o(ie).UPLOADING ? (m(), U(i, {
          key: 0,
          type: o($e).LIGHT,
          size: 16
        }, null, 8, ["type"])) : (m(), w("img", Jt))])), _("div", Ht, [_("div", Qt, $(("t" in c ? c.t : o(I))("memepad.new.step_1.field_icon.label")), 1), _("div", Zt, $(("t" in c ? c.t : o(I))("memepad.new.step_1.field_icon.description", {
    ...
    setup(e, {
      ...
      return _e(a, () => {
        ...
        return m(), w("div", {
          ...
          key: 0,
          for: o(l)
        }, [_("span", null, $(b.label), 1), b.errorCaption ? (m(), w("div", tn, [k[3] || (k[3] = _("img", {
          src: Ye,
          alt: "Warning icon"
        }, null, -1)), _("div", null, $(b.errorCaption), 1)])) : b.maxLength ? (m(), U(d, {
          key: 1,
          value: a.value,
...
const an = E({
    ...
    setup(e, {
      ...
      const a = () => {},
        ...
        n = L(() => r.value.every(u => i(u).length === 0));
      ...
      return ne(() => s("channel", {
        ...
        }, [(m(!0), w(K, null, Y(r.value, d => {
          var h, x, v, y, M, V, F, R;
          return m(), w("div", {
            key: d.key,
            class: "field"
          }, [d.type === o(D).STRING ? (m(), U(b, ye({
            key: 0,
            modelValue: d.value,
            ...
            class: "input",
            onChange: C => c(d),
            onFocus: (v = d.eventHandlers) == null ? void 0 : v.onFocus,
            onBlur: (y = d.eventHandlers) == null ? void 0 : y.onBlur
          }), {
            label: N(() => [Z(u.$slots, `${d.key}-label`, {}, void 0, !0)]),
            _: 2
          }, 1040, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur"])) : O("", !0), d.type === o(D).TEXTAREA ? (m(), U(k, ye({
            key: 1,
            modelValue: d.value,
            "onUpdate:modelValue": C => d.value = C,
            ref_for: !0
    ...
    setup(e, {
      ...
      const r = T({
        ...
        a = T([{
          ...
          customValidator: p => {
            if (!p.match(/^[A-Z0-9]+$/)) return I("memepad.new.step_1.field_ticker.custom_validator_error")
          }
        }, {
          key: "description",
          type: D.TEXTAREA,
        ...
        n = L(() => {
          var p;
          return ((p = c.value) == null ? void 0 : p.isFormValid) && !!r.value.iconFileKey
        }),
      ...
      return (p, f) => {
        ...
        return m(), w("div", ln, [S(u, {
          ...
          default: N(() => [S(k, {
            label: ("t" in p ? p.t : o(I))("base.continue"),
            fill: "",
            disabled: !o(n),
            tertiary: "",
            size: o(G).LARGE,
  ...
  vn = E({
    ...
    setup(e) {
      return (t, s) => {
        const r = J;
        return m(), w("div", un, [e.iconName ? (m(), U(r, {
          key: 0,
          name: e.iconName,
          class: "icon"
        }, null, 8, ["name"])) : O("", !0), _("div", dn, [_("span", mn, $(e.title), 1), e.isOptional ? (m(), w("span", pn, $(` ${("t"in t?t.t:o(I))("base.optional")}`), 1)) : O("", !0)])])
      }
    }
  }),
  qe = P(vn, [
    ...
    setup(e) {
      ...
      return (c, n) => {
        ...
        return m(), w("div", hn, [S(i, {
          ...
          alt: "Trash icon",
          class: "icon"
        }, null, -1)]))], 4)) : ((u = o(l)) == null ? void 0 : u.status) === o(ie).UPLOADING ? (m(), w("div", fn, [S(p, {
          type: o($e).LIGHT,
          size: 16
        }, null, 8, ["type"]), _("div", _n, $(("t" in c ? c.t : o(I))("memepad.new.step_1.field_banner.uploading")), 1)])) : (m(), w("div", {
          key: 2,
  ...
  An = E({
    ...
    setup(e, {
      ...
      const s = St(),
        ...
        c = L(() => Object.values(we).filter(p => !a.value.find(f => f.provider === p))),
        n = p => a.value.push({
          provider: p,
          isValid: !1,
          optional: !0
      ...
      return ne(() => {
        const p = a.value.every(f => f.isValid);
        l("isValid", p)
      }), (p, f) => {
        const u = xn,
          g = J;
        return m(), w("div", In, [_("div", Mn, [S(lt, {
          name: "list-shuffle-transition"
        }, {
          default: N(() => [(m(!0), w(K, null, Y(o(a), (b, k) => (m(), U(u, {
            key: b.provider,
          ...
          default: N(() => [o(c).length > 0 ? (m(), w("div", $n, [S(g, {
            name: "plus",
            class: "plus-icon"
          }), _("div", Vn, [(m(!0), w(K, null, Y(o(c), b => (m(), w("div", {
            key: b,
            class: "provider"
          }, [S(g, {
            name: o(s)[b].icon,
  ...
  Pn = E({
    ...
    setup(e) {
      const t = q(e, "modelValue");
      return (s, r) => (m(), w("div", Fn, [Ee(_("input", {
  ...
  Cn = E({
    ...
    setup(e) {
      ...
      return (s, r) => {
        const l = Rn,
          a = $t;
        return m(), w("div", Un, [_("div", Ln, [_("div", On, $(("t" in s ? s.t : o(I))("memepad.new.step_1.field_nsfw.label")), 1), S(l, {
          modelValue: t.value,
...
function re(e) {
  return Ke(e) ? e.changedTouches[0] || e.touches[0] : e
}
const We = E({
  props: {
    modelValue: null,
  ...
  methods: {
    ...
    calculateBounds() {
      const e = this.$refs.rotator,
        ...
        r = this.bounds = this.refItems.map(n => Kn(n) - s).sort((n, i) => n - i),
    ...
    onMove(e) {
      ...
      Math.abs(r) > 1.5 && (this.isDragging = !0), this.scroll = this.start[0] + r * (Ke(e) ? this.touchSensitivity : this.dragSensitivity);
      const l = this.sanitizeInternalIndex(this.findIndexFromScroll(this.scroll)),
    ...
    onClick(e) {
      ...
      if (this.internalIndex !== n && this.internalOptions[n]) {
        const i = this.internalValue,
          p = this.internalOptions[n].value;
        this.scrollTo(this.findScrollByIndex(n), () => {
          this.internalIndex = n, this.emitModalValue(p)
        }), this.$emit("click", p, i)
      }
    },
    correction(e) {
...
function Wn(e) {
  e.component("VueScrollPicker", We)
}
typeof window < "u" && window.Vue && Wn(window.Vue);
const zn = {
    ...
    setup(e) {
      const t = e,
        ...
        r = L(() => {
          ...
          const i = (p = t.overview) == null ? void 0 : p.tonForDexWithFees;
          return i && a.push({
            name: n(i),
            value: i.toNumber()
          }), a.filter(f => i ? i.gte(f.value) : !0).sort((f, u) => f.value - u.value)
        });
      return (l, a) => (m(), w("div", zn, [S(o(We), {
        modelValue: s.value,
    ...
    setup(e, {
      ...
      return _e(() => i.value.share, () => {
        ...
        return m(), w("div", Zn, [S(v, {
          ...
          default: N(() => [_("div", Yn, [o(l).wallet.value.status === "connected" && o(a).tonConnectUI.value.connected && o(l).wallet.value.balance && !o(u) ? (m(), w("div", Xn, [S(M, {
            name: "circle-warning",
            class: "icon"
          }), _("span", es, $(("t" in h ? h.t : o(I))("memepad.jetton.not_enough_error", {
            ticker: "TON"
          })), 1)])) : (m(), w("div", ts, [o(f) ? (m(), w("span", ns, $(o(f)), 1)) : (m(), U(V, {
            key: 1,
            class: "received-jetton-skeleton"
          }))])), o(l).wallet.value.status === "connected" && o(a).tonConnectUI.value.connected && o(l).wallet.value.balance ? (m(), w("div", ss, [_("div", os, [x[1] || (x[1] = _("img", {
            class: "img",
            src: ut,
            alt: "Ton logo",
            width: "24",
            height: "24"
          }, null, -1)), _("span", as, $(("t" in h ? h.t : o(I))("memepad.new.step_3.balance_label")), 1)]), _("div", ls, $(o(l).wallet.value.balance.tonBalance.balance.frontendWithSymbol), 1)])) : O("", !0), o(l).wallet.value.status === "connected" && o(a).tonConnectUI.value.connected && o(l).wallet.value.balance && !o(u) ? (m(), U(F, {
            key: 3
          })) : (m(), U(R, {
            key: 4,
  ...
  $s = E({
    ...
    setup(e) {
      return (t, s) => {
        const r = J,
          l = At;
        return m(), w("div", fs, [(m(!0), w(K, null, Y(t.details.sections, a => (m(), w("div", {
          key: a.title,
          class: "row"
          ...
          inner: N(() => [_("div", bs, [(m(!0), w(K, null, Y(a.details, c => (m(), w("span", {
            key: c.label,
            class: Fe({
          ...
          _: 2
        }, 1024), _("span", ys, $(a.label), 1)])]))), 128)), t.details.totalSection ? (m(), w(K, {
          key: 0
        }, [s[0] || (s[0] = _("div", {
          class: "divider"
        }, null, -1)), _("div", ws, [_("div", Ss, $(t.details.totalSection.title), 1), t.notEnoughBalance ? (m(), w("div", ks, [S(r, {
          name: "circle-help",
          class: "icon"
        }), _("span", xs, $(("t" in t ? t.t : o(I))("memepad.jetton.not_enough_error", {
          ticker: "TON"
        })), 1)])) : (m(), w("div", Is, [_("span", Ms, $(t.details.totalSection.label), 1)]))])], 64)) : O("", !0)])
      }
    }
  }),
  Vs = P($s, [
  ...
  Fs = E({
    ...
    setup(e, {
      ...
      const n = L(() => {
        ...
        i = L(() => s.jettonManagement.getPriceDetails(s.form.overview)),
        p = L(() => {
          var b;
    ...
    setup(e, {
      ...
      return ht(() => {
        ...
        const f = Et,
          ...
          b = ee,
          k = ft;
        return m(), w("div", Rs, [S(f), o(r) === "ERROR" ? (m(), w(K, {
          key: 0
          ...
          default: N(() => [S(g, {
            ...
            size: o(G).LARGE,
            onClick: p[0] || (p[0] = d => i.retryCallback(i.form))
          }, null, 8, ["label", "size"])]),
          _: 1
        })], 64)) : (m(), w(K, {
          key: 1
          ...
          width: "80",
          height: "80"
        }, null, 8, Ds)]), _("div", js, $(("t" in i ? i.t : o(I))("memepad.new.step_launch.title")), 1), _("div", qs, $(("t" in i ? i.t : o(I))("memepad.new.step_launch.subtitle")), 1)]), o(r) === "ROCKET" ? (m(), w("div", Ks, [S(k, {
  ...
  Hs = E({
    ...
    setup(e) {
      ...
      const c = t.jettonManagement.getWaitForCreateStatus(),
        n = T(t.retryPayload ? Mt(t.retryPayload) : {
          step: 1,
          step1: le.step1(),
          step2: le.step2(),
          step3: le.step3()
      ...
      return (d, h) => {
        const x = Dt,
          ...
          V = Ps,
          F = Gs;
        return m(), w("div", Js, [o(n).step !== 5 ? (m(), U(x, {
          key: 0,
          step: o(n).step,
          "count-steps": 4
        }, null, 8, ["step"])) : O("", !0), o(n).step === 1 ? (m(), U(v, {
          key: 1,
          state: o(n),
          onContinue: h[0] || (h[0] = R => p(o(n), R))
        }, null, 8, ["state"])) : O("", !0), o(n).step === 2 ? (m(), U(y, {
          key: 2,
          state: o(n),
          onContinue: h[1] || (h[1] = R => f(o(n), R))
        }, null, 8, ["state"])) : O("", !0), o(n).step === 3 ? (m(), U(M, {
          key: 3,
          state: o(n),
          "jetton-management": t.jettonManagement,
          onContinue: h[2] || (h[2] = R => u(o(n), R)),
          onUpdate: h[3] || (h[3] = R => g(o(n), R))
        }, null, 8, ["state", "jetton-management"])) : O("", !0), o(n).step === 4 ? (m(), U(V, {
          key: 4,
          form: o(ke)(o(n)),
          "jetton-management": t.jettonManagement,
        ...
        }, null, 8, ["form", "jetton-management", "ton-usd-rate"])) : O("", !0), o(n).step === 5 ? (m(), U(F, {
          key: 5,
  ...
  Ys = E({
    ...
    setup(e) {
      ...
      return (() => {
        ...
        const i = Qs,
          p = Pt;
        return m(), w("div", Zs, [o(r) ? (m(), U(i, {
          key: 0,
          "ton-usd-rate": o(s),
          "retry-payload": o(t)(),
          "jetton-management": o(r)
        }, null, 8, ["ton-usd-rate", "retry-payload", "jetton-management"])) : (m(), U(p, {
          key: 1
        }))])
      }
    }
