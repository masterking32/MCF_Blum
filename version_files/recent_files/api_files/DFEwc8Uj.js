    ...
    setup(b, {
      ...
      const s = b,
        ...
        f = _({
          ...
          set(e) {
            s.modifiers && (s.modifiers.includes(C.UPPERCASE) && (e = e.toUpperCase()), s.modifiers.includes(C.AMOUNT) && e && (e = z(e, {
      ...
      return (e, p) => {
        ...
        return a(), n("div", {
          ...
          default: I(() => [e.status === t(c).SUCCESS ? (a(), n("img", ue)) : o("", !0), e.status === t(c).ERROR ? (a(), n("img", pe)) : o("", !0), e.status === t(c).LOADING ? (a(), $(O, {
            key: 2,
            type: t(W).DARK,
            size: 20,
            "track-dimmed": "",
