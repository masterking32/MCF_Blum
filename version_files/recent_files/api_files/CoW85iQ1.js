...
const Lt = {
      ...
      return (k, S) => {
        ...
        return i(), L(f, {
          ...
          default: K(() => [a("div", jt, [g(R, {
            ...
            onClick: C
          }, [a("span", Bt, h(("t" in k ? k.t : e($))("base.read_more")), 1), g(E, {
            name: "arrow-right",
            class: "icon"
          })]))]), a("div", Vt, [k.dontShowStorageKey ? (i(), _("div", Gt, [a("div", xt, [g(y, {
            modelValue: e(d),
            "onUpdate:modelValue": S[0] || (S[0] = T => fe(d) ? d.value = T : null)
          }, null, 8, ["modelValue"]), a("span", {
            class: "label",
            onClick: S[1] || (S[1] = T => d.value = !e(d))
    ...
    setup(p) {
      return (t, r) => {
        ...
        return i(), _("div", {
          ...
          default: K(() => {
            var c;
            return [((c = t.moveDirection) == null ? void 0 : c.direction) === "up" ? (i(), _("div", Ss, [g(n, {
      ...
      return (u, C) => {
        ...
        return i(), L(k, {
          ...
          default: K(() => {
            ...
            }, h(((S = e(s)) == null ? void 0 : S.formatted) ?? "-"), 3)])) : P("", !0)]
          }),
          _: 1
        }, 8, ["to"])
      }
    ...
    setup(p, {
      ...
      return oe(m, u), ie().memepad.memepadSearchOpen(), ct().initHandler(() => r("close"), "memepad-search"), (b, O) => {
        ...
        return i(), _("div", fn, [g(k, {
          ...
          key: 0
        }, [e(o).data.value.length === 0 ? (i(), _("div", In, h(("t" in b ? b.t : e($))("memepad.search.empty_text")), 1)) : (i(), L(S, {
          key: 1,
  ...
  Ke = (p, t, r) => {
    const n = Math.max(0, p.length - 1),
      ...
      d = I(() => {
        const S = Math.max(0, c.value - r + 1),
          R = Math.min(c.value + 1, o.value.length);
        return [...o.value].slice(S, R).reverse()
      }),
    ...
    return {
      ...
      addItems: S => {
        o.value.push(...[...S].reverse())
      },
      setItems: S => {
        o.value = S, c.value = S.length - 1
      },
      items: I(() => o.value),
      appearedItems: d,
