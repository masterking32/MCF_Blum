...
class K extends A {
  _parse(e) {
    ...
    else if (a.kind === "cuid") Qa.test(e.data) || (s = this._getOrReturnCtx(e, s), m(s, {
      validation: "cuid",
      code: f.invalid_string,
      message: a.message
    }), r.dirty());
...
function aa() {
  if (Gn) return Qe;
  Gn = 1, Object.defineProperty(Qe, "__esModule", {
    value: !0
...
function ua(t) {
  const [e, ...n] = t;
  if (!e || !(0, Qn.isOutActionExtended)(e)) {
    if (t.some(Qn.isOutActionExtended)) throw new Error("Can't serialize actions list: all extended actions must be placed before out actions");
    return r => {
...
Be.computeGasPrices = Gi;
Be.computeExternalMessageFees = Qi;
