(function() {
  ...
  function d(n, e, t) {
    if (t === void 0) {
      const _ = h.encode(n),
        g = e(_.length, 1) >>> 0;
      return m().subarray(g, g + _.length).set(_), b = _.length, g
    }
    let r = n.length,
      o = e(r, 1) >>> 0;
    const s = m();
  ...
  function u() {
    return (a === null || a.buffer.detached === !0 || a.buffer.detached === void 0 && a.buffer !== c.memory.buffer) && (a = new DataView(c.memory.buffer)), a
  }
  ...
  function y(n, e) {
    return n = n >>> 0, T.decode(m().subarray(n, n + e))
  }
...
${n.stack}` : r
  ...
  function O(n, e, t, r) {
    ...
    try {
      ...
      var i = p[0],
        _ = p[1];
      if (p[3]) throw i = 0, _ = 0, A(p[2]);
      return o = i, s = _, y(i, _)
    } finally {
  ...
  function R(n) {
    ...
    return c.__wbindgen_export_2.set(e, n), e
  }
  ...
  function k() {
    ...
    return n.wbg = {}, n.wbg.__wbindgen_string_get = function(e, t) {
      ...
      var s = l(o) ? 0 : d(o, c.__wbindgen_malloc, c.__wbindgen_realloc),
        i = b;
      u().setInt32(e + 4 * 1, i, !0), u().setInt32(e + 4 * 0, s, !0)
      ...
      u().setFloat64(e + 8 * 1, l(o) ? 0 : o, !0), u().setInt32(e + 4 * 0, !l(o), !0)
      ...
      const r = String(t),
        ...
        s = b;
      u().setInt32(e + 4 * 1, s, !0), u().setInt32(e + 4 * 0, o, !0)
      ...
      u().setBigInt64(e + 8 * 1, l(o) ? BigInt(0) : o, !0), u().setInt32(e + 4 * 0, !l(o), !0)
  ...
  function M(n, e) {
    return c = n.exports, I.__wbindgen_wasm_module = e, a = null, w = null, c.__wbindgen_start(), c
  }
  async function I(n) {
    if (c !== void 0) return c;
    typeof n < "u" && (Object.getPrototypeOf(n) === Object.prototype ? {
      module_or_path: n
    } = n : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), typeof n > "u" && (n = new URL("" + new URL("game_wasm_bg-DyT60eOV.wasm", self.location.href).href, self.location.href));
    const e = k();
  ...
  self.onmessage = async n => {
    ...
    switch (t) {
      ...
      case "pack": {
        const o = O(r.gameId, r.challenge, r.earnedPoints, r.assetClicks);
        return self.postMessage({
          id: e,
          hash: o
        })
