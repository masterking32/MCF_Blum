...
var xr = function(r, e) {
  ...
  Ms = Fs && Fs.v8,
  F, dt;
Ms && (F = Ms.split("."), dt = F[0] > 0 && F[0] < 4 ? 1 : +(F[0] + F[1]));
!dt && Ot && (F = Ot.match(/Edge\/(\d+)/), (!F || F[1] >= 74) && (F = Ot.match(/Chrome\/(\d+)/), F && (dt = +F[1])));
var yc = dt,
  Ls = yc,
  gc = E,
  _c = G,
...
if ($p || Zt.state) {
  var M = Zt.state || (Zt.state = new Pp);
  M.get = M.get, M.has = M.has, M.set = M.set, lt = function(r, e) {
    if (M.has(r)) throw new yr(bn);
...
class nh {
    ...
    p(this, "createGetWaitForLaunchStatusUntilOk", e => () => ar((() => {
      ...
      return async ({
        ...
        const i = t ?? await li.getSaveMemepadJettonInfoStatus(n),
          c = s ?? await e(o);
        return N(c) && c.data && (s = c), N(i) && i.data.status === hs.READY && (t = i), fs(c) || fs(i) ? D() : N(i) && i.data.status === hs.READY ? L(i.data) : N(c) && !c.data ? L(void 0) : D()
      }
    })(), () => {}, 12e3));
  ...
  createGetPriceDetails({
    ...
    return t => {
      ...
      const d = s.reduce((a, m) => a.plus(m.total), new J(0)),
        u = {
      ...
      if (a === de.BUY) {
        ...
        return {
          details: [...y.isZero() ? [] : [{
            ...
            label: `${b("memepad.jetton.fees_platform")}: ${k(new J(0))} TON`
          }],
          total: new J(y),
...
class If extends nh {
  constructor(t) {
    ...
    p(this, "FEES", {
      MEMEPAD_JETTON_BUY_OPERATION_NETWORK_FEE: new J(0),
      MEMEPAD_JETTON_SELL_OPERATION_NETWORK_FEE: new J(0)
    });
  ...
  async getRouter(t) {
    ...
    return this.FEES.MEMEPAD_JETTON_BUY_OPERATION_NETWORK_FEE = z(i.gasConstants.swapTonToJetton.forwardGasAmount), this.FEES.MEMEPAD_JETTON_SELL_OPERATION_NETWORK_FEE = z(i.gasConstants.swapJettonToTon.forwardGasAmount), s.set(t, o.data), L(o.data)
  }
  ...
  async getUserJettonBalance() {
    ...
    return N(t) ? t.data.balance === void 0 ? L(new J(0)) : L(z(t.data.balance)) : D("Failed to get balance")
  }
  async buyJetton(t, s) {
