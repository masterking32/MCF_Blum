...
const Be = h(Se, [
      ...
      return (n, r) => {
        ...
        return d(), _("div", Ee, [m("div", Ae, [c(t), c(l, {
          ...
          default: V(() => [c(o, {
            ...
            class: "left-wing"
          }), m("span", Me, S(("formatFloatLine" in n ? n.formatFloatLine : a(D))(e.rank, {
            accuracy: 0
          })), 1), c(o, {
            name: "chevron-right",
            class: "icon"
  ...
  it = w({
    ...
    setup(e) {
      const i = e,
        s = O(e, "modelValue"),
        n = $(() => i.role === M.OWNER ? v("tribes.item.share.text_owner", {
          title: i.title
  ...
  At = w({
    ...
    setup(e, {
      ...
      const n = e,
        ...
        g = I(!1),
        T = I(),
        b = $(() => !!(o.value || n.myTribe && n.myTribe.role === M.OWNER && n.myTribe.countMembers > 1)),
        y = () => {
          o.value = !0, R()
        },
        R = () => {
          ...
          if (n.variant === "list") {
            ...
            const f = [{
              ...
              p = `tribes.leave.popup.message_${(M.OWNER??M.MEMBER).toLowerCase()}`;
