  ...
  ze = te({
    ...
    setup(Ue) {
      const v = se(),
        ...
        K = () => (y().memepad.memepadJettonAiFineTuneButtonClick(), H(o.value.shortname)),
        V = m(() => [f.TELEGRAM, f.TWITTER, f.INSTAGRAM, f.WEBSITE].map(e => ({
          ...Q(e),
          type: e
        })).map(e => {
          var _;
      ...
      return (e, n) => {
        ...
        return l(), u("div", be, [s("div", {
        ...
        }, a(("t" in e ? e.t : t(r))("memepad.about.description.more")), 1)])) : g("", !0)], 2), s("div", Se, [(l(!0), u(ae, null, ie(t(V), d => (l(), u("button", {
          key: d.type,
          type: "button",
          class: "item reset",
          disabled: !d.onClick,
          ...
          default: N(() => [s("div", Ke, a(("t" in e ? e.t : t(r))("memepad.jetton.transactions")), 1), i(c, {
            name: "chevron-right",
            class: "icon"
          })]),
          _: 1
          ...
          "jetton-information": t(C),
          preview: ""
        }, null, 8, ["transactions", "jetton-information"])]), s("div", Ve, [w(a(("t" in e ? e.t : t(r))("memepad.about.disclaimer")) + " ", 1), n[5] || (n[5] = s("i", {
          class: "warning"
        }, null, -1))])])
      }
    }
