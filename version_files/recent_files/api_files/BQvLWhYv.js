...
const Yn = f({
    ...
    setup(t) {
      const n = Nt(),
        ...
        s = D(l.page ?? "wallet");
      n.wallet.walletPageOpen(l.source), H(() => e.wallet.value, _ => {
      ...
      return H(i, () => Ct().meta.key = i.value), (_, m) => {
        const g = pt,
          $ = Yt,
          W = Ft,
          ct = _e,
