...
const bt = N({
    ...
    setup(e) {
      ...
      return (t, s) => {
        const i = qe;
        return o(), h(i, {
          icon: ("imgResolver" in t ? t.imgResolver : a(De))("emoji/Construction"),
          title: "Maintenance",
  ...
  Ct = N({
    ...
    setup(e) {
      const d = Me().internal.isPokrasTheme;
      return (t, s) => (o(), g("div", yt, [e.title ? (o(), g("div", Tt, q(e.title), 1)) : O("", !0), e.subtitle ? (o(), g("div", gt, q(e.subtitle), 1)) : O("", !0), a(d) ? (o(), g("div", ht)) : O("", !0)]))
    }
  }),
  Ot = w(Ct, [
  ...
  $t = N({
    ...
    setup(e) {
      const d = e,
        t = $(() => {
          const i = [G.CARD, G.SHORT_CARD].includes(d.itemMode) ? Le.RIGHT : void 0;
      ...
      return (s, i) => {
        ...
        return a(t) ? (o(), h(k, {
          ...
          default: B(() => [j(s.$slots, "default", {}, void 0, !0)]),
          _: 3
        }, 8, ["size", "disabled"])) : (o(), g("button", {
          key: 2,
          class: "tasks-pill-inline",
          disabled: e.disabled,
          onClick: i[2] || (i[2] = l => e.onClick && e.onClick(l))
        }, [j(s.$slots, "default", {}, void 0, !0)], 8, St))
      }
    }
  }),
  It = w($t, [
  ...
  _t = N({
    ...
    emits: E(["ui:claimed", "open:subtasks-modal", "open:verify"], ["update:claimOverride"]),
    setup(e, {
      emit: d
    }) {
      const t = e,
        ...
        c = $(() => {
          const l = t.reward && !t.reward.isZero() ? R("base.claim_bp", {
              bp: Z(t.reward)
            }) : R("base.claim"),
            n = {
              claimDisabled: {
          ...
          if (t.status === x.READY_FOR_CLAIM) return {
            ...
            cls: "is-status-ready-for-claim",
            onClick: async () => {
              i.value = W.LOADING, await Fe(t.claimCallback, 2e3) ? (i.value = W.DONE, s("ui:claimed")) : i.value = void 0
            }
          };
          throw $e("Unsupported condition")
        });
      return (l, n) => {
        const v = Q,
          S = Pe,
        ...
        return o(), h(r, {
          ...
          default: B(() => [a(c).label ? (o(), g("div", At, q(a(c).label), 1)) : a(c).icon ? (o(), h(v, {
            key: 1,
            name: a(c).icon,
            class: "icon"
...
`).reduce((r, p) => {
      ...
      return (S, r) => {
        ...
        return o(), h(f, {
          ...
          title: B(() => [a(c).state === "general" ? (o(), g("span", Rt, [se(T("img", {
            src: e.iconUrl,
            alt: "Task icon"
          }, null, 8, Nt), [
            [y]
          ]), T("span", null, q(e.productName), 1)])) : O("", !0), a(c).state === "details" ? (o(), g("span", wt, "Disclaimer")) : O("", !0)]),
          default: B(() => [a(c).state === "general" ? (o(), g("div", Bt, [r[8] || (r[8] = T("div", {
            class: "text"
          }, [T("p", null, "Nothing in Blum is to be considered as being of promotional nature or aiming at commercial use."), T("p", null, "No material or information which may be made available in Blum shall constitute or be construed as a recommendation, endorsement, offer, invitation or solicitation to enter into any transaction with or purchase any product, or otherwise deal with securities, crypto assets or other products."), T("p", null, "You alone are solely responsible for determining whether any investment, security or any other product or service, is appropriate or suitable for you. You should consult an attorney or tax professional regarding your specific legal or tax situation.")], -1)), T("div", qt, [I(p, {
            modelValue: a(c).isAgreed,
            "onUpdate:modelValue": r[0] || (r[0] = C => a(c).isAgreed = C)
          }, null, 8, ["modelValue"]), T("span", null, [r[6] || (r[6] = be("By using Blum, you accept the terms of our ")), T("span", {
            class: "as-link",
            onClick: r[1] || (r[1] = C => a(c).state = "details")
          }, "Disclaimer"), r[7] || (r[7] = be("."))])])])) : O("", !0), a(c).state === "details" ? (o(), g("div", Dt, [(o(), h(Ke(a(v))))])) : O("", !0)]),
...
function xt(e, d) {
  return o(), g("div", Ft, [T("div", Pt, [j(e.$slots, "default", {}, void 0, !0)])])
}
const Kt = w(Ut, [
    ["render", xt],
    ...
    setup(e, {
      ...
      const l = $(() => {
        switch (k.value) {
          case void 0:
            return {
              status: re.REGULAR, caption: R("earn.verify_input.caption.default")
            };
          case H.UNKNOWN_ERROR:
            return {
              status: re.ERROR, caption: R("earn.verify_input.caption.unknown_error")
            };
          case H.WRONG_KEYWORD:
            return {
              status: re.ERROR, caption: R("earn.verify_input.caption.wrong_keyword")
            };
          case H.SUCCESS:
            return {
              status: re.REGULAR
          ...
          default:
            throw k.value, $e("Invalid status")
        }
      });
      return (n, v) => {
        const S = Q,
          ...
          y = ae("img-error");
        return o(), h(f, null, {
          default: B(() => [T("div", Vt, [T("div", Gt, [se(T("img", {
            src: a(ie)(e.task.iconFileKey),
            alt: "Task icon",
            class: "task-icon"
          }, null, 8, Yt), [
            [y]
          ]), T("div", Wt, q(e.task.title), 1), I(S, {
            name: "external-link",
            class: "link-icon",
  ...
  Re = N({
    ...
    setup(e, {
      ...
      const t = e,
        ...
        l = () => {
          if ([K.SOCIAL_MEDIA_CHECK, K.SOCIAL_SUBSCRIPTION].includes(t.task.type) && t.task.socialSubscription) {
            ...
            t.task.socialSubscription.openInTelegram ? X().$webApp.openTelegramLink(b) : b.startsWith("http") ? X().$webApp.openLink(b) : pe().push(b)
          }
          ...
          if (t.task.type === K.ONCHAIN_TRANSACTION) {
            const b = async () => {
              ...
              const _ = ze().getters.mustGetUser.value.id,
                A = `${t.task.id}:${_}`;
          ...
          t.task.validationType === He.MEMEPAD && pe().push({
            name: "memepad"
          })
        },
        n = () => {
        ...
        f = $(() => {
          if (t.task.type === K.PROGRESS_TARGET) {
            const b = he(t.task.progressTarget, "progress target"),
              u = ke(b.target, {
                accuracy: b.accuracy
              });
      ...
      return me(D, b => Ae().meta.back = b), (b, u) => {
        var P;
        const _ = Lt,
          A = jt;
        return o(), g(L, null, [j(b.$slots, "default", Ye(We(a(C)))), I(_, {
          "model-value": !!a(r),
  ...
  sa = N({
    ...
    emits: E(["ui:claimed", "open:subtasks-modal"], ["update:claimOverride"]),
    setup(e) {
        ...
        return o(), h(k, {
          ...
          default: B(({
            ...
            return [T("div", Qe({
              ...
              [c]
            ]), T("div", Zt, [T("div", Jt, q(S.value), 1), r.value || n.value ? (o(), g("div", ea, [(m = r.value) != null && m.label ? (o(), g("span", ta, q(`${r.value.label}${r.value.postfix}`) + q(n.value ? ", " : ""), 1)) : O("", !0), n.value ? (o(), g("span", aa, q(n.value), 1)) : O("", !0)])) : O("", !0)]), e.task.status ? (o(), h(i, {
              key: 0,
              "claim-override": d.value,
              ...
              "onOpen:verify": p
            }, null, 8, ["claim-override", "status", "kind", "start-callback", "claim-callback", "is-nested", "item-mode", "onOpen:verify"])) : O("", !0)], 2)], 16, Qt)]
          }),
          _: 1
      ...
      return (l, n) => {
        ...
        return o(), h(p, {
          ...
          default: B(({
            ...
            onClick: f
          }, [a(t) ? (o(), g("div", ra, [(o(!0), g(L, null, Y(a(i), (_, A) => se((o(), g("img", {
            key: A,
            src: a(ie)(_),
            alt: "Task icon",
            class: "icon",
            ...
            [m]
          ])), 128))])) : O("", !0), T("div", ua, q(C.value), 1), u.value ? (o(), g("div", da, q(u.value), 1)) : O("", !0), T("div", ma, [e.task.status ? (o(), h(v, {
            key: 0,
            "claim-override": k.value,
            ...
            "onOpen:verify": b
          }, null, 8, ["claim-override", "status", "kind", "start-callback", "claim-callback", "mode", "item-mode", "onOpen:verify"])) : O("", !0), D.value ? (o(), g(L, {
            key: 1
          }, [D.value.done ? (o(), h(S, {
            key: 0,
            ...
            label: D.value.label,
            mode: a(s)
          }, null, 8, ["finished", "total", "label", "mode"]))], 64)) : O("", !0)])], 14, la)]),
          _: 1
        }, 8, ["claim-override", "task", "quest-details", "start-callback", "verify-callback"])
      }
    }
  ...
  pa = N({
    ...
    emits: E(["ui:claimed", "click:task"], ["update:modelValue", "update:tasksClaimOverride"]),
    setup(e) {
      const d = e,
        t = F(e, "modelValue"),
      ...
      const k = () => {
        ...
        l = M(d.task.isShared),
        n = M(!1),
        v = $(() => R("earn.quest.share.text")),
        S = $(() => `tasksheet_${btoa(d.task.id)}-ref_${Ce().referralToken.value}`);
      return we().onOpenTaskSheet(d.task, () => {
        t.value = !0
      }), (r, p) => {
        const m = Q,
          f = vt,
        ...
        return o(), g(L, null, [I(D, {
          ...
          default: B(() => [T("div", {
            ...
            class: "labe"
          }, "Invite and earn up to 8% revshare", -1))])) : O("", !0), e.task.bannerFileKey || e.task.description ? (o(), g("div", fa, [e.task.bannerFileKey ? (o(), h(f, {
            key: 0,
            url: a(ie)(e.task.bannerFileKey),
            alt: "Task banner",
            class: "banner"
          }, null, 8, ["url"])) : O("", !0), e.task.description ? (o(), g("div", ba, q(e.task.description), 1)) : O("", !0)])) : O("", !0), e.task.subTasks ? (o(), h(Te, {
            key: 2,
            tag: "div",
            name: "list-shuffle-transition",
            class: "nested-tasks"
          }, {
            default: B(() => [(o(!0), g(L, null, Y(e.task.subTasks, (u, _) => (o(), h(y, {
              key: u.id,
          ...
          title: ("t" in r ? r.t : a(R))("earn.quest.share.sheet.title"),
          "share-text": a(v),
          subtitle: e.task.sharingDescription,
          startapp: a(S),
          "copied-notification": ("t" in r ? r.t : a(R))("frens.invite.link_copied"),
          "back-icon": "",
          onBack: c
    ...
    setup(e, {
      ...
      const t = e,
        ...
        c = $(() => {
          ...
          return {
            countTotal: n,
            countFinished: v,
            progressLabel: `${v}/${n} ${R("base.n.tasks",n)}`,
      ...
      return (n, v) => {
        const S = Ne,
          r = va,
          p = ya;
        return o(), g("div", Ta, [e.mode === a(G).LIST_ITEM ? (o(), h(S, {
          key: 0,
    ...
    setup(e) {
      ...
      return (t, s) => {
        ...
        return se((o(), h(Te, {
          ...
          default: B(() => [(o(!0), g(L, null, Y(e.tasks, (c, l) => (o(), h(i, {
            key: c.id,
    ...
    setup(e) {
      ...
      const d = e,
        ...
        s = $(() => d.subSections.map(l => ({
          value: l.title,
          label: l.title,
          dot: l.tasks.some(n => at(n, t.value))
        }))),
      ...
      return (l, n) => {
        const v = dt,
          S = Q,
          r = Be;
        return a(k).length ? (o(), g("div", Oa, [I(v, {
          modelValue: a(i),
          "onUpdate:modelValue": n[0] || (n[0] = p => ne(i) ? i.value = p : null),
          items: a(s)
        }, null, 8, ["modelValue", "items"]), a(k).length ? (o(), h(Te, {
          key: a(i),
          tag: "div",
          name: "list-shuffle-transition",
          class: "tasks-list"
        }, {
          default: B(() => [(o(!0), g(L, null, Y(a(k), p => (o(), h(r, {
            key: p.id,
    ...
    setup(e) {
      const d = e,
        ...
        i = c => {
          const l = c.tasks,
            ...
            v = m => Oe(m, s.value),
            S = m => {
              const f = m.subTasks ? Oe(m.subTasks, s.value) : void 0;
              return {
                ...m,
                subTasks: f
              }
      ...
      return (c, l) => {
        const n = Ot,
          v = Ca,
          S = Aa;
        return o(), g("div", _a, [a(k).title || a(k).description ? (o(), h(n, {
          key: 0,
          title: a(k).title,
  ...
  Na = N({
    ...
    setup(e) {
      ...
      return Ee(() => clearTimeout(s)), (i, k) => a(t) ? j(i.$slots, "default", {
        key: 0
      }) : O("", !0)
    }
  }),
...
function Fa(e, d) {
  const t = ft,
    s = Na;
  return o(), h(s, null, {
    default: B(() => [T("div", Ba, [I(t, {
      class: "title"
    }), T("div", qa, [(o(), g(L, null, Y(2, i => I(t, {
      key: i,
      class: "item"
    })), 64))]), T("div", Da, [I(t, {
      class: "subtitle"
    })]), T("div", Ma, [(o(), g(L, null, Y(2, i => I(t, {
      key: i,
      class: "item"
    })), 64))]), T("div", La, [I(t, {
      class: "subtitle"
    })]), T("div", Ua, [(o(), g(L, null, Y(7, i => T("div", {
      key: i,
      class: "item"
    }, [I(t, {
      class: "icon"
...
const Pa = w(wa, [
  ...
  Ya = N({
    __name: "tasks",
    setup(e) {
      const d = $(() => Ae().query.openTaskSheetId),
        t = M(!1),
        s = M(),
        i = M({}),
        c = it(async () => rt(await ue.getTasksSections(X().$webApp.dataUnsafe.query.ref)), f => s.value = f, 15e3),
        l = (f, y) => {
          if (s.value)
        ...
        n = async f => {
          ...
          return y.err ? !1 : (l(f.id, y.data), ot().updateBalance(), !0)
        }, S = async (f, y) => {
          const C = await ue.verifyTask(f.id, y);
          return C.err ? C.code === 400 ? H.WRONG_KEYWORD : H.UNKNOWN_ERROR : (l(f.id, C.data), H.SUCCESS)
        }, r = f => {
          setTimeout(() => delete i.value[f.id], 3e3), f.reward.isZero() || lt().bottom.success(R("base.you_got_bp", {
            bp: Z(f.reward)
          }))
        }, p = $(() => s.value ? s.value.reduce((y, C) => ([...C.tasks, ...C.tasks.flatMap(u => u.subTasks ?? []), ...C.subSections.flatMap(u => u.tasks ?? [])].filter(u => !te(u.status, i.value[u.id]) && !_e(u) && u.kind !== U.GROUP).map(u => u.id).forEach(u => y.add(u)), y), new Set).size : 0);
      return (async () => {
        await c.exec()
      })(), me(() => [s.value, d.value], () => {
        ...
        const C = pt,
          D = Ra,
          b = Pa;
        return o(), g("div", xa, [a(t) ? (o(), h(C, {
          key: 0
        })) : a(s) ? (o(), g(L, {
          key: 1
        }, [T("div", Ka, [T("span", Va, [be(q(("t" in f ? f.t : a(R))("earn.title")) + " ", 1), T("sup", null, q(a(p)), 1)])]), T("div", Ga, [(o(!0), g(L, null, Y(a(s), (u, _) => (o(), h(D, {
          key: _,
