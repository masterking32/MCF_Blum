...
const ke = {
        ...
        return _(), X(I, {
          ...
          default: G(() => {
            ...
            return [B(A, {
              ...
              mCap: r(s),
              timeSince: r(d)
            }, () => [a.jetton.stats.holdersCount !== void 0 ? (_(), L("div", De, [B(P, {
              name: "personal",
              class: "icon"
            }), v("span", be, S(("formatCount" in a ? a.formatCount : r(J))(a.jetton.stats.holdersCount, {
              accuracy: 0
            }).full), 1)])) : $("", !0), a.jetton.stats.transactionsCount !== void 0 ? (_(), L("div", Re, [B(P, {
              name: "transfer",
              class: "icon"
              ...
              mCap: r(s),
              timeSince: r(d)
            }, () => [v("div", Ge, [v("span", Ve, S(("t" in a ? a.t : r(de))("memepad.jetton.stats.market_cap")), 1), v("span", We, S(r(s)), 1)]), v("div", Ye, [B(P, {
  ...
  ze = ({
    ...
    const d = {
      ...
      n = async ({
        ...
        const f = {
          ...
          h = f[l],
          j = E[l];
        return await b.getMemepadJettonsSection(h, j, i, C)
    ...
    const N = m(() => {
      ...
      switch (s.value.type) {
        case "step-list":
          return (C = s.value.stepList) == null ? void 0 : C.appearedItems;
        case "pagination-list":
