...
const et = e => {
  ...
  Ft = e => e.instance === "point",
  Vt = e => e.instance === "token",
  qt = (e, n) => {
    if (Ft(e)) return n.point(e);
    if (Vt(e)) return n.token(e);
...
const Pe = h(Ne, [
  ...
  Ce = w({
    ...
    setup(e) {
      ...
      return (c, o) => {
        ...
        return a(), r("div", {
          class: P(["pages-wallet-history-item-icon", {
  ...
  De = w({
    ...
    setup(e) {
      ...
      return (c, o) => {
        ...
        return s(t) ? (a(), r("div", {
          key: 0,
          class: P(["pages-wallet-history-item-status", s(t).cls])
        }, [p(l, {
          name: s(t).icon,
          class: "icon"
  ...
  qe = w({
    ...
    setup(e) {
      return (n, t) => {
        const c = Ye;
        return a(), r("div", Fe, [(a(!0), r($, null, D(e.history, (o, l) => (a(), r($, {
          key: l
        }, [l === 0 || e.history[l - 1].date.stamp !== e.history[l].date.stamp ? (a(), r("div", Ve, f(o.date.formatted), 1)) : g("", !0), p(c, {
          "history-item": o
...
const sn = h(en, [
  ...
  gn = w({
    ...
    setup(e, {
      ...
      return (d, v) => (a(), r("div", hn, [(a(!0), r($, null, D(s(l), (y, I) => (a(), r("button", {
        ...
        alt: `${y.label} icon`
      }, null, 8, wn)]), _("div", bn, f(y.label), 1)], 10, vn))), 128))]))
    }
  }),
  kn = h(gn, [
  ...
  Sn = w({
    ...
    setup(e) {
      ...
      return (c, o) => {
        const l = Lt;
        return a(), r("div", Pn, [(a(!0), r($, null, D(s(t), d => (a(), u(l, Pt({
          key: d.id,
          ref_for: !0
        }, d), null, 16))), 128))])
      }
    ...
    setup(e) {
      ...
      return (c, o) => {
        ...
        return a(), r("div", xn, [_("div", Mn, [_("div", Hn, f(("t" in c ? c.t : s(i))("wallet.history.title")), 1), e.address ? (a(), r("div", Yn, [o[1] || (o[1] = _("img", {
          src: O,
          alt: "Ton logo"
        }, null, -1)), _("div", Fn, f(e.address.short), 1)])) : g("", !0)]), p(v, {
          onEnd: o[0] || (o[0] = y => s(t).load())
        }, {
          default: T(() => [s(t).isEmpty.value ? (a(), u(l, {
            key: 0,
...
const zn = w({
    ...
    setup(e) {
      const n = x(),
        ...
        l = R(o.page ?? "wallet");
      n.wallet.walletPageOpen(o.source), V(() => t.wallet.value, v => {
      ...
      return V(d, () => Kt().meta.key = d.value), (v, y) => {
        const I = Ct,
          S = zt,
          U = Gt,
          dt = he,
