  ...
  Ur = at({
    ...
    setup(r, {
        ...
        d = ns({
          ...
          set: k => {
            if (a.value && a.value.value !== s.modelValue) {
              ...
              E !== -1 && a.value.value[E] === "," && (k = k.slice(0, E) + "." + k.slice(E))
            }
            k = (s.modifier || (E => E))(k), a.value && a.value.value !== k && (a.value.value = k), n("update:modelValue", k)
          }
        });
      ...
      const _ = ns(() => {
          ...
          const k = parseInt(getComputedStyle(i.value).getPropertyValue("font-size")),
            ...
            F = (te => {
              ...
              return ne ? (ne.font = `700 ${k}px RoobertPro`, ne.measureText(te).width) : void 0
            })(E.trim());
          if (!F) return;
      ...
      const B = () => {
        ...
        P = async () => {
          const k = new FontFace("RoobertPro", `url(${Pr})`, {
            weight: "700"
          });
      ...
      return (() => {
        ...
        class: "hidden",
        onFocus: B
      }, null, 544), k.postfix ? (fe(), Ft("span", {
        key: 0,
        class: "label",
        style: as(X(_))
      }, vr(k.postfix), 5)) : Lt("", !0)], 2))
    }
  }),
  uo = Wt(Ur, [
    ["__scopeId", "data-v-44264923"]
  ]),
  ho = r => new C(r.replaceAll(",", "") || "0"),
  Dr = {
    class: "top"
  },
  Gr = {
...
var D = {},
  ut, Vt = Ee && Ee.__importDefault || function(r) {
  ...
  constructor(e = {}) {
    ...
    y(this, "request", async ({
      ...
      return this.customFetch(`${i||this.baseUrl||""}${s}${B?`?${B}`:""}`, {
        ...
        signal: (m ? this.createAbortSignal(m) : w.signal) || null,
        body: typeof e > "u" || e === null ? null : N(e)
      }).then(async R => {
        const E = R.clone();
        E.data = null, E.error = null;
        const V = k === "json" ? "text" : k,
          G = V ? await R[V]().then(F => (E.ok ? E.data = k === "json" ? Qr(F) : F : E.error = F, E)).catch(F => (E.error = F, E)) : E;
...
var Gs = Te.internalOnchainContentToCell = cn;
  ...
  dn = function() {
    function r(t) {
      t === void 0 && (t = !1), Object.defineProperty(this, Bt, {
        ...
        value: un
      }), this.thresholdTons = void 0, this.thresholdSupply = void 0, Object.defineProperty(this, Ae, {
        writable: !0,
        value: void 0
      }), this.thresholdTons = t ? 2500000000n : 1833000000000n, this.thresholdSupply = t ? 800000000000000000n : 799999999998688507n, I(this, Ae)[Ae] = t ? 16000000000000n : 590892876676n
    }
    var e = r.prototype;
...
function hn(r) {
  if (r == 0n) return 0n;
  var e = 10n ** 9n;
  return I(this, Ut)[Ut](r * e * e) * I(this, Ae)[Ae] / e
}

function yn(r) {
  if (r == 0n) return 0n;
  var e = 10n ** 9n;
  return r ** 2n * e / I(this, Ae)[Ae] ** 2n / e
}
...
var gs = function() {
    ...
    var e = r.prototype;
    return e.sendDeployJetton = function(t, s, n, o, a, i, m, d, _) {
      d === void 0 && (d = null), _ === void 0 && (_ = 0);
      try {
        return m === void 0 && (m = 0n), Promise.resolve(t.internal(s, {
          value: n,
          body: j.beginCell().storeUint(Ks.deployJetton, 32).storeUint(_, 64).storeUint(o, 1).storeRef(a).storeBit(i).storeCoins(m).storeMaybeRef(d).endCell()
        })).then(function() {})
      } catch (w) {
  ...
  Q = ie("tokenomics"),
  le = ie("request"),
  we = ie("minterContractFromAddress"),
  ...
  _n = function() {
    ...
    return e.sendDeployJetton = function(t, s, n, o, a, i, m, d) {
      ...
      try {
        var _ = this.client.open(gs.createFromAddress(s));
        return Promise.resolve(_.getConfig()).then(function(w) {
          var B = w.deployFee + Y.deployGas + (i == 0n ? Y.initialGas : i + Y.buyGas);
          a && (B += w.agentDeployFee);
          var P = Gs(o);
          return Promise.resolve(_.sendDeployJetton(t, B, n, P, a, i, m, d)).then(function() {})
        })
      } catch (w) {
        return Promise.reject(w)
      }
      ...
      try {
        return Promise.resolve(I(this, we)[we](s).sendBuy(t, n, o, null, a, i)).then(function() {})
      } catch (m) {
      ...
      try {
        return Promise.resolve(I(this, we)[we](t).getWalletAddress(s))
      } catch (n) {
        return Promise.reject(n)
      }
    }, e.getTotalSupply = function(t) {
      try {
        return Promise.resolve(I(this, we)[we](t).getTotalSupply())
      } catch (s) {
        return Promise.reject(s)
      }
    ...
    }, e.getDeployJettonRequest = function(t, s, n, o, a, i, m) {
      i === void 0 && (i = null), m === void 0 && (m = 0);
      try {
        var d = this;
        return Promise.resolve(I(d, le)[le](function(_) {
          return d.sendDeployJetton(_, t, s, n, o, a, i, m)
        }))
      } catch (_) {
        return Promise.reject(_)
      }
...
const Hs = () => {
    const {
      ...
      wrapWithCache: i,
      memepadApi: m
    } = ct(), d = new _n(n, !1, !0), _ = l => +String(l) / 1e4, w = {
      LAUNCH_STATUS_CHECK: 6e3,
      BUY_STATUS_CHECK: 6e3,
      SELL_STATUS_CHECK: 6e3,
      UNLOCK_STATUS_CHECK: 6e3
    }, B = {
      MEMEPAD_JETTON_BUY_OPERATION_NETWORK_FEE: T(Y.buyGas),
      MEMEPAD_JETTON_SELL_OPERATION_NETWORK_FEE: T(Y.sellGas),
      MEMEPAD_JETTON_DEPLOY_NETWORK_FEE: T(Y.deployGas),
      MEMEPAD_JETTON_INITIAL_NETWORK_FEE: T(Y.initialGas),
      MEMEPAD_JETTON_UNLOCK_NETWORK_FEE: T(Y.unlockGas)
    }, P = {
      ...
      hasShare: l
    }) => N.deployNetworkFee.plus(l ? 0 : N.initialNetworkFee), R = ({
      referrerToken: l
    }) => j.beginCell().storeUint(1675682413, 32).storeStringTail(l).endCell(), E = async l => {
      const p = await W(async () => await d.getTotalSupply(r(l)))();
      return S(p) ? x(T(p.data)) : p
    }, G = i(({
      masterAddress: l
    }) => `blumSdk:factoryConfig:${l.toString()}`, async ({
      masterAddress: l
    }) => {
      const p = await W(async () => await d.getFactoryConfig(r(l)))();
      return S(p) ? x(p.data) : p
    }), z = i(({
      masterAddress: l
    }) => `blumSdk:bclData:${l.toString()}`, async ({
      masterAddress: l
    }) => {
      const p = T(d.getThresholdSupply()),
        u = T(d.getMaxSupply()),
        h = u.minus(p),
        g = T(d.getThresholdTons()),
        f = await G({
          masterAddress: l
        });
      if (!S(f)) return f;
      const {
        buyFeeBasis: A
      } = f.data, q = g.div(new C(1).minus(_(A))).toDecimalPlaces(9, C.ROUND_UP), L = f.data, K = T(f.data.agentDeployFee);
      return x({
      ...
      const {
        buyFeeBasis: K
      } = L.data, H = T(d.getBuyAmount(0n, u, K)), oe = H, be = H, Re = f.minus(oe), ve = T(d.getTonSupply(O(oe))), Ke = new C(d.getPrice(O(oe))), Ie = new C(Ke).times(q), ar = ve.div(g).times(100), ir = H.div(f).times(100), cr = new C(p).minus(ve);
      return x({
        share: new C(p),
        tokenForDexWithFees: A,
        tokenForDex: g,
      ...
      jettonAddress: l,
      userAddress: p
    }) => `blumSdk:jettonWalletAddress:${l.toString()}:${p.toString()}`, async ({
      jettonAddress: l,
      userAddress: p
    }) => await W(async () => await d.getJettonWalletAddress(r(l), r(p)))()), U = async ({
      masterAddress: l,
      form: p,
      tonConnectUI: u,
      referrerToken: h
    }) => {
      const g = Fs(p, it.STONFI),
        f = await m.saveMemepadJettonInfo(g);
      if (!S(f)) return f;
      const A = e(u),
        q = f.data.queryId,
        L = Dt.STONFI,
        K = {
          ...
          image: tt(p.iconFileKey),
          symbol: p.ticker,
          decimals: 9
        };
      g.socials.length && (K.social_links = JSON.stringify(g.socials.map(ve => ve.url))), g.bannerFileKey && (K.cover_image = tt(g.bannerFileKey));
      const H = h ? R({
          referrerToken: h
        }) : void 0,
        oe = p.aiAgentEnable,
        be = await W(async () => await d.sendDeployJetton(A, r(l), L, K, oe, O(new C(p.share)), H, q))();
      if (!S(be)) return be;
      const Re = (await A.getResult()).hash;
      return x({
        queryId: q,
        transactionHash: Re
      })
    }, ee = t(o, w.LAUNCH_STATUS_CHECK), _e = async ({
      tons: l,
      jettonAddress: p,
      masterAddress: u
    }) => {
      ...
      const {
        buyFeeBasis: A
      } = f.data, q = T(d.getBuyAmount(O(g), O(l), A)), L = q, K = a(q), H = l.times(_(A));
      return x({
        maxReceive: L,
        minReceive: K,
        platformFee: H,
      ...
      const {
        sellFeeBasis: A
      } = f.data, q = T(d.getSellAmount(O(g), O(l), A)), L = q, K = a(q), H = q.div(1 - _(A)).minus(q);
      return x({
        maxReceive: L,
        minReceive: K,
        platformFee: H,
      ...
      const f = e(h),
        ...
        q = await W(async () => await d.sendBuy(f, r(p), O(l), O(u.minReceive), A))();
      return S(q) ? x((await f.getResult()).hash) : q
    }, Tt = async ({
      jettons: l,
      jettonAddress: p,
      tradeInfoParams: u,
      ...
      if (!S(L)) return L;
      const K = L.data,
        H = await W(async () => await d.sendSell(A, K, O(l), O(u.minReceive), q))();
      return S(H) ? x((await A.getResult()).hash) : H
    }, At = () => $e(({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), () => {}, w.BUY_STATUS_CHECK), St = () => $e(({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), () => {}, w.SELL_STATUS_CHECK), jt = async ({
      jettonAddress: l,
      userAddress: p
    }) => {
      const u = await J({
      ...
      if (!S(u)) return u;
      const h = u.data,
        g = await W(async () => await d.getUnlocked(h))();
      if (!S(g)) return g;
      const f = !g.data;
      return x(f)
    }, qt = async ({
      ...
      if (!S(g)) return g;
      const f = g.data,
        A = await W(async () => await d.sendUnlock(h, f))();
      return S(A) ? x((await h.getResult()).hash) : A
    }, We = ({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), rs = () => $e(We, () => {}, w.UNLOCK_STATUS_CHECK), b = s({
      getFees: ({
        share: l,
        overview: p
      }) => {
        const u = !new C(l).isZero(),
          {
            buyNetworkFee: h,
            walletNetworkLaunchBuyFee: g,
            walletNetworkLaunchFee: f
          } = N,
          A = k({
            hasShare: u
          }),
          q = T(p.bclData.factoryConfig.deployFee);
        return {
          buyNetworkFee: h,
          launchNetworkFee: A,
          launchPlatformFee: q,
    ...
    return {
      ...
      getMaxShareAmount: ({
        ...
        const {
          ...
          hasShare: !0
        }), f = T(p.bclData.factoryConfig.deployFee), A = l.value.minus(g.plus(f).plus(h).plus(u)), q = p.bclData.tokenForDexWithFees;
        return q.lt(A) ? q : A.gte(0) ? A : new C(0)
      },
      getMaxBuyAmount: ({
        tokenBalance: l
      }) => {
        ...
        return l.value.minus(p).minus(u)
      },
      getReviewInfo: b,
      fees: N
    }
  ...
  kn = ({
    ...
    const {
      ...
      getMaxBuyAmount: V,
      fees: G
    } = Hs(), F = r.address, z = r.masterContractAddress, te = Ue().tonConnectUI.value, se = o(), ne = a({
      getFees: () => G
    });
    return {
      getUserJettonBalance: () => i({
...
Pe.storeSnakeContentData = Qs;
Pe.loadSnakeContentData = Xs;
Pe.storeTokenOnchainContent = On;
Pe.loadTokenOnchainContent = Mn;
const ot = Os,
  xn = _t,
  Vs = 0,
  Ys = 0;
...
class Xt {
  ...
  async sendDeployCoin(e, t, s, n) {
    let o = (0, qe.beginCell)().store((0, Un.storeTokenOnchainContent)({
        name: s.name,
      ...
      a = (0, qe.beginCell)().storeUint((0, Ts.crc32str)("op::deploy_coin"), 32).storeUint(s.queryId ?? 0, 64).storeRef(o).storeAddress(s.authorAddress).storeRef(s.referral ?? (0, qe.beginCell)().endCell()),
      i = (0, qe.beginCell)().storeUint(3547469196, 32).storeUint(s.queryId ?? 0, 64).endCell();
    if (n != null && n.firstBuy) {
      let _ = (0, qe.beginCell)().storeUint((0, Ts.crc32str)("op::buy"), 32).storeUint(n.firstBuy.queryId ?? 0, 64).storeCoins(n.firstBuy.minReceive).storeMaybeRef(n.firstBuy.referral);
  ...
  constructor(e = {}) {
    ...
    y(this, "request", async ({
      ...
      return this.customFetch(`${i||this.baseUrl||""}${s}${B?`?${B}`:""}`, {
        ...
        const E = N ? await k[N]().then(V => (R.ok ? R.data = V : R.error = V, R)).catch(V => (R.error = V, R)) : R;
        if (m && this.abortControllers.delete(m), !k.ok) throw E;
        return E.data
      })
    });
    Object.assign(this, e)
  ...
  return {
    ...
    async send(s) {
      ...
      const _ = await r.sendTransaction({
        ...
        w = Ze.Cell.fromBase64(_.boc);
      e = {
        msg: w,
        hash: w.hash().toString("hex")
      }, t.forEach(P => P(e))
    },
    async getResult() {
...
function Zn(r) {
  ...
  var e = Ee && Ee.__createBinding || (Object.create ? function(o, a, i, m) {
      m === void 0 && (m = i);
    ...
    t = Ee && Ee.__exportStar || function(o, a) {
  ...
  }), t(rr, r), t(Je, r), t(Be, r), t(Ge, r), t(Se, r), t(vt, r)
})(re);
const or = () => {
    const {
      getAddress: r,
      ...
      MEMEPAD_JETTON_BUY_OPERATION_NETWORK_FEE: T(re.Constants.CoinBuyGas),
      MEMEPAD_JETTON_SELL_OPERATION_NETWORK_FEE: T(re.Constants.CoinSellGas),
      MEMEPAD_JETTON_LAUNCH_NETWORK_FEE: T(re.Constants.CoinDeploymentGas),
      MEMEPAD_JETTON_UNLOCK_NETWORK_FEE: T(re.Constants.WalletUnlockGas)
    }, B = {
      LAUNCH_FEE: new C(.0114),
      LAUNCH_BUY_FEE: new C(.012),
      BUY_FEE: new C(.0062),
      ...
      buyNetworkFee: w.MEMEPAD_JETTON_BUY_OPERATION_NETWORK_FEE,
      sellNetworkFee: w.MEMEPAD_JETTON_SELL_OPERATION_NETWORK_FEE,
      launchNetworkFee: w.MEMEPAD_JETTON_LAUNCH_NETWORK_FEE,
      unlockNetworkFee: w.MEMEPAD_JETTON_UNLOCK_NETWORK_FEE,
      ...
      const v = `tonFunSdk:${b.toString()}`,
        ...
        l = $.value.get(v);
      if (l) return l;
      const p = re.BclSDK.create({
        apiProvider: re.simpleTonapiProvider(d),
        clientOptions: {
          endpoint: ""
        },
        masterAddress: r(b)
      });
      return $.value.set(v, p), p
    }, k = b => new C(1).minus(T(b.fees)).div(T(b.coins)), E = m(({
      masterAddress: b
      ...
      if (!S(v)) return Er(v);
      const $ = T(v.data.fullPriceTon),
        l = T(v.data.fullPriceTon).minus(T(v.data.fullPriceTonFees)),
        p = T(v.data.bclSupply),
        u = T(v.data.liqSupply),
        h = p.plus(u),
        g = new C(0);
      return x({
        tokenForDexWithFees: $,
        ...
        liqSupply: u,
        maxSupply: h,
        launchPlatformFee: T(v.data.deploymentFee),
        aiAgentDeployFee: g
      })
    }), G = m(({
      tons: b,
      ...
      tons: b,
      masterAddress: v
    }) => await W(async () => await N(v).getFirstCoinsForTons(O(new C(b))))()), z = m(({
      tons: b,
      masterAddress: v
      ...
      const {
        ...
        bclSupply: h,
        maxSupply: g
      } = l.data, f = await (async () => new C($).isZero() ? x({
        fees: O(new C(0)),
        coins: O(new C(0))
      }) : await G({
        tons: b,
      ...
      const L = q.data,
        ...
        oe = new C(T(A.fees)),
        be = new C($).minus(oe),
        Re = be.div(p).times(100),
        ve = H.div(h).times(100),
        Ke = new C(h).sub(H);
      return x({
        share: $,
        tokenForDexWithFees: u,
        tokenForDex: p,
        tokenCollected: be,
        tokenCollectedPercent: Re,
        jettonReceivePercent: ve,
        priceToken: L,
        marketCapToken: K,
        availableSupply: Ke,
        maxSupply: g,
      ...
      const p = Fs(b, it.STONFI_TON_FUN),
        u = await i.saveMemepadJettonInfo(p);
      if (!S(u)) return u;
      const h = new C(b.share),
        g = b.overview.minReceive,
        f = {
          name: p.name,
          description: p.description,
          imageUrl: tt(p.iconFileKey),
          symbol: p.ticker,
          share: O(h),
        ...
        A = {};
      p.socials.length && (A.social_links = JSON.stringify(p.socials.map(oe => oe.url))), p.bannerFileKey && (A.cover_image = tt(p.bannerFileKey));
      const q = {
          authorAddress: r(v),
          name: f.name,
          ...
          imageUrl: f.imageUrl,
          symbol: f.symbol,
          referral: re.packReferralConfig({
        ...
        K = e(l),
        H = await W(async () => await N($).deployCoin(K, q, L))();
      return S(H) ? x({
        queryId: u.data.queryId,
        transactionHash: (await K.getResult()).hash
      }) : H
    }, se = () => t(o, _.LAUNCH_STATUS_CHECK), ne = async ({
      jettonAddress: b,
      masterAddress: v
    }) => {
      const $ = await W(async () => await N(v).openCoin(r(b)))();
      if (!S($)) return $;
      const l = await W(async () => await $.data.getBclData())();
      if (!S(l)) return l;
      const p = T(l.data.totalSupply),
        u = T(l.data.fullPriceTon).minus(T(l.data.fullPriceTonFees)),
        h = T(l.data.tonLiqCollected),
        g = h.div(u).times(100),
        f = T(l.data.bclSupply),
        A = T(l.data.liqSupply),
        q = f.minus(p);
      return x({
        tokenForDex: u,
        tokenCollected: h,
      ...
      var h, g, f;
      const l = await W(async () => await N($).openCoin(r(b)).getUserWallet(r(v)))();
      if (!S(l)) return l;
      const p = await W(async () => !await l.data.getTransfersEnabled())();
      if (!S(p)) return ((h = p.extra) == null ? void 0 : h.status) === 404 && ((f = (g = p.extra) == null ? void 0 : g.error) == null ? void 0 : f.error) === "entity not found" ? x(!1) : p;
      const u = p.data;
      return x(u)
    }, U = async ({
      jettonAddress: b,
      ...
      const p = N($).openCoin(r(b)),
        u = await W(async () => await p.getUserWallet(r(v)))();
      if (!S(u)) return u;
      const h = e(l),
        g = await W(async () => await u.data.sendUnlockWallet(h, {}))();
      return S(g) ? x((await h.getResult()).hash) : g
    }, ee = () => $e(async ({
      transactionHash: b
    }) => await o({
      transactionHash: b
      ...
      const p = await W(async () => await N(v).openCoin(r($)).getCoinsForTons(O(b)))();
      if (!S(p)) return p;
      const u = T(p.data.coins),
        h = a(u);
      return x({
        minReceive: h,
        maxReceive: u,
        platformFee: T(p.data.fees),
        additionalInfo: {
      ...
      const p = await W(async () => await N(v).openCoin(r($)).getTonsForCoins(O(b)))();
      if (!S(p)) return p;
      const u = T(p.data.tons),
        h = a(u);
      return x({
        minReceive: h,
        maxReceive: u,
      ...
      const l = await W(async () => await N($).getUserCoinBalance(r(v), r(b)))();
      return S(l) ? x(T(l.data)) : l
    }, Tt = async ({
      tons: b,
      tradeInfoParams: v,
      masterAddress: $,
      ...
      const u = {
        ...
        h = e(p),
        g = await W(async () => await N($).openCoin(r(l)).sendBuy(h, u))();
      return S(g) ? x((await h.getResult()).hash) : g
    }, At = async ({
      jettons: b,
      tradeInfoParams: v,
      ...
      const h = await N(l).openCoin(r($)).getUserWallet(r(p)),
        g = e(u),
        f = await W(async () => await h.sendSellCoins(g, {
          amount: O(b),
          minReceive: O(v.minReceive),
          referral: re.packReferralConfig({
            partner: r(v.additionalInfo.partnerAddress)
      ...
      return S(f) ? x((await g.getResult()).hash) : f
    }, St = () => $e(({
      transactionHash: b
    }) => o({
      transactionHash: b
    }), () => {}, _.BUY_STATUS_CHECK), jt = () => $e(({
      transactionHash: b
    }) => o({
      transactionHash: b
      ...
      } = P, u = v.bclData.launchPlatformFee, h = b.value.minus(l.plus(u).plus(p).plus($)), g = v.bclData.tokenForDexWithFees;
      return g.lt(h) ? g : h.gte(0) ? h : new C(0)
    }, We = s({
      getFees: ({
        overview: b
      }) => {
  ...
  to = ({
    ...
    const {
      ...
      getMaxBuyAmount: V,
      fees: G
    } = or(), F = e.address, z = e.masterContractAddress, te = r.partnerAddress, se = Ue().tonConnectUI.value, ne = a({
      getFees: () => G
    }), J = o();
    return {
      getUserJettonBalance: () => m({
