...
const Ie = {
  ...
  Ue = J({
    ...
    setup(s) {
      ...
      return (r, i) => (E(), k("div", Ie, [q(g) ? (E(), k("div", Te, [T(r.$slots, "header", {}, void 0, !0)])) : A("", !0), q(_) ? (E(), k("div", Le, [T(r.$slots, "title", {}, void 0, !0)])) : A("", !0), q(u) ? (E(), k("div", Pe, [T(r.$slots, "subTitle", {}, void 0, !0)])) : A("", !0), q(o) ? (E(), k("div", Me, [T(r.$slots, "footer", {}, void 0, !0)])) : A("", !0)]))
    }
  }),
  je = Y(Ue, [
  ...
  ze = J({
    ...
    setup(s, {
      ...
      return se(o, () => {
        ...
        }, null, 8, ["title", "is-optional"]), f.errorCaption ? (E(), k("div", Oe, [y[3] || (y[3] = B("img", {
          src: de,
          alt: "Warning icon"
...
const Ke = J({
    ...
    setup(s, {
      ...
      return re(() => g("channel", {
        ...
        }, [(E(!0), k(xe, null, ye(_.value, c => {
          var S, V, e, t, d, m, F, $;
          return E(), k("div", {
            key: c.key,
            class: "field"
          }, [c.type === q(D).STRING ? (E(), N(f, ae({
            key: 0,
            modelValue: c.value,
            ...
            _: 2
          }, 1040, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur"])) : A("", !0), c.type === q(D).TEXTAREA ? (E(), N(y, ae({
            key: 1,
            modelValue: c.value,
            "onUpdate:modelValue": w => c.value = w,
            ref_for: !0
