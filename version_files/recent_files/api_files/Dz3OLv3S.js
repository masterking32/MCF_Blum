    ...
    setup(e, {
      ...
      return (i, u) => {
        ...
        return d(), A(m, {
          ...
          default: N(() => [n(l).label ? (d(), C("div", Vt, U(n(l).label), 1)) : n(l).icon ? (d(), A(v, {
            key: 1,
            name: n(l).icon,
            class: "icon"
...
`).reduce((m, c) => {
      ...
      return (b, m) => {
        ...
        return d(), A(p, {
          ...
          title: N(() => [n(l).state === "general" ? (d(), C("span", Wt, [oe(T("img", {
            src: e.iconUrl,
            alt: "Task icon"
          }, null, 8, Yt), [
            [h]
          ]), T("span", null, U(e.productName), 1)])) : I("", !0), n(l).state === "details" ? (d(), C("span", Qt, "Disclaimer")) : I("", !0)]),
          default: N(() => [n(l).state === "general" ? (d(), C("div", zt, [m[8] || (m[8] = T("div", {
            class: "text"
          ...
          footer: N(() => [n(l).state === "general" ? (d(), A(k, {
            key: 0,
    ...
    setup(e, {
      ...
      return (u, v) => {
        const b = J,
          ...
          h = ie("img-error");
        return d(), A(p, null, {
          default: N(() => [T("div", ea, [T("div", ta, [oe(T("img", {
    ...
    setup(e, {
      ...
      return be(() => [s.currentStreakDays.value, i.value, a.value], m, {
        ...
        const p = $t,
          h = fe,
          y = Le;
        return d(), C("div", ha, [n(r).type === "loading" ? (d(), A(p, {
          key: 0,
          fixed: ""
        })) : (d(), A(y, {
          key: 1,
    ...
    setup(e, {
      ...
      return De().initWatcher({
        ...
        const E = Zt,
          q = ia,
          P = Aa;
        return d(), C(F, null, [ee(f.$slots, "default", st(nt(n(w)))), R(E, {
          "model-value": !!n(k),
        ...
        return d(), A(r, {
          ...
          default: N(({
            ...
            return [T("div", rt({
              ...
              [l]
            ]), T("div", Oa, [T("div", wa, U(b.value), 1), m.value || u.value ? (d(), C("div", $a, [(k = m.value) != null && k.label ? (d(), C("span", Ra, U(`${m.value.label}${m.value.postfix}`) + U(u.value ? ", " : ""), 1)) : I("", !0), u.value ? (d(), C("span", Ea, U(u.value), 1)) : I("", !0)])) : I("", !0)]), e.task.status ? (d(), A(s, {
              key: 0,
              "claim-override": o.value,
      ...
      return (i, u) => {
        ...
        return d(), A(c, {
          ...
          default: N(({
            ...
            [k]
          ])), 128))])) : I("", !0), T("div", La, U(y.value), 1), f.value ? (d(), C("div", Pa, U(f.value), 1)) : I("", !0), T("div", Fa, [e.task.status ? (d(), A(v, {
            key: 0,
            "claim-override": r.value,
      ...
      return xe().onOpenTaskSheet(o.task, () => {
        ...
        return d(), C(F, null, [R(S, {
          ...
          default: N(() => [T("div", {
            ...
            default: N(() => [(d(!0), C(F, null, W(e.task.subTasks, (f, g) => (d(), A(h, {
              key: f.id,
          ...
          name: "footer",
          fn: N(() => [e.task.status && !n(z)(e.task.status, a.value[e.task.id]) ? (d(), A(y, {
            key: 0,
    ...
    setup(e) {
      ...
      return ce(() => v.disconnect()), (c, k) => {
        ...
        return oe((d(), A(Se, {
          ...
          default: N(() => [(d(!0), C(F, null, W(e.tasks, (y, S) => (d(), A(p, {
            key: y.id,
    ...
    setup(e) {
      ...
      const o = e,
        ...
        a = $(() => o.subSections.map(i => ({
          value: i.title,
          label: i.title,
          dot: i.tasks.some(u => ft(u, t.value))
        }))),
      ...
      return (i, u) => {
        ...
        return n(r).length ? (d(), C("div", ja, [R(v, {
          ...
          default: N(() => [(d(!0), C(F, null, W(n(r), c => (d(), A(m, {
            key: c.id,
            "tasks-claim-override": t.value,
...
function ms(e, o) {
  const t = _t,
    a = ns;
  return d(), A(a, null, {
    default: N(() => [T("div", os, [R(t, {
      class: "title"
    }), T("div", ls, [(d(), C(F, null, W(2, s => R(t, {
      key: s,
      class: "item"
    })), 64))]), T("div", rs, [R(t, {
      class: "subtitle"
    })]), T("div", cs, [(d(), C(F, null, W(2, s => R(t, {
      key: s,
      class: "item"
    })), 64))]), T("div", us, [R(t, {
      class: "subtitle"
    })]), T("div", ds, [(d(), C(F, null, W(7, s => T("div", {
      key: s,
      class: "item"
    }, [R(t, {
      class: "icon"
  ...
  ys = D({
    ...
    setup(e) {
      const o = qe(),
        ...
        s = B(),
        r = B({}),
        i = yt(async () => At(await Z.getTasksSections(te().$webApp.dataUnsafe.query.ref)), h => s.value = h, 15e3),
        u = (h, y) => {
          if (s.value)
        ...
        v = async h => {
          ...
          return y.err ? !1 : (u(h.id, y.data), ht().update(), !0)
        }, m = async (h, y) => {
          const S = await Z.verifyTask(h.id, y);
          return S.err ? S.code === 400 ? Q.WRONG_KEYWORD : Q.UNKNOWN_ERROR : (u(h.id, S.data), Q.SUCCESS)
        }, c = h => {
      ...
      return (async () => {
        ...
        return d(), C("div", ps, [n(a) ? (d(), A(S, {
          ...
          key: 1
        }, [T("div", fs, [T("span", vs, [pe(U(("t" in h ? h.t : n(O))("earn.title")) + " ", 1), T("sup", null, U(n(k)), 1)])]), T("div", bs, [(d(!0), C(F, null, W(n(s), (g, E) => (d(), A(w, {
          key: E,
