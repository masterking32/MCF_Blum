...
const Ee = h(Ie, [
    ...
    setup(e) {
      ...
      return (r, n) => {
        ...
        return u(), _("div", Ce, [n[2] || (n[2] = m("video", {
          ...
          key: 0,
          class: "score",
          to: ("useRouter" in r ? r.useRouter : a(U))().resolve({
            name: "tribe-top"
          })
        }, {
          default: V(() => [c(l, {
            ...
            class: "left-wing"
          }), m("span", Ue, S(("formatFloatLine" in r ? r.formatFloatLine : a(D))(e.rank, {
            accuracy: 0
          })), 1), c(l, {
            name: "chevron-right",
            class: "icon"
    ...
    setup(e, {
      ...
      return (t, l) => {
        ...
        return u(), _("div", Je, [c(o, {
          ...
          default: V(() => [m("div", Xe, S(n(e.role)), 1)]),
          _: 1
  ...
  ut = w({
    ...
    setup(e) {
      const i = e,
        s = O(e, "modelValue"),
        r = $(() => i.role === F.OWNER ? v("tribes.item.share.text_owner", {
          title: i.title
  ...
  Ft = w({
    ...
    setup(e, {
      ...
      const r = e,
        ...
        g = I(!1),
        T = I(),
        b = $(() => !!(o.value || r.myTribe && r.myTribe.role === F.OWNER && r.myTribe.countMembers > 1)),
        y = () => {
          o.value = !0, R()
        },
        R = () => {
