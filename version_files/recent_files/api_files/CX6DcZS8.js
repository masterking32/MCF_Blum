    ...
    setup(c) {
        ...
        f = () => {
          ...
          if (e) {
            const l = e.getBoundingClientRect(),
              ...
              M = l.left,
              C = e.offsetLeft;
            (m < 50 || M < 50) && (o.value.scrollLeft = C - window.innerWidth / 2 + l.width / 2)
          }
        };
      ...
      return (s, e) => {
        ...
        return n(), r("div", {
          ...
          ref: d,
          class: "start"
        }, null, 512), (n(!0), r(q, null, z(b(E), l => (n(), r("label", {
          key: l.value,
          class: w(["tab", {
          ...
          "data-tab": l.value
        }, [l.pingDot ? (n(), r("div", O)) : N("", !0), t("span", P, j(l.label), 1), e[1] || (e[1] = t("div", {
          class: "dot"
        }, null, -1)), h(t("input", {
