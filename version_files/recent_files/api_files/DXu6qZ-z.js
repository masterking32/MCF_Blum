...
const L = {
  ...
  A = u({
    ...
    setup(e) {
      return (i, s) => (t(), a("div", L, [$("div", O, S(("t" in i ? i.t : r(h))("tribes.search.no_results.title")), 1), e.noSubtitle ? g("", !0) : (t(), a("div", w, S(("t" in i ? i.t : r(h))("tribes.search.no_results.subtitle")), 1))]))
    }
  }),
  E = _(A, [
    ...
    setup(e) {
      ...
      return (o, n) => {
        ...
        return t(), a("div", D, [!e.list && !e.isSearching ? (t(), l(m, {
          ...
          key: 0,
          class: "no-results"
        })) : (t(), a("div", F, [(t(!0), a(b, null, V(e.list, c => (t(), l(v, {
          key: c.id,
          tribe: c,
