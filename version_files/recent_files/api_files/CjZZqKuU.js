...
var K = (c, o, t) => o in c ? I(c, o, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: t
}) : c[o] = t;
var l = (c, o, t) => K(c, typeof o != "symbol" ? o + "" : o, t);
import {
  bZ as h,
  a2 as m,
  av as E,
  ...
  constructor(t) {
    ...
    l(this, "getBclData", async () => {
      ...
      const a = r(s.data.fullPriceTon),
        i = r(s.data.fullPriceTon).minus(r(s.data.fullPriceTonFees)),
    ...
    this.partnerAddresses = t, this.tonApiClient = new G(new Y({
  ...
  constructor(t) {
    ...
    l(this, "getUnlockEnabled", h(async t => {
      ...
      const a = this.getAddress(t),
        ...
        d = !await (await this.sdk.openCoin(a).getUserWallet(i)).getTransfersEnabled();
...
class Z extends P {
  ...
  async getTradeTransactionStatus(t) {
    ...
    const s = e.data.actions.find(a => {
      var i;
      return a.type === "SmartContractExec" && ((i = a.SmartContractExec) == null ? void 0 : i.contract.address.equals(C.Address.parseFriendly(t.jettonAddress).address))
    });
  ...
  async sellJetton(t, e) {
    const s = this.mustGetUserWalletAddress(),
      ...
      n = this.getTonConnectSender();
    return await h(async () => (await a.sendSellCoins(n, i), (await n.getResult()).hash))()
  }
  getWaitForBuyStatus() {
...
const V = () => ({
  ...
  W = () => {
    ...
    return {
      ...
      partnerAddressesResolver: v(() => o.value)
    }
  },
  z = () => {
    const c = _("$JwHI1YwVmt"),
      ...
      s = k(async () => {
        ...
        return o.value = t(n), D(await o.value.getBclData())
      }, n => c.value = n);
    return {
      init: async () => {
        await s.exec()
      ...
      bclData: v(() => c.value),
      memepadManagementSdk: v(() => o.value)
    }
  },
  te = () => {
    const {
