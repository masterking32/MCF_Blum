    ...
    setup(e, {
      ...
      return ht(() => {
        ...
        return p(), w("div", Ts, [S(f), o(r) === "ERROR" ? (p(), w(W, {
          key: 0
        }, [_("div", Rs, [_("div", Us, [_("div", Ls, [S(u, {
          name: "warning",
          class: "icon"
    ...
    setup(e) {
      ...
      return (d, h) => {
        ...
        return p(), w("div", Js, [o(n).step !== 5 ? (p(), L(x, {
          ...
          key: 1,
          state: o(n),
          onContinue: h[0] || (h[0] = T => v(o(n), T))
        }, null, 8, ["state"])) : O("", !0), o(n).step === 2 ? (p(), L(y, {
          key: 2,
          state: o(n),
          onContinue: h[1] || (h[1] = T => f(o(n), T))
        }, null, 8, ["state"])) : O("", !0), o(n).step === 3 ? (p(), L(M, {
          key: 3,
          state: o(n),
          "jetton-management": t.jettonManagement,
          onContinue: h[2] || (h[2] = T => u(o(n), T)),
          onUpdate: h[3] || (h[3] = T => g(o(n), T))
