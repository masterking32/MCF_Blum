...
function Nt(e, i) {
  const t = Ge;
  return u(), C(t, {
    icon: ("imgResolver" in e ? e.imgResolver : n(We))("emoji/Construction"),
...
const Mt = M(Bt, [
  ...
  Kt = D({
    ...
    setup(e) {
      const i = e,
        t = w(() => {
          const s = [P.CARD, P.SHORT_CARD].includes(i.itemMode) ? He.RIGHT : void 0;
    ...
    setup(e, {
      ...
      return (o, d) => {
        ...
        return u(), C(m, {
          ...
          default: B(() => [n(l).label ? (u(), A("div", Gt, U(n(l).label), 1)) : n(l).icon ? (u(), C(v, {
            key: 1,
            name: n(l).icon,
            class: "icon"
...
`).reduce((m, c) => {
      ...
      return (b, m) => {
        ...
        return u(), C(p, {
          ...
          title: B(() => [n(l).state === "general" ? (u(), A("span", Yt, [oe(T("img", {
            src: e.iconUrl,
            alt: "Task icon"
          }, null, 8, Qt), [
            [h]
          ...
          }, "Disclaimer"), m[7] || (m[7] = pe("."))])])])) : I("", !0), n(l).state === "details" ? (u(), A("div", Zt, [(u(), C(Xe(n(v))))])) : I("", !0)]),
    ...
    setup(e, {
      ...
      return (d, v) => {
        const b = Z,
          ...
          h = ie("img-error");
        return u(), C(p, null, {
          default: B(() => [T("div", ta, [T("div", aa, [oe(T("img", {
          ...
          if ((t.task.kind === V.QUEST && t.task.reward.value.isZero() || t.task.kind === V.GROUP) && "subTasks" in t.task) {
            ...
            const g = () => ({
              ...
              E = t.task.subTasks.reduce((q, L) => {
                const W = q.get(L.reward.symbol) ?? g();
                return W.max = W.max.add(L.reward.value), z(L.status, s.value) && (W.finished = W.finished.add(L.reward.value)), q.set(L.reward.symbol, W), q
              }, new Map);
      ...
      return (o, d) => {
        ...
        return u(), C(c, {
          ...
          default: B(({
            ...
            onClick: p
          }, [n(t) ? (u(), A("div", Ua, [(u(!0), A(F, null, H(n(s), (g, E) => oe((u(), A("img", {
            key: E,
            src: n(le)(g),
            alt: "Task icon",
            class: "icon",
      ...
      return Ke().onOpenTaskSheet(i.task, () => {
        ...
        return u(), A(F, null, [R(S, {
          ...
          default: B(() => [T("div", {
            ...
            default: B(() => [(u(!0), A(F, null, H(e.task.subTasks, (f, g) => (u(), C(h, {
              key: f.id,
    ...
    setup(e) {
      ...
      return ce(() => v.disconnect()), (c, k) => {
        ...
        return oe((u(), C(Se, {
          ...
          default: B(() => [(u(!0), A(F, null, H(e.tasks, (y, S) => (u(), C(p, {
            key: y.id,
    ...
    setup(e) {
      ...
      return (o, d) => {
        ...
        return n(r).length ? (u(), A("div", Xa, [R(v, {
          ...
          default: B(() => [(u(!0), A(F, null, H(n(r), c => (u(), C(m, {
            key: c.id,
            "tasks-claim-override": t.value,
...
function ks(e, i) {
  ...
  return u(), C(a, null, {
    default: B(() => [T("div", ls, [R(t, {
      class: "title"
    }), T("div", rs, [(u(), A(F, null, H(2, s => R(t, {
      key: s,
      class: "item"
    })), 64))]), T("div", cs, [R(t, {
      class: "subtitle"
    })]), T("div", us, [(u(), A(F, null, H(2, s => R(t, {
      key: s,
      class: "item"
    })), 64))]), T("div", ds, [R(t, {
      class: "subtitle"
    })]), T("div", ms, [(u(), A(F, null, H(7, s => T("div", {
      key: s,
      class: "item"
    }, [R(t, {
      class: "icon"
  ...
  gs = D({
    ...
    setup(e) {
      const i = Ue(),
        ...
        s = N(),
        r = N({}),
        o = yt(async () => At(await J.getTasksSections(te().$webApp.dataUnsafe.query.ref)), h => s.value = h, 15e3),
        d = (h, y) => {
          if (s.value)
      ...
      return (async () => {
        ...
        return u(), A("div", fs, [n(a) ? (u(), C(S, {
          ...
          key: 1
        }, [T("div", vs, [T("span", bs, [pe(U(("t" in h ? h.t : n(O))("earn.title")) + " ", 1), T("sup", null, U(n(k)), 1)])]), T("div", ys, [(u(!0), A(F, null, H(n(s), (g, E) => (u(), C($, {
          key: E,
