...
async function ha(e, i) {
  ...
  return await Promise.all([ne().getReferralToken(), document.fonts.ready, r.load(), l.load()]), document.fonts.add(r), document.fonts.add(l), a.clearRect(0, 0, e, i), t.width = e * s, t.height = i * s, a.scale(s, s), a.imageSmoothingEnabled = !0, a.imageSmoothingQuality = "high", t.style.width = e * s + "px", t.style.height = i * s + "px", t.style.scale = `${1/s}`, fa(a, t, i, e)
}
async function Ta({
  canvas: e,
  name: i,
      ...
      return (o, d) => {
        ...
        return u(), C(c, {
          ...
          default: N(({
            ...
            [k]
          ])), 128))])) : I("", !0), T("div", Fa, U(y.value), 1), f.value ? (u(), A("div", xa, U(f.value), 1)) : I("", !0), T("div", Ka, [e.task.status ? (u(), C(v, {
            key: 0,
            "claim-override": r.value,
