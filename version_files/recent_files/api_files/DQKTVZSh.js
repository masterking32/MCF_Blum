...
const bt = {
  ...
  Ct = D({
    ...
    setup(p) {
      return (t, d) => {
        const n = he,
          a = vt;
        return l(), _("div", bt, [o("div", Mt, [v(n, {
    ...
    setup(p) {
      ...
      function j() {
        ...
        const R = k(),
          ...
          w = me(async () => await t.getReactions(s.value.shortname), re => {
            ...
            }, {}), Ve = 5e3 / Object.values(Te).reduce((F, H) => F + H, 0), Fe = b, He = F => ({
              id: st(),
              image: nt(F),
              position: {
                x: ve(0, 20) - 10,
      ...
      return (f, h) => {
        ...
        return l(), _("div", gs, [o("div", Es, [e(d).isLowEndDevice.value ? L("", !0) : (l(), _("img", {
          ...
          class: "gradient"
        }, null, -1))]), o("div", Ts, [o("div", bs, [o("div", Ms, [v(b, {
  ...
  Qs = D({
    ...
    setup(p) {
      const t = p,
        ...
        c = E(() => t.jetton.ownedAmountUSD ? Me(t.jetton.ownedAmountUSD, "USD").frontendWithSymbol : "-"),
      ...
      return (r, I) => {
        ...
        return l(), C(S, {
          ...
          default: B(() => {
            ...
            }, null, 8, ["image", "collected-percent", "is-released", "stream-online"]), o("div", Ds, [o("div", Os, y(r.jetton.ticker), 1), r.mode === e(J).BASE ? (l(), _("div", js, [r.jetton.stats.holdersCount !== void 0 ? (l(), _("div", Us, [v(M, {
              name: "personal",
              class: "icon"
            }), o("span", Ks, y(("formatCount" in r ? r.formatCount : e(q))(r.jetton.stats.holdersCount, {
              accuracy: 0
            }).full), 1)])) : L("", !0), r.jetton.stats.transactionsCount !== void 0 ? (l(), _("div", Bs, [v(M, {
              name: "transfer",
              class: "icon"
    ...
    setup(p) {
      ...
      return (c, s) => {
        ...
        return l(), _("div", tn, [o("div", sn, [v(I, {
          ...
          default: B(() => [c.items.length ? (l(), C(M, {
            key: t.value,
            items: c.items,
  ...
  vn = D({
    ...
    setup(p, {
      ...
      return oe(c, I), Ie().memepad.memepadSearchOpen(), rt().initHandler(() => d("close"), "memepad-search"), (M, S) => {
        const T = Tt,
          P = Oe;
        return l(), _("div", pn, [v(T, {
          ...
          placeholder: ("t" in M ? M.t : e($))("memepad.search.input_placeholder"),
          activated: e(m),
          autofocus: "",
          "is-loading": e(a).isSearching.value
        }, null, 8, ["modelValue", "placeholder", "activated", "is-loading"]), e(a).data.value ? (l(), _(Y, {
          key: 0
        }, [e(a).data.value.length === 0 ? (l(), _("div", _n, y(("t" in M ? M.t : e($))("memepad.search.empty_text")), 1)) : (l(), C(P, {
          key: 1,
          ...
          case "pagination-list":
            return {
              type: "pagination-list", pagination: Et(async h => {
                ...
                if (!ke(b)) throw ne("Failed to get list");
                return {
    ...
    setup(p) {
      ...
      return (M, S) => {
        ...
        const T = Bt,
          ...
          f = It,
          h = hn;
        return l(), _(Y, null, [e(c) ? (l(), _("div", Sn, [o("div", In, [o("div", Tn, y(("t" in M ? M.t : e($))("memepad.explore.title")), 1), v(T, {
          onLaunch: r
