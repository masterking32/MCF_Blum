    ...
    setup(g) {
      const t = g,
        ...
        i = Re(() => {
          ...
          const u = f.value.children[0].offsetHeight + 10,
            b = f.value.scrollTop;
          Math.round(b / u) === 0 ? n.value = P.BP : n.value = P.MP
      ...
      return (u, b) => {
        ...
        return a(), d("div", an, [o("div", rn, [o("div", ln, [b[2] || (b[2] = o("i", {
          class: "trophy"
        }, null, -1)), le(m(("t" in u ? u.t : e(l))("frens.leaderboards.my.title")), 1)]), c(S, {
          class: "link",
          to: {
          ...
          default: k(() => [o("div", cn, m(("t" in u ? u.t : e(l))("frens.leaderboards.my.see_all")), 1), c(A, {
            name: "chevron-right",
            class: "icon"
          })]),
          _: 1
          ...
          label: ("t" in u ? u.t : e(l))("frens.leaderboards.my.your_rating"),
          ...
          after: k(() => [o("div", mn, [o("div", {
            ...
            position: u.my[e(P).BP].position
          }, null, 8, ["position"])]), o("div", un, [c(T, {
            position: u.my[e(P).MP].position
    ...
    setup(g) {
      ...
      return (F, r) => {
        ...
        return a(), d("div", {
          ...
          key: _.title,
          class: "card"
        }, [o("div", bn, m(_.title), 1), o("div", hn, m(_.value), 1), o("div", $n, [(a(!0), d(R, null, E(_.text, i => (a(), d("span", {
          key: i.value,
          class: q([{
  ...
  Un = $({
    ...
    setup(g) {
      ...
      return (n, F) => {
        ...
        }, null, 8, ["type", "percent-from-friends", "percent-from-friends-of-friends"])]))), 128))]), c(_)])
      }
    }
  }),
  Pn = h(Un, [
    ...
    setup(g, {
      ...
      const s = g,
        ...
        f = async () => {
          ...
          const i = performance.now(),
            u = await s.claimCallback();
          if (u.err) {
            r.value = !1;
            return
          }
          const b = performance.now() - i;
          b < 2e3 && await new Promise(A => setTimeout(A, 1e3 - b)), r.value = !1, n("ui:claimed", u.data)
        }, _ = C(() => {
      ...
      return (i, u) => {
        ...
        return a(), d("div", Qn, [c(b, {
          ...
          name: "logo",
          class: "icon"
        }), o("div", nt, [o("div", tt, m(`${("formatBp"in i?i.formatBp:e(G))(i.amountForClaim)} BP`), 1), o("div", st, m(e(_)), 1)]), c(S, {
    ...
    setup(g) {
      return (t, s) => {
        ...
        return a(), d("div", rt, [o("div", it, [o("div", lt, m(t.fren.letterAvatar), 1), t.fren.avatarUrl ? Ne((a(), d("img", {
          ...
          [r]
        ]) : V("", !0)]), o("div", dt, [o("div", mt, m(t.fren.username), 1), o("div", _t, [c(n, {
          name: "users",
          class: "icon"
        }), o("div", ut, m(t.fren.totalFrens > 0 ? "+ " : "") + m(t.fren.totalFrens), 1)])]), t.fren.farmBalance ? (a(), d("div", pt, m(("formatBp" in t ? t.formatBp : e(G))(t.fren.farmBalance)) + " BP", 1)) : (a(), w(F, {
          key: 1,
          class: "skeleton"
        }))])
      }
    ...
    setup(g, {
      ...
      return Ke().initHandler(() => s("close"), "frens-referral-modal"), (n, F) => {
        const r = vt,
          f = sn;
        return a(), w(f, null, {
          default: k(() => [o("div", gt, [o("div", Ft, m(("t" in n ? n.t : e(l))("frens.referrals.title")), 1), o("div", bt, [(a(!0), d(R, null, E(n.frens, _ => (a(), w(r, {
            key: _.username,
            fren: _
          }, null, 8, ["fren"]))), 128))])])]),
          _: 1
  ...
  Ct = $({
    ...
    setup(g) {
      ...
      return He(t, s => {
        ...
        return a(), w(f, {
          modelValue: e(t),
          "onUpdate:modelValue": n[1] || (n[1] = _ => pe(t) ? t.value = _ : null)
        }, {
    ...
    setup(g) {
      ...
      return (async () => {
        ...
        return a(), d("div", St, [e(F) && e(r) && e(f) && e(K) && e(n) ? (a(), d(R, {
          ...
          modelValue: e(u),
          "onUpdate:modelValue": p[5] || (p[5] = B => pe(u) ? u.value = B : null),
