    ...
    setup(g) {
      ...
      return (n, F) => {
        const r = J,
          f = ve,
          u = ge;
        return a(), d("div", In, [o("div", Bn, [(a(!0), d(R, null, E(e(s), i => (a(), d("div", {
          key: i.title,
          class: "section"
        }, [c(r, {
          icon: i.icon,
    ...
    setup(g) {
      ...
      return He(t, s => {
        ...
        return a(), w(f, {
          ...
          }, null, 8, At), o("div", Ct, m(("t" in s ? s.t : e(l))("frens.leaderboards.intro_sheet.description")), 1), c(r, {
