  ...
  is = Za({
    ...
    setup(t) {
      const e = t,
        ...
        a = Ha(() => {
          const i = {};
          return i.textAlign = e.textAlignment, e.textMinWidth && (i.minWidth = `${e.textMinWidth}px`), e.textMaxWidth && (i.maxWidth = `${e.textMaxWidth}px`), i
        });
      return (i, o) => {
        const l = ns,
          d = Ka("click-outside");
        return Ga((Vn(), Dn("div", ss, [Xt("div", {
          class: Wn(["body", {
            "is-fill": i.fill
          }]),
          onClick: o[0] || (o[0] = u => r())
        }, [Nn(i.$slots, "default", {}, void 0, !0)], 2), Ln(ts, {
          name: "opacity-transition"
        }, {
          default: Qa(() => [qn(n) ? (Vn(), Dn("div", {
            key: 0,
            class: Wn(["content", `is-${i.alignment.toLowerCase()}`])
          }, [Xt("div", {
            class: "text",
            style: Xa(qn(a))
          }, [Nn(i.$slots, "inner", {}, () => [Ya(Ja(i.text), 1)], !0)], 4), Xt("button", {
            type: "button",
...
var ls = function() {
    function t(n, r) {
      ...
      this._batchLoadFn = n, this._maxBatchSize = hs(r), this._batchScheduleFn = ms(r), this._cacheKeyFn = gs(r), this._cacheMap = ps(r), this._batch = null, this.name = ys(r)
    }
    var e = t.prototype;
    return e.load = function(r) {
      ...
      if (!fr(r)) throw new TypeError("The loader.loadMany() function must be called with Array<key> " + ("but got: " + r + "."));
  ...
  ds = typeof en == "object" && typeof en.nextTick == "function" ? function(t) {
    tn || (tn = Promise.resolve()), tn.then(function() {
      en.nextTick(t)
    })
...
function fs(t, e) {
  ...
  try {
    ...
    return nn(t, e, new TypeError("DataLoader must be constructed with a function which accepts Array<key> and returns Promise<Array<value>>, but the function " + ("errored synchronously: " + String(r) + ".")))
  }
  if (!n || typeof n.then != "function") return nn(t, e, new TypeError("DataLoader must be constructed with a function which accepts Array<key> and returns Promise<Array<value>>, but the function did " + ("not return a Promise: " + String(n) + ".")));
  n.then(function(r) {
    if (!fr(r)) throw new TypeError("DataLoader must be constructed with a function which accepts Array<key> and returns Promise<Array<value>>, but the function did " + ("not return a Promise of an Array: " + String(r) + "."));
...
const vs = /^c[^\s-]{8,}$/i,
  _s = /^[0-9a-z]+$/,
  ws = /^[0-9A-HJKMNP-TV-Z]{26}$/,
  Cs = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i,
  As = /^[a-z0-9_-]{21}$/i,
  ks = /^[-+]?P(?!$)(?:(?:[-+]?\d+Y)|(?:[-+]?\d+[.,]\d+Y$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:(?:[-+]?\d+W)|(?:[-+]?\d+[.,]\d+W$))?(?:(?:[-+]?\d+D)|(?:[-+]?\d+[.,]\d+D$))?(?:T(?=[\d+-])(?:(?:[-+]?\d+H)|(?:[-+]?\d+[.,]\d+H$))?(?:(?:[-+]?\d+M)|(?:[-+]?\d+[.,]\d+M$))?(?:[-+]?\d+(?:[.,]\d+)?S)?)??$/,
  xs = /^(?!\.)(?!.*\.\.)([A-Z0-9_'+\-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i,
  Bs = "^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$";
let rn;
const Es = /^(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9][0-9]|[0-9])$/,
  Ts = /^(([a-f0-9]{1,4}:){7}|::([a-f0-9]{1,4}:){0,6}|([a-f0-9]{1,4}:){1}:([a-f0-9]{1,4}:){0,5}|([a-f0-9]{1,4}:){2}:([a-f0-9]{1,4}:){0,4}|([a-f0-9]{1,4}:){3}:([a-f0-9]{1,4}:){0,3}|([a-f0-9]{1,4}:){4}:([a-f0-9]{1,4}:){0,2}|([a-f0-9]{1,4}:){5}:([a-f0-9]{1,4}:){0,1})([a-f0-9]{1,4}|(((25[0-5])|(2[0-4][0-9])|(1[0-9]{2})|([0-9]{1,2}))\.){3}((25[0-5])|(2[0-4][0-9])|(1[0-9]{2})|([0-9]{1,2})))$/,
  Ps = /^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$/,
  vr = "((\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-((0[13578]|1[02])-(0[1-9]|[12]\\d|3[01])|(0[469]|11)-(0[1-9]|[12]\\d|30)|(02)-(0[1-9]|1\\d|2[0-8])))",
  Ss = new RegExp(`^${vr}$`);
...
function zs(t, e) {
  return !!((e === "v4" || !e) && Es.test(t) || (e === "v6" || !e) && Ts.test(t))
}
class K extends A {
  _parse(e) {
    ...
    for (const a of this._def.checks)
      if (a.kind === "min") e.data.length < a.value && (s = this._getOrReturnCtx(e, s), g(s, {
        code: f.too_small,
        minimum: a.value,
        type: "string",
        inclusive: !0,
      ...
      else if (a.kind === "max") e.data.length > a.value && (s = this._getOrReturnCtx(e, s), g(s, {
      code: f.too_big,
      maximum: a.value,
      type: "string",
      inclusive: !0,
    ...
    } else if (a.kind === "email") xs.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "email",
      code: f.invalid_string,
      message: a.message
    }), r.dirty());
    else if (a.kind === "emoji") rn || (rn = new RegExp(Bs, "u")), rn.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "emoji",
      code: f.invalid_string,
      message: a.message
    }), r.dirty());
    else if (a.kind === "uuid") Cs.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "uuid",
      code: f.invalid_string,
      message: a.message
    }), r.dirty());
    else if (a.kind === "nanoid") As.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "nanoid",
      code: f.invalid_string,
      message: a.message
    }), r.dirty());
    else if (a.kind === "cuid") vs.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "cuid",
      code: f.invalid_string,
      message: a.message
    }), r.dirty());
    else if (a.kind === "cuid2") _s.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "cuid2",
      code: f.invalid_string,
      message: a.message
    }), r.dirty());
    else if (a.kind === "ulid") ws.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "ulid",
      code: f.invalid_string,
      message: a.message
    }), r.dirty());
      ...
      message: a.message
    }), r.dirty()) : a.kind === "datetime" ? yn(a).test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      code: f.invalid_string,
      validation: "datetime",
      message: a.message
    }), r.dirty()) : a.kind === "date" ? Ss.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      code: f.invalid_string,
      validation: "date",
      message: a.message
    }), r.dirty()) : a.kind === "time" ? Ms(a).test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      code: f.invalid_string,
      validation: "time",
      message: a.message
    }), r.dirty()) : a.kind === "duration" ? ks.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "duration",
      code: f.invalid_string,
      message: a.message
    }), r.dirty()) : a.kind === "ip" ? zs(e.data, a.version) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "ip",
      code: f.invalid_string,
      message: a.message
    }), r.dirty()) : a.kind === "base64" ? Ps.test(e.data) || (s = this._getOrReturnCtx(e, s), g(s, {
      validation: "base64",
      code: f.invalid_string,
      message: a.message
...
class ie extends A {
  ...
  _parse(e) {
    ...
    let r;
    const s = new j;
    for (const a of this._def.checks) a.kind === "int" ? x.isInteger(e.data) || (r = this._getOrReturnCtx(e, r), g(r, {
      code: f.invalid_type,
      expected: "integer",
      received: "float",
      message: a.message
      ...
      exact: !1,
      message: a.message
    }), s.dirty()) : a.kind === "multipleOf" ? Is(e.data, a.value) !== 0 && (r = this._getOrReturnCtx(e, r), g(r, {
...
class oe extends A {
  ...
  _parse(e) {
    ...
    let r;
    const s = new j;
    for (const a of this._def.checks) a.kind === "min" ? (a.inclusive ? e.data < a.value : e.data <= a.value) && (r = this._getOrReturnCtx(e, r), g(r, {
      code: f.too_small,
      type: "bigint",
      minimum: a.value,
      inclusive: a.inclusive,
...
class ge extends A {
  _parse(e) {
    ...
    const r = new j;
    let s;
    for (const a of this._def.checks) a.kind === "min" ? e.data.getTime() < a.value && (s = this._getOrReturnCtx(e, s), g(s, {
      code: f.too_small,
      message: a.message,
      inclusive: !0,
      exact: !1,
...
class G extends A {
  _parse(e) {
    ...
    if (n.parsedType !== p.array) return g(n, {
      code: f.invalid_type,
      expected: p.array,
      received: n.parsedType
    }), _;
    ...
    if (s.minLength !== null && n.data.length < s.minLength.value && (g(n, {
        code: f.too_small,
      ...
      }), r.dirty()), s.maxLength !== null && n.data.length > s.maxLength.value && (g(n, {
        code: f.too_big,
...
function Se(t) {
  if (t instanceof I) {
    ...
    ...t._def,
    type: Se(t.element)
  }) : t instanceof Q ? Q.create(Se(t.unwrap())) : t instanceof le ? le.create(Se(t.unwrap())) : t instanceof Y ? Y.create(t.items.map(e => Se(e))) : t
}
class I extends A {
  constructor() {
  ...
  _parse(e) {
    ...
    if (this._def.catchall instanceof ee) {
      ...
      else if (d === "strict") o.length > 0 && (g(s, {
  ...
  keyof() {
    return wr(x.objectKeys(this.shape))
  }
}
I.create = (t, e) => new I({
  shape: () => t,
...
class Y extends A {
  _parse(e) {
    ...
    if (r.parsedType !== p.array) return g(r, {
      code: f.invalid_type,
      expected: p.array,
      received: r.parsedType
    }), _;
...
class De extends A {
  ...
  _parse(e) {
    ...
    if (r.parsedType !== p.object) return g(r, {
      code: f.invalid_type,
      expected: p.object,
      received: r.parsedType
    }), _;
...
class mt extends A {
  ...
  _parse(e) {
    ...
    if (r.parsedType !== p.map) return g(r, {
      code: f.invalid_type,
      expected: p.map,
      received: r.parsedType
    }), _;
...
class pe extends A {
  _parse(e) {
    ...
    if (r.parsedType !== p.set) return g(r, {
      code: f.invalid_type,
      expected: p.set,
      received: r.parsedType
    }), _;
    ...
    }), n.dirty()), s.maxSize !== null && r.data.size > s.maxSize.value && (g(r, {
      code: f.too_big,
...
class we extends A {
  ...
  _parse(e) {
    ...
    if (n.parsedType !== p.function) return g(n, {
      code: f.invalid_type,
      expected: p.function,
      received: n.parsedType
    }), _;
  ...
  args(...e) {
    return new we({
      ...this._def,
      args: Y.create(e).rest(me.create())
    })
  }
  returns(e) {
    return new we({
  ...
  static create(e, n, r) {
    return new we({
      args: e || Y.create([]).rest(me.create()),
      returns: n || me.create(),
...
class ce extends A {
  ...
  _parse(e) {
    ...
    if (Pt(this, it) || br(this, it, new Set(this._def.values)), !Pt(this, it).has(e.data)) {
      const n = this._getOrReturnCtx(e),
        r = this._def.values;
      return g(n, {
        received: n.data,
...
class Le extends A {
  ...
  _parse(e) {
    ...
    if (Pt(this, ot) || br(this, ot, new Set(x.getValidEnumValues(this._def.values))), !Pt(this, ot).has(e.data)) {
      const s = x.objectValues(n);
      return g(r, {
        received: r.data,
        code: f.invalid_enum_value,
...
class ke extends A {
  ...
  _parse(e) {
    ...
    if (n.parsedType !== p.promise && n.common.async === !1) return g(n, {
      code: f.invalid_type,
      expected: p.promise,
      received: n.parsedType
    }), _;
  ...
  _parse(e) {
    ...
    if (s.type === "transform")
      if (r.common.async === !1) {
        ...
        path: r.path,
        parent: r
      }).then(i => ze(i) ? Promise.resolve(s.transform(i.value, a)).then(o => ({
        status: n.value,
        value: o
      })) : i);
    x.assertNever(s)
...
class $e extends A {
  _parse(e) {
    const n = this._def.innerType._parse(e),
      r = s => (ze(s) && (s.value = Object.freeze(s.value)), s);
...
const Rs = Object.freeze(Object.defineProperty({
  ...
  Os = "@ton/ton",
  js = "15.1.0",
  Us = "https://github.com/ton-org/ton.git",
  Vs = "Whales Corp. <developers@whalescorp.com>",
  Ds = "MIT",
  Ns = "dist/index.js",
  Ws = ["dist"],
  Ls = {
...
var oa = O && O.__importDefault || function(t) {
...
const Gs = Rt,
  ...
  dn = h.z.object({
    ...
    in_msg: h.z.union([h.z.undefined(), Hn]),
    out_msgs: h.z.array(Hn)
  }),
  Kn = h.z.array(dn),
  ri = h.z.object({
...
class ii {
  constructor(e, n) {
    this.endpoint = e, this.cache = new Gs.InMemoryCache, this.parameters = {
      timeout: (n == null ? void 0 : n.timeout) || 3e4,
      apiKey: n == null ? void 0 : n.apiKey,
      adapter: n == null ? void 0 : n.adapter
    }, this.shardCache = new Qn("ton-shard", this.cache, h.z.array(Fe), r => r + ""), this.shardLoader = new Fn.default(async r => await Promise.all(r.map(async s => {
    ...
    }))), this.shardTransactionsCache = new Qn("ton-shard-tx", this.cache, Gn, r => r.workchain + ":" + r.shard + ":" + r.seqno), this.shardTransactionsLoader = new Fn.default(async r => await Promise.all(r.map(async s => {
  ...
  async getMasterchainInfo() {
    return await this.doCall("getMasterchainInfo", {}, ri)
  }
  async getShards(e) {
  ...
  async getTransaction(e, n, r) {
    let s = B.from(r, "base64").toString("hex"),
      i = (await this.doCall("getTransactions", {
        ...
        hash: s,
        limit: 1
      }, Kn)).find(o => o.transaction_id.lt === n && o.transaction_id.hash === r);
    return i || null
  }
  ...
  async doCall(e, n, r) {
    let s = {
      ...
      "X-Ton-Client-Version": Ys
    };
    this.parameters.apiKey && (s["X-API-Key"] = this.parameters.apiKey);
    let a = await Qs.default.post(this.endpoint, JSON.stringify({
      id: "1",
      jsonrpc: "2.0",
      method: e,
      params: n
...
class li {
  constructor(e) {
    this.parameters = {
      endpoint: e.endpoint
    }, this.api = new ci.HttpApi(this.parameters.endpoint, {
      timeout: e.timeout,
      apiKey: e.apiKey,
  ...
  open(e) {
    return (0, S.openContract)(e, n => un(this, n.address, n.init))
  }
  provider(e, n) {
    return un(this, e, n ?? null)
  }
}
jt.TonClient = li;
...
function un(t, e, n) {
  return {
    ...
    open(r) {
      return (0, S.openContract)(r, s => un(t, s.address, s.init ?? null))
    },
...
var Ct = O && O.__classPrivateFieldSet || function(t, e, n, r, s) {
  ...
  fi = O && O.__importDefault || function(t) {
    return t && t.__esModule ? t : {
      default: t
    }
  },
...
class mi {
  constructor(e) {
    W.set(this, void 0), L.set(this, void 0), q.set(this, void 0), V.set(this, void 0), Ct(this, V, hi.default.create(), "f"), Ct(this, W, e.endpoint, "f"), Ct(this, L, e.timeout || 5e3, "f"), Ct(this, q, e.httpAdapter, "f"), e.requestInterceptor && C(this, V, "f").interceptors.request.use(e.requestInterceptor)
  }
  async getLastBlock() {
  ...
  async getAccountTransactions(e, n, r) {
    let s = await C(this, V, "f").get(C(this, W, "f") + "/account/" + e.toString({
        urlSafe: !0
      }) + "/tx/" + n.toString(10) + "/" + (0, an.toUrlSafe)(r.toString("base64")), {
        adapter: C(this, q, "f"),
        timeout: C(this, L, "f")
      }),
      a = Ci.safeParse(s.data);
    if (!a.success) throw Error("Mailformed response");
    let i = a.data,
      o = [],
  ...
  async getAccountTransactionsParsed(e, n, r, s = 20) {
    let a = await C(this, V, "f").get(C(this, W, "f") + "/account/" + e.toString({
        urlSafe: !0
      }) + "/tx/parsed/" + n.toString(10) + "/" + (0, an.toUrlSafe)(r.toString("base64")), {
        adapter: C(this, q, "f"),
        timeout: C(this, L, "f"),
        params: {
          count: s
  ...
  async getConfig(e, n) {
    ...
    let s = await C(this, V, "f").get(C(this, W, "f") + "/block/" + e + "/config" + r, {
      ...
      a = _i.safeParse(s.data);
    if (!a.success) throw Error("Mailformed response");
    return a.data
  }
  async runMethod(e, n, r, s) {
    let a = s && s.length > 0 ? "/" + (0, an.toUrlSafe)((0, N.serializeTuple)(s).toBoc({
        idx: !1,
        crc32: !1
      }).toString("base64")) : "",
  ...
  async sendMessage(e) {
    ...
    if (!wi.safeParse(n.data).success) throw Error("Mailformed response");
    return {
...
const gi = c.z.object({
  ...
  pi = c.z.object({
    account: c.z.object({
      ...
      storageStat: c.z.union([c.z.null(), ca])
    }),
    block: c.z.object({
      workchain: c.z.number(),
      seqno: c.z.number(),
  ...
  Ai = c.z.union([c.z.object({
    ...
    dest: c.z.string(),
    src: c.z.union([Xn, c.z.null()]),
    importFee: c.z.string()
  }), c.z.object({
    type: c.z.literal("external-out"),
    dest: c.z.union([Xn, c.z.null()])
  })]),
  ki = c.z.object({
  ...
  er = c.z.object({
    body: c.z.string(),
    info: Ai,
    init: c.z.union([ki, c.z.null()])
  }),
  tr = c.z.union([c.z.literal("uninitialized"), c.z.literal("frozen"), c.z.literal("active"), c.z.literal("non-existing")]),
  xi = c.z.union([c.z.object({
  ...
  Ei = c.z.union([c.z.literal("jetton::excesses"), c.z.literal("jetton::transfer"), c.z.literal("jetton::transfer_notification"), c.z.literal("deposit"), c.z.literal("deposit::ok"), c.z.literal("withdraw"), c.z.literal("withdraw::all"), c.z.literal("withdraw::delayed"), c.z.literal("withdraw::ok"), c.z.literal("airdrop")]),
  Ti = c.z.object({
    type: Ei,
  ...
  Si = c.z.object({
    ...
    inMessage: c.z.union([er, c.z.null()]),
    outMessages: c.z.array(er),
    parsed: c.z.object({
      seqno: c.z.union([c.z.number(), c.z.null()]),
      body: c.z.union([xi, c.z.null()]),
...
vt.loadWalletIdV5Beta = zi;
vt.storeWalletIdV5Beta = Ii;
const sn = z,
  da = {
    v5: 0
  };
...
function zi(t) {
  var o;
  const e = new sn.BitReader(new sn.BitString(typeof t == "bigint" ? B.from(t.toString(16), "hex") : t instanceof sn.Slice ? t.loadBuffer(10) : t, 0, 80)),
    n = e.loadInt(32),
    r = e.loadInt(8),
    s = e.loadUint(8),
    a = e.loadUint(32),
    i = (o = Object.entries(da).find(([l, d]) => d === s)) == null ? void 0 : o[0];
...
function Ii(t) {
  return e => {
    e.storeInt(t.networkGlobalId, 32), e.storeInt(t.workchain, 8), e.storeUint(da[t.walletVersion], 8), e.storeUint(t.subwalletNumber, 32)
  }
}
var nr;
...
function ua() {
  if (nr) return Qe;
  nr = 1, Object.defineProperty(Qe, "__esModule", {
    value: !0
  }), Qe.WalletContractV5Beta = void 0;
  const t = z,
    e = te(),
    n = vt;
  class r {
  ...
  return Qe.WalletContractV5Beta = r, r.OpCodes = {
...
_t.isOutActionExtended = fa;
_t.isOutActionBasic = Ri;
...
xe.storeOutActionExtendedV5Beta = pa;
xe.loadOutActionV5BetaExtended = ya;
xe.storeOutListExtendedV5Beta = ba;
xe.loadOutListExtendedV5Beta = Vi;
const kt = z,
  rr = _t,
  ha = 550222170;
...
function Oi(t) {
  return e => {
    e.storeUint(ha, 32).storeUint(t.isEnabled ? 1 : 0, 1)
  }
}
const ma = 474012575;
...
function ji(t) {
  return e => {
    e.storeUint(ma, 32).storeAddress(t.address)
  }
}
const ga = 1588524196;
...
function Ui(t) {
  return e => {
    e.storeUint(ga, 32).storeAddress(t.address)
  }
}
...
function ba(t) {
  const [e, ...n] = t;
  if (!e || !(0, rr.isOutActionExtended)(e)) {
    if (t.some(rr.isOutActionExtended)) throw new Error("Can't serialize actions list: all extended actions must be placed before out actions");
    return r => {
      r.storeUint(0, 1).storeRef((0, kt.beginCell)().store((0, kt.storeOutList)(t)).endCell())
    }
  }
  return r => {
    r.storeUint(1, 1).store(pa(e)).storeRef((0, kt.beginCell)().store(ba(n)).endCell())
  }
}
...
function Ni(t, e, n) {
  return "secretKey" in t ? n((0, Di.sign)(e.endCell().hash(), t.secretKey), e) : t.signer(e.endCell()).then(r => n(r, e))
}
var Ye = {},
  Ke = {};
...
Ke.isWalletIdV5R1ClientContext = va;
Ke.loadWalletIdV5R1 = Wi;
Ke.storeWalletIdV5R1 = Li;
const Me = z;
...
function Wi(t, e) {
  var i;
  const n = new Me.BitReader(new Me.BitString(typeof t == "bigint" ? B.from(t.toString(16), "hex") : t instanceof Me.Slice ? t.loadBuffer(4) : t, 0, 32)).loadInt(32),
    r = BigInt(n) ^ BigInt(e),
    s = (0, Me.beginCell)().storeInt(r, 32).endCell().beginParse();
  if (s.loadUint(1)) {
    const o = s.loadInt(8),
      l = s.loadUint(8),
      d = s.loadUint(15),
      u = (i = Object.entries(_a).find(([v, E]) => E === l)) == null ? void 0 : i[0];
...
function Li(t) {
  return e => {
    let n;
    return va(t.context) ? n = (0, Me.beginCell)().storeUint(1, 1).storeInt(t.context.workchain, 8).storeUint(_a[t.context.walletVersion], 8).storeUint(t.context.subwalletNumber, 15).endCell().beginParse().loadInt(32) : n = (0, Me.beginCell)().storeUint(0, 1).storeUint(t.context, 31).endCell().beginParse().loadInt(32), e.storeInt(BigInt(t.networkGlobalId) ^ BigInt(n), 32)
  }
}
var ar;
...
function wa() {
  if (ar) return Ye;
  ar = 1, Object.defineProperty(Ye, "__esModule", {
    value: !0
...
de.storeOutActionExtendedV5R1 = kn;
de.loadOutActionExtendedV5R1 = fn;
de.storeOutListExtendedV5R1 = Fi;
de.loadOutListExtendedV5R1 = Hi;
de.toSafeV5R1SendMode = Ba;
de.patchV5R1ActionsSendMode = Ki;
const pt = z,
  sr = _t,
  Ca = 4;
...
function qi(t) {
  return e => {
    e.storeUint(Ca, 8).storeUint(t.isEnabled ? 1 : 0, 1)
  }
}
const Aa = 2;
...
function Zi(t) {
  return e => {
    e.storeUint(Aa, 8).storeAddress(t.address)
  }
}
const ka = 3;
...
function $i(t) {
  return e => {
    e.storeUint(ka, 8).storeAddress(t.address)
  }
}
...
function Fi(t) {
  const e = t.filter(sr.isOutActionExtended),
    n = t.filter(sr.isOutActionBasic);
  return r => {
    ...
    if (r.storeMaybeRef(s), e.length === 0) r.storeUint(0, 1);
      ...
      const [a, ...i] = e;
      r.storeUint(1, 1).store(kn(a)), i.length > 0 && r.storeRef(xa(i))
    }
  }
}
...
function xa(t) {
  const [e, ...n] = t;
  let r = (0, pt.beginCell)().store(kn(e));
  return n.length > 0 && (r = r.storeRef(xa(n))), r.endCell()
}
...
function te() {
  if (ir) return re;
  ir = 1, Object.defineProperty(re, "__esModule", {
    value: !0
  ...
  function o(m, w) {
    return (0, t.beginCell)().storeBuffer(m).storeBuilder(w).endCell()
  }

  function l(m, w) {
    return (0, t.beginCell)().storeBuilder(w).storeBuffer(m).endCell()
  }

  function d(m) {
    let w = (0, t.beginCell)().storeUint(m.seqno, 32);
    m.message && (w.storeUint(m.sendMode, 8), w.storeRef((0, t.beginCell)().store((0, t.storeMessageRelaxed)(m.message))));
    let T = (0, e.sign)(w.endCell().hash(), m.secretKey);
    return (0, t.beginCell)().storeBuffer(T).storeBuilder(w).endCell()
  }

  function u(m) {
    if (m.messages.length > 4) throw Error("Maximum number of messages in a single transfer is 4");
    let w = (0, t.beginCell)().storeUint(m.seqno, 32);
    if (m.seqno === 0)
      for (let ne = 0; ne < 32; ne++) w.storeBit(1);
    else w.storeUint(m.timeout || Math.floor(Date.now() / 1e3) + 60, 32);
    for (let ne of m.messages) w.storeUint(m.sendMode, 8), w.storeRef((0, t.beginCell)().store((0, t.storeMessageRelaxed)(ne)));
    let T = (0, e.sign)(w.endCell().hash(), m.secretKey);
    return (0, t.beginCell)().storeBuffer(T).storeBuilder(w).endCell()
  }
  ...
  function v(m) {
    if (m.messages.length > 4) throw Error("Maximum number of messages in a single transfer is 4");
    let w = (0, t.beginCell)().storeUint(m.walletId, 32);
    if (m.seqno === 0)
      for (let T = 0; T < 32; T++) w.storeBit(1);
    else w.storeUint(m.timeout || Math.floor(Date.now() / 1e3) + 60, 32);
    w.storeUint(m.seqno, 32);
    for (let T of m.messages) w.storeUint(m.sendMode, 8), w.storeRef((0, t.beginCell)().store((0, t.storeMessageRelaxed)(T)));
    return (0, s.signPayload)(m, w, o)
  }
  ...
  function E(m) {
    ...
    w.storeUint(m.seqno, 32), w.storeUint(0, 8);
    for (let T of m.messages) w.storeUint(m.sendMode, 8), w.storeRef((0, t.beginCell)().store((0, t.storeMessageRelaxed)(T)));
    return (0, s.signPayload)(m, w, o)
  }

  function R(m) {
    if (m.actions.length > 255) throw Error("Maximum number of OutActions in a single request is 255");
    if (m.authType === "extension") return (0, t.beginCell)().storeUint(n.WalletContractV5Beta.OpCodes.auth_extension, 32).store((0, r.storeOutListExtendedV5Beta)(m.actions)).endCell();
    const w = (0, t.beginCell)().storeUint(m.authType === "internal" ? n.WalletContractV5Beta.OpCodes.auth_signed_internal : n.WalletContractV5Beta.OpCodes.auth_signed_external, 32).store(m.walletId);
    if (m.seqno === 0)
      for (let T = 0; T < 32; T++) w.storeBit(1);
    else w.storeUint(m.timeout || Math.floor(Date.now() / 1e3) + 60, 32);
    return w.storeUint(m.seqno, 32).store((0, r.storeOutListExtendedV5Beta)(m.actions)), (0, s.signPayload)(m, w, l)
  }
  ...
  function ue(m) {
    ...
    if (m = {
        ...m
      }, m.authType === "extension") return (0, t.beginCell)().storeUint(a.WalletContractV5R1.OpCodes.auth_extension, 32).storeUint(m.queryId ?? 0, 64).store((0, i.storeOutListExtendedV5R1)(m.actions)).endCell();
    m.actions = (0, i.patchV5R1ActionsSendMode)(m.actions, m.authType);
    const w = (0, t.beginCell)().storeUint(m.authType === "internal" ? a.WalletContractV5R1.OpCodes.auth_signed_internal : a.WalletContractV5R1.OpCodes.auth_signed_external, 32).store(m.walletId);
    if (m.seqno === 0)
      for (let T = 0; T < 32; T++) w.storeBit(1);
    else w.storeUint(m.timeout || Math.floor(Date.now() / 1e3) + 60, 32);
    return w.storeUint(m.seqno, 32).store((0, i.storeOutListExtendedV5R1)(m.actions)), (0, s.signPayload)(m, w, l)
  }
  return re
}
Object.defineProperty(Vt, "__esModule", {
...
class xn {
  ...
  createTransfer(e) {
    ...
    return e.sendMode !== null && e.sendMode !== void 0 && (n = e.sendMode), (0, Gi.createWalletTransferV1)({
      seqno: e.seqno,
      sendMode: n,
...
class Bn {
  ...
  createTransfer(e) {
    ...
    return e.sendMode !== null && e.sendMode !== void 0 && (n = e.sendMode), (0, Qi.createWalletTransferV1)({
      seqno: e.seqno,
      sendMode: n,
      secretKey: e.secretKey,
      message: e.message
...
class En {
  ...
  createTransfer(e) {
    ...
    return e.sendMode !== null && e.sendMode !== void 0 && (n = e.sendMode), (0, Yi.createWalletTransferV1)({
      seqno: e.seqno,
      sendMode: n,
      secretKey: e.secretKey,
      message: e.message
...
class Tn {
  ...
  createTransfer(e) {
    ...
    return e.sendMode !== null && e.sendMode !== void 0 && (n = e.sendMode), (0, Ji.createWalletTransferV2)({
      seqno: e.seqno,
      sendMode: n,
      secretKey: e.secretKey,
      messages: e.messages,
...
class Pn {
  static create(e) {
    return new Pn(e.workchain, e.publicKey)
  }
  constructor(e, n) {
    this.workchain = e, this.publicKey = n;
  ...
  createTransfer(e) {
    ...
    return e.sendMode !== null && e.sendMode !== void 0 && (n = e.sendMode), (0, Xi.createWalletTransferV2)({
      seqno: e.seqno,
      sendMode: n,
      secretKey: e.secretKey,
      messages: e.messages,
...
class Sn {
  ...
  createTransfer(e) {
    return (0, eo.createWalletTransferV3)({
      ...e,
...
class Mn {
  static create(e) {
    return new Mn(e.workchain, e.publicKey, e.walletId)
  }
  constructor(e, n, r) {
    this.workchain = e, this.publicKey = n, r != null ? this.walletId = r : this.walletId = 698983191 + e;
  ...
  createTransfer(e) {
    return (0, to.createWalletTransferV3)({
      ...e,
...
class zn {
  ...
  createTransfer(e) {
    return (0, no.createWalletTransferV4)({
      ...e,
...
class In {
  ...
  async getWalletAddress(e, n) {
    return (await e.get("get_wallet_address", [{
      type: "slice",
      cell: (0, ro.beginCell)().storeAddress(n).endCell()
    }])).stack.readAddress()
  }
...
class Mt {
  ...
  addSignature(e, n, r) {
    ...
    if (!(0, or.signVerify)(s, n, r.owners.get(e).slice(0, -1))) throw Error("invalid signature");
    this.signatures[e] = n
  }
  sign(e, n) {
    const r = this.payload.hash();
    return this.signatures[e] = (0, or.sign)(r, n), r
  }
  unionSignatures(e) {
...
class so {
  ...
  build() {
    return ao.MultisigOrder.fromPayload((0, st.beginCell)().storeUint(this.walletId, 32).storeUint(this.queryId, 64).storeBuilder(this.messages).endCell())
  }
  updateQueryId() {
...
class On {
  ...
  static async fromAddress(e, n) {
    ...
    return new On(d, e.workChain, i, o, {
      address: e,
      provider: r,
      client: n.client
    })
  ...
  async sendOrder(e, n, r) {
    ...
    r || (r = this.provider);
    let s = (0, cr.keyPairFromSecretKey)(n).publicKey,
      a = this.getOwnerIdByPubkey(s),
      i = e.toCell(a),
      o = (0, cr.sign)(i.hash(), n);
...
Gt.MultisigWallet = On;
var Qt = {};
Object.defineProperty(Qt, "__esModule", {
  value: !0
});
Qt.ElectorContract = void 0;
const H = z,
  oo = {
    serialize(t, e) {
...
class jn {
  ...
  async getPastElections(e) {
    ...
    for (; r.remaining > 0;) {
      ...
      const d = a.readCell(),
        ...
        v = a.readBigNumber();
      let E = new Map;
      const R = d.beginParse().loadDictDirect(H.Dictionary.Keys.Buffer(32), oo);
      for (const [ue, m] of R) E.set(BigInt("0x" + ue.toString("hex")).toString(10), {
        address: m.address,
        weight: m.weight,
        stake: m.stake
      });
  ...
  async getElectionEntities(e) {
    ...
    const a = s.loadRef().beginParse(),
      ...
      l = a.loadCoins(),
      d = a.loadCoins(),
      u = a.loadDict(H.Dictionary.Keys.Buffer(32), co);
    let v = [];
    if (u)
...
Qt.ElectorContract = jn;
var P = {};
Object.defineProperty(P, "__esModule", {
  value: !0
});
P.configParseMasterAddress = lt;
P.parseValidatorSet = Pa;
P.parseBridge = Sa;
P.configParseMasterAddressRequired = hn;
P.configParse5 = Ma;
P.configParse13 = lo;
P.configParse15 = za;
P.configParse16 = Ia;
...
P.configParse8 = ja;
P.configParse40 = Ua;
P.configParseWorkchainDescriptor = fo;
P.configParse12 = Va;
P.configParseValidatorSet = ve;
P.configParseBridge = xt;
P.configParseGasLimitsPrices = mn;
P.configParseMsgPrices = gn;
P.configParse28 = Da;
P.configParse29 = Na;
P.parseProposalSetup = pn;
P.parseVotingSetup = Wa;
P.loadConfigParamById = go;
P.loadConfigParamsAsSlice = po;
P.parseFullConfig = yo;
const Z = z;
...
function Pa(t) {
  ...
  if (e === 17) {
    const n = t.loadUint(32),
      ...
      s = t.loadUint(16),
      a = t.loadUint(16),
      i = t.loadDictDirect(Z.Dictionary.Keys.Uint(16), dr);
    return {
      timeSince: n,
      timeUntil: r,
      total: s,
    ...
    const n = t.loadUint(32),
      ...
      a = t.loadUint(16),
      i = t.loadUintBig(64),
      o = t.loadDict(Z.Dictionary.Keys.Uint(16), dr);
    return {
      timeSince: n,
      timeUntil: r,
      total: s,
...
function Oa(t) {
  if (!t) throw Error("Invalid config");
  return t.loadDictDirect(Z.Dictionary.Keys.Buffer(4), uo).values()
}
...
function Va(t) {
  if (!t) throw Error("Invalid config");
  const e = t.loadDict(Z.Dictionary.Keys.Uint(32), ho);
  if (e) return e;
...
function Wa(t) {
  ...
  const n = pn(t.loadRef().beginParse()),
    r = pn(t.loadRef().beginParse());
  return {
    normalParams: n,
    criticalParams: r
  }
...
function yo(t) {
  return {
    configAddress: hn(t.get(0)),
    electorAddress: hn(t.get(1)),
    minterAddress: lt(t.get(2)),
    feeCollectorAddress: lt(t.get(3)),
    dnsRootAddress: lt(t.get(4)),
    burningConfig: Ma(t.get(5)),
    globalVersion: ja(t.get(8)),
    workchains: Va(t.get(12)),
    voting: Wa(t.get(11)),
    validators: {
      ...za(t.get(15)),
      ...Ia(t.get(16)),
    ...
    storagePrices: Oa(t.get(18)),
    gasPrices: {
      masterchain: mn(t.get(20)),
      workchain: mn(t.get(21))
    },
    msgPrices: {
    ...
    validatorsPunish: Ua(t.get(40)),
    bridges: {
      ethereum: xt(t.get(71)),
      binance: xt(t.get(72)),
      polygon: xt(t.get(73))
    },
    catchain: Da(t.get(28)),
    consensus: Na(t.get(29))
  }
}
var Be = {};
...
Be.computeStorageFees = bo;
Be.computeFwdFees = Un;
Be.computeGasPrices = vo;
Be.computeExternalMessageFees = _o;
Be.computeMessageForwardFees = wo;
const on = z;
...
function Un(t, e, n) {
  return t.lumpPrice + qa(t.bitPrice * n + t.cellPrice * e)
}
...
function _o(t, e) {
  let n = zt(e);
  return n.bits -= e.bits.length, n.cells -= 1, Un(t, BigInt(n.cells), BigInt(n.bits))
}

function wo(t, e) {
  let n = (0, on.loadMessageRelaxed)(e.beginParse()),
    r = {
      bits: 0,
      cells: 0
    };
  if (n.init) {
    const l = new on.Cell().asBuilder();
    (0, on.storeStateInit)(n.init)(l);
    const d = l.endCell();
    let u = zt(d);
  ...
  let a = Un(t, BigInt(r.cells), BigInt(r.bits)),
