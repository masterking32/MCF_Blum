      ...
      const t = e,
        ...
        c = R(() => {
          ...
          if ((t.task.kind === G.QUEST && t.task.reward.isZero() || t.task.kind === G.GROUP) && "subTasks" in t.task) {
            const $ = ((r = t.task.subTasks) == null ? void 0 : r.reduce((U, x) => U.add(x.reward), new fe(0))) ?? new fe(0),
              T = ((h = t.task.subTasks) == null ? void 0 : h.reduce((U, x) => j(x.status, s.value) ? U.add(x.reward) : U, new fe(0))) ?? new fe(0);
            return `+${ae(T)}/${ae($)} BP`
          }
      ...
      return (o, f) => {
        ...
        return d(), S(c, {
          ...
          default: B(({
            ...
            onClick: p
          }, [n(t) ? (d(), C("div", qa, [(d(!0), C(K, null, W(n(s), (h, $) => le((d(), C("img", {
            key: $,
            src: n(re)(h),
            alt: "Task icon",
            class: "icon",
  ...
  ys = M({
    ...
    setup(e) {
      const l = qe(),
        ...
        }, w = R(() => i.value ? i.value.reduce((y, r) => ([...r.tasks, ...r.tasks.flatMap(T => T.subTasks ?? []), ...r.subSections.flatMap(T => T.tasks ?? [])].filter(T => !j(T.status, o.value[T.id]) && !Ue(T) && T.kind !== G.GROUP).map(T => T.id).forEach(T => y.add(T)), y), new Set).size : 0);
      return (async () => {
        ...
        return d(), C("div", ps, [n(a) ? (d(), S(r, {
          ...
          key: 1
        }, [A("div", fs, [A("span", vs, [ve(P(("t" in g ? g.t : n(_))("earn.title")) + " ", 1), A("sup", null, P(n(w)), 1)])]), A("div", bs, [(d(!0), C(K, null, W(n(i), (T, U) => (d(), S(h, {
          key: U,
