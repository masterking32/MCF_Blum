    ...
    setup(s) {
      return (t, e) => {
        const i = yo,
          n = Ot,
          o = _o;
        return _(), z("div", vl, [t.errorMessage ? (_(), B(i, {
          key: 0,
          "error-message": t.errorMessage
        }, null, 8, ["error-message"])) : t.details && t.totalLabel ? (_(), z("div", gl, [t.details.length ? (_(), B(o, {
          key: 0,
          "text-min-width": 155,
          alignment: m(Lr).TOP
        }, {
          ...
          inner: Y(() => [S("div", bl, [(_(!0), z(dt, null, de(t.details, (r, l) => (_(), z(dt, {
            key: r.label
          }, [S("span", null, A(r.label), 1), l !== t.details.length - 1 ? (_(), z("br", yl)) : at("", !0)], 64))), 128))])]),
          _: 1
        }, 8, ["alignment"])) : at("", !0), S("span", _l, A(t.totalLabel), 1)])) : at("", !0)])
      }
    }
  }),
  xo = ot(wl, [
    ...
    setup(s, {
      ...
      return We(() => {
        ...
        const f = ko,
          ...
          b = wo,
          y = te;
        return _(), z("div", Sl, [S("div", Ml, [m(i).balanceLabel ? (_(), B(f, {
          key: 0,
    ...
    setup(s) {
      ...
      return hl("memepad-jetton-moving-to-dex"), (i, n) => {
        const o = Pr,
          ...
          u = al,
          d = Rr;
        return _(), z("div", Cl, [L(o), S("div", El, [S("div", Tl, [L(r, {
          size: 342,
  ...
  Ul = st({
    ...
    setup(s) {
      ...
      return (i, n) => {
        const o = cl,
          r = Ot;
        return _(), z("div", jl, [S("div", Rl, [L(o, {
          jetton: i.jetton
        }, null, 8, ["jetton"]), S("div", Al, [S("div", Ol, [S("div", Dl, A(i.jetton.ticker), 1), i.jettonInformation.stream.online ? (_(), z("div", Vl, n[2] || (n[2] = [S("div", {
          class: "dot"
        }, null, -1)]))) : at("", !0), i.jettonInformation.inSpotlight ? (_(), z("div", Wl, [L(r, {
          name: "fire",
          class: "icon"
        }), n[3] || (n[3] = S("span", {
          class: "label"
        }, "Spotlight", -1))])) : at("", !0)]), S("div", Nl, A(m(e)), 1)])]), S("div", Bl, [S("button", {
          type: "button",
          class: "reset copy",
          ...
          name: "edit-copy",
          class: "icon"
        }), S("span", Fl, A(("sliceWalletAddress" in i ? i.sliceWalletAddress : m(Ar))(i.jetton.address, 3)), 1)]), S("button", {
          type: "button",
          class: "reset share",
...
const Gl = s => s === ee || Co(s),
  ...
  ia = s => _i(s) && !!s.constructor && /function Object\b/.test(s.constructor.toString()),
  sa = s => _i(s) && typeof s.length < "u" && zo(s.splice);
var w = {
  window: Gl,
  docFrag: Zl,
  object: _i,
...
function na(s) {
  const t = tt.Element,
    e = s.navigator || {};
  it.supportsTouch = "ontouchstart" in s || w.func(s.DocumentTouch) && tt.document instanceof s.DocumentTouch, it.supportsPointerEvent = e.pointerEnabled !== !1 && !!tt.PointerEvent, it.isIOS = /iP(hone|od|ad)/.test(e.platform), it.isIOS7 = /iP(hone|od|ad)/.test(e.platform) && /OS 7[^\d]/.test(e.appVersion), it.isIe9 = /MSIE 9/.test(e.userAgent), it.isOperaMobile = e.appName === "Opera" && it.supportsTouch && /Presto/.test(e.userAgent), it.prefixedMatchesSelector = "matches" in t.prototype ? "matches" : "webkitMatchesSelector" in t.prototype ? "webkitMatchesSelector" : "mozMatchesSelector" in t.prototype ? "mozMatchesSelector" : "oMatchesSelector" in t.prototype ? "oMatchesSelector" : "msMatchesSelector", it.pEventTypes = it.supportsPointerEvent ? tt.PointerEvent === s.MSPointerEvent ? {
    up: "MSPointerUp",
    down: "MSPointerDown",
    over: "mouseover",
    out: "mouseout",
  ...
  } : null, it.wheelEvent = tt.document && "onmousewheel" in tt.document ? "mousewheel" : "wheel"
}
...
function ua(s) {
  ...
  s.usePlugin(ca), e.base.actionChecker = null, e.base.styleCursor = !0, $(e.perAction, {
    manualStart: !1,
    max: 1 / 0,
    maxPerElement: 1,
    allowFrom: null,
  ...
  if (e.prepared.axis = a.lockAxis === "start" ? c[0] : a.lockAxis, c !== "xy" && h !== "xy" && h !== c) {
    ...
    const d = function(f) {
      ...
      if (!p.manualStart && f.testIgnoreAllow(p, u, i)) {
        ...
        if (v && v.name === "drag" && ba(c, f) && $s.validateAction(v, f, u, i, t)) return f
      }
    };
    for (; w.element(u);) {
...
var Sa = {
  id: "auto-start",
  install(s) {
    s.usePlugin($s), s.usePlugin(wa), s.usePlugin(ya)
  }
};
...
function Ta(s, t) {
  return t = t || {
    x: 0,
    y: 0
  }, it.isOperaMobile && Bo(s) ? (fi("screen", s, t), t.x += window.scrollX, t.y += window.scrollY) : fi("page", s, t), t
}

function za(s, t) {
  return t = t || {}, it.isOperaMobile && Bo(s) ? fi("screen", s, t) : fi("client", s, t), t
}
...
function Ra(s) {
  ...
  function l(d, f, p, v) {
    ...
    const b = Si(e, k => k.eventTarget === d),
      y = e[b];
      ...
      for (k = g.length - 1; k >= 0; k--) {
        ...
        if (I.selector === d && I.context === f) {
          ...
          for (let U = W.length - 1; U >= 0; U--) {
            const N = W[U];
            if (N.func === v && Ke(N.options, y)) {
              W.splice(U, 1), W.length || (g.splice(k, 1), l(f, p, c), l(f, p, u, !0)), x = !0;
              break
            }
          }
          if (x) break
  ...
  function c(d, f) {
    ...
    for (; w.element(g);) {
      for (let x = 0; x < b.length; x++) {
        ...
        if (Xt(g, I) && Kt(W, y) && Kt(W, g)) {
          const {
            listeners: U
          } = k;
          v.currentTarget = g;
          for (const N of U) Ke(N.options, p) && N.func(v)
        }
      }
      g = zt(g)
    }
...
function Qa(s) {
  ...
  return t.getPointerAverage = Fo, t.getTouchBBox = $a, t.getTouchDistance = Pa, t.getTouchAngle = La, t.getElementRect = zs, t.getElementClientRect = $o, t.matchesSelector = Xt, t.closest = Io, t.globalEvents = {}, t.version = "1.10.27", t.scope = s, t.use = function(e, i) {
...
function eh(s, t) {
  return s.isInitialized = !0, w.window(t) && To(t), tt.init(t), it.init(t), ds.init(t), s.window = t, s.document = t.document, s.usePlugin(Ga), s.usePlugin(Oa), s
}
...
class Rs {
  ...
  start(t, e) {
    ...
    this.prepareStates(o), this.startEdges = $({}, n.edges), this.edges = $({}, this.startEdges), this.startOffset = nh(n.rect, e), this.startDelta = {
      x: 0,
      y: 0
    };
...
const Ph = {
    ...
    install(s) {
      ...
      t.snappers = $(t.snappers || {}, $h), t.createSnapGrid = t.snappers.grid
    }
  },
  Lh = {
    start(s) {
...
function ic(s) {
  const {
    ...
    options: n,
    offsets: o
  } = i, r = xi(t.interactable, t.element, t.prepared.name), l = $({}, e), a = [];
...
const fc = {
  ...
  install(s) {
    ...
    s.usePlugin(Zo), s.usePlugin(Ph), t.modifiers = Di;
    for (const e in Di) {
      const {
        _defaults: i,
        _methods: n
  ...
  Rc = (s, t) => {
    ...
    const r = et(!1),
      ...
      k = () => {
        var X;
        const E = W(),
          V = Math.ceil(((((X = window.visualViewport) == null ? void 0 : X.width) ?? window.innerWidth) - E) / 2);
        return {
          left: V,
          right: V
        }
      ...
      I = () => {
        const E = document.querySelector(".tabs"),
          ...
          X = (E == null ? void 0 : E.offsetHeight) ?? 0;
        return {
      ...
      U = () => {
        ...
        return Math.ceil((((X = window.visualViewport) == null ? void 0 : X.height) ?? window.innerHeight) - E - V)
      },
      N = () => {
        const E = W(),
          V = U();
      ...
      F = async () => {
        ...
        requestAnimationFrame(async () => {
          D() ? (H(), await ct(), R(`${N()}px`, `${T()}px`)) : j(), await d(n)
        })
      }, K = () => {
        window.addEventListener("resize", F), window.screen && "orientation" in window.screen ? window.screen.orientation.addEventListener("change", Z) : window.addEventListener("orientationchange", Z)
      }, q = () => {
        window.removeEventListener("resize", F), window.screen && "orientation" in window.screen ? window.screen.orientation.removeEventListener("change", Z) : window.removeEventListener("orientationchange", Z)
      }, J = l({
        ratio: x(),
        minHeight: 98,
        minWidth: 174
        ...
        onmove(E) {
          var V, X;
          p.position.x += ((V = E.deltaRect) == null ? void 0 : V.left) ?? 0, p.position.y += ((X = E.deltaRect) == null ? void 0 : X.top) ?? 0, E.target.style.height = `${E.rect.height}px`, E.target.style.transform = `translate(${p.position.x}px, ${p.position.y}px)`, E.target.style.width = `${E.rect.width}px`
        },
        onstart: u,
        onend(E) {
          const V = N(),
            X = T();
          E.rect.width > V || E.rect.height > X ? (E.target.style.height = `${X}px`, E.target.style.width = `${V}px`, d(n).then(() => c(E))) : c(E)
        }
      }, ct = async () => {
        var E, V, X;
        b(), v(), j(), C(), n = (V = (E = a(s.value)) == null ? void 0 : E.draggable(ht)) == null ? void 0 : V.resizable(rt), o = (X = a(t.value)) == null ? void 0 : X.on("doubletap", async wt => {
          D() ? j() : R(`${N()}px`, `${T()}px`), await d(n), wt.preventDefault()
        }), await d(n), K(), r.value = !0
      }, H = () => {
  ...
  Uc = st({
    ...
    setup(s, {
      ...
      const e = s,
        ...
        u = P(() => `https://stream.blum.codes/embed/${e.stream.id}?autoplay=1&loop=1&muted=1&controls=0&coverFitMode=1&ignoreSize=1`),
        d = P(() => h.value ? "media-volume-off" : "media-volume-min"),
        f = g => {
          var x, k;
      ...
      return (g, x) => {
        ...
        return _(), z("div", {
          ...
          ref: r,
          class: "bg"
        }, null, 512), S("div", Dc, [S("div", Vc, [L(k, {
          name: "user-voice",
          class: "icon"
        }), S("span", Wc, A(e.stream.viewers), 1)]), S("div", Nc, [L(k, {
          name: "calendar-clock",
          class: "icon"
    ...
    setup(s) {
      ...
      return (r, l) => {
        const a = Ot,
          ...
          u = te,
          d = mo;
        return _(), z("div", Hc, [S("button", {
          type: "button",
          class: "reset button",
          onClick: i
        }, A(("t" in r ? r.t : m(O))("memepad.jetton.start_stream_button")), 1), L(d, {
          modelValue: m(n),
          "onUpdate:modelValue": l[2] || (l[2] = f => bt(n) ? n.value = f : null)
        }, {
          default: Y(() => [S("div", Jc, [S("div", Xc, A(("t" in r ? r.t : m(O))("memepad.jetton.steam.start_sheet.title")), 1), S("div", Yc, A(("t" in r ? r.t : m(O))("memepad.jetton.steam.start_sheet.subtitle")), 1), S("div", Gc, [m(e).status === "loaded" ? (_(), z("button", {
            key: 0,
            type: "button",
            class: "reset",
            onClick: l[0] || (l[0] = f => ("useCopy" in r ? r.useCopy : m(Vr))().copy(m(e).streamKey))
          }, [S("div", Zc, A(m(e).streamKey), 1), L(a, {
            name: "edit-copy",
            class: "icon"
          })])) : (_(), B(h, {
            key: 1,
    ...
    setup(s) {
      ...
      return (o, r) => {
        ...
        return o.jettonInformation.stream.isBanned ? (_(), B(l, {
          key: 0,
          onOpenRules: n
        })) : o.jettonInformation.stream.online ? (_(), z(dt, {
          key: 1
        }, [m(e) ? (_(), z("button", {
          key: 0,
          type: "button",
    ...
    setup(s) {
      ...
      return (i, n) => {
        ...
        const o = Ne,
          r = Ot,
          l = _o;
        return _(), z("div", iu, [i.isReleased ? at("", !0) : (_(), z("div", su, [S("div", nu, [S("div", ou, [i.total !== void 0 && i.collected !== void 0 || i.percent ? (_(), z(dt, {
          key: 1
        }, [i.percent !== void 0 ? (_(), z("span", ru, A(`${i.percent.toFixed(2)}%`), 1)) : at("", !0), i.total !== void 0 && i.collected !== void 0 ? (_(), z("span", lu, A(`${("formatTon"in i?i.formatTon:m(Ys))(i.collected,{trim:!0})}/${("formatTon"in i?i.formatTon:m(Ys))(i.total,{trim:!0})} TON`), 1)) : at("", !0)], 64)) : (_(), B(o, {
          key: 0,
          class: "skeleton"
        }))]), (a = i.marketDetails) != null && a.statistics ? (_(), z("div", au, [S("div", hu, [L(r, {
          name: "personal",
          class: "icon"
        }), i.marketDetails.statistics.holdersCount ? (_(), z("span", cu, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.statistics.holdersCount, {
          accuracy: 0
        }).full), 1)) : (_(), z("span", uu, "—"))]), S("div", du, [L(r, {
          name: "transfer",
          class: "icon"
        }), i.marketDetails.statistics.transactionsCount ? (_(), z("span", fu, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.statistics.transactionsCount, {
          accuracy: 0
        }).full), 1)) : (_(), z("span", pu, "—"))]), S("div", mu, [i.marketDetails.statistics.marketCap ? (_(), z(dt, {
          key: 0
        }, [S("span", vu, A(("t" in i ? i.t : m(O))("memepad.jetton.stats.market_cap")), 1), S("span", gu, A(`$${("formatCount"in i?i.formatCount:m(Wt))(i.marketDetails.statistics.marketCap).full}`), 1)], 64)) : (_(), z("span", bu, "—"))])])) : (_(), B(l, {
          key: 1,
          text: ("t" in i ? i.t : m(O))("memepad.jetton.market_info_tooltip.text"),
          "text-min-width": 155,
          "text-max-width": 155
        }, {
          default: Y(() => [S("button", yu, [L(r, {
            name: "circle-help",
            class: "icon"
        ...
        }, null, 4)])])), m(e).length ? (_(), z("div", Su, [S("div", Mu, [S("div", ku, A(("t" in i ? i.t : m(O))("memepad.jetton.market_cap")), 1), (h = i.marketDetails) != null && h.marketCap ? (_(), z("div", xu, [n[0] || (n[0] = S("span", {
          class: "dollar"
        }, "$", -1)), S("span", null, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.marketCap).full), 1)])) : (_(), B(o, {
          key: 1,
          class: "skeleton"
        }))]), S("div", Cu, [(_(!0), z(dt, null, de(m(e), c => (_(), z("div", {
          key: c.title,
          class: "item"
        }, [S("span", Eu, A(c.title), 1), c.value === void 0 ? (_(), B(o, {
          key: 0,
          class: "skeleton"
        })) : (_(), z("span", Tu, [typeof c.value == "string" ? (_(), z(dt, {
          key: 0
        }, [Gs(A(c.value), 1)], 64)) : c.value === null ? (_(), z(dt, {
          key: 1
        }, [Gs(" — ")], 64)) : (_(), z(dt, {
          key: 2
        }, [c.value.prefix ? (_(), z("span", zu, A(c.value.prefix), 1)) : at("", !0), S("span", null, A(c.value.value), 1), c.value.postfix ? (_(), z("span", Iu, A(c.value.postfix), 1)) : at("", !0)], 64))]))]))), 128))])])) : at("", !0)])
      }
    }
  }),
  Pu = ot($u, [
...
class wn {
  ...
  Gt(t, e, i, n) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, f = e.L + this.Xt.wi, p = e.B + this.Xt.gi, v = e.A, b = e.I, y = this.zt.Kt, g = e.P, x = i.Mi(r, y), k = Math.ceil(i.xi(r, y)), I = g + f + p, W = e.C + v + b + k + u, U = Math.max(1, Math.floor(c));
    let N = Math.round(I * c);
    N % 2 != U % 2 && (N += 1);
    const T = d > 0 ? Math.max(1, Math.floor(d * h)) : 0,
      D = Math.round(W * h),
      C = Math.round(u * h),
      j = (o = this.Xt.Si) !== null && o !== void 0 ? o : this.Xt.ki,
      R = Math.round(j * c) - Math.floor(.5 * c),
      F = Math.floor(R + U / 2 - N / 2),
      Z = F + N,
      K = n === "right",
      q = K ? a.width - d : d,
      J = K ? l.width - T : T;
    let lt, ht, rt;
    return K ? (lt = J - D, ht = J - C, rt = q - u - v - d) : (lt = J + D, ht = J + C, rt = q + u + v), {
      Qt: K,
      Jt: {
        ii: F,
        li: R,
    ...
    t.useBitmapCoordinateSpace(({
      ...
      if (d.beginPath(), d.moveTo(b, y), d.lineTo(b, x - k), d.arcTo(b, x, b + k, x, k), d.lineTo(g - k, x), d.arcTo(g, x, g, x - k, k), d.lineTo(g, y), d.fill(), v.hi) {
        const I = Math.round(v.ki * f),
          W = y,
          U = Math.round((W + e.T) * p);
        d.fillStyle = v.V;
        const N = Math.max(1, Math.floor(f)),
          T = Math.floor(.5 * f);
        d.fillRect(I - T, W, N, U - W)
      }
    }), t.useMediaCoordinateSpace(({
      context: d
    }) => {
  ...
  K(t) {
    ...
    o !== void 0 && ur(t, e, o, i, n, c, fd), a && function(u, d, f, p, v) {
      ...
      for (let W = p.to - 1; W >= p.from; --W) {
        ...
        if (U) {
          const N = v(u, U);
          N !== x && (g.beginPath(), x !== null && g.fill(), g.fillStyle = N, x = N);
          const T = Math.round(U.nt * b) + k,
            D = U.st * y;
          g.moveTo(T, D), g.arc(T, D, I, 0, 2 * Math.PI)
        }
      }
      g.fill()
    }(t, e, a, i, c)
  ...
  K({
    ...
    for (let r = this.zt.tt.from; r < this.zt.tt.to; ++r) {
      ...
      if (o) {
        if (this.zt.fe) {
          const W = h - g;
          let U = Math.max(v, Math.round(l.ve * i) - a),
            N = U + u - 1;
          N > v + y - 1 && (N = v + y - 1, U = N - u + 1), t.fillRect(W, U, c - W, N - U + 1)
        }
        const x = h + g;
...
class Fs extends Jd {
  constructor(t, e, i, n, o) {
    super(t), this.zt = new Gd, this.Wh = new Bd(this), this.Il = [], this.zl = new Pd(this), this.Ll = null, this.El = null, this.Nl = [], this.Fl = [], this.Wl = null, this.jl = [], this.cn = e, this.Hl = i;
    const r = new Fd(this);
...
class cf {
  constructor(t, e, i, n) {
    this.ro = 0, this.ho = null, this.Ah = null, this.lo = null, this.ao = {
      oo: !1,
      _o: null
    }, this.uo = 0, this.co = 0, this.do = new nt, this.fo = new nt, this.vo = [], this.po = null, this.mo = null, this.bo = null, this.wo = null, this.ba = Rn, this.Mo = Ki(null), this.xo = t, this.cn = e, this.So = i, this.ko = n, this.yo = new Pn(this, 100, this.Co.bind(this), this.To.bind(this))
  }
  Ta() {
    return this.xo
  }
...
class uf {
  constructor(t, e) {
    this.vo = [], this.a_ = new Map, this.ro = 0, this.o_ = 0, this.__ = 1e3, this.po = null, this.u_ = new nt, this.kl = t, this.$i = e, this.c_ = new lf(this);
    const i = e.W();
...
class mf {
  constructor(t, e, i, n) {
    this.o_ = 0, this.ou = null, this._u = [], this.wo = null, this.bo = null, this.uu = new ff, this.cu = new Map, this.du = ue.au(), this.fu = !0, this.vu = new nt, this.pu = new nt, this.mu = new nt, this.bu = null, this.wu = null, this.gu = [], this.cn = e, this.ko = i, this.Mu = e.rightOffset, this.xu = e.barSpacing, this.$i = t, this.U_ = n, this.Su(), this.uu.Q_(e.uniformDistribution)
  }
  W() {
    return this.cn
  }
...
class Zn {
  constructor(t, e, i, n) {
    this.Li = null, this.Lv = null, this.Ev = !1, this.Nv = new De(200), this.Jr = null, this.Fv = 0, this.Wv = !1, this.jv = () => {
      ...
      this.Wv || this.tn.Hv().$t().$h()
    }, this.tn = t, this.cn = e, this.So = e.layout, this.Vc = i, this.Uv = n === "left", this.qv = Qi("normal", n), this.Yv = Qi("top", n), this.Zv = Qi("bottom", n), this.Xv = document.createElement("div"), this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Xv.style.width = "25px", this.Xv.style.left = "0", this.Xv.style.position = "relative", this.Kv = qt(this.Xv, G({
      width: 16,
      height: 16
...
class Hs {
  constructor(t, e) {
    this.Lv = G({
      width: 0,
      height: 0
    }), this.yp = null, this.Cp = null, this.Tp = null, this.Pp = null, this.Rp = !1, this.Dp = new nt, this.Vp = new nt, this.Op = 0, this.Bp = !1, this.Ap = null, this.Ip = !1, this.zp = null, this.Lp = null, this.Wv = !1, this.jv = () => {
...
class Rf {
  constructor(t, e) {
    this.Pm = null, this.Rm = null, this.k = null, this.Dm = !1, this.Lv = G({
      width: 0,
      height: 0
    }), this.Vm = new nt, this.Nv = new De(5), this.Wv = !1, this.jv = () => {
      this.Wv || this.Jd.$t().$h()
    }, this.$v = () => {
      this.Wv || this.Jd.$t().$h()
  ...
  fp(t) {
    ...
    if (t !== 1) {
      ...
      }), this.bp(i), this.Hm(i, Pf)), this.Pm !== null && this.Pm.fp(t), this.Rm !== null && this.Rm.fp(t)
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Gt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
...
const Af = !!ge && !!navigator.userAgentData && navigator.userAgentData.brands.some(s => s.brand.includes("Chromium")) && !!ge && (!((ts = navigator == null ? void 0 : navigator.userAgentData) === null || ts === void 0) && ts.platform ? navigator.userAgentData.platform === "Windows" : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
var ts;
class Of {
  constructor(t, e, i) {
    var n;
    this.Zm = [], this.Xm = 0, this.ro = 0, this.o_ = 0, this.Km = 0, this.Gm = 0, this.Jm = null, this.Qm = !1, this.Dp = new nt, this.Vp = new nt, this.Pc = new nt, this.tb = null, this.ib = null, this.Gd = t, this.cn = e, this.U_ = i, this.Zd = document.createElement("div"), this.Zd.classList.add("tv-lightweight-charts"), this.Zd.style.overflow = "hidden", this.Zd.style.direction = "ltr", this.Zd.style.width = "100%", this.Zd.style.height = "100%", (n = this.Zd).style.userSelect = "none", n.style.webkitUserSelect = "none", n.style.msUserSelect = "none", n.style.MozUserSelect = "none", n.style.webkitTapHighlightColor = "transparent", this.nb = document.createElement("table"), this.nb.setAttribute("cellspacing", "0"), this.Zd.appendChild(this.nb), this.sb = this.eb.bind(this), es(this.cn) && this.rb(!0), this.$i = new _f(this.Dc.bind(this), this.cn, i), this.$t().Zc().l(this.hb.bind(this), this), this.lb = new Rf(this, this.U_), this.nb.appendChild(this.lb.hp());
...
class np {
  constructor(t, e, i, n, o) {
    this._w = new nt, this.Ls = t, this.uw = e, this.cw = i, this.U_ = o, this.dw = n
  }
  S() {
    this._w.S()
  }
...
class op {
  constructor(t, e, i) {
    this.bw = new nt, this.pu = new nt, this.Vm = new nt, this.$i = t, this.kl = t.St(), this.lb = e, this.kl.tc().l(this.ww.bind(this)), this.kl.nc().l(this.gw.bind(this)), this.lb.Em().l(this.Mw.bind(this)), this.U_ = i
  }
  S() {
...
class lp {
  constructor(t, e, i) {
    this.xw = new Map, this.Sw = new Map, this.kw = new nt, this.yw = new nt, this.Cw = new nt, this.Tw = new Uf(e);
...
const ho = "chart-series-type-storage-key",
  zr = s => {
    const t = It("$iBkM1fJygO"),
      ...
      d = g => {
        ...
        const W = g.points.filter(N => I.data.points.some(T => T.timestamp === N.timestamp)),
          U = g.points.filter(N => !I.data.points.some(T => T.timestamp === N.timestamp));
        return {
          type: x,
          interval: k,
          data: {
            points: [...U, ...I.data.points.map(N => W.find(T => T.timestamp === N.timestamp) || N)]
          }
        }
      },
      f = async g => {
        ...
        return Br(g)
      }, g => t.value = d(g), 5e3), "$94wRLOqniR"), v = P(() => {
        var g;
    ...
    return {
      ...
      chart: P(() => t.value),
      chartType: P(() => i.value),
      chartInterval: P(() => e.value),
      chartSeriesType: P(() => n.value),
      chartMarketCap: v,
    ...
    setup(s) {
      const t = s,
        ...
        x = new ResizeObserver(() => {
          var D;
          const T = c.value;
          T && ((D = u.value) == null || D.resize(T.clientWidth, T.clientHeight))
        }),
        k = () => {
          const T = c.value;
          T && x.observe(T)
      ...
      const U = (T, D, C) => {
          var Z;
          const j = (Z = $e().$webApp.dataUnsafe.user) == null ? void 0 : Z.language_code;
          u.value || (u.value = hp(D, {
            localization: {
              timeFormatter: K => {
                const q = lt => String(lt).padStart(2, "0"),
                  J = new Date(K * 1e3);
                return `${q(J.getUTCHours())}:${q(J.getUTCMinutes())}`
              },
              priceFormatter: K => {
                if (g.value === Lt.MARKET_CAP) return `$${Ut(K,{accuracy:0})}`;
                {
                  if (Math.abs(K) < 1e-9) return "$0";
                  const [q, J] = K.toFixed(9).split("."), lt = J[0], rt = J.slice(1).match(/^0+/), ct = rt ? rt[0].length : 0, H = ct > 0 ? String.fromCharCode(8321 + ct) : "", E = J.slice(ct + 1).replace(/0+$/, "").slice(0, 3);
                  return `$${q}.${lt}${H}${E}`
                }
              },
              locale: j
          ...
          const R = T.map(K => ({
            ...
            value: K.price.toNumber()
          })).sort((K, q) => K.time - q.time);
          ...
          }), W = C, u.value.timeScale().subscribeVisibleLogicalRangeChange(K => {
            var ht, rt, ct, H;
            if (!K || K.from >= 0) return;
            const q = (rt = (ht = d.value) == null ? void 0 : ht.dataByIndex(0)) == null ? void 0 : rt.time,
              J = (H = (ct = u.value) == null ? void 0 : ct.timeScale().getVisibleRange()) == null ? void 0 : H.from;
            if (!q || q !== J) return;
            const lt = (() => {
        ...
        N = P(() => {
          ...
          const T = Fr(t.jettonPnl.pnlAbsoluteUSD, {
            ...
            D = ul(t.jettonPnl.pnlPercent);
          return {
            label: `P&L ${T} ${D.formatted}`,
            cls: D.cls
          }
        });
      return he(() => {
        ...
        !T.container || !T.chart || U(T.chart.points, T.container, T.chartSeriesType)
      }, {
        immediate: !0
      }), he(c, T => T && k(), {
        immediate: !0
        ...
        const C = Ot;
        return _(), z("div", cp, [S("div", up, [S("div", {
          class: "section",
          style: rs({
            "grid-template-columns": `repeat(${m(b).length}, 1fr)`
          })
        }, [(_(!0), z(dt, null, de(m(b), j => (_(), z("label", {
          key: j.value,
          class: ae(["item", {
            "is-active": m(n) === j.value
          }])
        }, [Ft(S("input", {
          "onUpdate:modelValue": D[0] || (D[0] = R => bt(g) ? g.value = R : null),
          type: "radio",
          name: "chart-type",
          value: j.value
        }, null, 8, dp), [
          [ls, m(g)]
        ]), S("span", fp, A(j.label), 1)], 2))), 128))], 4), S("div", {
          class: "section",
          style: rs({
            "grid-template-columns": `repeat(${m(v).length}, 1fr)`
          })
        }, [(_(!0), z(dt, null, de(m(v), j => (_(), z("label", {
          key: j.value,
          class: ae(["item", {
            "is-active": m(i) === j.value
          }])
        }, [Ft(S("input", {
          "onUpdate:modelValue": D[1] || (D[1] = R => bt(y) ? y.value = R : null),
          type: "radio",
          name: "chart-interval",
          value: j.value
        }, null, 8, pp), [
          [ls, m(y)]
        ]), S("span", mp, A(j.label), 1)], 2))), 128))], 4), S("button", {
          type: "button",
          class: "reset chart-type",
          onClick: D[2] || (D[2] = j => m(a)(m(o) === m(oe).LINEAR ? m(oe).CANDLESTICK : m(oe).LINEAR))
          ...
          name: "candle-chart",
          class: "icon"
        }))])]), !m(e) || !m(e).data.points.length ? (_(), z("div", vp, [D[4] || (D[4] = S("img", {
          src: Zs,
          class: "lines"
        }, null, -1)), D[5] || (D[5] = S("img", {
          src: Ur,
          class: "empty"
        }, null, -1)), S("div", gp, [D[3] || (D[3] = S("div", {
          class: "dot"
        }, null, -1)), S("div", bp, A(("t" in T ? T.t : m(O))("memepad.jetton.chart.coming_text")), 1)])])) : (_(), z("div", yp, [m(N) ? (_(), z("div", {
          key: 0,
          class: ae(["pnl-label", m(N).cls])
        }, A(m(N).label), 3)) : at("", !0), S("div", {
          ref_key: "container",
          ref: c,
    ...
    setup(s) {
      ...
      return (n, o) => {
        ...
        return _(), z(dt, null, [L(r, {
          ...
          default: Y(() => [S("div", Mp, [S("div", kp, [L(l, {
  ...
  jp = st({
    ...
    setup(s) {
      ...
      return Hr(go, {
        ...
        }, [Ft((_(), z("div", Lp, [Yr(n.$slots, "default", {}, void 0, !0), (_(!0), z(dt, null, de(m(i), a => (_(), B(r, {
          key: a.value,
          label: a.label,
          value: a.value,
          type: s.type
  ...
  Wp = st({
    ...
    setup(s) {
      const t = s,
        ...
        i = P(() => Cs(t.value)),
        n = P(() => t.tradePendings[t.tab]),
        o = P(() => !!(n.value || !t.inputState || t.inputState.loading)),
        r = P(() => o.value ? !1 : !!(i.value.isZero() || !t.inputState || t.inputState.error));
      return (l, a) => {
        var p, v, b, y, g, x;
        const h = ko,
          c = Ne,
          ...
          d = wo,
          f = te;
        return _(), z("div", Ap, [S("div", Op, [l.inputState ? (_(), z(dt, {
          key: 0
        ...
        }, null, 8, ["jetton-shortname", "jetton-address", "details", "input-value", "value-balance", "source"])) : (_(), z("div", {
          key: 1,
  ...
  Up = st({
    ...
    setup(s) {
      ...
      return (n, o) => (_(), z("div", Bp, [(_(!0), z(dt, null, de(m(i), r => (_(), z("button", {
        key: r.label,
        type: "button",
        class: "item reset",
    ...
    setup(s, {
      ...
      const k = P(() => {
        ...
        I = P(() => {
          ...
          if (!C) return;
          const j = e.jettonSdk.getMaxBuyAmount({
            tokenBalance: C
          });
          return ni(j, "TON")
        });
      ...
      const N = Qs(C => Bt().memepad.memepadJettonTradeInputUpdate(C), 300).debouncedFunction;
      he(h, C => N({
        value: C.toNumber(),
        type: n.value
      })), We(() => {
      ...
      function T() {
        const C = P(() => e.jettonSdk.tradeStateControls.getImmediateState({
            operation: n.value,
            amount: h.value
          })),
          j = et(e.jettonSdk.tradeStateControls.getEmptyState({
            operation: n.value
          })),
          R = P(() => C.value || j.value);
        ...
        const Z = () => {
          ...
          },
          {
            ...
            const {
              signal: J
            } = F, lt = await e.jettonSdk.tradeStateControls.getState({
              operation: n.value,
              amount: h.value
            });
            J.aborted || (j.value = lt)
          }, 600);
        return {
          state: R,
          updateInputState: () => {
      ...
      function D() {
        ...
        return async () => {
          ...
          const R = n.value,
            ...
            q = e.jetton.id,
            J = e.jetton.address,
            lt = e.jetton.shortname;
          await (async () => {
            o.value[R] = !0;
            const ht = () => {
                const V = ni(R === Q.BUY ? Z.minReceive : F, K),
                  X = ni(R === Q.BUY ? F : Z.minReceive, "TON"),
                  wt = R === Q.BUY ? O("memepad.jetton.buy.failed_alert", {
              ...
              rt = await (R === Q.BUY ? e.jettonSdk.buyJetton({
                tons: F,
                tradeInfoParams: Z
            ...
            if (rt.err) {
              Zr().error("Memepad jetton trade error", rt.extra), o.value[R] = !1, ht(), j({
                value: F.toFixed(),
                operation: R
              }, {
                source: R === Q.BUY ? fe.BUY : fe.SELL
              });
              return
            }
            i("trade"), W = R === Q.BUY ? e.jettonSdk.getWaitForBuyStatus() : e.jettonSdk.getWaitForSellStatus(), await co(5e3);
            const ct = await W.exec({
                transactionHash: rt.data
              }),
              H = ct ? "success" : "failed";
            if (R === Q.BUY ? C.memepad.memepadJettonBuy({
                status: H,
                jettonId: q,
                jettonShortname: lt,
                jettonAddress: J,
                ...
                jettonShortname: lt,
                jettonAddress: J,
                purchaseAmount: Z.maxReceive.toNumber()
              }), !ct) {
              o.value[R] = !1, ht();
              return
            }
            const E = R === Q.BUY ? O("memepad.jetton.buy.success_alert", {
              ticker: K,
              label: `${qs(F)} TON`
            }) : O("memepad.jetton.sell.success_alert", {
              label: `${Wt(F).full} ${K}`
            });
            ai().success(E), o.value[R] = !1, e.tradeSuccessCallback()
          })()
        }
      }
      return (C, j) => {
        ...
        return _(), B(ct, {
          ...
          "top-center": Y(() => [L(F, {
            modelValue: n.value,
            "onUpdate:modelValue": j[0] || (j[0] = H => n.value = H),
            class: "tabs"
          }, {
            default: Y(() => [L(R, {
          ...
          inner: Y(() => [S("div", Hp, [(_(), B(Z, {
            ref_key: "actionControlsInputComp",
            ref: r,
            key: n.value,
            modelValue: m(c),
            "onUpdate:modelValue": j[1] || (j[1] = H => bt(c) ? c.value = H : null),
            postfix: n.value === "buy" ? "TON" : C.jetton.ticker,
            modifier: x,
            centered: "",
            onBlur: g
          }, null, 8, ["modelValue", "postfix"])), S("div", Jp, [m(k) ? (_(), z("span", Xp, A(m(k)), 1)) : m(k) === void 0 ? (_(), B(K, {
            key: 1,
            class: "skeleton"
          })) : at("", !0)]), S("button", {
            type: "button",
            ...
            onClick: U
          }, [S("span", Yp, A(`${("t"in C?C.t:m(O))("memepad.jetton.slippage_btn")} ${m(l)}%`), 1), L(q, {
            name: "arrow-caret-down",
            class: "icon"
          })])])]),
          "bottom-action": Y(() => [L(ht, {
            ...
            default: Y(() => [C.unlockEnabled ? (_(), B(J, {
              ...
              balances: C.balances,
              onUnlocked: j[2] || (j[2] = H => C.$emit("unlock-success"))
            }, null, 8, ["jetton", "jetton-information", "jetton-sdk", "balances"])) : (_(), B(lt, {
              key: 1,
              value: m(a),
              tab: n.value,
              jetton: C.jetton,
          ...
          "bottom-helpers": Y(() => [L(rt, {
            modelValue: m(u),
            "onUpdate:modelValue": j[3] || (j[3] = H => bt(u) ? u.value = H : null),
            tab: n.value,
            balances: C.balances,
            "token-balance": m(I),
  ...
  nm = st({
    ...
    setup(s, {
      ...
      const e = s,
        ...
        l = P(() => Cs(r.value)),
        a = P(() => l.value.lt(im) ? O("memepad.jetton.slippage.error_message.too_low") : l.value.gt(sm) ? O("memepad.jetton.slippage.error_message.too_high") : ""),
        h = () => {
          if (a.value) return;
      ...
      return bo().initHandler(() => {
        ...
        return _(), B(v, {
          ...
          "bottom-action": Y(() => [S("div", tm, [m(a) ? (_(), B(f, {
            key: 0,
            "error-message": m(a)
          }, null, 8, ["error-message"])) : (_(), z("div", em, A(("t" in c ? c.t : m(O))("memepad.jetton.slippage.text")), 1)), L(p, {
      ...
      return (c, u) => {
        ...
        return _(), z("div", um, [L(b, {
          ...
          default: Y(() => [c.unlockEnabled ? (_(), B(d, {
            ...
            balances: c.balances
          }, null, 8, ["jetton", "jetton-information", "jetton-sdk", "balances"])) : (_(), z(dt, {
            key: 1
          }, [m(o) === "trade" ? (_(), B(f, {
            key: 0,
            modelValue: m(i),
          ...
          }, null, 8, ["modelValue", "trade-pendings", "jetton", "jetton-information", "jetton-bcl-data", "balances", "is-released", "unlock-enabled", "jetton-sdk"])) : at("", !0), m(o) === "slippage" ? (_(), B(p, {
            key: 1,
            "jetton-sdk": c.jettonSdk,
            onSlippageUpdated: u[5] || (u[5] = y => o.value = "trade"),
            onClose: u[6] || (u[6] = y => o.value = "trade")
          }, null, 8, ["jetton-sdk"])) : at("", !0), L(v, {
            "trade-pendings": m(n),
            onClick: r
  ...
  mm = st({
    ...
    setup(s) {
      const t = s,
        e = P(() => t.chartMarketCap ? t.chartMarketCap : t.jettonInformation.marketCap),
        i = P(() => {
          var l, a, h, c;
      ...
      return (n, o) => {
        const r = Kl,
          ...
          c = dl,
          u = fm;
        return _(), z("div", pm, [L(r, {
          jetton: n.jetton,
          "jetton-information": n.jettonInformation,
          "is-released": n.isReleased,
          onShare: o[0] || (o[0] = d => n.$emit("share")),
          onCopy: o[1] || (o[1] = d => n.$emit("copy"))
        }, null, 8, ["jetton", "jetton-information", "is-released"]), L(l, {
          jetton: n.jetton,
          "jetton-information": n.jettonInformation
        }, null, 8, ["jetton", "jetton-information"]), L(a, Qr(tl(m(i))), null, 16), L(h, {
  ...
  jm = st({
    ...
    setup(s) {
      const t = el(),
        e = P(() => t.jetton),
        i = P(() => t.jettonShortname),
        n = P(() => t.jettonInformation),
        o = P(() => t.jettonReactions),
        r = P(() => t.updateJettonReaction),
        l = P(() => il.Address.parse(e.value.address).equals(e.value.masterContractAddress)),
        a = P(() => {
          var T;
          return (T = sl().getters.getUser.value) == null ? void 0 : T.referrerToken
        }),
        {
          addresses: h,
        ...
        g = () => v.update(),
        x = () => v.resetAndUpdateUnlocked(),
        k = P(() => ({
          jettonBalance: d.value ? ni(d.value, e.value.ticker) : void 0,
          tokenBalance: c(e.value.networkType)
        })),
        I = P(() => {
          if (!(!n.value || !h.value)) return ol({
            addresses: h.value,
            jetton: e.value,
      ...
      function N() {
        ...
        function K() {
          const ht = () => !I.value || u.value.status !== "connected" ? ie() : Mt({
            jettonSdk: I.value
          });
          ns(ht, () => {
            j = ji(async () => {
              const H = ht();
              if (!gt(H)) return ie();
              const E = await H.data.jettonSdk.getUserJettonBalance();
              return Mt((gt(E) ? E.data : T.value) || T.value)
            }, H => T.value = H, Z.BALANCE_UPDATE), j.exec()
          });
          const rt = () => !I.value || !n.value || u.value.status !== "connected" || !T.value || !n.value.isReleased ? ie() : Mt({
            jettonSdk: I.value,
            balance: T.value,
          ...
          ns(rt, () => {
            R = ji(async () => {
              if (l.value) return Mt(!1);
              if (D.value === !1) return Mt(!1);
              const H = rt();
              if (!gt(H)) return ie();
              const E = await H.data.jettonSdk.getUnlockEnabled();
              return Mt(gt(E) ? E.data : D.value)
            }, H => D.value = H, Z.UNLOCK_ENABLED_UPDATE), R == null || R.exec()
          });
          const ct = () => !n.value || u.value.status !== "connected" ? ie() : Mt({
            walletAddress: u.value.address,
          ...
          ns(ct, () => {
            F = ji(async () => {
              const H = ct();
              if (!gt(H)) return ie();
              const E = await hi.getMemepadJettonPnl(H.data.jettonShortname, H.data.walletAddress);
              return Mt((gt(E) ? E.data : C.value) || C.value)
            }, H => C.value = H, Z.PNL_UPDATE), F == null || F.exec()
          })
        }
        return {
          init: K,
          destroy: () => {
            j == null || j.destroy(), R == null || R.destroy(), F == null || F.destroy(), T.value = void 0, D.value = void 0, C.value = void 0
          },
          update: () => {
            j == null || j.exec(), R == null || R.exec(), F == null || F.exec()
          },
          resetAndUpdateUnlocked: () => {
            D.value = void 0, R == null || R.exec()
          },
          jettonBalance: P(() => T.value),
          jettonUnlockEnabled: P(() => D.value),
          jettonPnl: P(() => C.value)
        }
      }
      return (T, D) => {
        const C = $r,
          j = Ll,
          R = vm;
        return !m(n) || !m(h) || !m(I) || m(n).status === m(tn).IN_PROGRESS ? (_(), B(C, {
          key: 0
        })) : m(n).status === m(tn).LISTED_TO_DEX ? (_(), B(j, {
          key: 1,
          jetton: m(e),
          ...
          "jetton-sdk": m(I),
          balances: m(k)
        }, null, 8, ["jetton", "jetton-information", "unlock-enabled", "jetton-sdk", "balances"])) : (_(), B(R, {
          key: 2,
          jetton: m(e),
          "jetton-information": m(n),
          "jetton-pnl": m(p),
          "chart-market-cap": m(y),
          ...
          onTradeSuccess: g,
          onUnlockSuccess: x,
          onShare: D[0] || (D[0] = F => T.$emit("share", "trade")),
          onCopy: D[1] || (D[1] = F => T.$emit("copy", "trade"))
