    ...
    setup(U, {
      ...
      return B(l, c => r("update:lock-by-avatar-uploading", !!c)), (c, a) => {
        const e = D,
          n = ce,
          p = x("activate");
        return f(), I("div", de, [k("div", me, [_(e, {
          "override-avatar-url": o(m),
          onOnImageError: a[0] || (a[0] = d => s.value = void 0)
        }, null, 8, ["override-avatar-url"]), Y((f(), I("div", pe, [a[4] || (a[4] = k("img", {
          src: z,
          alt: "Edit icon"
        }, null, -1)), k("span", null, H(("t" in c ? c.t : o(i))("welcome.avatar.edit")), 1)])), [
          [p, () => t.value = !0]
        ])]), _(n, {
          modelValue: o(t),
    ...
    setup(U, {
      ...
      return (e, n) => {
        const p = _e,
          ...
          T = K,
          v = re;
        return f(), I("div", ge, [k("div", {
          class: "title",
          innerHTML: ("t" in e ? e.t : o(i))("welcome.title")
        }, null, 8, Ae), o(a) ? (f(), I("img", ke)) : L("", !0), k("div", Ie, [_(p, {
  ...
  Se = E({
    ...
    setup(U) {
      ...
      return (a, e) => {
        const n = Ee,
          p = le;
        return f(), I("div", Ne, [o(t) === "USERNAME" ? (f(), b(n, {
          key: "onboarding",
          "tg-avatar-url": o(m),
