    ...
    setup(b, {
      ...
      const s = b,
        ...
        f = _({
          ...
          set(e) {
            s.modifiers && (s.modifiers.includes(C.UPPERCASE) && (e = e.toUpperCase()), s.modifiers.includes(C.AMOUNT) && e && (e = G(e, {
      ...
      return (e, d) => {
        ...
        return a(), n("div", {
          ...
          ref_key: "inputRef",
          ref: i,
          "onUpdate:modelValue": d[0] || (d[0] = y => X(f) ? f.value = y : null),
          disabled: e.disabled,
          type: t(A),
          ...
          [j, t(f)],
          [D, P]
        ]), l("div", ie, [g(e.$slots, "postfix", {}, void 0, !0)])], 10, oe), l("div", le, [$(W, {
          name: "change-item-transition"
        }, {
          default: I(() => [e.status === t(c).SUCCESS ? (a(), n("img", ue)) : o("", !0), e.status === t(c).ERROR ? (a(), n("img", de)) : o("", !0), e.status === t(c).LOADING ? (a(), T(V, {
            key: 2,
            type: t(q).DARK,
            size: 20,
            "track-dimmed": "",
