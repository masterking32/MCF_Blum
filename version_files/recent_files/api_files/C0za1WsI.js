...
const _e = {
    ...
    setup(_) {
      ...
      return (o, a) => {
        ...
        return s(), r("div", {
          ...
          name: "edit-copy",
          class: "icon"
        })])), i(l) ? (s(), r("div", $e, v(i(l)), 1)) : S("", !0)]), d("div", Ce, [d("div", be, v(i(m)), 1), d("div", Pe, v(i(n)), 1)])], 2)
      }
    }
  }),
  Le = A(ge, [
  ...
  we = L({
    ...
    setup(_) {
      return (t, l) => {
        const m = Le;
        return s(), r("div", Ae, [(s(!0), r(U, null, R(t.items, n => (s(), V(m, Q({
    ...
    setup(_) {
      ...
      return (o, a) => {
        ...
        return s(), r("div", je, [d("div", He, [(f = o.user) != null && f.avatarUrl ? (s(), r("img", {
          ...
          src: i(b),
          class: "user-avatar-empty"
        }, null, 8, Me))]), d("div", Be, [(k = o.user) != null && k.nickname ? (s(), r("button", {
          key: 0,
          class: "user-name reset",
          type: "button",
          onClick: a[0] || (a[0] = I => u())
        }, [d("div", Se, v(o.user.nickname), 1), h(p, {
          name: "edit-copy",
          class: "icon"
        })])) : (s(), r("button", {
          key: 1,
          ...
          name: "edit-copy",
          class: "icon"
        })])), i(l) ? (s(), r("div", Oe, v(i(l)), 1)) : S("", !0)]), d("div", Te, [d("div", Ee, v(i(m)), 1), d("div", Fe, v(i(n)), 1)])])
      }
    }
  }),
  Ne = A(De, [
      ...
      getHoldersInfo: n => {
        ...
        const o = y(() => {
          ...
          const p = (e, $) => T.Address.parse(e).equals(T.Address.parse($)),
            ...
            I = k.filter(e => e.affiliation !== w.LIQUIDITY_POOL).slice(0, B).reduce((e, $) => e.plus($.percent), new g(0)),
            j = I.gte(E),
            H = k.map(e => {
              const $ = (() => {
                ...
                X = e.affiliation === w.CREATOR,
                Z = e.affiliation === w.LIQUIDITY_POOL,
                ee = f(e.address);
              return {
                holder: e,
                user: $,
  ...
  Qe = L({
    ...
    setup(_) {
      ...
      return (m, n) => {
        ...
        }, null, 8, ["items"]), m.preview ? S("", !0) : (s(), r("div", Ve, [h(o, {
          items: i(l).items
