...
(function(s, l) {
  ...
  function $(e, t) {
    ...
    if (t.domain_specific_validation && (w === "gmail.com" || w === "googlemail.com")) {
      ...
      for (var V = p.split("."), D = 0; D < V.length; D++)
        if (!r.test(V[D])) return !1
    }
    ...
    if (!(0, f.default)(E, {
      ...
      if (!(0, o.default)(E)) {
        ...
        var k = E.slice(1, -1);
        if (k.length === 0 || !(0, o.default)(k)) return !1
      }
    }
    if (g[0] === '"') return g = g.slice(1, g.length - 1), t.allow_utf8_local_part ? x.test(g) : F.test(g);
    for (var U = t.allow_utf8_local_part ? c : _, L = g.split("."), A = 0; A < L.length; A++)
      if (!U.test(L[A])) return !1;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function $(e, t) {
    ...
    E = p.join("@"), g = null, V = null;
    var A = E.match(x);
    if (A ? (b = "", V = A[1], g = A[2] || null) : (p = E.split(":"), b = p.shift(), p.length && (g = p.join(":"))), g !== null && g.length > 0) {
      if (w = parseInt(g, 10), !/^[0-9]+$/.test(g) || w <= 0 || w > 65535) return !1
    } else if (t.require_port) return !1;
    return t.host_whitelist ? S(b, t.host_whitelist) : b === "" && !t.require_host ? !0 : !(!(0, f.default)(b) && !(0, v.default)(b, t) && (!V || !(0, f.default)(V, 6)) || (b = b || V, t.host_blacklist && S(b, t.host_blacklist)))
  }
  s.exports = l.default, s.exports.default = l.default
})(W, W.exports);
var $e = W.exports;
  ...
  De = re({
    ...
    setup(s, {
      ...
      return le(o, () => {
        ...
        const u = ie;
        return q(), I("div", {
          class: me(["kit-textarea", C(_)])
        }, [c.label ? (q(), I("label", {
          key: 0,
          for: C(f)
        }, [M("span", null, Z(c.label), 1), c.errorCaption ? (q(), I("div", Re, [x[3] || (x[3] = M("img", {
          src: de,
          alt: "Warning icon"
        ...
        }, null, 8, ["value", "max-length"])) : P("", !0)], 8, Ae)) : P("", !0), _e(M("textarea", {
          id: C(f),
          ref_key: "textareaRef",
          ref: n,
...
var R = (s => (s.STRING = "STRING", s.TEXTAREA = "TEXTAREA", s))(R || {});
const Ce = re({
    __name: "KitForm",
    props: {
      modelValue: {
      ...
      const i = r => {
          ...
          switch (r.type) {
            ...
            case R.TEXTAREA: {
              ...
              if (r.type === R.STRING && ((u = r.validators) != null && u.url)) {
              ...
              r.type === R.STRING && (($ = r.validators) != null && $.email) && (Se(r.value) || F.push({
                msg: "Invalid email",
                isVisible: !0
              }));
              break
      ...
      return J(() => y("channel", {
        ...
        return q(), I("form", {
          ...
          return q(), I("div", {
            ...
            _: 2
          }, 1040, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur"])) : P("", !0), u.type === C(R).TEXTAREA ? (q(), O(x, ee({
            key: 1,
            modelValue: u.value,
            "onUpdate:modelValue": w => u.value = w,
            ref_for: !0
