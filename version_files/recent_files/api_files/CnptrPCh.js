  ...
  Zn = ot({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        c = async () => {
          if (u.value) return;
          const d = () => ve().bottom.error(R("memepad.jetton.unlock.failed_alert", {
          ...
          await js(2e4), await l.exec(m.data) ? (f("success"), s("unlocked"), ve().bottom.success(R("memepad.jetton.unlock.success_alert", {
            ticker: e.jetton.ticker
      ...
      return Se(() => {
        ...
        const f = Ts,
          ...
          _ = Ps,
          M = Dt;
        return S(), D("div", Hn, [C("div", Yn, [v(i).balanceLabel ? (S(), W(f, {
          key: 0,
          balance: v(i).balanceLabel
        }, null, 8, ["balance"])) : (S(), W(m, {
          key: 1,
          class: "skeleton"
        })), v(i).feesInfo ? (S(), W(w, {
          key: 2,
          ...
          "error-message": (j = v(i).error) == null ? void 0 : j.message
        }, null, 8, ["details", "total-label", "error-message"])) : (S(), W(m, {
          key: 3,
          class: "skeleton"
        }))]), (k = v(i).error) != null && k.notEnoughtTon ? (S(), W(_, {
          key: 0,
          "jetton-shortname": d.jetton.shortname,
          "jetton-address": d.jetton.address
        }, null, 8, ["jetton-shortname", "jetton-address"])) : (S(), W(M, {
          key: 1,
          fill: "",
          icon: "lock-open",
          "icon-align": "left",
          ...
          default: Z(() => [C("div", Gn, J(("t" in d ? d.t : v(R))("memepad.jetton.unlock_btn", {
    ...
    setup(n) {
      ...
      return (i, s) => {
        const o = dn,
          ...
          u = Is,
          d = pn;
        return S(), D("div", qn, [E(o), C("div", Qn, [C("div", to, [E(h, {
          size: 342,
          name: "animations/Clover",
          class: "animation"
        }), E(r, {
          src: v(zs)(i.jetton.iconFileKey),
          size: 80
        }, null, 8, ["src"])]), C("div", eo, J(("t" in i ? i.t : v(R))("memepad.moving_to_dex.title")), 1), C("div", io, J(("t" in i ? i.t : v(R))("memepad.moving_to_dex.subtitle", {
          ticker: i.jetton.ticker
        })), 1)]), E(u, null, {
          default: Z(() => [C("div", so, [E(c, {
            "force-loading": i.unlockEnabled === void 0 && i.isReleased
          }, {
            default: Z(() => [i.unlockEnabled ? (S(), W(l, {
              key: 0,
              jetton: i.jetton,
            ...
            }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (S(), W(a, {
              key: 1,
              label: ("t" in i ? i.t : v(R))("memepad.jetton.share_token_link"),
              fill: "",
              size: v(Wt).LARGE,
          ...
          modelValue: v(e),
          "onUpdate:modelValue": s[2] || (s[2] = p => pt(e) ? e.value = p : null),
  ...
  vo = ot({
    ...
    setup(n) {
      const t = n,
        ...
        i = () => gn().copy(t.jetton.address);
      return (s, o) => {
        var l;
        const h = On,
          r = xs;
        return S(), D("div", ho, [C("div", ro, [E(h, {
          "jetton-modal-controls": s.jettonModalControls,
          jetton: s.jetton
        }, null, 8, ["jetton-modal-controls", "jetton"]), C("div", lo, [C("div", ao, [C("div", co, J(s.jetton.ticker), 1), (l = s.jettonInformation) != null && l.inSpotlight ? (S(), D("div", uo, [E(r, {
          name: "fire",
          class: "icon"
        }), o[1] || (o[1] = C("span", {
          class: "label"
        }, "Spotlight", -1))])) : jt("", !0)]), C("div", fo, J(v(e)), 1)])]), C("div", mo, [C("button", {
          type: "button",
          class: "reset copy",
          onClick: i
        }, [E(r, {
          name: "edit-copy",
          class: "icon"
        }), C("span", po, J(("sliceWalletAddress" in s ? s.sliceWalletAddress : v(bn))(s.jetton.address, 3)), 1)]), C("button", {
          type: "button",
          class: "reset share",
...
var _o = function() {
  function n(t, e, i) {
    var s;
    this._canvasElement = null, this._bitmapSizeChangedListeners = [], this._suggestedBitmapSize = null, this._suggestedBitmapSizeChangedListeners = [], this._devicePixelRatioObservable = null, this._canvasElementResizeObserver = null, this._canvasElement = t, this._canvasElementClientSize = N({
  ...
  return n.prototype.dispose = function() {
    ...
    this._canvasElementClientSize = N(t), this.canvasElement.style.width = "".concat(this._canvasElementClientSize.width, "px"), this.canvasElement.style.height = "".concat(this._canvasElementClientSize.height, "px"), this._invalidateBitmapSize()
    ...
    kt(e, t) || (this.canvasElement.width = t.width, this.canvasElement.height = t.height, this._emitBitmapSizeChanged(e, t))
    ...
    var e = this._suggestedBitmapSize,
      i = N(this._transformBitmapSize(t, this._canvasElementClientSize)),
      s = kt(this.bitmapSize, i) ? null : i;
    e === null && s === null || e !== null && s !== null && kt(e, s) || (this._suggestedBitmapSize = s, this._emitSuggestedBitmapSizeChanged(e, s))
...
function yo(n, t) {
  if (t.type === "device-pixel-content-box") return new _o(n, t.transform, t.options);
...
function Lt(n, t) {
  ...
  return s === null ? null : new Co(s, e, i)
}
/*!
 * @license
...
const To = /^#([0-9a-f])([0-9a-f])([0-9a-f])([0-9a-f])?$/i,
  $o = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?$/i,
  Po = /^rgb\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*\)$/,
  Vo = /^rgba\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d*\.?\d+)\s*\)$/;

function Gt(n) {
  (n = n.toLowerCase()) in Pi && (n = Pi[n]);
  {
    const t = Vo.exec(n) || Po.exec(n);
...
function ut(n, ...t) {
  for (const e of t)
    for (const i in e) e[i] !== void 0 && (typeof e[i] != "object" || n[i] === void 0 || Array.isArray(e[i]) ? n[i] = e[i] : ut(n[i], e[i]));
  return n
}
...
function vt(n) {
  ...
  let e, i, s;
  for (i in e = Array.isArray(t) ? [] : {}, t) t.hasOwnProperty(i) && (s = t[i], e[i] = s && typeof s == "object" ? vt(s) : s);
  return e
}
...
class Io {
  ...
  W() {
    const t = this.k,
      e = this.j(),
      i = this.H();
    return t.P === e && t.D === i || (t.P = e, t.D = i, t.R = Bt(e, i), t.L = 2.5 / 12 * e, t.B = t.L, t.A = e / 12 * t.T, t.I = e / 12 * t.T, t.N = 0), t.V = this.$(), t.O = this.U(), this.k
  }
  $() {
...
class Do {
  ...
  bt(t) {
    const e = this.F.wt();
    e.length !== this.ct.length && (this.dt = e.map(Bo), this.ct = this.dt.map(i => {
      const s = new Wo;
      return s.J(i), s
  ...
  Mt() {
    ...
    e.forEach((o, h) => {
      ...
      const c = g(o.Ct());
      l.lt = a.Tt, l.ht = a.ht, l.et = a.Pt, l.it[0]._t = a._t, l.it[0].st = o.Dt().Rt(a._t, c.Vt), l.rt = (r = a.Ot) !== null && r !== void 0 ? r : this.F.Bt(l.it[0].st / o.Dt().At()), l.it[0].ot = i, l.it[0].nt = s.It(i), l.tt = Ao
    })
  }
}
class No extends dt {
  ...
  K({
    ...
    t.lineCap = "butt", o && r >= 0 && (t.lineWidth = Math.floor(this.zt.Lt.et * i), t.strokeStyle = this.zt.Lt.V, t.fillStyle = this.zt.Lt.V, xt(t, this.zt.Lt.Nt), function(a, c, u, d) {
      a.beginPath();
      const p = a.lineWidth % 2 ? .5 : 0;
      a.moveTo(c + p, u), a.lineTo(c + p, d), a.stroke()
    }(t, r, 0, e.height)), h && l >= 0 && (t.lineWidth = Math.floor(this.zt.Et.et * s), t.strokeStyle = this.zt.Et.V, t.fillStyle = this.zt.Et.V, xt(t, this.zt.Et.Nt), As(t, l, 0, e.width))
  }
}
class Oo {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      nt: 0,
      st: 0
    }, this.Wt = new No(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
...
function Ri(n, t, e, i, s, o, h = 0, r = [0, 0, 0, 0], l = "") {
  ...
  const a = h / 2;
  var c;
  Vi(n, t + a, e + a, i - h, s - h, (c = -a, r.map(u => u === 0 ? u : u + c))), o !== "transparent" && (n.fillStyle = o, n.fill()), l !== "transparent" && (n.lineWidth = h, n.strokeStyle = l, n.closePath(), n.stroke()), n.restore()
}
...
class Ii {
    ...
    const o = this.zt.V,
      ...
      r = t.useBitmapCoordinateSpace(l => {
        ...
        const c = this.Gt(l, e, i, s),
          u = c.Jt;
        return c.Qt ? Ri(a, u.ti, u.ii, u.ni, u.si, h, u.ei, [u.ht, 0, 0, u.ht], h) : Ri(a, u.ri, u.ii, u.ni, u.si, h, u.ei, [0, u.ht, u.ht, 0], h), this.zt.hi && (a.fillStyle = o, a.fillRect(u.ri, u.li, u.ai - u.ri, u.oi)), this.zt._i && (a.fillStyle = e.O, a.fillRect(c.Qt ? u.ui - u.ei : 0, u.ii, u.ei, u.ci - u.ii)), c
      });
  ...
  Gt(t, e, i, s) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, p = e.L + this.Xt.wi, f = e.B + this.Xt.gi, m = e.A, w = e.I, _ = this.zt.Kt, M = e.P, j = i.Mi(h, _), k = Math.ceil(i.xi(h, _)), I = M + p + f, q = e.C + m + w + k + u, y = Math.max(1, Math.floor(c));
    let b = Math.round(I * c);
    b % 2 != y % 2 && (b += 1);
    const T = d > 0 ? Math.max(1, Math.floor(d * a)) : 0,
      U = Math.round(q * a),
      L = Math.round(u * a),
      F = (o = this.Xt.Si) !== null && o !== void 0 ? o : this.Xt.ki,
      x = Math.round(F * c) - Math.floor(.5 * c),
      $ = Math.floor(x + y / 2 - b / 2),
      P = $ + b,
      B = s === "right",
      A = B ? l.width - d : d,
      O = B ? r.width - T : T;
    let V, X, H;
    return B ? (V = O - U, X = O - L, H = A - u - m - d) : (V = O + U, X = O + L, H = A + u + m), {
      Qt: B,
      Jt: {
        ii: $,
        li: x,
...
class Fo extends je {
  ...
  zi(t, e, i) {
    ...
    const h = Ce(s.labelBackgroundColor);
    i.t = h.t, t.V = h.i;
...
class Us {
  ...
  X(t, e) {
    ...
    const i = t.useMediaCoordinateSpace(({
      context: d
    }) => (d.font = e.R, Math.round(e.Wi.xi(d, g(this.zt).Kt, Ko))));
    if (i <= 0) return;
    const s = e.ji,
      o = i + 2 * s,
      h = o / 2,
    ...
    t.useBitmapCoordinateSpace(({
      ...
      const w = Math.round(a * p),
        ...
        j = Math.round(u * f),
        k = Math.round(2 * p);
      if (d.beginPath(), d.moveTo(w, _), d.lineTo(w, j - k), d.arcTo(w, j, w + k, j, k), d.lineTo(M - k, j), d.arcTo(M, j, M, j - k, k), d.lineTo(M, _), d.fill(), m.hi) {
        const I = Math.round(m.ki * p),
          q = _,
          y = Math.round((q + e.T) * f);
        d.fillStyle = m.V;
        const b = Math.max(1, Math.floor(p)),
          T = Math.floor(.5 * p);
        d.fillRect(I - T, q, b, y - q)
      }
    }), t.useMediaCoordinateSpace(({
      context: d
    }) => {
...
class Jo {
  constructor(t, e, i) {
    this.ft = !0, this.Wt = new Us, this.Ft = {
      yt: !1,
      t: "#4c525e",
      V: "white",
      Kt: "",
  ...
  Mt() {
    ...
    const h = Ce(e.labelBackgroundColor);
...
class Xo extends mi {
  constructor(t, e) {
    super(), this.tn = null, this.nn = NaN, this.sn = 0, this.en = !0, this.rn = new Map, this.hn = !1, this.ln = NaN, this.an = NaN, this._n = NaN, this.un = NaN, this.$i = t, this.cn = e, this.dn = new Do(t, this), this.fn = ((s, o) => h => {
      const r = o(),
        l = s();
    ...
    this.bn = new Jo(this, t, i), this.wn = new Oo(this)
  }
  W() {
    return this.cn
  }
  ...
  Tn() {
    const t = this.$i.wt().map(i => i.In().An()).filter(Ro),
      e = t.length === 0 ? null : Math.max(...t);
    this.sn = e !== null ? e : NaN
  }
  Dn(t, e, i) {
    let s = t.get(e);
    return s === void 0 && (s = new Fo(this, e, i), t.set(e, s)), s
  }
}
...
function bt(n, t) {
  if (!mt(n)) return "n/a";
  if (!Zt(t)) throw new TypeError("invalid length");
  if (t < 0 || t > 16) throw new TypeError("invalid length");
  return t === 0 ? n.toString() : ("0000000000000000" + n.toString()).slice(-t)
}
class Le {
  constructor(t, e) {
    if (e || (e = 1), mt(t) && Zt(t) || (t = 100), t < 0) throw new TypeError("invalid base");
  ...
  ls(t) {
    ...
    if (e > 1) {
      ...
      h >= e && (h -= e, i += 1), s = Wi + bt(+h.toFixed(this.os) * this.rs, o)
    } else i = Math.round(i * e) / e, o > 0 && (s = Wi + bt(0, o));
...
function Ks(n, t, e, i, s, o, h) {
  ...
  if (i.to - i.from < 2) {
    ...
    r.moveTo(f.nt * l, f.st * a), r.lineTo(m.nt * l, m.st * a), h(n, u, f, m)
  } else {
    const p = (m, w) => {
      h(n, u, d, w), r.beginPath(), u = m, d = w
    };
    let f = d;
    ...
    for (let m = i.from + 1; m < i.to; ++m) {
      ...
      switch (e) {
        case 0:
          ...
          break;
        case 1:
          r.lineTo(f.nt * l, t[m - 1].st * a), w !== u && (p(w, f), r.lineTo(f.nt * l, t[m - 1].st * a)), r.lineTo(f.nt * l, f.st * a);
          break;
        case 2: {
          const [_, M] = Yo(t, m - 1, m);
          r.bezierCurveTo(_.nt * l, _.st * a, M.nt * l, M.st * a, f.nt * l, f.st * a);
          break
        }
      }
      e !== 1 && w !== u && (p(w, f), r.moveTo(f.nt * l, f.st * a))
...
function Yo(n, t, e) {
  ...
  var o, h;
  return [(o = n[t], h = Ai(Te(n[e], n[i]), Bi), {
    nt: o.nt + h.nt,
    st: o.st + h.st
  }), Te(n[e], Ai(Te(n[s], n[t]), Bi))]
}
...
class Js extends dt {
  ...
  K(t) {
    ...
    if (s === null) return;
    const c = t.context;
    c.lineCap = "butt", c.lineJoin = "round", c.lineWidth = h, xt(c, r), c.lineWidth = 1, Ks(t, i, l, s, o, this.ps.bind(this), Go.bind(null, a))
  }
}
  ...
  bs(t, e) {
    ...
    if (this.ys === void 0 || i === void 0 || i.gs !== s || i.Ms !== o || i.xs !== h || i.Ss !== r || i.fs !== a || i.ks !== l) {
      ...
      if (c.addColorStop(0, s), a != null) {
        const u = si(a * t.verticalPixelRatio / l, 0, 1);
...
class Hs extends dt {
  ...
  K(t) {
    ...
    o !== void 0 && Ks(t, e, o, i, s, c, qo), l && function(u, d, p, f, m) {
      const {
      ...
      for (let q = f.to - 1; q >= f.from; --q) {
        ...
        if (y) {
          const b = m(u, y);
          b !== j && (M.beginPath(), j !== null && M.fill(), M.fillStyle = b, j = b);
          const T = Math.round(y.nt * w) + k,
            U = y.st * _;
          M.moveTo(T, U), M.arc(T, U, I, 0, 2 * Math.PI)
        }
      }
      M.fill()
    }(t, e, l, i, c)
...
function Gs(n, t, e, i, s = 0, o = t.length) {
  let h = o - s;
  for (; 0 < h;) {
    const r = h >> 1,
      l = s + r;
...
class vi {
  ...
  Ys() {
    ...
    const s = this.Ls.Ct();
    s !== null && (this.zs = qs(this.Is, i, this.Ns), this.Ks(t, e, s.Vt), this.Gs())
  }
}
class xe extends vi {
  constructor(t, e) {
...
class eh extends xe {
  constructor(t, e) {
    super(t, e), this.Ws = new fi, this.ee = new Zo, this.re = new Ys, this.Ws.Z([this.ee, this.re])
  }
  ne(t, e, i) {
      ...
      if (o) {
        if (this.zt.fe) {
          ...
          let y = Math.max(m, Math.round(r.ve * i) - l),
            b = y + u - 1;
          b > m + _ - 1 && (b = m + _ - 1, y = b - u + 1), t.fillRect(q, y, c - q, b - y + 1)
        }
        const j = a + M;
        let k = Math.max(m, Math.round(r.pe * i) - l),
          I = k + u - 1;
        I > m + _ - 1 && (I = m + _ - 1, k = I - u + 1), t.fillRect(d + 1, k, j - d, I - k + 1)
      }
    }
  }
  oe(t) {
...
class hh extends xe {
  constructor(t, e) {
    super(t, e), this.Ws = new fi, this.De = new nh, this.Ve = new oh, this.Ws.Z([this.De, this.Ve])
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class rh extends dt {
  ...
  Be(t, e, i) {
    ...
    for (let u = i.from; u < i.to; u++) {
      ...
      const M = _ + l - 1;
      c !== null && (_ = Math.max(c + 1, _), _ = Math.min(_, M));
      const j = M - _ + 1;
      s.fillRect(_, m, j, p - m), s.fillRect(_, f + 1, j, w - f), c = M
    }
  }
  Ie(t) {
  ...
  Ae(t, e, i) {
    ...
    for (let c = i.from; c < i.to; c++) {
      ...
      if (a !== null && (d = Math.max(a + 1, d), d = Math.min(d, p)), this.zt.he * o > 2 * l) Uo(s, d, f, p - d + 1, m - f + 1, l);
      else {
        const w = p - d + 1;
        s.fillRect(d, f, w, m - f + 1)
      }
      a = p
    }
  }
  ze(t, e, i) {
    ...
    for (let a = i.from; a < i.to; a++) {
      ...
      let u = Math.round(Math.min(c.ve, c.pe) * h),
        ...
        p = Math.round(c.nt * o) - Math.floor(.5 * this.le),
        f = p + this.le - 1;
      if (c.ue !== r) {
        const m = c.ue;
        s.fillStyle = m, r = m
...
class lh extends Qs {
  constructor() {
    super(...arguments), this.Ws = new rh
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.be(t, e, i)), i.Hs(t))
  }
...
class $e extends vi {
  constructor(t, e, i) {
    super(t, e, !1), this.wn = i, this.Ws = new ah(this.wn.renderer(), s => {
      const o = t.Ct();
...
class fh extends xe {
  constructor() {
    super(...arguments), this.Ws = new Ys
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class tn {
  constructor(t, e, i) {
    this._r = t, this.lr = new Qt(50), this.ur = e, this.F = i, this.j = -1, this.Wt = new ph(this.lr)
  }
  gt() {
...
class vh extends dt {
  ...
  K({
    ...
    o < 0 || o > e.height || (t.lineCap = "butt", t.strokeStyle = this.zt.V, t.lineWidth = Math.floor(this.zt.et * i), xt(t, this.zt.Nt), As(t, o, 0, e.width))
  }
}
class bi {
  constructor(t) {
...
class _h {
  constructor(t) {
    this.Wt = new gh, this.ft = !0, this.Er = !0, this.Nr = performance.now(), this.Fr = this.Nr - 1, this.Wr = t
  }
  jr() {
...
function Jt(n, t) {
  return Xs(Math.min(Math.max(n, 12), 30) * t)
}
...
function yh(n, t, e, i, s, o) {
  return sn(t, e, i, s, o)
}
class Mh extends dt {
  constructor() {
    super(...arguments), this.zt = null, this.lr = new Qt, this.j = -1, this.H = "", this.Jr = ""
  }
  J(t) {
    this.zt = t
  }
  ar(t, e) {
    this.j === t && this.H === e || (this.j = t, this.H = e, this.Jr = Bt(t, e), this.lr.ir())
  }
  br(t, e) {
  ...
  K({
    ...
    if (this.zt !== null && this.zt.tt !== null) {
      ...
      for (let h = this.zt.tt.from; h < this.zt.tt.to; h++) {
        ...
        r.Kt !== void 0 && (r.Kt.Hi = this.lr.xi(t, r.Kt.th), r.Kt.At = this.j, r.Kt.nt = r.nt - r.Kt.Hi / 2), Sh(r, t, e, i)
      }
    }
  }
}
...
function Ch(n, t, e) {
  return !(n.Kt === void 0 || ! function(i, s, o, h, r, l) {
    ...
    switch (i.ih) {
      case "arrowDown":
      case "arrowUp":
        return yh(0, i.nt, i.st, i.Xs, s, o);
      case "circle":
        return function(h, r, l, a, c) {
          const u = 2 + te("circle", l) / 2,
            d = h - a,
            p = r - c;
          return Math.sqrt(d * d + p * p) <= u
        }(i.nt, i.st, i.Xs, s, o);
      case "square":
        return sn(i.nt, i.st, i.Xs, s, o)
    }
  }(n, t, e)
}

function kh(n, t, e, i, s, o, h, r, l) {
  const a = mt(e) ? e : e.xe,
    c = mt(e) ? e : e.ge,
    u = mt(e) ? e : e.Me,
  ...
  switch (n.Xs = p, t.position) {
    ...
    case "aboveBar":
      return n.st = h.Rt(c, l) - f - i.nh, n.Kt !== void 0 && (n.Kt.st = n.st - f - .6 * s, i.nh += 1.2 * s), void(i.nh += p + o);
    case "belowBar":
      return n.st = h.Rt(u, l) + f + i.sh, n.Kt !== void 0 && (n.Kt.st = n.st + f + o + .6 * s, i.sh += 1.2 * s), void(i.sh += p + o)
  }
  t.position
}
class jh {
  constructor(t, e) {
    this.ft = !0, this.eh = !0, this.rh = !0, this.hh = null, this.ah = null, this.Wt = new Mh, this.Wr = t, this.$i = e, this.zt = {
      it: [],
      tt: null
    }
  }
  ...
  oh() {
    ...
    for (let c = this.zt.tt.from; c < this.zt.tt.to; c++) {
      ...
      const p = this.Wr.fh(u.time);
      p !== null && kh(d, u, p, a, s.fontSize, l, t, e, h.Vt)
    }
    this.ft = !1
  }
}
...
class nt {
  ...
  ts(t) {
    return t === null ? this : new nt(Ki(Math.min, this.Th(), t.Th(), -1 / 0), Ki(Math.max, this.Ph(), t.Ph(), 1 / 0))
  }
  Dh(t) {
  ...
  static Bh(t) {
    return t === null ? null : new nt(t.minValue, t.maxValue)
  }
}
class ye {
  constructor(t, e) {
  ...
  static Bh(t) {
    return t === null ? null : new ye(nt.Bh(t.priceRange), t.margins)
  }
}
class xh extends bi {
  constructor(t, e) {
...
class Eh extends je {
  ...
  zi(t, e, i) {
    ...
    const a = Ce(s.axisLabelColor || s.color);
    i.t = a.t;
...
class Th {
  constructor(t, e) {
    this.Wr = t, this.cn = e, this.Wh = new xh(t, this), this._r = new Eh(t, this), this.jh = new tn(this._r, t, t.$t())
  }
  Hh(t) {
    ut(this.cn, t), this.bt(), this.Wr.$t().$h()
  }
  W() {
    return this.cn
  }
...
const Ph = {
  ...
  Candlestick: (n, t, e, i) => {
    ...
    const r = t.upColor,
      ...
      d = t.wickDownColor,
      p = g(n(e, i)),
      f = Vt(p.Vt[0]) <= Vt(p.Vt[3]);
    return {
      ue: (s = p.V) !== null && s !== void 0 ? s : f ? r : l,
      Ee: (o = p.Ot) !== null && o !== void 0 ? o : f ? a : c,
      Le: (h = p.Zh) !== null && h !== void 0 ? h : f ? u : d
    }
  },
  Custom: (n, t, e, i) => {
    var s;
...
class Vh {
  constructor(t) {
    this.Xh = (e, i) => i !== void 0 ? i.Vt : this.Wr.In().Kh(e), this.Wr = t, this.Gh = Ph[t.Jh()]
  }
  Hs(t, e) {
...
class Rh {
  ...
  al(t, e, i) {
    ...
    let s = null;
    for (const o of i) s = re(s, this.ol(t, e, o));
    return s
  }
  J(t) {
  ...
  dl(t) {
    return ie(this.Qh, t, (e, i) => e.se < i)
  }
  fl(t) {
    return Zs(this.Qh, t, (e, i) => e.se > i)
  }
  vl(t, e, i) {
    let s = null;
    for (let o = t; o < e; o++) {
  ...
  ol(t, e, i) {
    ...
    const o = g(this.sl()),
      ...
      l = Math.min(e, h),
      a = Math.ceil(r / gt) * gt,
      c = Math.max(a, Math.floor(l / gt) * gt);
    {
      const d = this.dl(r),
        p = this.fl(Math.min(l, a, e));
      s = re(s, this.vl(d, p, i))
    }
    let u = this.tl.get(i);
    u === void 0 && (u = new Map, this.tl.set(i, u));
    for (let d = Math.max(a + 1, r); d < c; d += gt) {
      const p = Math.floor(d / gt);
      let f = u.get(p);
      if (f === void 0) {
        const m = this.dl(p * gt),
          w = this.fl((p + 1) * gt - 1);
        f = this.vl(m, w, i), u.set(p, f)
      }
      s = re(s, f)
    } {
      const d = this.dl(c),
...
class Wh {
  constructor(t, e) {
    this.Wt = new Us, this.Sl = t, this.kl = e
  }
  gt() {
...
class gi extends $h {
  constructor(t, e, i, s, o) {
    super(t), this.zt = new Rh, this.Wh = new zh(this), this.Il = [], this.zl = new bh(this), this.Ll = null, this.El = null, this.Nl = [], this.Fl = [], this.Wl = null, this.jl = [], this.cn = e, this.Hl = i;
    const h = new Lh(this);
    this.rn = [h], this.jh = new tn(h, this, t), i !== "Area" && i !== "Line" && i !== "Baseline" || (this.Ll = new _h(this)), this.$l(), this.Ul(o)
  }
  S() {
  ...
  $s() {
    return this.El !== null || (this.El = new Vh(this)), this.El
  }
  W() {
    return this.cn
  }
  Hh(t) {
    ...
    e !== void 0 && e !== this.cn.priceScaleId && this.$t().Zl(this, e), ut(this.cn, t), t.priceFormat !== void 0 && (this.$l(), this.$t().Xl()), this.$t().Kl(this), this.$t().Gl(), this.wn.bt("options")
  }
  J(t, e) {
  ...
  Pn() {
    ...
    return t.push(...e), Ve(this.jl, Re, "normal", t), t
  }
  _a() {
    return this.ua(Re, "bottom")
  }
  ca(t) {
    return this.ua(Dh, t)
  }
  ...
  Sa(t) {
    this.jl.push(new Ah(t, this))
  }
  ka(t) {
    this.jl = this.jl.filter(e => e.Vl() !== t)
  }
  ya() {
    if (this.wn instanceof $e) return t => this.wn.Fe(t)
  }
  Ca() {
    if (this.wn instanceof $e) return t => this.wn.We(t)
  }
  oa() {
    return !ze(this.Dt().Ta())
  }
  va(t, e) {
    if (!Zt(t) || !Zt(e) || this.zt.Ni()) return null;
    const i = this.Hl === "Line" || this.Hl === "Area" || this.Hl === "Baseline" || this.Hl === "Histogram" ? [3] : [2, 1],
      s = this.zt.al(t, e, i);
    let o = s !== null ? new nt(s.pl, s.ml) : null;
    ...
    return this.jl.forEach(r => {
      ...
      if (l != null && l.priceRange) {
        const p = new nt(l.priceRange.minValue, l.priceRange.maxValue);
        o = o !== null ? o.ts(p) : p
      }
      var a, c, u, d;
  ...
  $l() {
    switch (this.cn.priceFormat.type) {
      case "custom":
        ...
        break;
      case "volume":
        this.ba = new Ho(this.cn.priceFormat.precision);
        break;
      case "percent":
        this.ba = new Fs(this.cn.priceFormat.precision);
        break;
      default: {
        const t = Math.pow(10, this.cn.priceFormat.precision);
        this.ba = new Le(t, this.cn.priceFormat.minMove * t)
      }
    }
  ...
  Ul(t) {
    switch (this.dn = new jh(this, this.$t()), this.Hl) {
      case "Bar":
      ...
      case "Line":
        ...
        break;
      case "Custom":
        this.wn = new $e(this, this.$t(), st(t));
        break;
      case "Area":
  ...
  Va(t, e, i) {
    ...
    const r = o.Rt(t, h),
      l = i.Oa().filter(c => c instanceof gi).reduce((c, u) => {
        ...
        const d = u.Dt(),
          p = u.In();
        if (d.Ni() || !p.Xr(e)) return c;
        const f = p.Kh(e);
        if (f === null) return c;
        const m = Vt(u.Ct());
        return c.concat([d.Rt(f.Vt[3], m.Vt)])
      }, []);
...
class Fh {
  constructor(t) {
    this.Wt = new Uh, this.ft = !0, this.tn = t
  }
  bt() {
    this.ft = !0
  }
...
class Be {
  ...
  Za(t, e, i) {
    ...
    let o = Math.pow(10, Math.max(0, Math.ceil(Math.log10(t - e)))),
      ...
      r = this.qa[0];
    for (;;) {
      const u = he(o, s, 1e-14) && o > s + 1e-14,
        d = he(o, i * r, 1e-14),
        p = he(o, 1, 1e-14);
      if (!(u && d && p)) break;
    ...
    if (o <= s + 1e-14 && (o = s), o = Math.max(1, o), this.Ya.length > 0 && (l = o, a = 1, c = 1e-14, Math.abs(l - a) < c))
      for (h = 0, r = this.Ya[0]; he(o, i * r, 1e-14) && o > s + 1e-14;) o /= r, r = this.Ya[++h % this.Ya.length];
    var l, a, c;
    return o
  }
}
class Xi {
  ...
  Za(t, e) {
    ...
    const i = this.Li.At(),
      s = (t - e) * this.Ja() / i,
      o = new Be(this.Ua, [2, 2.5, 2]),
      h = new Be(this.Ua, [2, 2, 2.5]),
      r = new Be(this.Ua, [2.5, 2, 2]),
      l = [];
  ...
  Qa() {
    ...
    let f = null,
      m = 0;
    for (let w = a - d; w > c; w -= u) {
      const _ = this.Ga(w, e, !0);
      f !== null && Math.abs(_ - f) < this.Ja() || _ < r || _ > l || (m < this.Xa.length ? (this.Xa[m].La = _, this.Xa[m].no = t.so(w)) : this.Xa.push({
        La: _,
        no: t.so(w)
      }), m++, f = _, t.eo() && (u = this.Za(w * p, c)))
    }
    this.Xa.length = m
  }
  ja() {
...
class Hh {
  constructor(t, e, i, s) {
    this.ro = 0, this.ho = null, this.Ah = null, this.lo = null, this.ao = {
      oo: !1,
      _o: null
    }, this.uo = 0, this.co = 0, this.do = new Y, this.fo = new Y, this.vo = [], this.po = null, this.mo = null, this.bo = null, this.wo = null, this.ba = Gi, this.Mo = We(null), this.xo = t, this.cn = e, this.So = i, this.ko = s, this.yo = new Xi(this, 100, this.Co.bind(this), this.To.bind(this))
  }
  Ta() {
    return this.xo
  }
  ...
  Hh(t) {
    if (ut(this.cn, t), this.Pa(), t.mode !== void 0 && this.Po({
        yr: t.mode
  ...
  Po(t) {
    ...
    }(this.Ah, this.Mo) ? (i = le(this.Ah, this.Mo), i !== null && this.Bo(i)) : this.cn.autoScale = !0), t.yr === 1 && t.yr !== e.yr && (i = Ot(this.Ah, this.Mo), i !== null && this.Bo(i));
  ...
  Rt(t, e) {
    return this.gh() ? t = Rt(t, e) : this.Vo() && (t = Xt(t, e)), this.To(t, e)
  }
  Qs(t, e, i) {
    this.Fo();
    const s = this.No(),
  ...
  me(t, e, i) {
    ...
    for (let f = u; f < d; f++) {
      ...
      let w = m.we,
        ...
        M = m.Me,
        j = m.xe;
      p !== null && (w = p(m.we, e), _ = p(m.ge, e), M = p(m.Me, e), j = p(m.xe, e));
      let k = s + c * (w - h),
        I = a ? k : this.ro - 1 - k;
      m.ve = I, k = s + c * (_ - h), I = a ? k : this.ro - 1 - k, m.ce = I, k = s + c * (M - h), I = a ? k : this.ro - 1 - k, m.de = I, k = s + c * (j - h), I = a ? k : this.ro - 1 - k, m.pe = I
    }
  }
  pn(t, e) {
    const i = this.Co(t, e);
  ...
  $o() {
    ...
    return t = on(t), this.po = t, this.po
  }
  Uo(t) {
  ...
  Pa() {
    ...
    const t = this.s_();
    let e = 100;
    t !== null && (e = Math.round(1 / t.pa())), this.ba = Gi, this.gh() ? (this.ba = Yi, e = 100) : this.Vo() ? (this.ba = new Le(100, 1), e = 100) : t !== null && (this.ba = t.ma()), this.yo = new Xi(this, e, this.Co.bind(this), this.To.bind(this)), this.yo.Qa()
  }
  qo() {
    this.po = null
  }
  ...
  h_() {
    ...
    if (s === this.uo && o === this.co || (this.uo = s, this.co = o, this.mo = null, this.Ro()), e !== null) {
      if (e.Th() === e.Ph()) {
        ...
        this.eo() && (e = le(e, this.Mo)), e = new nt(e.Th() - a, e.Ph() + a), this.eo() && (e = Ot(e, this.Mo))
      }
      if (this.eo()) {
        const l = le(e, this.Mo),
          a = We(l);
        if (h = a, r = this.Mo, h.Ha !== r.Ha || h.$a !== r.$a) {
          const c = this.lo !== null ? le(this.lo, this.Mo) : null;
          this.Mo = a, e = Ot(l, a), c !== null && (this.lo = Ot(c, a))
        }
      }
      this.Bo(e)
    } else this.Ah === null && (this.Bo(new nt(-.5, .5)), this.Mo = We(null));
    var h, r;
    this.ao.oo = !0
  }
  jo() {
    return this.gh() ? Rt : this.Vo() ? Xt : this.eo() ? t => Me(t, this.Mo) : null
  }
  l_(t, e, i) {
...
class Yh {
  constructor(t, e) {
    this.vo = [], this.a_ = new Map, this.ro = 0, this.o_ = 0, this.__ = 1e3, this.po = null, this.u_ = new Y, this.kl = t, this.$i = e, this.c_ = new Kh(this);
    const i = e.W();
  ...
  Yo(t) {
    const e = this.vo.indexOf(t);
    Mt(e !== -1, "removeDataSource: invalid data source"), this.vo.splice(e, 1);
    const i = g(t.Dt()).Ta();
    if (this.a_.has(i)) {
  ...
  $o() {
    return this.po === null && (this.po = on(this.vo)), this.po
  }
  F_() {
    return this.u_
  }
  ...
  C_(t, e, i) {
    let s = this.b_(e);
    if (s === null && (s = this.f_(e, this.$i.W().overlayPriceScales)), this.vo.push(t), !ze(e)) {
  ...
  f_(t, e) {
    const i = Object.assign({
      ...
      s = new Hh(t, i, this.$i.W().layout, this.$i.W().localization);
...
class Yt {
  constructor(t, e) {
    Mt(t <= e, "right should be >= left"), this.Z_ = t, this.X_ = e
  }
  Vs() {
    return this.Z_
  }
...
class Zh {
  ...
  iu(t) {
    ...
    const e = [];
    this.G_.forEach((i, s) => {
      t <= i[0].index ? e.push(s) : i.splice(ie(i, t, o => o.index < t), 1 / 0)
    });
    ...
    for (const i of Array.from(this.G_.keys()).sort((s, o) => o - s)) {
      ...
      for (let u = 0; u < l; u++) {
        ...
        for (; h < o;) {
          ...
          h++, e.push(f), c = m, a = 1 / 0
        }
        if (a - p >= t && p - c >= t) e.push(d), c = p;
...
class Qh {
  constructor(t, e, i, s) {
    this.o_ = 0, this.ou = null, this._u = [], this.wo = null, this.bo = null, this.uu = new Zh, this.cu = new Map, this.du = It.au(), this.fu = !0, this.vu = new Y, this.pu = new Y, this.mu = new Y, this.bu = null, this.wu = null, this.gu = [], this.cn = e, this.ko = i, this.Mu = e.rightOffset, this.xu = e.barSpacing, this.$i = t, this.U_ = s, this.Su(), this.uu.Q_(e.uniformDistribution)
  }
  W() {
    return this.cn
  }
  ku(t) {
    ut(this.ko, t), this.yu(), this.Su()
  }
  Hh(t, e) {
    var i;
    ut(this.cn, t), this.cn.fixLeftEdge && this.Cu(), this.cn.fixRightEdge && this.Tu(), t.barSpacing !== void 0 && this.$i.Gn(t.barSpacing), t.rightOffset !== void 0 && this.$i.Jn(t.rightOffset), t.minBarSpacing !== void 0 && this.$i.Gn((i = t.barSpacing) !== null && i !== void 0 ? i : this.xu), this.yu(), this.Su(), this.mu.m()
  }
  mn(t) {
    var e, i;
  ...
  Da(t, e) {
    ...
    const i = ie(this._u, this.U_.key(t), (s, o) => this.U_.key(s.time) < o);
  ...
  ja() {
    ...
    for (const f of r) {
      ...
      p < this.gu.length ? (m = this.gu[p], m.coord = this.It(f.index), m.label = this.$u(f), m.weight = f.weight) : (m = {
        ...
        label: this.$u(f),
        weight: f.weight
      }, this.gu.push(m)), this.xu > e / 2 && !c ? m.needAlignCoordinate = !1 : m.needAlignCoordinate = u && f.index <= l || d && f.index >= a, p++
    }
  ...
  Go(t) {
    ...
    const e = si(this.o_ - t, 0, this.o_),
      i = si(this.o_ - g(this.bo), 0, this.o_);
  ...
  Pu() {
    if (!this.fu) return;
    if (this.fu = !1, this.Ni()) return void this.oc(It.au());
    const t = this.Lu(),
      e = this.o_ / this.xu,
      i = this.Mu + t,
      s = new Yt(i - e + 1, i);
  ...
  $u(t) {
    ...
    return e === void 0 && (e = new Gh(i => this.dc(i), this.U_), this.cu.set(t.weight, e)), e.q_(t)
  }
  dc(t) {
...
class ir {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      gc: "center",
      Mc: "center"
    }, this.Wt = new er(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
  ...
  Mt() {
    ...
    e.yt = t.visible, e.yt && (e.V = t.color, e.Mc = t.horzAlign, e.gc = t.vertAlign, e.mc = [{
      Kt: t.text,
      R: Bt(t.fontSize, t.fontFamily, t.fontStyle),
      wc: 1.2 * t.fontSize,
      xc: 0,
      Yu: 0
    }])
...
class nr {
  constructor(t, e, i) {
    this.kc = [], this.yc = [], this.o_ = 0, this.Cc = null, this.Tc = new Y, this.Pc = new Y, this.Rc = null, this.Dc = t, this.cn = e, this.U_ = i, this.Vc = new Io(this), this.kl = new Qh(this, e.timeScale, this.cn.localization, i), this.vt = new Xo(this, e.crosshair), this.Oc = new Oh(e.crosshair), this.Bc = new sr(this, e.watermark), this.Ac(), this.kc[0].M_(2e3), this.Ic = this.zc(0), this.Lc = this.zc(1)
  }
  Xl() {
    this.Ec(tt.es())
  }
  ...
  Hh(t) {
    ut(this.cn, t), this.kc.forEach(e => e.m_(t)), t.timeScale !== void 0 && this.kl.Hh(t.timeScale), t.localization !== void 0 && this.kl.ku(t.localization), (t.leftPriceScale || t.rightPriceScale) && this.Tc.m(), this.Ic = this.zc(0), this.Lc = this.zc(1), this.Xl()
  }
  Hc(t, e) {
  ...
  fd(t) {
    const e = this.cr(t),
      i = this.yc.indexOf(t);
    Mt(i !== -1, "Series not found"), this.yc.splice(i, 1), g(e).Yo(t), t.S && t.S()
  }
  Zl(t, e) {
    const i = g(this.cr(t));
    i.Yo(t);
  ...
  Bt(t) {
    ...
    const s = function(o, h, r) {
      const [l, a, c, u] = Gt(o), [d, p, f, m] = Gt(h), w = [lt(l + r * (d - l)), lt(a + r * (p - a)), lt(c + r * (f - c)), Ds(u + r * (m - u))];
...
function or(n, t, e) {
  return t.replace(/yyyy/g, (i => bt(ss(i), 4))(n)).replace(/yy/g, (i => bt(ss(i) % 100, 2))(n)).replace(/MMMM/g, ((i, s) => new Date(i.getUTCFullYear(), i.getUTCMonth(), 1).toLocaleString(s, {
    month: "long"
  }))(n, e)).replace(/MMM/g, ((i, s) => new Date(i.getUTCFullYear(), i.getUTCMonth(), 1).toLocaleString(s, {
    month: "short"
  }))(n, e)).replace(/MM/g, (i => bt((s => s.getUTCMonth() + 1)(i), 2))(n)).replace(/dd/g, (i => bt((s => s.getUTCDate())(i), 2))(n))
}
class rn {
...
class hr {
  ...
  q_(t) {
    return this.Md.replace("%h", bt(t.getUTCHours(), 2)).replace("%m", bt(t.getUTCMinutes(), 2)).replace("%s", bt(t.getUTCSeconds(), 2))
  }
}
const rr = {
  xd: "yyyy-MM-dd",
...
class lr {
  constructor(t = {}) {
    const e = Object.assign(Object.assign({}, rr), t);
    this.Cd = new rn(e.xd, e.yd), this.Td = new hr(e.Sd), this.Pd = e.kd
  }
  q_(t) {
...
function De(n) {
  let t = n;
  if (ee(n) && (t = wi(n)), !ni(t)) throw new Error("time must be of type BusinessDay");
...
function hs(n) {
  if (!hn(n)) throw new Error("time must be of type isUTCTimestamp");
  return {
    Vd: n
  }
}
...
class ls {
  ...
  createConverterToInternalObj(t) {
    return g(function(e) {
      return e.length === 0 ? null : ni(e[0].time) || ee(e[0].time) ? De : hs
    }(t))
  }
  key(t) {
  ...
  convertHorzItemToInternal(t) {
    return hn(e = t) ? hs(e) : ni(e) ? De(e) : De(wi(e));
    var e
  }
  updateFormatter(t) {
    if (!this.cn) return;
    const e = t.dateFormat;
    this.cn.timeScale.timeVisible ? this.Bd = new lr({
      xd: e,
      Sd: this.cn.timeScale.secondsVisible ? "%h:%m:%s" : "%h:%m",
      kd: "   ",
      yd: t.locale
    }) : this.Bd = new rn(e, t.locale)
  }
  formatHorzItem(t) {
    const e = t;
  ...
  fillWeightsForPoints(t, e) {
    (function(i, s = 0) {
      ...
      for (let l = s; l < i.length; ++l) {
        ...
        h !== null && (a.timeWeight = os(c, h)), r += a.time.Vd - (o || a.time.Vd), o = a.time.Vd, h = c
      }
      if (s === 0 && i.length > 1) {
...
function as() {
  return !!At && window.navigator.userAgent.toLowerCase().indexOf("firefox") > -1
}

function Ne() {
  return !!At && /iPhone|iPad|iPod/.test(window.navigator.platform)
}
...
class ar {
  ...
  Dr(t, e) {
    ...
    let i = 0;
    const s = Ue(this.zd, this.Ld, this.$d),
      o = Oe(this.zd, this.Ld),
      h = [s],
      r = [o];
    if (i += o, this.Ed !== null) {
      const a = Ue(this.Ld, this.Ed, this.$d);
      if (Math.sign(a) === Math.sign(s)) {
        const c = Oe(this.Ld, this.Ed);
        if (h.push(a), r.push(c), i += c, this.Nd !== null) {
          const u = Ue(this.Ed, this.Nd, this.$d);
          if (Math.sign(u) === Math.sign(s)) {
            const d = Oe(this.Ed, this.Nd);
...
class cr {
  ...
  sf() {
    return Ns(Gt(this.Jd.W().layout.textColor)) > 160 ? "dark" : "light"
  }
  nf() {
...
function ur(n) {
  At && window.chrome !== void 0 && n.addEventListener("mousedown", t => {
...
class _i {
  constructor(t, e, i) {
    this.rf = 0, this.hf = null, this.lf = {
      ...
      nt: Number.NEGATIVE_INFINITY,
      st: Number.POSITIVE_INFINITY
    }, this.cf = null, this.df = !1, this.ff = null, this.vf = null, this.pf = !1, this.mf = !1, this.bf = !1, this.wf = null, this.gf = null, this.Mf = null, this.xf = null, this.Sf = null, this.kf = null, this.yf = null, this.Cf = 0, this.Tf = !1, this.Pf = !1, this.Rf = !1, this.Df = 0, this.Vf = null, this.Of = !Ne(), this.Bf = s => {
      this.Af(s)
    }, this.If = s => {
      if (this.zf(s)) {
        const o = this.Lf(s);
  ...
  tv(t) {
    const e = Fe(t.changedTouches, g(this.Vf));
    if (e === null || (this.Df = ue(t), this.yf !== null) || this.Pf) return;
    this.Tf = !0;
  ...
  av(t) {
    let e = Fe(t.changedTouches, g(this.Vf));
    if (e === null && t.touches.length === 0 && (e = t.changedTouches[0]), e === null) return;
    this.Vf = null, this.Df = ue(t), this.Xf(), this.vf = null, this.kf && (this.kf(), this.kf = null);
    const i = this.Lf(t, e);
    ...
    } else this.bf || (this.Ff(i, this.jf._v), this.jf._v && $t(t));
    this.af === 0 && $t(t), t.touches.length === 0 && this.df && (this.df = !1, $t(t))
  }
  Af(t) {
    if (t.button !== 0) return;
    const e = this.Lf(t);
  ...
  dv(t) {
    ...
    this.Vf = e.identifier, this.Df = ue(t);
  ...
  pv(t) {
    ...
    as() && e.addEventListener("mouseleave", this.Bf), this.mf = !1, this.ff = ft(t), this.Sf && (this.Sf(), this.Sf = null);
    {
  ...
  Zf() {
    ...
    Ne() && (this.Mf = () => {
      ...
      passive: !0
    }), ur(this.Yf), this.Yf.addEventListener("mousedown", this.pv.bind(this)), this.gv(), this.Yf.addEventListener("touchmove", () => {}, {
      passive: !1
    })
  }
  gv() {
    this.jf.Mv === void 0 && this.jf.xv === void 0 && this.jf.Sv === void 0 || (this.Yf.addEventListener("touchstart", t => this.kv(t.touches), {
      ...
      if (t.touches.length === 2 && this.yf !== null && this.jf.xv !== void 0) {
        const e = cs(t.touches[0], t.touches[1]) / this.Cf;
        this.jf.xv(this.yf, e), $t(t)
      }
    }, {
      passive: !1
  ...
  Cv(t) {
    ...
    }, this.Cf = cs(t[0], t[1]), this.jf.Mv !== void 0 && this.jf.Mv(), this.Xf()
  }
  yv() {
  ...
  wv(t) {
    ...
    const e = this.Lf(t);
    this.$f(e, this.jf.Tv), this.Of = !Ne()
  }
  fv(t) {
    const e = Fe(t.touches, g(this.Vf));
    if (e === null) return;
    const i = this.Lf(t, e);
    this.Ff(i, this.jf.Pv), this.bf = !0, this.df = !0
  }
  zf(t) {
    return t.sourceCapabilities && t.sourceCapabilities.firesTouchEvents !== void 0 ? t.sourceCapabilities.firesTouchEvents : ue(t) < this.Df + 500
  }
  Ff(t, e) {
    e && e.call(this.jf, t)
  }
  ...
  for (let l = 1; l < n.length; l++) {
    ...
    if (t === 1 ? d > p - u : d < p + u) {
      ...
      if ((t === 1 ? m < 0 : m > e) && r > 0) {
        const w = t === 1 ? -1 - m : m - e,
          _ = Math.min(w, r);
        for (let M = s; M < n.length; M++) n[M].Oi(n[M].Vi() + t * _);
        r -= _
      }
    } else s = l, r = t === 1 ? p - u - d : d - (p + u)
  }
}
class ds {
  constructor(t, e, i, s) {
    this.Li = null, this.Lv = null, this.Ev = !1, this.Nv = new Qt(200), this.Jr = null, this.Fv = 0, this.Wv = !1, this.jv = () => {
      this.Wv || this.tn.Hv().$t().$h()
    }, this.$v = () => {
      this.Wv || this.tn.Hv().$t().$h()
    }, this.tn = t, this.cn = e, this.So = e.layout, this.Vc = i, this.Uv = s === "left", this.qv = Ke("normal", s), this.Yv = Ke("top", s), this.Zv = Ke("bottom", s), this.Xv = document.createElement("div"), this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Xv.style.width = "25px", this.Xv.style.left = "0", this.Xv.style.position = "relative", this.Kv = Et(this.Xv, N({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const o = this.Kv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "1", o.style.left = "0", o.style.top = "0", this.Gv = Et(this.Xv, N({
      width: 16,
      height: 16
    ...
    this.rp = new _i(this.Gv.canvasElement, r, {
  ...
  up(t) {
    this.Lv !== null && kt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`)
  }
  cp() {
  ...
  pp({
    ...
    h === r ? ke(t, 0, 0, i, s, h) : Os(t, 0, 0, i, s, h, r)
  }
  Ae({
    context: t,
    bitmapSize: e,
  ...
  kp(t, e) {
    ...
    us(s, 1, this.Lv.height, e), us(o, -1, this.Lv.height, e)
  }
  wp(t) {
    if (this.Lv === null) return;
    const e = this._p(),
  ...
  op() {
    return Bt(this.So.fontSize, this.So.fontFamily)
  }
}
...
class yi {
  constructor(t, e) {
    this.Lv = N({
      width: 0,
      height: 0
    }), this.yp = null, this.Cp = null, this.Tp = null, this.Pp = null, this.Rp = !1, this.Dp = new Y, this.Vp = new Y, this.Op = 0, this.Bp = !1, this.Ap = null, this.Ip = !1, this.zp = null, this.Lp = null, this.Wv = !1, this.jv = () => {
    ...
    i.style.width = "100%", i.style.height = "100%", i.style.position = "relative", i.style.overflow = "hidden", this.Wp = document.createElement("td"), this.Wp.style.padding = "0", this.jp = document.createElement("td"), this.jp.style.padding = "0", this.Fp.appendChild(i), this.Kv = Et(i, N({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const s = this.Kv.canvasElement;
    s.style.position = "absolute", s.style.zIndex = "1", s.style.left = "0", s.style.top = "0", this.Gv = Et(i, N({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
    const o = this.Gv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "2", o.style.left = "0", o.style.top = "0", this.Hp = document.createElement("tr"), this.Hp.appendChild(this.Wp), this.Hp.appendChild(this.Fp), this.Hp.appendChild(this.jp), this.$p(), this.rp = new _i(this.Gv.canvasElement, this, {
  ...
  Up(t) {
    var e, i;
    this.Ep !== null && this.Ep.F_().p(this), this.Ep = t, this.Ep !== null && this.Ep.F_().l(yi.prototype.Np.bind(this), this, !0), this.$p(), this.Jd.qp().indexOf(this) === this.Jd.qp().length - 1 ? (this.Tp = (e = this.Tp) !== null && e !== void 0 ? e : new cr(this.Fp, this.Jd), this.Tp.bt()) : ((i = this.Tp) === null || i === void 0 || i.tf(), this.Tp = null)
  }
  Hv() {
    return this.Jd
  }
    ...
    return i === null ? null : function(s, o, h) {
      const r = s.$o(),
        l = function(a, c, u) {
          ...
          let f, m;
          for (const M of a) {
            const j = (p = (d = M.fa) === null || d === void 0 ? void 0 : d.call(M, c, u)) !== null && p !== void 0 ? p : [];
            for (const k of j) w = k.zOrder, (!(_ = f == null ? void 0 : f.zOrder) || w === "top" && _ !== "top" || w === "normal" && _ === "bottom") && (f = k, m = M)
          }
          var w, _;
          return f && m ? {
            Iv: f,
      ...
      if ((l == null ? void 0 : l.Iv.zOrder) === "top") return de(l);
      for (const a of r) {
        if (l && l.jc === a && l.Iv.zOrder !== "bottom" && !l.Iv.isBackground) return de(l);
        const c = dr(a.Pn(s), o, h);
        if (c !== null) return {
          jc: a,
          Ov: c.Ov,
          Av: c.Av
      ...
      return l != null && l.Iv ? de(l) : null
    }(i, t, e)
  }
  om(t, e) {
    g(e === "left" ? this.yp : this.Cp).up(N({
      width: t,
  ...
  up(t) {
    kt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Fp.style.width = t.width + "px", this.Fp.style.height = t.height + "px")
  }
  um() {
    const t = g(this.Ep);
    t.T_(t.P_()), t.T_(t.R_());
  ...
  fp(t) {
    ...
    if (t > 1 && this.um(), this.yp !== null && this.yp.fp(t), this.Cp !== null && this.Cp.fp(t), t !== 1) {
      ...
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s)
      }), this.Ep && (this.dm(i, fr), this.fm(i), this.vm(i), this.dm(i, fe), this.dm(i, mr)))
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Lt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
  ...
  pp({
    ...
    h === r ? ke(t, 0, 0, i, s, r) : Os(t, 0, 0, i, s, h, r)
  }
  fm(t) {
  ...
  vm(t) {
    const e = this.$i().qc();
    this.gm(t, fe, hi, e), this.gm(t, fe, pe, e)
  }
  pm(t) {
    this.gm(t, fe, pe, this.$i().Yc())
  }
  dm(t, e) {
    const i = g(this.Ep).$o();
    for (const s of i) this.gm(t, e, hi, s);
    for (const s of i) this.gm(t, e, pe, s)
  }
  gm(t, e, i, s) {
    const o = g(this.Ep),
      h = o.$t().Fc(),
  ...
  im(t) {
    ...
    if (this.Pp !== null || this.Mm(t) || (this.Pp = {
      ...
      if (t.Rv && h.touch || !t.Rv && h.mouse) {
        const a = i.he();
        this.Lp = new ar(.2 / a, 7 / a, .997, 15 / a), this.Lp.qd(i.ju(), this.Pp.Vd)
      } else this.Lp = null;
...
class fs {
  constructor(t, e, i, s, o) {
    this.ft = !0, this.Lv = N({
      width: 0,
      height: 0
    }), this.jv = () => this.fp(3), this.Uv = t === "left", this.Vc = i._d, this.cn = e, this.Cm = s, this.Tm = o, this.Xv = document.createElement("div"), this.Xv.style.width = "25px", this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Kv = Et(this.Xv, N({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv)
  }
  ...
  up(t) {
    kt(this.Lv, t) || (this.Lv = t, this.Kv.resizeCanvasElement(t), this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.ft = !0)
  }
  fp(t) {
  ...
  pp({
    ...
    ke(t, 0, 0, e.width, e.height, this.Tm())
  }
}
...
class wr {
  ...
  Nm(t, e, i) {
    kt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.Vm.m(t)), this.Pm !== null && this.Pm.up(N({
      width: e,
      height: t.height
    })), this.Rm !== null && this.Rm.up(N({
      width: i,
      height: t.height
    }))
  }
  ...
  fp(t) {
    ...
    if (t !== 1) {
      ...
      const i = Lt(this.Kv);
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s), this.Ae(s), this.Hm(i, gr)
    ...
    e !== null && (e.useBitmapCoordinateSpace(({
      ...
      i.clearRect(0, 0, s.width, s.height)
    }), this.$m([...this.Jd.$t().wt(), this.Jd.$t().Yc()], e), this.Hm(e, br))
  }
  Hm(t, e) {
    const i = this.Jd.$t().wt();
    for (const s of i) ri(e, o => hi(o, t, !1, void 0), s, void 0);
    for (const s of i) ri(e, o => pe(o, t, !1, void 0), s, void 0)
  }
  pp({
    context: t,
    bitmapSize: e
  }) {
    ke(t, 0, 0, e.width, e.height, this.Jd.$t().md())
  }
  Ae({
    context: t,
    bitmapSize: e,
  ...
  op() {
    return Bt(this.j(), this.cn.fontFamily)
  }
  Ym() {
    return Bt(this.j(), this.cn.fontFamily, "bold")
  }
  Wm() {
    this.k === null && (this.k = {
      C: 1,
...
const _r = !!At && !!navigator.userAgentData && navigator.userAgentData.brands.some(n => n.brand.includes("Chromium")) && !!At && (!((Je = navigator == null ? void 0 : navigator.userAgentData) === null || Je === void 0) && Je.platform ? navigator.userAgentData.platform === "Windows" : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
var Je;
class yr {
  constructor(t, e, i) {
    var s;
    this.Zm = [], this.Xm = 0, this.ro = 0, this.o_ = 0, this.Km = 0, this.Gm = 0, this.Jm = null, this.Qm = !1, this.Dp = new Y, this.Vp = new Y, this.Pc = new Y, this.tb = null, this.ib = null, this.Gd = t, this.cn = e, this.U_ = i, this.Zd = document.createElement("div"), this.Zd.classList.add("tv-lightweight-charts"), this.Zd.style.overflow = "hidden", this.Zd.style.direction = "ltr", this.Zd.style.width = "100%", this.Zd.style.height = "100%", (s = this.Zd).style.userSelect = "none", s.style.webkitUserSelect = "none", s.style.msUserSelect = "none", s.style.MozUserSelect = "none", s.style.webkitTapHighlightColor = "transparent", this.nb = document.createElement("table"), this.nb.setAttribute("cellspacing", "0"), this.Zd.appendChild(this.nb), this.sb = this.eb.bind(this), Xe(this.cn) && this.rb(!0), this.$i = new nr(this.Dc.bind(this), this.cn, i), this.$t().Zc().l(this.hb.bind(this), this), this.lb = new wr(this, this.U_), this.nb.appendChild(this.lb.hp());
  ...
  ob(t, e, i = !1) {
    ...
    const o = this.ro + "px",
      h = this.o_ + "px";
    g(this.Zd).style.height = o, g(this.Zd).style.width = h, this.nb.style.height = o, this.nb.style.width = h, i ? this.pb(tt.es(), performance.now()) : this.$i.Xl()
  }
  fp(t) {
    t === void 0 && (t = tt.es());
  ...
  Tb() {
    ...
    for (let f = 0; f < this.Zm.length; ++f) {
      ...
      let w = 0,
        _ = 0;
      _ = f === this.Zm.length - 1 ? u - p : Math.round(m.g_() * d), w = Math.max(_, 2), p += w, m.up(N({
        width: h,
        height: w
      })), this.Mb() && m.om(e, "left"), this.xb() && m.om(i, "right"), m.dp() && this.$i.Xc(m.dp(), w)
    }
    this.lb.Nm(N({
      width: r ? h : 0,
      height: l
  ...
  Pb(t) {
    ...
    return _r ? 1 / window.devicePixelRatio : 1
  }
  eb(t) {
...
class Lr {
    ...
    if (e.length !== 0) {
      ...
      h = e.map((p, f) => {
        const m = a(p.time),
          w = this.U_.key(m);
        let _ = this.Ub.get(w);
        _ === void 0 && (_ = bs(m), this.Ub.set(w, _), s = !0);
        const M = c(m, _.se, p, l[f], u, d);
        return _.jb.set(t, M), M
      })
    }
  ...
  tw(t, e) {
    ...
    const p = {
        ...
        time: h.ha,
        pointData: h,
        originalTime: ws(h.jb)
      },
      f = ie(this.Zb, this.U_.key(p.time), (m, w) => this.U_.key(m.time) < w);
    this.Zb.splice(f, 0, p);
    for (let m = f; m < this.Zb.length; ++m) He(this.Zb[m].pointData, m);
  ...
  Jb(t) {
    ...
    for (let i = 0; i < this.Zb.length && i < t.length; ++i) {
      ...
      o.timeWeight = s.timeWeight, He(o.pointData, i)
    }
    if (e === -1 && this.Zb.length !== t.length && (e = Math.min(this.Zb.length, t.length)), e === -1) return -1;
    for (let i = e; i < t.length; ++i) He(t[i].pointData, i);
...
function ys() {
  return {
    ...
    crosshair: Vr,
    grid: Rr,
    overlayPriceScales: Object.assign({}, Ye),
    leftPriceScale: Object.assign(Object.assign({}, Ye), {
      visible: !1
    }),
    rightPriceScale: Object.assign(Object.assign({}, Ye), {
      visible: !0
    }),
    timeScale: Wr,
    watermark: Br,
    localization: {
      locale: At ? navigator.language : "",
      dateFormat: "dd MMM 'yy"
    },
    handleScroll: {
      mouseWheel: !0,
...
class Ar {
  ...
  width() {
    return ze(this.aw) ? this.lw.gb(this.aw) : 0
  }
  Li() {
...
function Ms(n, t, e) {
  const i = ln(n, ["time", "originalTime"]),
    s = Object.assign({
      time: t
    }, i);
...
class Or {
  constructor(t, e, i, s, o) {
    this._w = new Y, this.Ls = t, this.uw = e, this.cw = i, this.U_ = o, this.dw = s
  }
  S() {
    this._w.S()
  }
  ...
  barsInLogicalRange(t) {
    if (t === null) return null;
    const e = new It(new Yt(t.from, t.to)).hu(),
      i = this.Ls.In();
    if (i.Ni()) return null;
    const s = i.hl(e.Vs(), 1),
      o = i.hl(e.ui(), -1),
...
class Ur {
  constructor(t, e, i) {
    this.bw = new Y, this.pu = new Y, this.Vm = new Y, this.$i = t, this.kl = t.St(), this.lb = e, this.kl.tc().l(this.ww.bind(this)), this.kl.nc().l(this.gw.bind(this)), this.lb.Em().l(this.Mw.bind(this)), this.U_ = i
  }
  S() {
  ...
  setVisibleLogicalRange(t) {
    Mt(t.from <= t.to, "The from index cannot be after the to index."), this.$i.vd(t)
  }
  resetTimeScale() {
    this.$i.Kn()
  }
  ...
  options() {
    return Object.assign(Object.assign({}, vt(this.kl.W())), {
...
function Ss(n) {
  return function(t) {
    if (oe(t.handleScale)) {
      ...
      oe(i) && (t.handleScale.axisPressedMouseMove = {
        time: i,
        price: i
      }), oe(s) && (t.handleScale.axisDoubleClickReset = {
        time: s,
        price: s
      })
    }
...
class Kr {
  constructor(t, e, i) {
    this.xw = new Map, this.Sw = new Map, this.kw = new Y, this.yw = new Y, this.Cw = new Y, this.Tw = new Lr(e);
    const s = i === void 0 ? vt(ys()) : ut(vt(ys()), Ss(i));
    this.U_ = e, this.lw = new yr(t, s, e), this.lw.hm().l(h => {
    ...
    const o = this.lw.$t();
    this.Rw = new Ur(o, this.lw.cb(), this.U_)
  }
  remove() {
  ...
  addCustomSeries(t, e) {
    const i = Vt(t),
      s = Object.assign(Object.assign({}, Ws), i.defaultOptions());
    return this.Dw("Custom", s, e, i)
  }
  addAreaSeries(t) {
    return this.Dw("Area", Lo, t)
  }
  addBaselineSeries(t) {
    return this.Dw("Baseline", xo, t)
  }
  addBarSeries(t) {
    return this.Dw("Bar", jo, t)
  }
  addCandlestickSeries(t = {}) {
    ...
    }(t), this.Dw("Candlestick", ko, t)
  }
  addHistogramSeries(t) {
    return this.Dw("Histogram", Eo, t)
  }
  addLineSeries(t) {
    return this.Dw("Line", zo, t)
  }
  removeSeries(t) {
  ...
  Dw(t, e, i = {}, s) {
    Fr(i.priceFormat);
    const o = ut(vt(Bs), vt(e), i),
      h = this.lw.$t().ud(t, o, s),
      r = new Or(h, this, this, this, this.U_);
...
function Jr(n, t, e) {
  ...
  if (ee(n)) {
    ...
    Mt(o !== null, `Cannot find element in DOM with id=${n}`), i = o
  } else i = n;
  const s = new Kr(i, t, e);
  return t.setOptions(s.options()), s
}

function Xr(n, t) {
  return Jr(n, new ls, ls.Ad(t))
}
Object.assign(Object.assign({}, Bs), Ws);
const Hr = {
  ...
  nl = ot({
    ...
    setup(n) {
      const t = n,
        ...
        d = (f, m) => {
          var y, b;
          const w = (y = yn().$webApp.dataUnsafe.user) == null ? void 0 : y.language_code,
            _ = (b = i.value) == null ? void 0 : b.timeScale().getVisibleLogicalRange();
          s.value && i.value && i.value.removeSeries(s.value), m.innerHTML = "";
          const j = Xr(m, {
            localization: {
              timeFormatter: T => {
                const U = F => String(F).padStart(2, "0"),
                  L = new Date(T * 1e3);
                return `${U(L.getUTCHours())}:${U(L.getUTCMinutes())}`
              },
              priceFormatter: T => {
                if (a.value === Ut.MARKET_CAP) return `$${ge(T,{accuracy:0})}`;
                {
                  if (Math.abs(T) < 1e-9) return "$0";
                  const [U, L] = T.toFixed(9).split("."), F = L[0], $ = L.slice(1).match(/^0+/), P = $ ? $[0].length : 0, B = P > 0 ? String.fromCharCode(8321 + P) : "", A = L.slice(P + 1).replace(/0+$/, "").slice(0, 3);
                  return `$${U}.${F}${B}${A}`
                }
              },
              locale: w
          ...
          const k = j.addLineSeries({
            ...
            I = f.map(T => {
              const U = new Date(T.timestamp);
              return {
                time: (U.getTime() - U.getTimezoneOffset() * 60 * 1e3) / 1e3,
                value: T.price.toNumber()
              }
            }).sort((T, U) => T.time - U.time);
          k.setData(I);
          const q = o.value === t.chartInterval;
          _ && q ? j.timeScale().setVisibleLogicalRange(_) : j.timeScale().fitContent(), o.value = t.chartInterval
        },
        p = z(() => {
          var w;
          if (!((w = t.jettonPnl) != null && w.hasPnL)) return;
          const f = wn(t.jettonPnl.pnlAbsoluteUSD, {
              accuracy: 2,
              trim: !0
            }),
            m = Un(t.jettonPnl.pnlPercent);
          return {
      ...
      return _t(() => ({
        ...
        immediate: !0
      }), Se(u), (f, m) => (S(), D("div", Hr, [C("div", Yr, [C("div", {
        class: "section",
        style: ji({
          "grid-template-columns": `repeat(${v(r).length}, 1fr)`
        })
      }, [(S(!0), D(yt, null, Ge(v(r), w => (S(), D("label", {
        key: w.value,
        class: Kt(["item", {
          "is-active": f.chartType === w.value
        }])
      }, [be(C("input", {
        "onUpdate:modelValue": m[0] || (m[0] = _ => pt(a) ? a.value = _ : null),
        type: "radio",
        name: "chart-type",
        value: w.value
      }, null, 8, Gr), [
        [Ze, v(a)]
      ]), C("span", Zr, J(w.label), 1)], 2))), 128))], 4), C("div", {
        class: "section",
        style: ji({
          "grid-template-columns": `repeat(${v(h).length}, 1fr)`
        })
      }, [(S(!0), D(yt, null, Ge(v(h), w => (S(), D("label", {
        key: w.value,
        class: Kt(["item", {
          "is-active": f.chartInterval === w.value
        }])
      }, [be(C("input", {
        "onUpdate:modelValue": m[1] || (m[1] = _ => pt(l) ? l.value = _ : null),
        type: "radio",
        name: "chart-interval",
        value: w.value
      }, null, 8, qr), [
        [Ze, v(l)]
      ]), C("span", Qr, J(w.label), 1)], 2))), 128))], 4)]), !f.chart || !f.chart.points.length ? (S(), D("div", tl, [m[3] || (m[3] = C("img", {
        src: zi,
        class: "lines"
      }, null, -1)), m[4] || (m[4] = C("img", {
        src: _n,
        class: "empty"
      }, null, -1)), C("div", el, [m[2] || (m[2] = C("div", {
        class: "dot"
      }, null, -1)), C("div", il, J(("t" in f ? f.t : v(R))("memepad.jetton.chart.coming_text")), 1)])])) : (S(), D("div", sl, [v(p) ? (S(), D("div", {
        key: 0,
        class: Kt(["pnl-label", v(p).cls])
      }, J(v(p).label), 3)) : jt("", !0), C("div", {
        ref_key: "container",
        ref: e,
        style: {
          width: "100%",
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return S(), D(yt, null, [E(h, {
          ...
          default: Z(() => [C("div", hl, J(("t" in s ? s.t : v(R))("memepad.jetton.unlock.btn")), 1)]),
          _: 1
        }, 8, ["type"]), E(a, {
          modelValue: v(e),
          "onUpdate:modelValue": o[1] || (o[1] = c => pt(e) ? e.value = c : null)
        }, {
          default: Z(() => [C("div", rl, [C("div", ll, [E(r, {
            src: v(zs)(s.jetton.iconFileKey),
            size: 80
          }, null, 8, ["src"])]), C("div", al, J(("t" in s ? s.t : v(R))("memepad.jetton.unlock.sheet.title", {
            ticker: s.jetton.ticker
          })), 1), C("div", cl, J(("t" in s ? s.t : v(R))("memepad.jetton.unlock.sheet.subtitle", {
            ticker: s.jetton.ticker
          })), 1), C("div", ul, [E(l, {
            jetton: s.jetton,
  ...
  vl = ot({
    ...
    setup(n) {
      ...
      return (o, h) => (S(), D("label", {
        class: Kt(["kit-tab", [`is-${v(i).toLowerCase()}`, {
          "is-active": v(s)
        }]])
      }, [C("span", ml, J(n.label), 1), be(C("input", {
        "onUpdate:modelValue": h[0] || (h[0] = r => pt(s) ? s.value = r : null),
        type: "radio",
        value: n.value,
        name: v(e).name
      }, null, 8, pl), [
  ...
  gl = ot({
    ...
    setup(n) {
      ...
      return kn(Es, {
        ...
        }, [be((S(), D("div", bl, [Ln(s.$slots, "default", {}, void 0, !0), (S(!0), D(yt, null, Ge(v(i), l => (S(), W(h, {
          key: l.value,
          label: l.label,
          value: l.value,
          type: n.type
  ...
  Cl = ot({
    ...
    setup(n) {
      const t = n,
        e = z(() => new we(t.value.replaceAll(",", "") || "0")),
      ...
      return (h, r) => {
        ...
        const l = Ts,
          ...
          u = Ps,
          d = Dt;
        return S(), D("div", _l, [C("div", yl, [h.inputState ? (S(), D(yt, {
          key: 0
        }, [h.inputState.balanceLabel ? (S(), W(l, {
          key: 0,
          balance: h.inputState.balanceLabel
        }, null, 8, ["balance"])) : (S(), W(a, {
          key: 1,
          class: "skeleton"
        })), h.inputState.error || h.inputState.feesInfo ? (S(), W(c, {
          key: 2,
        ...
        }, null, 8, ["details", "total-label", "error-message"])) : (S(), W(a, {
          key: 3,
          class: "skeleton"
        }))], 64)) : (S(), D(yt, {
          key: 1
          ...
          class: "skeleton"
        })], 64))]), (_ = (w = h.inputState) == null ? void 0 : w.error) != null && _.notEnoughtTon ? (S(), W(u, {
          key: 0,
          "jetton-shortname": h.jetton.shortname,
          "jetton-address": h.jetton.address
        }, null, 8, ["jetton-shortname", "jetton-address"])) : (S(), D(yt, {
          key: 1
        }, [h.tab === v(G).BUY ? (S(), W(d, {
          key: 0,
          fill: "",
          ...
          default: Z(() => [C("div", Ml, J(("t" in h ? h.t : v(R))("memepad.jetton.buy_button_label", {
            ticker: h.jetton.ticker
          })), 1)]),
          _: 1
        }, 8, ["size", "type", "loading", "disabled"])) : jt("", !0), h.tab === v(G).SELL ? (S(), W(d, {
          key: 1,
          fill: "",
          size: v(Wt).LARGE,
          type: v(zt).PINK,
          ...
          default: Z(() => [C("div", Sl, J(("t" in h ? h.t : v(R))("memepad.jetton.sell_button_label", {
            ticker: h.jetton.ticker
          })), 1)]),
          _: 1
  ...
  El = ot({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        u = () => {
          var y;
          e.jettonModalControls.value.value === wt.TRADE && ((y = h.value) == null || y.focusOnInput())
        },
        d = K(e.jettonTrading.slippage);
      _t(() => e.jettonModalControls.isOpened(wt.SLIPPAGE), y => {
        var b;
        d.value = e.jettonTrading.slippage, a(), y || (b = h.value) == null || b.focusOnInput()
      });
      const p = K(),
        f = K("0"),
        m = y => ge(y, {
        ...
        w = z({
          ...
          set: y => {
            f.value = y, Li(() => {
              var b;
              return (b = p.value) == null ? void 0 : b.applyNearestValue()
            })
          }
        }),
        _ = z({
      ...
      const M = z(() => {
          if (!(!l.value || l.value.loading)) {
            if (j.value.isZero()) return s.value === G.BUY ? `0 ${e.jetton.ticker}` : "0 TON";
            if (!l.value.feesInfo || !l.value.ready) return "";
            if (s.value === G.SELL) {
              const y = l.value.tradeInfo.maxReceive,
                b = `${xi(y)} TON`;
              if (!e.tonUsdRate) return b;
              const T = xn(e.tonUsdRate.mul(y));
              return `${b} (≈$${T})`
            } else {
              const y = l.value.tradeInfo.maxReceive;
              return `≈${ge(y,{accuracy:0})} ${e.jetton.ticker}`
            }
          }
        }),
        j = z(() => new we(f.value.replaceAll(",", "") || "0"));
      let k;
      _t(() => [f.value, e.balances.jettonBalance, e.balances.tonBalance], () => a()), Se(() => {
        k == null || k.destroy()
      });

      function I() {
        const y = e.jettonTrading.tradeStateControls,
          b = z(() => y.getImmediateState({
            operation: s.value,
            amount: j.value,
            tonBalance: e.balances.tonBalance,
            jettonBalance: e.balances.jettonBalance,
      ...
      function q() {
        ...
        const T = (L, F) => {
          if (b.push({
              amount: L,
              operation: F
            }), b = b.slice(-3), b.length === 3) {
            const x = b.every(P => P.amount.eq(b[0].amount)),
              $ = b.every(P => P.operation === b[0].operation);
            x && $ && r.disconnect()
          }
        };
        return async () => {
          ...
          await (async () => {
            o.value[L] = !0;
            const V = () => {
                const se = ei(L === G.BUY ? x.minReceive : F, $),
                  Ee = ei(L === G.BUY ? F : x.minReceive, "TON"),
                  Ci = L === G.BUY ? R("memepad.jetton.buy.failed_alert", {
                    askLabel: se.frontendWithSymbol,
                    offerLabel: Ee.frontendWithSymbol
              ...
              X = await (L === G.BUY ? e.jettonTrading.buyJetton(F, x) : e.jettonTrading.sellJetton(F, x));
            if (X.err) {
              En().error("Memepad jetton trade error", X.extra), o.value[L] = !1, V(), T(F, L);
              return
            }
            i("trade");
            const H = X.data;
            k = L === G.BUY ? e.jettonTrading.getWaitForBuyStatus() : e.jettonTrading.getWaitForSellStatus(), await js(2e4);
            const at = await k.exec({
                jettonAddress: A,
                transactionHash: H
              }),
              it = at ? "success" : "failed";
            if (L === G.BUY ? y.memepad.memepadJettonBuy({
                status: it,
                jettonId: P,
                jettonShortname: O,
                jettonAddress: B,
                purchaseAmount: F.toNumber()
              }) : y.memepad.memepadJettonSell({
                status: it,
                jettonId: P,
                jettonShortname: O,
                jettonAddress: B,
                purchaseAmount: x.maxReceive.toNumber()
              }), !at) {
              o.value[L] = !1, V();
              return
            }
            const Q = L === G.BUY ? R("memepad.jetton.buy.success_alert", {
              ticker: $,
              label: `${xi(F)} TON`
            }) : R("memepad.jetton.sell.success_alert", {
              label: `${Tn(F).full} ${$}`
            });
            ve().bottom.success(Q), o.value[L] = !1, e.tradeSuccessCallback()
          })()
        }
      }
      return (y, b) => {
        ...
        return S(), W(O, {
          ...
          "top-center": Z(() => [E(U, {
            ...
            default: Z(() => [E(T, {
              label: ("t" in y ? y.t : v(R))("memepad.jetton.buy_tab"),
              value: v(G).BUY,
              type: v(Qe).PRIMARY,
              class: "buy-tab"
            }, null, 8, ["label", "value", "type"]), E(T, {
              label: ("t" in y ? y.t : v(R))("memepad.jetton.sell_tab"),
              value: v(G).SELL,
              type: v(Qe).SECONDARY,
              class: "sell-tab"
          ...
          default: Z(() => [C("div", jl, [(S(), W(L, {
            ref_key: "actionControlsInputComp",
            ref: h,
            key: s.value,
            modelValue: v(w),
            "onUpdate:modelValue": b[1] || (b[1] = V => pt(w) ? w.value = V : null),
            postfix: s.value === "buy" ? "TON" : y.jetton.ticker,
            modifier: m,
            onBlur: u
          }, null, 8, ["modelValue", "postfix"])), C("div", zl, [v(M) ? (S(), D("span", Ll, J(v(M)), 1)) : v(M) === void 0 ? (S(), W(F, {
            key: 1,
            class: "skeleton"
          })) : jt("", !0)]), C("button", {
            type: "button",
            class: "reset slippage-btn",
            onClick: b[2] || (b[2] = V => y.$emit("open-slippage"))
          }, [C("span", xl, J(`${("t"in y?y.t:v(R))("memepad.jetton.slippage_btn")} ${v(d)}%`), 1), E(x, {
          ...
          "bottom-action": Z(() => [E(B, {
            ...
            default: Z(() => [y.unlockEnabled ? (S(), W($, {
              key: 0,
              jetton: y.jetton,
              "jetton-information": y.jettonInformation,
              balances: y.balances,
              "jetton-management": y.jettonManagement,
              onUnlocked: b[3] || (b[3] = V => y.$emit("unlock-success"))
            }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (S(), W(P, {
              key: 1,
              value: v(f),
              tab: s.value,
              jetton: y.jetton,
          ...
          "bottom-helpers": Z(() => [E(A, {
            ref_key: "rangeInputEl",
            ref: p,
            modelValue: v(_),
            "onUpdate:modelValue": b[4] || (b[4] = V => pt(_) ? _.value = V : null),
            tab: s.value,
            balances: y.balances
  ...
  Bl = ot({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        o = () => {
          var c;
          e.jettonModalControls.value.value === wt.SLIPPAGE && ((c = s.value) == null || c.focusOnInput())
        },
        h = K(e.jettonTrading.slippage.toString()),
        r = z(() => new we(h.value.replaceAll(",", "") || "0")),
        l = z(() => r.value.lt(Il) ? R("memepad.jetton.slippage.error_message.too_low") : r.value.gt(Wl) ? R("memepad.jetton.slippage.error_message.too_high") : ""),
        a = () => {
      ...
      return (c, u) => {
        ...
        return S(), W(m, {
          ...
          "top-center": Z(() => [C("div", $l, J(("t" in c ? c.t : v(R))("memepad.jetton.slippage.title")), 1)]),
          default: Z(() => [C("div", Pl, [E(d, {
            ref_key: "actionControlsInputComp",
            ref: s,
            modelValue: v(h),
            "onUpdate:modelValue": u[0] || (u[0] = w => pt(h) ? h.value = w : null),
            postfix: "%",
            modifier: w => ("formatFloatLine" in c ? c.formatFloatLine : v(ge))(w, {
              join: "emptyFractional"
            }),
            onBlur: o
          }, null, 8, ["modelValue", "modifier"]), u[1] || (u[1] = C("div", {
            class: "subtitle-compensator"
          }, null, -1))])]),
          "bottom-action": Z(() => [C("div", Vl, [v(l) ? (S(), W(p, {
            key: 0,
            "error-message": v(l)
          }, null, 8, ["error-message"])) : (S(), D("div", Rl, J(("t" in c ? c.t : v(R))("memepad.jetton.slippage.text")), 1)), E(f, {
  ...
  Ul = ot({
    ...
    setup(n) {
      return (t, e) => {
        const i = Dt;
        return S(), D("div", Dl, [E(i, {
          class: "buy-button",
          type: v(zt).HIGHLIGHT,
          loading: t.tradePendings[v(G).BUY],
          onClick: e[0] || (e[0] = s => t.$emit("click", v(G).BUY))
        }, {
          default: Z(() => [C("span", Nl, J(("t" in t ? t.t : v(R))("memepad.jetton.buy_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"]), E(i, {
          class: "sell-button",
          type: v(zt).PINK,
          loading: t.tradePendings[v(G).SELL],
          onClick: e[1] || (e[1] = s => t.$emit("click", v(G).SELL))
        }, {
          default: Z(() => [C("span", Ol, J(("t" in t ? t.t : v(R))("memepad.jetton.sell_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"])])
      }
    }
  ...
  Jl = ot({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        h = c => {
          s.value = c, e.jettonModalControls.set(wt.TRADE)
        },
        r = () => {
      ...
      return (c, u) => {
        const d = fl,
          ...
          w = ai,
          _ = Is;
        return S(), D("div", Kl, [E(_, null, {
          default: Z(() => [E(w, {
            "force-loading": c.unlockEnabled === void 0 && c.isReleased || !c.jettonTrading,
            "button-size": v(Wt).MEDIUM
          }, {
            default: Z(() => [c.unlockEnabled ? (S(), W(d, {
              key: 0,
              jetton: c.jetton,
            ...
            }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (S(), D(yt, {
              key: 1
            }, [c.jettonModalControls.isOpened(v(wt).TRADE) ? (S(), W(p, {
              key: 0,
              modelValue: v(s),
              "onUpdate:modelValue": u[0] || (u[0] = M => pt(s) ? s.value = M : null),
              "trade-pendings": v(o),
              "onUpdate:tradePendings": u[1] || (u[1] = M => pt(o) ? o.value = M : null),
              jetton: c.jetton,
              "jetton-information": c.jettonInformation,
              ...
              onOpenSlippage: u[3] || (u[3] = M => c.jettonModalControls.add(v(wt).SLIPPAGE))
            }, null, 8, ["modelValue", "trade-pendings", "jetton", "jetton-information", "jetton-bcl-data", "balances", "jetton-management", "jetton-trading", "is-released", "unlock-enabled", "ton-usd-rate", "jetton-modal-controls"])) : jt("", !0), c.jettonModalControls.isOpened(v(wt).SLIPPAGE) ? (S(), W(f, {
              key: 1,
              "jetton-trading": c.jettonTrading,
              "jetton-modal-controls": c.jettonModalControls,
              onSlippageUpdated: u[4] || (u[4] = M => c.jettonModalControls.set(v(wt).TRADE))
            }, null, 8, ["jetton-trading", "jetton-modal-controls"])) : jt("", !0), E(m, {
              "trade-pendings": v(o),
              onClick: h
    ...
    setup(n) {
      ...
      return (i, s) => {
        const o = bo,
          ...
          r = ol,
          l = Xl;
        return S(), D("div", Hl, [E(o, {
          jetton: i.jetton,
          "jetton-information": i.jettonInformation,
          "is-released": i.isReleased,
          "jetton-modal-controls": i.jettonModalControls,
          onShare: s[0] || (s[0] = a => i.$emit("share"))
        }, null, 8, ["jetton", "jetton-information", "is-released", "jetton-modal-controls"]), E(h, Vn(v(e), {
          class: "details"
        }), null, 16), E(r, {
          chart: i.jettonChart,
        ...
        }, null, 8, ["chart", "chart-interval", "chart-type", "jetton-pnl", "update-chart-interval", "update-chart-type"]), E(l, {
          jetton: i.jetton,
          "jetton-information": i.jettonInformation,
          "is-released": i.isReleased,
          ...
          onTradeSuccess: s[1] || (s[1] = a => i.$emit("trade-success")),
          onUnlockSuccess: s[2] || (s[2] = a => i.$emit("unlock-success"))
  ...
  da = ot({
    ...
    setup(n) {
      const t = Rn(),
        ...
        q = async () => {
          await Promise.all([d.update(), h.value.update(), I.update(), M.update()])
        }, y = async () => {
          ...
          if (!e.value || !o || o.value.status === ne.IN_PROGRESS) return {
            status: "loading"
          };
          const x = e.value.address,
            $ = [ne.PUBLISHED_ON_DEX, ne.LISTED_TO_DEX].includes(o.value.status),
            P = {
              jettonBalance: m.value ? ei(m.value, e.value.ticker) : void 0,
              tonBalance: d.wallet.value.status === "connected" ? (V = d.wallet.value.balance) == null ? void 0 : V.tonBalance.balance : void 0
            },
            B = Bn(An, {
            ...
            A = a(B),
            O = $ ? u(x) : c(x, B);
          return o.value.status === ne.LISTED_TO_DEX ? {
            ...
            jettonChartType: I.jettonChartType.value,
            jettonPnl: _.value,
            updateJettonChartInterval: I.updateChartInterval,
            updateJettonChartType: I.updateChartType,
            isReleased: $,
            unlockEnabled: w.value,
            balances: P,
            jettonManagement: A,
      ...
      Kn(z(() => b.value.status === "moving_to_dex"), "memepad-jetton-trade-status");
      const T = () => {
          M.init(), I.init()
        },
        U = () => {
      ...
      function L() {
        ...
        const A = () => {
          ...
          X = Nt(async () => {
            A();
            const Q = await Ei.getMemepadJettonChart(i.value, {
              interval: $.value,
              type: P.value
            });
            return B.signal.aborted ? ct(x.value) : ct((Pt(Q) ? Q.data : x.value) || x.value)
          }, Q => x.value = Q, 5e3);
        return {
          init: async () => await X.exec(),
          destroy: () => {
            X.destroy(), x.value = void 0, $.value = Ft.ONE_MINUTE
          },
          update: async () => await X.exec(),
          updateChartInterval: O,
          updateChartType: V,
          jettonChartInterval: z(() => $.value),
          jettonChartType: z(() => P.value),
          jettonChart: z(() => x.value)
        }
      }
      ...
      function F() {
        const x = K(),
          ...
          P = K(),
          B = K();
        let A, O, V, X, H, at, it, Q;

        function se() {
          O = _t(b, rt => {
            rt.status === "loading" || A || rt.jettonManagement && (O == null || O(), A = Nt(async () => {
              if (b.value.status === "loading") return ct(void 0);
              const et = b.value.jetton.address,
                St = await b.value.jettonManagement.getJettonBclData(et);
              return ct((Pt(St) ? St.data : x.value) || x.value)
            }, et => x.value = et, 6e4), A == null || A.exec())
          }, {
            immediate: !0
          }), X = _t(b, rt => {
            rt.status === "loading" || V || !rt.jettonTrading || p.value !== "connected" || (X == null || X(), V = Nt(async () => {
              if (b.value.status === "loading" || !b.value.jettonTrading || p.value !== "connected") return ct(void 0);
              const et = b.value.jetton.address,
                St = await b.value.jettonTrading.getUserJettonBalance(et);
              return ct((Pt(St) ? St.data : $.value) || $.value)
            }, et => $.value = et, 6e4), V == null || V.exec())
          }, {
            immediate: !0
          }), at = _t(b, rt => {
            rt.status === "loading" || H || !rt.jetton || !rt.balances.jettonBalance || !rt.isReleased || p.value !== "connected" || (at == null || at(), H = Nt(async () => {
              if (b.value.status === "loading" || !b.value.balances.jettonBalance || !b.value.isReleased || p.value !== "connected") return ct(void 0);
              if (b.value.balances.jettonBalance.value.isZero()) return ct(!1);
              const et = await b.value.jettonManagement.getUnlockEnabled(b.value.jetton.address);
              return ct(Pt(et) ? et.data : P.value)
            }, et => P.value = et, 6e4), H == null || H.exec())
          }, {
            immediate: !0
          }), Q = _t(b, rt => {
            rt.status === "loading" || it || d.wallet.value.status === "connected" && (Q == null || Q(), it = Nt(async () => {
              if (b.value.status === "loading" || d.wallet.value.status !== "connected") return ct(void 0);
              const et = b.value.jetton.shortname,
                St = d.wallet.value.address.default,
                ki = await Ei.getMemepadJettonPnl(et, St);
              return ct((Pt(ki) ? ki.data : B.value) || B.value)
            }, et => B.value = et, 6e4), it == null || it.exec())
          }, {
            immediate: !0
          })
        }
        return {
          init: se,
          destroy: () => {
            O == null || O(), A == null || A.destroy(), X == null || X(), V == null || V.destroy(), at == null || at(), H == null || H.destroy(), Q == null || Q(), it == null || it.destroy(), x.value = void 0, $.value = void 0, P.value = void 0, B.value = void 0
          },
          update: async () => {
            await (A == null ? void 0 : A.exec()), await (V == null ? void 0 : V.exec()), await (H == null ? void 0 : H.exec()), it == null || it.exec()
          },
          resetAndUpdateUnlocked: async () => {
            P.value = void 0, await (H == null ? void 0 : H.exec())
          },
          jettonBclData: z(() => x.value),
          jettonBalance: z(() => $.value),
          jettonUnlockEnabled: z(() => P.value),
          jettonPnl: z(() => B.value)
        }
      }
      return (x, $) => {
        const P = un,
          B = oo,
          A = Gl;
        return v(b).status === "loading" ? (S(), W(P, {
          key: 0
        })) : v(b).status === "moving_to_dex" ? (S(), W(B, {
          key: 1,
          jetton: v(b).jetton,
          ...
          "is-released": ""
        }, null, 8, ["jetton", "jetton-information", "unlock-enabled", "balances", "jetton-management"])) : (S(), W(A, {
          key: 2,
          jetton: v(b).jetton,
          "jetton-information": v(b).jettonInformation,
          "jetton-bcl-data": v(b).jettonBclData,
          "jetton-chart": v(b).jettonChart,
          "jetton-chart-interval": v(b).jettonChartInterval,
          "jetton-chart-type": v(b).jettonChartType,
          "jetton-pnl": v(b).jettonPnl,
          "update-jetton-chart-interval": v(b).updateJettonChartInterval,
          "update-jetton-chart-type": v(b).updateJettonChartType,
          "is-released": v(b).isReleased,
          "unlock-enabled": v(b).unlockEnabled,
          "jetton-management": v(b).jettonManagement,
          "jetton-trading": v(b).jettonTrading,
          balances: v(b).balances,
          "jetton-modal-controls": v(b).jettonModalControls,
          "ton-usd-rate": v(r),
          onTradeSuccess: q,
          onUnlockSuccess: y,
          onShare: $[0] || ($[0] = O => x.$emit("share"))
