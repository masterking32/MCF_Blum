...
const Pe = {
    ...
    setup(i) {
      return (e, o) => {
        ...
        return _(), L("div", {
          ...
          size: 48,
          class: "image"
        }, null, 8, ["src"]), e.streamOnline ? (_(), L("div", ke, "LIVE")) : $("", !0)])], 6)
      }
    }
  }),
  Ce = H(Ae, [
      ...
      return (a, P) => {
        ...
        return _(), X(I, {
          ...
          default: G(() => {
            ...
            }, null, 8, ["image", "collected-percent", "is-released", "stream-online"]), v("div", Ne, [v("div", je, [w(a.$slots, "ticker", {
              jetton: a.jetton
            }, () => [ce(S(a.jetton.ticker), 1)], !0)]), a.mode === r(U).BASE ? (_(), L("div", we, [w(a.$slots, "base-stats", {
              jetton: a.jetton,
              mCap: r(s),
              timeSince: r(d)
            }, () => [a.jetton.stats.holdersCount !== void 0 ? (_(), L("div", De, [B(C, {
              name: "personal",
              class: "icon"
            }), v("span", be, S(("formatCount" in a ? a.formatCount : r(J))(a.jetton.stats.holdersCount, {
              accuracy: 0
            }).full), 1)])) : $("", !0), a.jetton.stats.transactionsCount !== void 0 ? (_(), L("div", Re, [B(C, {
              name: "transfer",
              class: "icon"
            }), v("span", Ue, S(("formatCount" in a ? a.formatCount : r(J))(a.jetton.stats.transactionsCount, {
              accuracy: 0
            }).full), 1)])) : $("", !0)], !0)])) : a.mode === r(U).MY_TOKENS ? (_(), L("div", Oe, [v("div", Be, S(r(n)), 1)])) : $("", !0)]), a.mode === r(U).BASE ? (_(), L("div", $e, [w(a.$slots, "base-values", {
              jetton: a.jetton,
              mCap: r(s),
              timeSince: r(d)
            }, () => [v("div", Ge, [v("span", Ve, S(("t" in a ? a.t : r(de))("memepad.jetton.stats.market_cap")), 1), v("span", We, S(r(s)), 1)]), v("div", Ye, [B(C, {
              name: "environment-leaf",
              class: "icon"
            }), v("span", Je, S(r(d)), 1)])], !0)])) : a.mode === r(U).MY_TOKENS ? (_(), L("div", Ke, [v("div", Xe, S(r(y)), 1), v("div", {
              class: ee(["pnl", r(p) && r(p).cls])
            }, S(((N = r(p)) == null ? void 0 : N.formatted) ?? "-"), 3)])) : $("", !0)]
          }),
          _: 3
        }, 8, ["to"])
      }
    ...
    const u = Math.max(0, i.length - 1),
      ...
      y = m(() => {
        const I = Math.max(0, d.value - o + 1),
          N = Math.min(d.value + 1, c.value.length);
        return [...c.value].slice(I, N).reverse()
      }),
  ...
  ze = ({
    ...
    const d = {
      ...
      n = async ({
        ...
        const f = {
          ...
          h = f[l],
          j = E[l];
        return await b.getMemepadJettonsSection(h, j, i, A)
          ...
          case "step-list":
            return {
              type: "step-list", stepList: void 0, interval: x(async () => await n({
                ...
                const E = s.value.stepList;
                if (!E) s.value.stepList = se(f.jettons, 1e3, 60), s.value.stepList.init();
                else {
                  const j = E,
                    V = f.jettons.filter(W => !j.items.some(z => z.id === W.id)),
                    R = j.items.map(W => f.jettons.find(ae => ae.id === W.id) || W);
                  j.setItems(R), j.addItems(V)
                }
              }, 5e3)
            };
          case "pagination-list":
            return {
              type: "pagination-list", pagination: Me(async E => {
                const h = await n({
                  type: l,
                  pageToken: E
                });
          ...
          case "list":
            return {
              type: "list", data: void 0, interval: x(async () => await n({
                ...
                var E;
                ((E = s.value) == null ? void 0 : E.type) !== "list" || l !== y.value || (s.value.data = f.jettons)
              }, 5e3)
            };
          default:
    ...
    const N = m(() => {
      ...
      switch (s.value.type) {
        case "step-list":
          return (A = s.value.stepList) == null ? void 0 : A.appearedItems;
        case "pagination-list":
  ...
  qe = () => {
    const i = D(),
      ...
      u = D(Se(async () => await b.getMemepadExploreEvents(), n => {
        o(n.transactions)
      }, 9e3));
    return {
      init: async () => {
