    ...
    setup(h) {
      return (s, m) => {
        ...
        return t(), a("div", he, [s.errorMessage ? (t(), b(e, {
          ...
          inner: S(() => [r("div", Te, [(t(!0), a($, null, U(s.details, (n, l) => (t(), a($, {
            key: n.label
  ...
  Ce = C({
    ...
    setup(h) {
      ...
      return (e, u) => {
        ...
        }, null, 8, ["class"])) : i(s) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in e ? e.WALLET_LOCAL_AND_REMOTE_STATUS : i(g)).CONNECTED ? L(e.$slots, "default", {
          key: 3
        }, void 0, !0) : k("", !0)
      }
    }
    ...
    setup(h) {
      ...
      return (e, u) => {
        ...
        const o = q,
          n = j,
          l = G;
        return t(), a("div", Le, [e.isReleased ? k("", !0) : (t(), a("div", Ae, [r("div", we, [r("div", Ee, [e.total !== void 0 && e.collected !== void 0 || e.percent ? (t(), a($, {
          key: 1
          ...
          key: 0
        }, [V(d(p.value), 1)], 64)) : p.value === null ? (t(), a($, {
          key: 1
        }, [V(" — ")], 64)) : (t(), a($, {
          key: 2
    ...
    setup(h) {
      return (s, m) => {
        ...
        return t(), b(u, {
          ...
          default: S(() => [L(s.$slots, "top", {}, () => [r("div", at, [m[0] || (m[0] = r("div", {
            class: "left"
          }, null, -1)), r("div", lt, [L(s.$slots, "top-center", {}, void 0, !0)]), r("div", it, [L(s.$slots, "top-right", {}, void 0, !0)])])], !0), r("div", rt, [L(s.$slots, "default", {}, void 0, !0)]), E(e, {
            "ignore-tabs": "",
            "hide-space": ""
          }, {
            default: S(() => [r("div", ct, [r("div", ut, [L(s.$slots, "bottom-action", {}, void 0, !0)]), s.$slots["bottom-helpers"] ? (t(), a("div", dt, [L(s.$slots, "bottom-helpers", {}, void 0, !0)])) : k("", !0)])]),
            _: 3
          })]),
          _: 3
        })
...
export {
  Tt as _, bt as a, yt as b, $t as c, Lt as d, At as e, wt as f, Ct as g
};