    ...
    setup(g) {
      ...
      return (_, b) => {
        ...
        return a(), d("div", an, [o("div", rn, [o("div", ln, [b[2] || (b[2] = o("i", {
          ...
          }, null, 8, ["position"])])], 544), (a(!0), d(R, null, L(e(F), (I, x) => (a(), d("div", {
            key: I,
            class: j([
              [{
                active: e(n) === I
    ...
    setup(g) {
      ...
      return (F, r) => {
        ...
        return a(), d("div", {
          ...
          key: u.title,
          class: "card"
        }, [o("div", bn, m(u.title), 1), o("div", hn, m(u.value), 1), o("div", $n, [(a(!0), d(R, null, L(u.text, i => (a(), d("span", {
          key: i.value,
          class: j([{
    ...
    setup(g) {
      ...
      return (n, F) => {
        const r = J,
          f = ve,
          u = ge;
        return a(), d("div", Cn, [o("div", Bn, [(a(!0), d(R, null, L(e(s), i => (a(), d("div", {
          key: i.title,
          class: "section"
        }, [c(r, {
          icon: i.icon,
          class: "icons"
        }, null, 8, ["icon"]), o("div", Sn, m(i.title), 1), i.subtitle ? (a(), d("div", Tn, m(i.subtitle), 1)) : D("", !0), c(f, {
          class: "cards",
          type: i.type,
    ...
    setup(g) {
      ...
      return (n, F) => {
        ...
        return a(), d("div", Rn, [e(s) ? (a(), d("div", On, [c(r, {
          class: "background"
        }), o("div", En, m(("t" in n ? n.t : e(l))("frens.ton.title")), 1), n.tonAmount ? (a(), d("div", Ln, m(("getWalletAmount" in n ? n.getWalletAmount : e(te))(n.tonAmount, "TON").defaultWithSymbol), 1)) : (a(), w(f, {
          key: 1,
    ...
    setup(g) {
      return (t, s) => {
        ...
        return a(), d("div", rt, [o("div", it, [o("div", lt, m(t.fren.letterAvatar), 1), t.fren.avatarUrl ? Ne((a(), d("img", {
          ...
          [r]
        ]) : D("", !0)]), o("div", dt, [o("div", mt, m(t.fren.username), 1), o("div", ut, [c(n, {
          name: "users",
          class: "icon"
    ...
    setup(g, {
      ...
      return Ke().initHandler(() => s("close"), "frens-referral-modal"), (n, F) => {
        const r = vt,
          f = on;
        return a(), w(f, null, {
          default: k(() => [o("div", gt, [o("div", Ft, m(("t" in n ? n.t : e(l))("frens.referrals.title")), 1), o("div", bt, [(a(!0), d(R, null, L(n.frens, u => (a(), w(r, {
            key: u.username,
            fren: u
          }, null, 8, ["fren"]))), 128))])])]),
          _: 1
  ...
  Tt = $({
    ...
    setup(g) {
      ...
      const i = () => {
        ...
        _ = U(!1),
        b = U(!1),
        A = async () => ae(await E.getFrens({
          pageSize: 1e3
        })), S = async () => {
          const v = await E.getFrensUsing();
          if (!re(v)) return v;
          if (!v.data.enableNewBalance) return V({
            frensUsing: v.data,
        ...
        }, T = async () => ae(await E.getFrensTradingUsing()), H = v => {
          i();
          ...
          if (!r.value.enableNewBalance) {
            ...
            return y.err ? y : (O.exec(), V(y.data.claimBalance))
          }
          const p = await E.claimWalletFrensBalance();
          return p.err ? p : (O.exec(), V(p.data.amount))
        }, x = v => {
          Ge().makeConfetti();
          const p = G(v);
        ...
        return a(), d("div", St, [e(F) && e(r) && e(f) && e(K) && e(n) ? (a(), d(R, {
          ...
          ton: k(() => {
            ...
            return [c(he, {
              ...
              "onOpen:referral": p[0] || (p[0] = Lt => b.value = !0)
