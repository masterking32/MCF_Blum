    ...
    setup(U, {
      ...
      return (e, n) => {
        ...
        return f(), y(D, null, [_(d, {
          ...
          default: O(() => [k("div", ue, [U.canDelete ? (f(), b(p, {
            key: 0,
      ...
      const s = u,
        ...
        l = N(() => {
          switch (t.value) {
            ...
            case "SUCCESS":
              return {
                status: E.SUCCESS, caption: i("welcome.username.input.caption.success")
              };
            case "TAKEN":
              return {
                status: E.ERROR, caption: i("welcome.username.input.caption.already_taken")
              };
            case "INVALID":
              return {
                status: E.ERROR, caption: i("welcome.username.input.caption.invalid")
              };
            case "UNKNOWN":
              return {
                status: E.ERROR, caption: i("welcome.username.input.caption.unknown_error")
              };
            default:
  ...
  Se = I({
    ...
    setup(U) {
      ...
      const m = N(() => {
          ...
          if (a) return $.getTgAvatarUrl(a)
        }),
        c = async a => {
          t.value = "LOADING";
          const e = await $.authOrCreate({
            query: u.data,
            username: a.username,
      ...
      return (a, e) => {
        const n = Ie,
          p = le;
        return f(), y("div", Ne, [o(t) === "USERNAME" ? (f(), b(n, {
          key: "onboarding",
          "tg-avatar-url": o(m),
