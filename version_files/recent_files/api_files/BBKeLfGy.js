    ...
    setup(r) {
      ...
      return (s, n) => {
        ...
        const o = $i,
          a = Ii,
          i = Li;
        return S(), I("div", Ji, [s.isReleased ? qe("", !0) : (S(), I("div", Wi, [N("div", Ui, [N("div", Vi, [s.total !== void 0 && s.collected !== void 0 || s.percent ? (S(), I(Pe, {
          key: 1
        }, [s.percent !== void 0 ? (S(), I("span", Ki, V(`${H(Ci)(s.percent)}%`), 1)) : qe("", !0), s.total !== void 0 && s.collected !== void 0 ? (S(), I("span", zi, V(`${("formatTon"in s?s.formatTon:H(Is))(s.collected,2)}/${("formatTon"in s?s.formatTon:H(Is))(s.total,2)} TON`), 1)) : qe("", !0)], 64)) : (S(), st(o, {
          key: 0,
          class: "skeleton"
        }))]), (d = s.marketDetails) != null && d.statistics ? (S(), I("div", Hi, [N("div", Yi, [Ut(a, {
          name: "personal",
          class: "icon"
        }), s.marketDetails.statistics.holdersCount ? (S(), I("span", Qi, V(("formatCount" in s ? s.formatCount : H(Ce))(s.marketDetails.statistics.holdersCount, 0).full), 1)) : (S(), I("span", Zi, "—"))]), N("div", Xi, [Ut(a, {
          name: "transfer",
          class: "icon"
        }), s.marketDetails.statistics.transactionsCount ? (S(), I("span", ec, V(("formatCount" in s ? s.formatCount : H(Ce))(s.marketDetails.statistics.transactionsCount, 0).full), 1)) : (S(), I("span", tc, "—"))]), N("div", rc, [s.marketDetails.statistics.marketCap ? (S(), I(Pe, {
          key: 0
        }, [N("span", sc, V(("t" in s ? s.t : H(v))("memepad.jetton.stats.market_cap")), 1), N("span", nc, V(`$${("formatCount"in s?s.formatCount:H(Ce))(s.marketDetails.statistics.marketCap).full}`), 1)], 64)) : (S(), I("span", oc, "—"))])])) : (S(), st(i, {
          key: 1,
          text: ("t" in s ? s.t : H(v))("memepad.jetton.market_info_tooltip.text"),
          "text-min-width": 155,
          "text-max-width": 155
        }, {
          default: Pi(() => [N("button", ac, [Ut(a, {
            name: "circle-help",
            class: "icon"
          ...
          class: "dollar"
        }, "$", -1)), N("span", null, V(("formatCount" in s ? s.formatCount : H(Ce))(s.marketDetails.marketCap).full), 1)])) : (S(), st(o, {
          key: 1,
          class: "skeleton"
        }))]), N("div", mc, [(S(!0), I(Pe, null, ji(H(t), c => (S(), I("div", {
          key: c.title,
          class: "item"
        }, [N("span", hc, V(c.title), 1), c.value === void 0 ? (S(), st(o, {
          key: 0,
          class: "skeleton"
        })) : (S(), I("span", fc, [typeof c.value == "string" ? (S(), I(Pe, {
          key: 0
        }, [xs(V(c.value), 1)], 64)) : c.value === null ? (S(), I(Pe, {
          key: 1
        }, [xs(" — ")], 64)) : (S(), I(Pe, {
          key: 2
...
class Jr {
  ...
  async sendBuy(e, t, s) {
    ...
    s.buyerAddress && n.storeAddress(s.buyerAddress), await e.internal(t, {
      value: s.tons + Cc.Constants.CoinBuyGas,
  ...
  async getUserWallet(e, t) {
    ...
    return e.open(Pc.BclWallet.createFromAddress(s))
  }
}
$e.BclJetton = Jr;
var ze = {},
...
var Sd = wt,
  ...
  Bt = !!Object.getOwnPropertySymbols && !Ed(function() {
    ...
    return !Pd(r) || !(Object(r) instanceof Symbol) || !Symbol.sham && un && un < 41
  }),
  qd = Bt,
...
var eu = ce,
  ...
  la = function(r, e) {
    var t = Su(r),
      ...
      n = [],
      o;
    for (o in t) !ir(Cu, o) && ir(t, o) && kn(n, o);
  ...
  Sr = function(r, e, t, s) {
    ...
    if (cp(n)) {
      var h = dp(n),
        y = o ? s.nodes : h ? [] : {};
      if (h)
        for (i = y.length, l = Pn(n), c = 0; c < l; c++) xn(n, c, Sr(n, "" + c, t, c < i ? y[c] : void 0));
      else
        for (d = fp(n), l = Pn(d), c = 0; c < l; c++) m = d[c], xn(n, m, Sr(n, m, t, lp(y, m) ? y[m] : void 0))
    }
    return ip(t, r, e, n, a)
  },
  xn = function(r, e, t) {
...
va.f = kp && !Sp ? Object.defineProperties : function(e, t) {
  Cp(e);
  for (var s = Pp(t), n = qp(t), o = n.length, a = 0, i; o > a;) Ep.f(e, i = n[a++], s[i]);
  return e
};
var jp = Ze,
  ...
  mt, _t = function() {
    ...
    for (var r = Bn.length; r--;) delete _t[Cr][Bn[r]];
    return _t()
  };
Np[Aa] = !0;
var Lp = Object.create || function(e, t) {
    var s;
    return e !== null ? (pr[Cr] = Bp(e), s = new pr, pr[Cr] = null, s[Aa] = e) : s = _t(), t === void 0 ? s : Op.f(s, t)
  },
  Jp = ge,
  Wp = ce,
  Up = Lp;
...
var tm = G,
  ...
  vm = function(r) {
    return fm && Ca && ls(r) && !ds(r, ie) && us(r), r
  },
  bm = function() {
    Am.enable = function() {}, Ca = !0;
    var r = Mn.f,
      e = dm([].splice),
      t = {};
...
var dh = Qe,
  ...
  Sh = _e(de.getTime),
  Eh = _e(de.getUTCDate),
  Ch = _e(de.getUTCFullYear),
  Ph = _e(de.getUTCHours),
  ...
  Rh = Xn(function() {
    ...
    var e = this,
      ...
      s = qh(e),
      n = t < 0 ? "-" : t > 9999 ? "+" : "";
    return n + be(kh(t), n ? 6 : 4, 0) + "-" + be(Ih(e) + 1, 2, 0) + "-" + be(Eh(e), 2, 0) + "T" + be(Ph(e), 2, 0) + ":" + be(jh(e), 2, 0) + ":" + be(xh(e), 2, 0) + "." + be(s, 3, 0) + "Z"
  } : yr,
  Bh = ge,
  Ba = Se,
  Oh = Xr,
...
function jf(r) {
  return encodeURI("" + r).replace(Pf, "|")
}

function Or(r) {
  return jf(typeof r == "string" ? r : JSON.stringify(r)).replace(hs, "%2B").replace(qf, "+").replace(Tf, "%23").replace($f, "%26").replace(Cf, "`").replace(Ef, "^").replace(kf, "%2F")
}
...
const Sy = (r, e) => r.some(t => typeof t == "string" ? t === e : (t.lastIndex = 0, t.test(e))),
  ...
  Co = r => typeof r == "object" && r !== null && !(r instanceof RegExp) && !(r instanceof Error) && !(r instanceof Date),
  Po = (r, e = {}) => {
    if (!Co(r)) return r;
    const {
      exclude: t,
...
class Py {
  ...
  async getAsset(e) {
    return P(await this.apiFetch(...C("/v1/assets/{assetAddress}", {
      method: "GET",
      query: {
        assetAddress: e
      }
  ...
  async getAssets() {
    return P(await this.apiFetch(...C("/v1/assets", {
      method: "GET"
    }))).assetList
  }
  async queryAssets({
    ...
    return P(await this.apiFetch(...C("/v1/assets/query", {
      method: "POST",
      query: {
        ...t,
  ...
  async searchAssets({
    ...
    return P(await this.apiFetch(...C("/v1/assets/search", {
      method: "POST",
      query: {
        ...t,
        unconditionalAsset: e
  ...
  async getFarm(e) {
    return P(await this.apiFetch(...C("/v1/farms/{farmAddress}", {
      method: "GET",
      query: {
        farmAddress: e
      }
  ...
  async getFarms(e) {
    return P(await this.apiFetch(...C("/v1/farms", {
      method: "GET",
      query: e
    }))).farmList
  }
  async getFarmsByPool(e) {
    return P(await this.apiFetch(...C("/v1/farms_by_pool/{poolAddress}", {
      method: "GET",
      query: {
        poolAddress: e
      }
  ...
  async getSwapPairs(e) {
    return P(await this.apiFetch(...C("/v1/markets", {
      method: "GET",
      query: e
    }))).pairs
  }
  async getSwapStatus(e) {
    return P(await this.apiFetch(...C("/v1/swap/status", {
      method: "GET",
      query: e
    })))
  }
  async getPool(e) {
    return P(await this.apiFetch(...C("/v1/pools/{poolAddress}", {
      method: "GET",
  ...
  async getPools(e) {
    return P(await this.apiFetch(...C("/v1/pools", {
      method: "GET",
      query: e
    }))).poolList
  }
  async queryPools({
    ...
    return P(await this.apiFetch(...C("/v1/pool/query", {
      method: "POST",
      query: {
        ...t,
        unconditionalAsset: e
  ...
  async simulateSwap({
    ...
    return P(await this.apiFetch(...C("/v1/swap/simulate", {
      method: "POST",
      query: {
        ...t,
        units: e
  ...
  async simulateReverseSwap({
    ...
    return P(await this.apiFetch(...C("/v1/reverse_swap/simulate", {
      method: "POST",
      query: {
        ...t,
        units: e
  ...
  async getJettonWalletAddress(e) {
    return P(await this.apiFetch(...C("/v1/jetton/{jettonAddress}/address", {
      method: "GET",
      query: e
    }))).address
  }
  async getWalletAsset(e) {
    return P(await this.apiFetch(...C("/v1/wallets/{walletAddress}/assets/{assetAddress}", {
      method: "GET",
      query: e
    }))).asset
  }
  async getWalletAssets(e) {
    return P(await this.apiFetch(...C("/v1/wallets/{walletAddress}/assets", {
      method: "GET",
      query: {
        walletAddress: e
      }
  ...
  async getWalletFarm(e) {
    return P(await this.apiFetch(...C("/v1/wallets/{walletAddress}/farms/{farmAddress}", {
      method: "GET",
      query: e
    }))).farm
  }
  async getWalletFarms(e) {
    return P(await this.apiFetch(...C("/v1/wallets/{walletAddress}/farms", {
      method: "GET",
      query: typeof e == "string" ? {
        walletAddress: e
      } : e
  ...
  async getWalletPool(e) {
    return P(await this.apiFetch(...C("/v1/wallets/{walletAddress}/pools/{poolAddress}", {
      method: "GET",
      query: e
    }))).pool
  }
  async getWalletPools(e) {
    return P(await this.apiFetch(...C("/v1/wallets/{walletAddress}/pools", {
      method: "GET",
      query: typeof e == "string" ? {
        walletAddress: e
      } : e
  ...
  async getWalletOperations({
    ...
    return P(await this.apiFetch(...C("/v1/wallets/{walletAddress}/operations", {
      method: "GET",
      query: {
        ...s,
        since: ft(e),
  ...
  async getOperations({
    ...
    return P(await this.apiFetch(...C("/v1/stats/operations", {
      method: "GET",
      query: {
        since: ft(e),
        until: ft(t)
  ...
  async getRouters(e) {
    return P(await this.apiFetch(...C("/v1/routers", {
      method: "GET",
      query: e
    }))).routerList
  }
  async getRouter(e) {
    return P(await this.apiFetch(...C("/v1/routers/{routerAddress}", {
      method: "GET",
      query: {
        routerAddress: e
      }
