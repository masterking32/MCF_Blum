    ...
    setup(e, {
      ...
      return (o, d) => {
        ...
        return u(), C(m, {
          ...
          default: N(() => [n(l).label ? (u(), A("div", Vt, U(n(l).label), 1)) : n(l).icon ? (u(), C(v, {
            key: 1,
            name: n(l).icon,
            class: "icon"
...
`).reduce((m, c) => {
      ...
      return (b, m) => {
        ...
        return u(), C(p, {
          ...
          title: N(() => [n(l).state === "general" ? (u(), A("span", Wt, [oe(T("img", {
            src: e.iconUrl,
            alt: "Task icon"
          }, null, 8, Yt), [
            [h]
          ]), T("span", null, U(e.productName), 1)])) : I("", !0), n(l).state === "details" ? (u(), A("span", Qt, "Disclaimer")) : I("", !0)]),
          default: N(() => [n(l).state === "general" ? (u(), A("div", zt, [m[8] || (m[8] = T("div", {
            class: "text"
