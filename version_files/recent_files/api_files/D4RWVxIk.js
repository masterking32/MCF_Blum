...
var re = (s => (s.ERROR = "ERROR", s.LOADING = "LOADING", s.LOADED = "LOADED", s))(re || {}),
  x = (s => (s.GENERAL = "general", s.ICON = "icon", s.BANNER = "banner", s.NONE = "none", s))(x || {});
const tt = s => {
    ...
    setup(s, {
      ...
      const p = t,
        ...
        U = async () => {
          ...
          o.value.info !== null && (W(x.NONE), p("select", {
            ...o.value.info,
            ...w
          }))
        }, b = () => {
  ...
  nt = async s => {
    ...
    setup(s, {
      ...
      const t = s,
        ...
        C = () => {
          var n;
          u.value = !0, (n = f.value) == null || n.setAppearance(x.GENERAL)
        },
        O = Ee(() => {
        ...
        W = () => {
          var n, T;
          if (t.withAgent) {
            (n = f.value) == null || n.setAppearance(x.ICON);
            return
        ...
        d = async ({
          ...
          var K;
          const T = await nt(n);
          j(T) ? ((K = i.value) == null || K.selectFile(T.data), H().memepad.memepadJettonSelectJettonIcon({
            flowType: t.withAgent ? I.AI : I.REGULAR,
            aiPowered: !0
    ...
    setup(s, {
      ...
      const t = s,
        ...
        N = () => {
          var g;
          !t.withAgent || o.value.bannerFileKey !== void 0 || (g = f.value) == null || g.setAppearance(x.BANNER)
        },
        v = async ({
          imageUrl: g
        }) => {
          ...
          var C;
          const k = await nt(g);
          j(k) ? ((C = i.value) == null || C.selectFile(k.data), H().memepad.memepadJettonSelectJettonBanner({
            flowType: t.withAgent ? I.AI : I.REGULAR,
            aiPowered: !1
          })) : se().error(m("memepad.new.ai_generate.load_image_error"))
        };
      ...
      const F = E(() => !v.value || !t.balances.tokenBalance ? !1 : t.balances.tokenBalance.value.gte(v.value.feesInfo.total.value)),
        ...
        C = async () => {
          ...
          if (t.withAgent && new Date(t.state.stepTokenInfo.promptExpireAt) < new Date) {
            ...
            j(A) ? p("continue", A.data) : se().success(m("memepad.jetton.new.error_alert"))
          })(), f.value = !1)
        }, O = async () => {
          ...
          !new Ce(d).eq(i.value.share) || !j(S) || (i.value = {
            status: "loaded",
            share: d,
            overview: S.data
          }, p("update", {
            share: d,
            overview: j(S) ? S.data : void 0
          }))
        }, {
          debouncedFunction: W
        } = Ee(O, 200);
          ...
          "bottom-action": M(() => [_("div", ba, [e(v) ? (a(), L(n, {
            ...
            default: M(() => {
              ...
              return [((te = (P = e(v)) == null ? void 0 : P.error) == null ? void 0 : te.type) === e(Qe).NOT_ENOUGH_TOKEN ? (a(), L(T, {
                ...
                source: ("ANALYTICS_MEMEPAD_OPERATION_SOURCE" in d ? d.ANALYTICS_MEMEPAD_OPERATION_SOURCE : e(He)).LAUNCH,
    ...
    setup(s) {
      ...
      const {
        ...
        }), ze(w.data)) : (r.memepad.memepadJettonLaunchWalletUiError({
          flowType: s.withAgent ? I.AI : I.REGULAR,
