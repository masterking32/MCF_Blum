    ...
    setup(n) {
      ...
      return (i, o) => {
        ...
        return rt(), ut("div", xi, [at(u, {
          ...
          default: xt(() => [Y("div", zi, ot(("t" in i ? i.t : U(ct))("wallet.points.meme_modal.title")), 1), Y("div", Ui, [(rt(!0), ut($e, null, hs(U(s), (b, A) => (rt(), ut("div", {
            key: A,
            class: "item",
            onClick: k => b.onClick()
            ...
            name: "chevron-right",
            class: "icon"
          })]), Y("div", Vi, [b.reward ? (rt(), ut("span", Qi, ot(r(b.reward)), 1)) : ce("", !0), b.postfix ? (rt(), ut("span", Ji, ot(" " + b.postfix), 1)) : ce("", !0)])]), at(h, {
            name: b.icon,
            class: "image"
      ...
      return (i, o) => {
        ...
        return rt(), Gt(C, {
          ...
          default: xt(() => [i.state.type !== "loading" ? (rt(), ut("div", oa, [Y("div", ca, [at(u, {
            ...
            src: i.state.asset.imageUrl
          }, null, 8, Fa)]), Y("div", Na, ot(i.state.asset.symbol), 1), Y("div", ja, ot(r(i.state.amount, i.state.asset.symbol)), 1)]), at(h, {
...
(function(n) {
  ...
  function u(A) {
    ...
    return new A(function() {
        ...
        for (k.data = K = ++K % 2; y < w.length;) v = w[y], y++, y === w.length && (w = null), v()
      }).observe(k, {
        characterData: !0
      }),
      function(v) {
...
(function(n) {
  var t = tt && tt.__awaiter || function(p, C, b, A) {
      ...
      return new(b || (b = Promise))(function(f, w) {
        ...
        function v(m) {
          m.done ? f(m.value) : k(m.value).then(K, y)
        }
  ...
  var _ = function(p, C) {
    ...
    return t(void 0, s([p, C], b, !0), void 0, function(k, f, w) {
      ...
      return w === void 0 && (w = "10000000"), e(this, function($) {
        switch ($.label) {
          case 0:
            K = r.Address.parseFriendly(k).address.toRawString(), $.label = 1;
          case 1:
...
(function(n) {
  var t = tt && tt.__assign || function() {
    ...
    e = tt && tt.__createBinding || (Object.create ? function(k, f, w, K) {
      K === void 0 && (K = w);
    ...
    A = function() {
      ...
      return k.prototype.destory = function() {
        ...
        var f = this.state.getState(),
          ...
          K = f.userAddress,
          y = f.claimId,
          v = w && K && y ? k.getStorageKey(w, K, y) : null;
      ...
      }, k.getStorageKey = function(f, w, K) {
...
function Jo(n, t, e, s, r, i, o) {
  try {
    ...
    var u = wt(i) ? 0 : V(i, c.__wbindgen_malloc, c.__wbindgen_realloc),
      _ = H;
    c.executeLocal(b, A, k, f, w, K, y, s, r, u, _, !wt(o), wt(o) ? 0 : o);
...
function uc(n, t, e, s, r, i, o) {
  ...
  try {
    ...
    const l = V(i, c.__wbindgen_malloc, c.__wbindgen_realloc),
      d = H;
    c.encodeInternalMessage(F, h, p, $, B, e, C, b, A, k, l, d, wt(o) ? 16777215 : o ? 1 : 0);
...
function kc(n, t, e, s, r, i, o) {
  try {
    ...
    var u = wt(r) ? 0 : V(r, c.__wbindgen_malloc, c.__wbindgen_realloc),
      _ = H;
    c.createExternalMessageWithoutSignature(b, n.__wbg_ptr, A, k, f, w, K, y, u, _, J(i), o);
    var h = R().getInt32(b + 4 * 0, !0),
      p = R().getInt32(b + 4 * 1, !0),
      C = R().getInt32(b + 4 * 2, !0);
    if (C) throw W(p);
...
function Ic(n, t, e, s, r, i, o, u) {
  try {
    ...
    const m = V(o, c.__wbindgen_malloc, c.__wbindgen_realloc),
      F = H;
    c.createExternalMessage(A, n.__wbg_ptr, k, f, w, K, y, v, _, h, J(i), m, F, u);
...
function nn(n, t, e, s) {
  typeof s > "u" && (s = Rr()), cs(n, "", 0, [], void 0, 0, s);
  var r;
  try {
...
function $r(n) {
  ...
  function y(l, d) {
    ...
    if (d == null) {
      ...
      if ((I = typeof l == "number") && l * 0 == 0) {
        ...
        if (!dl.test(j = String(l))) return s(L, j, I);
      ...
      if (j = String(l), I = typeof l == "number") {
        if (l * 0 != 0) return s(L, j, I, d);
        if (L.s = 1 / l < 0 ? (j = j.slice(1), -1) : 1, y.DEBUG && j.replace(/^0\.0*|\./, "").length > 15) throw Error(Ys + l)
      ...
      for (g = w.slice(0, d), O = N = 0, M = j.length; N < M; N++)
        ...
        } I = !1, j = e(j, d, 10, L.s), (O = j.indexOf(".")) > -1 ? j = j.replace(".", "") : O = j.length
    }
  ...
  y.clone = $r, y.ROUND_UP = 0, y.ROUND_DOWN = 1, y.ROUND_CEIL = 2, y.ROUND_FLOOR = 3, y.ROUND_HALF_UP = 4, y.ROUND_HALF_DOWN = 5, y.ROUND_HALF_EVEN = 6, y.ROUND_HALF_CEIL = 7, y.ROUND_HALF_FLOOR = 8, y.EUCLID = 9, y.config = y.set = function(l) {
    var d, g;
    if (l != null)
      if (typeof l == "object") {
    ...
    return function(g) {
      ...
      if (g == null ? g = o : Ct(g, 0, Ft), N = Xn(g / it), b)
        if (crypto.getRandomValues) {
          for (P = crypto.getRandomValues(new Uint32Array(N *= 2)); M < N;) I = P[M] * 131072 + (P[M + 1] >>> 11), I >= 9e15 ? (T = crypto.getRandomValues(new Uint32Array(2)), P[M] = T[0], P[M + 1] = T[1]) : (j.push(I % 1e14), M += 2);
          M = N / 2
        } else if (crypto.randomBytes) {
        for (P = crypto.randomBytes(N *= 7); M < N;) I = (P[M] & 31) * 281474976710656 + P[M + 1] * 1099511627776 + P[M + 2] * 4294967296 + P[M + 3] * 16777216 + (P[M + 4] << 16) + (P[M + 5] << 8) + P[M + 6], I >= 9e15 ? crypto.randomBytes(7).copy(P, M) : (j.push(I % 1e14), M += 7);
        M = N / 7
      } else throw b = !1, Error(Jt + "crypto unavailable");
      if (!b)
        for (; M < N;) I = d(), I < 9e15 && (j[M++] = I % 1e14);
      for (N = j[--M], g %= it, N && g && (I = Zn[it - g], j[M] = ee(N / I) * I); j[M] === 0; j.pop(), M--);
      if (M < 0) j = [O = 0];
      else {
        for (O = -1; j[0] === 0; j.splice(0, 1), O -= it);
        for (M = 1, I = j[0]; I >= 10; I /= 10, M++);
        M < it && (O -= it - M)
      }
    ...
    function d(g, P, T, O) {
      for (var N, I = [0], M, j = 0, L = g.length; j < L;) {
        for (M = I.length; M--; I[M] *= P);
        for (I[0] += O.indexOf(g.charAt(j++)), N = 0; N < I.length; N++) I[N] > T - 1 && (I[N + 1] == null && (I[N + 1] = 0), I[N + 1] += I[N] / T | 0, I[N] %= T)
      }
      return I.reverse()
    }
    return function(g, P, T, O, N) {
      var I, M, j, L, z, et, nt, _t, vt = g.indexOf("."),
        Pt = o,
        dt = u;
      for (vt >= 0 && (L = k, k = 0, g = g.replace(".", ""), _t = new y(P), et = _t.pow(g.length - vt), k = L, _t.c = d(de(te(et.c), et.e, "0"), 10, T, l), _t.e = _t.c.length), nt = d(g, P, T, N ? (I = w, l) : (I = l, w)), j = L = nt.length; nt[--L] == 0; nt.pop());
      if (!nt[0]) return I.charAt(0);
      if (vt < 0 ? --j : (et.c = nt, et.e = j, et.s = O, et = t(et, _t, Pt, dt, T), nt = et.c, z = et.r, j = et.e), M = j + Pt + 1, vt = nt[M], L = T / 2, z = z || M < 0 || nt[M + 1] != null, z = dt < 4 ? (vt != null || z) && (dt == 0 || dt == (et.s < 0 ? 3 : 2)) : vt > L || vt == L && (dt == 4 || z || dt == 6 && nt[M - 1] & 1 || dt == (et.s < 0 ? 8 : 7)), M < 1 || !nt[0]) g = z ? de(I.charAt(1), -Pt, I.charAt(0)) : I.charAt(0);
      else {
        if (nt.length = M, z)
    ...
    function l(P, T, O) {
      var N, I, M, j, L = 0,
        ...
        et = T % me,
        nt = T / me | 0;
      for (P = P.slice(); z--;) M = P[z] % me, j = P[z] / me | 0, N = nt * M + j * et, I = et * M + N % me * me + L, L = (I / O | 0) + (N / me | 0) + nt * j, P[z] = I % O;
    ...
    return function(P, T, O, N, I) {
      ...
      for (vt = new y(Vt), Pt = vt.c = [], j = P.e - T.e, Vt = O + j + 1, I || (I = ie, j = ne(P.e / it) - ne(T.e / it), Vt = Vt / it | 0), L = 0; At[L] == (Nt[L] || 0); L++);
  ...
  function v(l, d, g, P) {
    ...
    else if (l = $(new y(l), d, g), O = l.e, M = te(l.c), I = M.length, P == 1 || P == 2 && (d <= O || O <= _)) {
      for (; I < d; M += "0", I++);
      M = pn(M, O)
  ...
  function $(l, d, g, P) {
    ...
    if (z) {
      t: {
        ...
        M = z[j = 0],
        L = ee(M / et[T - N - 1] % 10);
        else if (j = Xn((O + 1) / it), j >= z.length)
          if (P) {
            for (; z.length <= j; z.push(0));
            M = L = 0, T = 1, O %= it, N = O - it + 1
          } else break t;
        else {
          for (M = I = z[j], T = 1; I >= 10; I /= 10, T++);
        ...
        l;
        if (O == 0 ? (z.length = j, I = 1, j--) : (z.length = j + 1, I = et[it - O], z[j] = N > 0 ? ee(M / et[T - N] % et[N]) * I : 0), P)
          for (;;)
            if (j == 0) {
  ...
  return r.absoluteValue = r.abs = function() {
    ...
    for (I ? (g = new y(.5), M && (l.s = 1), j = _n(l)) : (T = Math.abs(+B(l)), j = T % 2), L = new y(i);;) {
      if (j) {
    ...
    if (M = ne(M), j = ne(j), L = L.slice(), I = M - j) {
      for ((O = I < 0) ? (I = -I, T = L) : (j = M, T = z), T.reverse(), d = I; d--; T.push(0));
      T.reverse()
    } else
    ...
    var g, P, T, O, N, I, M, j, L, z, et, nt, _t, vt, Pt, dt = this,
      ht = dt.c,
      Rt = (l = new y(l, d)).c;
    ...
    for (vt = ie, Pt = me, T = z; --T >= 0;) {
      for (g = 0, et = Rt[T] % Pt, nt = Rt[T] / Pt | 0, N = M, O = T + N; O > T;) j = ht[--N] % Pt, L = ht[N] / Pt | 0, I = nt * j + L * et, j = et * j + I % Pt * Pt + _t[O] + g, g = (j / vt | 0) + (I / Pt | 0) + nt * L, _t[O--] = j % vt;
      _t[O] = g
    }
    ...
    if (I = Math.sqrt(+B(O)), I == 0 || I == 1 / 0 ? (d = te(N), (d.length + M) % 2 == 0 && (d += "0"), I = Math.sqrt(+d), M = ne((M + 1) / 2) - (M < 0 || M % 2), I == 1 / 0 ? d = "5e" + M : (d = I.toExponential(), d = d.slice(0, d.indexOf("e") + 1) + M), g = new y(d)) : g = new y(I + ""), g.c[0]) {
      for (M = g.e, I = M + j, I < 3 && (I = 0);;)
        if (T = g, g = L.times(T.plus(t(O, T, j, 1))), te(T.c).slice(0, I) === (d = te(g.c)).slice(0, I))
    ...
    if (P = T.toFixed(l, d), T.c) {
      ...
      if (M && (O = I, I = M, M = O, _t -= O), I > 0 && _t > 0) {
        for (O = _t % I || I, L = nt.substr(0, O); O < _t; O += I) L += j + nt.substr(O, I);
    ...
    var d, g, P, T, O, N, I, M, j, L, z, et, nt = this,
      _t = nt.c;
    ...
    for (d = new y(i), j = g = new y(i), P = M = new y(i), et = te(_t), O = d.e = et.length - nt.e - 1, d.c[0] = Zn[(N = O % it) < 0 ? it + N : N], l = !l || I.comparedTo(d) > 0 ? O > 0 ? d : j : I, N = C, C = 1 / 0, I = new y(et), M.c[0] = 0; L = t(I, d, 0, 1), T = g.plus(L.times(P)), T.comparedTo(l) != 1;) g = P, P = T, j = M.plus(L.times(T = j)), M = T, d = I.minus(L.times(T = d)), I = T;
...
(function(n) {
  ...
  const w = async (S, a) => {
    ...
    let Ot;
    if (Z.type === "external")
      if (G == null || typeof G == "string") Ot = i.default.nekoton.createRawExternalMessage(St, x, G, Kt + Qt).boc;
    ...
    try {
      ...
      }) => Promise.all([D ?? kt.getFullContractState(St), kt.getBlockchainConfig(), kt.getNetworkDescription()])), Lt = i.default.nekoton.makeFullAccountBoc(gt == null ? void 0 : gt.boc), pt = st == null ? void 0 : st.overrideBalance, Dt = i.default.nekoton.executeLocal(mt, Lt, Ot, Kt, (st == null ? void 0 : st.disableSignatureCheck) === !0, pt != null ? pt.toString() : void 0, yt.globalId);
    ...
    try {
      ...
      Lt = await pt.prepareMessage({
        ...
        timeout: 60,
        signatureId: ft
      }, new h.AccountsStorageContext(It, Kt, i.default.nekoton, Qt))
    } catch (pt) {
      throw Q(a, pt.toString())
    }
    ...
    const pt = "Message expired",
      Dt = await mt(60),
      zt = await Kt.sendMessageLocally(It, Dt).catch($t => {
  ...
  function si(S, a, E) {
    ge(S, a, E);
    const D = a[E];
    be(S, D, "isExact"), q(S, D, "lt"), ue(S, D, "hash")
  }
  ...
  function zn(S, a, E) {
    ge(S, a, E);
    const D = a[E];
    q(S, D, "balance"), oe(S, D, "lastTransactionId", si), be(S, D, "isDeployed")
  }

  function De(S, a, E) {
    ge(S, a, E);
    const D = a[E];
    q(S, D, "abi"), q(S, D, "method"), ge(S, D, "params")
  }

  function As(S, a, E) {
    const D = a[E];
    if (!(typeof D == "string" || D == null))
      if (typeof D == "object") q(S, D, "abi"), q(S, D, "method"), ge(S, D, "params");
    ...
    setup(n) {
      return (t, e) => {
        ...
        return rt(), ut("div", Nl, [at(s, {
          name: "animations/MoneyWings",
          size: 116
        }), Y("div", jl, ot(("t" in t ? t.t : U(ct))("wallet.drop.notification.content.title")), 1), Y("div", {
          class: "text",
    ...
    setup(n) {
      ...
      return (b, A) => {
        const k = aa,
          ...
          w = Fl,
          K = zl;
        return rt(), ut("div", Ul, [(rt(!0), ut($e, null, hs(U(i), y => (rt(), Gt(k, Os({
          key: y.asset.id,
          ref_for: !0
        }, y.asset, {
          onClick: v => {
...
export {
  Li as _, br as a, eu as b, Bl as c, Zi as d, aa as e, Ni as u
};