...
const bt = N({
  ...
  Ct = N({
    ...
    setup(e) {
      ...
      return (t, s) => (o(), T("div", yt, [e.title ? (o(), T("div", gt, q(e.title), 1)) : O("", !0), e.subtitle ? (o(), T("div", Tt, q(e.subtitle), 1)) : O("", !0), a(d) ? (o(), T("div", ht)) : O("", !0)]))
    }
  }),
  Ot = w(Ct, [
    ...
    setup(e, {
      ...
      return (l, n) => {
        ...
        return o(), h(r, {
          ...
          default: B(() => [a(c).label ? (o(), T("div", At, q(a(c).label), 1)) : a(c).icon ? (o(), h(v, {
            key: 1,
            name: a(c).icon,
            class: "icon"
...
`).reduce((r, p) => {
      ...
      return (S, r) => {
        ...
        return o(), h(f, {
          ...
          title: B(() => [a(c).state === "general" ? (o(), T("span", Et, [se(g("img", {
            src: e.iconUrl,
            alt: "Task icon"
          }, null, 8, Nt), [
            [y]
          ]), g("span", null, q(e.productName), 1)])) : O("", !0), a(c).state === "details" ? (o(), T("span", wt, "Disclaimer")) : O("", !0)]),
          default: B(() => [a(c).state === "general" ? (o(), T("div", Bt, [r[8] || (r[8] = g("div", {
            class: "text"
          }, [g("p", null, "Nothing in Blum is to be considered as being of promotional nature or aiming at commercial use."), g("p", null, "No material or information which may be made available in Blum shall constitute or be construed as a recommendation, endorsement, offer, invitation or solicitation to enter into any transaction with or purchase any product, or otherwise deal with securities, crypto assets or other products."), g("p", null, "You alone are solely responsible for determining whether any investment, security or any other product or service, is appropriate or suitable for you. You should consult an attorney or tax professional regarding your specific legal or tax situation.")], -1)), g("div", qt, [I(p, {
          ...
          }, "Disclaimer"), r[7] || (r[7] = be("."))])])])) : O("", !0), a(c).state === "details" ? (o(), T("div", Dt, [(o(), h(xe(a(v))))])) : O("", !0)]),
...
function xt(e, d) {
  return o(), T("div", Ft, [g("div", Pt, [j(e.$slots, "default", {}, void 0, !0)])])
}
const Kt = w(Ut, [
    ["render", xt],
    ...
    setup(e, {
      ...
      return (n, v) => {
        const S = Q,
          ...
          y = ae("img-error");
        return o(), h(f, null, {
          default: B(() => [g("div", Vt, [g("div", Gt, [se(g("img", {
            src: a(ie)(e.task.iconFileKey),
            alt: "Task icon",
            class: "task-icon"
          }, null, 8, Yt), [
            [y]
          ]), g("div", Wt, q(e.task.title), 1), I(S, {
            name: "external-link",
            class: "link-icon",
        ...
        return o(), h(k, {
          ...
          default: B(({
            ...
            return [g("div", je({
              ...
              [c]
            ]), g("div", Zt, [g("div", Jt, q(S.value), 1), r.value || n.value ? (o(), T("div", ea, [(m = r.value) != null && m.label ? (o(), T("span", ta, q(`${r.value.label}${r.value.postfix}`) + q(n.value ? ", " : ""), 1)) : O("", !0), n.value ? (o(), T("span", aa, q(n.value), 1)) : O("", !0)])) : O("", !0)]), e.task.status ? (o(), h(i, {
              key: 0,
              "claim-override": d.value,
      ...
      return (l, n) => {
        ...
        return o(), h(p, {
          ...
          default: B(({
            ...
            onClick: f
          }, [a(t) ? (o(), T("div", ra, [(o(!0), T(L, null, Y(a(i), (_, A) => se((o(), T("img", {
            key: A,
            src: a(ie)(_),
            alt: "Task icon",
            class: "icon",
            ...
            [m]
          ])), 128))])) : O("", !0), g("div", ua, q(C.value), 1), u.value ? (o(), T("div", da, q(u.value), 1)) : O("", !0), g("div", ma, [e.task.status ? (o(), h(v, {
            key: 0,
            "claim-override": k.value,
      ...
      return Ne().onOpenTaskSheet(d.task, () => {
        ...
        return o(), T(L, null, [(o(), h(Je, {
          ...
          default: B(() => [g("div", {
            ...
            class: "labe"
          }, "Invite and earn up to 8% revshare", -1))])) : O("", !0), e.task.bannerFileKey || e.task.description ? (o(), T("div", fa, [e.task.bannerFileKey ? (o(), h(f, {
            key: 0,
            url: a(ie)(e.task.bannerFileKey),
            alt: "Task banner",
            class: "banner"
          }, null, 8, ["url"])) : O("", !0), e.task.description ? (o(), T("div", ba, q(e.task.description), 1)) : O("", !0)])) : O("", !0), e.task.subTasks ? (o(), h(ye, {
            key: 2,
            tag: "div",
    ...
    setup(e, {
      ...
      return (n, v) => {
        const S = Ee,
          r = va,
          p = ya;
        return o(), T("div", ga, [e.mode === a(G).LIST_ITEM ? (o(), h(S, {
          key: 0,
    ...
    setup(e) {
      ...
      const d = e,
        ...
        s = $(() => d.subSections.map(l => ({
          value: l.title,
          label: l.title,
          dot: l.tasks.some(n => tt(n, t.value))
        }))),
      ...
      return (l, n) => {
        const v = dt,
          S = Q,
          r = we;
        return a(k).length ? (o(), T("div", Oa, [I(v, {
          modelValue: a(i),
    ...
    setup(e) {
      ...
      return (c, l) => {
        const n = Ot,
          v = Ca,
          S = Aa;
        return o(), T("div", _a, [a(k).title || a(k).description ? (o(), h(n, {
          key: 0,
          title: a(k).title,
...
function Fa(e, d) {
  const t = ft,
    s = Na;
  return o(), h(s, null, {
    default: B(() => [g("div", Ba, [I(t, {
      class: "title"
    }), g("div", qa, [(o(), T(L, null, Y(2, i => I(t, {
      key: i,
      class: "item"
    })), 64))]), g("div", Da, [I(t, {
      class: "subtitle"
    })]), g("div", Ma, [(o(), T(L, null, Y(2, i => I(t, {
      key: i,
      class: "item"
    })), 64))]), g("div", La, [I(t, {
      class: "subtitle"
    })]), g("div", Ua, [(o(), T(L, null, Y(7, i => g("div", {
      key: i,
      class: "item"
    }, [I(t, {
      class: "icon"
  ...
  Ya = N({
    ...
    setup(e) {
      const d = $(() => Ie().query.openTaskSheetId),
        ...
        s = M(),
        i = M({}),
        c = st(async () => rt(await ue.getTasksSections(X().$webApp.dataUnsafe.query.ref)), f => s.value = f, 15e3),
        l = (f, y) => {
          if (s.value)
        ...
        n = async f => {
          ...
          setTimeout(() => delete i.value[f.id], 3e3), f.reward.isZero() || lt().bottom.success(E("base.you_got_bp", {
            bp: Z(f.reward)
          }))
      ...
      return (async () => {
        ...
        const C = pt,
          D = Ea,
          b = Pa;
        return o(), T("div", xa, [a(t) ? (o(), h(C, {
          key: 0
        })) : a(s) ? (o(), T(L, {
          key: 1
        }, [g("div", Ka, [g("span", Va, [be(q(("t" in f ? f.t : a(E))("earn.title")) + " ", 1), g("sup", null, q(a(p)), 1)])]), g("div", Ga, [(o(!0), T(L, null, Y(a(s), (u, _) => (o(), h(D, {
          key: _,
