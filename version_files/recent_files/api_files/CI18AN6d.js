...
const G = t => {
  ...
  ae = b({
    ...
    setup(t) {
      return (n, e) => {
        const s = U;
        return i(), r("div", ne, [(i(!0), r(T, null, D(t.items, l => (i(), r("div", {
          key: l.text,
          class: S(["item", {
            "is-active": l.active
          }])
...
const Ie = y(ge, [
    ...
    setup(t) {
      ...
      return (s, l) => {
        ...
        return o(e) ? (i(), r("div", {
          ...
          name: o(e).icon,
          class: "icon"
        }, null, 8, ["name"]), d("div", Ue, f(o(e).label), 1)], 2)) : $("", !0)
      }
    }
  }),
  Ce = y(Se, [
    ...
    setup(t) {
      ...
      return (a, u) => {
        ...
        return i(), r("div", Ae, [m(_, {
          icon: o(e).icon
        }, null, 8, ["icon"]), d("div", Ke, [d("div", Oe, f(o(e).title), 1), o(s) ? (i(), r("div", De, f(o(s)), 1)) : $("", !0)]), o(l) ? (i(), r(T, {
          key: 0
        }, [o(l).type === "text" ? (i(), r("div", xe, f(o(l).text), 1)) : o(l).type === "status" ? (i(), p(v, {
          key: 1,
          status: o(l).status,
          class: "status"
  ...
  He = b({
    ...
    setup(t) {
      return (n, e) => {
        const s = Le;
        return i(), r("div", Re, [(i(!0), r(T, null, D(t.history, (l, a) => (i(), r(T, {
          key: a
        }, [a === 0 || t.history[a - 1].date.stamp !== t.history[a].date.stamp ? (i(), r("div", Be, f(l.date.formatted), 1)) : $("", !0), m(s, {
          "history-item": l
  ...
  Ve = b({
    ...
    setup(t, {
      ...
      return kt(() => s.value && l.observe(s.value)), $t(() => l.disconnect()), (a, u) => (i(), r("div", Me, [R(a.$slots, "default", {}, void 0, !0), d("div", {
        ref_key: "endRef",
        ref: s,
        class: "end"
      }, null, 512)]))
  ...
  Ze = b({
    ...
    setup(t) {
      ...
      return (s, l) => {
        ...
        }, [t.image || s.$slots.image ? (i(), r("div", Qe, [R(s.$slots, "image", {}, () => [t.image ? (i(), r("img", {
          key: 0,
          src: t.image,
          alt: "Image"
...
const tn = y(Xe, [
  ...
  fn = b({
    ...
    setup(t, {
      ...
      return (l, a) => (i(), r("div", pn, [(i(!0), r(T, null, D(o(s), (u, _) => (i(), r("button", {
        key: _,
  ...
  Pn = b({
    ...
    setup(t) {
      ...
      return (s, l) => {
        const a = At;
        return i(), r("div", Nn, [(i(!0), r(T, null, D(o(e), u => (i(), p(a, Pt({
          key: u.id,
          ref_for: !0
        }, u), null, 16))), 128))])
      }
    ...
    setup(t) {
      ...
      return (s, l) => {
        const a = xn,
          u = st,
          _ = ot;
        return i(), r("div", Wn, [d("div", Ln, [d("div", Rn, f(("t" in s ? s.t : o(c))("wallet.history.title")), 1), t.address ? (i(), r("div", Bn, [l[1] || (l[1] = d("img", {
          src: O,
          alt: "Ton logo"
...
const qn = b({
    ...
    setup(t) {
      ...
      return L(_, () => W().meta.key = _.value), (v, w) => {
        const C = yt,
          ct = Vt,
          rt = qt,
          dt = ue,
