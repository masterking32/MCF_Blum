    ...
    setup(a) {
      ...
      return (n, o) => {
        const d = P,
          ...
          _ = H,
          f = q;
        return i(), p(T, null, [l("div", Z, [l("div", X, [c(d), o[2] || (o[2] = l("img", {
          src: S,
          alt: "Dizzy emoji"
        }, null, -1)), l("div", {
          class: "title",
          innerHTML: ("t" in n ? n.t : e(s))("tribes.welcome.title")
        }, null, 8, J), l("div", x, [o[1] || (o[1] = l("i", {
          class: "lightning"
        ...
        }, null, 8, ["label", "to"]), l("div", ne, [(i(!0), p(T, null, j(a.leaderboard.slice(0, 3), (u, g) => (i(), b(_, {
          key: u.id,
          tribe: u,
          rank: g + 1
