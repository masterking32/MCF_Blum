    ...
    setup(f, {
      ...
      const s = f,
        ...
        h = b({
          ...
          set(e) {
            s.modifiers && (s.modifiers.includes(C.UPPERCASE) && (e = e.toUpperCase()), s.modifiers.includes(C.AMOUNT) && e && (e = q(e, {
        ...
        w = b(() => {
          switch (s.type) {
            ...
            case c.AMOUNT:
              return "number";
            default:
              throw s.type, Y("Unknown input type")
          }
        }),
        A = () => {
          var e;
      ...
      return (e, d) => {
        ...
        return a(), i("div", {
          ...
          ref_key: "inputRef",
          ref: p,
          "onUpdate:modelValue": d[0] || (d[0] = $ => H(h) ? h.value = $ : null),
          disabled: e.disabled,
          type: t(w),
