    ...
    setup(n) {
      return (e, t) => {
        ...
        return S(), ce(r, {
          ...
          default: Ve(() => [qe(e.$slots, "top", {}, () => [I("div", Jr, [t[0] || (t[0] = I("div", {
            class: "left"
          }, null, -1)), I("div", Lr, [qe(e.$slots, "top-center", {}, void 0, !0)]), I("div", Wr, [qe(e.$slots, "top-right", {}, void 0, !0)])])], !0), I("div", Kr, [qe(e.$slots, "default", {}, void 0, !0)]), Fe(s, {
            "ignore-tabs": "",
            "hide-space": ""
          }, {
  ...
  constructor(e = {}) {
    ...
    f(this, "request", async ({
      ...
      return this.customFetch(`${i||this.baseUrl||""}${s}${v?`?${v}`:""}`, {
        ...
        const J = x.clone();
        J.data = null, J.error = null;
        const H = U === "json" ? "text" : U,
          X = H ? await x[H]().then(Y => (J.ok ? J.data = U === "json" ? eo(Y) : Y : J.error = Y, J)).catch(Y => (J.error = Y, J)) : J;
...
const nn = () => {
    const {
      ...
      const {
        buyFeeBasis: M
      } = R.data, L = j(c.getBuyAmount(0n, d, M)), re = L, oe = L, be = _.minus(re), Je = j(c.getTonSupply(W(re))), et = new C(c.getPrice(W(re))), Ct = new C(et).times(A), Le = Je.div(u).times(100), gn = L.div(_).times(100), _n = new C(l).minus(Je);
      return G({
        share: new C(l),
        tokenForDexWithFees: k,
        tokenForDex: u,
      ...
      const L = y ? P({
        ...
        re = await V(async () => await c.sendDeployJetton(k, n(m), R, M, W(new C(l.share)), L, A))();
      if (!q(re)) return re;
      ...
      const {
        buyFeeBasis: k
      } = _.data, A = j(c.getBuyAmount(W(u), W(m), k)), R = A, M = o(A), L = m.times(h(k));
      return G({
        maxReceive: R,
        minReceive: M,
        platformFee: L,
      ...
      const {
        sellFeeBasis: k
      } = _.data, A = j(c.getSellAmount(W(u), W(m), k)), R = A, M = o(A), L = A.div(1 - h(k)).minus(A);
      return G({
        maxReceive: R,
        minReceive: M,
        platformFee: L,
      ...
      if (!q(R)) return R;
      const M = R.data,
        L = await V(async () => await c.sendSell(k, M, W(m), W(d.minReceive), A))();
      return q(L) ? G((await k.getResult()).hash) : L
    }, as = () => xe(({
      transactionHash: m
    }) => r({
      transactionHash: m
    ...
    return {
      ...
      getPriceDetails: ({
        ...
        if (l.push({
          ...
          l.push({
            title: `${F("base.share")} ${Ls(m.jettonReceivePercent)}%`,
            details: [{
              highlight: !1,
        ...
        const L = l.reduce((oe, be) => oe.plus(be.total), new C(0)),
          re = {
...
class Xt {
  ...
  async sendDeployCoin(e, t, s, r) {
    let o = (0, Ne.beginCell)().store((0, Jo.storeTokenOnchainContent)({
        name: s.name,
...
class es {
  constructor(e) {
    this.apiProvider = e.apiProvider, this.api = new Lo.BclClient(e.clientOptions), this.masterAddress = e.masterAddress
  }
  openCoin(e) {
  ...
  constructor(e = {}) {
    ...
    f(this, "request", async ({
      ...
      return this.customFetch(`${i||this.baseUrl||""}${s}${v?`?${v}`:""}`, {
        ...
        const J = P ? await U[P]().then(H => (x.ok ? x.data = H : x.error = H, x)).catch(H => (x.error = H, x)) : x;
        if (c && this.abortControllers.delete(c), !U.ok) throw J;
        return J.data
      })
    });
    Object.assign(this, e)
...
async function zo(n, e, t, s) {
  ...
  return {
    stack: new Lt.TupleReader(r.stack.map(ts))
  }
}
  ...
  switch (n.type) {
    ...
    case "cell":
      try {
        return {
          type: "cell",
          cell: Lt.Cell.fromBase64(n.cell)
        }
      } catch {
        return {
          type: "cell",
          cell: Lt.Cell.fromBase64(we.from(n.cell, "hex").toString("base64"))
        }
      }
    case "null":
      return {
    ...
    return {
      ...
      getPriceDetails: ({
        ...
        if (w.push({
          ...
          w.push({
            title: `${F("base.share")} ${Ls(b.jettonReceivePercent)}%`,
            details: [{
              highlight: !1,
        ...
        const A = w.reduce((M, L) => M.plus(L.total), new C(0)),
          R = {
            title: F("memepad.new.price_details.total_label"),
            label: `${ne(A)} TON`,
            value: A
      ...
      createJetton: async ({
        ...
        const d = Js(b, yt.STONFI_TON_FUN),
        ...
        const R = {
          ...
          L = e(l),
          re = await V(async () => await T(m).deployCoin(L, R, M))();
        return q(re) ? G({
          queryId: y.data.queryId,
          transactionHash: (await L.getResult()).hash
        }) : re
      },
