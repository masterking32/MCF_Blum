    ...
    setup(_) {
      return (e, n) => {
        ...
        return i(), p("div", fn, [m(a, {
          ...
          key: 1,
          layout: e.story.layout
        }, null, 8, ["layout"])) : x("", !0)]), b("div", $n, [e.story.button ? (i(), y(r, {
          key: 0,
      ...
      const n = _,
        ...
        z = $ => {
          ...
          const {
            width: C,
            left: G
          } = k.value.getBoundingClientRect(), F = $.clientX - G, D = C / 3;
          F < D ? r() : F > D * 2 && s()
        };
      return Le(() => {
    ...
    setup(_) {
      ...
      return Oe(() => {
        ...
        return i(), p("div", xn, [b("div", {
          ...
          modelValue: o(l),
          "onUpdate:modelValue": h[2] || (h[2] = $ => me(l) ? l.value = $ : null),
          set: f.value.set
