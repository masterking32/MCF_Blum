...
const ve = {
  ...
  Ee = L({
    ...
    setup(v) {
      const o = v,
        ...
        _ = z(`avatars/${Q(0,9)}`, "webp");
      return (e, c) => {
        var u, g;
        const d = B;
        return s(), n("div", {
          class: V(["memepad-jetton-holder-important", {
  ...
  Fe = L({
    ...
    setup(v) {
      return (o, m) => {
        const y = xe;
        return s(), n("div", De, [(s(!0), n(U, null, M(o.items, t => (s(), j(y, Z({
    ...
    setup(v) {
      ...
      return (e, c) => {
        ...
        return s(), n("div", Je, [a("div", Ke, [(u = e.user) != null && u.avatarUrl ? (s(), n("img", {
          ...
          src: i(_),
          class: "user-avatar-empty"
        }, null, 8, We))]), a("div", ze, [(g = e.user) != null && g.nickname ? (s(), n("button", {
          key: 0,
          class: "user-name reset",
          type: "button",
          onClick: c[0] || (c[0] = $ => p())
        }, [a("div", Qe, h(e.user.nickname), 1), f(d, {
          name: "edit-copy",
          class: "icon"
        })])) : (s(), n("button", {
          key: 1,
  ...
  rt = L({
    ...
    setup(v) {
      return (o, m) => {
        const y = ot;
        return s(), n("div", nt, [(s(!0), n(U, null, M(o.items, t => (s(), j(y, Z({
          key: t.holder.address,
          ref_for: !0
        }, t), null, 16))), 128))])
      }
