...
const Ve = {
    ...
    setup(i) {
      ...
      return (s, t) => {
        const o = B,
          ...
          _ = Y,
          r = Le;
        return l(), d("div", Ve, [s.myTribe ? (l(), d(D, {
          key: 1
    ...
    setup(i) {
      ...
      return (t, o) => {
        ...
        return l(), d("div", He, [a(s).type === "skeleton" ? (l(), y(c, {
          key: 0,
          class: "skeleton"
        })) : a(s).type === "connected" ? (l(), d("div", We, [m("div", Ye, [u(_, {
          name: "ton-logo",
          class: "logo"
        }), m("div", Ge, w(a(s).shortAddress), 1)]), (l(), y(pe(a(s).balance), {
          class: "balance"
  ...
  tt = v({
    ...
    setup(i) {
      ...
      return (n, s) => {
        const t = z;
        return l(), d("div", Ze, [(l(!0), d(D, null, U(a(e), (o, c) => (l(), d("button", {
          key: c,
          class: "control reset",
          onClick: _ => o.onClick()
        }, [m("div", Qe, [u(t, {
  ...
  mt = v({
    ...
    setup(i) {
      ...
      return (s, t) => (l(), d("div", pt, [(l(!0), d(D, null, U(a(n), o => (l(), d("div", {
        key: o.key,
    ...
    setup(i) {
      return (e, n) => {
        ...
        return l(), d("div", Et, [u(s, {
          ...
          class: "background"
        }, null, 8, ["background"]), m("div", Dt, [m("div", Nt, [e.story.layout.type === "TitleSubtitle" ? (l(), y(t, {
          key: 0,
  ...
  Ut = v({
    ...
    setup(i, {
      ...
      const n = i,
        ...
        N = S(!1),
        le = () => {
          T.value = !1, N.value = !1, h.set(() => {
            r.value.pause(), T.value = !0, N.value = !0
          }, Mt)
        },
        j = () => {
        ...
        ie = A => {
          if (T.value || N.value || !f.value) return;
          const {
            width: k,
            left: V
      ...
      return te(() => {
        ...
        return l(), y(L, {
          ...
          default: R(() => [m("div", {
            ...
            onPointerup: k[2] || (k[2] = C => j()),
            onPointercancel: k[3] || (k[3] = C => j()),
            onPointerleave: k[4] || (k[4] = C => j()),
    ...
    setup(i) {
      ...
      return Ie(n, s => s && e.value.onShowed(), {
        ...
        const o = oe,
          c = Q,
          _ = Wt;
        return l(), d("div", Yt, [m("div", Gt, [m("div", qt, [m("div", Xt, w(("t" in s ? s.t : a(p))("index.season_2.banner.title")), 1), m("div", Zt, w(("t" in s ? s.t : a(p))("index.season_2.banner.subtitle")), 1), u(o, {
          state: "default",
  ...
  ss = v({
    ...
    setup(i) {
      return (e, n) => {
        const s = B;
        return l(), d("div", es, [(l(!0), d(D, null, U(e.count, t => (l(), d("div", {
          key: t,
          class: "skeleton"
        }, [u(s, {
          rounded: "",
  ...
  ys = () => {
    const i = S(!1),
      ...
      o = async () => {
        ...
        return i.value = !1, r.err ? F() : (e.value = ms(e.value, r.data), t.exec(), setTimeout(() => se().update(), 5e3), O(r.data))
      };
    return {
      init: async () => {
        await t.exec()
