...
const ot = i => {
    ...
    return {
      ...
      resetGenerateContentSheetResultState: () => {
        Y(), t.value.loadStatus = "LOADED", t.value.selectedCategory = null, t.value.info = null, t.value.result = []
      },
      resetGenerateContentSheetState: () => {
        Y(), t.value.loadStatus = "LOADED", t.value.categories = [], t.value.selectedCategory = null, t.value.info = null, t.value.result = []
      },
      show: y
    }
  },
      ...
      const p = t,
        {
          ...
          onResultItemLoad: y,
          resetGenerateContentSheetResultState: $,
          resetGenerateContentSheetState: Y,
          show: u
        } = ot(i.withAi),
        l = h(() => {
  ...
  st = async i => {
    ...
    setup(i, {
      ...
      return ee(() => r.value.share, () => {
        r.value.status = "loading", Y()
      }), ke(() => {
        r.value.status !== "loaded" && $()
      }), (u, l) => {
        const k = Ie,
          N = be,
          m = Mt,
        ...
        return d(), L(Z, {
          ...
          default: V(() => [E("div", Ka, [w(N, {
            ...
            onBlur: G
          }, null, 8, ["modelValue", "modifier"]), E("div", $a, [e(T) ? (d(), b("span", Ya, U(e(T).subtitle), 1)) : (d(), L(_, {
            key: 0,
            class: "skeleton"
    ...
    setup(i) {
      ...
      return (m, _) => {
        ...
        return d(), b("div", qa, [w(f, {
          ...
          onContinue: _[4] || (_[4] = W => $(W)),
          onUpdate: _[5] || (_[5] = W => Y(e(a), W))
