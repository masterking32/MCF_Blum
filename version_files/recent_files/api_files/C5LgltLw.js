...
const ro = {
  ...
  co = it({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        c = async () => {
          if (u.value) return;
          const d = () => Ce().error(T("memepad.jetton.unlock.failed_alert", {
          ...
          await Ps(2e4), await l.exec(v.data) ? (m("success"), s("unlocked"), Ce().success(T("memepad.jetton.unlock.success_alert", {
            ticker: e.jetton.ticker
      ...
      return le(() => {
        ...
        const m = Ds,
          ...
          w = Os,
          _ = At;
        return M(), I("div", ro, [S("div", lo, [p(i).balanceLabel ? (M(), x(m, {
          key: 0,
          balance: p(i).balanceLabel
        }, null, 8, ["balance"])) : (M(), x(v, {
          key: 1,
          class: "skeleton"
        })), p(i).feesInfo ? (M(), x(y, {
          key: 2,
        ...
        }, null, 8, ["details", "total-label", "error-message"])) : (M(), x(v, {
          key: 3,
          class: "skeleton"
        }))]), (j = p(i).error) != null && j.notEnoughTon ? (M(), x(w, {
          key: 0,
          "jetton-shortname": d.jetton.shortname,
          "jetton-address": d.jetton.address,
          reason: p(i).error.notEnoughTonReason
        }, null, 8, ["jetton-shortname", "jetton-address", "reason"])) : (M(), x(_, {
          key: 1,
          fill: "",
          icon: "lock-open",
          "icon-align": "left",
          ...
          default: Z(() => [S("div", ao, B(("t" in d ? d.t : p(T))("memepad.jetton.unlock_btn", {
    ...
    setup(n) {
      ...
      return (i, s) => {
        const o = Mn,
          ...
          u = qn,
          d = Cn;
        return M(), I("div", uo, [L(o), S("div", fo, [S("div", mo, [L(h, {
          size: 342,
          name: "animations/Clover",
          class: "animation"
        }), L(r, {
          src: p(Rs)(i.jetton.iconFileKey),
          size: 80
        }, null, 8, ["src"])]), S("div", po, B(("t" in i ? i.t : p(T))("memepad.moving_to_dex.title")), 1), S("div", vo, B(("t" in i ? i.t : p(T))("memepad.moving_to_dex.subtitle", {
          ticker: i.jetton.ticker
        })), 1)]), L(u, null, {
          default: Z(() => [S("div", bo, [L(c, {
            "force-loading": i.unlockEnabled === void 0 && i.isReleased
          }, {
            default: Z(() => [i.unlockEnabled ? (M(), x(l, {
              key: 0,
              jetton: i.jetton,
            ...
            }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (M(), x(a, {
              key: 1,
          ...
          modelValue: p(e),
          "onUpdate:modelValue": s[2] || (s[2] = f => ft(e) ? e.value = f : null),
  ...
  Eo = it({
    ...
    setup(n) {
      const t = n,
        e = z(() => {
          const i = oi(t.jetton.releaseTimestamp).label;
          return t.isReleased ? `${i} • STON.fi` : i
        });
      return (i, s) => {
        const o = Qn,
          h = ae;
        return M(), I("div", wo, [S("div", yo, [L(o, {
          jetton: i.jetton
        }, null, 8, ["jetton"]), S("div", So, [S("div", Mo, [S("div", ko, B(i.jetton.ticker), 1), i.jettonInformation.stream.online ? (M(), I("div", Co, s[2] || (s[2] = [S("div", {
          class: "dot"
        }, null, -1)]))) : St("", !0), i.jettonInformation.inSpotlight ? (M(), I("div", jo, [L(h, {
          name: "fire",
          class: "icon"
        }), s[3] || (s[3] = S("span", {
          class: "label"
        }, "Spotlight", -1))])) : St("", !0)]), S("div", zo, B(p(e)), 1)])]), S("div", Lo, [S("button", {
          type: "button",
          class: "reset copy",
          ...
          name: "edit-copy",
          class: "icon"
        }), S("span", $o, B(("sliceWalletAddress" in i ? i.sliceWalletAddress : p(jn))(i.jetton.address, 3)), 1)]), S("button", {
          type: "button",
          class: "reset share",
    ...
    setup(n) {
      return (t, e) => {
        ...
        return M(), I("div", xo, [L(i, {
          ...
          }, B(("t" in t ? t.t : p(T))("memepad.jetton.stream_banned_link")), 1)]),
          _: 1
        })])
      }
    }
  ...
  Fo = it({
    ...
    setup(n) {
      const t = n,
        ...
        r = Vo(t.stream.startAt, "hms");
      return (l, a) => {
        const c = ae;
        return M(), I("div", Io, [S("iframe", {
          ref_key: "player",
          ref: e,
        ...
        }, null, 8, Bo), a[2] || (a[2] = S("div", {
          class: "bg"
        }, null, -1)), S("div", Wo, [S("div", Ao, [L(c, {
          name: "user-voice",
          class: "icon"
        }), S("span", Do, B(l.stream.viewers), 1)]), S("div", No, [L(c, {
          name: "calendar-clock",
          class: "icon"
        }), S("span", Oo, B(p(r).label), 1)])]), S("div", Uo, [S("button", {
          type: "button",
          class: "reset sound-control",
          onClick: a[0] || (a[0] = u => p(s) ? h() : o())
        }, [L(c, {
    ...
    setup(n) {
      const t = n,
        ...
        i = async () => {
          ...
          if (!jt(h)) throw _i("Failed to generate stream key");
          e.value = {
            status: "loaded",
            streamKey: h.data
          }
        ...
        }), o = () => ie().$webApp.openLink("https://www.blum.io/post/videostream-quick-start-guide");
      return (h, r) => {
        const l = ae,
          a = Pe,
          c = Is("I18nT"),
          u = At,
          d = Bs;
        return M(), I("div", Jo, [S("button", {
          type: "button",
          class: "reset button",
          onClick: i
        }, B(("t" in h ? h.t : p(T))("memepad.jetton.start_stream_button")), 1), L(d, {
          modelValue: p(s),
          "onUpdate:modelValue": r[2] || (r[2] = f => ft(s) ? s.value = f : null)
        }, {
          default: Z(() => [S("div", Ho, [S("div", Xo, B(("t" in h ? h.t : p(T))("memepad.jetton.steam.start_sheet.title")), 1), S("div", Yo, B(("t" in h ? h.t : p(T))("memepad.jetton.steam.start_sheet.subtitle")), 1), S("div", Zo, [p(e).status === "loaded" ? (M(), I("button", {
            key: 0,
            type: "button",
            class: "reset",
            onClick: r[0] || (r[0] = f => ("useCopy" in h ? h.useCopy : p(Ln))().copy(p(e).streamKey))
          }, [S("div", Go, B(p(e).streamKey), 1), L(l, {
            name: "edit-copy",
            class: "icon"
          })])) : (M(), x(a, {
            key: 1,
            ...
            }, B(("t" in h ? h.t : p(T))("memepad.jetton.stream.rules_link")), 1)]),
            _: 1
          }), L(u, {
  ...
  th = it({
    ...
    setup(n) {
      const t = n,
        e = F(!1),
        i = async () => {
          if (t.jettonInformation.stream.key) return dt(t.jettonInformation.stream.key);
          const o = await je.getMemepadStreamKey(t.jetton.shortname);
          if (!jt(o)) return o;
          const h = o.data.stream.key;
          if (!h) throw _i("Failed to generate stream key");
          return dt(h)
        }, s = () => ie().$webApp.openLink("https://www.blum.io/post/videostream-quick-start-guide#:~:text=Blum%20Memepad%20Videostream%20Terms%20%26%C2%A0Conditions");
      return (o, h) => {
        const r = Ro,
          l = Ko,
          a = Qo;
        return o.jettonInformation.stream.isBanned ? (M(), x(r, {
          key: 0,
          onOpenRules: s
        })) : o.jettonInformation.stream.online ? (M(), I(Lt, {
          key: 1
        }, [p(e) ? (M(), I("button", {
          key: 0,
          type: "button",
        ...
        }, B(("t" in o ? o.t : p(T))("memepad.jetton.show_stream_button")), 1)) : (M(), x(l, {
          key: 1,
          stream: o.jettonInformation.stream,
          onHide: h[1] || (h[1] = c => e.value = !0)
        }, null, 8, ["stream"]))], 64)) : o.jettonInformation.stream.creator ? (M(), x(a, {
          key: 2,
...
var nh = function() {
  ...
  return n.prototype.dispose = function() {
    ...
    Pt(e, t) || (this.canvasElement.width = t.width, this.canvasElement.height = t.height, this._emitBitmapSizeChanged(e, t))
    ...
    var e = this._suggestedBitmapSize,
      ...
      s = Pt(this.bitmapSize, i) ? null : i;
    e === null && s === null || e !== null && s !== null && Pt(e, s) || (this._suggestedBitmapSize = s, this._emitSuggestedBitmapSizeChanged(e, s))
    ...
    if (this._canvasElement !== null) {
      var e = Wi(this._canvasElement);
      if (e === null) throw new Error("No window is associated with the canvas");
      this._devicePixelRatioObservable = sh(e), this._devicePixelRatioObservable.subscribe(function() {
...
function oh(n, t) {
  if (t.type === "device-pixel-content-box") return new nh(n, t.transform, t.options);
...
function Vt(n, t) {
  ...
  return s === null ? null : new lh(s, e, i)
}
/*!
 * @license
...
const ph = /^#([0-9a-f])([0-9a-f])([0-9a-f])([0-9a-f])?$/i,
  vh = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?$/i,
  bh = /^rgb\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*\)$/,
  gh = /^rgba\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d*\.?\d+)\s*\)$/;

function se(n) {
  (n = n.toLowerCase()) in Di && (n = Di[n]);
  {
    const t = gh.exec(n) || bh.exec(n);
    if (t) return [ct(parseInt(t[1], 10)), ct(parseInt(t[2], 10)), ct(parseInt(t[3], 10)), Xs(t.length < 5 ? 1 : parseFloat(t[4]))]
  } {
    const t = vh.exec(n);
...
function mt(n, ...t) {
  for (const e of t)
    for (const i in e) e[i] !== void 0 && (typeof e[i] != "object" || n[i] === void 0 || Array.isArray(e[i]) ? n[i] = e[i] : mt(n[i], e[i]));
  return n
}
...
function wt(n) {
  ...
  let e, i, s;
  for (i in e = Array.isArray(t) ? [] : {}, t) t.hasOwnProperty(i) && (s = t[i], e[i] = s && typeof s == "object" ? wt(s) : s);
  return e
}
...
const Si = "-apple-system, BlinkMacSystemFont, 'Trebuchet MS', Roboto, Ubuntu, sans-serif";

function Jt(n, t, e) {
  return t === void 0 && (t = Si), `${e=e!==void 0?`${e} `:""}${n}px ${t}`
}
class wh {
  constructor(t) {
    this.k = {
  ...
  W() {
    const t = this.k,
      e = this.j(),
      i = this.H();
    return t.P === e && t.D === i || (t.P = e, t.D = i, t.R = Jt(e, i), t.L = 2.5 / 12 * e, t.B = t.L, t.A = e / 12 * t.T, t.I = e / 12 * t.T, t.N = 0), t.V = this.$(), t.O = this.U(), this.k
  }
  $() {
...
class kh {
  ...
  bt(t) {
    const e = this.F.wt();
    e.length !== this.ct.length && (this.dt = e.map(Sh), this.ct = this.dt.map(i => {
      const s = new yh;
      return s.J(i), s
  ...
  Mt() {
    ...
    e.forEach((o, h) => {
      ...
      const c = g(o.Ct());
      l.lt = a.Tt, l.ht = a.ht, l.et = a.Pt, l.it[0]._t = a._t, l.it[0].st = o.Dt().Rt(a._t, c.Vt), l.rt = (r = a.Ot) !== null && r !== void 0 ? r : this.F.Bt(l.it[0].st / o.Dt().At()), l.it[0].ot = i, l.it[0].nt = s.It(i), l.tt = Mh
    })
  }
}
class Ch extends pt {
  ...
  K({
    ...
    t.lineCap = "butt", o && r >= 0 && (t.lineWidth = Math.floor(this.zt.Lt.et * i), t.strokeStyle = this.zt.Lt.V, t.fillStyle = this.zt.Lt.V, It(t, this.zt.Lt.Nt), function(a, c, u, d) {
      a.beginPath();
      const f = a.lineWidth % 2 ? .5 : 0;
      a.moveTo(c + f, u), a.lineTo(c + f, d), a.stroke()
    }(t, r, 0, e.height)), h && l >= 0 && (t.lineWidth = Math.floor(this.zt.Et.et * s), t.strokeStyle = this.zt.Et.V, t.fillStyle = this.zt.Et.V, It(t, this.zt.Et.Nt), Hs(t, l, 0, e.width))
  }
}
class jh {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      nt: 0,
      st: 0
    }, this.Wt = new Ch(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
...
function Oi(n, t, e, i, s, o, h = 0, r = [0, 0, 0, 0], l = "") {
  if (n.save(), !h || !l || l === o) return Ni(n, t, e, i, s, r), n.fillStyle = o, n.fill(), void n.restore();
  const a = h / 2;
  var c;
  Ni(n, t + a, e + a, i - h, s - h, (c = -a, r.map(u => u === 0 ? u : u + c))), o !== "transparent" && (n.fillStyle = o, n.fill()), l !== "transparent" && (n.lineWidth = h, n.strokeStyle = l, n.closePath(), n.stroke()), n.restore()
}
...
class Ui {
    ...
    const o = this.zt.V,
      ...
      r = t.useBitmapCoordinateSpace(l => {
        ...
        const c = this.Gt(l, e, i, s),
          u = c.Jt;
        return c.Qt ? Oi(a, u.ti, u.ii, u.ni, u.si, h, u.ei, [u.ht, 0, 0, u.ht], h) : Oi(a, u.ri, u.ii, u.ni, u.si, h, u.ei, [0, u.ht, u.ht, 0], h), this.zt.hi && (a.fillStyle = o, a.fillRect(u.ri, u.li, u.ai - u.ri, u.oi)), this.zt._i && (a.fillStyle = e.O, a.fillRect(c.Qt ? u.ui - u.ei : 0, u.ii, u.ei, u.ci - u.ii)), c
      });
  ...
  Gt(t, e, i, s) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, f = e.L + this.Xt.wi, m = e.B + this.Xt.gi, v = e.A, y = e.I, w = this.zt.Kt, _ = e.P, C = i.Mi(h, w), j = Math.ceil(i.xi(h, w)), P = _ + f + m, q = e.C + v + y + j + u, O = Math.max(1, Math.floor(c));
    let b = Math.round(P * c);
    b % 2 != O % 2 && (b += 1);
    const k = d > 0 ? Math.max(1, Math.floor(d * a)) : 0,
      A = Math.round(q * a),
      H = Math.round(u * a),
      E = (o = this.Xt.Si) !== null && o !== void 0 ? o : this.Xt.ki,
      R = Math.round(E * c) - Math.floor(.5 * c),
      W = Math.floor(R + O / 2 - b / 2),
      J = W + b,
      $ = s === "right",
      N = $ ? l.width - d : d,
      D = $ ? r.width - k : k;
    let Q, V, et;
    return $ ? (Q = D - A, V = D - H, et = N - u - v - d) : (Q = D + A, V = D + H, et = N + u + v), {
      Qt: $,
      Jt: {
        ii: W,
        li: R,
...
class Ie {
  constructor(t) {
    this.yi = {
      ...
      _i: !0,
      bi: !0
    }, this.ft = !0, this.Pi = new(t || Ui)(this.Ci, this.yi), this.Ri = new(t || Ui)(this.Ti, this.yi)
  }
  Kt() {
...
class Lh extends Ie {
  ...
  zi(t, e, i) {
    ...
    const h = Re(s.labelBackgroundColor);
    i.t = h.t, t.V = h.i;
...
class Gs {
  ...
  X(t, e) {
    ...
    const i = t.useMediaCoordinateSpace(({
      context: d
    }) => (d.font = e.R, Math.round(e.Wi.xi(d, g(this.zt).Kt, $h))));
    if (i <= 0) return;
    const s = e.ji,
      o = i + 2 * s,
      h = o / 2,
    ...
    t.useBitmapCoordinateSpace(({
      ...
      const y = Math.round(a * f),
        ...
        C = Math.round(u * m),
        j = Math.round(2 * f);
      if (d.beginPath(), d.moveTo(y, w), d.lineTo(y, C - j), d.arcTo(y, C, y + j, C, j), d.lineTo(_ - j, C), d.arcTo(_, C, _, C - j, j), d.lineTo(_, w), d.fill(), v.hi) {
        const P = Math.round(v.ki * f),
          q = w,
          O = Math.round((q + e.T) * m);
        d.fillStyle = v.V;
        const b = Math.max(1, Math.floor(f)),
          k = Math.floor(.5 * f);
        d.fillRect(P - k, q, b, O - q)
      }
    }), t.useMediaCoordinateSpace(({
      context: d
    }) => {
...
class Eh {
  constructor(t, e, i) {
    this.ft = !0, this.Wt = new Gs, this.Ft = {
      yt: !1,
      t: "#4c525e",
      V: "white",
      Kt: "",
  ...
  Mt() {
    ...
    const h = Re(e.labelBackgroundColor);
...
class Th extends ki {
  constructor(t, e) {
    super(), this.tn = null, this.nn = NaN, this.sn = 0, this.en = !0, this.rn = new Map, this.hn = !1, this.ln = NaN, this.an = NaN, this._n = NaN, this.un = NaN, this.$i = t, this.cn = e, this.dn = new kh(t, this), this.fn = ((s, o) => h => {
      const r = o(),
        l = s();
    ...
    this.bn = new Eh(this, t, i), this.wn = new jh(this)
  }
  W() {
    return this.cn
  }
  ...
  Tn() {
    const t = this.$i.wt().map(i => i.In().An()).filter(_h),
...
function yt(n, t) {
  if (!bt(n)) return "n/a";
  if (!ne(t)) throw new TypeError("invalid length");
  if (t < 0 || t > 16) throw new TypeError("invalid length");
  return t === 0 ? n.toString() : ("0000000000000000" + n.toString()).slice(-t)
}
class We {
  constructor(t, e) {
    if (e || (e = 1), bt(t) && ne(t) || (t = 100), t < 0) throw new TypeError("invalid base");
  ...
  ls(t) {
    ...
    if (e > 1) {
      ...
      h >= e && (h -= e, i += 1), s = Fi + yt(+h.toFixed(this.os) * this.rs, o)
    } else i = Math.round(i * e) / e, o > 0 && (s = Fi + yt(0, o));
...
function Qs(n, t, e, i, s, o, h) {
  ...
  if (i.to - i.from < 2) {
    ...
    r.moveTo(m.nt * l, m.st * a), r.lineTo(v.nt * l, v.st * a), h(n, u, m, v)
  } else {
    const f = (v, y) => {
      h(n, u, d, y), r.beginPath(), u = v, d = y
    };
    let m = d;
    ...
    for (let v = i.from + 1; v < i.to; ++v) {
      ...
      switch (e) {
        case 0:
          ...
          break;
        case 1:
          r.lineTo(m.nt * l, t[v - 1].st * a), y !== u && (f(y, m), r.lineTo(m.nt * l, t[v - 1].st * a)), r.lineTo(m.nt * l, m.st * a);
          break;
        case 2: {
          const [w, _] = Ph(t, v - 1, v);
          r.bezierCurveTo(w.nt * l, w.st * a, _.nt * l, _.st * a, m.nt * l, m.st * a);
          break
        }
      }
      e !== 1 && y !== u && (f(y, m), r.moveTo(m.nt * l, m.st * a))
    }(d !== m || d === m && e === 1) && h(n, u, d, m)
  }
}
const Ki = 6;
...
function Ph(n, t, e) {
  ...
  var o, h;
  return [(o = n[t], h = Ji(De(n[e], n[i]), Ki), {
    nt: o.nt + h.nt,
    st: o.st + h.st
  }), De(n[e], Ji(De(n[s], n[t]), Ki))]
}
...
class tn extends pt {
  ...
  K(t) {
    ...
    if (s === null) return;
    const c = t.context;
    c.lineCap = "butt", c.lineJoin = "round", c.lineWidth = h, It(c, r), c.lineWidth = 1, Qs(t, i, l, s, o, this.ps.bind(this), Rh.bind(null, a))
  }
}
  ...
  bs(t, e) {
    ...
    if (this.ys === void 0 || i === void 0 || i.gs !== s || i.Ms !== o || i.xs !== h || i.Ss !== r || i.fs !== a || i.ks !== l) {
      ...
      if (c.addColorStop(0, s), a != null) {
        const u = fi(a * t.verticalPixelRatio / l, 0, 1);
...
class Vh extends tn {
  constructor() {
    super(...arguments), this.Cs = new Ci
  }
  ps(t, e) {
    return this.Cs.bs(t, {
      gs: e.Ts,
...
class sn extends pt {
  ...
  K(t) {
    ...
    if (i === null) return;
    const a = t.context;
    a.lineCap = "butt", a.lineWidth = h * t.verticalPixelRatio, It(a, r), a.lineJoin = "round";
    const c = this.Ds.bind(this);
    o !== void 0 && Qs(t, e, o, i, s, c, Ih), l && function(u, d, f, m, v) {
      const {
      ...
      let C = null;
      const j = Math.max(1, Math.floor(y)) % 2 / 2,
        P = f * w + j;
      for (let q = m.to - 1; q >= m.from; --q) {
        const O = d[q];
        if (O) {
          const b = v(u, O);
          b !== C && (_.beginPath(), C !== null && _.fill(), _.fillStyle = b, C = b);
          const k = Math.round(O.nt * y) + j,
            A = O.st * w;
          _.moveTo(k, A), _.arc(k, A, P, 0, 2 * Math.PI)
        }
      }
      _.fill()
    }(t, e, l, i, c)
...
function on(n, t, e, i, s = 0, o = t.length) {
  let h = o - s;
  for (; 0 < h;) {
    const r = h >> 1,
      l = s + r;
...
class ji {
  ...
  Ys() {
    ...
    const s = this.Ls.Ct();
    s !== null && (this.zs = rn(this.Is, i, this.Ns), this.Ks(t, e, s.Vt), this.Gs())
  }
}
class Ae extends ji {
  constructor(t, e) {
...
class Ah extends Ae {
  constructor(t, e) {
    super(t, e), this.Ws = new Mi, this.ee = new Vh, this.re = new nn, this.Ws.Z([this.ee, this.re])
  }
  ne(t, e, i) {
  ...
  K({
    ...
    for (let h = this.zt.tt.from; h < this.zt.tt.to; ++h) {
      ...
      if (o) {
        if (this.zt.fe) {
          const q = a - _;
          let O = Math.max(v, Math.round(r.ve * i) - l),
            b = O + u - 1;
          b > v + w - 1 && (b = v + w - 1, O = b - u + 1), t.fillRect(q, O, c - q, b - O + 1)
        }
        const C = a + _;
        let j = Math.max(v, Math.round(r.pe * i) - l),
          P = j + u - 1;
        P > v + w - 1 && (P = v + w - 1, j = P - u + 1), t.fillRect(d + 1, j, C - d, P - j + 1)
      }
    }
  }
  oe(t) {
...
class Nh extends ln {
  constructor() {
    super(...arguments), this.Ws = new Dh
  }
  ne(t, e, i) {
...
class Uh extends sn {
  constructor() {
    super(...arguments), this.Te = new Ci
  }
  Ds(t, e) {
    const i = this.G;
    return this.Te.bs(t, {
...
class Fh extends Ae {
  constructor(t, e) {
    super(t, e), this.Ws = new Mi, this.De = new Oh, this.Ve = new Uh, this.Ws.Z([this.De, this.Ve])
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class Kh extends pt {
  ...
  Be(t, e, i) {
    ...
    for (let u = i.from; u < i.to; u++) {
      ...
      const _ = w + l - 1;
      c !== null && (w = Math.max(c + 1, w), w = Math.min(w, _));
      const C = _ - w + 1;
      s.fillRect(w, v, C, f - v), s.fillRect(w, m + 1, C, y - m), c = _
    }
  }
  Ie(t) {
  ...
  Ae(t, e, i) {
    ...
    for (let c = i.from; c < i.to; c++) {
      ...
      const f = d + this.le - 1,
        m = Math.round(Math.min(u.ve, u.pe) * h),
        v = Math.round(Math.max(u.ve, u.pe) * h);
      if (a !== null && (d = Math.max(a + 1, d), d = Math.min(d, f)), this.zt.he * o > 2 * l) zh(s, d, m, f - d + 1, v - m + 1, l);
      else {
        const y = f - d + 1;
  ...
  ze(t, e, i) {
    ...
    for (let a = i.from; a < i.to; a++) {
      ...
      this.zt._i && (f += l, u += l, m -= l, d -= l), u > d || s.fillRect(f, u, m - f + 1, d - u + 1)
    }
  }
}
class Jh extends ln {
...
class Ne extends ji {
  constructor(t, e, i) {
    super(t, e, !1), this.wn = i, this.Ws = new Hh(this.wn.renderer(), s => {
      const o = t.Ct();
...
class Zh extends Ae {
  constructor() {
    super(...arguments), this.Ws = new Yh
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class Gh extends Ae {
  constructor() {
    super(...arguments), this.Ws = new nn
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class he {
  ...
  nr(t, e, i) {
    ...
    if (this.Qe.has(o)) return rt(this.Qe.get(o)).sr;
    if (this.Xe === this.tr) {
...
class an {
  constructor(t, e, i) {
    this._r = t, this.lr = new he(50), this.ur = e, this.F = i, this.j = -1, this.Wt = new Qh(this.lr)
  }
  gt() {
...
class tr extends pt {
  ...
  K({
    ...
    o < 0 || o > e.height || (t.lineCap = "butt", t.strokeStyle = this.zt.V, t.lineWidth = Math.floor(this.zt.et * i), It(t, this.zt.Nt), Hs(t, o, 0, e.width))
  }
}
class zi {
  constructor(t) {
    this.Mr = {
      ...
      Nt: 0,
      yt: !1
    }, this.Sr = new tr, this.ft = !0, this.Ls = t, this.Es = t.$t(), this.Sr.J(this.Mr)
  }
  bt() {
    this.ft = !0
  }
...
class nr {
  constructor(t) {
    this.Wt = new ir, this.ft = !0, this.Er = !0, this.Nr = performance.now(), this.Fr = this.Nr - 1, this.Wr = t
  }
  jr() {
...
function qt(n, t) {
  return en(Math.min(Math.max(n, 12), 30) * t)
}
...
class hr extends pt {
  constructor() {
    super(...arguments), this.zt = null, this.lr = new he, this.j = -1, this.H = "", this.Jr = ""
  }
  J(t) {
    this.zt = t
  }
  ar(t, e) {
    this.j === t && this.H === e || (this.j = t, this.H = e, this.Jr = Jt(t, e), this.lr.ir())
  }
  br(t, e) {
  ...
  K({
    ...
    if (this.zt !== null && this.zt.tt !== null) {
      ...
      for (let h = this.zt.tt.from; h < this.zt.tt.to; h++) {
        ...
        r.Kt !== void 0 && (r.Kt.Hi = this.lr.xi(t, r.Kt.th), r.Kt.At = this.j, r.Kt.nt = r.nt - r.Kt.Hi / 2), rr(r, t, e, i)
      }
    }
  }
}
  ...
  t.fillStyle = n.V, n.Kt !== void 0 && function(s, o, h, r, l, a) {
    ...
    function(s, o, h) {
      if (s.Xs !== 0) {
        switch (s.ih) {
          case "arrowDown":
            return void Gi(!1, o, h, s.Xs);
          case "arrowUp":
            return void Gi(!0, o, h, s.Xs);
          case "circle":
            return void
            function(r, l, a) {
              const c = (re("circle", a) - 1) / 2;
...
function lr(n, t, e) {
  return !(n.Kt === void 0 || ! function(i, s, o, h, r, l) {
    ...
    switch (i.ih) {
      case "arrowDown":
      case "arrowUp":
        return or(0, i.nt, i.st, i.Xs, s, o);
      case "circle":
        return function(h, r, l, a, c) {
          const u = 2 + re("circle", l) / 2,
            d = h - a,
            f = r - c;
...
function ar(n, t, e, i, s, o, h, r, l) {
  const a = bt(e) ? e : e.xe,
    c = bt(e) ? e : e.ge,
    u = bt(e) ? e : e.Me,
    d = bt(t.size) ? Math.max(t.size, 0) : 1,
    f = cn(r.he()) * d,
    m = f / 2;
  switch (n.Xs = f, t.position) {
    ...
    case "aboveBar":
      return n.st = h.Rt(c, l) - m - i.nh, n.Kt !== void 0 && (n.Kt.st = n.st - m - .6 * s, i.nh += 1.2 * s), void(i.nh += f + o);
    case "belowBar":
      return n.st = h.Rt(u, l) + m + i.sh, n.Kt !== void 0 && (n.Kt.st = n.st + m + o + .6 * s, i.sh += 1.2 * s), void(i.sh += f + o)
  }
  t.position
}
class cr {
  constructor(t, e) {
    this.ft = !0, this.eh = !0, this.rh = !0, this.hh = null, this.ah = null, this.Wt = new hr, this.Wr = t, this.$i = e, this.zt = {
      it: [],
      tt: null
    }
  }
    ...
    if (this.rh) {
      if (this.Wr.uh().length > 0) {
        const t = this.$i.St().he(),
          ...
          s = this.dh();
        this.hh = {
          above: Zi(i, s.aboveBar, s.inBar),
          below: Zi(i, s.belowBar, s.inBar)
        }
      } else this.hh = null;
      this.rh = !1
    }
  ...
  oh() {
    ...
    for (let c = this.zt.tt.from; c < this.zt.tt.to; c++) {
      ...
      f !== null && ar(d, u, f, a, s.fontSize, l, t, e, h.Vt)
    }
    this.ft = !1
  }
}
...
class lt {
  ...
  ts(t) {
    return t === null ? this : new lt(qi(Math.min, this.Th(), t.Th(), -1 / 0), qi(Math.max, this.Ph(), t.Ph(), 1 / 0))
  }
  Dh(t) {
    if (!bt(t) || this.kh - this.Sh === 0) return;
...
class Te {
  ...
  static Bh(t) {
    return t === null ? null : new Te(lt.Bh(t.priceRange), t.margins)
  }
}
class fr extends zi {
  constructor(t, e) {
...
class mr extends Ie {
  ...
  zi(t, e, i) {
    ...
    const a = Re(s.axisLabelColor || s.color);
    i.t = a.t;
...
class pr {
  constructor(t, e) {
    this.Wr = t, this.cn = e, this.Wh = new fr(t, this), this._r = new mr(t, this), this.jh = new an(this._r, t, t.$t())
  }
  Hh(t) {
    mt(this.cn, t), this.bt(), this.Wr.$t().$h()
  }
  W() {
    return this.cn
  }
...
class gr {
  constructor(t) {
    this.Xh = (e, i) => i !== void 0 ? i.Vt : this.Wr.In().Kh(e), this.Wr = t, this.Gh = br[t.Jh()]
  }
  Hs(t, e) {
...
class _r {
  ...
  al(t, e, i) {
    ...
    let s = null;
    for (const o of i) s = ve(s, this.ol(t, e, o));
    return s
  }
  J(t) {
  ...
  fl(t) {
    return hn(this.Qh, t, (e, i) => e.se > i)
  }
  vl(t, e, i) {
    let s = null;
    for (let o = t; o < e; o++) {
  ...
  ol(t, e, i) {
    ...
    const o = g(this.sl()),
      ...
      l = Math.min(e, h),
      a = Math.ceil(r / kt) * kt,
      c = Math.max(a, Math.floor(l / kt) * kt);
    {
      const d = this.dl(r),
        f = this.fl(Math.min(l, a, e));
      s = ve(s, this.vl(d, f, i))
    }
    let u = this.tl.get(i);
    u === void 0 && (u = new Map, this.tl.set(i, u));
    for (let d = Math.max(a + 1, r); d < c; d += kt) {
      const f = Math.floor(d / kt);
      let m = u.get(f);
      if (m === void 0) {
        const v = this.dl(f * kt),
          y = this.fl((f + 1) * kt - 1);
        m = this.vl(v, y, i), u.set(f, m)
      }
      s = ve(s, m)
    } {
      const d = this.dl(c),
...
class yr {
  constructor(t, e) {
    this.Wt = new Gs, this.Sl = t, this.kl = e
  }
  gt() {
...
class Li extends vr {
  constructor(t, e, i, s, o) {
    super(t), this.zt = new _r, this.Wh = new ur(this), this.Il = [], this.zl = new er(this), this.Ll = null, this.El = null, this.Nl = [], this.Fl = [], this.Wl = null, this.jl = [], this.cn = e, this.Hl = i;
    const h = new dr(this);
    this.rn = [h], this.jh = new an(h, this, t), i !== "Area" && i !== "Line" && i !== "Baseline" || (this.Ll = new nr(this)), this.$l(), this.Ul(o)
  }
  S() {
  ...
  $s() {
    return this.El !== null || (this.El = new gr(this)), this.El
  }
  W() {
    return this.cn
  }
  Hh(t) {
    ...
    e !== void 0 && e !== this.cn.priceScaleId && this.$t().Zl(this, e), mt(this.cn, t), t.priceFormat !== void 0 && (this.$l(), this.$t().Xl()), this.$t().Kl(this), this.$t().Gl(), this.wn.bt("options")
  }
  J(t, e) {
  ...
  Pn() {
    ...
    return t.push(...e), Ue(this.jl, Fe, "normal", t), t
  }
  _a() {
    return this.ua(Fe, "bottom")
  }
  ca(t) {
    return this.ua(kr, t)
  }
  ...
  Sa(t) {
    this.jl.push(new Mr(t, this))
  }
  ka(t) {
    this.jl = this.jl.filter(e => e.Vl() !== t)
  }
  ya() {
    if (this.wn instanceof Ne) return t => this.wn.Fe(t)
  }
  Ca() {
    if (this.wn instanceof Ne) return t => this.wn.We(t)
  }
  oa() {
    return !Be(this.Dt().Ta())
  }
  va(t, e) {
    if (!ne(t) || !ne(e) || this.zt.Ni()) return null;
  ...
  $l() {
    switch (this.cn.priceFormat.type) {
      case "custom":
        ...
        break;
      case "volume":
        this.ba = new xh(this.cn.priceFormat.precision);
        break;
      case "percent":
        this.ba = new qs(this.cn.priceFormat.precision);
        break;
      default: {
        const t = Math.pow(10, this.cn.priceFormat.precision);
        this.ba = new We(t, this.cn.priceFormat.minMove * t)
      }
    }
  ...
  Ul(t) {
    switch (this.dn = new cr(this, this.$t()), this.Hl) {
      case "Bar":
      ...
      case "Line":
        ...
        break;
      case "Custom":
        this.wn = new Ne(this, this.$t(), rt(t));
        break;
      case "Area":
        this.wn = new Ah(this, this.$t());
        break;
      case "Baseline":
        this.wn = new Fh(this, this.$t());
        break;
      case "Histogram":
        this.wn = new Zh(this, this.$t());
        break;
      default:
...
class jr {
  ...
  Va(t, e, i) {
    ...
    if (h === null) return s;
    const r = o.Rt(t, h),
      l = i.Oa().filter(c => c instanceof Li).reduce((c, u) => {
        ...
        if (m === null) return c;
        const v = Ut(u.Ct());
        return c.concat([d.Rt(m.Vt[3], v.Vt)])
      }, []);
  ...
  K({
    ...
    t.lineWidth = o,
      function(h, r) {
        ...
        const h = g(this.zt);
        if (h.Ba) {
          t.strokeStyle = h.Aa, It(t, h.Ia), t.beginPath();
          for (const r of h.za) {
        ...
        if (h.Ea) {
          t.strokeStyle = h.Na, It(t, h.Fa), t.beginPath();
          for (const r of h.Wa) {
...
class Lr {
  constructor(t) {
    this.Wt = new zr, this.ft = !0, this.tn = t
  }
  bt() {
    this.ft = !0
  }
...
class He {
  ...
  Za(t, e, i) {
    ...
    let o = Math.pow(10, Math.max(0, Math.ceil(Math.log10(t - e)))),
      ...
      r = this.qa[0];
    for (;;) {
      const u = pe(o, s, 1e-14) && o > s + 1e-14,
        d = pe(o, i * r, 1e-14),
        f = pe(o, 1, 1e-14);
      if (!(u && d && f)) break;
    ...
    if (o <= s + 1e-14 && (o = s), o = Math.max(1, o), this.Ya.length > 0 && (l = o, a = 1, c = 1e-14, Math.abs(l - a) < c))
      for (h = 0, r = this.Ya[0]; pe(o, i * r, 1e-14) && o > s + 1e-14;) o /= r, r = this.Ya[++h % this.Ya.length];
    var l, a, c;
    return o
  }
}
class ts {
  ...
  Za(t, e) {
    ...
    const i = this.Li.At(),
      s = (t - e) * this.Ja() / i,
      o = new He(this.Ua, [2, 2.5, 2]),
      h = new He(this.Ua, [2, 2, 2.5]),
      r = new He(this.Ua, [2.5, 2, 2]),
      l = [];
...
class xr {
  constructor(t, e, i, s) {
    this.ro = 0, this.ho = null, this.Ah = null, this.lo = null, this.ao = {
      oo: !1,
      _o: null
    }, this.uo = 0, this.co = 0, this.do = new G, this.fo = new G, this.vo = [], this.po = null, this.mo = null, this.bo = null, this.wo = null, this.ba = ss, this.Mo = Je(null), this.xo = t, this.cn = e, this.So = i, this.ko = s, this.yo = new ts(this, 100, this.Co.bind(this), this.To.bind(this))
  }
  Ta() {
    return this.xo
  }
  ...
  Hh(t) {
    if (mt(this.cn, t), this.Pa(), t.mode !== void 0 && this.Po({
        yr: t.mode
      }), t.scaleMargins !== void 0) {
      const e = rt(t.scaleMargins.top),
        i = rt(t.scaleMargins.bottom);
  ...
  Po(t) {
    ...
    }(this.Ah, this.Mo) ? (i = be(this.Ah, this.Mo), i !== null && this.Bo(i)) : this.cn.autoScale = !0), t.yr === 1 && t.yr !== e.yr && (i = Yt(this.Ah, this.Mo), i !== null && this.Bo(i));
  ...
  Rt(t, e) {
    return this.gh() ? t = Ft(t, e) : this.Vo() && (t = Qt(t, e)), this.To(t, e)
  }
  Qs(t, e, i) {
    this.Fo();
    const s = this.No(),
  ...
  me(t, e, i) {
    ...
    for (let m = u; m < d; m++) {
      ...
      let j = s + c * (y - h),
        P = a ? j : this.ro - 1 - j;
      v.ve = P, j = s + c * (w - h), P = a ? j : this.ro - 1 - j, v.ce = P, j = s + c * (_ - h), P = a ? j : this.ro - 1 - j, v.de = P, j = s + c * (C - h), P = a ? j : this.ro - 1 - j, v.pe = P
    }
  }
  pn(t, e) {
    const i = this.Co(t, e);
  ...
  $o() {
    ...
    return t = fn(t), this.po = t, this.po
  }
  Uo(t) {
  ...
  Fi(t, e) {
    switch (this.cn.mode) {
      case 2:
        return this.n_(Ft(t, e));
      case 3:
        return this.ma().format(Qt(t, e));
      default:
        return this.Fh(t)
    }
  }
  ...
  Pa() {
    ...
    const t = this.s_();
    let e = 100;
    t !== null && (e = Math.round(1 / t.pa())), this.ba = ss, this.gh() ? (this.ba = is, e = 100) : this.Vo() ? (this.ba = new We(100, 1), e = 100) : t !== null && (this.ba = t.ma()), this.yo = new ts(this, e, this.Co.bind(this), this.To.bind(this)), this.yo.Qa()
  }
  qo() {
    this.po = null
  }
  ...
  h_() {
    ...
    if (s === this.uo && o === this.co || (this.uo = s, this.co = o, this.mo = null, this.Ro()), e !== null) {
      if (e.Th() === e.Ph()) {
        ...
        this.eo() && (e = be(e, this.Mo)), e = new lt(e.Th() - a, e.Ph() + a), this.eo() && (e = Yt(e, this.Mo))
      }
      if (this.eo()) {
        const l = be(e, this.Mo),
          a = Je(l);
        if (h = a, r = this.Mo, h.Ha !== r.Ha || h.$a !== r.$a) {
          const c = this.lo !== null ? be(this.lo, this.Mo) : null;
          this.Mo = a, e = Yt(l, a), c !== null && (this.lo = Yt(c, a))
        }
      }
      this.Bo(e)
    } else this.Ah === null && (this.Bo(new lt(-.5, .5)), this.Mo = Je(null));
    var h, r;
    this.ao.oo = !0
  }
  jo() {
    return this.gh() ? Ft : this.Vo() ? Qt : this.eo() ? t => xe(t, this.Mo) : null
  }
  l_(t, e, i) {
...
class Pr {
  constructor(t, e) {
    this.vo = [], this.a_ = new Map, this.ro = 0, this.o_ = 0, this.__ = 1e3, this.po = null, this.u_ = new G, this.kl = t, this.$i = e, this.c_ = new $r(this);
    const i = e.W();
  ...
  b_(t) {
    ...
    return this.a_.has(t) ? rt(this.a_.get(t))[0].Dt() : null
  }
  S() {
  ...
  $o() {
    return this.po === null && (this.po = fn(this.vo)), this.po
  }
  F_() {
    return this.u_
  }
  ...
  C_(t, e, i) {
    let s = this.b_(e);
    if (s === null && (s = this.f_(e, this.$i.W().overlayPriceScales)), this.vo.push(t), !Be(e)) {
  ...
  f_(t, e) {
    const i = Object.assign({
      ...
      s = new xr(t, i, this.$i.W().layout, this.$i.W().localization);
...
class Rr {
  ...
  q_(t) {
    ...
    if (this.Xe === this.tr) {
      ...
      this.Je.delete(this.Ge), this.Qe.delete(rt(h)), this.Ge++, this.Xe--
    }
    const o = this.H_(t);
...
class Vr {
  ...
  iu(t) {
    ...
    const e = [];
    this.G_.forEach((i, s) => {
      t <= i[0].index ? e.push(s) : i.splice(ue(i, t, o => o.index < t), 1 / 0)
    });
...
class Kt {
  ...
  hu() {
    return this.ru === null ? null : new ee(Math.floor(this.ru.Vs()), Math.ceil(this.ru.ui()))
  }
  lu() {
    return this.ru
  }
...
class Br {
  constructor(t, e, i, s) {
    this.o_ = 0, this.ou = null, this._u = [], this.wo = null, this.bo = null, this.uu = new Vr, this.cu = new Map, this.du = Kt.au(), this.fu = !0, this.vu = new G, this.pu = new G, this.mu = new G, this.bu = null, this.wu = null, this.gu = [], this.cn = e, this.ko = i, this.Mu = e.rightOffset, this.xu = e.barSpacing, this.$i = t, this.U_ = s, this.Su(), this.uu.Q_(e.uniformDistribution)
  }
  W() {
    return this.cn
  }
  ku(t) {
    mt(this.ko, t), this.yu(), this.Su()
  }
  Hh(t, e) {
    var i;
    mt(this.cn, t), this.cn.fixLeftEdge && this.Cu(), this.cn.fixRightEdge && this.Tu(), t.barSpacing !== void 0 && this.$i.Gn(t.barSpacing), t.rightOffset !== void 0 && this.$i.Jn(t.rightOffset), t.minBarSpacing !== void 0 && this.$i.Gn((i = t.barSpacing) !== null && i !== void 0 ? i : this.xu), this.yu(), this.Su(), this.mu.m()
  }
  mn(t) {
    var e, i;
  ...
  Da(t, e) {
    ...
    const i = ue(this._u, this.U_.key(t), (s, o) => this.U_.key(s.time) < o);
  ...
  ja() {
    ...
    for (const m of r) {
      ...
      f < this.gu.length ? (v = this.gu[f], v.coord = this.It(m.index), v.label = this.$u(m), v.weight = m.weight) : (v = {
        ...
        label: this.$u(m),
        weight: m.weight
      }, this.gu.push(v)), this.xu > e / 2 && !c ? v.needAlignCoordinate = !1 : v.needAlignCoordinate = u && m.index <= l || d && m.index >= a, f++
    }
  ...
  Go(t) {
    ...
    const e = fi(this.o_ - t, 0, this.o_),
      i = fi(this.o_ - g(this.bo), 0, this.o_);
  ...
  rc() {
    const t = this.Ou(),
      e = this.Bu();
    t !== null && e !== null && this.ec(new ee(t, e + this.cn.rightOffset))
  }
  hc(t) {
    const e = new ee(t.from, t.to);
    this.ec(e)
  }
  qi(t) {
  ...
  Pu() {
    if (!this.fu) return;
    if (this.fu = !1, this.Ni()) return void this.oc(Kt.au());
    const t = this.Lu(),
      e = this.o_ / this.xu,
      i = this.Mu + t,
      s = new ee(i - e + 1, i);
  ...
  $u(t) {
    ...
    return e === void 0 && (e = new Rr(i => this.dc(i), this.U_), this.cu.set(t.weight, e)), e.q_(t)
  }
  dc(t) {
  ...
  oc(t) {
    const e = this.du;
    this.du = t, ns(e.hu(), this.du.hu()) || this.vu.m(), ns(e.lu(), this.du.lu()) || this.pu.m(), this.ac()
  }
  ac() {
    this.wu = null
  }
...
class Dr {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      gc: "center",
      Mc: "center"
    }, this.Wt = new Ar(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
  ...
  Mt() {
    ...
    e.yt = t.visible, e.yt && (e.V = t.color, e.Mc = t.horzAlign, e.gc = t.vertAlign, e.mc = [{
      Kt: t.text,
      R: Jt(t.fontSize, t.fontFamily, t.fontStyle),
      wc: 1.2 * t.fontSize,
      xc: 0,
      Yu: 0
    }])
...
class Nr extends ki {
  constructor(t, e) {
    super(), this.cn = e, this.wn = new Dr(this)
  }
  Rn() {
    return []
  }
...
class Or {
  constructor(t, e, i) {
    this.kc = [], this.yc = [], this.o_ = 0, this.Cc = null, this.Tc = new G, this.Pc = new G, this.Rc = null, this.Dc = t, this.cn = e, this.U_ = i, this.Vc = new wh(this), this.kl = new Br(this, e.timeScale, this.cn.localization, i), this.vt = new Th(this, e.crosshair), this.Oc = new jr(e.crosshair), this.Bc = new Nr(this, e.watermark), this.Ac(), this.kc[0].M_(2e3), this.Ic = this.zc(0), this.Lc = this.zc(1)
  }
  Xl() {
    this.Ec(st.es())
  }
  ...
  Hh(t) {
    mt(this.cn, t), this.kc.forEach(e => e.m_(t)), t.timeScale !== void 0 && this.kl.Hh(t.timeScale), t.localization !== void 0 && this.kl.ku(t.localization), (t.leftPriceScale || t.rightPriceScale) && this.Tc.m(), this.Ic = this.zc(0), this.Lc = this.zc(1), this.Xl()
  }
  Hc(t, e) {
  ...
  fd(t) {
    const e = this.cr(t),
      i = this.yc.indexOf(t);
    $t(i !== -1, "Series not found"), this.yc.splice(i, 1), g(e).Yo(t), t.S && t.S()
  }
  Zl(t, e) {
    const i = g(this.cr(t));
    i.Yo(t);
  ...
  Bt(t) {
    ...
    const s = function(o, h, r) {
      const [l, a, c, u] = se(o), [d, f, m, v] = se(h), y = [ct(l + r * (d - l)), ct(a + r * (f - a)), ct(c + r * (m - c)), Xs(u + r * (v - u))];
  ...
  dd(t, e, i, s) {
    const o = new Li(this, t, e, i, s),
      h = t.priceScaleId !== void 0 ? t.priceScaleId : this.pd();
    return i.Uo(o, h), Be(h) || o.Hh(t), o
  }
  zc(t) {
...
const cs = n => n.getUTCFullYear();

function Ur(n, t, e) {
  return t.replace(/yyyy/g, (i => yt(cs(i), 4))(n)).replace(/yy/g, (i => yt(cs(i) % 100, 2))(n)).replace(/MMMM/g, ((i, s) => new Date(i.getUTCFullYear(), i.getUTCMonth(), 1).toLocaleString(s, {
    month: "long"
  }))(n, e)).replace(/MMM/g, ((i, s) => new Date(i.getUTCFullYear(), i.getUTCMonth(), 1).toLocaleString(s, {
    month: "short"
  }))(n, e)).replace(/MM/g, (i => yt((s => s.getUTCMonth() + 1)(i), 2))(n)).replace(/dd/g, (i => yt((s => s.getUTCDate())(i), 2))(n))
}
class pn {
...
class Fr {
  ...
  q_(t) {
    return this.Md.replace("%h", yt(t.getUTCHours(), 2)).replace("%m", yt(t.getUTCMinutes(), 2)).replace("%s", yt(t.getUTCSeconds(), 2))
  }
}
const Kr = {
  xd: "yyyy-MM-dd",
...
class Jr {
  constructor(t = {}) {
    ...
    this.Cd = new pn(e.xd, e.yd), this.Td = new Fr(e.Sd), this.Pd = e.kd
  }
  q_(t) {
...
function ds(n, t) {
  ...
  for (let e = _e.length - 1; e >= 0; --e)
    if (Math.floor(t.getTime() / _e[e].Rd) !== Math.floor(n.getTime() / _e[e].Rd)) return _e[e].Dd;
  return 0
}

function Ye(n) {
  let t = n;
  if (ce(n) && (t = $i(n)), !mi(t)) throw new Error("time must be of type BusinessDay");
...
function fs(n) {
  if (!mn(n)) throw new Error("time must be of type isUTCTimestamp");
  return {
    Vd: n
  }
}
...
class ps {
  ...
  createConverterToInternalObj(t) {
    return g(function(e) {
      return e.length === 0 ? null : mi(e[0].time) || ce(e[0].time) ? Ye : fs
    }(t))
  }
  key(t) {
  ...
  convertHorzItemToInternal(t) {
    return mn(e = t) ? fs(e) : mi(e) ? Ye(e) : Ye($i(e));
    var e
  }
  updateFormatter(t) {
    if (!this.cn) return;
  ...
  fillWeightsForPoints(t, e) {
    (function(i, s = 0) {
      ...
      for (let l = s; l < i.length; ++l) {
        ...
        h !== null && (a.timeWeight = ds(c, h)), r += a.time.Vd - (o || a.time.Vd), o = a.time.Vd, h = c
      }
      if (s === 0 && i.length > 1) {
        const l = Math.ceil(r / (i.length - 1)),
          a = new Date(1e3 * (i[0].time.Vd - l));
        i[0].timeWeight = ds(new Date(1e3 * i[0].time.Vd), a)
      }
    })(t, e)
  }
  static Ad(t) {
...
class Hr {
  ...
  Dr(t, e) {
    ...
    let i = 0;
    const s = qe(this.zd, this.Ld, this.$d),
      o = Ge(this.zd, this.Ld),
      h = [s],
      r = [o];
    if (i += o, this.Ed !== null) {
      const a = qe(this.Ld, this.Ed, this.$d);
      if (Math.sign(a) === Math.sign(s)) {
        const c = Ge(this.Ld, this.Ed);
        if (h.push(a), r.push(c), i += c, this.Nd !== null) {
          const u = qe(this.Ed, this.Nd, this.$d);
          if (Math.sign(u) === Math.sign(s)) {
            const d = Ge(this.Ed, this.Nd);
...
class Xr {
  ...
  sf() {
    return Ys(se(this.Jd.W().layout.textColor)) > 160 ? "dark" : "light"
  }
  nf() {
...
class Ei {
  constructor(t, e, i) {
    this.rf = 0, this.hf = null, this.lf = {
      ...
      nt: Number.NEGATIVE_INFINITY,
      st: Number.POSITIVE_INFINITY
    }, this.cf = null, this.df = !1, this.ff = null, this.vf = null, this.pf = !1, this.mf = !1, this.bf = !1, this.wf = null, this.gf = null, this.Mf = null, this.xf = null, this.Sf = null, this.kf = null, this.yf = null, this.Cf = 0, this.Tf = !1, this.Pf = !1, this.Rf = !1, this.Df = 0, this.Vf = null, this.Of = !Ze(), this.Bf = s => {
      this.Af(s)
    }, this.If = s => {
      if (this.zf(s)) {
        const o = this.Lf(s);
  ...
  tv(t) {
    const e = Qe(t.changedTouches, g(this.Vf));
    if (e === null || (this.Df = we(t), this.yf !== null) || this.Pf) return;
    this.Tf = !0;
    const i = this.Nf(vt(e), g(this.vf)),
      {
        iv: s,
        nv: o,
        Ef: h
    ...
    if (this.pf || !(h < 5)) {
      ...
      if (!this.Pf) {
        const r = this.Lf(t, e);
        this.Ff(r, this.jf.rv), Nt(t)
      }
    }
  }
  hv(t) {
    if (t.button !== 0) return;
    const e = this.Nf(vt(t), g(this.ff)),
      {
        Ef: i
      } = e;
  ...
  av(t) {
    let e = Qe(t.changedTouches, g(this.Vf));
    if (e === null && t.touches.length === 0 && (e = t.changedTouches[0]), e === null) return;
    this.Vf = null, this.Df = we(t), this.Xf(), this.vf = null, this.kf && (this.kf(), this.kf = null);
    const i = this.Lf(t, e);
    if (this.Ff(i, this.jf.ov), ++this.af, this._f && this.af > 1) {
      const {
        Ef: s
      } = this.Nf(vt(e), this.uf);
  ...
  Af(t) {
    if (t.button !== 0) return;
    const e = this.Lf(t);
    if (this.ff = null, this.Rf = !1, this.Sf && (this.Sf(), this.Sf = null), vs() && this.Yf.ownerDocument.documentElement.removeEventListener("mouseleave", this.Bf), !this.zf(t))
      if (this.$f(e, this.jf.uv), ++this.rf, this.hf && this.rf > 1) {
        const {
          Ef: i
        } = this.Nf(vt(t), this.lf);
  ...
  dv(t) {
    ...
    this.Vf = e.identifier, this.Df = we(t);
    const i = this.Yf.ownerDocument.documentElement;
    this.bf = !1, this.pf = !1, this.Pf = !1, this.vf = vt(e), this.kf && (this.kf(), this.kf = null);
    {
    ...
    const s = this.Lf(t, e);
    this.Ff(s, this.jf.vv), this._f || (this.af = 0, this._f = setTimeout(this.Hf.bind(this), 500), this.uf = vt(e))
  }
  pv(t) {
    if (t.button !== 0) return;
    const e = this.Yf.ownerDocument.documentElement;
    vs() && e.addEventListener("mouseleave", this.Bf), this.mf = !1, this.ff = vt(t), this.Sf && (this.Sf(), this.Sf = null);
    {
    ...
    const i = this.Lf(t);
    this.$f(i, this.jf.mv), this.hf || (this.rf = 0, this.hf = setTimeout(this.qf.bind(this), 500), this.lf = vt(t))
  }
  Zf() {
    ...
    Ze() && (this.Mf = () => {
      ...
      passive: !0
    }), Yr(this.Yf), this.Yf.addEventListener("mousedown", this.pv.bind(this)), this.gv(), this.Yf.addEventListener("touchmove", () => {}, {
      passive: !1
    })
  }
  gv() {
    this.jf.Mv === void 0 && this.jf.xv === void 0 && this.jf.Sv === void 0 || (this.Yf.addEventListener("touchstart", t => this.kv(t.touches), {
      ...
      if (t.touches.length === 2 && this.yf !== null && this.jf.xv !== void 0) {
        const e = bs(t.touches[0], t.touches[1]) / this.Cf;
  ...
  Cv(t) {
    ...
    }, this.Cf = bs(t[0], t[1]), this.jf.Mv !== void 0 && this.jf.Mv(), this.Xf()
  }
  yv() {
  ...
  wv(t) {
    ...
    const e = this.Lf(t);
    this.$f(e, this.jf.Tv), this.Of = !Ze()
  }
  fv(t) {
    const e = Qe(t.touches, g(this.Vf));
    if (e === null) return;
    const i = this.Lf(t, e);
    this.Ff(i, this.jf.Pv), this.bf = !0, this.df = !0
  }
  zf(t) {
    return t.sourceCapabilities && t.sourceCapabilities.firesTouchEvents !== void 0 ? t.sourceCapabilities.firesTouchEvents : we(t) < this.Df + 500
  }
  Ff(t, e) {
    e && e.call(this.jf, t)
  }
...
class _s {
  constructor(t, e, i, s) {
    this.Li = null, this.Lv = null, this.Ev = !1, this.Nv = new he(200), this.Jr = null, this.Fv = 0, this.Wv = !1, this.jv = () => {
      this.Wv || this.tn.Hv().$t().$h()
    }, this.$v = () => {
      this.Wv || this.tn.Hv().$t().$h()
    }, this.tn = t, this.cn = e, this.So = e.layout, this.Vc = i, this.Uv = s === "left", this.qv = ti("normal", s), this.Yv = ti("top", s), this.Zv = ti("bottom", s), this.Xv = document.createElement("div"), this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Xv.style.width = "25px", this.Xv.style.left = "0", this.Xv.style.position = "relative", this.Kv = Bt(this.Xv, U({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const o = this.Kv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "1", o.style.left = "0", o.style.top = "0", this.Gv = Bt(this.Xv, U({
      width: 16,
      height: 16
    ...
    this.rp = new Ei(this.Gv.canvasElement, r, {
      sv: () => !this.cn.handleScroll.vertTouchDrag,
      ev: () => !0
    })
  }
  S() {
    this.rp.S(), this.Gv.unsubscribeSuggestedBitmapSizeChanged(this.$v), Wt(this.Gv.canvasElement), this.Gv.dispose(), this.Kv.unsubscribeSuggestedBitmapSizeChanged(this.jv), Wt(this.Kv.canvasElement), this.Kv.dispose(), this.Li !== null && this.Li.Xo().p(this), this.Li = null
  }
  hp() {
    return this.Xv
  }
  ...
  ap() {
    ...
    i.restore();
    const r = t || 34;
    return pi(Math.ceil(e.C + e.T + e.A + e.I + 5 + r))
  }
  up(t) {
    this.Lv !== null && Pt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`)
  }
  cp() {
  ...
  pp({
    ...
    h === r ? Ve(t, 0, 0, i, s, h) : Zs(t, 0, 0, i, s, h, r)
  }
  Ae({
    context: t,
    bitmapSize: e,
  ...
  kp(t, e) {
    ...
    gs(s, 1, this.Lv.height, e), gs(o, -1, this.Lv.height, e)
  }
  wp(t) {
    if (this.Lv === null) return;
    const e = this._p(),
  ...
  op() {
    return Jt(this.So.fontSize, this.So.fontFamily)
  }
}
...
class Ti {
  constructor(t, e) {
    ...
    i.style.width = "100%", i.style.height = "100%", i.style.position = "relative", i.style.overflow = "hidden", this.Wp = document.createElement("td"), this.Wp.style.padding = "0", this.jp = document.createElement("td"), this.jp.style.padding = "0", this.Fp.appendChild(i), this.Kv = Bt(i, U({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const s = this.Kv.canvasElement;
    s.style.position = "absolute", s.style.zIndex = "1", s.style.left = "0", s.style.top = "0", this.Gv = Bt(i, U({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
    const o = this.Gv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "2", o.style.left = "0", o.style.top = "0", this.Hp = document.createElement("tr"), this.Hp.appendChild(this.Wp), this.Hp.appendChild(this.Fp), this.Hp.appendChild(this.jp), this.$p(), this.rp = new Ei(this.Gv.canvasElement, this, {
      sv: () => this.Ap === null && !this.Jd.W().handleScroll.vertTouchDrag,
      ev: () => this.Ap === null && !this.Jd.W().handleScroll.horzTouchDrag
    })
  }
  S() {
    this.yp !== null && this.yp.S(), this.Cp !== null && this.Cp.S(), this.Tp = null, this.Gv.unsubscribeSuggestedBitmapSizeChanged(this.$v), Wt(this.Gv.canvasElement), this.Gv.dispose(), this.Kv.unsubscribeSuggestedBitmapSizeChanged(this.jv), Wt(this.Kv.canvasElement), this.Kv.dispose(), this.Ep !== null && this.Ep.F_().p(this), this.rp.S()
  }
  dp() {
    return g(this.Ep)
  }
  Up(t) {
    var e, i;
    this.Ep !== null && this.Ep.F_().p(this), this.Ep = t, this.Ep !== null && this.Ep.F_().l(Ti.prototype.Np.bind(this), this, !0), this.$p(), this.Jd.qp().indexOf(this) === this.Jd.qp().length - 1 ? (this.Tp = (e = this.Tp) !== null && e !== void 0 ? e : new Xr(this.Fp, this.Jd), this.Tp.bt()) : ((i = this.Tp) === null || i === void 0 || i.tf(), this.Tp = null)
  }
  Hv() {
    return this.Jd
  }
    ...
    return i === null ? null : function(s, o, h) {
      const r = s.$o(),
        l = function(a, c, u) {
          ...
          let m, v;
          for (const _ of a) {
            const C = (f = (d = _.fa) === null || d === void 0 ? void 0 : d.call(_, c, u)) !== null && f !== void 0 ? f : [];
            for (const j of C) y = j.zOrder, (!(w = m == null ? void 0 : m.zOrder) || y === "top" && w !== "top" || y === "normal" && w === "bottom") && (m = j, v = _)
          }
          var y, w;
          return m && v ? {
            Iv: m,
      ...
      if ((l == null ? void 0 : l.Iv.zOrder) === "top") return ye(l);
      for (const a of r) {
        if (l && l.jc === a && l.Iv.zOrder !== "bottom" && !l.Iv.isBackground) return ye(l);
        const c = Zr(a.Pn(s), o, h);
        if (c !== null) return {
          jc: a,
          Ov: c.Ov,
          Av: c.Av
  ...
  up(t) {
    Pt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Fp.style.width = t.width + "px", this.Fp.style.height = t.height + "px")
  }
  um() {
    const t = g(this.Ep);
    t.T_(t.P_()), t.T_(t.R_());
  ...
  fp(t) {
    ...
    if (t > 1 && this.um(), this.yp !== null && this.yp.fp(t), this.Cp !== null && this.Cp.fp(t), t !== 1) {
      ...
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s)
      }), this.Ep && (this.dm(i, Gr), this.fm(i), this.vm(i), this.dm(i, Se), this.dm(i, qr)))
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Vt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
  ...
  pp({
    ...
    h === r ? Ve(t, 0, 0, i, s, r) : Zs(t, 0, 0, i, s, h, r)
  }
  fm(t) {
  ...
  vm(t) {
    const e = this.$i().qc();
    this.gm(t, Se, vi, e), this.gm(t, Se, ke, e)
  }
  pm(t) {
    this.gm(t, Se, ke, this.$i().Yc())
  }
  dm(t, e) {
    const i = g(this.Ep).$o();
    for (const s of i) this.gm(t, e, vi, s);
    for (const s of i) this.gm(t, e, ke, s)
  }
  gm(t, e, i, s) {
    const o = g(this.Ep),
      h = o.$t().Fc(),
  ...
  Yp() {
    ...
    const s = t.$t()._d();
    e && this.yp === null && (this.yp = new _s(this, t.W(), s, "left"), this.Wp.appendChild(this.yp.hp())), i && this.Cp === null && (this.Cp = new _s(this, t.W(), s, "right"), this.jp.appendChild(this.Cp.hp()))
  }
  Mm(t) {
  ...
  im(t) {
    ...
    if (this.Pp !== null || this.Mm(t) || (this.Pp = {
      ...
      if (t.Rv && h.touch || !t.Rv && h.mouse) {
        const a = i.he();
        this.Lp = new Hr(.2 / a, 7 / a, .997, 15 / a), this.Lp.qd(i.ju(), this.Pp.Vd)
      } else this.Lp = null;
...
class ws {
  constructor(t, e, i, s, o) {
    this.ft = !0, this.Lv = U({
      width: 0,
      height: 0
    }), this.jv = () => this.fp(3), this.Uv = t === "left", this.Vc = i._d, this.cn = e, this.Cm = s, this.Tm = o, this.Xv = document.createElement("div"), this.Xv.style.width = "25px", this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Kv = Bt(this.Xv, U({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv)
  }
  S() {
    this.Kv.unsubscribeSuggestedBitmapSizeChanged(this.jv), Wt(this.Kv.canvasElement), this.Kv.dispose()
  }
  hp() {
    return this.Xv
  }
  ...
  up(t) {
    Pt(this.Lv, t) || (this.Lv = t, this.Kv.resizeCanvasElement(t), this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.ft = !0)
  }
  fp(t) {
  ...
  pp({
    ...
    Ve(t, 0, 0, e.width, e.height, this.Tm())
  }
}
...
class sl {
  constructor(t, e) {
    this.Pm = null, this.Rm = null, this.k = null, this.Dm = !1, this.Lv = U({
      width: 0,
      height: 0
    }), this.Vm = new G, this.Nv = new he(5), this.Wv = !1, this.jv = () => {
      this.Wv || this.Jd.$t().$h()
    }, this.$v = () => {
      this.Wv || this.Jd.$t().$h()
    }, this.Jd = t, this.U_ = e, this.cn = t.W().layout, this.Zd = document.createElement("tr"), this.Om = document.createElement("td"), this.Om.style.padding = "0", this.Bm = document.createElement("td"), this.Bm.style.padding = "0", this.Xv = document.createElement("td"), this.Xv.style.height = "25px", this.Xv.style.padding = "0", this.Am = document.createElement("div"), this.Am.style.width = "100%", this.Am.style.height = "100%", this.Am.style.position = "relative", this.Am.style.overflow = "hidden", this.Xv.appendChild(this.Am), this.Kv = Bt(this.Am, U({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const i = this.Kv.canvasElement;
    i.style.position = "absolute", i.style.zIndex = "1", i.style.left = "0", i.style.top = "0", this.Gv = Bt(this.Am, U({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
    const s = this.Gv.canvasElement;
    s.style.position = "absolute", s.style.zIndex = "2", s.style.left = "0", s.style.top = "0", this.Zd.appendChild(this.Om), this.Zd.appendChild(this.Xv), this.Zd.appendChild(this.Bm), this.Im(), this.Jd.$t().w_().l(this.Im.bind(this), this), this.rp = new Ei(this.Gv.canvasElement, this, {
      sv: () => !0,
      ev: () => !this.Jd.W().handleScroll.horzTouchDrag
    })
  }
  S() {
    this.rp.S(), this.Pm !== null && this.Pm.S(), this.Rm !== null && this.Rm.S(), this.Gv.unsubscribeSuggestedBitmapSizeChanged(this.$v), Wt(this.Gv.canvasElement), this.Gv.dispose(), this.Kv.unsubscribeSuggestedBitmapSizeChanged(this.jv), Wt(this.Kv.canvasElement), this.Kv.dispose()
  }
  hp() {
    return this.Zd
  }
  ...
  Nm(t, e, i) {
    Pt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.Vm.m(t)), this.Pm !== null && this.Pm.up(U({
      width: e,
      height: t.height
  ...
  fp(t) {
    ...
    if (t !== 1) {
      ...
      const i = Vt(this.Kv);
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s), this.Ae(s), this.Hm(i, il)
      }), this.bp(i), this.Hm(i, tl)), this.Pm !== null && this.Pm.fp(t), this.Rm !== null && this.Rm.fp(t)
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Vt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
      ...
      i.clearRect(0, 0, s.width, s.height)
    }), this.$m([...this.Jd.$t().wt(), this.Jd.$t().Yc()], e), this.Hm(e, el))
  }
  Hm(t, e) {
    const i = this.Jd.$t().wt();
    for (const s of i) bi(e, o => vi(o, t, !1, void 0), s, void 0);
    for (const s of i) bi(e, o => ke(o, t, !1, void 0), s, void 0)
  }
  pp({
    context: t,
    bitmapSize: e
  }) {
    Ve(t, 0, 0, e.width, e.height, this.Jd.$t().md())
  }
  Ae({
    context: t,
    bitmapSize: e,
  ...
  op() {
    return Jt(this.j(), this.cn.fontFamily)
  }
  Ym() {
    return Jt(this.j(), this.cn.fontFamily, "bold")
  }
  Wm() {
    this.k === null && (this.k = {
      C: 1,
  ...
  Im() {
    ...
    const i = {
      ...
      o = () => t.md();
    e.leftPriceScale.visible && this.Pm === null && (this.Pm = new ws("left", e, i, s, o), this.Om.appendChild(this.Pm.hp())), e.rightPriceScale.visible && this.Rm === null && (this.Rm = new ws("right", e, i, s, o), this.Bm.appendChild(this.Rm.hp()))
  }
}
const nl = !!Ht && !!navigator.userAgentData && navigator.userAgentData.brands.some(n => n.brand.includes("Chromium")) && !!Ht && (!((ei = navigator == null ? void 0 : navigator.userAgentData) === null || ei === void 0) && ei.platform ? navigator.userAgentData.platform === "Windows" : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
var ei;
class ol {
  constructor(t, e, i) {
    var s;
    this.Zm = [], this.Xm = 0, this.ro = 0, this.o_ = 0, this.Km = 0, this.Gm = 0, this.Jm = null, this.Qm = !1, this.Dp = new G, this.Vp = new G, this.Pc = new G, this.tb = null, this.ib = null, this.Gd = t, this.cn = e, this.U_ = i, this.Zd = document.createElement("div"), this.Zd.classList.add("tv-lightweight-charts"), this.Zd.style.overflow = "hidden", this.Zd.style.direction = "ltr", this.Zd.style.width = "100%", this.Zd.style.height = "100%", (s = this.Zd).style.userSelect = "none", s.style.webkitUserSelect = "none", s.style.msUserSelect = "none", s.style.MozUserSelect = "none", s.style.webkitTapHighlightColor = "transparent", this.nb = document.createElement("table"), this.nb.setAttribute("cellspacing", "0"), this.Zd.appendChild(this.nb), this.sb = this.eb.bind(this), ii(this.cn) && this.rb(!0), this.$i = new Or(this.Dc.bind(this), this.cn, i), this.$t().Zc().l(this.hb.bind(this), this), this.lb = new sl(this, this.U_), this.nb.appendChild(this.lb.hp());
  ...
  ob(t, e, i = !1) {
    ...
    const o = this.ro + "px",
      h = this.o_ + "px";
    g(this.Zd).style.height = o, g(this.Zd).style.width = h, this.nb.style.height = o, this.nb.style.width = h, i ? this.pb(st.es(), performance.now()) : this.$i.Xl()
  }
  fp(t) {
    t === void 0 && (t = st.es());
  ...
  Tb() {
    ...
    for (let m = 0; m < this.Zm.length; ++m) {
      ...
      let y = 0,
        w = 0;
      w = m === this.Zm.length - 1 ? u - f : Math.round(v.g_() * d), y = Math.max(w, 2), f += y, v.up(U({
        width: h,
        height: y
  ...
  Pb(t) {
    ...
    return nl ? 1 / window.devicePixelRatio : 1
  }
  eb(t) {
  ...
  Ab(t, e, i) {
    ...
    const r = this.$t().Fc(),
      l = r !== null && r.jc instanceof Li ? r.jc : void 0,
...
class dl {
    ...
    if (e.length !== 0) {
      ...
      h = e.map((f, m) => {
        const v = a(f.time),
          y = this.U_.key(v);
        let w = this.Ub.get(y);
        w === void 0 && (w = ks(v), this.Ub.set(y, w), s = !0);
        const _ = c(v, w.se, f, l[m], u, d);
  ...
  tw(t, e) {
    ...
    const r = h === void 0;
    h === void 0 && (h = ks(s), this.Ub.set(this.U_.key(s), h));
    const l = Ms(t.Jh()),
      a = t.ya(),
      c = t.Ca(),
    ...
    const f = {
        ...
        time: h.ha,
        pointData: h,
        originalTime: js(h.jb)
      },
      m = ue(this.Zb, this.U_.key(f.time), (v, y) => this.U_.key(v.time) < y);
    this.Zb.splice(m, 0, f);
    for (let v = m; v < this.Zb.length; ++v) si(this.Zb[v].pointData, v);
  ...
  iw(t, e) {
    ...
    s === null || this.U_.key(e.ot) > this.U_.key(s.ot) ? Me(e) && i.push(e) : Me(e) ? i[i.length - 1] = e : i.splice(-1, 1), this.Yb.set(t, e.ot)
  }
  Gb(t, e) {
    e.length !== 0 ? (this.qb.set(t, e.filter(Me)), this.Yb.set(t, e[e.length - 1].ot)) : (this.qb.delete(t), this.Yb.delete(t))
  }
  Kb() {
  ...
  Jb(t) {
    ...
    for (let i = 0; i < this.Zb.length && i < t.length; ++i) {
      ...
      o.timeWeight = s.timeWeight, si(o.pointData, i)
    }
    if (e === -1 && this.Zb.length !== t.length && (e = Math.min(this.Zb.length, t.length)), e === -1) return -1;
    for (let i = e; i < t.length; ++i) si(t[i].pointData, i);
...
function Ls() {
  return {
    ...
    crosshair: gl,
    grid: _l,
    overlayPriceScales: Object.assign({}, ni),
    leftPriceScale: Object.assign(Object.assign({}, ni), {
      visible: !1
    }),
    rightPriceScale: Object.assign(Object.assign({}, ni), {
      visible: !0
    }),
    timeScale: yl,
    watermark: Sl,
...
class Ml {
  ...
  width() {
    return Be(this.aw) ? this.lw.gb(this.aw) : 0
  }
  Li() {
...
function $s(n, t, e) {
  const i = vn(n, ["time", "originalTime"]),
    s = Object.assign({
      time: t
    }, i);
...
class jl {
  ...
  barsInLogicalRange(t) {
    if (t === null) return null;
    const e = new Kt(new ee(t.from, t.to)).hu(),
      i = this.Ls.In();
    if (i.Ni()) return null;
    const s = i.hl(e.Vs(), 1),
      o = i.hl(e.ui(), -1),
  ...
  dataByIndex(t, e) {
    ...
    return i === null ? null : gi(this.seriesType())(i)
  }
  data() {
    const t = gi(this.seriesType());
...
class zl {
  ...
  options() {
    return Object.assign(Object.assign({}, wt(this.kl.W())), {
...
function Es(n) {
  return function(t) {
    if (me(t.handleScale)) {
      ...
      me(i) && (t.handleScale.axisPressedMouseMove = {
        time: i,
        price: i
      }), me(s) && (t.handleScale.axisDoubleClickReset = {
        time: s,
        price: s
      })
    }
...
class $l {
  constructor(t, e, i) {
    this.xw = new Map, this.Sw = new Map, this.kw = new G, this.yw = new G, this.Cw = new G, this.Tw = new dl(e);
    const s = i === void 0 ? wt(Ls()) : mt(wt(Ls()), Es(i));
    this.U_ = e, this.lw = new ol(t, s, e), this.lw.hm().l(h => {
    ...
    const o = this.lw.$t();
    this.Rw = new zl(o, this.lw.cb(), this.U_)
  }
  remove() {
  ...
  addCustomSeries(t, e) {
    const i = Ut(t),
      s = Object.assign(Object.assign({}, Ks), i.defaultOptions());
    return this.Dw("Custom", s, e, i)
  }
  addAreaSeries(t) {
    return this.Dw("Area", dh, t)
  }
  addBaselineSeries(t) {
    return this.Dw("Baseline", fh, t)
  }
  addBarSeries(t) {
    return this.Dw("Bar", ch, t)
  }
  addCandlestickSeries(t = {}) {
    ...
    }(t), this.Dw("Candlestick", ah, t)
  }
  addHistogramSeries(t) {
    return this.Dw("Histogram", mh, t)
  }
  addLineSeries(t) {
    return this.Dw("Line", uh, t)
  }
  removeSeries(t) {
    const e = rt(this.xw.get(t)),
      i = this.Tw.fd(e);
  ...
  Dw(t, e, i = {}, s) {
    Ll(i.priceFormat);
    const o = mt(wt(Js), wt(e), i),
      h = this.lw.$t().ud(t, o, s),
      r = new jl(h, this, this, this, this.U_);
...
function Tl(n, t) {
  return El(n, new ps, ps.Ad(t))
}
Object.assign(Object.assign({}, Js), Ks);
const Ts = "chart-series-type-storage-key",
  gn = n => {
    const t = gt("$iBkM1fJygO"),
      e = gt(() => Zt.ONE_MINUTE, "$U7uRnIu5qm"),
      i = gt(() => Ct.MARKET_CAP, "$oqBOSk6KRz"),
      s = gt(() => {
        const _ = Ot.CANDLESTICK;
        return ie().$webApp.storage.local.get(Ts) ?? _
      }, "$HolymaTkRj"),
      o = gt(() => n.jettonShortname, "$UDNpnPF3Rr"),
      h = gt("$OxUMQZpMxL"),
      r = gt(() => new AbortController, "$3srltZOr0B"),
      l = () => {
      ...
      u = _ => {
        s.value = _, ie().$webApp.storage.local.set(Ts, _)
      },
      d = _ => {
        const C = i.value,
          j = e.value,
          P = t.value;
        if (!P || P.type !== C || P.interval !== j) return {
          type: C,
          interval: j,
          data: _
        };
        const q = _.points.filter(b => P.data.points.some(k => k.timestamp === b.timestamp)),
          O = _.points.filter(b => !P.data.points.some(k => k.timestamp === b.timestamp));
        return {
          type: C,
          interval: j,
          data: {
            points: [...O, ...P.data.points.map(b => q.find(k => k.timestamp === b.timestamp) || b)]
          }
        }
      },
      f = async _ => {
        ...
        const {
          signal: j
        } = r.value, P = await je.getMemepadJettonCandleChart(o.value, {
          interval: e.value,
          type: i.value,
          fromTimestamp: _
        });
        j.aborted || (jt(P) ? t.value = d(P.data) : h.value = C)
      }, m = gt(() => $n(async () => {
        const _ = await je.getMemepadJettonCandleChart(o.value, {
          interval: e.value,
          type: i.value
        });
        return En(_)
      }, _ => t.value = d(_), 5e3), "$94wRLOqniR"), v = z(() => {
        var _;
        return t.value && t.value.type === Ct.MARKET_CAP ? (_ = [...t.value.data.points].sort((C, j) => C.timestamp - j.timestamp).at(-1)) == null ? void 0 : _.price : void 0
      });
    return {
      _flow: {
        init: async () => {
        ...
        destroy: () => {
          m.value.destroy(), t.value = void 0, e.value = Zt.ONE_MINUTE, i.value = Ct.MARKET_CAP, h.value = void 0, l()
        }
      },
      chart: z(() => t.value),
      chartType: z(() => i.value),
      chartInterval: z(() => e.value),
      chartSeriesType: z(() => s.value),
      chartMarketCap: v,
    ...
    setup(n) {
      const t = n,
        ...
        v = z(() => [{
          ...
          value: Zt.FIVE_MINUTES,
          label: `5${T("base.time.abbr.minutes")}`
        }, {
          value: Zt.FIFTEEN_MINUTES,
        ...
        C = new ResizeObserver(() => {
          var k;
          const b = c.value;
          b && ((k = u.value) == null || k.resize(b.clientWidth, b.clientHeight))
        }),
        j = () => {
          const b = c.value;
          b && C.observe(b)
        ...
        q = (b, k, A) => {
          var et, ot, at, Et, Xt;
          const H = (et = ie().$webApp.dataUnsafe.user) == null ? void 0 : et.language_code,
            E = (ot = u.value) == null ? void 0 : ot.timeScale().getVisibleRange(),
            R = (at = u.value) == null ? void 0 : at.timeScale().getVisibleLogicalRange(),
            W = (Xt = (Et = d.value) == null ? void 0 : Et.dataByIndex(0)) == null ? void 0 : Xt.time;
          d.value && u.value && u.value.removeSeries(d.value), k.innerHTML = "";
          const $ = Tl(k, {
            localization: {
              timeFormatter: X => {
                const ht = Y => String(Y).padStart(2, "0"),
                  K = new Date(X * 1e3);
                return `${ht(K.getUTCHours())}:${ht(K.getUTCMinutes())}`
              },
              priceFormatter: X => {
                if (_.value === Ct.MARKET_CAP) return `$${Le(X,{accuracy:0})}`;
                {
                  if (Math.abs(X) < 1e-9) return "$0";
                  const [ht, K] = X.toFixed(9).split("."), Y = K[0], Mt = K.slice(1).match(/^0+/), Dt = Mt ? Mt[0].length : 0, wn = Dt > 0 ? String.fromCharCode(8321 + Dt) : "", yn = K.slice(Dt + 1).replace(/0+$/, "").slice(0, 3);
                  return `$${ht}.${Y}${wn}${yn}`
                }
              },
              locale: H
          ...
          const N = A === Ot.CANDLESTICK ? $.addCandlestickSeries({
            upColor: "#C4F85C",
            downColor: "#FF00C7",
            baseLineWidth: 2,
            ...
            priceFormat: {
              type: "price",
              precision: _.value === Ct.MARKET_CAP ? 0 : 9,
              minMove: 1e-9
            }
          }) : $.addLineSeries({
            color: "#C4F85C",
          ...
          $.timeScale().subscribeVisibleLogicalRangeChange(X => {
            var ut, Mt;
            if (!X || X.from >= 0) return;
            const ht = (ut = N.dataByIndex(0)) == null ? void 0 : ut.time,
              K = (Mt = $.timeScale().getVisibleRange()) == null ? void 0 : Mt.from;
            if (!ht || ht !== K) return;
            const Y = (() => {
              const Dt = new Date(K * 1e3);
              return (Dt.getTime() + Dt.getTimezoneOffset() * 60 * 1e3) / 1e3
            })();
            a(Y)
          });
          const D = b.map(X => ({
              time: (() => {
                const ht = new Date(X.timestamp);
                return (ht.getTime() - ht.getTimezoneOffset() * 60 * 1e3) / 1e3
              })(),
              open: X.open.toNumber(),
              high: X.high.toNumber(),
              low: X.low.toNumber(),
              close: X.close.toNumber(),
              value: X.price.toNumber()
            })).sort((X, ht) => X.time - ht.time),
            Q = D[0].time,
            V = f.value !== i.value ? "interval" : m.value !== s.value ? "type" : W > Q ? "history" : "timer";
          N.setData(D), f.value = i.value, m.value = s.value, d.value = N, u.value = $, V === "history" ? E && $.timeScale().setVisibleRange(E) : V === "timer" ? R && $.timeScale().setVisibleLogicalRange(R) : $.timeScale().fitContent()
        },
        O = z(() => {
          var A;
          if (!((A = t.jettonPnl) != null && A.hasPnL)) return;
          const b = Tn(t.jettonPnl.pnlAbsoluteUSD, {
              accuracy: 2,
              trim: !0
            }),
            k = to(t.jettonPnl.pnlPercent);
          return {
            label: `P&L ${b} ${k.formatted}`,
            cls: k.cls
          }
        });
      return _t(() => {
        ...
        return {
          container: c.value,
          chart: (b = e.value) == null ? void 0 : b.data,
          chartSeriesType: o.value
        }
      }, b => {
        !b.container || !b.chart || q(b.chart.points, b.container, b.chartSeriesType)
      }, {
        immediate: !0
      }), _t(c, b => b && j(), {
        immediate: !0
        ...
        const A = ae;
        return M(), I("div", xl, [S("div", Pl, [S("div", {
          class: "section",
          style: Ri({
            "grid-template-columns": `repeat(${p(y).length}, 1fr)`
          })
        }, [(M(!0), I(Lt, null, hi(p(y), H => (M(), I("label", {
          key: H.value,
          class: Gt(["item", {
            "is-active": p(s) === H.value
          }])
        }, [ze(S("input", {
          "onUpdate:modelValue": k[0] || (k[0] = E => ft(_) ? _.value = E : null),
          type: "radio",
          name: "chart-type",
          value: H.value
        }, null, 8, Rl), [
          [ri, p(_)]
        ]), S("span", Vl, B(H.label), 1)], 2))), 128))], 4), S("div", {
          class: "section",
          style: Ri({
            "grid-template-columns": `repeat(${p(v).length}, 1fr)`
          })
        }, [(M(!0), I(Lt, null, hi(p(v), H => (M(), I("label", {
          key: H.value,
          class: Gt(["item", {
            "is-active": p(i) === H.value
          }])
        }, [ze(S("input", {
          "onUpdate:modelValue": k[1] || (k[1] = E => ft(w) ? w.value = E : null),
          type: "radio",
          name: "chart-interval",
          value: H.value
        }, null, 8, Il), [
          [ri, p(w)]
        ]), S("span", Bl, B(H.label), 1)], 2))), 128))], 4), S("button", {
          type: "button",
          class: "reset chart-type",
          onClick: k[2] || (k[2] = H => p(l)(p(o) === p(Ot).LINEAR ? p(Ot).CANDLESTICK : p(Ot).LINEAR))
        }, [p(o) === p(Ot).CANDLESTICK ? (M(), x(A, {
          key: 0,
          name: "chart-line",
          class: "icon"
        })) : (M(), x(A, {
          ...
          name: "candle-chart",
          class: "icon"
        }))])]), !p(e) || !p(e).data.points.length ? (M(), I("div", Wl, [k[4] || (k[4] = S("img", {
          src: Vi,
          class: "lines"
        }, null, -1)), k[5] || (k[5] = S("img", {
          src: xn,
          class: "empty"
        }, null, -1)), S("div", Al, [k[3] || (k[3] = S("div", {
          class: "dot"
        }, null, -1)), S("div", Dl, B(("t" in b ? b.t : p(T))("memepad.jetton.chart.coming_text")), 1)])])) : (M(), I("div", Nl, [p(O) ? (M(), I("div", {
          key: 0,
          class: Gt(["pnl-label", p(O).cls])
        }, B(p(O).label), 3)) : St("", !0), S("div", {
          ref_key: "container",
          ref: c,
          class: "chart-container"
        }, null, 512), k[6] || (k[6] = S("img", {
          src: Vi,
          class: "lines"
        }, null, -1))]))])
      }
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return M(), I(Lt, null, [L(h, {
          ...
          default: Z(() => [S("div", Fl, B(("t" in s ? s.t : p(T))("memepad.jetton.unlock.btn")), 1)]),
          _: 1
        }, 8, ["type"]), L(a, {
          modelValue: p(e),
          "onUpdate:modelValue": o[1] || (o[1] = c => ft(e) ? e.value = c : null)
        }, {
          default: Z(() => [S("div", Kl, [S("div", Jl, [L(r, {
            src: p(Rs)(s.jetton.iconFileKey),
            size: 80
          }, null, 8, ["src"])]), S("div", Hl, B(("t" in s ? s.t : p(T))("memepad.jetton.unlock.sheet.title", {
            ticker: s.jetton.ticker
          })), 1), S("div", Xl, B(("t" in s ? s.t : p(T))("memepad.jetton.unlock.sheet.subtitle", {
            ticker: s.jetton.ticker
          })), 1), S("div", Yl, [L(l, {
            jetton: s.jetton,
  ...
  ta = it({
    ...
    setup(n) {
      const t = n,
        e = Pn(Ws);
      if (!e) throw _i("Tabs injection not defined");
      ...
      return (o, h) => (M(), I("label", {
        class: Gt(["kit-tab", [`is-${p(i).toLowerCase()}`, {
          "is-active": p(s)
        }]])
      }, [S("span", ql, B(n.label), 1), ze(S("input", {
        "onUpdate:modelValue": h[0] || (h[0] = r => ft(s) ? s.value = r : null),
        type: "radio",
        value: n.value,
        name: p(e).name
      }, null, 8, Ql), [
  ...
  ia = it({
    ...
    setup(n) {
      ...
      return Rn(Ws, {
        ...
        const h = _n,
          r = In("horizontal-wheel-scroll");
        return M(), I("div", {
          class: Gt(["kit-tabs", `is-${n.type.toLowerCase()}`])
        }, [ze((M(), I("div", ea, [Bn(s.$slots, "default", {}, void 0, !0), (M(!0), I(Lt, null, hi(p(i), l => (M(), x(h, {
          key: l.value,
          label: l.label,
          value: l.value,
          type: n.type
  ...
  la = it({
    ...
    setup(n) {
      const t = n,
        e = () => xt().memepad.memepadJettonTradeDisabledButtonClick(),
        i = z(() => new $e(t.value.replaceAll(",", "") || "0")),
        s = z(() => t.tradePendings[t.tab]),
        o = z(() => !!(s.value || !t.inputState || t.inputState.loading)),
        h = z(() => o.value ? !1 : !!(i.value.isZero() || !t.inputState || t.inputState.error));
      return (r, l) => {
        var m, v, y, w, _;
        const a = Ds,
          c = Pe,
          ...
          d = Os,
          f = At;
        return M(), I("div", na, [S("div", oa, [r.inputState ? (M(), I(Lt, {
          key: 0
        }, [r.inputState.balanceLabel ? (M(), x(a, {
          key: 0,
          balance: r.inputState.balanceLabel
        }, null, 8, ["balance"])) : (M(), x(c, {
          key: 1,
          class: "skeleton"
        })), r.inputState.error || r.inputState.feesInfo ? (M(), x(u, {
          key: 2,
        ...
        }, null, 8, ["details", "total-label", "error-message"])) : (M(), x(c, {
          key: 3,
          class: "skeleton"
        }))], 64)) : (M(), I(Lt, {
          key: 1
          ...
          class: "skeleton"
        })], 64))]), (_ = (w = r.inputState) == null ? void 0 : w.error) != null && _.notEnoughTon ? (M(), x(d, {
          key: 0,
          "jetton-shortname": r.jetton.shortname,
          "jetton-address": r.jetton.address,
          reason: r.inputState.error.notEnoughTonReason
        }, null, 8, ["jetton-shortname", "jetton-address", "reason"])) : (M(), I("div", {
          key: 1,
          onPointerdown: l[2] || (l[2] = () => p(h) && e())
        }, [r.tab === p(tt).BUY ? (M(), x(f, {
          key: 0,
          fill: "",
          size: p(Rt).LARGE,
          type: p(zt).HIGHLIGHT,
          ...
          default: Z(() => [S("div", ha, B(("t" in r ? r.t : p(T))("memepad.jetton.buy_button_label", {
            ticker: r.jetton.ticker
          })), 1)]),
          _: 1
        }, 8, ["size", "type", "loading", "disabled"])) : St("", !0), r.tab === p(tt).SELL ? (M(), x(f, {
          key: 1,
          fill: "",
          size: p(Rt).LARGE,
          type: p(zt).PINK,
          ...
          default: Z(() => [S("div", ra, B(("t" in r ? r.t : p(T))("memepad.jetton.sell_button_label", {
            ticker: r.jetton.ticker
          })), 1)]),
          _: 1
        }, 8, ["size", "type", "loading", "disabled"])) : St("", !0)], 32))])
      }
    }
  }),
  aa = nt(la, [
  ...
  ma = it({
    ...
    emits: li(["trade", "unlock-success", "open-slippage", "close"], ["update:modelValue", "update:tradePendings"]),
    setup(n, {
      emit: t
    }) {
      const e = n,
      ...
      const w = z(() => {
          if (!(!l.value || l.value.loading)) {
            if (_.value.isZero()) return s.value === tt.BUY ? `0 ${e.jetton.ticker}` : "0 TON";
            if (!l.value.feesInfo || !l.value.ready) return "";
            if (s.value === tt.SELL) {
              const b = l.value.tradeInfo.maxReceive,
                k = `${Ii(b)} TON`;
              if (!e.tonUsdRate) return k;
              const A = Wn(e.tonUsdRate.mul(b));
              return `${k} (≈$${A})`
            } else {
              const b = l.value.tradeInfo.maxReceive;
              return `≈${Le(b,{accuracy:0})} ${e.jetton.ticker}`
            }
          }
        }),
        _ = z(() => new $e(f.value.replaceAll(",", "") || "0"));
      let C;
      const j = () => {
        xt().memepad.memepadJettonSlippageButtonClick(), i("open-slippage")
      };
      _t(() => [f.value, e.balances.jettonBalance, e.balances.tonBalance], () => a());
      const P = Bi(b => xt().memepad.memepadJettonTradeInputUpdate(b), 300).debouncedFunction;
      _t(_, b => P({
        value: b.toNumber(),
        type: s.value
      })), le(() => {
      ...
      function O() {
        ...
        const A = (E, R) => {
          if (k.push({
            ...
            const W = k.every($ => $.amount.eq(k[0].amount)),
              J = k.every($ => $.operation === k[0].operation);
            W && J && r.disconnect()
          }
        };
        return async () => {
          ...
          const E = s.value,
            ...
            N = e.jetton.address,
            D = e.jetton.address,
            Q = e.jetton.shortname;
          await (async () => {
            o.value[E] = !0;
            const V = () => {
                const X = ui(E === tt.BUY ? W.minReceive : R, J),
                  ht = ui(E === tt.BUY ? R : W.minReceive, "TON"),
                  K = E === tt.BUY ? T("memepad.jetton.buy.failed_alert", {
                    askLabel: X.frontendWithSymbol,
                    offerLabel: ht.frontendWithSymbol
              ...
              et = await (E === tt.BUY ? e.jettonTrading.buyJetton(R, W) : e.jettonTrading.sellJetton(R, W));
            if (et.err) {
              An().error("Memepad jetton trade error", et.extra), o.value[E] = !1, V(), A(R, E);
              return
            }
            i("trade");
            const ot = et.data;
            C = E === tt.BUY ? e.jettonTrading.getWaitForBuyStatus() : e.jettonTrading.getWaitForSellStatus(), await Ps(2e4);
            const at = await C.exec({
                jettonAddress: D,
                transactionHash: ot
              }),
              Et = at ? "success" : "failed";
            if (E === tt.BUY ? b.memepad.memepadJettonBuy({
                status: Et,
                jettonId: $,
                jettonShortname: Q,
                jettonAddress: N,
                purchaseAmount: R.toNumber()
              }) : b.memepad.memepadJettonSell({
                status: Et,
                jettonId: $,
                jettonShortname: Q,
                jettonAddress: N,
                purchaseAmount: W.maxReceive.toNumber()
              }), !at) {
              o.value[E] = !1, V();
              return
            }
            const Xt = E === tt.BUY ? T("memepad.jetton.buy.success_alert", {
              ticker: J,
              label: `${Ii(R)} TON`
            }) : T("memepad.jetton.sell.success_alert", {
              label: `${Dn(R).full} ${J}`
            });
            Ce().success(Xt), o.value[E] = !1, e.tradeSuccessCallback()
          })()
        }
      }
      return (b, k) => {
        ...
        return M(), x(Q, {
          ...
          "top-center": Z(() => [L(H, {
            modelValue: s.value,
            "onUpdate:modelValue": k[0] || (k[0] = V => s.value = V),
            class: "tabs"
          }, {
            default: Z(() => [L(A, {
          ...
          default: Z(() => [S("div", ca, [(M(), x(E, {
            ref_key: "actionControlsInputComp",
            ref: h,
            key: s.value,
            modelValue: p(v),
            "onUpdate:modelValue": k[1] || (k[1] = V => ft(v) ? v.value = V : null),
            postfix: s.value === "buy" ? "TON" : b.jetton.ticker,
            modifier: m,
            onBlur: u
          }, null, 8, ["modelValue", "postfix"])), S("div", ua, [p(w) ? (M(), I("span", da, B(p(w)), 1)) : p(w) === void 0 ? (M(), x(R, {
            key: 1,
            class: "skeleton"
          })) : St("", !0)]), S("button", {
            type: "button",
            ...
            onClick: j
          }, [S("span", fa, B(`${("t"in b?b.t:p(T))("memepad.jetton.slippage_btn")} ${p(d)}%`), 1), L(W, {
          ...
          "bottom-action": Z(() => [L(N, {
            ...
            default: Z(() => [b.unlockEnabled ? (M(), x(J, {
              key: 0,
              jetton: b.jetton,
              "jetton-information": b.jettonInformation,
              balances: b.balances,
              "jetton-management": b.jettonManagement,
              onUnlocked: k[2] || (k[2] = V => b.$emit("unlock-success"))
            }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (M(), x($, {
              key: 1,
              value: p(f),
              tab: s.value,
              jetton: b.jetton,
          ...
          "bottom-helpers": Z(() => [L(D, {
            modelValue: p(y),
            "onUpdate:modelValue": k[3] || (k[3] = V => ft(y) ? y.value = V : null),
            tab: s.value,
            balances: b.balances
  ...
  Sa = it({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        o = () => {
          var c;
          (c = s.value) == null || c.focusOnInput()
        },
        h = F(e.jettonTrading.slippage.toString()),
        r = z(() => new $e(h.value.replaceAll(",", "") || "0")),
        l = z(() => r.value.lt(wa) ? T("memepad.jetton.slippage.error_message.too_low") : r.value.gt(ya) ? T("memepad.jetton.slippage.error_message.too_high") : ""),
        a = () => {
          if (l.value) return;
          const c = parseFloat(h.value);
          e.jettonTrading.slippage === c ? (xt().memepad.memepadJettonSlippageUpdate({
            value: c
          }), e.jettonTrading.updateSlippage(c), i("slippage-updated")) : i("close")
        };
      return As().initHandler(() => {
        i("close")
        ...
        return M(), x(v, {
          ...
          "top-center": Z(() => [S("div", va, B(("t" in c ? c.t : p(T))("memepad.jetton.slippage.title")), 1)]),
          default: Z(() => [S("div", ba, [L(d, {
            ref_key: "actionControlsInputComp",
            ref: s,
            modelValue: p(h),
            "onUpdate:modelValue": u[0] || (u[0] = y => ft(h) ? h.value = y : null),
            postfix: "%",
            modifier: y => ("formatFloatLine" in c ? c.formatFloatLine : p(Le))(y, {
              join: "emptyFractional"
            }),
            onBlur: o
          ...
          "bottom-action": Z(() => [S("div", ga, [p(l) ? (M(), x(f, {
            key: 0,
            "error-message": p(l)
          }, null, 8, ["error-message"])) : (M(), I("div", _a, B(("t" in c ? c.t : p(T))("memepad.jetton.slippage.text")), 1)), L(m, {
            label: ("t" in c ? c.t : p(T))("memepad.jetton.slippage.done_btn"),
            fill: "",
            size: p(Rt).LARGE,
            type: p(l) ? p(zt).HIGHLIGHT : p(zt).PRIMARY,
            disabled: !!p(l),
            onClick: a
  ...
  za = it({
    ...
    setup(n, {
      ...
      const e = t,
        i = xt(),
        s = () => {
          i.memepad.memepadTradeButtonBuyClick(), e("click", tt.BUY)
        },
        o = () => {
          i.memepad.memepadTradeButtonSellClick(), e("click", tt.SELL)
        };
      return (h, r) => {
        const l = At;
        return M(), I("div", ka, [L(l, {
          class: "buy-button",
          type: p(zt).HIGHLIGHT,
          loading: h.tradePendings[p(tt).BUY],
          onClick: s
        }, {
          default: Z(() => [S("span", Ca, B(("t" in h ? h.t : p(T))("memepad.jetton.buy_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"]), L(l, {
          class: "sell-button",
          type: p(zt).PINK,
          loading: h.tradePendings[p(tt).SELL],
          onClick: o
        }, {
          default: Z(() => [S("span", ja, B(("t" in h ? h.t : p(T))("memepad.jetton.sell_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"])])
      }
    }
    ...
    setup(n, {
      ...
      return (c, u) => {
        const d = Gl,
          ...
          v = La,
          y = wi;
        return M(), I("div", $a, [L(y, {
          "force-loading": c.unlockEnabled === void 0 && c.isReleased || !c.jettonTrading,
          "button-size": p(Rt).MEDIUM
        }, {
          default: Z(() => [c.unlockEnabled ? (M(), x(d, {
            key: 0,
            jetton: c.jetton,
          ...
          }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (M(), I(Lt, {
            key: 1
          }, [p(o) === "trade" ? (M(), x(f, {
            key: 0,
            modelValue: p(i),
            "onUpdate:modelValue": u[0] || (u[0] = w => ft(i) ? i.value = w : null),
            "trade-pendings": p(s),
            "onUpdate:tradePendings": u[1] || (u[1] = w => ft(s) ? s.value = w : null),
            jetton: c.jetton,
            "jetton-information": c.jettonInformation,
            ...
            onTrade: r,
            onUnlockSuccess: u[2] || (u[2] = w => c.$emit("unlock-success")),
            onOpenSlippage: u[3] || (u[3] = w => o.value = "slippage"),
            onClose: u[4] || (u[4] = w => o.value = void 0)
          }, null, 8, ["modelValue", "trade-pendings", "jetton", "jetton-information", "jetton-bcl-data", "balances", "jetton-management", "jetton-trading", "is-released", "unlock-enabled", "ton-usd-rate"])) : St("", !0), p(o) === "slippage" ? (M(), x(m, {
            key: 1,
            "jetton-trading": c.jettonTrading,
            onSlippageUpdated: u[5] || (u[5] = w => o.value = "trade"),
            onClose: u[6] || (u[6] = w => o.value = "trade")
          }, null, 8, ["jetton-trading"])) : St("", !0), L(v, {
            "trade-pendings": p(s),
            onClick: h
  ...
  Pa = it({
    ...
    setup(n) {
      const t = n,
        e = z(() => t.chartMarketCap ? t.chartMarketCap : t.jettonInformation.marketCap),
        i = z(() => {
          var r, l, a, c, u;
  ...
  Ga = it({
    ...
    setup(n) {
      const t = Fn(),
        ...
        s = z(() => t.jettonInformation),
        o = z(() => t.jettonReactions),
        h = z(() => t.updateJettonReaction),
        {
          partnerAddresses: r
        } = no(),
        {
        ...
        {
          getManagementSdk: a,
          getBeforeDexTradingSdk: c,
          getDexTradingSdk: u
        } = ho(),
        d = Kn(),
        f = Jn().status,
        m = Hn().getters.getUser,
        {
          jettonBclData: v,
          jettonBalance: y,
        ...
        q = async () => {
          ...
          if (!e.value || !s || s.value.status === de.IN_PROGRESS) return {
            status: "loading"
          };
          const E = e.value.address,
            R = [de.PUBLISHED_ON_DEX, de.LISTED_TO_DEX].includes(s.value.status),
            W = {
              jettonBalance: y.value ? ui(y.value, e.value.ticker) : void 0,
              tonBalance: d.wallet.value.status === "connected" ? (D = d.wallet.value.balance) == null ? void 0 : D.tonBalance.balance : void 0
            },
            J = Xn(Yn, {
            ...
            N = (() => {
              var V;
              if (!R) return c(E, J);
              const Q = (V = m.value) == null ? void 0 : V.referrerToken;
              return u({
                jettonAddress: E,
                referrerToken: Q
              })
            })();
          return s.value.status === de.LISTED_TO_DEX ? {
      ...
      so(z(() => b.value.status === "moving_to_dex"), "memepad-jetton-trade-status");
      const k = () => {
          C.init(), j.init()
        },
        A = () => {
      ...
      function H() {
        const E = F(),
          ...
          W = F(),
          J = F();
        let $, N, D, Q, V, et, ot, at;

        function Et() {
          N = _t(b, K => {
            K.status === "loading" || $ || K.jettonManagement && (N == null || N(), $ = fe(async () => {
              if (b.value.status === "loading") return dt(void 0);
              const Y = b.value.jetton.address,
                ut = await b.value.jettonManagement.getJettonBclData(Y);
              return dt((jt(ut) ? ut.data : E.value) || E.value)
            }, Y => E.value = Y, 6e4), $ == null || $.exec())
          }, {
            immediate: !0
          }), Q = _t(b, K => {
            K.status === "loading" || D || !K.jettonTrading || f.value !== "connected" || (Q == null || Q(), D = fe(async () => {
              if (b.value.status === "loading" || !b.value.jettonTrading || f.value !== "connected") return dt(void 0);
              const Y = b.value.jetton.address,
                ut = await b.value.jettonTrading.getUserJettonBalance(Y);
              return dt((jt(ut) ? ut.data : R.value) || R.value)
            }, Y => R.value = Y, 6e4), D == null || D.exec())
          }, {
            immediate: !0
          }), et = _t(b, K => {
            K.status === "loading" || V || !K.jetton || !K.balances.jettonBalance || !K.isReleased || f.value !== "connected" || (et == null || et(), V = fe(async () => {
              if (b.value.status === "loading" || !b.value.balances.jettonBalance || !b.value.isReleased || f.value !== "connected") return dt(void 0);
              if (b.value.balances.jettonBalance.value.isZero()) return dt(!1);
              const Y = await b.value.jettonManagement.getUnlockEnabled(b.value.jetton.address);
              return dt(jt(Y) ? Y.data : W.value)
            }, Y => W.value = Y, 6e4), V == null || V.exec())
          }, {
            immediate: !0
          }), at = _t(b, K => {
            K.status === "loading" || ot || d.wallet.value.status === "connected" && (at == null || at(), ot = fe(async () => {
              if (b.value.status === "loading" || d.wallet.value.status !== "connected") return dt(void 0);
              const Y = b.value.jetton.shortname,
                ut = d.wallet.value.address.default,
                Mt = await je.getMemepadJettonPnl(Y, ut);
              return dt((jt(Mt) ? Mt.data : J.value) || J.value)
            }, Y => J.value = Y, 6e4), ot == null || ot.exec())
          }, {
            immediate: !0
          })
        }
        return {
          init: Et,
          destroy: () => {
            N == null || N(), $ == null || $.destroy(), Q == null || Q(), D == null || D.destroy(), et == null || et(), V == null || V.destroy(), at == null || at(), ot == null || ot.destroy(), E.value = void 0, R.value = void 0, W.value = void 0, J.value = void 0
          },
          update: async () => {
            await ($ == null ? void 0 : $.exec()), await (D == null ? void 0 : D.exec()), await (V == null ? void 0 : V.exec()), ot == null || ot.exec()
          },
          resetAndUpdateUnlocked: async () => {
            W.value = void 0, await (V == null ? void 0 : V.exec())
          },
          jettonBclData: z(() => E.value),
          jettonBalance: z(() => R.value),
      ...
      return (E, R) => {
        const W = Sn,
          J = _o,
          $ = Ra;
        return p(b).status === "loading" ? (M(), x(W, {
          key: 0
        })) : p(b).status === "moving_to_dex" ? (M(), x(J, {
          key: 1,
          jetton: p(b).jetton,
          ...
          "is-released": ""
        }, null, 8, ["jetton", "jetton-information", "unlock-enabled", "balances", "jetton-management"])) : (M(), x($, {
          key: 2,
          jetton: p(b).jetton,
          "jetton-information": p(b).jettonInformation,
          "jetton-bcl-data": p(b).jettonBclData,
          "jetton-pnl": p(b).jettonPnl,
          "chart-market-cap": p(P),
          ...
          onTradeSuccess: q,
          onUnlockSuccess: O,
          onShare: R[0] || (R[0] = N => E.$emit("share", "trade")),
          onCopy: R[1] || (R[1] = N => E.$emit("copy", "trade"))
