...
var ur = (r, e, t) => e in r ? mr(r, e, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: t
}) : r[e] = t;
var u = (r, e, t) => ur(r, typeof e != "symbol" ? e + "" : e, t);
import {
  d as rt,
  a9 as dr,
  h as hr,
  ...
  Gr = rt({
    ...
    setup(r) {
      ...
      return (s, n) => {
        const o = Fs,
          a = Nr;
        return X(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in s ? s.WALLET_LOCAL_AND_REMOTE_STATUS : X(Le)).DISCONNECTED ? (_e(), Fe(o, {
          key: 0,
          label: ("t" in s ? s.t : X(Nt))("wallet.connect.btn"),
          fill: "",
          size: s.buttonSize,
          onClick: n[0] || (n[0] = i => X(t).runConnectionFlow())
        }, null, 8, ["label", "size"])) : X(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in s ? s.WALLET_LOCAL_AND_REMOTE_STATUS : X(Le)).MUST_RECONNECT ? (_e(), Fe(o, {
          key: 1,
          label: ("t" in s ? s.t : X(Nt))("wallet.reconnect.btn"),
          fill: "",
          size: s.buttonSize,
          onClick: n[1] || (n[1] = i => X(t).runConnectionFlow())
        }, null, 8, ["label", "size"])) : X(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in s ? s.WALLET_LOCAL_AND_REMOTE_STATUS : X(Le)).LOADING || s.forceLoading ? (_e(), Fe(a, {
          key: 2,
          class: Jt(["skeleton", `is-${s.buttonSize.toLowerCase()}`])
        }, null, 8, ["class"])) : X(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in s ? s.WALLET_LOCAL_AND_REMOTE_STATUS : X(Le)).CONNECTED ? he(s.$slots, "default", {
          key: 3
        }, void 0, !0) : Lt("", !0)
      }
    }
    ...
    setup(r) {
      return (e, t) => {
        ...
        return _e(), Fe(n, {
          ...
          default: cs(() => [he(e.$slots, "top", {}, () => [ue("div", Lr, [t[0] || (t[0] = ue("div", {
            class: "left"
          }, null, -1)), ue("div", Wr, [he(e.$slots, "top-center", {}, void 0, !0)]), ue("div", Kr, [he(e.$slots, "top-right", {}, void 0, !0)])])], !0), he(e.$slots, "default", {}, () => [ue("div", Hr, [he(e.$slots, "inner", {}, void 0, !0)])], !0), Ar(s, {
            "ignore-tabs": "",
            "hide-space": ""
          }, {
            default: cs(() => [ue("div", {
            ...
            }, [ue("div", zr, [he(e.$slots, "bottom-action", {}, void 0, !0)]), e.$slots["bottom-helpers"] ? (_e(), It("div", Vr, [he(e.$slots, "bottom-helpers", {}, void 0, !0)])) : Lt("", !0)], 2)]),
            _: 3
          })]),
          _: 3
        })
...
const Ft = E,
  ...
  qt = r => (0, Xr.default)(r, (e, t) => typeof t == "bigint" ? (0, Zr.default)(t.toString()) : t);
class tn {
  constructor(e = {}) {
    ...
    u(this, "contentFormatters", {
      [ye.Json]: e => e !== null && (typeof e == "object" || typeof e == "string") ? qt(e) : e,
      [ye.Text]: e => e !== null && typeof e != "string" ? qt(e) : e,
      [ye.FormData]: e => Object.keys(e || {}).reduce((t, s) => {
        const n = e[s];
        return t.append(s, n instanceof Blob ? n : typeof n == "object" && n !== null ? qt(n) : `${n}`), t
      }, new FormData),
...
var an = class {
  ...
  open(r) {
    return E.openContract(r, e => xt(this.tonapi, e.address, e.init))
  }
  provider(r, e) {
...
function xt(r, e, t) {
  return {
    ...
    async get(s, n) {
      ...
      return {
        stack: new E.TupleReader(o.stack)
      }
    },
    async external(s) {
      let n = null;
      ...
      const o = E.external({
        ...
        a = E.beginCell().store(E.storeMessage(o)).endCell();
    ...
    async internal(s, n) {
      ...
      let i;
      typeof n.value == "string" ? i = E.toNano(n.value) : i = n.value;
      let p = null;
      typeof n.body == "string" ? p = E.comment(n.body) : n.body && (p = n.body), await s.send({
        to: e,
        value: i,
        bounce: a,
        sendMode: n.sendMode,
    ...
    open(s) {
      return E.openContract(s, n => xt(r, n.address, n.init))
    },
    getTransactions(s, n, o, a) {
      return console.info("hash param in getTransactions action ignored, beacause not supported", o.toString("hex")), r.blockchain.getBlockchainAccountTransactions(s, {
        ...
        transactions: i
      }) => i.map(p => E.loadTransaction(p.raw.asSlice())))
    }
  }
}
...
var hn = function() {
  ...
  te = function() {};
te.deployJettonGas = E.toNano(.05), te.initialGas = E.toNano(.015), te.buyGas = E.toNano(.08), te.sellGas = E.toNano(.08), te.unlockGas = E.toNano(.05);
var Ls = function() {};
Ls.buy = 2943683892;
var Ws = function() {
    function r(t, s) {
    ...
    return e.getWalletAddress = function(t, s) {
      try {
        return Promise.resolve(t.get("get_wallet_address", [{
          type: "slice",
          cell: E.beginCell().storeAddress(s).endCell()
        }])).then(function(n) {
      ...
      try {
        return Promise.resolve(t.internal(s, {
          value: n + te.buyGas,
          body: E.beginCell().storeUint(Ls.buy, 32).storeUint(p, 64).storeCoins(o).storeAddress(a).storeMaybeRef(i).endCell()
        })).then(function() {})
      } catch (y) {
...
var Ot = function() {
    ...
    r.createFromAddress = function(t) {
      ...
      return n === void 0 && (n = null), o === void 0 && (o = 0), E.beginCell().storeUint(et.sell, 32).storeUint(o, 64).storeCoins(t).storeCoins(s).storeMaybeRef(n).endCell()
    }, r.unlockMessage = function(t) {
      return t === void 0 && (t = 0), E.beginCell().storeUint(et.unlock, 32).storeUint(t, 64).endCell()
    };
    var e = r.prototype;
    return e.getJettonBalance = function(t) {
      ...
      try {
        return Promise.resolve(t.internal(s, {
          sendMode: E.SendMode.PAY_GAS_SEPARATELY,
...
var _s = function() {
    ...
    return e.sendDeployJetton = function(t, s, n, o, a, i, p, y, f) {
      ...
      try {
        return p === void 0 && (p = 0n), Promise.resolve(t.internal(s, {
          value: n,
          body: E.beginCell().storeUint(Hs.deployJetton, 32).storeUint(f, 64).storeUint(o, 1).storeRef(a).storeBit(i).storeCoins(p).storeMaybeRef(y).endCell()
        })).then(function() {})
      } catch (h) {
  ...
  vn = function(r) {
    try {
      ...
      return Promise.resolve(r(s)).then(function() {
        ...
        return e.init && (o.stateInit = E.beginCell().store(E.storeStateInit(e.init)).endCell().toBoc().toString("base64")), {
  ...
  se = de("tokenomics"),
  me = de("request"),
  ke = de("minterContractFromAddress"),
  Bt = de("walletContractFromAddress"),
  kn = function() {
    function r(t, s, n) {
...
const zs = () => {
    const {
      ...
      isProd: f
    } = qr(), h = new kn(n, !1, !f.value), N = l => +String(l) / 1e4, I = {
      ...
      referrerToken: l
    }) => E.beginCell().storeUint(1675682413, 32).storeStringTail(l).endCell(), H = async l => {
      ...
      const {
        buyFeeBasis: V
      } = M.data, Z = S(h.getBuyAmount(0n, _, V)), we = Z, je = Z, Ne = w.minus(we), ce = S(h.getTonSupply(D(we))), ns = new C(h.getPrice(D(we))), ir = new C(ns).times(P), cr = ce.div(A).times(100), pr = Z.div(w).times(100), lr = new C(m).minus(ce);
      return x({
        share: new C(m),
        tokenForDexWithFees: q,
        tokenForDex: A,
      ...
      const Z = d ? K({
        ...
        we = m.aiAgentEnable,
        je = await W(async () => await h.sendDeployJetton(q, r(l), M, V, we, D(new C(m.share)), Z, P))();
      if (!j(je)) return je;
      ...
      const {
        buyFeeBasis: q
      } = w.data, P = S(h.getBuyAmount(D(A), D(l), q)), M = P, V = i(P), Z = l.times(N(q));
      return x({
        maxReceive: M,
        minReceive: V,
        platformFee: Z,
      ...
      const {
        sellFeeBasis: q
      } = w.data, P = S(h.getSellAmount(D(A), D(l), q)), M = P, V = i(P), Z = P.div(1 - N(q)).minus(P);
      return x({
        maxReceive: M,
        minReceive: V,
        platformFee: Z,
      ...
      const w = e(d),
        ...
        P = await W(async () => await h.sendBuy(w, r(m), D(l), D(_.minReceive), q))();
      ...
      if (!j(M)) return M;
      const V = M.data,
        Z = await W(async () => await h.sendSell(q, V, D(l), D(_.minReceive), P))();
...
(function(r) {
  r.TransOrd = "TransOrd", r.TransTickTock = "TransTickTock", r.TransSplitPrepare = "TransSplitPrepare", r.TransSplitInstall = "TransSplitInstall", r.TransMergePrepare = "TransMergePrepare", r.TransMergeInstall = "TransMergeInstall", r.TransStorage = "TransStorage"
})(js || (G.TransactionType = js = {}));
var qs;
(function(r) {
  r.AcstUnchanged = "acst_unchanged", r.AcstFrozen = "acst_frozen", r.AcstDeleted = "acst_deleted"
})(qs || (G.AccStatusChange = qs = {}));
var Es;
(function(r) {
  r.CskipNoState = "cskip_no_state", r.CskipBadState = "cskip_bad_state", r.CskipNoGas = "cskip_no_gas"
...
const ar = () => {
    const {
      ...
      const {
        ...
        bclSupply: m,
        maxSupply: _
      } = T.data, d = await (async () => new C($).isZero() ? x({
        fees: D(new C(0)),
        coins: D(new C(0))
      }) : await H({
        tons: g,
      ...
      const w = {
        ...
        P = e(T),
        M = await W(async () => await F($).deployCoin(P, w, q))();
      return j(M) ? x({
        queryId: l.data.queryId,
