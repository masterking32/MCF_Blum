    ...
    setup(b, {
      ...
      return (e, p) => {
        ...
        return a(), n("div", {
          ...
          default: T(() => [e.status === t(c).SUCCESS ? (a(), n("img", ue)) : o("", !0), e.status === t(c).ERROR ? (a(), n("img", pe)) : o("", !0), e.status === t(c).LOADING ? (a(), C(D, {
            key: 2,
            type: t(W).DARK,
            size: 20,
            "track-dimmed": "",
          ...
          default: T(() => [e.errorCaption || e.caption ? (a(), n("p", de, h(e.errorCaption || e.caption), 1)) : o("", !0)]),
          _: 1
        })], 2)
      }
    }
