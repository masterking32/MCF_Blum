    ...
    setup(g, {
      ...
      return (e, o) => {
        const p = P,
          m = G,
          E = te;
        return f(), y(F, null, [_(m, {
          modelValue: n(a),
          "onUpdate:modelValue": o[3] || (o[3] = u => R(a) ? a.value = u : null),
          title: ("t" in e ? e.t : n(i))("welcome.avatar.modal.title")
        }, {
          default: O(() => [U("div", re, [g.canDelete ? (f(), w(p, {
            key: 0,
    ...
    setup(g, {
      ...
      return K(s, d => l("update:lock-by-avatar-uploading", !!d)), (d, t) => {
        ...
        return f(), y("div", ie, [U("div", ce, [_(e, {
          ...
          modelValue: n(a),
          "onUpdate:modelValue": t[1] || (t[1] = m => R(a) ? a.value = m : null),
          "can-delete": !!r.value,
  ...
  ve = I({
    ...
    setup(g, {
      ...
      return K(l, () => {
        ...
        return f(), w(o, {
          modelValue: n(l),
          "onUpdate:modelValue": e[0] || (e[0] = p => R(l) ? l.value = p : null),
  ...
  ye = I({
    ...
    setup(g) {
      ...
      return (e, o) => {
        const p = Ee,
          m = se;
        return f(), y("div", Ne, [n(s) === "USERNAME" ? (f(), w(p, {
          key: "onboarding",
          "tg-avatar-url": n(d),
          onContinue: o[0] || (o[0] = E => t(E))
        }, null, 8, ["tg-avatar-url"])) : (f(), w(m, {
          key: 1
        }))])
      }
    }
