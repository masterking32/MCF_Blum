...
var h = (s, e, t) => ys(s, typeof e != "symbol" ? e + "" : e, t);
import {
  d as lt,
  h as fs,
  X as gs,
    ...
    setup(s) {
      const e = s,
        ...
        a = () => {
          ...
          if (vs(d)) {
            const B = "https://t.me/wallet/start?startapp=main-rc__a0646df863";
            ["ios", "weba", "android", "tdesktop", "webk"].includes(t.platform) ? t.openTelegramLink(B) : t.openLink(B)
          } else t.openLink(d)
        },
        i = () => {
          var f;
          ...
          if (r.memepad.memepadClickTopupButton({
            ...
            const d = (() => {
              ...
              const R = new C(new C(e.needMoreValue).toFixed(1, C.ROUND_UP));
              return R.gt(10) ? R.toNumber() : 10
            })();
            o.getAndOpen(d)
          } else a()
        },
        p = bs(() => r.memepad.memepadShowTopupButton({
          flowType: e.flowType,
      ...
      return xr(() => {
        ...
        const d = Mr;
        return ve(), De(d, {
          label: ("t" in u ? u.t : X(Mt))("memepad.top_up_wallet_button"),
          fill: "",
          size: X(Or).LARGE,
          loading: X(o).isLoading.value,
          onClick: i
  ...
  Ks = lt({
    ...
    setup(s) {
      ...
      return (r, n) => {
        const o = Mr,
          a = Os;
        return X(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in r ? r.WALLET_LOCAL_AND_REMOTE_STATUS : X(Ve)).DISCONNECTED ? (ve(), De(o, {
          key: 0,
          label: ("t" in r ? r.t : X(Mt))("wallet.connect.btn"),
          fill: "",
          size: r.buttonSize,
          onClick: n[0] || (n[0] = i => X(t).runConnectionFlow())
        }, null, 8, ["label", "size"])) : X(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in r ? r.WALLET_LOCAL_AND_REMOTE_STATUS : X(Ve)).MUST_RECONNECT ? (ve(), De(o, {
          key: 1,
          label: ("t" in r ? r.t : X(Mt))("wallet.reconnect.btn"),
          fill: "",
          size: r.buttonSize,
          onClick: n[1] || (n[1] = i => X(t).runConnectionFlow())
        }, null, 8, ["label", "size"])) : X(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in r ? r.WALLET_LOCAL_AND_REMOTE_STATUS : X(Ve)).LOADING || r.forceLoading ? (ve(), De(a, {
          key: 2,
          class: Wt(["skeleton", `is-${r.buttonSize.toLowerCase()}`])
        }, null, 8, ["class"])) : X(e) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in r ? r.WALLET_LOCAL_AND_REMOTE_STATUS : X(Ve)).CONNECTED ? fe(r.$slots, "default", {
          key: 3
        }, void 0, !0) : Kt("", !0)
      }
    }
  ...
  Hs = lt({
    ...
    setup(s, {
        ...
        u = ir({
          ...
          set: k => {
            if (a.value && a.value.value !== r.modelValue) {
              ...
              N !== -1 && a.value.value[N] === "," && (k = k.slice(0, N) + "." + k.slice(N))
            }
            k = (r.modifier || (N => N))(k), a.value && a.value.value !== k && (a.value.value = k), n("update:modelValue", k)
          }
        });
      ...
      return (() => {
        ...
        ref: "input",
        "onUpdate:modelValue": F[0] || (F[0] = N => Ss(u) ? u.value = N : null),
        type: "text",
        inputmode: "decimal",
        style: pr(X(f)),
  ...
  constructor(e = {}) {
    ...
    h(this, "request", async ({
      ...
      return this.customFetch(`${i||this.baseUrl||""}${r}${B?`?${B}`:""}`, {
        ...
        signal: (p ? this.createAbortSignal(p) : d.signal) || null,
        body: typeof e > "u" || e === null ? null : x(e)
      }).then(async F => {
        const N = F.clone();
        N.data = null, N.error = null;
        const H = k === "json" ? "text" : k,
          z = H ? await F[H]().then(M => (N.ok ? N.data = k === "json" ? nn(M) : M : N.error = M, N)).catch(M => (N.error = M, N)) : N;
...
var vr, wr = function() {
    ...
    var e = s.prototype;
    return e.sendDeployJetton = function(t, r, n, o, a, i, p, u, f) {
      u === void 0 && (u = null), f === void 0 && (f = 0);
      try {
        return p === void 0 && (p = 0n), Promise.resolve(t.internal(r, {
          value: n,
          body: q.beginCell().storeUint(Hr.deployJetton, 32).storeUint(f, 64).storeUint(o, 1).storeRef(a).storeBit(i).storeCoins(p).storeMaybeRef(u).endCell()
        })).then(function() {})
      } catch (d) {
  ...
  vn = function() {
    ...
    return e.calculateJettonAmount = function(t, r) {
      ...
      var n = j.fp.to(r),
        ...
        u = j.fp.mul(n, i + a);
      return j.fp.from(j.fp.div(u, p + n + o))
...
var An = function(s) {
  ...
  qn = function() {
    ...
    var e = s.prototype;
    return e.sendDeployJetton = function(t, r, n, o, a, i, p, u) {
      p === void 0 && (p = null), u === void 0 && (u = 0);
      try {
        var f = this.client.open(wr.createFromAddress(r));
        return Promise.resolve(f.getConfig()).then(function(d) {
          var B = d.deployFee + re.deployJettonGas + re.initialGas;
          a && (B += d.agentDeployFee), i > 0n && (B += i + re.buyGas);
          var R = Kr(o);
          return Promise.resolve(f.sendDeployJetton(t, B, n, R, a, i, p, u)).then(function() {})
        })
      } catch (d) {
        return Promise.reject(d)
      }
      ...
      try {
        var p = Lt.createFromAddress(r),
          u = this.client.open(p);
        return Promise.resolve(u.sendSell(t, re.sellGas, n, o, a, i)).then(function() {})
      } catch (f) {
      ...
      try {
        var u = this;
        return Promise.resolve(D(u, ue)[ue](function(f) {
          return u.sendDeployJetton(f, t, r, n, o, a, i, p)
        }))
      } catch (f) {
        return Promise.reject(f)
      }
...
const Qr = () => {
    const {
      ...
      isProd: f
    } = Bs(), d = new qn(n, !1, !f.value), B = l => +String(l) / 1e4, R = {
      ...
      const m = await K(async () => await d.getTotalSupply(s(l)))();
      ...
      const m = await K(async () => await d.getFactoryConfig(s(l)))();
      ...
      const {
        buyFeeBasis: $
      } = w.data, I = A.div(new C(1).minus(B($))).toDecimalPlaces(9, C.ROUND_UP), U = w.data, Y = S(w.data.agentDeployFee);
      return O({
      ...
      const I = $.data,
        U = new C(y).minus(I),
        Y = S(d.getTonSupply(G(I))),
        ee = Y.div(A).times(100);
      return O({
        tokenForDex: A,
        tokenCollected: Y,
        tokenCollectedPercent: ee,
        bclSupply: y,
        liqSupply: w,
        totalSupply: I,
        availableSupply: U
      ...
      const {
        buyFeeBasis: Y
      } = U.data, ee = S(d.getBuyAmount(0n, _, Y)), Te = ee, Ce = ee, xe = w.minus(Te), le = S(d.getTonSupply(G(Te))), ar = new C(d.getPrice(G(Te))), ls = new C(ar).times(I), ms = le.div(A).times(100), us = ee.div(w).times(100), ds = new C(m).minus(le);
      return O({
        share: new C(m),
        tokenForDexWithFees: $,
        tokenForDex: A,
      ...
      jettonAddress: l,
      userAddress: m
    }) => await K(async () => await d.getJettonWalletAddress(s(l), s(m)))()), ke = async ({
      masterAddress: l,
      form: m,
      tonConnectUI: _,
      referrerToken: y
      ...
      const ee = y ? H({
        ...
        Te = m.aiAgentEnable,
        Ce = await K(async () => await d.sendDeployJetton($, s(l), U, Y, Te, G(new C(m.share)), ee, I))();
      if (!E(Ce)) return Ce;
    ...
    }, St = t(o, R.LAUNCH_STATUS_CHECK), jt = async ({
      tons: l,
      jettonAddress: m,
      masterAddress: _
    }) => {
      ...
      const {
        buyFeeBasis: $
      } = w.data, I = S(d.getBuyAmount(G(A), G(l), $)), U = I, Y = i(I), ee = l.times(B($));
      return O({
        maxReceive: U,
        minReceive: Y,
        platformFee: ee,
      ...
      const {
        sellFeeBasis: $
      } = w.data, I = S(d.getSellAmount(G(A), G(l), $)), U = I, Y = i(I), ee = I.div(1 - B($)).minus(I);
      return O({
        maxReceive: U,
        minReceive: Y,
        platformFee: ee,
      ...
      const w = e(y),
        ...
        I = await K(async () => await d.sendBuy(w, s(m), G(l), G(_.minReceive), $))();
      return E(I) ? O((await w.getResult()).hash) : I
    }, Ct = async ({
      jettons: l,
      jettonAddress: m,
      tradeInfoParams: _,
      ...
      if (!E(U)) return U;
      const Y = U.data,
        ee = await K(async () => await d.sendSell($, Y, G(l), G(_.minReceive), I))();
      return E(ee) ? O((await $.getResult()).hash) : ee
    }, $t = () => Re(({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), () => {}, R.BUY_STATUS_CHECK), Bt = () => Re(({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), () => {}, R.SELL_STATUS_CHECK), Pt = async ({
      jettonAddress: l,
      userAddress: m
    }) => {
      const _ = await a({
      ...
      if (!E(y)) return y;
      const A = y.data,
        w = await K(async () => await d.getUnlocked(A))();
      if (!E(w)) return w;
      const $ = !w.data;
      return O($)
    }, or = async ({
      ...
      if (!E(A)) return A;
      const w = A.data,
        $ = await K(async () => await d.sendUnlock(y, w))();
      return E($) ? O((await y.getResult()).hash) : $
    }, g = ({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), b = () => Re(g, () => {}, R.UNLOCK_STATUS_CHECK), P = r({
      getFees: ({
        share: l,
        overview: m
      }) => {
    ...
    return {
      ...
      getMaxShareAmount: ({
        ...
        const {
          ...
          hasShare: !0
        }), w = S(m.bclData.factoryConfig.deployFee), $ = l.value.minus(A.plus(w).plus(y).plus(_)), I = m.bclData.tokenForDexWithFees;
        return I.lt($) ? I : $.gte(0) ? $ : new C(0)
      },
      getMaxBuyAmount: ({
        tokenBalance: l
      }) => {
  ...
  $n = ({
    ...
    const {
      ...
      getMaxShareAmount: a,
      getReviewInfo: i
    } = Qr(), p = s.masterAddresses[mt.STONFI], u = Je().tonConnectUI.value;
    return {
      getJettonOverview: ({
        tons: f
      }) => r({
...
class er {
  ...
  async sendDeployCoin(e, t, r, n) {
    ...
    let u = p + jr.Constants.CoinDeploymentGas;
  ...
  constructor(e = {}) {
    ...
    h(this, "request", async ({
      ...
      const f = (typeof t == "boolean" ? t : this.baseApiParams.secure) && this.securityWorker && await this.securityWorker(this.securityData) || {},
        d = this.mergeRequestParams(u, f),
        B = o && this.toQueryString(o),
        R = this.contentFormatters[n || _e.Json],
        x = a || d.format;
      return this.customFetch(`${i||this.baseUrl||""}${r}${B?`?${B}`:""}`, {
        ...d,
        headers: {
        ...
        const N = x ? await k[x]().then(H => (F.ok ? F.data = H : F.error = H, F)).catch(H => (F.error = H, F)) : F;
        if (p && this.abortControllers.delete(p), !k.ok) throw N;
        return N.data
      })
    });
    Object.assign(this, e)
...
const ps = () => {
    const {
      ...
      return P.value.set(b, v), v
    }, k = g => new C(1).minus(S(g.fees)).div(S(g.coins)), N = p(({
      masterAddress: g
      ...
      tons: g,
      masterAddress: b
    }) => await K(async () => await x(b).getFirstCoinsForTons(G(new C(g))))()), V = p(({
      tons: g,
      masterAddress: b
      ...
      const {
        ...
        bclSupply: m,
        maxSupply: _
      } = T.data, y = await (async () => new C(P).isZero() ? O({
        fees: G(new C(0)),
        coins: G(new C(0))
      }) : await z({
        tons: g,
      ...
      const w = {
        ...
        I = e(T),
        U = await K(async () => await x(P).deployCoin(I, w, $))();
      return E(U) ? O({
        queryId: l.data.queryId,
      ...
      const P = await K(async () => await x(b).openCoin(s(g)))();
      if (!E(P)) return P;
      const T = await K(async () => await P.data.getBclData())();
      if (!E(T)) return T;
      ...
      var m, _, y;
      const T = await K(async () => await x(P).openCoin(s(g)).getUserWallet(s(b)))();
      if (!E(T)) return T;
      const v = await K(async () => !await T.data.getTransfersEnabled())();
      if (!E(v)) return ((m = v.extra) == null ? void 0 : m.status) === 404 && ((y = (_ = v.extra) == null ? void 0 : _.error) == null ? void 0 : y.error) === "entity not found" ? O(!1) : v;
      const l = v.data;
      return O(l)
    }, W = async ({
      jettonAddress: g,
      ...
      const v = await K(async () => await x(b).openCoin(s(P)).getCoinsForTons(G(g)))();
      if (!E(v)) return v;
      ...
      const v = await K(async () => await x(b).openCoin(s(P)).getTonsForCoins(G(g)))();
      if (!E(v)) return v;
      ...
      const T = await K(async () => await x(P).getUserCoinBalance(s(b), s(g)))();
      ...
      const l = {
        ...
        m = e(v),
        _ = await K(async () => await x(P).openCoin(s(T)).sendBuy(m, l))();
      return E(_) ? O((await m.getResult()).hash) : _
    }, Et = async ({
      jettons: g,
      tradeInfoParams: b,
      ...
      const m = await x(T).openCoin(s(P)).getUserWallet(s(v)),
        _ = e(l),
        y = await K(async () => await m.sendSellCoins(_, {
          amount: G(g),
          minReceive: G(b.minReceive),
          referral: ce.packReferralConfig({
            partner: s(b.additionalInfo.partnerAddress)
      ...
      return E(y) ? O((await _.getResult()).hash) : y
    }, Ct = () => Re(({
      transactionHash: g
    }) => o({
      transactionHash: g
      ...
      } = R, l = b.bclData.launchPlatformFee, m = g.value.minus(T.plus(l).plus(v).plus(P)), _ = b.bclData.tokenForDexWithFees;
      ...
      getFees: ({
        ...
        } = R, l = g.bclData.launchPlatformFee;
        return {
          buyNetworkFee: b,
          launchNetworkFee: P,
          launchPlatformFee: l,
    ...
    return {
      ...
      getMaxBuyAmount: ({
        ...
        const {
          buyNetworkFee: b,
          walletNetworkBuyFee: P
        } = R;
        return g.value.minus(b).minus(P)
      },
      getReviewInfo: Pt,
      fees: R
    }
  ...
  po = ({
    ...
    const {
      ...
      getMaxShareAmount: a,
      getReviewInfo: i
    } = ps(), p = s.masterAddresses[mt.STONFI_TON_FUN], u = Je().tonConnectUI.value;
    return {
      getJettonOverview: ({
        tons: f
      }) => r({
