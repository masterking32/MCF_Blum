...
const ro = {
  ...
  co = et({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        c = async () => {
          if (u.value) return;
          const d = () => ke().error(x("memepad.jetton.unlock.failed_alert", {
              ticker: e.jetton.ticker
            })),
            f = () => {
              a.value.push(e.jetton.address), a.value = a.value.slice(-3), a.value.length === 3 && a.value.every(w => w === a.value[0]) && (h.disconnect(), a.value = [])
            },
            m = _ => {
          ...
          await Ts(2e4), await l.exec(p.data) ? (m("success"), s("unlocked"), ke().success(x("memepad.jetton.unlock.success_alert", {
            ticker: e.jetton.ticker
          }))) : (m("failed"), d()), r.value = !1
        }, u = $(() => !!(r.value || !i.value.feesInfo));
      return re(() => {
        l.destroy()
      }), (d, f) => {
        var C, j;
        const m = As,
          ...
          _ = Ns,
          w = Bt;
        return M(), W("div", ro, [S("div", lo, [v(i).balanceLabel ? (M(), V(m, {
          key: 0,
          balance: v(i).balanceLabel
        }, null, 8, ["balance"])) : (M(), V(p, {
          key: 1,
          class: "skeleton"
        })), v(i).feesInfo ? (M(), V(y, {
          key: 2,
          ...
          "error-message": (C = v(i).error) == null ? void 0 : C.message
        }, null, 8, ["details", "total-label", "error-message"])) : (M(), V(p, {
          key: 3,
          class: "skeleton"
        ...
        }, null, 8, ["jetton-shortname", "jetton-address"])) : (M(), V(w, {
          key: 1,
          fill: "",
          icon: "lock-open",
          "icon-align": "left",
          ...
          default: Y(() => [S("div", ao, D(("t" in d ? d.t : v(x))("memepad.jetton.unlock_btn", {
    ...
    setup(n) {
      ...
      return (i, s) => {
        const o = Sn,
          ...
          u = Qn,
          d = kn;
        return M(), W("div", uo, [E(o), S("div", fo, [S("div", mo, [E(h, {
          size: 342,
          name: "animations/Clover",
          class: "animation"
        }), E(r, {
          src: v(Ps)(i.jetton.iconFileKey),
          size: 80
        }, null, 8, ["src"])]), S("div", po, D(("t" in i ? i.t : v(x))("memepad.moving_to_dex.title")), 1), S("div", vo, D(("t" in i ? i.t : v(x))("memepad.moving_to_dex.subtitle", {
          ticker: i.jetton.ticker
        })), 1)]), E(u, null, {
          default: Y(() => [S("div", bo, [E(c, {
            "force-loading": i.unlockEnabled === void 0 && i.isReleased
          }, {
            default: Y(() => [i.unlockEnabled ? (M(), V(l, {
              key: 0,
              jetton: i.jetton,
  ...
  Eo = et({
    ...
    setup(n) {
      const t = n,
        e = $(() => {
          const i = ni(t.jetton.releaseTimestamp).label;
          return t.isReleased ? `${i} • STON.fi` : i
        });
      return (i, s) => {
        const o = to,
          h = le;
        return M(), W("div", wo, [S("div", yo, [E(o, {
          jetton: i.jetton
        }, null, 8, ["jetton"]), S("div", So, [S("div", Mo, [S("div", ko, D(i.jetton.ticker), 1), i.jettonInformation.stream.online ? (M(), W("div", Co, s[2] || (s[2] = [S("div", {
          class: "dot"
        }, null, -1)]))) : St("", !0), i.jettonInformation.inSpotlight ? (M(), W("div", jo, [E(h, {
          name: "fire",
          class: "icon"
        }), s[3] || (s[3] = S("span", {
          class: "label"
        }, "Spotlight", -1))])) : St("", !0)]), S("div", zo, D(v(e)), 1)])]), S("div", Lo, [S("button", {
          type: "button",
          class: "reset copy",
          ...
          name: "edit-copy",
          class: "icon"
        }), S("span", $o, D(("sliceWalletAddress" in i ? i.sliceWalletAddress : v(Cn))(i.jetton.address, 3)), 1)]), S("button", {
          type: "button",
          class: "reset share",
    ...
    setup(n) {
      return (t, e) => {
        ...
        return M(), W("div", To, [E(i, {
          ...
          }, D(("t" in t ? t.t : v(x))("memepad.jetton.stream_banned_link")), 1)]),
          _: 1
        })])
      }
    }
  ...
  Fo = et({
    ...
    setup(n) {
      const t = n,
        ...
        r = Ro(t.stream.startAt, "hms");
      return (l, a) => {
        const c = le;
        return M(), W("div", Io, [S("iframe", {
          ref_key: "player",
          ref: e,
        ...
        }, null, 8, Wo), a[2] || (a[2] = S("div", {
          class: "bg"
        }, null, -1)), S("div", Bo, [S("div", Ao, [E(c, {
          name: "user-voice",
          class: "icon"
        }), S("span", Do, D(l.stream.viewers), 1)]), S("div", No, [E(c, {
          name: "calendar-clock",
          class: "icon"
        }), S("span", Oo, D(v(r).label), 1)])]), S("div", Uo, [S("button", {
          type: "button",
  ...
  qo = et({
    ...
    setup(n) {
      const t = n,
        ...
        }), o = () => ee().$webApp.openLink("https://www.blum.io/post/videostream-quick-start-guide");
      return (h, r) => {
        const l = le,
          a = Te,
          c = Rs("I18nT"),
          u = Bt,
          d = Is;
        return M(), W("div", Jo, [S("button", {
          type: "button",
          class: "reset button",
          onClick: i
        }, D(("t" in h ? h.t : v(x))("memepad.jetton.start_stream_button")), 1), E(d, {
          modelValue: v(s),
          "onUpdate:modelValue": r[2] || (r[2] = f => ft(s) ? s.value = f : null)
        }, {
          default: Y(() => [S("div", Ho, [S("div", Xo, D(("t" in h ? h.t : v(x))("memepad.jetton.steam.start_sheet.title")), 1), S("div", Yo, D(("t" in h ? h.t : v(x))("memepad.jetton.steam.start_sheet.subtitle")), 1), S("div", Zo, [v(e).status === "loaded" ? (M(), W("button", {
            key: 0,
            type: "button",
            class: "reset",
            onClick: r[0] || (r[0] = f => ("useCopy" in h ? h.useCopy : v(zn))().copy(v(e).streamKey))
          }, [S("div", Go, D(v(e).streamKey), 1), E(l, {
            name: "edit-copy",
            class: "icon"
          })])) : (M(), V(a, {
            key: 1,
            ...
            }, D(("t" in h ? h.t : v(x))("memepad.jetton.stream.rules_link")), 1)]),
            _: 1
          }), E(u, {
    ...
    setup(n) {
      const t = n,
        ...
        i = async () => {
          ...
          const o = await Ce.getMemepadStreamKey(t.jetton.shortname);
          if (!jt(o)) return o;
          const h = o.data.stream.key;
          if (!h) throw _i("Failed to generate stream key");
          return dt(h)
        }, s = () => ee().$webApp.openLink("https://www.blum.io/post/videostream-quick-start-guide#:~:text=Blum%20Memepad%20Videostream%20Terms%20%26%C2%A0Conditions");
      return (o, h) => {
        const r = Vo,
          l = Ko,
          a = Qo;
        return o.jettonInformation.stream.isBanned ? (M(), V(r, {
          key: 0,
          onOpenRules: s
        })) : o.jettonInformation.stream.online ? (M(), W(yt, {
          key: 1
        }, [v(e) ? (M(), W("button", {
          key: 0,
          type: "button",
        ...
        }, D(("t" in o ? o.t : v(x))("memepad.jetton.show_stream_button")), 1)) : (M(), V(l, {
          key: 1,
...
var nh = function() {
  ...
  return n.prototype.dispose = function() {
    ...
    Tt(e, t) || (this.canvasElement.width = t.width, this.canvasElement.height = t.height, this._emitBitmapSizeChanged(e, t))
    ...
    var e = this._suggestedBitmapSize,
      ...
      s = Tt(this.bitmapSize, i) ? null : i;
    e === null && s === null || e !== null && s !== null && Tt(e, s) || (this._suggestedBitmapSize = s, this._emitSuggestedBitmapSizeChanged(e, s))
...
function ie(n) {
  (n = n.toLowerCase()) in Ai && (n = Ai[n]);
  {
    ...
    if (t) return [ct(parseInt(t[1], 10)), ct(parseInt(t[2], 10)), ct(parseInt(t[3], 10)), Hs(t.length < 5 ? 1 : parseFloat(t[4]))]
  } {
    const t = vh.exec(n);
...
class Ch extends pt {
  ...
  K({
    ...
    t.lineCap = "butt", o && r >= 0 && (t.lineWidth = Math.floor(this.zt.Lt.et * i), t.strokeStyle = this.zt.Lt.V, t.fillStyle = this.zt.Lt.V, Rt(t, this.zt.Lt.Nt), function(a, c, u, d) {
      a.beginPath();
      const f = a.lineWidth % 2 ? .5 : 0;
      a.moveTo(c + f, u), a.lineTo(c + f, d), a.stroke()
    }(t, r, 0, e.height)), h && l >= 0 && (t.lineWidth = Math.floor(this.zt.Et.et * s), t.strokeStyle = this.zt.Et.V, t.fillStyle = this.zt.Et.V, Rt(t, this.zt.Et.Nt), Js(t, l, 0, e.width))
  }
}
class jh {
  constructor(t) {
...
function Ni(n, t, e, i, s, o, h = 0, r = [0, 0, 0, 0], l = "") {
  ...
  const a = h / 2;
  var c;
  Di(n, t + a, e + a, i - h, s - h, (c = -a, r.map(u => u === 0 ? u : u + c))), o !== "transparent" && (n.fillStyle = o, n.fill()), l !== "transparent" && (n.lineWidth = h, n.strokeStyle = l, n.closePath(), n.stroke()), n.restore()
}
...
class Oi {
    ...
    const o = this.zt.V,
      ...
      r = t.useBitmapCoordinateSpace(l => {
        ...
        const c = this.Gt(l, e, i, s),
          u = c.Jt;
        return c.Qt ? Ni(a, u.ti, u.ii, u.ni, u.si, h, u.ei, [u.ht, 0, 0, u.ht], h) : Ni(a, u.ri, u.ii, u.ni, u.si, h, u.ei, [0, u.ht, u.ht, 0], h), this.zt.hi && (a.fillStyle = o, a.fillRect(u.ri, u.li, u.ai - u.ri, u.oi)), this.zt._i && (a.fillStyle = e.O, a.fillRect(c.Qt ? u.ui - u.ei : 0, u.ii, u.ei, u.ci - u.ii)), c
      });
  ...
  Gt(t, e, i, s) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, f = e.L + this.Xt.wi, m = e.B + this.Xt.gi, p = e.A, y = e.I, _ = this.zt.Kt, w = e.P, C = i.Mi(h, _), j = Math.ceil(i.xi(h, _)), R = w + f + m, k = e.C + p + y + j + u, z = Math.max(1, Math.floor(c));
    let b = Math.round(R * c);
    b % 2 != z % 2 && (b += 1);
    const L = d > 0 ? Math.max(1, Math.floor(d * a)) : 0,
      T = Math.round(k * a),
      B = Math.round(u * a),
      A = (o = this.Xt.Si) !== null && o !== void 0 ? o : this.Xt.ki,
      N = Math.round(A * c) - Math.floor(.5 * c),
      O = Math.floor(N + z / 2 - b / 2),
      Z = O + b,
      P = s === "right",
      J = P ? l.width - d : d,
      I = P ? r.width - L : L;
    let tt, U, it;
    return P ? (tt = I - T, U = I - B, it = J - u - p - d) : (tt = I + T, U = I + B, it = J + u + p), {
      Qt: P,
      Jt: {
        ii: O,
        li: N,
...
class Lh extends Re {
  ...
  zi(t, e, i) {
    ...
    const h = Pe(s.labelBackgroundColor);
    i.t = h.t, t.V = h.i;
  ...
  X(t, e) {
    ...
    t.useBitmapCoordinateSpace(({
      ...
      const y = Math.round(a * f),
        ...
        C = Math.round(u * m),
        j = Math.round(2 * f);
      if (d.beginPath(), d.moveTo(y, _), d.lineTo(y, C - j), d.arcTo(y, C, y + j, C, j), d.lineTo(w - j, C), d.arcTo(w, C, w, C - j, j), d.lineTo(w, _), d.fill(), p.hi) {
        const R = Math.round(p.ki * f),
          k = _,
          z = Math.round((k + e.T) * m);
        d.fillStyle = p.V;
        const b = Math.max(1, Math.floor(f)),
          L = Math.floor(.5 * f);
        d.fillRect(R - L, k, b, z - k)
      }
    }), t.useMediaCoordinateSpace(({
      context: d
    }) => {
      ...
      d.translate(a + s, m + p), d.fillText(f.Kt, 0, 0)
    })
  }
}
class Eh {
  ...
  Mt() {
    ...
    const h = Pe(e.labelBackgroundColor);
...
function wt(n, t) {
  if (!bt(n)) return "n/a";
  if (!se(t)) throw new TypeError("invalid length");
  if (t < 0 || t > 16) throw new TypeError("invalid length");
  return t === 0 ? n.toString() : ("0000000000000000" + n.toString()).slice(-t)
}
class We {
  constructor(t, e) {
    if (e || (e = 1), bt(t) && se(t) || (t = 100), t < 0) throw new TypeError("invalid base");
  ...
  ls(t) {
    ...
    if (e > 1) {
      ...
      h >= e && (h -= e, i += 1), s = Ui + wt(+h.toFixed(this.os) * this.rs, o)
    } else i = Math.round(i * e) / e, o > 0 && (s = Ui + wt(0, o));
...
function qs(n, t, e, i, s, o, h) {
  ...
  if (i.to - i.from < 2) {
    ...
    r.moveTo(m.nt * l, m.st * a), r.lineTo(p.nt * l, p.st * a), h(n, u, m, p)
  } else {
    const f = (p, y) => {
      h(n, u, d, y), r.beginPath(), u = p, d = y
    };
    let m = d;
    ...
    for (let p = i.from + 1; p < i.to; ++p) {
      ...
      switch (e) {
        case 0:
          ...
          break;
        case 1:
          r.lineTo(m.nt * l, t[p - 1].st * a), y !== u && (f(y, m), r.lineTo(m.nt * l, t[p - 1].st * a)), r.lineTo(m.nt * l, m.st * a);
          break;
        case 2: {
          const [_, w] = Ph(t, p - 1, p);
          r.bezierCurveTo(_.nt * l, _.st * a, w.nt * l, w.st * a, m.nt * l, m.st * a);
          break
        }
      }
...
function Ph(n, t, e) {
  ...
  var o, h;
  return [(o = n[t], h = Ki(Ae(n[e], n[i]), Fi), {
    nt: o.nt + h.nt,
    st: o.st + h.st
  }), Ae(n[e], Ki(Ae(n[s], n[t]), Fi))]
}
...
class Qs extends pt {
  ...
  K(t) {
    ...
    if (s === null) return;
    const c = t.context;
    c.lineCap = "butt", c.lineJoin = "round", c.lineWidth = h, Rt(c, r), c.lineWidth = 1, qs(t, i, l, s, o, this.ps.bind(this), Vh.bind(null, a))
  }
}
  ...
  bs(t, e) {
    ...
    if (this.ys === void 0 || i === void 0 || i.gs !== s || i.Ms !== o || i.xs !== h || i.Ss !== r || i.fs !== a || i.ks !== l) {
      ...
      if (c.addColorStop(0, s), a != null) {
        const u = di(a * t.verticalPixelRatio / l, 0, 1);
...
class en extends pt {
  ...
  K(t) {
    ...
    if (i === null) return;
    const a = t.context;
    a.lineCap = "butt", a.lineWidth = h * t.verticalPixelRatio, Rt(a, r), a.lineJoin = "round";
    const c = this.Ds.bind(this);
    o !== void 0 && qs(t, e, o, i, s, c, Ih), l && function(u, d, f, m, p) {
      const {
      ...
      for (let k = m.to - 1; k >= m.from; --k) {
        ...
        if (z) {
          const b = p(u, z);
          b !== C && (w.beginPath(), C !== null && w.fill(), w.fillStyle = b, C = b);
          const L = Math.round(z.nt * y) + j,
            T = z.st * _;
          w.moveTo(L, T), w.arc(L, T, R, 0, 2 * Math.PI)
        }
      }
      w.fill()
    }(t, e, l, i, c)
...
class Be extends ji {
  ...
  Ks(t, e, i) {
    e.Js(this.Is, ne(this.zs)), t.Qs(this.Is, i, ne(this.zs))
  }
  te(t, e) {
    return {
      ot: t,
...
class Ah extends Be {
  constructor(t, e) {
    super(t, e), this.Ws = new Mi, this.ee = new Rh, this.re = new sn, this.Ws.Z([this.ee, this.re])
  }
  ne(t, e, i) {
  ...
  K({
    ...
    for (let h = this.zt.tt.from; h < this.zt.tt.to; ++h) {
      ...
      const l = Math.floor(.5 * this.ae),
        ...
        p = Math.round(f * i) - l,
        y = Math.round(m * i) + l,
        _ = Math.max(y - p, this.ae);
      t.fillRect(c, p, u, _);
      const w = Math.ceil(1.5 * this.le);
      if (o) {
        if (this.zt.fe) {
          const k = a - w;
          let z = Math.max(p, Math.round(r.ve * i) - l),
            b = z + u - 1;
          b > p + _ - 1 && (b = p + _ - 1, z = b - u + 1), t.fillRect(k, z, c - k, b - z + 1)
        }
        const C = a + w;
        let j = Math.max(p, Math.round(r.pe * i) - l),
          R = j + u - 1;
        R > p + _ - 1 && (R = p + _ - 1, j = R - u + 1), t.fillRect(d + 1, j, C - d, R - j + 1)
      }
    }
  }
  oe(t) {
...
class rn extends ji {
  ...
  Ks(t, e, i) {
    e.Js(this.Is, ne(this.zs)), t.me(this.Is, i, ne(this.zs))
  }
  be(t, e, i) {
    return {
      ot: t,
...
class Kh extends pt {
  ...
  Be(t, e, i) {
    ...
    for (let u = i.from; u < i.to; u++) {
      ...
      const w = _ + l - 1;
      c !== null && (_ = Math.max(c + 1, _), _ = Math.min(_, w));
      const C = w - _ + 1;
      s.fillRect(_, p, C, f - p), s.fillRect(_, m + 1, C, y - m), c = w
    }
  }
  Ie(t) {
  ...
  Ae(t, e, i) {
    ...
    for (let c = i.from; c < i.to; c++) {
      ...
      if (a !== null && (d = Math.max(a + 1, d), d = Math.min(d, f)), this.zt.he * o > 2 * l) zh(s, d, m, f - d + 1, p - m + 1, l);
      else {
        const y = f - d + 1;
        s.fillRect(d, m, y, p - m + 1)
      }
      a = f
    }
  }
...
class ln {
  constructor(t, e, i) {
    this._r = t, this.lr = new oe(50), this.ur = e, this.F = i, this.j = -1, this.Wt = new Qh(this.lr)
  }
  gt() {
...
class tr extends pt {
  ...
  K({
    ...
    o < 0 || o > e.height || (t.lineCap = "butt", t.strokeStyle = this.zt.V, t.lineWidth = Math.floor(this.zt.et * i), Rt(t, this.zt.Nt), Js(t, o, 0, e.width))
  }
}
class zi {
  constructor(t) {
...
class hr extends pt {
  constructor() {
    super(...arguments), this.zt = null, this.lr = new oe, this.j = -1, this.H = "", this.Jr = ""
  }
  J(t) {
    this.zt = t
  }
    ...
    switch (i.ih) {
      ...
      case "circle":
        return function(h, r, l, a, c) {
          const u = 2 + he("circle", l) / 2,
            d = h - a,
            f = r - c;
          return Math.sqrt(d * d + f * f) <= u
        }(i.nt, i.st, i.Xs, s, o);
      case "square":
        return cn(i.nt, i.st, i.Xs, s, o)
    }
  }(n, t, e)
}
...
class Ee {
  ...
  static Bh(t) {
    return t === null ? null : new Ee(rt.Bh(t.priceRange), t.margins)
  }
}
class fr extends zi {
  constructor(t, e) {
...
class mr extends Re {
  ...
  zi(t, e, i) {
    ...
    const a = Pe(s.axisLabelColor || s.color);
    i.t = a.t;
...
class pr {
  constructor(t, e) {
    this.Wr = t, this.cn = e, this.Wh = new fr(t, this), this._r = new mr(t, this), this.jh = new ln(this._r, t, t.$t())
  }
  Hh(t) {
...
class _r {
  ...
  al(t, e, i) {
    ...
    let s = null;
    for (const o of i) s = pe(s, this.ol(t, e, o));
    return s
  }
  J(t) {
  ...
  dl(t) {
    return ce(this.Qh, t, (e, i) => e.se < i)
  }
  fl(t) {
  ...
  ol(t, e, i) {
    ...
    for (let d = Math.max(a + 1, r); d < c; d += kt) {
      ...
      let m = u.get(f);
      if (m === void 0) {
        const p = this.dl(f * kt),
          y = this.fl((f + 1) * kt - 1);
        m = this.vl(p, y, i), u.set(f, m)
      }
      s = pe(s, m)
    } {
      const d = this.dl(c),
...
class Li extends vr {
  constructor(t, e, i, s, o) {
    ...
    const h = new dr(this);
    this.rn = [h], this.jh = new ln(h, this, t), i !== "Area" && i !== "Line" && i !== "Baseline" || (this.Ll = new nr(this)), this.$l(), this.Ul(o)
  }
  S() {
  ...
  Pn() {
    ...
    return t.push(...e), Oe(this.jl, Ue, "normal", t), t
  }
  _a() {
    return this.ua(Ue, "bottom")
  }
  ca(t) {
    return this.ua(kr, t)
  }
  ...
  ya() {
    if (this.wn instanceof De) return t => this.wn.Fe(t)
  }
  Ca() {
    if (this.wn instanceof De) return t => this.wn.We(t)
  }
  oa() {
    return !Ie(this.Dt().Ta())
  }
  va(t, e) {
    if (!se(t) || !se(e) || this.zt.Ni()) return null;
  ...
  $l() {
    switch (this.cn.priceFormat.type) {
      case "custom":
        ...
        break;
      case "volume":
        this.ba = new Th(this.cn.priceFormat.precision);
        break;
      case "percent":
  ...
  Ul(t) {
    switch (this.dn = new cr(this, this.$t()), this.Hl) {
      ...
      case "Line":
        ...
        break;
      case "Custom":
        this.wn = new De(this, this.$t(), ht(t));
        break;
      case "Area":
  ...
  K({
    ...
    t.lineWidth = o,
      function(h, r) {
        ...
        const h = g(this.zt);
        if (h.Ba) {
          t.strokeStyle = h.Aa, Rt(t, h.Ia), t.beginPath();
          for (const r of h.za) {
        ...
        if (h.Ea) {
          t.strokeStyle = h.Na, Rt(t, h.Fa), t.beginPath();
          for (const r of h.Wa) {
...
class Je {
  ...
  Za(t, e, i) {
    ...
    let o = Math.pow(10, Math.max(0, Math.ceil(Math.log10(t - e)))),
      ...
      r = this.qa[0];
    for (;;) {
      const u = me(o, s, 1e-14) && o > s + 1e-14,
        d = me(o, i * r, 1e-14),
        f = me(o, 1, 1e-14);
      if (!(u && d && f)) break;
    ...
    if (o <= s + 1e-14 && (o = s), o = Math.max(1, o), this.Ya.length > 0 && (l = o, a = 1, c = 1e-14, Math.abs(l - a) < c))
      for (h = 0, r = this.Ya[0]; me(o, i * r, 1e-14) && o > s + 1e-14;) o /= r, r = this.Ya[++h % this.Ya.length];
    var l, a, c;
    return o
  }
}
class Qi {
  ...
  Za(t, e) {
    ...
    const i = this.Li.At(),
      s = (t - e) * this.Ja() / i,
      o = new Je(this.Ua, [2, 2.5, 2]),
      h = new Je(this.Ua, [2, 2, 2.5]),
      r = new Je(this.Ua, [2.5, 2, 2]),
      l = [];
  ...
  Qa() {
    ...
    for (let y = a - d; y > c; y -= u) {
      const _ = this.Ga(y, e, !0);
      m !== null && Math.abs(_ - m) < this.Ja() || _ < r || _ > l || (p < this.Xa.length ? (this.Xa[p].La = _, this.Xa[p].no = t.so(y)) : this.Xa.push({
        La: _,
        no: t.so(y)
      }), p++, m = _, t.eo() && (u = this.Za(y * f, c)))
    }
    this.Xa.length = p
  }
  ja() {
...
class Tr {
  constructor(t, e, i, s) {
    this.ro = 0, this.ho = null, this.Ah = null, this.lo = null, this.ao = {
      oo: !1,
      _o: null
    }, this.uo = 0, this.co = 0, this.do = new q, this.fo = new q, this.vo = [], this.po = null, this.mo = null, this.bo = null, this.wo = null, this.ba = is, this.Mo = Ke(null), this.xo = t, this.cn = e, this.So = i, this.ko = s, this.yo = new Qi(this, 100, this.Co.bind(this), this.To.bind(this))
  }
  Ta() {
    return this.xo
  }
  ...
  Po(t) {
    ...
    }(this.Ah, this.Mo) ? (i = ve(this.Ah, this.Mo), i !== null && this.Bo(i)) : this.cn.autoScale = !0), t.yr === 1 && t.yr !== e.yr && (i = Xt(this.Ah, this.Mo), i !== null && this.Bo(i));
  ...
  me(t, e, i) {
    ...
    for (let m = u; m < d; m++) {
      ...
      let y = p.we,
        ...
        w = p.Me,
        C = p.xe;
      f !== null && (y = f(p.we, e), _ = f(p.ge, e), w = f(p.Me, e), C = f(p.xe, e));
      let j = s + c * (y - h),
        R = a ? j : this.ro - 1 - j;
      p.ve = R, j = s + c * (_ - h), R = a ? j : this.ro - 1 - j, p.ce = R, j = s + c * (w - h), R = a ? j : this.ro - 1 - j, p.de = R, j = s + c * (C - h), R = a ? j : this.ro - 1 - j, p.pe = R
    }
  }
  pn(t, e) {
    const i = this.Co(t, e);
  ...
  Pa() {
    ...
    const t = this.s_();
    let e = 100;
    t !== null && (e = Math.round(1 / t.pa())), this.ba = is, this.gh() ? (this.ba = es, e = 100) : this.Vo() ? (this.ba = new We(100, 1), e = 100) : t !== null && (this.ba = t.ma()), this.yo = new Qi(this, e, this.Co.bind(this), this.To.bind(this)), this.yo.Qa()
  }
  qo() {
    this.po = null
  }
  ...
  h_() {
    ...
    if (s === this.uo && o === this.co || (this.uo = s, this.co = o, this.mo = null, this.Ro()), e !== null) {
      if (e.Th() === e.Ph()) {
        ...
        this.eo() && (e = ve(e, this.Mo)), e = new rt(e.Th() - a, e.Ph() + a), this.eo() && (e = Xt(e, this.Mo))
      }
      if (this.eo()) {
        const l = ve(e, this.Mo),
          a = Ke(l);
        if (h = a, r = this.Mo, h.Ha !== r.Ha || h.$a !== r.$a) {
          const c = this.lo !== null ? ve(this.lo, this.Mo) : null;
          this.Mo = a, e = Xt(l, a), c !== null && (this.lo = Xt(c, a))
        }
      }
      this.Bo(e)
    } else this.Ah === null && (this.Bo(new rt(-.5, .5)), this.Mo = Ke(null));
    var h, r;
    this.ao.oo = !0
  }
  jo() {
...
class Pr {
  constructor(t, e) {
    this.vo = [], this.a_ = new Map, this.ro = 0, this.o_ = 0, this.__ = 1e3, this.po = null, this.u_ = new q, this.kl = t, this.$i = e, this.c_ = new $r(this);
    const i = e.W();
  ...
  C_(t, e, i) {
    let s = this.b_(e);
    if (s === null && (s = this.f_(e, this.$i.W().overlayPriceScales)), this.vo.push(t), !Ie(e)) {
  ...
  f_(t, e) {
    const i = Object.assign({
      ...
      s = new Tr(t, i, this.$i.W().layout, this.$i.W().localization);
...
class Rr {
  ...
  iu(t) {
    ...
    const e = [];
    this.G_.forEach((i, s) => {
      t <= i[0].index ? e.push(s) : i.splice(ce(i, t, o => o.index < t), 1 / 0)
    });
...
class Kt {
  ...
  hu() {
    return this.ru === null ? null : new te(Math.floor(this.ru.Vs()), Math.ceil(this.ru.ui()))
  }
  lu() {
    return this.ru
  }
...
class Wr {
  constructor(t, e, i, s) {
    this.o_ = 0, this.ou = null, this._u = [], this.wo = null, this.bo = null, this.uu = new Rr, this.cu = new Map, this.du = Kt.au(), this.fu = !0, this.vu = new q, this.pu = new q, this.mu = new q, this.bu = null, this.wu = null, this.gu = [], this.cn = e, this.ko = i, this.Mu = e.rightOffset, this.xu = e.barSpacing, this.$i = t, this.U_ = s, this.Su(), this.uu.Q_(e.uniformDistribution)
  }
  W() {
    return this.cn
  }
  ...
  Da(t, e) {
    ...
    const i = ce(this._u, this.U_.key(t), (s, o) => this.U_.key(s.time) < o);
  ...
  ja() {
    ...
    for (const m of r) {
      ...
      f < this.gu.length ? (p = this.gu[f], p.coord = this.It(m.index), p.label = this.$u(m), p.weight = m.weight) : (p = {
        ...
        label: this.$u(m),
        weight: m.weight
      }, this.gu.push(p)), this.xu > e / 2 && !c ? p.needAlignCoordinate = !1 : p.needAlignCoordinate = u && m.index <= l || d && m.index >= a, f++
    }
  ...
  Go(t) {
    ...
    const e = di(this.o_ - t, 0, this.o_),
      i = di(this.o_ - g(this.bo), 0, this.o_);
  ...
  rc() {
    const t = this.Ou(),
      e = this.Bu();
    t !== null && e !== null && this.ec(new te(t, e + this.cn.rightOffset))
  }
  hc(t) {
    const e = new te(t.from, t.to);
    this.ec(e)
  }
  qi(t) {
  ...
  $u(t) {
    ...
    return e === void 0 && (e = new Vr(i => this.dc(i), this.U_), this.cu.set(t.weight, e)), e.q_(t)
  }
  dc(t) {
...
class Or {
  ...
  Bt(t) {
    ...
    const s = function(o, h, r) {
      const [l, a, c, u] = ie(o), [d, f, m, p] = ie(h), y = [ct(l + r * (d - l)), ct(a + r * (f - a)), ct(c + r * (m - c)), Hs(u + r * (p - u))];
...
function Ur(n, t, e) {
  return t.replace(/yyyy/g, (i => wt(as(i), 4))(n)).replace(/yy/g, (i => wt(as(i) % 100, 2))(n)).replace(/MMMM/g, ((i, s) => new Date(i.getUTCFullYear(), i.getUTCMonth(), 1).toLocaleString(s, {
    month: "long"
...
class Jr {
  constructor(t = {}) {
    ...
    this.Cd = new mn(e.xd, e.yd), this.Td = new Fr(e.Sd), this.Pd = e.kd
  }
  q_(t) {
...
function us(n, t) {
  ...
  for (let e = ge.length - 1; e >= 0; --e)
    if (Math.floor(t.getTime() / ge[e].Rd) !== Math.floor(n.getTime() / ge[e].Rd)) return ge[e].Dd;
  return 0
}

function Xe(n) {
  let t = n;
  if (ae(n) && (t = $i(n)), !fi(t)) throw new Error("time must be of type BusinessDay");
...
class ms {
  ...
  createConverterToInternalObj(t) {
    return g(function(e) {
      return e.length === 0 ? null : fi(e[0].time) || ae(e[0].time) ? Xe : ds
    }(t))
  }
  key(t) {
  ...
  convertHorzItemToInternal(t) {
    return fn(e = t) ? ds(e) : fi(e) ? Xe(e) : Xe($i(e));
    var e
  }
  updateFormatter(t) {
    if (!this.cn) return;
  ...
  fillWeightsForPoints(t, e) {
    (function(i, s = 0) {
      ...
      for (let l = s; l < i.length; ++l) {
        ...
        h !== null && (a.timeWeight = us(c, h)), r += a.time.Vd - (o || a.time.Vd), o = a.time.Vd, h = c
      }
      if (s === 0 && i.length > 1) {
        const l = Math.ceil(r / (i.length - 1)),
          a = new Date(1e3 * (i[0].time.Vd - l));
        i[0].timeWeight = us(new Date(1e3 * i[0].time.Vd), a)
      }
    })(t, e)
  }
  static Ad(t) {
...
class Hr {
  ...
  Dr(t, e) {
    ...
    let i = 0;
    const s = Ge(this.zd, this.Ld, this.$d),
      o = Ze(this.zd, this.Ld),
      h = [s],
      r = [o];
    if (i += o, this.Ed !== null) {
      const a = Ge(this.Ld, this.Ed, this.$d);
      if (Math.sign(a) === Math.sign(s)) {
        const c = Ze(this.Ld, this.Ed);
        if (h.push(a), r.push(c), i += c, this.Nd !== null) {
          const u = Ge(this.Ed, this.Nd, this.$d);
          if (Math.sign(u) === Math.sign(s)) {
            const d = Ze(this.Ed, this.Nd);
...
class Xr {
  ...
  sf() {
    return Xs(ie(this.Jd.W().layout.textColor)) > 160 ? "dark" : "light"
  }
  nf() {
...
class Ei {
  constructor(t, e, i) {
    this.rf = 0, this.hf = null, this.lf = {
      ...
      nt: Number.NEGATIVE_INFINITY,
      st: Number.POSITIVE_INFINITY
    }, this.cf = null, this.df = !1, this.ff = null, this.vf = null, this.pf = !1, this.mf = !1, this.bf = !1, this.wf = null, this.gf = null, this.Mf = null, this.xf = null, this.Sf = null, this.kf = null, this.yf = null, this.Cf = 0, this.Tf = !1, this.Pf = !1, this.Rf = !1, this.Df = 0, this.Vf = null, this.Of = !Ye(), this.Bf = s => {
      this.Af(s)
    }, this.If = s => {
      if (this.zf(s)) {
        const o = this.Lf(s);
  ...
  tv(t) {
    ...
    if (e === null || (this.Df = _e(t), this.yf !== null) || this.Pf) return;
    this.Tf = !0;
  ...
  av(t) {
    ...
    this.Vf = null, this.Df = _e(t), this.Xf(), this.vf = null, this.kf && (this.kf(), this.kf = null);
    const i = this.Lf(t, e);
  ...
  dv(t) {
    ...
    this.Vf = e.identifier, this.Df = _e(t);
  ...
  pv(t) {
    ...
    ps() && e.addEventListener("mouseleave", this.Bf), this.mf = !1, this.ff = vt(t), this.Sf && (this.Sf(), this.Sf = null);
    {
  ...
  wv(t) {
    ...
    const e = this.Lf(t);
    this.$f(e, this.jf.Tv), this.Of = !Ye()
  }
  fv(t) {
  ...
  zf(t) {
    return t.sourceCapabilities && t.sourceCapabilities.firesTouchEvents !== void 0 ? t.sourceCapabilities.firesTouchEvents : _e(t) < this.Df + 500
  }
  Ff(t, e) {
    e && e.call(this.jf, t)
  }
  ...
  for (let l = 1; l < n.length; l++) {
    ...
    if (t === 1 ? d > f - u : d < f + u) {
      ...
      if ((t === 1 ? p < 0 : p > e) && r > 0) {
        const y = t === 1 ? -1 - p : p - e,
          _ = Math.min(y, r);
        for (let w = s; w < n.length; w++) n[w].Oi(n[w].Vi() + t * _);
        r -= _
      }
...
class gs {
  constructor(t, e, i, s) {
    this.Li = null, this.Lv = null, this.Ev = !1, this.Nv = new oe(200), this.Jr = null, this.Fv = 0, this.Wv = !1, this.jv = () => {
      this.Wv || this.tn.Hv().$t().$h()
    }, this.$v = () => {
      this.Wv || this.tn.Hv().$t().$h()
    }, this.tn = t, this.cn = e, this.So = e.layout, this.Vc = i, this.Uv = s === "left", this.qv = Qe("normal", s), this.Yv = Qe("top", s), this.Zv = Qe("bottom", s), this.Xv = document.createElement("div"), this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Xv.style.width = "25px", this.Xv.style.left = "0", this.Xv.style.position = "relative", this.Kv = It(this.Xv, F({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const o = this.Kv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "1", o.style.left = "0", o.style.top = "0", this.Gv = It(this.Xv, F({
      width: 16,
      height: 16
  ...
  ap() {
    ...
    i.restore();
    const r = t || 34;
    return mi(Math.ceil(e.C + e.T + e.A + e.I + 5 + r))
  }
  up(t) {
    this.Lv !== null && Tt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`)
  }
  cp() {
  ...
  pp({
    ...
    h === r ? Ve(t, 0, 0, i, s, h) : Ys(t, 0, 0, i, s, h, r)
  }
  Ae({
    context: t,
    bitmapSize: e,
...
class xi {
  constructor(t, e) {
    ...
    i.style.width = "100%", i.style.height = "100%", i.style.position = "relative", i.style.overflow = "hidden", this.Wp = document.createElement("td"), this.Wp.style.padding = "0", this.jp = document.createElement("td"), this.jp.style.padding = "0", this.Fp.appendChild(i), this.Kv = It(i, F({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const s = this.Kv.canvasElement;
    s.style.position = "absolute", s.style.zIndex = "1", s.style.left = "0", s.style.top = "0", this.Gv = It(i, F({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
  ...
  Up(t) {
    var e, i;
    this.Ep !== null && this.Ep.F_().p(this), this.Ep = t, this.Ep !== null && this.Ep.F_().l(xi.prototype.Np.bind(this), this, !0), this.$p(), this.Jd.qp().indexOf(this) === this.Jd.qp().length - 1 ? (this.Tp = (e = this.Tp) !== null && e !== void 0 ? e : new Xr(this.Fp, this.Jd), this.Tp.bt()) : ((i = this.Tp) === null || i === void 0 || i.tf(), this.Tp = null)
  }
  Hv() {
    return this.Jd
  }
    ...
    return i === null ? null : function(s, o, h) {
      const r = s.$o(),
        l = function(a, c, u) {
          ...
          let m, p;
          for (const w of a) {
            const C = (f = (d = w.fa) === null || d === void 0 ? void 0 : d.call(w, c, u)) !== null && f !== void 0 ? f : [];
            for (const j of C) y = j.zOrder, (!(_ = m == null ? void 0 : m.zOrder) || y === "top" && _ !== "top" || y === "normal" && _ === "bottom") && (m = j, p = w)
          }
          var y, _;
          return m && p ? {
            Iv: m,
      ...
      if ((l == null ? void 0 : l.Iv.zOrder) === "top") return we(l);
      for (const a of r) {
        if (l && l.jc === a && l.Iv.zOrder !== "bottom" && !l.Iv.isBackground) return we(l);
      ...
      return l != null && l.Iv ? we(l) : null
    }(i, t, e)
  }
  om(t, e) {
    g(e === "left" ? this.yp : this.Cp).up(F({
      width: t,
  ...
  up(t) {
    Tt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Fp.style.width = t.width + "px", this.Fp.style.height = t.height + "px")
  }
  um() {
    const t = g(this.Ep);
    t.T_(t.P_()), t.T_(t.R_());
  ...
  fp(t) {
    ...
    if (t > 1 && this.um(), this.yp !== null && this.yp.fp(t), this.Cp !== null && this.Cp.fp(t), t !== 1) {
      ...
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s)
      }), this.Ep && (this.dm(i, Gr), this.fm(i), this.vm(i), this.dm(i, ye), this.dm(i, qr)))
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Vt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
  ...
  pp({
    ...
    h === r ? Ve(t, 0, 0, i, s, r) : Ys(t, 0, 0, i, s, h, r)
  }
  fm(t) {
  ...
  vm(t) {
    const e = this.$i().qc();
    this.gm(t, ye, pi, e), this.gm(t, ye, Me, e)
  }
  pm(t) {
    this.gm(t, ye, Me, this.$i().Yc())
  }
  dm(t, e) {
    const i = g(this.Ep).$o();
    for (const s of i) this.gm(t, e, pi, s);
    for (const s of i) this.gm(t, e, Me, s)
  }
  gm(t, e, i, s) {
    const o = g(this.Ep),
      h = o.$t().Fc(),
...
class _s {
  constructor(t, e, i, s, o) {
    this.ft = !0, this.Lv = F({
      width: 0,
      height: 0
    }), this.jv = () => this.fp(3), this.Uv = t === "left", this.Vc = i._d, this.cn = e, this.Cm = s, this.Tm = o, this.Xv = document.createElement("div"), this.Xv.style.width = "25px", this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Kv = It(this.Xv, F({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv)
  }
  ...
  up(t) {
    Tt(this.Lv, t) || (this.Lv = t, this.Kv.resizeCanvasElement(t), this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.ft = !0)
  }
  fp(t) {
...
class sl {
  ...
  Nm(t, e, i) {
    Tt(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.Vm.m(t)), this.Pm !== null && this.Pm.up(F({
      width: e,
      height: t.height
  ...
  Hm(t, e) {
    ...
    for (const s of i) vi(e, o => pi(o, t, !1, void 0), s, void 0);
    for (const s of i) vi(e, o => Me(o, t, !1, void 0), s, void 0)
  }
  pp({
    context: t,
    bitmapSize: e
...
const nl = !!Ht && !!navigator.userAgentData && navigator.userAgentData.brands.some(n => n.brand.includes("Chromium")) && !!Ht && (!((ti = navigator == null ? void 0 : navigator.userAgentData) === null || ti === void 0) && ti.platform ? navigator.userAgentData.platform === "Windows" : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
var ti;
class ol {
  constructor(t, e, i) {
    var s;
    this.Zm = [], this.Xm = 0, this.ro = 0, this.o_ = 0, this.Km = 0, this.Gm = 0, this.Jm = null, this.Qm = !1, this.Dp = new q, this.Vp = new q, this.Pc = new q, this.tb = null, this.ib = null, this.Gd = t, this.cn = e, this.U_ = i, this.Zd = document.createElement("div"), this.Zd.classList.add("tv-lightweight-charts"), this.Zd.style.overflow = "hidden", this.Zd.style.direction = "ltr", this.Zd.style.width = "100%", this.Zd.style.height = "100%", (s = this.Zd).style.userSelect = "none", s.style.webkitUserSelect = "none", s.style.msUserSelect = "none", s.style.MozUserSelect = "none", s.style.webkitTapHighlightColor = "transparent", this.nb = document.createElement("table"), this.nb.setAttribute("cellspacing", "0"), this.Zd.appendChild(this.nb), this.sb = this.eb.bind(this), ei(this.cn) && this.rb(!0), this.$i = new Or(this.Dc.bind(this), this.cn, i), this.$t().Zc().l(this.hb.bind(this), this), this.lb = new sl(this, this.U_), this.nb.appendChild(this.lb.hp());
  ...
  ob(t, e, i = !1) {
    ...
    const o = this.ro + "px",
      h = this.o_ + "px";
    g(this.Zd).style.height = o, g(this.Zd).style.width = h, this.nb.style.height = o, this.nb.style.width = h, i ? this.pb(nt.es(), performance.now()) : this.$i.Xl()
  }
  fp(t) {
    t === void 0 && (t = nt.es());
  ...
  Tb() {
    ...
    for (let m = 0; m < this.Zm.length; ++m) {
      ...
      let y = 0,
        _ = 0;
      _ = m === this.Zm.length - 1 ? u - f : Math.round(p.g_() * d), y = Math.max(_, 2), f += y, p.up(F({
        width: h,
        height: y
      })), this.Mb() && p.om(e, "left"), this.xb() && p.om(i, "right"), p.dp() && this.$i.Xc(p.dp(), y)
    }
    this.lb.Nm(F({
      width: r ? h : 0,
      height: l
...
class dl {
    ...
    if (e.length !== 0) {
      ...
      h = e.map((f, m) => {
        const p = a(f.time),
          y = this.U_.key(p);
        let _ = this.Ub.get(y);
        _ === void 0 && (_ = Ms(p), this.Ub.set(y, _), s = !0);
        const w = c(p, _.se, f, l[m], u, d);
        return _.jb.set(t, w), w
      })
    }
  ...
  tw(t, e) {
    ...
    const f = {
      ...
      m = ce(this.Zb, this.U_.key(f.time), (p, y) => this.U_.key(p.time) < y);
  ...
  iw(t, e) {
    ...
    s === null || this.U_.key(e.ot) > this.U_.key(s.ot) ? Se(e) && i.push(e) : Se(e) ? i[i.length - 1] = e : i.splice(-1, 1), this.Yb.set(t, e.ot)
  }
  Gb(t, e) {
    e.length !== 0 ? (this.qb.set(t, e.filter(Se)), this.Yb.set(t, e[e.length - 1].ot)) : (this.qb.delete(t), this.Yb.delete(t))
  }
  Kb() {
  ...
  Jb(t) {
    ...
    for (let i = 0; i < this.Zb.length && i < t.length; ++i) {
      ...
      o.timeWeight = s.timeWeight, ii(o.pointData, i)
    }
    if (e === -1 && this.Zb.length !== t.length && (e = Math.min(this.Zb.length, t.length)), e === -1) return -1;
    for (let i = e; i < t.length; ++i) ii(t[i].pointData, i);
...
function zs() {
  return {
    ...
    leftPriceScale: Object.assign(Object.assign({}, si), {
      visible: !1
    }),
    rightPriceScale: Object.assign(Object.assign({}, si), {
      visible: !0
    }),
    timeScale: yl,
    watermark: Sl,
...
class Ml {
  ...
  width() {
    return Ie(this.aw) ? this.lw.gb(this.aw) : 0
  }
  Li() {
...
class jl {
  constructor(t, e, i, s, o) {
    this._w = new q, this.Ls = t, this.uw = e, this.cw = i, this.U_ = o, this.dw = s
  }
  S() {
    this._w.S()
  }
  ...
  barsInLogicalRange(t) {
    if (t === null) return null;
    const e = new Kt(new te(t.from, t.to)).hu(),
      i = this.Ls.In();
    if (i.Ni()) return null;
    const s = i.hl(e.Vs(), 1),
      o = i.hl(e.ui(), -1),
  ...
  dataByIndex(t, e) {
    ...
    return i === null ? null : bi(this.seriesType())(i)
  }
  data() {
    const t = bi(this.seriesType());
...
class zl {
  constructor(t, e, i) {
    this.bw = new q, this.pu = new q, this.Vm = new q, this.$i = t, this.kl = t.St(), this.lb = e, this.kl.tc().l(this.ww.bind(this)), this.kl.nc().l(this.gw.bind(this)), this.lb.Em().l(this.Mw.bind(this)), this.U_ = i
  }
  S() {
  ...
  return function(t) {
    if (fe(t.handleScale)) {
      ...
      fe(i) && (t.handleScale.axisPressedMouseMove = {
        time: i,
        price: i
      }), fe(s) && (t.handleScale.axisDoubleClickReset = {
        time: s,
        price: s
      })
    }
...
class $l {
  constructor(t, e, i) {
    this.xw = new Map, this.Sw = new Map, this.kw = new q, this.yw = new q, this.Cw = new q, this.Tw = new dl(e);
    const s = i === void 0 ? _t(zs()) : mt(_t(zs()), $s(i));
...
const Es = "chart-series-type-storage-key",
  bn = n => {
    const t = gt("$iBkM1fJygO"),
      ...
      a = w => {
        h.value = void 0, e.value = w, l(), m.value.exec()
      },
      c = w => {
        h.value = void 0, i.value = w, l(), m.value.exec()
      },
      u = w => {
        s.value = w, ee().$webApp.storage.local.set(Es, w)
      },
      d = w => {
        const C = i.value,
          j = e.value,
          R = t.value;
        if (!R || R.type !== C || R.interval !== j) return {
          type: C,
          interval: j,
          data: w
        };
        const k = w.points.filter(b => R.data.points.some(L => L.timestamp === b.timestamp)),
          z = w.points.filter(b => !R.data.points.some(L => L.timestamp === b.timestamp));
        return {
          type: C,
          interval: j,
          data: {
            points: [...z, ...R.data.points.map(b => k.find(L => L.timestamp === b.timestamp) || b)]
          }
        }
      },
      f = async w => {
        ...
        const {
          signal: j
        } = r.value, R = await Ce.getMemepadJettonCandleChart(o.value, {
          interval: e.value,
          type: i.value,
          fromTimestamp: w
        });
        j.aborted || (jt(R) ? t.value = d(R.data) : h.value = C)
      }, m = gt(() => Ln(async () => {
        const w = await Ce.getMemepadJettonCandleChart(o.value, {
          interval: e.value,
          type: i.value
        });
        return $n(w)
      }, w => t.value = d(w), 5e3), "$94wRLOqniR"), p = $(() => {
        var w;
        return t.value && t.value.type === Ct.MARKET_CAP ? (w = [...t.value.data.points].sort((C, j) => C.timestamp - j.timestamp).at(-1)) == null ? void 0 : w.price : void 0
      });
    return {
      _flow: {
        init: async () => {
        ...
        destroy: () => {
          m.value.destroy(), t.value = void 0, e.value = Yt.ONE_MINUTE, i.value = Ct.MARKET_CAP, h.value = void 0, l()
        }
      },
      chart: $(() => t.value),
      chartType: $(() => i.value),
    ...
    setup(n) {
      const t = n,
        ...
        p = $(() => [{
          ...
          value: Yt.FIVE_MINUTES,
          label: `5${x("base.time.abbr.minutes")}`
        }, {
          value: Yt.FIFTEEN_MINUTES,
        ...
        C = new ResizeObserver(() => {
          var L;
          const b = c.value;
          b && ((L = u.value) == null || L.resize(b.clientWidth, b.clientHeight))
        }),
        j = () => {
          const b = c.value;
          b && C.observe(b)
        ...
        k = (b, L, T) => {
          var it, st, at, Et, At;
          const B = (it = ee().$webApp.dataUnsafe.user) == null ? void 0 : it.language_code,
            A = (st = u.value) == null ? void 0 : st.timeScale().getVisibleRange(),
            N = (at = u.value) == null ? void 0 : at.timeScale().getVisibleLogicalRange(),
            O = (At = (Et = d.value) == null ? void 0 : Et.dataByIndex(0)) == null ? void 0 : At.time;
          d.value && u.value && u.value.removeSeries(d.value), L.innerHTML = "";
          const P = xl(L, {
            localization: {
              timeFormatter: G => {
                const lt = X => String(X).padStart(2, "0"),
                  H = new Date(G * 1e3);
                return `${lt(H.getUTCHours())}:${lt(H.getUTCMinutes())}`
              },
              priceFormatter: G => {
                if (w.value === Ct.MARKET_CAP) return `$${ze(G,{accuracy:0})}`;
                {
                  if (Math.abs(G) < 1e-9) return "$0";
                  const [lt, H] = G.toFixed(9).split("."), X = H[0], Mt = H.slice(1).match(/^0+/), Dt = Mt ? Mt[0].length : 0, _n = Dt > 0 ? String.fromCharCode(8321 + Dt) : "", wn = H.slice(Dt + 1).replace(/0+$/, "").slice(0, 3);
                  return `$${lt}.${X}${_n}${wn}`
                }
              },
              locale: B
          ...
          const J = T === Ot.CANDLESTICK ? P.addCandlestickSeries({
            upColor: "#C4F85C",
            downColor: "#FF00C7",
            baseLineWidth: 2,
            ...
            priceFormat: {
              type: "price",
              precision: w.value === Ct.MARKET_CAP ? 0 : 9,
              minMove: 1e-9
            }
          }) : P.addLineSeries({
            color: "#C4F85C",
          ...
          P.timeScale().subscribeVisibleLogicalRangeChange(G => {
            var ut, Mt;
            if (!G || G.from >= 0) return;
            const lt = (ut = J.dataByIndex(0)) == null ? void 0 : ut.time,
              H = (Mt = P.timeScale().getVisibleRange()) == null ? void 0 : Mt.from;
            if (!lt || lt !== H) return;
            const X = (() => {
              const Dt = new Date(H * 1e3);
          ...
          const I = b.map(G => ({
              time: (() => {
                const lt = new Date(G.timestamp);
                return (lt.getTime() - lt.getTimezoneOffset() * 60 * 1e3) / 1e3
              })(),
              open: G.open.toNumber(),
              high: G.high.toNumber(),
              low: G.low.toNumber(),
              close: G.close.toNumber(),
              value: G.price.toNumber()
            })).sort((G, lt) => G.time - lt.time),
            tt = I[0].time,
            U = f.value !== i.value ? "interval" : m.value !== s.value ? "type" : O > tt ? "history" : "timer";
          J.setData(I), f.value = i.value, m.value = s.value, d.value = J, u.value = P, U === "history" ? A && P.timeScale().setVisibleRange(A) : U === "timer" ? N && P.timeScale().setVisibleLogicalRange(N) : P.timeScale().fitContent()
        },
        z = $(() => {
          var T;
          if (!((T = t.jettonPnl) != null && T.hasPnL)) return;
          const b = En(t.jettonPnl.pnlAbsoluteUSD, {
              accuracy: 2,
              trim: !0
            }),
            L = eo(t.jettonPnl.pnlPercent);
          return {
            label: `P&L ${b} ${L.formatted}`,
            cls: L.cls
          }
        });
      return zt(() => {
        ...
        !b.container || !b.chart || k(b.chart.points, b.container, b.chartSeriesType)
      }, {
        immediate: !0
      }), zt(c, b => b && j(), {
        immediate: !0
        ...
        const T = le;
        return M(), W("div", Tl, [S("div", Pl, [S("div", {
          class: "section",
          style: Vi({
            "grid-template-columns": `repeat(${v(y).length}, 1fr)`
          })
        }, [(M(!0), W(yt, null, oi(v(y), B => (M(), W("label", {
          key: B.value,
          class: Zt(["item", {
            "is-active": v(s) === B.value
          }])
        }, [je(S("input", {
          "onUpdate:modelValue": L[0] || (L[0] = A => ft(w) ? w.value = A : null),
          type: "radio",
          name: "chart-type",
          value: B.value
        }, null, 8, Vl), [
          [hi, v(w)]
        ]), S("span", Rl, D(B.label), 1)], 2))), 128))], 4), S("div", {
          class: "section",
          style: Vi({
            "grid-template-columns": `repeat(${v(p).length}, 1fr)`
          })
        }, [(M(!0), W(yt, null, oi(v(p), B => (M(), W("label", {
          key: B.value,
          class: Zt(["item", {
            "is-active": v(i) === B.value
          }])
        }, [je(S("input", {
          "onUpdate:modelValue": L[1] || (L[1] = A => ft(_) ? _.value = A : null),
          type: "radio",
          name: "chart-interval",
          value: B.value
        }, null, 8, Il), [
          [hi, v(_)]
        ]), S("span", Wl, D(B.label), 1)], 2))), 128))], 4), S("button", {
          type: "button",
          class: "reset chart-type",
          onClick: L[2] || (L[2] = B => v(l)(v(o) === v(Ot).LINEAR ? v(Ot).CANDLESTICK : v(Ot).LINEAR))
        }, [v(o) === v(Ot).CANDLESTICK ? (M(), V(T, {
          key: 0,
          name: "chart-line",
          class: "icon"
        })) : (M(), V(T, {
          ...
          name: "candle-chart",
          class: "icon"
        }))])]), !v(e) || !v(e).data.points.length ? (M(), W("div", Bl, [L[4] || (L[4] = S("img", {
          src: Ri,
          class: "lines"
        }, null, -1)), L[5] || (L[5] = S("img", {
          src: xn,
          class: "empty"
        }, null, -1)), S("div", Al, [L[3] || (L[3] = S("div", {
          class: "dot"
        }, null, -1)), S("div", Dl, D(("t" in b ? b.t : v(x))("memepad.jetton.chart.coming_text")), 1)])])) : (M(), W("div", Nl, [v(z) ? (M(), W("div", {
          key: 0,
          class: Zt(["pnl-label", v(z).cls])
        }, D(v(z).label), 3)) : St("", !0), S("div", {
          ref_key: "container",
          ref: c,
          style: {
            width: "100%",
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return M(), W(yt, null, [E(h, {
          ...
          default: Y(() => [S("div", Fl, D(("t" in s ? s.t : v(x))("memepad.jetton.unlock.btn")), 1)]),
          _: 1
        }, 8, ["type"]), E(a, {
          modelValue: v(e),
          "onUpdate:modelValue": o[1] || (o[1] = c => ft(e) ? e.value = c : null)
        }, {
          default: Y(() => [S("div", Kl, [S("div", Jl, [E(r, {
            src: v(Ps)(s.jetton.iconFileKey),
            size: 80
          }, null, 8, ["src"])]), S("div", Hl, D(("t" in s ? s.t : v(x))("memepad.jetton.unlock.sheet.title", {
            ticker: s.jetton.ticker
          })), 1), S("div", Xl, D(("t" in s ? s.t : v(x))("memepad.jetton.unlock.sheet.subtitle", {
            ticker: s.jetton.ticker
          })), 1), S("div", Yl, [E(l, {
            jetton: s.jetton,
  ...
  ta = et({
    ...
    setup(n) {
      ...
      return (o, h) => (M(), W("label", {
        class: Zt(["kit-tab", [`is-${v(i).toLowerCase()}`, {
          "is-active": v(s)
        }]])
      }, [S("span", ql, D(n.label), 1), je(S("input", {
  ...
  ia = et({
    ...
    setup(n) {
      ...
      return Pn(Ws, {
        ...
        const h = gn,
          r = Rn("horizontal-wheel-scroll");
        return M(), W("div", {
          class: Zt(["kit-tabs", `is-${n.type.toLowerCase()}`])
        }, [je((M(), W("div", ea, [In(s.$slots, "default", {}, void 0, !0), (M(!0), W(yt, null, oi(v(i), l => (M(), V(h, {
          key: l.value,
          label: l.label,
          value: l.value,
          type: n.type
  ...
  la = et({
    ...
    setup(n) {
      const t = n,
        e = $(() => new Le(t.value.replaceAll(",", "") || "0")),
        i = $(() => t.tradePendings[t.tab]),
        s = $(() => !!(i.value || !t.inputState || t.inputState.loading)),
        o = $(() => s.value ? !1 : !!(e.value.isZero() || !t.inputState || t.inputState.error));
      return (h, r) => {
        var f, m, p, y, _;
        const l = As,
          a = Te,
          ...
          u = Ns,
          d = Bt;
        return M(), W("div", na, [S("div", oa, [h.inputState ? (M(), W(yt, {
          key: 0
          ...
          "total-label": (m = h.inputState.feesInfo) == null ? void 0 : m.totalLabel,
          ...
          class: "skeleton"
        })], 64))]), (_ = (y = h.inputState) == null ? void 0 : y.error) != null && _.notEnoughTon ? (M(), V(u, {
          key: 0,
          "jetton-shortname": h.jetton.shortname,
          "jetton-address": h.jetton.address
        }, null, 8, ["jetton-shortname", "jetton-address"])) : (M(), W(yt, {
          key: 1
        }, [h.tab === v(Q).BUY ? (M(), V(d, {
          key: 0,
          fill: "",
          ...
          loading: v(s),
          disabled: v(o),
          onClick: r[0] || (r[0] = w => h.$emit("trade"))
        }, {
          default: Y(() => [S("div", ha, D(("t" in h ? h.t : v(x))("memepad.jetton.buy_button_label", {
            ticker: h.jetton.ticker
          })), 1)]),
          _: 1
        }, 8, ["size", "type", "loading", "disabled"])) : St("", !0), h.tab === v(Q).SELL ? (M(), V(d, {
          key: 1,
          fill: "",
          size: v(Pt).LARGE,
          type: v(Lt).PINK,
          loading: v(s),
          disabled: v(o),
          onClick: r[1] || (r[1] = w => h.$emit("trade"))
        }, {
          default: Y(() => [S("div", ra, D(("t" in h ? h.t : v(x))("memepad.jetton.sell_button_label", {
            ticker: h.jetton.ticker
          })), 1)]),
          _: 1
        }, 8, ["size", "type", "loading", "disabled"])) : St("", !0)], 64))])
      }
    }
  }),
  aa = ot(la, [
  ...
  ma = et({
    ...
    emits: ri(["trade", "unlock-success", "open-slippage", "close"], ["update:modelValue", "update:tradePendings"]),
    setup(n, {
      emit: t
    }) {
      const e = n,
      ...
      const _ = $(() => {
          if (!(!l.value || l.value.loading)) {
            if (w.value.isZero()) return s.value === Q.BUY ? `0 ${e.jetton.ticker}` : "0 TON";
            if (!l.value.feesInfo || !l.value.ready) return "";
            if (s.value === Q.SELL) {
              const k = l.value.tradeInfo.maxReceive,
                z = `${Ii(k)} TON`;
              if (!e.tonUsdRate) return z;
              const b = Wn(e.tonUsdRate.mul(k));
              return `${z} (≈$${b})`
            } else {
              const k = l.value.tradeInfo.maxReceive;
              return `≈${ze(k,{accuracy:0})} ${e.jetton.ticker}`
            }
          }
        }),
        w = $(() => new Le(f.value.replaceAll(",", "") || "0"));
      let C;
      zt(() => [f.value, e.balances.jettonBalance, e.balances.tonBalance], () => a()), re(() => {
        C == null || C.destroy()
      }), Bs().initHandler(() => {
        i("close")
      ...
      function j() {
        const k = e.jettonTrading.tradeStateControls,
          z = $(() => k.getImmediateState({
            operation: s.value,
            amount: w.value,
            tonBalance: e.balances.tonBalance,
            jettonBalance: e.balances.jettonBalance,
      ...
      function R() {
        ...
        const b = (T, B) => {
          if (z.push({
              amount: T,
              operation: B
            }), z = z.slice(-3), z.length === 3) {
            const A = z.every(O => O.amount.eq(z[0].amount)),
              N = z.every(O => O.operation === z[0].operation);
            A && N && r.disconnect()
          }
        };
        return async () => {
          ...
          await (async () => {
            o.value[T] = !0;
            const I = () => {
                const Et = ci(T === Q.BUY ? A.minReceive : B, N),
                  At = ci(T === Q.BUY ? B : A.minReceive, "TON"),
                  G = T === Q.BUY ? x("memepad.jetton.buy.failed_alert", {
                    askLabel: Et.frontendWithSymbol,
                    offerLabel: At.frontendWithSymbol
              ...
              tt = await (T === Q.BUY ? e.jettonTrading.buyJetton(B, A) : e.jettonTrading.sellJetton(B, A));
            if (tt.err) {
              Bn().error("Memepad jetton trade error", tt.extra), o.value[T] = !1, I(), b(B, T);
              return
            }
            i("trade");
            const U = tt.data;
            C = T === Q.BUY ? e.jettonTrading.getWaitForBuyStatus() : e.jettonTrading.getWaitForSellStatus(), await Ts(2e4);
            const it = await C.exec({
                jettonAddress: P,
                transactionHash: U
              }),
              st = it ? "success" : "failed";
            if (T === Q.BUY ? k.memepad.memepadJettonBuy({
                status: st,
                jettonId: O,
                jettonShortname: J,
                jettonAddress: Z,
                purchaseAmount: B.toNumber()
              }) : k.memepad.memepadJettonSell({
                status: st,
                jettonId: O,
                jettonShortname: J,
                jettonAddress: Z,
            ...
            const at = T === Q.BUY ? x("memepad.jetton.buy.success_alert", {
              ticker: N,
              label: `${Ii(B)} TON`
            }) : x("memepad.jetton.sell.success_alert", {
              label: `${An(B).full} ${N}`
            });
            ke().success(at), o.value[T] = !1, e.tradeSuccessCallback()
          })()
        }
      }
      return (k, z) => {
        ...
        return M(), V(J, {
          ...
          "top-center": Y(() => [E(L, {
            ...
            default: Y(() => [E(b, {
              label: ("t" in k ? k.t : v(x))("memepad.jetton.buy_tab"),
              value: v(Q).BUY,
              type: v(li).PRIMARY,
              class: "buy-tab"
            }, null, 8, ["label", "value", "type"]), E(b, {
              label: ("t" in k ? k.t : v(x))("memepad.jetton.sell_tab"),
              value: v(Q).SELL,
              type: v(li).SECONDARY,
              class: "sell-tab"
          ...
          default: Y(() => [S("div", ca, [(M(), V(T, {
            ref_key: "actionControlsInputComp",
            ref: h,
            key: s.value,
            modelValue: v(p),
            "onUpdate:modelValue": z[1] || (z[1] = I => ft(p) ? p.value = I : null),
            postfix: s.value === "buy" ? "TON" : k.jetton.ticker,
            modifier: m,
            onBlur: u
          }, null, 8, ["modelValue", "postfix"])), S("div", ua, [v(_) ? (M(), W("span", da, D(v(_)), 1)) : v(_) === void 0 ? (M(), V(B, {
            key: 1,
            class: "skeleton"
          })) : St("", !0)]), S("button", {
            type: "button",
            class: "reset slippage-btn",
            onClick: z[2] || (z[2] = I => k.$emit("open-slippage"))
          }, [S("span", fa, D(`${("t"in k?k.t:v(x))("memepad.jetton.slippage_btn")} ${v(d)}%`), 1), E(A, {
            name: "arrow-caret-down",
            class: "icon"
          })])])]),
          "bottom-action": Y(() => [E(Z, {
            "force-loading": k.unlockEnabled === void 0 && k.isReleased || !k.jettonTrading
          }, {
            default: Y(() => [k.unlockEnabled ? (M(), V(N, {
              key: 0,
              jetton: k.jetton,
              "jetton-information": k.jettonInformation,
              balances: k.balances,
              "jetton-management": k.jettonManagement,
              onUnlocked: z[3] || (z[3] = I => k.$emit("unlock-success"))
            }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (M(), V(O, {
              key: 1,
              value: v(f),
              tab: s.value,
              jetton: k.jetton,
          ...
          "bottom-helpers": Y(() => [E(P, {
            modelValue: v(y),
            "onUpdate:modelValue": z[4] || (z[4] = I => ft(y) ? y.value = I : null),
            tab: s.value,
            balances: k.balances
  ...
  Sa = et({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        r = $(() => new Le(h.value.replaceAll(",", "") || "0")),
        l = $(() => r.value.lt(wa) ? x("memepad.jetton.slippage.error_message.too_low") : r.value.gt(ya) ? x("memepad.jetton.slippage.error_message.too_high") : ""),
        a = () => {
          l.value || (e.jettonTrading.updateSlippage(parseFloat(h.value)), i("slippage-updated"))
        };
      return Bs().initHandler(() => {
        i("close")
        ...
        return M(), V(p, {
          ...
          "top-center": Y(() => [S("div", va, D(("t" in c ? c.t : v(x))("memepad.jetton.slippage.title")), 1)]),
          default: Y(() => [S("div", ba, [E(d, {
            ref_key: "actionControlsInputComp",
            ref: s,
            modelValue: v(h),
            "onUpdate:modelValue": u[0] || (u[0] = y => ft(h) ? h.value = y : null),
            postfix: "%",
            modifier: y => ("formatFloatLine" in c ? c.formatFloatLine : v(ze))(y, {
              join: "emptyFractional"
            }),
            onBlur: o
          ...
          "bottom-action": Y(() => [S("div", ga, [v(l) ? (M(), V(f, {
            key: 0,
            "error-message": v(l)
          }, null, 8, ["error-message"])) : (M(), W("div", _a, D(("t" in c ? c.t : v(x))("memepad.jetton.slippage.text")), 1)), E(m, {
            label: ("t" in c ? c.t : v(x))("memepad.jetton.slippage.done_btn"),
            fill: "",
            size: v(Pt).LARGE,
            type: v(l) ? v(Lt).HIGHLIGHT : v(Lt).PRIMARY,
            disabled: !!v(l),
            onClick: a
  ...
  za = et({
    ...
    setup(n, {
      ...
      return (h, r) => {
        const l = Bt;
        return M(), W("div", ka, [E(l, {
          class: "buy-button",
          type: v(Lt).HIGHLIGHT,
          loading: h.tradePendings[v(Q).BUY],
          onClick: s
        }, {
          default: Y(() => [S("span", Ca, D(("t" in h ? h.t : v(x))("memepad.jetton.buy_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"]), E(l, {
          class: "sell-button",
          type: v(Lt).PINK,
          loading: h.tradePendings[v(Q).SELL],
          onClick: o
        }, {
          default: Y(() => [S("span", ja, D(("t" in h ? h.t : v(x))("memepad.jetton.sell_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"])])
      }
    }
    ...
    setup(n, {
      ...
      return (c, u) => {
        const d = Gl,
          ...
          p = La,
          y = wi;
        return M(), W("div", $a, [E(y, {
          "force-loading": c.unlockEnabled === void 0 && c.isReleased || !c.jettonTrading,
          "button-size": v(Pt).MEDIUM
        }, {
          default: Y(() => [c.unlockEnabled ? (M(), V(d, {
            key: 0,
            jetton: c.jetton,
          ...
          }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (M(), W(yt, {
            key: 1
          }, [v(o) === "trade" ? (M(), V(f, {
            key: 0,
            modelValue: v(i),
            "onUpdate:modelValue": u[0] || (u[0] = _ => ft(i) ? i.value = _ : null),
            "trade-pendings": v(s),
            "onUpdate:tradePendings": u[1] || (u[1] = _ => ft(s) ? s.value = _ : null),
            jetton: c.jetton,
            "jetton-information": c.jettonInformation,
            ...
            onOpenSlippage: u[3] || (u[3] = _ => o.value = "slippage"),
            onClose: u[4] || (u[4] = _ => o.value = void 0)
          }, null, 8, ["modelValue", "trade-pendings", "jetton", "jetton-information", "jetton-bcl-data", "balances", "jetton-management", "jetton-trading", "is-released", "unlock-enabled", "ton-usd-rate"])) : St("", !0), v(o) === "slippage" ? (M(), V(m, {
            key: 1,
            "jetton-trading": c.jettonTrading,
            onSlippageUpdated: u[5] || (u[5] = _ => o.value = "trade"),
            onClose: u[6] || (u[6] = _ => o.value = "trade")
          }, null, 8, ["jetton-trading"])) : St("", !0), E(p, {
            "trade-pendings": v(s),
            onClick: h
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return M(), W("div", Ta, [E(h, {
          ...
          jetton: s.jetton,
          "jetton-information": s.jettonInformation
        }, null, 8, ["jetton", "jetton-information"]), E(l, On(Un(v(i))), null, 16), E(a, {
          "jetton-pnl": s.jettonPnl,
          "jetton-shortname": s.jetton.shortname,
          class: "chart"
        }, null, 8, ["jetton-pnl", "jetton-shortname"]), E(c, {
          reactions: s.jettonReactions,
          "update-callback": s.updateJettonReaction,
          type: "trade",
          class: "reactions"
        }, null, 8, ["reactions", "update-callback"]), E(u, {
          jetton: s.jetton,
          "jetton-information": s.jettonInformation,
          "is-released": s.isReleased,
  ...
  Ga = et({
    ...
    setup(n) {
      const t = Fn(),
        ...
        d = Jn(),
        f = Hn().status,
        m = Xn().getters.getUser,
        {
          jettonBclData: p,
          jettonBalance: y,
          jettonUnlockEnabled: _,
          jettonPnl: w,
          ...C
        } = B(),
        {
        ...
        k = async () => {
          ...
          if (!e.value || !s || s.value.status === ue.IN_PROGRESS) return {
            status: "loading"
          };
          const A = e.value.address,
            N = [ue.PUBLISHED_ON_DEX, ue.LISTED_TO_DEX].includes(s.value.status),
            O = {
              jettonBalance: y.value ? ci(y.value, e.value.ticker) : void 0,
              tonBalance: d.wallet.value.status === "connected" ? (I = d.wallet.value.balance) == null ? void 0 : I.tonBalance.balance : void 0
            },
            Z = Yn(Zn, {
            ...
            J = (() => {
              var U;
              if (!N) return c(A, Z);
              const tt = (U = m.value) == null ? void 0 : U.referrerToken;
              return u({
                jettonAddress: A,
                referrerToken: tt
              })
            })();
          return s.value.status === ue.LISTED_TO_DEX ? {
            status: "moving_to_dex",
            jetton: e.value,
            jettonInformation: s.value,
            isReleased: !0,
            unlockEnabled: _.value,
            balances: O,
            jettonManagement: P,
            jettonTrading: J
          } : {
      ...
      no($(() => b.value.status === "moving_to_dex"), "memepad-jetton-trade-status");
      const L = () => {
          C.init(), j.init()
        },
        T = () => {
      ...
      function B() {
        const A = K(),
          ...
          O = K(),
          Z = K();
        let P, J, I, tt, U, it, st, at;

        function Et() {
          J = zt(b, H => {
            H.status === "loading" || P || H.jettonManagement && (J == null || J(), P = de(async () => {
              if (b.value.status === "loading") return dt(void 0);
              const X = b.value.jetton.address,
                ut = await b.value.jettonManagement.getJettonBclData(X);
              return dt((jt(ut) ? ut.data : A.value) || A.value)
            }, X => A.value = X, 6e4), P == null || P.exec())
          }, {
            immediate: !0
          }), tt = zt(b, H => {
            H.status === "loading" || I || !H.jettonTrading || f.value !== "connected" || (tt == null || tt(), I = de(async () => {
              if (b.value.status === "loading" || !b.value.jettonTrading || f.value !== "connected") return dt(void 0);
              const X = b.value.jetton.address,
                ut = await b.value.jettonTrading.getUserJettonBalance(X);
              return dt((jt(ut) ? ut.data : N.value) || N.value)
            }, X => N.value = X, 6e4), I == null || I.exec())
          }, {
            immediate: !0
          }), it = zt(b, H => {
            H.status === "loading" || U || !H.jetton || !H.balances.jettonBalance || !H.isReleased || f.value !== "connected" || (it == null || it(), U = de(async () => {
              ...
              const X = await b.value.jettonManagement.getUnlockEnabled(b.value.jetton.address);
              return dt(jt(X) ? X.data : O.value)
            }, X => O.value = X, 6e4), U == null || U.exec())
          }, {
            immediate: !0
          }), at = zt(b, H => {
            H.status === "loading" || st || d.wallet.value.status === "connected" && (at == null || at(), st = de(async () => {
              if (b.value.status === "loading" || d.wallet.value.status !== "connected") return dt(void 0);
              const X = b.value.jetton.shortname,
                ut = d.wallet.value.address.default,
                Mt = await Ce.getMemepadJettonPnl(X, ut);
              return dt((jt(Mt) ? Mt.data : Z.value) || Z.value)
            }, X => Z.value = X, 6e4), st == null || st.exec())
          }, {
            immediate: !0
          })
        }
        return {
          init: Et,
          destroy: () => {
            J == null || J(), P == null || P.destroy(), tt == null || tt(), I == null || I.destroy(), it == null || it(), U == null || U.destroy(), at == null || at(), st == null || st.destroy(), A.value = void 0, N.value = void 0, O.value = void 0, Z.value = void 0
          },
          update: async () => {
            await (P == null ? void 0 : P.exec()), await (I == null ? void 0 : I.exec()), await (U == null ? void 0 : U.exec()), st == null || st.exec()
          },
          resetAndUpdateUnlocked: async () => {
            O.value = void 0, await (U == null ? void 0 : U.exec())
          },
          jettonBclData: $(() => A.value),
          jettonBalance: $(() => N.value),
          jettonUnlockEnabled: $(() => O.value),
          jettonPnl: $(() => Z.value)
        }
      }
      return (A, N) => {
        const O = yn,
          Z = _o,
          P = Va;
        return v(b).status === "loading" ? (M(), V(O, {
          key: 0
        })) : v(b).status === "moving_to_dex" ? (M(), V(Z, {
          key: 1,
          jetton: v(b).jetton,
          "jetton-information": v(b).jettonInformation,
          "unlock-enabled": v(b).unlockEnabled,
          balances: v(b).balances,
          "jetton-management": v(b).jettonManagement,
          "is-released": ""
        }, null, 8, ["jetton", "jetton-information", "unlock-enabled", "balances", "jetton-management"])) : (M(), V(P, {
          key: 2,
          jetton: v(b).jetton,
          "jetton-information": v(b).jettonInformation,
          "jetton-bcl-data": v(b).jettonBclData,
          "jetton-pnl": v(b).jettonPnl,
          "chart-market-cap": v(R),
          "jetton-reactions": v(b).jettonReactions,
          "update-jetton-reaction": v(b).updateJettonReaction,
          "is-released": v(b).isReleased,
          "unlock-enabled": v(b).unlockEnabled,
          "jetton-management": v(b).jettonManagement,
          "jetton-trading": v(b).jettonTrading,
          balances: v(b).balances,
          "ton-usd-rate": v(l),
          onTradeSuccess: k,
          onUnlockSuccess: z,
          onShare: N[0] || (N[0] = J => A.$emit("share", "trade")),
          onCopy: N[1] || (N[1] = J => A.$emit("copy", "trade"))
