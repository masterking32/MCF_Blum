    ...
    setup(C) {
      ...
      return (e, p) => {
        ...
        return t(), l("div", je, [e.isReleased ? g("", !0) : (t(), l("div", Ie, [o("div", Ve, [o("div", Ue, [e.total !== void 0 && e.collected !== void 0 || e.percent ? (t(), l(w, {
          ...
          accuracy: 0
        }).full), 1)) : (t(), l("span", Ke, "—"))]), o("div", Ge, [U(r, {
          name: "transfer",
          class: "icon"
        }), e.marketDetails.statistics.transactionsCount ? (t(), l("span", qe, b(("formatCount" in e ? e.formatCount : u(V))(e.marketDetails.statistics.transactionsCount, {
          accuracy: 0
        }).full), 1)) : (t(), l("span", Ye, "—"))]), o("div", Ze, [e.marketDetails.statistics.marketCap ? (t(), l(w, {
          key: 0
        }, [o("span", He, b(("t" in e ? e.t : u($))("memepad.jetton.stats.market_cap")), 1), o("span", Xe, b(`$${("formatCount"in e?e.formatCount:u(V))(e.marketDetails.statistics.marketCap).full}`), 1)], 64)) : (t(), l("span", Je, "—"))])])) : (t(), S(_, {
          key: 1,
  ...
  bt = D({
    ...
    setup(C, {
      ...
      const m = C,
          ...
          for (let h = 0; h <= X; h++) {
            ...
            for (let A = 0; A < c.length - 1; A++)
              if (d > c[A] && d < c[A + 1]) {
                ...
                const R = a[k],
                  Z = a[O];
                N = "value" in R ? R.value : R.percent, B = "value" in Z ? Z.value : Z.percent;
                break
        ...
        G = a => L.value.find(c => Math.abs(Number(c.percent) - a) < 4 && !c.isFirst),
        v = a => {
          var c;
          if (m.tab === z.BUY) {
