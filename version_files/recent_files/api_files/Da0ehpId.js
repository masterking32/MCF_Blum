...
const _e = {
    ...
    setup(_) {
      ...
      return (o, a) => {
        ...
        return s(), r("div", {
          ...
          name: "edit-copy",
          class: "icon"
        })])), i(l) ? (s(), r("div", $e, v(i(l)), 1)) : B("", !0)]), d("div", be, [d("div", Ce, v(i(m)), 1), d("div", Pe, v(i(n)), 1)])], 2)
      }
    }
  }),
  Le = w(ge, [
  ...
  Ae = L({
    ...
    setup(_) {
      return (t, l) => {
        const m = Le;
        return s(), r("div", we, [(s(!0), r(U, null, O(t.items, n => (s(), V(m, Q({
    ...
    setup(_) {
      ...
      return (o, a) => {
        ...
        return s(), r("div", je, [d("div", He, [(f = o.user) != null && f.avatarUrl ? (s(), r("img", {
          ...
          type: "button",
          onClick: a[1] || (a[1] = k => u())
        }, [d("div", Oe, v(i(c)), 1), h(p, {
          name: "edit-copy",
          class: "icon"
        })])), i(l) ? (s(), r("div", Re, v(i(l)), 1)) : B("", !0)]), d("div", Te, [d("div", Ee, v(i(m)), 1), d("div", Fe, v(i(n)), 1)])])
      }
    }
  }),
  Ye = w(De, [
  ...
  Ne = L({
    ...
    setup(_) {
      return (t, l) => {
        const m = Ye;
        return s(), r("div", Je, [(s(!0), r(U, null, O(t.items, n => (s(), V(m, Q({
          key: n.holder.address,
          ref_for: !0
        }, n), null, 16))), 128))])
      }
    ...
    return {
      getHoldersInfo: n => {
        ...
        const o = y(() => {
          ...
          const R = new g(100).minus(k).minus((P == null ? void 0 : P.holder.percent) ?? 0);
          return M.push({
            title: "",
            color: "#7C3EC3",
            label: `${q(R,{accuracy:2,trim:!0})}%`,
            percent: R,
            inChartOnly: !0
          }), {
            isRiskHolder: j,
