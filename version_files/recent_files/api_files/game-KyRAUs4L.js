(function() {
  ...
  function y(n, e) {
    return n = n >>> 0, I.decode(m().subarray(n, n + e))
  }
...
${n.stack}` : r
  ...
  function M(n, e) {
    return c = n.exports, T.__wbindgen_wasm_module = e, a = null, w = null, c.__wbindgen_start(), c
  }
  async function T(n) {
    if (c !== void 0) return c;
    typeof n < "u" && (Object.getPrototypeOf(n) === Object.prototype ? {
      module_or_path: n
    } = n : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), typeof n > "u" && (n = new URL("" + new URL("game_wasm_bg-Bhvqx7ea.wasm", self.location.href).href, self.location.href));
    const e = k();
