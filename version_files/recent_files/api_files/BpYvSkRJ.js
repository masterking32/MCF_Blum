...
(function(o, l) {
  ...
  function k(e, t) {
    if ((0, h.default)(e), t = (0, n.default)(t, f), t.require_display_name || t.allow_display_name) {
      ...
      if (_) {
        var p = _[1];
        if (e = e.replace(p, "").replace(/(^<|>$)/g, ""), p.endsWith(" ") && (p = p.slice(0, -1)), !E(p)) return !1
    ...
    var b = e.split("@"),
      F = b.pop(),
      $ = F.toLowerCase();
    if (t.host_blacklist.includes($) || t.host_whitelist.length > 0 && !t.host_whitelist.includes($)) return !1;
    var g = b.join("@");
    if (t.domain_specific_validation && ($ === "gmail.com" || $ === "googlemail.com")) {
      g = g.toLowerCase();
      var d = g.split("+")[0];
    ...
    for (var N = t.allow_utf8_local_part ? w : m, B = g.split("."), R = 0; R < B.length; R++)
      if (!N.test(B[R])) return !1;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function a(e, t) {
    if (!(typeof Symbol > "u" || !(Symbol.iterator in Object(e)))) {
      var _ = [],
        ...
        F = void 0;
      try {
        for (var $ = e[Symbol.iterator](), g; !(p = (g = $.next()).done) && (_.push(g.value), !(t && _.length === t)); p = !0);
      } catch (d) {
        b = !0, F = d
      } finally {
        try {
  ...
  function k(e, t) {
    ...
    if (R ? (b = "", A = R[1], g = R[2] || null) : (d = F.split(":"), b = d.shift(), d.length && (g = d.join(":"))), g !== null && g.length > 0) {
      if ($ = parseInt(g, 10), !/^[0-9]+$/.test(g) || $ <= 0 || $ > 65535) return !1
    } else if (t.require_port) return !1;
    return t.host_whitelist ? E(b, t.host_whitelist) : b === "" && !t.require_host ? !0 : !(!(0, i.default)(b) && !(0, v.default)(b, t) && (!A || !(0, i.default)(A, 6)) || (b = b || A, t.host_blacklist && E(b, t.host_blacklist)))
  }
  o.exports = l.default, o.exports.default = l.default
})(J, J.exports);
var Ae = J.exports;
...
const De = {
  ...
  Be = Z({
    ...
    setup(o) {
      ...
      return (r, f) => (S(), V("div", De, [q(h) ? (S(), V("div", Te, [T(r.$slots, "header", {}, void 0, !0)])) : C("", !0), q(v) ? (S(), V("div", Le, [T(r.$slots, "title", {}, void 0, !0)])) : C("", !0), q(i) ? (S(), V("div", Pe, [T(r.$slots, "subTitle", {}, void 0, !0)])) : C("", !0), q(u) ? (S(), V("div", Ue, [T(r.$slots, "footer", {}, void 0, !0)])) : C("", !0)]))
    }
  }),
  Qe = Y(Be, [
    ["__scopeId", "data-v-a6692220"]
  ]),
  Me = ["for"],
  Oe = {
    key: 0,
  ...
  Ne = Z({
    ...
    setup(o, {
      ...
      return se(u, () => {
        ...
        }, null, 8, ["title", "is-optional"]), c.errorCaption ? (S(), V("div", Oe, [s[3] || (s[3] = M("img", {
          src: de,
          alt: "Warning icon"
        }, null, -1)), M("div", null, _e(c.errorCaption), 1)])) : c.maxLength ? (S(), H(k, {
          key: 1,
          value: u.value,
          "max-length": c.maxLength
        }, null, 8, ["value", "max-length"])) : C("", !0)], 8, Me)) : C("", !0), M("div", {
          class: "wrapper",
          onClick: m
        }, [ve(M("textarea", {
          id: q(i),
...
const Ge = Z({
    ...
    setup(o, {
      ...
      const u = () => {},
        ...
        r = D(() => v.value.every(a => f(a).length === 0));
          ...
          switch (a.type) {
            ...
            case I.TEXTAREA: {
              ...
              if (a.type === I.STRING && ((s = a.validators) != null && s.url)) {
                const e = a.validators.url.includePrefix && ((E = a.props) != null && E.prefix) ? `${a.props.prefix}${a.value}` : a.value;
                Ie(e) || x.push({
      ...
      return re(() => h("channel", {
        ...
        }, [(S(!0), V(xe, null, ye(v.value, s => {
          var E, k, e, t, _, p, b, F, $, g;
          return S(), V("div", {
            key: s.key,
            class: "field"
          }, [s.type === q(I).STRING ? (S(), H(w, ae({
            key: 0,
            modelValue: s.value,
            ...
            "error-caption": y(s),
            "is-error": m(s),
            "max-length": (k = (E = s.validators) == null ? void 0 : E.maxLength) == null ? void 0 : k.value,
            class: "input",
            onChange: d => n(s),
            ...
            label: be(() => [T(a.$slots, `${s.key}-label`, {}, void 0, !0)]),
            _: 2
          }, 1040, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur", "onClick"])) : C("", !0), s.type === q(I).TEXTAREA ? (S(), H(c, ae({
            key: 1,
            modelValue: s.value,
            "onUpdate:modelValue": d => s.value = d,
            ref_for: !0
            ...
            onBlur: ($ = s.eventHandlers) == null ? void 0 : $.onBlur,
            onClick: (g = s.eventHandlers) == null ? void 0 : g.onClick
          }), null, 16, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur", "onClick"])) : C("", !0), T(a.$slots, `${s.key}-after`, {}, void 0, !0)])
        }), 128))], 32)
      }
    }
  }),
