...
const qn = {
  ...
  eo = it({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        c = async () => {
          if (u.value) return;
          const d = () => _e().error($("memepad.jetton.unlock.failed_alert", {
              ticker: e.jetton.ticker
            })),
            m = () => {
              a.value.push(e.jetton.address), a.value = a.value.slice(-3), a.value.length === 3 && a.value.every(C => C === a.value[0]) && (h.disconnect(), a.value = [])
            },
            f = _ => {
          ...
          await Ls(2e4), await l.exec(p.data) ? (f("success"), s("unlocked"), _e().success($("memepad.jetton.unlock.success_alert", {
            ticker: e.jetton.ticker
      ...
      return se(() => {
        ...
        const f = Rs,
          ...
          _ = Ws,
          C = It;
        return S(), x("div", qn, [y("div", Qn, [v(i).balanceLabel ? (S(), P(f, {
          key: 0,
          balance: v(i).balanceLabel
        }, null, 8, ["balance"])) : (S(), P(p, {
          key: 1,
          class: "skeleton"
        })), v(i).feesInfo ? (S(), P(g, {
          key: 2,
        ...
        }, null, 8, ["details", "total-label", "error-message"])) : (S(), P(p, {
          key: 3,
          class: "skeleton"
        }))]), (j = v(i).error) != null && j.notEnoughTon ? (S(), P(_, {
          key: 0,
          "jetton-shortname": d.jetton.shortname,
          "jetton-address": d.jetton.address
        }, null, 8, ["jetton-shortname", "jetton-address"])) : (S(), P(C, {
          key: 1,
          fill: "",
          icon: "lock-open",
          "icon-align": "left",
          ...
          default: Y(() => [y("div", to, I(("t" in d ? d.t : v($))("memepad.jetton.unlock_btn", {
    ...
    setup(n) {
      ...
      return (i, s) => {
        const o = pn,
          ...
          u = Fn,
          d = gn;
        return S(), x("div", io, [E(o), y("div", so, [y("div", no, [E(h, {
          size: 342,
          name: "animations/Clover",
          class: "animation"
        }), E(r, {
          src: v(Es)(i.jetton.iconFileKey),
          size: 80
        }, null, 8, ["src"])]), y("div", oo, I(("t" in i ? i.t : v($))("memepad.moving_to_dex.title")), 1), y("div", ho, I(("t" in i ? i.t : v($))("memepad.moving_to_dex.subtitle", {
          ticker: i.jetton.ticker
        })), 1)]), E(u, null, {
          default: Y(() => [y("div", ro, [E(c, {
            "force-loading": i.unlockEnabled === void 0 && i.isReleased
          }, {
            default: Y(() => [i.unlockEnabled ? (S(), P(l, {
              key: 0,
              jetton: i.jetton,
            ...
            }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (S(), P(a, {
              key: 1,
              label: ("t" in i ? i.t : v($))("memepad.jetton.share_token_link"),
              fill: "",
              size: v(xt).LARGE,
          ...
          modelValue: v(e),
          "onUpdate:modelValue": s[2] || (s[2] = m => ft(e) ? e.value = m : null),
  ...
  yo = it({
    ...
    setup(n) {
      const t = n,
        e = z(() => {
          const s = Qe(t.jetton.releaseTimestamp).label;
          return t.isReleased ? `${s} • STON.fi` : s
        }),
        i = () => xs().copy(t.jetton.address);
      return (s, o) => {
        const h = Kn,
          r = je;
        return S(), x("div", co, [y("div", uo, [E(h, {
          "jetton-modal-controls": s.jettonModalControls,
          jetton: s.jetton
        }, null, 8, ["jetton-modal-controls", "jetton"]), y("div", fo, [y("div", mo, [y("div", po, I(s.jetton.ticker), 1), s.jettonInformation.stream.online ? (S(), x("div", vo, o[1] || (o[1] = [y("div", {
          class: "dot"
        }, null, -1)]))) : St("", !0), s.jettonInformation.inSpotlight ? (S(), x("div", bo, [E(r, {
          name: "fire",
          class: "icon"
        }), o[2] || (o[2] = y("span", {
          class: "label"
        }, "Spotlight", -1))])) : St("", !0)]), y("div", go, I(v(e)), 1)])]), y("div", _o, [y("button", {
          type: "button",
          class: "reset copy",
          onClick: i
        }, [E(r, {
          name: "edit-copy",
          class: "icon"
        }), y("span", wo, I(("sliceWalletAddress" in s ? s.sliceWalletAddress : v(_n))(s.jetton.address, 3)), 1)]), y("button", {
          type: "button",
          class: "reset share",
  ...
  To = it({
    ...
    setup(n) {
      const t = n,
        ...
        r = Mo(t.stream.startAt, "hms");
      return (l, a) => {
        const c = je;
        return S(), x("div", Co, [y("iframe", {
          ref_key: "player",
          ref: e,
        ...
        }, null, 8, ko), a[2] || (a[2] = y("div", {
          class: "bg"
        }, null, -1)), y("div", jo, [y("div", zo, [E(c, {
          name: "user-voice",
          class: "icon"
        }), y("span", Lo, I(l.stream.viewers), 1)]), y("div", Eo, [E(c, {
          name: "calendar-clock",
          class: "icon"
        }), y("span", $o, I(v(r).label), 1)])]), y("div", xo, [y("button", {
          type: "button",
    ...
    setup(n) {
      const t = n,
        ...
        i = async () => {
          ...
          if (!Ct(h)) throw mi("Failed to generate stream key");
          e.value = {
            status: "loaded",
            streamKey: h.data
          }
        ...
        }), o = () => Ts().$webApp.openLink("https://www.blum.io/post/videostream-quick-start-guide");
      return (h, r) => {
        const l = je,
          a = ze,
          c = It,
          u = Ps;
        return S(), x("div", Vo, [y("button", {
          type: "button",
          class: "reset button",
          onClick: i
        }, I(("t" in h ? h.t : v($))("memepad.jetton.start_stream_button")), 1), E(u, {
          modelValue: v(s),
          "onUpdate:modelValue": r[1] || (r[1] = d => ft(s) ? s.value = d : null)
        }, {
          default: Y(() => [y("div", Ro, [y("div", Io, I(("t" in h ? h.t : v($))("memepad.jetton.steam.start_sheet.title")), 1), y("div", Wo, I(("t" in h ? h.t : v($))("memepad.jetton.steam.start_sheet.subtitle")), 1), y("div", Bo, [v(e).status === "loaded" ? (S(), x("button", {
            key: 0,
            type: "button",
            class: "reset",
            onClick: r[0] || (r[0] = d => ("useCopy" in h ? h.useCopy : v(xs))().copy(v(e).streamKey))
          }, [y("div", Ao, I(v(e).streamKey), 1), E(l, {
            name: "edit-copy",
            class: "icon"
          })])) : (S(), P(a, {
            key: 1,
            ...
            label: ("t" in h ? h.t : v($))("memepad.jetton.stream.how.title"),
            fill: "",
            type: v(jt).SECONDARY,
            size: v(xt).LARGE,
            onClick: o
    ...
    setup(n) {
      const t = n,
        ...
        i = async () => {
          ...
          const s = await ti.getMemepadStreamKey(t.jetton.shortname);
          if (!Ct(s)) return s;
          const o = s.data.stream.key;
          if (!o) throw mi("Failed to generate stream key");
          return at(o)
        };
      return (s, o) => {
        const h = Po,
          r = No;
        return s.jettonInformation.stream.online ? (S(), x(yt, {
          key: 0
        }, [v(e) ? (S(), x("button", {
          key: 0,
          type: "button",
          class: "reset memepad-jetton-stream-show-button",
          onClick: o[0] || (o[0] = l => e.value = !1)
        }, I(("t" in s ? s.t : v($))("memepad.jetton.show_stream_button")), 1)) : (S(), P(h, {
          key: 1,
          stream: s.jettonInformation.stream,
          onHide: o[1] || (o[1] = l => e.value = !0)
        }, null, 8, ["stream"]))], 64)) : s.jettonInformation.stream.creator ? (S(), P(r, {
          key: 1,
...
var Jo = function() {
  ...
  return n.prototype.dispose = function() {
    ...
    $t(e, t) || (this.canvasElement.width = t.width, this.canvasElement.height = t.height, this._emitBitmapSizeChanged(e, t))
    ...
    var e = this._suggestedBitmapSize,
      ...
      s = $t(this.bitmapSize, i) ? null : i;
    e === null && s === null || e !== null && s !== null && $t(e, s) || (this._suggestedBitmapSize = s, this._emitSuggestedBitmapSizeChanged(e, s))
    ...
    if (this._canvasElement !== null) {
      var e = Pi(this._canvasElement);
      if (e === null) throw new Error("No window is associated with the canvas");
      this._devicePixelRatioObservable = Ko(e), this._devicePixelRatioObservable.subscribe(function() {
...
function Xo(n, t) {
  if (t.type === "device-pixel-content-box") return new Jo(n, t.transform, t.options);
...
function Tt(n, t) {
  ...
  return s === null ? null : new Go(s, e, i)
}
/*!
 * @license
...
const sh = /^#([0-9a-f])([0-9a-f])([0-9a-f])([0-9a-f])?$/i,
  nh = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?$/i,
  oh = /^rgb\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*\)$/,
  hh = /^rgba\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d*\.?\d+)\s*\)$/;

function qt(n) {
  (n = n.toLowerCase()) in Ri && (n = Ri[n]);
  {
    const t = hh.exec(n) || oh.exec(n);
    if (t) return [ut(parseInt(t[1], 10)), ut(parseInt(t[2], 10)), ut(parseInt(t[3], 10)), Us(t.length < 5 ? 1 : parseFloat(t[4]))]
  } {
    const t = nh.exec(n);
    if (t) return [ut(parseInt(t[1], 16)), ut(parseInt(t[2], 16)), ut(parseInt(t[3], 16)), 1]
  } {
    const t = sh.exec(n);
    if (t) return [ut(17 * parseInt(t[1], 16)), ut(17 * parseInt(t[2], 16)), ut(17 * parseInt(t[3], 16)), 1]
  }
...
const bi = "-apple-system, BlinkMacSystemFont, 'Trebuchet MS', Roboto, Ubuntu, sans-serif";

function Ot(n, t, e) {
  return t === void 0 && (t = bi), `${e=e!==void 0?`${e} `:""}${n}px ${t}`
}
class lh {
  constructor(t) {
    this.k = {
...
class dh {
  constructor(t, e) {
    this.ut = new gi, this.ct = [], this.dt = [], this.ft = !0, this.F = t, this.vt = e, this.ut.Z(this.ct)
  }
  bt(t) {
    const e = this.F.wt();
    e.length !== this.ct.length && (this.dt = e.map(ch), this.ct = this.dt.map(i => {
      const s = new ah;
      return s.J(i), s
  ...
  Mt() {
    ...
    e.forEach((o, h) => {
      ...
      const c = b(o.Ct());
      l.lt = a.Tt, l.ht = a.ht, l.et = a.Pt, l.it[0]._t = a._t, l.it[0].st = o.Dt().Rt(a._t, c.Vt), l.rt = (r = a.Ot) !== null && r !== void 0 ? r : this.F.Bt(l.it[0].st / o.Dt().At()), l.it[0].ot = i, l.it[0].nt = s.It(i), l.tt = uh
    })
  }
}
class fh extends pt {
  ...
  K({
    ...
    t.lineCap = "butt", o && r >= 0 && (t.lineWidth = Math.floor(this.zt.Lt.et * i), t.strokeStyle = this.zt.Lt.V, t.fillStyle = this.zt.Lt.V, Pt(t, this.zt.Lt.Nt), function(a, c, u, d) {
      a.beginPath();
      const m = a.lineWidth % 2 ? .5 : 0;
      a.moveTo(c + m, u), a.lineTo(c + m, d), a.stroke()
    }(t, r, 0, e.height)), h && l >= 0 && (t.lineWidth = Math.floor(this.zt.Et.et * s), t.strokeStyle = this.zt.Et.V, t.fillStyle = this.zt.Et.V, Pt(t, this.zt.Et.Nt), Os(t, l, 0, e.width))
  }
}
class mh {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      nt: 0,
      st: 0
    }, this.Wt = new fh(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
...
function Wi(n, t, e, i, s, o, h = 0, r = [0, 0, 0, 0], l = "") {
  if (n.save(), !h || !l || l === o) return Ii(n, t, e, i, s, r), n.fillStyle = o, n.fill(), void n.restore();
  const a = h / 2;
  var c;
  Ii(n, t + a, e + a, i - h, s - h, (c = -a, r.map(u => u === 0 ? u : u + c))), o !== "transparent" && (n.fillStyle = o, n.fill()), l !== "transparent" && (n.lineWidth = h, n.strokeStyle = l, n.closePath(), n.stroke()), n.restore()
}

function Ks(n, t, e, i, s, o, h) {
...
class Bi {
    ...
    const o = this.zt.V,
      ...
      r = t.useBitmapCoordinateSpace(l => {
        ...
        const c = this.Gt(l, e, i, s),
          u = c.Jt;
        return c.Qt ? Wi(a, u.ti, u.ii, u.ni, u.si, h, u.ei, [u.ht, 0, 0, u.ht], h) : Wi(a, u.ri, u.ii, u.ni, u.si, h, u.ei, [0, u.ht, u.ht, 0], h), this.zt.hi && (a.fillStyle = o, a.fillRect(u.ri, u.li, u.ai - u.ri, u.oi)), this.zt._i && (a.fillStyle = e.O, a.fillRect(c.Qt ? u.ui - u.ei : 0, u.ii, u.ei, u.ci - u.ii)), c
      });
  ...
  Gt(t, e, i, s) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, m = e.L + this.Xt.wi, f = e.B + this.Xt.gi, p = e.A, g = e.I, _ = this.zt.Kt, C = e.P, L = i.Mi(h, _), j = Math.ceil(i.xi(h, _)), U = C + m + f, M = e.C + p + g + j + u, k = Math.max(1, Math.floor(c));
    let T = Math.round(U * c);
    T % 2 != k % 2 && (T += 1);
    const D = d > 0 ? Math.max(1, Math.floor(d * a)) : 0,
      w = Math.round(M * a),
      W = Math.round(u * a),
      G = (o = this.Xt.Si) !== null && o !== void 0 ? o : this.Xt.ki,
      rt = Math.round(G * c) - Math.floor(.5 * c),
      Z = Math.floor(rt + k / 2 - T / 2),
      V = Z + T,
      B = s === "right",
      F = B ? l.width - d : d,
      R = B ? r.width - D : D;
    let N, q, K;
    return B ? (N = R - w, q = R - W, K = F - u - p - d) : (N = R + w, q = R + W, K = F + u + p), {
      Qt: B,
      Jt: {
        ii: Z,
        li: rt,
...
class $e {
  constructor(t) {
    this.yi = {
      ...
      _i: !0,
      bi: !0
    }, this.ft = !0, this.Pi = new(t || Bi)(this.Ci, this.yi), this.Ri = new(t || Bi)(this.Ti, this.yi)
  }
  Kt() {
...
class vh extends $e {
  ...
  zi(t, e, i) {
    ...
    const h = Le(s.labelBackgroundColor);
    i.t = h.t, t.V = h.i;
...
class Js {
  ...
  X(t, e) {
    ...
    const i = t.useMediaCoordinateSpace(({
      context: d
    }) => (d.font = e.R, Math.round(e.Wi.xi(d, b(this.zt).Kt, bh))));
    if (i <= 0) return;
    const s = e.ji,
      o = i + 2 * s,
      h = o / 2,
    ...
    t.useBitmapCoordinateSpace(({
      ...
      const g = Math.round(a * m),
        ...
        L = Math.round(u * f),
        j = Math.round(2 * m);
      if (d.beginPath(), d.moveTo(g, _), d.lineTo(g, L - j), d.arcTo(g, L, g + j, L, j), d.lineTo(C - j, L), d.arcTo(C, L, C, L - j, j), d.lineTo(C, _), d.fill(), p.hi) {
        const U = Math.round(p.ki * m),
          M = _,
          k = Math.round((M + e.T) * f);
        d.fillStyle = p.V;
        const T = Math.max(1, Math.floor(m)),
          D = Math.floor(.5 * m);
        d.fillRect(U - D, M, T, k - M)
      }
    }), t.useMediaCoordinateSpace(({
      context: d
    }) => {
...
class gh {
  constructor(t, e, i) {
    this.ft = !0, this.Wt = new Js, this.Ft = {
      yt: !1,
      t: "#4c525e",
      V: "white",
      Kt: "",
  ...
  Mt() {
    ...
    const h = Le(e.labelBackgroundColor);
...
class _h extends _i {
  constructor(t, e) {
    super(), this.tn = null, this.nn = NaN, this.sn = 0, this.en = !0, this.rn = new Map, this.hn = !1, this.ln = NaN, this.an = NaN, this._n = NaN, this.un = NaN, this.$i = t, this.cn = e, this.dn = new dh(t, this), this.fn = ((s, o) => h => {
      const r = o(),
        l = s();
    ...
    this.bn = new gh(this, t, i), this.wn = new mh(this)
  }
  W() {
    return this.cn
  }
  ...
  Tn() {
    const t = this.$i.wt().map(i => i.In().An()).filter(rh),
      e = t.length === 0 ? null : Math.max(...t);
    this.sn = e !== null ? e : NaN
  }
  Dn(t, e, i) {
    let s = t.get(e);
    return s === void 0 && (s = new vh(this, e, i), t.set(e, s)), s
  }
}
...
class Te {
  constructor(t, e) {
    if (e || (e = 1), gt(t) && Qt(t) || (t = 100), t < 0) throw new TypeError("invalid base");
  ...
  ls(t) {
    ...
    if (e > 1) {
      ...
      h >= e && (h -= e, i += 1), s = Ai + wt(+h.toFixed(this.os) * this.rs, o)
    } else i = Math.round(i * e) / e, o > 0 && (s = Ai + wt(0, o));
    ...
    for (let p = i.from + 1; p < i.to; ++p) {
      ...
      switch (e) {
        ...
        case 1:
          ...
          break;
        case 2: {
          const [_, C] = yh(t, p - 1, p);
          r.bezierCurveTo(_.nt * l, _.st * a, C.nt * l, C.st * a, f.nt * l, f.st * a);
          break
        }
      }
...
function yh(n, t, e) {
  ...
  var o, h;
  return [(o = n[t], h = Ni(Ve(n[e], n[i]), Di), {
    nt: o.nt + h.nt,
    st: o.st + h.st
  }), Ve(n[e], Ni(Ve(n[s], n[t]), Di))]
}
...
class Ys extends pt {
  ...
  K(t) {
    ...
    if (s === null) return;
    const c = t.context;
    c.lineCap = "butt", c.lineJoin = "round", c.lineWidth = h, Pt(c, r), c.lineWidth = 1, Hs(t, i, l, s, o, this.ps.bind(this), Sh.bind(null, a))
  }
}
  ...
  bs(t, e) {
    ...
    if (this.ys === void 0 || i === void 0 || i.gs !== s || i.Ms !== o || i.xs !== h || i.Ss !== r || i.fs !== a || i.ks !== l) {
      ...
      if (c.addColorStop(0, s), a != null) {
        const u = li(a * t.verticalPixelRatio / l, 0, 1);
...
class Mh extends Ys {
  constructor() {
    super(...arguments), this.Cs = new wi
  }
  ps(t, e) {
    return this.Cs.bs(t, {
      gs: e.Ts,
...
class Zs extends pt {
  ...
  K(t) {
    ...
    o !== void 0 && Hs(t, e, o, i, s, c, Ch), l && function(u, d, m, f, p) {
      const {
      ...
      for (let M = f.to - 1; M >= f.from; --M) {
        ...
        if (k) {
          const T = p(u, k);
          T !== L && (C.beginPath(), L !== null && C.fill(), C.fillStyle = T, L = T);
          const D = Math.round(k.nt * g) + j,
            w = k.st * _;
          C.moveTo(D, w), C.arc(D, w, U, 0, 2 * Math.PI)
        }
      }
      C.fill()
    }(t, e, l, i, c)
...
class yi {
  ...
  Ys() {
    ...
    const s = this.Ls.Ct();
    s !== null && (this.zs = en(this.Is, i, this.Ns), this.Ks(t, e, s.Vt), this.Gs())
  }
}
class Pe extends yi {
  constructor(t, e) {
...
class zh extends Pe {
  constructor(t, e) {
    super(t, e), this.Ws = new gi, this.ee = new Mh, this.re = new qs, this.Ws.Z([this.ee, this.re])
  }
  ne(t, e, i) {
...
class Lh extends pt {
  ...
  K({
    ...
    for (let h = this.zt.tt.from; h < this.zt.tt.to; ++h) {
      ...
      t.fillRect(c, p, u, _);
      const C = Math.ceil(1.5 * this.le);
      if (o) {
        if (this.zt.fe) {
          const M = a - C;
          let k = Math.max(p, Math.round(r.ve * i) - l),
            T = k + u - 1;
          T > p + _ - 1 && (T = p + _ - 1, k = T - u + 1), t.fillRect(M, k, c - M, T - k + 1)
        }
        const L = a + C;
        let j = Math.max(p, Math.round(r.pe * i) - l),
          U = j + u - 1;
        U > p + _ - 1 && (U = p + _ - 1, j = U - u + 1), t.fillRect(d + 1, j, L - d, U - j + 1)
      }
    }
  }
  oe(t) {
...
class Eh extends sn {
  constructor() {
    super(...arguments), this.Ws = new Lh
  }
  ne(t, e, i) {
...
class xh extends Zs {
  constructor() {
    super(...arguments), this.Te = new wi
  }
  Ds(t, e) {
    const i = this.G;
    return this.Te.bs(t, {
...
class Th extends Pe {
  constructor(t, e) {
    super(t, e), this.Ws = new gi, this.De = new $h, this.Ve = new xh, this.Ws.Z([this.De, this.Ve])
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class Ph extends pt {
  ...
  Be(t, e, i) {
    ...
    for (let u = i.from; u < i.to; u++) {
      ...
      const C = _ + l - 1;
      c !== null && (_ = Math.max(c + 1, _), _ = Math.min(_, C));
      const L = C - _ + 1;
      s.fillRect(_, p, L, m - p), s.fillRect(_, f + 1, L, g - f), c = C
    }
  }
  Ie(t) {
  ...
  Ae(t, e, i) {
    ...
    for (let c = i.from; c < i.to; c++) {
      ...
      if (a !== null && (d = Math.max(a + 1, d), d = Math.min(d, m)), this.zt.he * o > 2 * l) ph(s, d, f, m - d + 1, p - f + 1, l);
      else {
        const g = m - d + 1;
...
class Vh extends sn {
  constructor() {
    super(...arguments), this.Ws = new Ph
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.be(t, e, i)), i.Hs(t))
  }
...
class Re extends yi {
  constructor(t, e, i) {
    super(t, e, !1), this.wn = i, this.Ws = new Rh(this.wn.renderer(), s => {
      const o = t.Ct();
...
class Ah extends Pe {
  constructor() {
    super(...arguments), this.Ws = new qs
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class nn {
  constructor(t, e, i) {
    this._r = t, this.lr = new ee(50), this.ur = e, this.F = i, this.j = -1, this.Wt = new Nh(this.lr)
  }
  gt() {
...
class Oh extends pt {
  ...
  K({
    ...
    o < 0 || o > e.height || (t.lineCap = "butt", t.strokeStyle = this.zt.V, t.lineWidth = Math.floor(this.zt.et * i), Pt(t, this.zt.Nt), Os(t, o, 0, e.width))
  }
}
class Si {
  constructor(t) {
    this.Mr = {
      ...
      Nt: 0,
      yt: !1
    }, this.Sr = new Oh, this.ft = !0, this.Ls = t, this.Es = t.$t(), this.Sr.J(this.Mr)
  }
  bt() {
    this.ft = !0
  }
...
function Ui(n, t) {
  ...
  for (const l of Kh)
    if (e >= l.Dr && e <= l.Vr) {
      i = l;
      break
    } zt(i !== void 0, "Last price animation internal logic error");
...
class Jh {
  constructor(t) {
    this.Wt = new Fh, this.ft = !0, this.Er = !0, this.Nr = performance.now(), this.Fr = this.Nr - 1, this.Wr = t
  }
  jr() {
...
function Ht(n, t) {
  return Gs(Math.min(Math.max(n, 12), 30) * t)
}
  ...
  K({
    ...
    if (this.zt !== null && this.zt.tt !== null) {
      ...
      for (let h = this.zt.tt.from; h < this.zt.tt.to; h++) {
        ...
        r.Kt !== void 0 && (r.Kt.Hi = this.lr.xi(t, r.Kt.th), r.Kt.At = this.j, r.Kt.nt = r.nt - r.Kt.Hi / 2), Yh(r, t, e, i)
      }
    }
  }
}
  ...
  t.fillStyle = n.V, n.Kt !== void 0 && function(s, o, h, r, l, a) {
    ...
    function(s, o, h) {
      if (s.Xs !== 0) {
        switch (s.ih) {
          case "arrowDown":
            return void Ji(!1, o, h, s.Xs);
          case "arrowUp":
            return void Ji(!0, o, h, s.Xs);
          case "circle":
            return void
            function(r, l, a) {
              const c = (ie("circle", a) - 1) / 2;
...
function Gh(n, t, e) {
  return !(n.Kt === void 0 || ! function(i, s, o, h, r, l) {
    ...
    switch (i.ih) {
      case "arrowDown":
      case "arrowUp":
        return Xh(0, i.nt, i.st, i.Xs, s, o);
      case "circle":
        return function(h, r, l, a, c) {
          const u = 2 + ie("circle", l) / 2,
            d = h - a,
            m = r - c;
          return Math.sqrt(d * d + m * m) <= u
        }(i.nt, i.st, i.Xs, s, o);
      case "square":
        return hn(i.nt, i.st, i.Xs, s, o)
    }
  }(n, t, e)
}
...
class qh {
  constructor(t, e) {
    this.ft = !0, this.eh = !0, this.rh = !0, this.hh = null, this.ah = null, this.Wt = new Hh, this.Wr = t, this.$i = e, this.zt = {
      it: [],
      tt: null
    }
  }
    ...
    if (this.rh) {
      if (this.Wr.uh().length > 0) {
        const t = this.$i.St().he(),
          ...
          s = this.dh();
        this.hh = {
          above: Ki(i, s.aboveBar, s.inBar),
          below: Ki(i, s.belowBar, s.inBar)
        }
      } else this.hh = null;
      this.rh = !1
    }
...
class lt {
  ...
  ts(t) {
    return t === null ? this : new lt(Xi(Math.min, this.Th(), t.Th(), -1 / 0), Xi(Math.max, this.Ph(), t.Ph(), 1 / 0))
  }
  Dh(t) {
...
class Ce {
  ...
  static Bh(t) {
    return t === null ? null : new Ce(lt.Bh(t.priceRange), t.margins)
  }
}
class er extends Si {
  constructor(t, e) {
...
class ir extends $e {
  ...
  zi(t, e, i) {
    ...
    const a = Le(s.axisLabelColor || s.color);
    i.t = a.t;
...
class sr {
  constructor(t, e) {
    this.Wr = t, this.cn = e, this.Wh = new er(t, this), this._r = new ir(t, this), this.jh = new nn(this._r, t, t.$t())
  }
  Hh(t) {
...
class hr {
  constructor(t) {
    this.Xh = (e, i) => i !== void 0 ? i.Vt : this.Wr.In().Kh(e), this.Wr = t, this.Gh = or[t.Jh()]
  }
  Hs(t, e) {
...
class rr {
  ...
  fl(t) {
    return tn(this.Qh, t, (e, i) => e.se > i)
  }
  vl(t, e, i) {
    let s = null;
    for (let o = t; o < e; o++) {
...
class ar {
  constructor(t, e) {
    this.Wt = new Js, this.Sl = t, this.kl = e
  }
  gt() {
...
class Mi extends nr {
  constructor(t, e, i, s, o) {
    super(t), this.zt = new rr, this.Wh = new Qh(this), this.Il = [], this.zl = new Uh(this), this.Ll = null, this.El = null, this.Nl = [], this.Fl = [], this.Wl = null, this.jl = [], this.cn = e, this.Hl = i;
    const h = new tr(this);
    this.rn = [h], this.jh = new nn(h, this, t), i !== "Area" && i !== "Line" && i !== "Baseline" || (this.Ll = new Jh(this)), this.$l(), this.Ul(o)
  }
  S() {
  ...
  $s() {
    return this.El !== null || (this.El = new hr(this)), this.El
  }
  W() {
    return this.cn
  }
  ...
  va(t, e) {
    ...
    return this.jl.forEach(r => {
      ...
      if (l != null && l.priceRange) {
        const m = new lt(l.priceRange.minValue, l.priceRange.maxValue);
        o = o !== null ? o.ts(m) : m
      }
      var a, c, u, d;
  ...
  $l() {
    switch (this.cn.priceFormat.type) {
      case "custom":
        ...
        break;
      case "volume":
        this.ba = new wh(this.cn.priceFormat.precision);
        break;
      case "percent":
        this.ba = new Xs(this.cn.priceFormat.precision);
        break;
      default: {
  ...
  Ul(t) {
    switch (this.dn = new qh(this, this.$t()), this.Hl) {
      case "Bar":
        this.wn = new Eh(this, this.$t());
        break;
      case "Candlestick":
        this.wn = new Vh(this, this.$t());
        break;
      case "Line":
        this.wn = new Ah(this, this.$t());
        break;
      case "Custom":
        this.wn = new Re(this, this.$t(), ht(t));
        break;
      case "Area":
        this.wn = new zh(this, this.$t());
        break;
      case "Baseline":
        this.wn = new Th(this, this.$t());
        break;
      case "Histogram":
...
class mr {
  ...
  Va(t, e, i) {
    ...
    if (h === null) return s;
    const r = o.Rt(t, h),
      l = i.Oa().filter(c => c instanceof Mi).reduce((c, u) => {
...
class vr {
  constructor(t) {
    this.Wt = new pr, this.ft = !0, this.tn = t
  }
  bt() {
    this.ft = !0
  }
...
class Ne {
  ...
  Za(t, e, i) {
    ...
    let o = Math.pow(10, Math.max(0, Math.ceil(Math.log10(t - e)))),
      ...
      r = this.qa[0];
    for (;;) {
      const u = ae(o, s, 1e-14) && o > s + 1e-14,
        d = ae(o, i * r, 1e-14),
        m = ae(o, 1, 1e-14);
      if (!(u && d && m)) break;
    ...
    if (o <= s + 1e-14 && (o = s), o = Math.max(1, o), this.Ya.length > 0 && (l = o, a = 1, c = 1e-14, Math.abs(l - a) < c))
      for (h = 0, r = this.Ya[0]; ae(o, i * r, 1e-14) && o > s + 1e-14;) o /= r, r = this.Ya[++h % this.Ya.length];
    var l, a, c;
    return o
  }
}
...
class wr {
  constructor(t, e, i, s) {
    this.ro = 0, this.ho = null, this.Ah = null, this.lo = null, this.ao = {
      oo: !1,
      _o: null
    }, this.uo = 0, this.co = 0, this.do = new J, this.fo = new J, this.vo = [], this.po = null, this.mo = null, this.bo = null, this.wo = null, this.ba = qi, this.Mo = De(null), this.xo = t, this.cn = e, this.So = i, this.ko = s, this.yo = new Yi(this, 100, this.Co.bind(this), this.To.bind(this))
  }
  Ta() {
    return this.xo
  }
  ...
  Po(t) {
    ...
    }(this.Ah, this.Mo) ? (i = ue(this.Ah, this.Mo), i !== null && this.Bo(i)) : this.cn.autoScale = !0), t.yr === 1 && t.yr !== e.yr && (i = Kt(this.Ah, this.Mo), i !== null && this.Bo(i));
  ...
  Rt(t, e) {
    return this.gh() ? t = Dt(t, e) : this.Vo() && (t = Yt(t, e)), this.To(t, e)
  }
  Qs(t, e, i) {
    this.Fo();
    const s = this.No(),
  ...
  me(t, e, i) {
    ...
    for (let f = u; f < d; f++) {
      ...
      let g = p.we,
        ...
        C = p.Me,
        L = p.xe;
      m !== null && (g = m(p.we, e), _ = m(p.ge, e), C = m(p.Me, e), L = m(p.xe, e));
      let j = s + c * (g - h),
        U = a ? j : this.ro - 1 - j;
      p.ve = U, j = s + c * (_ - h), U = a ? j : this.ro - 1 - j, p.ce = U, j = s + c * (C - h), U = a ? j : this.ro - 1 - j, p.de = U, j = s + c * (L - h), U = a ? j : this.ro - 1 - j, p.pe = U
    }
  }
  pn(t, e) {
    const i = this.Co(t, e);
  ...
  $o() {
    ...
    return t = ln(t), this.po = t, this.po
  }
  Uo(t) {
  ...
  Pa() {
    ...
    const t = this.s_();
    let e = 100;
    t !== null && (e = Math.round(1 / t.pa())), this.ba = qi, this.gh() ? (this.ba = Zi, e = 100) : this.Vo() ? (this.ba = new Te(100, 1), e = 100) : t !== null && (this.ba = t.ma()), this.yo = new Yi(this, e, this.Co.bind(this), this.To.bind(this)), this.yo.Qa()
  }
  qo() {
    this.po = null
  }
  ...
  h_() {
    ...
    if (s === this.uo && o === this.co || (this.uo = s, this.co = o, this.mo = null, this.Ro()), e !== null) {
      if (e.Th() === e.Ph()) {
        ...
        this.eo() && (e = ue(e, this.Mo)), e = new lt(e.Th() - a, e.Ph() + a), this.eo() && (e = Kt(e, this.Mo))
      }
      if (this.eo()) {
        const l = ue(e, this.Mo),
          a = De(l);
        if (h = a, r = this.Mo, h.Ha !== r.Ha || h.$a !== r.$a) {
          const c = this.lo !== null ? ue(this.lo, this.Mo) : null;
          this.Mo = a, e = Kt(l, a), c !== null && (this.lo = Kt(c, a))
        }
      }
      this.Bo(e)
    } else this.Ah === null && (this.Bo(new lt(-.5, .5)), this.Mo = De(null));
    var h, r;
    this.ao.oo = !0
  }
  jo() {
    return this.gh() ? Dt : this.Vo() ? Yt : this.eo() ? t => ke(t, this.Mo) : null
  }
  l_(t, e, i) {
...
class yr {
  constructor(t, e) {
    this.vo = [], this.a_ = new Map, this.ro = 0, this.o_ = 0, this.__ = 1e3, this.po = null, this.u_ = new J, this.kl = t, this.$i = e, this.c_ = new br(this);
    const i = e.W();
  ...
  Yo(t) {
    const e = this.vo.indexOf(t);
    zt(e !== -1, "removeDataSource: invalid data source"), this.vo.splice(e, 1);
    const i = b(t.Dt()).Ta();
    if (this.a_.has(i)) {
  ...
  $o() {
    return this.po === null && (this.po = ln(this.vo)), this.po
  }
  F_() {
    return this.u_
  }
  ...
  f_(t, e) {
    const i = Object.assign({
      ...
      s = new wr(t, i, this.$i.W().layout, this.$i.W().localization);
...
class Zt {
  constructor(t, e) {
    zt(t <= e, "right should be >= left"), this.Z_ = t, this.X_ = e
  }
  Vs() {
    return this.Z_
  }
...
class kr {
  constructor(t, e, i, s) {
    this.o_ = 0, this.ou = null, this._u = [], this.wo = null, this.bo = null, this.uu = new Mr, this.cu = new Map, this.du = Nt.au(), this.fu = !0, this.vu = new J, this.pu = new J, this.mu = new J, this.bu = null, this.wu = null, this.gu = [], this.cn = e, this.ko = i, this.Mu = e.rightOffset, this.xu = e.barSpacing, this.$i = t, this.U_ = s, this.Su(), this.uu.Q_(e.uniformDistribution)
  }
  W() {
    return this.cn
  }
  ...
  Go(t) {
    ...
    const e = li(this.o_ - t, 0, this.o_),
      i = li(this.o_ - b(this.bo), 0, this.o_);
  ...
  $u(t) {
    ...
    return e === void 0 && (e = new Sr(i => this.dc(i), this.U_), this.cu.set(t.weight, e)), e.q_(t)
  }
  dc(t) {
  ...
  oc(t) {
    const e = this.du;
    this.du = t, Qi(e.hu(), this.du.hu()) || this.vu.m(), Qi(e.lu(), this.du.lu()) || this.pu.m(), this.ac()
  }
  ac() {
    this.wu = null
  }
...
class Lr {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      gc: "center",
      Mc: "center"
    }, this.Wt = new zr(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
...
class Er extends _i {
  constructor(t, e) {
    super(), this.cn = e, this.wn = new Lr(this)
  }
  Rn() {
    return []
  }
...
class $r {
  constructor(t, e, i) {
    this.kc = [], this.yc = [], this.o_ = 0, this.Cc = null, this.Tc = new J, this.Pc = new J, this.Rc = null, this.Dc = t, this.cn = e, this.U_ = i, this.Vc = new lh(this), this.kl = new kr(this, e.timeScale, this.cn.localization, i), this.vt = new _h(this, e.crosshair), this.Oc = new mr(e.crosshair), this.Bc = new Er(this, e.watermark), this.Ac(), this.kc[0].M_(2e3), this.Ic = this.zc(0), this.Lc = this.zc(1)
  }
  Xl() {
    this.Ec(et.es())
  }
  ...
  fd(t) {
    const e = this.cr(t),
      i = this.yc.indexOf(t);
    zt(i !== -1, "Series not found"), this.yc.splice(i, 1), b(e).Yo(t), t.S && t.S()
  }
  Zl(t, e) {
    const i = b(this.cr(t));
    i.Yo(t);
  ...
  Bt(t) {
    ...
    const s = function(o, h, r) {
      const [l, a, c, u] = qt(o), [d, m, f, p] = qt(h), g = [ut(l + r * (d - l)), ut(a + r * (m - a)), ut(c + r * (f - c)), Us(u + r * (p - u))];
...
const os = n => n.getUTCFullYear();

function xr(n, t, e) {
  return t.replace(/yyyy/g, (i => wt(os(i), 4))(n)).replace(/yy/g, (i => wt(os(i) % 100, 2))(n)).replace(/MMMM/g, ((i, s) => new Date(i.getUTCFullYear(), i.getUTCMonth(), 1).toLocaleString(s, {
    month: "long"
...
class Vr {
  constructor(t = {}) {
    const e = Object.assign(Object.assign({}, Pr), t);
    this.Cd = new cn(e.xd, e.yd), this.Td = new Tr(e.Sd), this.Pd = e.kd
  }
  q_(t) {
...
function rs(n, t) {
  ...
  for (let e = fe.length - 1; e >= 0; --e)
    if (Math.floor(t.getTime() / fe[e].Rd) !== Math.floor(n.getTime() / fe[e].Rd)) return fe[e].Dd;
  return 0
}

function Ue(n) {
  let t = n;
  if (ne(n) && (t = Ci(n)), !ai(t)) throw new Error("time must be of type BusinessDay");
...
function ls(n) {
  if (!an(n)) throw new Error("time must be of type isUTCTimestamp");
  return {
    Vd: n
  }
}
...
class cs {
  ...
  createConverterToInternalObj(t) {
    return b(function(e) {
      return e.length === 0 ? null : ai(e[0].time) || ne(e[0].time) ? Ue : ls
    }(t))
  }
  key(t) {
  ...
  convertHorzItemToInternal(t) {
    return an(e = t) ? ls(e) : ai(e) ? Ue(e) : Ue(Ci(e));
    var e
  }
  updateFormatter(t) {
    if (!this.cn) return;
    const e = t.dateFormat;
    this.cn.timeScale.timeVisible ? this.Bd = new Vr({
      xd: e,
      Sd: this.cn.timeScale.secondsVisible ? "%h:%m:%s" : "%h:%m",
      kd: "   ",
      yd: t.locale
    }) : this.Bd = new cn(e, t.locale)
  }
  formatHorzItem(t) {
    const e = t;
  ...
  fillWeightsForPoints(t, e) {
    (function(i, s = 0) {
      ...
      for (let l = s; l < i.length; ++l) {
        ...
        h !== null && (a.timeWeight = rs(c, h)), r += a.time.Vd - (o || a.time.Vd), o = a.time.Vd, h = c
      }
      if (s === 0 && i.length > 1) {
        const l = Math.ceil(r / (i.length - 1)),
          a = new Date(1e3 * (i[0].time.Vd - l));
        i[0].timeWeight = rs(new Date(1e3 * i[0].time.Vd), a)
      }
    })(t, e)
  }
  static Ad(t) {
...
class Ir {
  ...
  sf() {
    return Fs(qt(this.Jd.W().layout.textColor)) > 160 ? "dark" : "light"
  }
  nf() {
...
class ki {
  ...
  tv(t) {
    const e = Xe(t.changedTouches, b(this.Vf));
    if (e === null || (this.Df = me(t), this.yf !== null) || this.Pf) return;
    this.Tf = !0;
    const i = this.Nf(vt(e), b(this.vf)),
      {
        iv: s,
        nv: o,
        Ef: h
    ...
    if (this.pf || !(h < 5)) {
      ...
      if (!this.Pf) {
        const r = this.Lf(t, e);
        this.Ff(r, this.jf.rv), Wt(t)
      }
    }
  }
  hv(t) {
    if (t.button !== 0) return;
    const e = this.Nf(vt(t), b(this.ff)),
      {
        Ef: i
      } = e;
  ...
  av(t) {
    let e = Xe(t.changedTouches, b(this.Vf));
    if (e === null && t.touches.length === 0 && (e = t.changedTouches[0]), e === null) return;
    this.Vf = null, this.Df = me(t), this.Xf(), this.vf = null, this.kf && (this.kf(), this.kf = null);
    const i = this.Lf(t, e);
    ...
    } else this.bf || (this.Ff(i, this.jf._v), this.jf._v && Wt(t));
    this.af === 0 && Wt(t), t.touches.length === 0 && this.df && (this.df = !1, Wt(t))
  }
  Af(t) {
    if (t.button !== 0) return;
    const e = this.Lf(t);
    if (this.ff = null, this.Rf = !1, this.Sf && (this.Sf(), this.Sf = null), us() && this.Yf.ownerDocument.documentElement.removeEventListener("mouseleave", this.Bf), !this.zf(t))
  ...
  dv(t) {
    ...
    this.Vf = e.identifier, this.Df = me(t);
  ...
  pv(t) {
    ...
    us() && e.addEventListener("mouseleave", this.Bf), this.mf = !1, this.ff = vt(t), this.Sf && (this.Sf(), this.Sf = null);
    {
  ...
  Zf() {
    ...
    Fe() && (this.Mf = () => {
      ...
      passive: !0
    }), Wr(this.Yf), this.Yf.addEventListener("mousedown", this.pv.bind(this)), this.gv(), this.Yf.addEventListener("touchmove", () => {}, {
      passive: !1
    })
  }
  gv() {
    this.jf.Mv === void 0 && this.jf.xv === void 0 && this.jf.Sv === void 0 || (this.Yf.addEventListener("touchstart", t => this.kv(t.touches), {
      ...
      if (t.touches.length === 2 && this.yf !== null && this.jf.xv !== void 0) {
        const e = ds(t.touches[0], t.touches[1]) / this.Cf;
        this.jf.xv(this.yf, e), Wt(t)
      }
    }, {
      passive: !1
  ...
  Cv(t) {
    ...
    }, this.Cf = ds(t[0], t[1]), this.jf.Mv !== void 0 && this.jf.Mv(), this.Xf()
  }
  yv() {
  ...
  fv(t) {
    const e = Xe(t.touches, b(this.Vf));
    if (e === null) return;
    const i = this.Lf(t, e);
    this.Ff(i, this.jf.Pv), this.bf = !0, this.df = !0
  }
  zf(t) {
    return t.sourceCapabilities && t.sourceCapabilities.firesTouchEvents !== void 0 ? t.sourceCapabilities.firesTouchEvents : me(t) < this.Df + 500
  }
  Ff(t, e) {
    e && e.call(this.jf, t)
  }
  ...
  for (let l = 1; l < n.length; l++) {
    ...
    if (t === 1 ? d > m - u : d < m + u) {
      ...
      if ((t === 1 ? p < 0 : p > e) && r > 0) {
        const g = t === 1 ? -1 - p : p - e,
          _ = Math.min(g, r);
        for (let C = s; C < n.length; C++) n[C].Oi(n[C].Vi() + t * _);
        r -= _
      }
...
class ms {
  constructor(t, e, i, s) {
    this.Li = null, this.Lv = null, this.Ev = !1, this.Nv = new ee(200), this.Jr = null, this.Fv = 0, this.Wv = !1, this.jv = () => {
      ...
      this.Wv || this.tn.Hv().$t().$h()
    }, this.tn = t, this.cn = e, this.So = e.layout, this.Vc = i, this.Uv = s === "left", this.qv = He("normal", s), this.Yv = He("top", s), this.Zv = He("bottom", s), this.Xv = document.createElement("div"), this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Xv.style.width = "25px", this.Xv.style.left = "0", this.Xv.style.position = "relative", this.Kv = Vt(this.Xv, O({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const o = this.Kv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "1", o.style.left = "0", o.style.top = "0", this.Gv = Vt(this.Xv, O({
      width: 16,
      height: 16
    ...
    this.rp = new ki(this.Gv.canvasElement, r, {
      sv: () => !this.cn.handleScroll.vertTouchDrag,
      ev: () => !0
    })
  }
  S() {
    this.rp.S(), this.Gv.unsubscribeSuggestedBitmapSizeChanged(this.$v), Rt(this.Gv.canvasElement), this.Gv.dispose(), this.Kv.unsubscribeSuggestedBitmapSizeChanged(this.jv), Rt(this.Kv.canvasElement), this.Kv.dispose(), this.Li !== null && this.Li.Xo().p(this), this.Li = null
  }
  hp() {
    return this.Xv
  }
  ...
  ap() {
    ...
    i.restore();
    const r = t || 34;
    return ci(Math.ceil(e.C + e.T + e.A + e.I + 5 + r))
  }
  up(t) {
    this.Lv !== null && $t(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`)
  }
  cp() {
  ...
  pp({
    ...
    h === r ? Ee(t, 0, 0, i, s, h) : Ks(t, 0, 0, i, s, h, r)
  }
  Ae({
    context: t,
    bitmapSize: e,
  ...
  kp(t, e) {
    ...
    fs(s, 1, this.Lv.height, e), fs(o, -1, this.Lv.height, e)
  }
  wp(t) {
    if (this.Lv === null) return;
    const e = this._p(),
...
class ji {
  constructor(t, e) {
    this.Lv = O({
      width: 0,
      height: 0
    }), this.yp = null, this.Cp = null, this.Tp = null, this.Pp = null, this.Rp = !1, this.Dp = new J, this.Vp = new J, this.Op = 0, this.Bp = !1, this.Ap = null, this.Ip = !1, this.zp = null, this.Lp = null, this.Wv = !1, this.jv = () => {
    ...
    i.style.width = "100%", i.style.height = "100%", i.style.position = "relative", i.style.overflow = "hidden", this.Wp = document.createElement("td"), this.Wp.style.padding = "0", this.jp = document.createElement("td"), this.jp.style.padding = "0", this.Fp.appendChild(i), this.Kv = Vt(i, O({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const s = this.Kv.canvasElement;
    s.style.position = "absolute", s.style.zIndex = "1", s.style.left = "0", s.style.top = "0", this.Gv = Vt(i, O({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
    const o = this.Gv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "2", o.style.left = "0", o.style.top = "0", this.Hp = document.createElement("tr"), this.Hp.appendChild(this.Wp), this.Hp.appendChild(this.Fp), this.Hp.appendChild(this.jp), this.$p(), this.rp = new ki(this.Gv.canvasElement, this, {
      sv: () => this.Ap === null && !this.Jd.W().handleScroll.vertTouchDrag,
      ev: () => this.Ap === null && !this.Jd.W().handleScroll.horzTouchDrag
    })
  }
  S() {
    this.yp !== null && this.yp.S(), this.Cp !== null && this.Cp.S(), this.Tp = null, this.Gv.unsubscribeSuggestedBitmapSizeChanged(this.$v), Rt(this.Gv.canvasElement), this.Gv.dispose(), this.Kv.unsubscribeSuggestedBitmapSizeChanged(this.jv), Rt(this.Kv.canvasElement), this.Kv.dispose(), this.Ep !== null && this.Ep.F_().p(this), this.rp.S()
  }
  dp() {
    return b(this.Ep)
  }
  Up(t) {
    var e, i;
    this.Ep !== null && this.Ep.F_().p(this), this.Ep = t, this.Ep !== null && this.Ep.F_().l(ji.prototype.Np.bind(this), this, !0), this.$p(), this.Jd.qp().indexOf(this) === this.Jd.qp().length - 1 ? (this.Tp = (e = this.Tp) !== null && e !== void 0 ? e : new Ir(this.Fp, this.Jd), this.Tp.bt()) : ((i = this.Tp) === null || i === void 0 || i.tf(), this.Tp = null)
  }
  Hv() {
    return this.Jd
  }
    ...
    return i === null ? null : function(s, o, h) {
      const r = s.$o(),
        l = function(a, c, u) {
          ...
          let f, p;
          for (const C of a) {
            const L = (m = (d = C.fa) === null || d === void 0 ? void 0 : d.call(C, c, u)) !== null && m !== void 0 ? m : [];
            for (const j of L) g = j.zOrder, (!(_ = f == null ? void 0 : f.zOrder) || g === "top" && _ !== "top" || g === "normal" && _ === "bottom") && (f = j, p = C)
          }
          var g, _;
          return f && p ? {
            Iv: f,
      ...
      if ((l == null ? void 0 : l.Iv.zOrder) === "top") return pe(l);
      for (const a of r) {
        if (l && l.jc === a && l.Iv.zOrder !== "bottom" && !l.Iv.isBackground) return pe(l);
        const c = Br(a.Pn(s), o, h);
        if (c !== null) return {
          jc: a,
          Ov: c.Ov,
          Av: c.Av
      ...
      return l != null && l.Iv ? pe(l) : null
    }(i, t, e)
  }
  om(t, e) {
    b(e === "left" ? this.yp : this.Cp).up(O({
      width: t,
  ...
  up(t) {
    $t(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Fp.style.width = t.width + "px", this.Fp.style.height = t.height + "px")
  }
  um() {
    const t = b(this.Ep);
    t.T_(t.P_()), t.T_(t.R_());
  ...
  fp(t) {
    ...
    if (t > 1 && this.um(), this.yp !== null && this.yp.fp(t), this.Cp !== null && this.Cp.fp(t), t !== 1) {
      ...
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s)
      }), this.Ep && (this.dm(i, Ar), this.fm(i), this.vm(i), this.dm(i, ve), this.dm(i, Dr)))
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Tt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
  ...
  pp({
    ...
    h === r ? Ee(t, 0, 0, i, s, r) : Ks(t, 0, 0, i, s, h, r)
  }
  fm(t) {
  ...
  vm(t) {
    const e = this.$i().qc();
    this.gm(t, ve, ui, e), this.gm(t, ve, ge, e)
  }
  pm(t) {
    this.gm(t, ve, ge, this.$i().Yc())
  }
  dm(t, e) {
    const i = b(this.Ep).$o();
    for (const s of i) this.gm(t, e, ui, s);
    for (const s of i) this.gm(t, e, ge, s)
  }
  gm(t, e, i, s) {
    const o = b(this.Ep),
      h = o.$t().Fc(),
  ...
  Yp() {
    ...
    const s = t.$t()._d();
    e && this.yp === null && (this.yp = new ms(this, t.W(), s, "left"), this.Wp.appendChild(this.yp.hp())), i && this.Cp === null && (this.Cp = new ms(this, t.W(), s, "right"), this.jp.appendChild(this.Cp.hp()))
  }
  Mm(t) {
  ...
  im(t) {
    ...
    if (this.Pp !== null || this.Mm(t) || (this.Pp = {
      ...
      if (t.Rv && h.touch || !t.Rv && h.mouse) {
        const a = i.he();
        this.Lp = new Rr(.2 / a, 7 / a, .997, 15 / a), this.Lp.qd(i.ju(), this.Pp.Vd)
      } else this.Lp = null;
...
class ps {
  constructor(t, e, i, s, o) {
    this.ft = !0, this.Lv = O({
      width: 0,
      height: 0
    }), this.jv = () => this.fp(3), this.Uv = t === "left", this.Vc = i._d, this.cn = e, this.Cm = s, this.Tm = o, this.Xv = document.createElement("div"), this.Xv.style.width = "25px", this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Kv = Vt(this.Xv, O({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv)
  }
  S() {
    this.Kv.unsubscribeSuggestedBitmapSizeChanged(this.jv), Rt(this.Kv.canvasElement), this.Kv.dispose()
  }
  hp() {
    return this.Xv
  }
  ...
  up(t) {
    $t(this.Lv, t) || (this.Lv = t, this.Kv.resizeCanvasElement(t), this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.ft = !0)
  }
  fp(t) {
...
class Kr {
  constructor(t, e) {
    this.Pm = null, this.Rm = null, this.k = null, this.Dm = !1, this.Lv = O({
      width: 0,
      height: 0
    }), this.Vm = new J, this.Nv = new ee(5), this.Wv = !1, this.jv = () => {
      this.Wv || this.Jd.$t().$h()
    }, this.$v = () => {
      this.Wv || this.Jd.$t().$h()
    }, this.Jd = t, this.U_ = e, this.cn = t.W().layout, this.Zd = document.createElement("tr"), this.Om = document.createElement("td"), this.Om.style.padding = "0", this.Bm = document.createElement("td"), this.Bm.style.padding = "0", this.Xv = document.createElement("td"), this.Xv.style.height = "25px", this.Xv.style.padding = "0", this.Am = document.createElement("div"), this.Am.style.width = "100%", this.Am.style.height = "100%", this.Am.style.position = "relative", this.Am.style.overflow = "hidden", this.Xv.appendChild(this.Am), this.Kv = Vt(this.Am, O({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const i = this.Kv.canvasElement;
    i.style.position = "absolute", i.style.zIndex = "1", i.style.left = "0", i.style.top = "0", this.Gv = Vt(this.Am, O({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
    const s = this.Gv.canvasElement;
    s.style.position = "absolute", s.style.zIndex = "2", s.style.left = "0", s.style.top = "0", this.Zd.appendChild(this.Om), this.Zd.appendChild(this.Xv), this.Zd.appendChild(this.Bm), this.Im(), this.Jd.$t().w_().l(this.Im.bind(this), this), this.rp = new ki(this.Gv.canvasElement, this, {
      sv: () => !0,
      ev: () => !this.Jd.W().handleScroll.horzTouchDrag
    })
  }
  S() {
    this.rp.S(), this.Pm !== null && this.Pm.S(), this.Rm !== null && this.Rm.S(), this.Gv.unsubscribeSuggestedBitmapSizeChanged(this.$v), Rt(this.Gv.canvasElement), this.Gv.dispose(), this.Kv.unsubscribeSuggestedBitmapSizeChanged(this.jv), Rt(this.Kv.canvasElement), this.Kv.dispose()
  }
  hp() {
    return this.Zd
  }
  ...
  Nm(t, e, i) {
    $t(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.Vm.m(t)), this.Pm !== null && this.Pm.up(O({
      width: e,
      height: t.height
  ...
  fp(t) {
    ...
    if (t !== 1) {
      ...
      const i = Tt(this.Kv);
      i !== null && (i.useBitmapCoordinateSpace(s => {
        this.pp(s), this.Ae(s), this.Hm(i, Fr)
      }), this.bp(i), this.Hm(i, Or)), this.Pm !== null && this.Pm.fp(t), this.Rm !== null && this.Rm.fp(t)
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Tt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
      ...
      i.clearRect(0, 0, s.width, s.height)
    }), this.$m([...this.Jd.$t().wt(), this.Jd.$t().Yc()], e), this.Hm(e, Ur))
  }
  Hm(t, e) {
    const i = this.Jd.$t().wt();
    for (const s of i) di(e, o => ui(o, t, !1, void 0), s, void 0);
    for (const s of i) di(e, o => ge(o, t, !1, void 0), s, void 0)
  }
  pp({
    context: t,
    bitmapSize: e
  ...
  Im() {
    ...
    const i = {
      ...
      o = () => t.md();
    e.leftPriceScale.visible && this.Pm === null && (this.Pm = new ps("left", e, i, s, o), this.Om.appendChild(this.Pm.hp())), e.rightPriceScale.visible && this.Rm === null && (this.Rm = new ps("right", e, i, s, o), this.Bm.appendChild(this.Rm.hp()))
  }
}
const Jr = !!Ut && !!navigator.userAgentData && navigator.userAgentData.brands.some(n => n.brand.includes("Chromium")) && !!Ut && (!((Ye = navigator == null ? void 0 : navigator.userAgentData) === null || Ye === void 0) && Ye.platform ? navigator.userAgentData.platform === "Windows" : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
var Ye;
class Xr {
  constructor(t, e, i) {
    var s;
    this.Zm = [], this.Xm = 0, this.ro = 0, this.o_ = 0, this.Km = 0, this.Gm = 0, this.Jm = null, this.Qm = !1, this.Dp = new J, this.Vp = new J, this.Pc = new J, this.tb = null, this.ib = null, this.Gd = t, this.cn = e, this.U_ = i, this.Zd = document.createElement("div"), this.Zd.classList.add("tv-lightweight-charts"), this.Zd.style.overflow = "hidden", this.Zd.style.direction = "ltr", this.Zd.style.width = "100%", this.Zd.style.height = "100%", (s = this.Zd).style.userSelect = "none", s.style.webkitUserSelect = "none", s.style.msUserSelect = "none", s.style.MozUserSelect = "none", s.style.webkitTapHighlightColor = "transparent", this.nb = document.createElement("table"), this.nb.setAttribute("cellspacing", "0"), this.Zd.appendChild(this.nb), this.sb = this.eb.bind(this), Ge(this.cn) && this.rb(!0), this.$i = new $r(this.Dc.bind(this), this.cn, i), this.$t().Zc().l(this.hb.bind(this), this), this.lb = new Kr(this, this.U_), this.nb.appendChild(this.lb.hp());
  ...
  Tb() {
    ...
    for (let f = 0; f < this.Zm.length; ++f) {
      ...
      let g = 0,
        _ = 0;
      _ = f === this.Zm.length - 1 ? u - m : Math.round(p.g_() * d), g = Math.max(_, 2), m += g, p.up(O({
        width: h,
        height: g
  ...
  Pb(t) {
    ...
    return Jr ? 1 / window.devicePixelRatio : 1
  }
  eb(t) {
  ...
  Ab(t, e, i) {
    ...
    const r = this.$t().Fc(),
      l = r !== null && r.jc instanceof Mi ? r.jc : void 0,
...
class tl {
    ...
    if (e.length !== 0) {
      ...
      h = e.map((m, f) => {
        const p = a(m.time),
          g = this.U_.key(p);
        let _ = this.Ub.get(g);
        _ === void 0 && (_ = _s(p), this.Ub.set(g, _), s = !0);
        const C = c(p, _.se, m, l[f], u, d);
        return _.jb.set(t, C), C
      })
    }
  ...
  tw(t, e) {
    ...
    const r = h === void 0;
    h === void 0 && (h = _s(s), this.Ub.set(this.U_.key(s), h));
    const l = gs(t.Jh()),
      a = t.ya(),
      c = t.Ca(),
  ...
  iw(t, e) {
    ...
    s === null || this.U_.key(e.ot) > this.U_.key(s.ot) ? be(e) && i.push(e) : be(e) ? i[i.length - 1] = e : i.splice(-1, 1), this.Yb.set(t, e.ot)
  }
  Gb(t, e) {
    e.length !== 0 ? (this.qb.set(t, e.filter(be)), this.Yb.set(t, e[e.length - 1].ot)) : (this.qb.delete(t), this.Yb.delete(t))
  }
  Kb() {
...
class ml {
  constructor(t, e, i, s, o) {
    this._w = new J, this.Ls = t, this.uw = e, this.cw = i, this.U_ = o, this.dw = s
  }
  S() {
    this._w.S()
  }
  ...
  dataByIndex(t, e) {
    ...
    return i === null ? null : fi(this.seriesType())(i)
  }
  data() {
    const t = fi(this.seriesType());
  ...
  setMarkers(t) {
    this.U_;
    const e = t.map(i => Cs(i, this.U_.convertHorzItemToInternal(i.time), i.time));
    this.Ls.ia(e)
  }
  markers() {
    return this.Ls.na().map(t => Cs(t, t.originalTime, void 0))
  }
  applyOptions(t) {
    this.Ls.Hh(t)
  }
...
class pl {
  constructor(t, e, i) {
    this.bw = new J, this.pu = new J, this.Vm = new J, this.$i = t, this.kl = t.St(), this.lb = e, this.kl.tc().l(this.ww.bind(this)), this.kl.nc().l(this.gw.bind(this)), this.lb.Em().l(this.Mw.bind(this)), this.U_ = i
  }
  S() {
  ...
  setVisibleLogicalRange(t) {
    zt(t.from <= t.to, "The from index cannot be after the to index."), this.$i.vd(t)
  }
  resetTimeScale() {
    this.$i.Kn()
  }
...
function ks(n) {
  return function(t) {
    if (le(t.handleScale)) {
      ...
      le(i) && (t.handleScale.axisPressedMouseMove = {
        time: i,
        price: i
      }), le(s) && (t.handleScale.axisDoubleClickReset = {
        time: s,
        price: s
      })
    }
...
class bl {
  constructor(t, e, i) {
    this.xw = new Map, this.Sw = new Map, this.kw = new J, this.yw = new J, this.Cw = new J, this.Tw = new tl(e);
    const s = i === void 0 ? _t(Ms()) : mt(_t(Ms()), ks(i));
    this.U_ = e, this.lw = new Xr(t, s, e), this.lw.hm().l(h => {
    ...
    const o = this.lw.$t();
    this.Rw = new pl(o, this.lw.cb(), this.U_)
  }
  remove() {
  ...
  addCustomSeries(t, e) {
    const i = At(t),
      s = Object.assign(Object.assign({}, Ds), i.defaultOptions());
    return this.Dw("Custom", s, e, i)
  }
  addAreaSeries(t) {
    return this.Dw("Area", th, t)
  }
  addBaselineSeries(t) {
    return this.Dw("Baseline", eh, t)
  }
  addBarSeries(t) {
    return this.Dw("Bar", qo, t)
  }
  ...
  addHistogramSeries(t) {
    return this.Dw("Histogram", ih, t)
  }
  addLineSeries(t) {
    return this.Dw("Line", Qo, t)
  }
  removeSeries(t) {
...
function gl(n, t, e) {
  ...
  if (ne(n)) {
    ...
    zt(o !== null, `Cannot find element in DOM with id=${n}`), i = o
  } else i = n;
  const s = new bl(i, t, e);
  return t.setOptions(s.options()), s
}

function _l(n, t) {
  return gl(n, new cs, cs.Ad(t))
}
Object.assign(Object.assign({}, Ns), Ds);
const wl = {
    ...
    setup(n) {
      const t = n,
        ...
        h = z(() => [{
          ...
          value: Jt.FIVE_MINUTES,
          label: `5${$("base.time.abbr.minutes")}`
        }, {
          value: Jt.FIFTEEN_MINUTES,
        ...
        d = (f, p) => {
          var k, T;
          const g = (k = Ts().$webApp.dataUnsafe.user) == null ? void 0 : k.language_code,
            _ = (T = i.value) == null ? void 0 : T.timeScale().getVisibleLogicalRange();
          s.value && i.value && i.value.removeSeries(s.value), p.innerHTML = "";
          const L = _l(p, {
            localization: {
              timeFormatter: D => {
                const w = G => String(G).padStart(2, "0"),
                  W = new Date(D * 1e3);
                return `${w(W.getUTCHours())}:${w(W.getUTCMinutes())}`
              },
              priceFormatter: D => {
                if (a.value === Bt.MARKET_CAP) return `$${ye(D,{accuracy:0})}`;
                {
                  if (Math.abs(D) < 1e-9) return "$0";
                  const [w, W] = D.toFixed(9).split("."), G = W[0], Z = W.slice(1).match(/^0+/), V = Z ? Z[0].length : 0, B = V > 0 ? String.fromCharCode(8321 + V) : "", F = W.slice(V + 1).replace(/0+$/, "").slice(0, 3);
                  return `$${w}.${G}${B}${F}`
                }
              },
              locale: g
          ...
          const j = L.addLineSeries({
              ...
              priceFormat: {
                type: "price",
                precision: a.value === Bt.MARKET_CAP ? 0 : 9,
                minMove: 1e-9
              }
            }),
            U = f.map(D => {
              const w = new Date(D.timestamp);
              return {
                time: (w.getTime() - w.getTimezoneOffset() * 60 * 1e3) / 1e3,
                value: D.price.toNumber()
              }
            }).sort((D, w) => D.time - w.time);
          j.setData(U);
        ...
        m = z(() => {
          ...
          const f = yn(t.jettonPnl.pnlAbsoluteUSD, {
              accuracy: 2,
              trim: !0
            }),
      ...
      return bt(() => ({
        ...
        immediate: !0
      }), se(u), (f, p) => (S(), x("div", wl, [y("div", yl, [y("div", {
        class: "section",
        style: $i({
          "grid-template-columns": `repeat(${v(r).length}, 1fr)`
        })
      }, [(S(!0), x(yt, null, ei(v(r), g => (S(), x("label", {
        key: g.value,
        class: Xt(["item", {
          "is-active": f.chartType === g.value
        }])
      }, [we(y("input", {
        "onUpdate:modelValue": p[0] || (p[0] = _ => ft(a) ? a.value = _ : null),
        type: "radio",
        name: "chart-type",
        value: g.value
      }, null, 8, Sl), [
        [ii, v(a)]
      ]), y("span", Ml, I(g.label), 1)], 2))), 128))], 4), y("div", {
        class: "section",
        style: $i({
          "grid-template-columns": `repeat(${v(h).length}, 1fr)`
        })
      }, [(S(!0), x(yt, null, ei(v(h), g => (S(), x("label", {
        key: g.value,
        class: Xt(["item", {
          "is-active": f.chartInterval === g.value
        }])
      }, [we(y("input", {
        "onUpdate:modelValue": p[1] || (p[1] = _ => ft(l) ? l.value = _ : null),
        type: "radio",
        name: "chart-interval",
        value: g.value
      }, null, 8, Cl), [
        [ii, v(l)]
      ]), y("span", kl, I(g.label), 1)], 2))), 128))], 4)]), !f.chart || !f.chart.points.length ? (S(), x("div", jl, [p[3] || (p[3] = y("img", {
        src: xi,
        class: "lines"
      }, null, -1)), p[4] || (p[4] = y("img", {
        src: Sn,
        class: "empty"
      }, null, -1)), y("div", zl, [p[2] || (p[2] = y("div", {
        class: "dot"
      }, null, -1)), y("div", Ll, I(("t" in f ? f.t : v($))("memepad.jetton.chart.coming_text")), 1)])])) : (S(), x("div", El, [v(m) ? (S(), x("div", {
        key: 0,
        class: Xt(["pnl-label", v(m).cls])
      }, I(v(m).label), 3)) : St("", !0), y("div", {
        ref_key: "container",
        ref: e,
        style: {
          width: "100%",
    ...
    setup(n) {
      ...
      return (s, o) => {
        ...
        return S(), x(yt, null, [E(h, {
          ...
          default: Y(() => [y("div", Tl, I(("t" in s ? s.t : v($))("memepad.jetton.unlock.btn")), 1)]),
          _: 1
        }, 8, ["type"]), E(a, {
          modelValue: v(e),
          "onUpdate:modelValue": o[1] || (o[1] = c => ft(e) ? e.value = c : null)
        }, {
          default: Y(() => [y("div", Pl, [y("div", Vl, [E(r, {
            src: v(Es)(s.jetton.iconFileKey),
            size: 80
          }, null, 8, ["src"])]), y("div", Rl, I(("t" in s ? s.t : v($))("memepad.jetton.unlock.sheet.title", {
            ticker: s.jetton.ticker
          })), 1), y("div", Il, I(("t" in s ? s.t : v($))("memepad.jetton.unlock.sheet.subtitle", {
            ticker: s.jetton.ticker
          })), 1), y("div", Wl, [E(l, {
            jetton: s.jetton,
  ...
  Ol = it({
    ...
    setup(n) {
      const t = n,
        e = Mn(Vs);
      if (!e) throw mi("Tabs injection not defined");
      ...
      return (o, h) => (S(), x("label", {
        class: Xt(["kit-tab", [`is-${v(i).toLowerCase()}`, {
          "is-active": v(s)
        }]])
      }, [y("span", Dl, I(n.label), 1), we(y("input", {
  ...
  Fl = it({
    ...
    setup(n) {
      ...
      return Cn(Vs, {
        ...
        return S(), x("div", {
          class: Xt(["kit-tabs", `is-${n.type.toLowerCase()}`])
        }, [we((S(), x("div", Ul, [zn(s.$slots, "default", {}, void 0, !0), (S(!0), x(yt, null, ei(v(i), l => (S(), P(h, {
          key: l.value,
          label: l.label,
          value: l.value,
          type: n.type
  ...
  Gl = it({
    ...
    setup(n) {
      const t = n,
        e = z(() => new Se(t.value.replaceAll(",", "") || "0")),
      ...
      return (h, r) => {
        ...
        const l = Rs,
          ...
          u = Ws,
          d = It;
        return S(), x("div", Jl, [y("div", Xl, [h.inputState ? (S(), x(yt, {
          key: 0
        }, [h.inputState.balanceLabel ? (S(), P(l, {
          key: 0,
          balance: h.inputState.balanceLabel
        }, null, 8, ["balance"])) : (S(), P(a, {
          key: 1,
          class: "skeleton"
        })), h.inputState.error || h.inputState.feesInfo ? (S(), P(c, {
          key: 2,
        ...
        }, null, 8, ["details", "total-label", "error-message"])) : (S(), P(a, {
          key: 3,
          class: "skeleton"
        }))], 64)) : (S(), x(yt, {
          key: 1
          ...
          class: "skeleton"
        })], 64))]), (_ = (g = h.inputState) == null ? void 0 : g.error) != null && _.notEnoughTon ? (S(), P(u, {
          key: 0,
          "jetton-shortname": h.jetton.shortname,
          "jetton-address": h.jetton.address
        }, null, 8, ["jetton-shortname", "jetton-address"])) : (S(), x(yt, {
          key: 1
        }, [h.tab === v(H).BUY ? (S(), P(d, {
          key: 0,
          fill: "",
          ...
          loading: v(s),
          disabled: v(o),
          onClick: r[0] || (r[0] = C => h.$emit("trade"))
        }, {
          default: Y(() => [y("div", Hl, I(("t" in h ? h.t : v($))("memepad.jetton.buy_button_label", {
            ticker: h.jetton.ticker
          })), 1)]),
          _: 1
        }, 8, ["size", "type", "loading", "disabled"])) : St("", !0), h.tab === v(H).SELL ? (S(), P(d, {
          key: 1,
          fill: "",
          size: v(xt).LARGE,
          type: v(jt).PINK,
          loading: v(s),
          disabled: v(o),
          onClick: r[1] || (r[1] = C => h.$emit("trade"))
        }, {
          default: Y(() => [y("div", Yl, I(("t" in h ? h.t : v($))("memepad.jetton.sell_button_label", {
            ticker: h.jetton.ticker
          })), 1)]),
          _: 1
  ...
  ia = it({
    ...
    emits: si(["trade", "unlock-success", "open-slippage"], ["update:modelValue", "update:tradePendings"]),
    setup(n, {
      emit: t
    }) {
      const e = n,
        ...
        u = () => {
          var M;
          e.jettonModalControls.value.value === kt.TRADE && ((M = h.value) == null || M.focusOnInput())
        },
        d = A(e.jettonTrading.slippage);
      bt(() => e.jettonModalControls.isOpened(kt.SLIPPAGE), M => {
        var k;
        d.value = e.jettonTrading.slippage, a(), M || (k = h.value) == null || k.focusOnInput()
      });
      const m = A("0"),
        f = M => ye(M, {
      ...
      const _ = z(() => {
          if (!(!l.value || l.value.loading)) {
            if (C.value.isZero()) return s.value === H.BUY ? `0 ${e.jetton.ticker}` : "0 TON";
            if (!l.value.feesInfo || !l.value.ready) return "";
            if (s.value === H.SELL) {
              const M = l.value.tradeInfo.maxReceive,
                k = `${Ti(M)} TON`;
              if (!e.tonUsdRate) return k;
              const T = Ln(e.tonUsdRate.mul(M));
              return `${k} (≈$${T})`
            } else {
              const M = l.value.tradeInfo.maxReceive;
              return `≈${ye(M,{accuracy:0})} ${e.jetton.ticker}`
            }
          }
        }),
        C = z(() => new Se(m.value.replaceAll(",", "") || "0"));
      let L;
      bt(() => [m.value, e.balances.jettonBalance, e.balances.tonBalance], () => a()), se(() => {
        L == null || L.destroy()
      });

      function j() {
        const M = e.jettonTrading.tradeStateControls,
          k = z(() => M.getImmediateState({
            operation: s.value,
            amount: C.value,
            tonBalance: e.balances.tonBalance,
            jettonBalance: e.balances.jettonBalance,
      ...
      function U() {
        ...
        const T = (w, W) => {
          if (k.push({
            ...
            const G = k.every(Z => Z.amount.eq(k[0].amount)),
              rt = k.every(Z => Z.operation === k[0].operation);
            G && rt && r.disconnect()
          }
        };
        return async () => {
          ...
          const w = s.value,
            ...
            V = e.jetton.address,
            B = e.jetton.address,
            F = e.jetton.shortname;
          await (async () => {
            o.value[w] = !0;
            const R = () => {
                const dt = hi(w === H.BUY ? G.minReceive : W, rt),
                  ot = hi(w === H.BUY ? W : G.minReceive, "TON"),
                  tt = w === H.BUY ? $("memepad.jetton.buy.failed_alert", {
                    askLabel: dt.frontendWithSymbol,
                    offerLabel: ot.frontendWithSymbol
              ...
              N = await (w === H.BUY ? e.jettonTrading.buyJetton(W, G) : e.jettonTrading.sellJetton(W, G));
            if (N.err) {
              En().error("Memepad jetton trade error", N.extra), o.value[w] = !1, R(), T(W, w);
              return
            }
            i("trade");
            const q = N.data;
            L = w === H.BUY ? e.jettonTrading.getWaitForBuyStatus() : e.jettonTrading.getWaitForSellStatus(), await Ls(2e4);
            const K = await L.exec({
                jettonAddress: B,
                transactionHash: q
              }),
              Q = K ? "success" : "failed";
            if (w === H.BUY ? M.memepad.memepadJettonBuy({
                ...
                jettonShortname: F,
                jettonAddress: V,
                purchaseAmount: G.maxReceive.toNumber()
              }), !K) {
              o.value[w] = !1, R();
              return
            }
            const X = w === H.BUY ? $("memepad.jetton.buy.success_alert", {
              ticker: rt,
              label: `${Ti(W)} TON`
            }) : $("memepad.jetton.sell.success_alert", {
              label: `${$n(W).full} ${rt}`
            });
            _e().success(X), o.value[w] = !1, e.tradeSuccessCallback()
          })()
        }
      }
      return (M, k) => {
        ...
        return S(), P(F, {
          ...
          "top-center": Y(() => [E(D, {
            ...
            default: Y(() => [E(T, {
              label: ("t" in M ? M.t : v($))("memepad.jetton.buy_tab"),
              value: v(H).BUY,
              type: v(ni).PRIMARY,
              class: "buy-tab"
            }, null, 8, ["label", "value", "type"]), E(T, {
              label: ("t" in M ? M.t : v($))("memepad.jetton.sell_tab"),
              value: v(H).SELL,
              type: v(ni).SECONDARY,
              class: "sell-tab"
          ...
          default: Y(() => [y("div", ql, [(S(), P(w, {
            ref_key: "actionControlsInputComp",
            ref: h,
            key: s.value,
            modelValue: v(p),
            "onUpdate:modelValue": k[1] || (k[1] = R => ft(p) ? p.value = R : null),
            postfix: s.value === "buy" ? "TON" : M.jetton.ticker,
            modifier: f,
            onBlur: u
          }, null, 8, ["modelValue", "postfix"])), y("div", Ql, [v(_) ? (S(), x("span", ta, I(v(_)), 1)) : v(_) === void 0 ? (S(), P(W, {
            key: 1,
            class: "skeleton"
          })) : St("", !0)]), y("button", {
            type: "button",
            class: "reset slippage-btn",
            onClick: k[2] || (k[2] = R => M.$emit("open-slippage"))
          }, [y("span", ea, I(`${("t"in M?M.t:v($))("memepad.jetton.slippage_btn")} ${v(d)}%`), 1), E(G, {
          ...
          "bottom-action": Y(() => [E(V, {
            ...
            default: Y(() => [M.unlockEnabled ? (S(), P(rt, {
              key: 0,
              jetton: M.jetton,
              "jetton-information": M.jettonInformation,
              balances: M.balances,
              "jetton-management": M.jettonManagement,
              onUnlocked: k[3] || (k[3] = R => M.$emit("unlock-success"))
            }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (S(), P(Z, {
              key: 1,
              value: v(m),
              tab: s.value,
              jetton: M.jetton,
          ...
          "bottom-helpers": Y(() => [E(B, {
            modelValue: v(g),
            "onUpdate:modelValue": k[4] || (k[4] = R => ft(g) ? g.value = R : null),
            tab: s.value,
            balances: M.balances
  ...
  ca = it({
    ...
    setup(n, {
      ...
      const e = n,
        ...
        h = A(e.jettonTrading.slippage.toString()),
        r = z(() => new Se(h.value.replaceAll(",", "") || "0")),
        l = z(() => r.value.lt(la) ? $("memepad.jetton.slippage.error_message.too_low") : r.value.gt(aa) ? $("memepad.jetton.slippage.error_message.too_high") : ""),
        a = () => {
      ...
      return (c, u) => {
        ...
        return S(), P(p, {
          ...
          "top-center": Y(() => [y("div", na, I(("t" in c ? c.t : v($))("memepad.jetton.slippage.title")), 1)]),
          default: Y(() => [y("div", oa, [E(d, {
            ref_key: "actionControlsInputComp",
            ref: s,
            modelValue: v(h),
            "onUpdate:modelValue": u[0] || (u[0] = g => ft(h) ? h.value = g : null),
            postfix: "%",
            modifier: g => ("formatFloatLine" in c ? c.formatFloatLine : v(ye))(g, {
              join: "emptyFractional"
            }),
            onBlur: o
          ...
          "bottom-action": Y(() => [y("div", ha, [v(l) ? (S(), P(m, {
            key: 0,
            "error-message": v(l)
          }, null, 8, ["error-message"])) : (S(), x("div", ra, I(("t" in c ? c.t : v($))("memepad.jetton.slippage.text")), 1)), E(f, {
            label: ("t" in c ? c.t : v($))("memepad.jetton.slippage.done_btn"),
            fill: "",
            size: v(xt).LARGE,
            type: v(l) ? v(jt).HIGHLIGHT : v(jt).PRIMARY,
            disabled: !!v(l),
            onClick: a
  ...
  pa = it({
    ...
    setup(n) {
      return (t, e) => {
        const i = It;
        return S(), x("div", da, [E(i, {
          class: "buy-button",
          type: v(jt).HIGHLIGHT,
          loading: t.tradePendings[v(H).BUY],
          onClick: e[0] || (e[0] = s => t.$emit("click", v(H).BUY))
        }, {
          default: Y(() => [y("span", fa, I(("t" in t ? t.t : v($))("memepad.jetton.buy_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"]), E(i, {
          class: "sell-button",
          type: v(jt).PINK,
          ...
          default: Y(() => [y("span", ma, I(("t" in t ? t.t : v($))("memepad.jetton.sell_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"])])
      }
    }
    ...
    setup(n, {
      ...
      return (c, u) => {
        const d = Al,
          ...
          p = va,
          g = pi;
        return S(), x("div", ba, [E(g, {
          "force-loading": c.unlockEnabled === void 0 && c.isReleased || !c.jettonTrading,
          "button-size": v(xt).MEDIUM
        }, {
          default: Y(() => [c.unlockEnabled ? (S(), P(d, {
            key: 0,
            jetton: c.jetton,
          ...
          }, null, 8, ["jetton", "jetton-information", "balances", "jetton-management"])) : (S(), x(yt, {
            key: 1
          }, [c.jettonModalControls.isOpened(v(kt).TRADE) ? (S(), P(m, {
            key: 0,
            modelValue: v(s),
            "onUpdate:modelValue": u[0] || (u[0] = _ => ft(s) ? s.value = _ : null),
            "trade-pendings": v(o),
            "onUpdate:tradePendings": u[1] || (u[1] = _ => ft(o) ? o.value = _ : null),
            jetton: c.jetton,
            "jetton-information": c.jettonInformation,
          ...
          }, null, 8, ["modelValue", "trade-pendings", "jetton", "jetton-information", "jetton-bcl-data", "balances", "jetton-management", "jetton-trading", "is-released", "unlock-enabled", "ton-usd-rate", "jetton-modal-controls"])) : St("", !0), c.jettonModalControls.isOpened(v(kt).SLIPPAGE) ? (S(), P(f, {
            key: 1,
            "jetton-trading": c.jettonTrading,
            "jetton-modal-controls": c.jettonModalControls,
            onSlippageUpdated: u[4] || (u[4] = _ => c.jettonModalControls.set(v(kt).TRADE))
          }, null, 8, ["jetton-trading", "jetton-modal-controls"])) : St("", !0), E(p, {
            "trade-pendings": v(o),
            onClick: h
  ...
  ya = it({
    ...
    setup(n) {
      const t = n,
        ...
        i = z(() => {
          var o;
          return t.jettonChart && t.jettonChart.type === Bt.MARKET_CAP ? (o = [...t.jettonChart.data.points].sort((h, r) => h.timestamp - r.timestamp).at(-1)) == null ? void 0 : o.price : void 0
        });
      bt(i, o => {
        o && (e.value = o)
      }), bt(() => t.jettonInformation.marketCap, o => {
        i.value || (e.value = o)
      }, {
        immediate: !0
      });
      const s = z(() => {
        var l, a, c, u, d;
        const o = t.jettonBclData && t.jettonBclData.tonCollectedPercent,
          h = ((l = t.jettonBclData) == null ? void 0 : l.tonCollected) || ((a = t.jettonInformation) == null ? void 0 : a.tonCollected),
          r = (c = t.jettonBclData) == null ? void 0 : c.tonForDex;
        return {
      ...
      return (o, h) => {
        ...
        const r = So,
          ...
          u = Xn,
          d = _a;
        return S(), x("div", wa, [E(r, {
          jetton: o.jetton,
          "jetton-information": o.jettonInformation,
          "is-released": o.isReleased,
          "jetton-modal-controls": o.jettonModalControls,
          onShare: h[0] || (h[0] = f => o.$emit("share"))
        }, null, 8, ["jetton", "jetton-information", "is-released", "jetton-modal-controls"]), E(l, {
          jetton: o.jetton,
          "jetton-information": o.jettonInformation,
          class: "stream"
        }, null, 8, ["jetton", "jetton-information"]), E(a, Pn(Vn(v(s))), null, 16), E(c, {
          chart: (m = o.jettonChart) == null ? void 0 : m.data,
          "chart-interval": o.jettonChartInterval,
          "chart-type": o.jettonChartType,
          "jetton-pnl": o.jettonPnl,
          "update-chart-interval": o.updateJettonChartInterval,
          "update-chart-type": o.updateJettonChartType,
          class: "chart"
        }, null, 8, ["chart", "chart-interval", "chart-type", "jetton-pnl", "update-chart-interval", "update-chart-type"]), E(u, {
          reactions: o.jettonReactions,
          "update-callback": o.updateJettonReaction,
          type: "trade",
          class: "reactions"
        }, null, 8, ["reactions", "update-callback"]), E(d, {
          jetton: o.jetton,
          "jetton-information": o.jettonInformation,
          "is-released": o.isReleased,
          "unlock-enabled": o.unlockEnabled,
          balances: o.balances,
          "jetton-management": o.jettonManagement,
          "jetton-trading": o.jettonTrading,
          "ton-usd-rate": o.tonUsdRate,
          "jetton-modal-controls": o.jettonModalControls,
          class: "action-controls",
          onTradeSuccess: h[1] || (h[1] = f => o.$emit("trade-success")),
          onUnlockSuccess: h[2] || (h[2] = f => o.$emit("unlock-success"))
  ...
  Oa = it({
    ...
    setup(n) {
      const t = Rn(),
        ...
        m = Wn(),
        f = Bn().status,
        p = An().getters.getUser,
        {
          jettonBclData: g,
          jettonBalance: _,
          jettonUnlockEnabled: C,
          jettonPnl: L,
          ...j
        } = Z(),
        {
        ...
        T = async () => {
          await Promise.all([m.update(), k.update(), j.update()])
        }, D = async () => {
          ...
          if (!e.value || !o || o.value.status === re.IN_PROGRESS) return {
            status: "loading"
          };
          const V = e.value.address,
            B = [re.PUBLISHED_ON_DEX, re.LISTED_TO_DEX].includes(o.value.status),
            F = {
              jettonBalance: _.value ? hi(_.value, e.value.ticker) : void 0,
              tonBalance: m.wallet.value.status === "connected" ? (K = m.wallet.value.balance) == null ? void 0 : K.tonBalance.balance : void 0
            },
            R = Dn(Nn, {
          ...
          return o.value.status === re.LISTED_TO_DEX ? {
            status: "moving_to_dex",
            jetton: e.value,
            jettonInformation: o.value,
            isReleased: !0,
            unlockEnabled: C.value,
            balances: F,
            jettonManagement: N,
            jettonTrading: q,
            ...
            jettonChartType: k.jettonChartType.value,
            jettonPnl: L.value,
            jettonReactions: h.value,
            updateJettonChartInterval: k.updateChartInterval,
            updateJettonChartType: k.updateChartType,
      ...
      Yn(z(() => w.value.status === "moving_to_dex"), "memepad-jetton-trade-status");
      const W = () => {
          j.init(), k.init()
        },
        G = () => {
      ...
      function rt() {
        ...
        const N = () => {
          ...
          Q = Ft(async () => {
            N();
            const tt = F.value,
              he = await ti.getMemepadJettonChart(i.value, {
                interval: B.value,
                type: tt
              });
            return R.signal.aborted ? at(V.value) : at((Ct(he) ? {
              type: tt,
              data: he.data
            } : V.value) || V.value)
          }, tt => V.value = tt, 5e3);
        return {
          ...
          destroy: () => {
            Q.destroy(), V.value = void 0, B.value = Jt.ONE_MINUTE
          },
          update: async () => await Q.exec(),
          updateChartInterval: q,
          updateChartType: K,
          jettonChartInterval: z(() => B.value),
          jettonChartType: z(() => F.value),
          jettonChart: z(() => V.value)
        }
      }
      ...
      function Z() {
        const V = A(),
          ...
          F = A(),
          R = A();
        let N, q, K, Q, X, dt, ot, tt;

        function he() {
          q = bt(w, ct => {
            ct.status === "loading" || N || ct.jettonManagement && (q == null || q(), N = Ft(async () => {
              if (w.value.status === "loading") return at(void 0);
              const st = w.value.jetton.address,
                Lt = await w.value.jettonManagement.getJettonBclData(st);
              return at((Ct(Lt) ? Lt.data : V.value) || V.value)
            }, st => V.value = st, 6e4), N == null || N.exec())
          }, {
            immediate: !0
          }), Q = bt(w, ct => {
            ct.status === "loading" || K || !ct.jettonTrading || f.value !== "connected" || (Q == null || Q(), K = Ft(async () => {
              if (w.value.status === "loading" || !w.value.jettonTrading || f.value !== "connected") return at(void 0);
              const st = w.value.jetton.address,
                Lt = await w.value.jettonTrading.getUserJettonBalance(st);
              return at((Ct(Lt) ? Lt.data : B.value) || B.value)
            }, st => B.value = st, 6e4), K == null || K.exec())
          }, {
            immediate: !0
          }), dt = bt(w, ct => {
            ct.status === "loading" || X || !ct.jetton || !ct.balances.jettonBalance || !ct.isReleased || f.value !== "connected" || (dt == null || dt(), X = Ft(async () => {
              if (w.value.status === "loading" || !w.value.balances.jettonBalance || !w.value.isReleased || f.value !== "connected") return at(void 0);
              if (w.value.balances.jettonBalance.value.isZero()) return at(!1);
              const st = await w.value.jettonManagement.getUnlockEnabled(w.value.jetton.address);
              return at(Ct(st) ? st.data : F.value)
            }, st => F.value = st, 6e4), X == null || X.exec())
          }, {
            immediate: !0
          }), tt = bt(w, ct => {
            ct.status === "loading" || ot || m.wallet.value.status === "connected" && (tt == null || tt(), ot = Ft(async () => {
              if (w.value.status === "loading" || m.wallet.value.status !== "connected") return at(void 0);
              const st = w.value.jetton.shortname,
                Lt = m.wallet.value.address.default,
                Ei = await ti.getMemepadJettonPnl(st, Lt);
              return at((Ct(Ei) ? Ei.data : R.value) || R.value)
            }, st => R.value = st, 6e4), ot == null || ot.exec())
          }, {
            immediate: !0
          })
        }
        return {
          init: he,
          destroy: () => {
            q == null || q(), N == null || N.destroy(), Q == null || Q(), K == null || K.destroy(), dt == null || dt(), X == null || X.destroy(), tt == null || tt(), ot == null || ot.destroy(), V.value = void 0, B.value = void 0, F.value = void 0, R.value = void 0
          },
          update: async () => {
            await (N == null ? void 0 : N.exec()), await (K == null ? void 0 : K.exec()), await (X == null ? void 0 : X.exec()), ot == null || ot.exec()
          },
          resetAndUpdateUnlocked: async () => {
            F.value = void 0, await (X == null ? void 0 : X.exec())
          },
          jettonBclData: z(() => V.value),
          jettonBalance: z(() => B.value),
          jettonUnlockEnabled: z(() => F.value),
          jettonPnl: z(() => R.value)
        }
      }
      return (V, B) => {
        const F = mn,
          R = ao,
          N = Sa;
        return v(w).status === "loading" ? (S(), P(F, {
          key: 0
        })) : v(w).status === "moving_to_dex" ? (S(), P(R, {
          key: 1,
          jetton: v(w).jetton,
          ...
          "is-released": ""
        }, null, 8, ["jetton", "jetton-information", "unlock-enabled", "balances", "jetton-management"])) : (S(), P(N, {
          key: 2,
          jetton: v(w).jetton,
          "jetton-information": v(w).jettonInformation,
          ...
          onTradeSuccess: T,
          onUnlockSuccess: D,
          onShare: B[0] || (B[0] = q => V.$emit("share"))
