    ...
    setup(n, {
      ...
      return (d, p) => {
        ...
        return U(), q("div", cc, [H("div", lc, [$(o) ? (U(), q(xt, {
          ...
          key: 0,
          "error-message": $(r)
        }, null, 8, ["error-message"])) : (U(), q("div", dc, [st(k, {
          "text-min-width": 155,
          alignment: $(Ci).TOP
        }, {
          default: Dt(() => [st(P, {
...
(function(n) {
  ...
  function p(k, A, h) {
    if (h.batchType === "old") return k.push(...A), k;
    if (k.length === 0) return k.push(...A), k;
    let m = 0;
    for (; m < k.length && n.LT_COLLATOR.compare(k[m].id.lt, h.maxLt) >= 0;) ++m;
    return k.splice(m, 0, ...A), k
  }
      ...
      i = l => {
        ...
        if (p != null) {
          ...
          if (f != null) {
            ...
            k.finished || (k.finished = !0, P.clear(), P.enqueue(async () => y(k.eof)))
          }
    ...
    return new qt((l, d) => {
      ...
      const A = this.provider.subscribe(t, {
        ...
        for (const {
          ...
          of k.values()) v.eof || v.finished || w.enqueue(async () => {
          await B(m) || (v.eof = !0, i(o))
        })
      }), h.on("unsubscribed", () => {
        for (const m of k.keys()) i(m)
      }), h)).catch(h => {
        console.error(h);
        for (const m of k.keys()) i(m);
        throw h
  ...
  constructor(t, e, s, r) {
    this.makeProducer = t, this.stopProducer = e, this.extractor = s, this.isFinite = r, this.fold = this.onlyFinite((i, o, l) => {
      ...
      return new Promise((p, f) => {
        const P = this.makeProducer(y => this.extractor(y, async k => (d = await o(d, k), !0)), y => {
          ...
          return {
            promise: (async () => {
              ...
              for (;;) {
                ...
                let y;
                const k = new Promise((A, h) => {
                  y = () => A(), o.reject = () => h()
                });
                if (o.timeout = setTimeout(y, p), await k, o.stopped) return;
      ...
      if (f.length > 0) {
        const P = await Promise.all(f.map(async y => ({
          ...
          events: await this.decodeTransactionEvents({
            transaction: y
          }).then(k => (k.forEach(A => A.transaction = y), k))
        })));
        for (let {
            tx: y,
            events: k
          ...
          of P) {
          i != null && (k = await Promise.all(k.map(async A => await i(A) ? A : void 0)).then(A => A.filter(h => h != null))), l = y.id;
          for (const A of k) {
  ...
  async sendWithResult(t) {
    ...
    try {
      ...
      e.transactions(this.address).flatMap(k => k.transactions).filter(k => {
        ...
        r == null ? l.push(k) : r.possibleMessages.findIndex(A => A.hash == k.inMessage.hash) >= 0 && (i == null || i(k))
      });
      const d = await this.send(t),
        p = d.outMessages.filter(k => {
          var A;
      ...
      const f = l.find(k => p.findIndex(A => A.hash == k.inMessage.hash) >= 0);
      f != null && (i == null || i(f));
      const P = await o;
      let y;
      try {
        ...
        k != null && (y = this.functionAbi.outputs != null ? (0, Rt.parseTokensObject)(this.functionAbi.outputs, k.output) : {})
      } catch (k) {
        console.error(k)
      }
      return {
...
(function(n) {
  ...
  const k = () => P ? window.__ever || window.ton : void 0;
  async function A() {
  ...
  class h {
    constructor(b = {}) {
      ...
      this.Subscriber = x, this._api = new Proxy({}, {
        ...
        this._provider = u
      }) : Promise.resolve() : (this._provider = k(), this._provider != null ? this._initializationPromise = Promise.resolve() : this._initializationPromise = A().then(u => new Promise(_ => {
        if (!u) return _();
        if (this._provider = k(), this._provider != null) _();
        else {
        ...
        case "contractStateChanged": {
          ...
          const _ = R.address.toString(),
            g = new j(async E => {
              ...
              try {
                (F.transactions !== I.transactions || F.state !== I.state) && await this.rawApi.subscribe({
                  address: _,
                  subscriptions: F
                })
              } catch (M) {
...
var ms = {};
(function(n) {
  var t = rt && rt.__awaiter || function(f, P, y, k) {
      function A(h) {
    ...
    e = rt && rt.__generator || function(f, P) {
      var y = {
        ...
        k, A, h, m = Object.create((typeof Iterator == "function" ? Iterator : Object).prototype);
      ...
      function w(v) {
        ...
        for (; m && (m = 0, v[0] && (y = 0)), y;) try {
          if (k = 1, A && (h = v[0] & 2 ? A.return : v[0] ? A.throw || ((h = A.return) && h.call(A), 0) : A.next) && !(h = h.call(A, v[1])).done) return h;
    ...
    s = rt && rt.__spreadArray || function(f, P, y) {
      if (y || arguments.length === 2)
        for (var k = 0, A = P.length, h; k < A; k++)(h || !(k in P)) && (h || (h = Array.prototype.slice.call(P, 0, k)), h[k] = P[k]);
  ...
  n.checkQueue = l;
  var d = function(f, P) {
    for (var y = [], k = 2; k < arguments.length; k++) y[k - 2] = arguments[k];
  ...
  var p = function(f, P, y) {
    ...
    return t(void 0, s([f, P, y], k, !0), void 0, function(h, m, B, w) {
      var v, b, R, j, x, u, _, g;
        ...
        return r(this, void 0, void 0, function() {
          ...
          return i(this, function(I) {
            switch (I.label) {
              ...
              case 2:
                return b = I.sent(), [4, (0, f.getCodeAirdropAndAmount)(v.factory, this.rpc, this.options.deployValue)];
              case 3:
                return R = I.sent(), j = R.codeAirdrop, x = R.amount, [4, this.rpc.mergeTvc({
                  code: j ?? "",
                  data: "te6ccgEBAgEAKAABAcABAEPQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAg"
                })];
              case 4:
                return u = I.sent(), [4, this.rpc.getStateInit(d.AirdropAbi, {
                  workchain: 0,
                  initParams: {
                    _data: v.data,
                    _nonce: v.nonce
              ...
              case 5:
                return _ = I.sent(), g = _.stateInit, E = _.address, T = this.clock.time, [4, this.tonConnect.sendTransaction({
                  messages: [{
                    amount: x,
              ...
              case 7:
                return F = I.sent(), console.error(F), [3, 8];
              case 8:
...
function He() {
  return (en === null || en.byteLength === 0) && (en = new Uint8Array(c.memory.buffer)), en
}

function yt(n, t) {
  return n = n >>> 0, Fr.decode(He().subarray(n, n + t))
}
...
function Y(n, t, e) {
  if (e === void 0) {
    const l = vn.encode(n),
      d = t(l.length, 1) >>> 0;
    return He().subarray(d, d + l.length).set(l), Q = l.length, d
  }
  let s = n.length,
    r = t(s, 1) >>> 0;
  const i = He();
...
function il(n, t) {
  ...
  return He().set(n, e / 1), Q = n.length, e
}
...
function cl(n, t, e, s, r, i, o) {
  try {
    ...
    const P = Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      y = Q,
      k = Y(e, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q,
      h = Y(s, c.__wbindgen_malloc, c.__wbindgen_realloc),
      m = Q;
    c.runLocal(f, n.__wbg_ptr, P, y, k, A, h, m, Z(r), i, !At(o), At(o) ? 0 : o);
...
function pl(n, t, e, s, r, i, o) {
  try {
    const y = c.__wbindgen_add_to_stack_pointer(-16),
      k = Y(n, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q,
    ...
    var l = At(i) ? 0 : Y(i, c.__wbindgen_malloc, c.__wbindgen_realloc),
      d = Q;
    c.executeLocal(y, k, A, h, m, B, w, s, r, l, d, !At(o), At(o) ? 0 : o);
...
function fl(n, t, e, s, r) {
  try {
    const f = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      y = Q,
      k = Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q;
    var i = At(s) ? 0 : Y(s, c.__wbindgen_malloc, c.__wbindgen_realloc),
      o = Q;
    c.getExpectedAddress(f, P, y, k, A, e, i, o, Z(r));
    var l = D().getInt32(f + 4 * 0, !0),
      d = D().getInt32(f + 4 * 1, !0),
      p = D().getInt32(f + 4 * 2, !0);
    if (p) throw V(d);
...
function Cl(n, t, e) {
  ...
  try {
    const P = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      h = Q;
    c.encodeInternalInput(P, y, k, A, h, Z(e));
    var i = D().getInt32(P + 4 * 0, !0),
      o = D().getInt32(P + 4 * 1, !0),
      l = D().getInt32(P + 4 * 2, !0),
      d = D().getInt32(P + 4 * 3, !0),
...
function Pl(n, t, e, s, r, i, o) {
  ...
  try {
    ...
    var P = At(s) ? 0 : Y(s, c.__wbindgen_malloc, c.__wbindgen_realloc),
      y = Q,
      k = At(r) ? 0 : Y(r, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q;
    const u = Y(i, c.__wbindgen_malloc, c.__wbindgen_realloc),
      _ = Q;
    c.encodeInternalMessage(R, p, f, j, x, e, P, y, k, A, u, _, At(o) ? 16777215 : o ? 1 : 0);
...
function Fl(n, t, e) {
  ...
  try {
    const P = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      A = Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      h = Q;
    c.ed25519_sign(P, y, k, A, h, !At(e), At(e) ? 0 : e);
    var i = D().getInt32(P + 4 * 0, !0),
      o = D().getInt32(P + 4 * 1, !0),
      l = D().getInt32(P + 4 * 2, !0),
      d = D().getInt32(P + 4 * 3, !0),
...
function Bl(n, t, e, s) {
  try {
    const l = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      k = Q;
    c.verifySignature(l, d, p, f, P, y, k, !At(s), At(s) ? 0 : s);
    var r = D().getInt32(l + 4 * 0, !0),
      i = D().getInt32(l + 4 * 1, !0),
      o = D().getInt32(l + 4 * 2, !0);
    if (o) throw V(i);
...
function jl(n, t, e, s) {
  try {
    ...
    var r = At(t) ? 0 : Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      ...
      l = Q;
    c.createRawExternalMessage(P, y, k, r, i, o, l, s);
...
function xl(n, t, e, s, r, i, o) {
  try {
    const y = c.__wbindgen_add_to_stack_pointer(-16);
    ue(n, we);
    const k = Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q,
    ...
    var l = At(r) ? 0 : Y(r, c.__wbindgen_malloc, c.__wbindgen_realloc),
      d = Q;
    c.createExternalMessageWithoutSignature(y, n.__wbg_ptr, k, A, h, m, B, w, l, d, Z(i), o);
    var p = D().getInt32(y + 4 * 0, !0),
      f = D().getInt32(y + 4 * 1, !0),
      P = D().getInt32(y + 4 * 2, !0);
    if (P) throw V(f);
...
function Ul(n, t, e, s, r, i, o, l) {
  try {
    ...
    const b = Y(o, c.__wbindgen_malloc, c.__wbindgen_realloc),
      R = Q;
    c.createExternalMessage(k, n.__wbg_ptr, A, h, m, B, w, v, d, p, Z(i), b, R, l);
    var f = D().getInt32(k + 4 * 0, !0),
      P = D().getInt32(k + 4 * 1, !0),
      y = D().getInt32(k + 4 * 2, !0);
    if (y) throw V(P);
    return jn.__wrap(f)
  } finally {
    c.__wbindgen_add_to_stack_pointer(16)
...
function zr(n, t) {
  return c = n.exports, Wr.__wbindgen_wasm_module = t, $e = null, en = null, c
}
      ...
      async _selectQueryingEndpoint() {
        ...
        for (let o = 0; o < 5; ++o) {
          ...
          try {
            ...
            setTimeout(() => y(), Math.min(100 * o, 5e3)), await k
          }
        }
...
(function(n) {
  ...
  async function p(h) {
    ...
    try {
      const w = new y(B);
      await w._connect(m), w._initializedTransport != null && k(w._initializedTransport)
    } catch (w) {
    ...
    return this._subscriptionsMutex.use(async () => {
      const r = f => {
          ...
          return Object.keys(P).map(y => {
            ...
            const k = e[y];
            if (typeof k == "boolean") P[y] = k;
            else {
              if (k == null) return;
              throw new Error(`Unknown subscription topic value ${y}: ${k}`)
            }
          }), P
        },
...
Qe.MsigAccount = Qe.GenericAccount = void 0;
const Su = ee;
class Zr {
  constructor(t) {
...
function qr(n) {
  ...
  function w(u, _) {
    ...
    if (_ == null) {
      ...
      if ((I = typeof u == "number") && u * 0 == 0) {
        ...
        if (!Eu.test(K = String(u))) return s(L, K, I);
      ...
      if (K = String(u), I = typeof u == "number") {
        if (u * 0 != 0) return s(L, K, I, _);
      ...
      for (g = m.slice(0, _), O = F = 0, M = K.length; F < M; F++)
        if (g.indexOf(E = K.charAt(F)) < 0) {
          ...
          return s(L, String(u), I, _)
        } I = !1, K = e(K, _, 10, L.s), (O = K.indexOf(".")) > -1 ? K = K.replace(".", "") : O = K.length
    }
    for (F = 0; K.charCodeAt(F) === 48; F++);
    for (M = K.length; K.charCodeAt(--M) === 48;);
    if (K = K.slice(F, ++M)) {
      if (M -= F, I && w.DEBUG && M > 15 && (u > cs || u !== ce(u))) throw Error(sr + L.s * u);
  ...
  w.clone = qr, w.ROUND_UP = 0, w.ROUND_DOWN = 1, w.ROUND_CEIL = 2, w.ROUND_FLOOR = 3, w.ROUND_HALF_UP = 4, w.ROUND_HALF_DOWN = 5, w.ROUND_HALF_EVEN = 6, w.ROUND_HALF_CEIL = 7, w.ROUND_HALF_FLOOR = 8, w.EUCLID = 9, w.config = w.set = function(u) {
    ...
    if (u != null)
      if (typeof u == "object") {
        ...
        if (u.hasOwnProperty(_ = "MODULO_MODE") && (g = u[_], Ot(g, 0, 9, _), k = g), u.hasOwnProperty(_ = "POW_PRECISION") && (g = u[_], Ot(g, 0, Wt, _), A = g), u.hasOwnProperty(_ = "FORMAT"))
    ...
    return function(g) {
      ...
      if (g == null ? g = o : Ot(g, 0, Wt), F = os(g / lt), y)
        if (crypto.getRandomValues) {
          for (E = crypto.getRandomValues(new Uint32Array(F *= 2)); M < F;) I = E[M] * 131072 + (E[M + 1] >>> 11), I >= 9e15 ? (T = crypto.getRandomValues(new Uint32Array(2)), E[M] = T[0], E[M + 1] = T[1]) : (K.push(I % 1e14), M += 2);
          M = F / 2
        } else if (crypto.randomBytes) {
        for (E = crypto.randomBytes(F *= 7); M < F;) I = (E[M] & 31) * 281474976710656 + E[M + 1] * 1099511627776 + E[M + 2] * 4294967296 + E[M + 3] * 16777216 + (E[M + 4] << 16) + (E[M + 5] << 8) + E[M + 6], I >= 9e15 ? crypto.randomBytes(7).copy(E, M) : (K.push(I % 1e14), M += 7);
        M = F / 7
      } else throw y = !1, Error(re + "crypto unavailable");
      if (!y)
        for (; M < F;) I = _(), I < 9e15 && (K[M++] = I % 1e14);
      for (F = K[--M], g %= lt, F && g && (I = ls[lt - g], K[M] = ce(F / I) * I); K[M] === 0; K.pop(), M--);
      if (M < 0) K = [O = 0];
      else {
    ...
    function _(g, E, T, O) {
      for (var F, I = [0], M, K = 0, L = g.length; K < L;) {
        for (M = I.length; M--; I[M] *= E);
        for (I[0] += O.indexOf(g.charAt(K++)), F = 0; F < I.length; F++) I[F] > T - 1 && (I[F + 1] == null && (I[F + 1] = 0), I[F + 1] += I[F] / T | 0, I[F] %= T)
      }
      return I.reverse()
    }
    return function(g, E, T, O, F) {
      var I, M, K, L, W, it, ot, ft, St = g.indexOf("."),
        Lt = o,
        pt = l;
      for (St >= 0 && (L = A, A = 0, g = g.replace(".", ""), ft = new w(E), it = ft.pow(g.length - St), A = L, ft.c = _(be(oe(it.c), it.e, "0"), 10, T, u), ft.e = ft.c.length), ot = _(g, E, T, F ? (I = m, u) : (I = u, m)), K = L = ot.length; ot[--L] == 0; ot.pop());
      if (!ot[0]) return I.charAt(0);
      if (St < 0 ? --K : (it.c = ot, it.e = K, it.s = O, it = t(it, ft, Lt, pt, T), ot = it.c, W = it.r, K = it.e), M = K + Lt + 1, St = ot[M], L = T / 2, W = W || M < 0 || ot[M + 1] != null, W = pt < 4 ? (St != null || W) && (pt == 0 || pt == (it.s < 0 ? 3 : 2)) : St > L || St == L && (pt == 4 || W || pt == 6 && ot[M - 1] & 1 || pt == (it.s < 0 ? 8 : 7)), M < 1 || !ot[0]) g = W ? be(I.charAt(1), -Lt, I.charAt(0)) : I.charAt(0);
      else {
        if (ot.length = M, W)
          for (--T; ++ot[--M] > T;) ot[M] = 0, M || (++K, ot = [1].concat(ot));
        for (L = ot.length; !ot[--L];);
        for (St = 0, g = ""; St <= L; g += I.charAt(ot[St++]));
        g = be(g, K, I.charAt(0))
      }
      return g
    }
    ...
    function u(E, T, O) {
      var F, I, M, K, L = 0,
        ...
        it = T % Se,
        ot = T / Se | 0;
      for (E = E.slice(); W--;) M = E[W] % Se, K = E[W] / Se | 0, F = ot * M + K * it, I = it * M + F % Se * Se + L, L = (I / O | 0) + (F / Se | 0) + ot * K, E[W] = I % O;
    ...
    function g(E, T, O, F) {
      for (var I = 0; O--;) E[O] -= I, I = E[O] < T[O] ? 1 : 0, E[O] = I * F + E[O] - T[O];
      for (; !E[0] && E.length > 1; E.splice(0, 1));
    }
    return function(E, T, O, F, I) {
      var M, K, L, W, it, ot, ft, St, Lt, pt, mt, Ut, je, Xe, Ze, ae, Pe, ne = E.s == T.s ? 1 : -1,
        Ht = E.c,
        Tt = T.c;
      if (!Ht || !Ht[0] || !Tt || !Tt[0]) return new w(!E.s || !T.s || (Ht ? Tt && Ht[0] == Tt[0] : !Tt) ? NaN : Ht && Ht[0] == 0 || !Tt ? ne * 0 : ne / 0);
      for (St = new w(ne), Lt = St.c = [], K = E.e - T.e, ne = O + K + 1, I || (I = pe, K = le(E.e / lt) - le(T.e / lt), ne = ne / lt | 0), L = 0; Tt[L] == (Ht[L] || 0); L++);
      if (Tt[L] > (Ht[L] || 0) && K--, ne < 0) Lt.push(1), W = !0;
      else {
        for (Xe = Ht.length, ae = Tt.length, L = 0, ne += 2, it = ce(I / (Tt[0] + 1)), it > 1 && (Tt = u(Tt, it, I), Ht = u(Ht, it, I), ae = Tt.length, Xe = Ht.length), je = ae, pt = Ht.slice(0, ae), mt = pt.length; mt < ae; pt[mt++] = 0);
        Pe = Tt.slice(), Pe = [0].concat(Pe), Ze = Tt[0], Tt[1] >= I / 2 && Ze++;
        do {
          if (it = 0, M = _(Tt, pt, ae, mt), M < 0) {
            if (Ut = pt[0], ae != mt && (Ut = Ut * I + (pt[1] || 0)), it = ce(Ut / Ze), it > 1)
              for (it >= I && (it = I - 1), ot = u(Tt, it, I), ft = ot.length, mt = pt.length; _(ot, pt, ft, mt) == 1;) it--, g(ot, ae < ft ? Pe : Tt, ft, I), ft = ot.length, M = 1;
            else it == 0 && (M = it = 1), ot = Tt.slice(), ft = ot.length;
            if (ft < mt && (ot = [0].concat(ot)), g(pt, ot, mt, I), mt = pt.length, M == -1)
              for (; _(Tt, pt, ae, mt) < 1;) it++, g(pt, ae < mt ? Pe : Tt, mt, I), mt = pt.length
          } else M === 0 && (it++, pt = [0]);
          Lt[L++] = it, pt[0] ? pt[mt++] = Ht[je] || 0 : (pt = [Ht[je]], mt = 1)
        } while ((je++ < Xe || pt[0] != null) && ne--);
  ...
  function v(u, _, g, E) {
    ...
    else if (u = j(new w(u), _, g), O = u.e, M = oe(u.c), I = M.length, E == 1 || E == 2 && (_ <= O || O <= d)) {
      for (; I < _; M += "0", I++);
      M = wn(M, O)
    } else if (_ -= F, M = be(M, O, "0"), O + 1 > I) {
      if (--_ > 0)
        for (M += "."; _--; M += "0");
    } else if (_ += O - I, _ > 0)
      for (O + 1 == I && (M += "."); _--; M += "0");
  ...
  s = function() {
    var u = /^(-?)0([xbo])(?=\w[\w.]*$)/i,
      ...
      E = /^-?(Infinity|NaN)$/,
      T = /^\s*\+(?=[\w.])|^\s+|\s+$/g;
    return function(O, F, I, M) {
      var K, L = I ? F : F.replace(T, "");
      if (E.test(L)) O.s = isNaN(L) ? null : L < 0 ? -1 : 1;
      else {
        if (!I && (L = L.replace(u, function(W, it, ot) {
  ...
  function j(u, _, g, E) {
    var T, O, F, I, M, K, L, W = u.c,
      it = ls;
    if (W) {
      t: {
        for (T = 1, I = W[0]; I >= 10; I /= 10, T++);
        if (O = _ - T, O < 0) O += lt,
        F = _,
        M = W[K = 0],
        L = ce(M / it[T - F - 1] % 10);
        ...
        u;
        if (O == 0 ? (W.length = K, I = 1, K--) : (W.length = K + 1, I = it[lt - O], W[K] = F > 0 ? ce(M / it[T - F] % it[F]) * I : 0), E)
          for (;;)
            if (K == 0) {
              for (O = 1, F = W[0]; F >= 10; F /= 10, O++);
              for (F = W[0] += I, I = 1; F >= 10; F /= 10, I++);
              O != I && (u.e++, W[0] == pe && (W[0] = 1));
              break
            } else {
              if (W[K] += I, W[K] != pe) break;
              W[K--] = 0, I = 1
  ...
  return r.absoluteValue = r.abs = function() {
    ...
    var g, E, T, O, F, I, M, K, L, W = this;
    if (u = new w(u), u.c && !u.isInteger()) throw Error(re + "Exponent not an integer: " + x(u));
    if (_ != null && (_ = new w(_)), I = u.e > 14, !W.c || !W.c[0] || W.c[0] == 1 && !W.e && W.c.length == 1 || !u.c || !u.c[0]) return L = new w(Math.pow(+x(W), I ? u.s * (2 - mn(u)) : +x(u))), _ ? L.mod(_) : L;
    if (M = u.s < 0, _) {
      if (_.c ? !_.c[0] : !_.s) return new w(NaN);
      E = !M && W.isInteger() && _.isInteger(), E && (W = W.mod(_))
    } else {
      if (u.e > 9 && (W.e > 0 || W.e < -1 || (W.e == 0 ? W.c[0] > 1 || I && W.c[1] >= 24e7 : W.c[0] < 8e13 || I && W.c[0] <= 9999975e7))) return O = W.s < 0 && mn(u) ? -0 : 0, W.e > -1 && (O = 1 / O), new w(M ? 1 / O : O);
      A && (O = os(A / lt + 2))
    }
    for (I ? (g = new w(.5), M && (u.s = 1), K = mn(u)) : (T = Math.abs(+x(u)), K = T % 2), L = new w(i);;) {
      if (K) {
    ...
    var g, E, T, O, F = this,
      I = F.s;
    if (u = new w(u, _), _ = u.s, !I || !_) return new w(NaN);
    if (I != _) return u.s = -_, F.plus(u);
    var M = F.e / lt,
      K = u.e / lt,
      L = F.c,
      W = u.c;
    ...
    if (M = le(M), K = le(K), L = L.slice(), I = M - K) {
      for ((O = I < 0) ? (I = -I, T = L) : (K = M, T = W), T.reverse(), _ = I; _--; T.push(0));
      T.reverse()
    } else
      for (E = (O = (I = L.length) < (_ = W.length)) ? I : _, I = _ = 0; _ < E; _++)
        if (L[_] != W[_]) {
          O = L[_] < W[_];
          break
    ...
    var g, E, T = this;
    return u = new w(u, _), !T.c || !u.s || u.c && !u.c[0] ? new w(NaN) : !u.c || T.c && !T.c[0] ? new w(T) : (k == 9 ? (E = u.s, u.s = 1, g = t(T, u, 0, 3), u.s = E, g.s *= E) : g = t(T, u, 0, k), u = T.minus(g.times(u)), !u.c[0] && k == 1 && (u.s = T.s), u)
  }, r.multipliedBy = r.times = function(u, _) {
    var g, E, T, O, F, I, M, K, L, W, it, ot, ft, St, Lt, pt = this,
      mt = pt.c,
      Ut = (u = new w(u, _)).c;
    ...
    for (St = pe, Lt = Se, T = W; --T >= 0;) {
      for (g = 0, it = Ut[T] % Lt, ot = Ut[T] / Lt | 0, F = M, O = T + F; O > T;) K = mt[--F] % Lt, L = mt[F] / Lt | 0, I = ot * K + L * it, K = it * K + I % Lt * Lt + ft[O] + g, g = (K / St | 0) + (I / Lt | 0) + ot * L, ft[O--] = K % St;
      ft[O] = g
    }
    ...
    var O = E.e / lt,
      ...
      M = u.c;
    if (!O || !F) {
      if (!I || !M) return new w(T / 0);
      if (!I[0] || !M[0]) return M[0] ? u : new w(I[0] ? E : T * 0)
    }
    if (O = le(O), F = le(F), I = I.slice(), T = O - F) {
      for (T > 0 ? (F = O, g = M) : (T = -T, g = I), g.reverse(); T--; g.push(0));
      g.reverse()
    }
    for (T = I.length, _ = M.length, T - _ < 0 && (g = M, M = I, I = g, _ = T), T = 0; _;) T = (I[--_] = I[_] + M[_] + T) / pe | 0, I[_] = pe === I[_] ? 0 : I[_] % pe;
    return T && (I = [T].concat(I), ++F), R(u, I, F)
    ...
    var u, _, g, E, T, O = this,
      ...
      K = o + 4,
      L = new w("0.5");
    if (I !== 1 || !F || !F[0]) return new w(!I || I < 0 && (!F || F[0]) ? NaN : F ? O : 1 / 0);
    if (I = Math.sqrt(+x(O)), I == 0 || I == 1 / 0 ? (_ = oe(F), (_.length + M) % 2 == 0 && (_ += "0"), I = Math.sqrt(+_), M = le((M + 1) / 2) - (M < 0 || M % 2), I == 1 / 0 ? _ = "5e" + M : (_ = I.toExponential(), _ = _.slice(0, _.indexOf("e") + 1) + M), g = new w(_)) : g = new w(I + ""), g.c[0]) {
      for (M = g.e, I = M + K, I < 3 && (I = 0);;)
        if (T = g, g = L.times(T.plus(t(O, T, K, 1))), oe(T.c).slice(0, I) === (_ = oe(g.c)).slice(0, I))
          if (g.e < M && --I, _ = _.slice(I - 3, I + 1), _ == "9999" || !E && _ == "4999") {
    ...
    if (E = T.toFixed(u, _), T.c) {
      var O, F = E.split("."),
        ...
        ot = it ? L.slice(1) : L,
        ft = ot.length;
      if (M && (O = I, I = M, M = O, ft -= O), I > 0 && ft > 0) {
        for (O = ft % I || I, L = ot.substr(0, O); O < ft; O += I) L += K + ot.substr(O, I);
    ...
    var _, g, E, T, O, F, I, M, K, L, W, it, ot = this,
      ft = ot.c;
    if (u != null && (I = new w(u), !I.isInteger() && (I.c || I.s !== 1) || I.lt(i))) throw Error(re + "Argument " + (I.isInteger() ? "out of range: " : "not an integer: ") + x(I));
    if (!ft) return new w(ot);
    for (_ = new w(i), K = g = new w(i), E = M = new w(i), it = oe(ft), O = _.e = it.length - ot.e - 1, _.c[0] = ls[(F = O % lt) < 0 ? lt + F : F], u = !u || I.comparedTo(_) > 0 ? O > 0 ? _ : K : I, F = P, P = 1 / 0, I = new w(it), M.c[0] = 0; L = t(I, _, 0, 1), T = g.plus(L.times(E)), T.comparedTo(u) != 1;) g = E, E = T, K = M.plus(L.times(T = K)), M = T, _ = I.minus(L.times(T = _)), I = T;
...
class Mn {
  ...
  async prepareMessage(t, e) {
    ...
    f.signatureHigh = k.high, f.signatureLow = k.low;
...
class On {
  static async computeAddress(t) {
    ...
    const e = t.publicKey instanceof sn.default ? t.publicKey : new sn.default(`0x${t.publicKey}`),
      s = ar(e).hash;
    return new Lu.Address(`${t.workchain!=null?t.workchain:0}:${s}`)
  }
  static async fromPubkey(t) {
    const e = new sn.default(`0x${t.publicKey}`),
  ...
  async fetchPublicKey(t) {
    let e = this.publicKey;
    return e == null && (e = this.publicKey = await t.fetchPublicKey(this.address).then(s => new sn.default(`0x${s}`))), e.toString(16).padStart(64, "0")
  }
  async prepareMessage(t, e) {
    const {
      publicKey: s,
    ...
    const y = e.packIntoCell({
      ...
      k = await i.sign(y, t.signatureId),
      {
        signatureParts: A
      } = e.extendSignature(k);
...
const Fu = (n, t) => {
    ...
    return {
      publicKey: new sn.default(e.publicKey)
    }
  },
  ar = n => {
...
class Nn {
  static async computeAddress(t) {
    ...
    const e = t.publicKey instanceof tn.default ? t.publicKey : new tn.default(`0x${t.publicKey}`),
      s = or(e, t.nonce).hash;
    return new ju.Address(`${t.workchain!=null?t.workchain:0}:${s}`)
  }
  static async fromPubkey(t) {
    const e = new tn.default(`0x${t.publicKey}`),
  ...
  async fetchPublicKey(t) {
    let e = this.publicKey;
    return e == null && (e = this.publicKey = await t.fetchPublicKey(this.address).then(s => new tn.default(`0x${s}`)), this.isDeployed = !0), e.toString(16).padStart(64, "0")
  }
  async prepareMessage(t, e) {
    const {
      publicKey: s,
  ...
  async fetchState(t) {
    ...
    if (this.isDeployed === !0 && this.publicKey != null) s = this.publicKey;
      ...
      } else this.isDeployed = !0, s = new tn.default(`0x${$n.default.nekoton.extractPublicKey(r.boc)}`);
...
(function(n) {
  ...
  class l {
    constructor(f, P, y, k) {
      this.clock = f, this.connectionController = P, this.nekoton = y, this.keystore = k
    }
    async getSigner(f) {
...
Zn.Clock = Yu;
(function(n) {
  var t = rt && rt.__createBinding || (Object.create ? function(S, a, C, N) {
      N === void 0 && (N = C);
      ...
      }), Object.defineProperty(S, N, z)
    } : function(S, a, C, N) {
      N === void 0 && (N = C), S[N] = a[C]
    }),
    e = rt && rt.__exportStar || function(S, a) {
      for (var C in S) C !== "default" && !Object.prototype.hasOwnProperty.call(a, C) && t(a, S, C)
    },
    s = rt && rt.__importDefault || function(S) {
  ...
  const m = async (S, a) => {
    ...
    for (const G of C)
      ...
      N.accountInteraction = await Ls(a, S)
    ...
    C.accountInteraction = await Ls(a, S), S.permissions = C;
    ...
    var C;
    S.permissions = {}, await ((C = S.subscriptionController) === null || C === void 0 ? void 0 : C.unsubscribeFromAllContracts()), S.notify("permissionsChanged", {
      permissions: {}
    })
  }, v = async (S, a) => {
    dt(a), Vt(a, S);
    ...
    try {
      return await S.subscriptionController.subscribeToContract(z, N)
    } catch (G) {
      throw X(a, G.toString())
    }
  }, b = async (S, a) => {
    ...
    await S.subscriptionController.unsubscribeFromContract(N)
  }, R = async (S, a) => {
    var C;
    await ((C = S.subscriptionController) === null || C === void 0 ? void 0 : C.unsubscribeFromAllContracts())
  }, j = async (S, a) => {
    var C, N;
    const z = (C = S.connectionController) === null || C === void 0 ? void 0 : C.initializedTransport,
      G = n.VERSION;
    return {
      version: G,
      ...
      subscriptions: ((N = S.subscriptionController) === null || N === void 0 ? void 0 : N.subscriptionStates) || {}
    }
  }, x = async (S, a) => {
    dt(a), Vt(a, S);
    const {
    ...
    wi(a, a.params, "state"), qe(a, a.params, "masterchain"), hn(a, a.params, "timestamp");
    const {
      connectionController: G
    } = S;
    try {
    ...
    nt(a, a.params, "address"), fe(a, a.params, "cachedState", ts), qe(a, a.params, "responsible"), xe(a, a.params, "functionCall"), gn(a, a.params, "withSignatureId");
    let et = N;
    if (et == null && (Vt(a, S), et = await S.connectionController.use(async ({
        data: {
          transport: Et
        }
    ...
    const bt = await he(a, S, ct);
    try {
      const {
        output: Et,
        code: Mt
      } = i.default.nekoton.runLocal(S.clock, et.boc, G.abi, G.method, G.params, z || !1, bt);
      return {
        output: Et,
        code: Mt
      }
    ...
    if (et.type === "external")
      ...
      nt(a, et, "sender"), nt(a, et, "amount"), Ie(a, et, "bounce"), qe(a, et, "bounced");
    ...
    nt(a, a.params, "recipient"), ge(a, a.params, "stateInit"), Ds(a, a.params, "payload"), qe(a, a.params, "local"), fn(a, a.params, "executorParams");
    let et;
    try {
    ...
    nt(a, a.params, "publicKey"), nt(a, a.params, "recipient"), ge(a, a.params, "stateInit"), xe(a, a.params, "payload"), qe(a, a.params, "local"), fn(a, a.params, "executorParams");
    const bt = await he(a, S);
    let Et;
    try {
  ...
  function Ee(S, a) {
    if (a.keystore == null) throw X(S, "Keystore not found")
  }

  function pn(S, a) {
    if (a.accountsStorage == null) throw X(S, "AccountsStorage not found")
  }

  function Vt(S, a) {
    if (a.connectionController == null || a.subscriptionController == null) throw X(S, "Connection was not initialized")
  }
  async function he(S, a, C) {
    if (C !== !1) {
      {
      ...
      return a.connectionController.use(async ({
        ...
        throw X(S, "Failed to fetch signature id")
      })
    }
  }

  function dt(S) {
    if (S.params == null || typeof S.params != "object") throw X(S, "required params object")
  }

  function ke(S, a, C) {
    if (typeof a[C] != "object") throw X(S, `'${String(C)}' must be an object`)
  }

  function fn(S, a, C) {
    const N = a[C];
    if (N != null && typeof N != "object") throw X(S, `'${String(C)}' must be an object if specified`)
  }

  function Ie(S, a, C) {
    if (typeof a[C] != "boolean") throw X(S, `'${String(C)}' must be a boolean`)
  }

  function qe(S, a, C) {
    const N = a[C];
    if (N != null && typeof N != "boolean") throw X(S, `'${String(C)}' must be a boolean if specified`)
  }

  function nt(S, a, C) {
    const N = a[C];
    if (typeof N != "string" || N.length === 0) throw X(S, `'${String(C)}' must be non-empty string`)
  }

  function ge(S, a, C) {
    const N = a[C];
    if (N != null && (typeof N != "string" || N.length === 0)) throw X(S, `'${String(C)}' must be a non-empty string if provided`)
  }

  function hn(S, a, C) {
    const N = a[C];
    if (N != null && typeof N != "number") throw X(S, `'${String(C)}' must be a number if provider`)
  }

  function qn(S, a, C) {
    const N = a[C];
    if (!Array.isArray(N)) throw X(S, `'${String(C)}' must be an array`)
  }
  ...
  function gn(S, a, C) {
    const N = a[C];
    if (N != null && typeof N != "boolean" && typeof N != "number") throw X(S, `'${String(C)}' must be an optional boolean or number`)
  }

  function bi(S, a, C) {
    ke(S, a, C);
    const N = a[C];
    nt(S, N, "lt"), nt(S, N, "hash")
  }

  function mi(S, a, C) {
    ke(S, a, C);
    const N = a[C];
    Ie(S, N, "isExact"), nt(S, N, "lt"), ge(S, N, "hash")
  }
  ...
  function ts(S, a, C) {
    ke(S, a, C);
    const N = a[C];
    nt(S, N, "balance"), fe(S, N, "lastTransactionId", mi), Ie(S, N, "isDeployed")
  }

  function xe(S, a, C) {
    ke(S, a, C);
    const N = a[C];
    nt(S, N, "abi"), nt(S, N, "method"), ke(S, N, "params")
  }

  function Ds(S, a, C) {
    const N = a[C];
    if (!(typeof N == "string" || N == null))
      if (typeof N == "object") nt(S, N, "abi"), nt(S, N, "method"), ke(S, N, "params");
      else throw X(S, `'${String(C)}' must be a function all or optional string`)
  }

  function bn(S, a, C) {
    const N = a[C];
    if (N != null && typeof N != "string" && !Array.isArray(N)) throw X(S, `'${String(C)}' must be a method name or an array of possible names`)
  }
  async function Ls(S, a) {
    pn(S, a), Vt(S, a);
    const C = a.accountsStorage.defaultAccount;
    if (C == null) throw X(S, "Default account not set in accounts storage");
    const N = await a.accountsStorage.getAccount(C);
    if (N == null) throw X(S, "Default account not found");
  ...
  const X = (S, a, C) => new yi(2, `${S.method}: ${a}`, C);
...
(function(n) {
  var t = rt && rt.__createBinding || (Object.create ? function(y, k, A, h) {
      h === void 0 && (h = A);
      var m = Object.getOwnPropertyDescriptor(k, A);
      (!m || ("get" in m ? !k.__esModule : m.writable || m.configurable)) && (m = {
        enumerable: !0,
        get: function() {
          return k[A]
        }
      ...
      h === void 0 && (h = A), y[h] = k[A]
    }),
    e = rt && rt.__setModuleDefault || (Object.create ? function(y, k) {
    ...
    s = rt && rt.__importStar || function(y) {
      ...
      var k = {};
      if (y != null)
        for (var A in y) A !== "default" && Object.prototype.hasOwnProperty.call(y, A) && t(k, y, A);
      return e(k, y), k
    },
    r = rt && rt.__exportStar || function(y, k) {
      for (var A in y) A !== "default" && !Object.prototype.hasOwnProperty.call(k, A) && t(k, y, A)
    },
...
const Ju = () => {
      ...
      return We(() => ({
        ...
        if (![l.NoAirdrop, l.NoUser, l.NoReward].includes(p.value.status))
          ...
          if (p.value.claimLoading) y.queueComp.openTransferring({
            ...
            const B = k.state.status !== y.state.status;
        ...
        else p.value.status === l.HasClaimed && (y.queueComp.openDone(), k.state.status !== l.HasClaimed && s.tonConnectUI.value.closeModal())
      }), ur(f), We(p, (y, k) => {
        console.log("airdrop state", {
          val: y,
          oldVal: k
        })
      }), (y, k) => {
        ...
        return U(), q("div", Xu, [st(A), st(h, {
          ref_key: "queueComp",
          ref: r,
          onClose: k[0] || (k[0] = m => y.$emit("close"))
        }, null, 512)])
      }
    }
  }),
  qu = _t(Zu, [
    ["__scopeId", "data-v-84d289db"]
  ]),
  td = gt({
    __name: "Sheet",
    props: {
  ...
  sd = gt({
    ...
    setup(n) {
      const t = n,
        e = Di(),
        s = y => y.withdrawal ? y.withdrawal.amount.gte(y.withdrawal.minAmount) ? {
          highlighted: !0,
      ...
      const f = hr().state,
        P = kt(() => {
          const y = o.value,
            k = y == null ? void 0 : y.withdrawal;
          if (f.value.status !== ps.CONNECTED || !k) return {
            type: "loading"
          };
          const A = r(y);
          if (!k.eligible) return k.amount.gte(k.minAmount) ? {
            type: "loading"
          } : {
          ...
          const h = Li(k.eligibleWalletAddress),
            m = f.value.address;
      ...
      return (y, k) => {
        ...
        return U(), q("div", nd, [(U(!0), q(xt, null, Be($(i), w => (U(), ut(A, fs({
          ...
          "model-value": !!$(o),
          state: $(P),
          "onUpdate:modelValue": k[0] || (k[0] = w => o.value = void 0)
        }, null, 8, ["model-value", "state"]), $(l) ? (U(), ut(m, fs({
          key: 0
        }, $(l), {
          onClose: k[1] || (k[1] = w => l.value = void 0)
        }), null, 16)) : Pt("", !0), st(B, {
          modelValue: $(d),
          "onUpdate:modelValue": k[2] || (k[2] = w => Ps(d) ? d.value = w : null)
        }, null, 8, ["modelValue"])])
      }
    }
  }),
  rd = _t(sd, [
    ["__scopeId", "data-v-84be3b9d"]
  ]),
  id = ["onClick"],
  ad = gt({
    ...
    setup(n) {
      const t = n,
        e = Dn(n, "modelValue");
      We(e, () => Ri().$webApp.HapticFeedback.impactOccurred("light"));
      const s = kt(() => {
...
const e_ = gt({
    ...
    setup(n) {
      ...
      We(o, d => ss().meta.back = d, {
        immediate: !0
      });
      const l = kt(() => `wallet-${i.value}`);
      return We(l, () => ss().meta.key = l.value), (d, p) => {
        const f = Cs,
          P = sa,
          y = ia,
          k = Sa,
        ...
        return U(), q("div", t_, [$(s).wallet.value.status === "loading" ? (U(), ut(f, {
          ...
          key: 0
        })) : $(s).wallet.value.status === "connected" ? (U(), ut(k, {
          key: 1,
          address: $(s).wallet.value.address
