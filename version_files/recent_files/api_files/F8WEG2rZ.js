    ...
    setup(p) {
      return (t, r) => {
        ...
        return i(), _("button", {
          ...
          class: "ping-dot"
        }, null, -1)), o("div", Ot, h(t.title), 1), t.loading ? (i(), A(n, {
          key: 0,
          class: "spinner",
          size: 16,
          type: e(Ne).DARK
      ...
      return (S, k) => {
        ...
        return i(), A(f, {
          ...
          default: K(() => [o("div", jt, [g(R, {
            ...
            onClick: L
          }, [o("span", Bt, h(("t" in S ? S.t : e(b))("base.read_more")), 1), g(E, {
            name: "arrow-right",
            class: "icon"
          })]))]), o("div", Vt, [S.dontShowStorageKey ? (i(), _("div", Gt, [o("div", xt, [g(y, {
            modelValue: e(d),
    ...
    setup(p, {
      ...
      return (s, u) => {
        ...
        return i(), _(Z, null, [o("button", {
          ...
          class: "seedling"
        }, null, -1)), Ze(" " + h(("t" in s ? s.t : e(b))("memepad.explore.launch.button_text")), 1)]), g(L, {
          modelValue: e(a),
      ...
      return (c, m) => {
        ...
        return i(), A(L, {
          ...
          default: K(() => [c.event.user.avatarUrl ? (i(), _("img", {
            ...
            name: "space-invader",
            class: "icon"
          })])), o("div", zt, [c.event.user.nickname ? (i(), _("span", qt, h(c.event.user.nickname), 1)) : (i(), _("span", Zt, h(("sliceWalletAddress" in c ? c.sliceWalletAddress : e(et))(c.event.user.address)), 1)), o("span", Qt, h(e(r)), 1), c.event.amount ? (i(), A(s, {
            key: 2,
  ...
  Ts = j({
    ...
    setup(p) {
      return (t, r) => {
        ...
        }, [o("div", vs, [o("div", hs, [o("span", gs, h(t.marketCap ? `$${t.marketCap.full}` : "-"), 1), t.moveDirection ? (i(), _("span", ys, h(t.moveDirection.diffFormatted), 1)) : P("", !0)]), t.jetton.isReleased ? (i(), A(n, {
          key: 0,
    ...
    setup(p) {
      ...
      ae(s, (y, v) => {
        ...
        M !== "0" && (L.value = {
          direction: T ? "down" : "up",
          diffFormatted: `${T?"-":"+"}${M}`
        }, u.push(setTimeout(() => L.value = void 0, 3e3)))
      });
      const C = I(() => {
          var y, v;
          return ((y = L.value) == null ? void 0 : y.direction) === "down" ? se("memepad/spotlight-room-down", "svg") : ((v = L.value) == null ? void 0 : v.direction) === "up" ? se("memepad/spotlight-room-up", "svg") : se("memepad/spotlight-room", "svg")
        }),
        {
      ...
      function E() {
        ...
        const D = $(),
          ...
          V = ue(async () => await t.getReactions(s.value.shortname), le => {
            ...
            const {
              ...
              userStars: jn,
              ...Ve
            } = D.value, Ee = Object.entries(Ve).reduce((G, [F, _e]) => {
              const Fe = Be[F],
                Ye = _e,
        ...
        ae(() => s.value.shortname, () => {
          f++, T.forEach(clearTimeout), W(), w()
        }), w(), oe(W);
        const pe = () => {
          W(), w()
        };
        return {
          reactionsAnimations: I(() => N.value),
      ...
      return (y, v) => {
        ...
        const f = ge,
          ...
          M = _s,
          D = Cs;
        return i(), _("div", Ls, [o("div", As, [e(r).isLowEndDevice.value ? P("", !0) : (i(), _("img", {
          key: 0,
          src: e(R),
          alt: "Gif",
          class: ee([{
          ...
          class: "gradient"
        }, null, -1))]), o("div", Ms, [o("div", Ns, [o("div", ws, [g(f, {
          name: "animations/Fire",
          size: 28
        }), o("div", Ps, h(("t" in y ? y.t : e(b))("memepad.explore.spotlight.title")), 1)]), y.list.length > 1 ? (i(), A(T, {
          key: 0,
          "model-value": e(n),
          count: y.list.length,
          timer: 15e3,
        ...
        }, [(i(!0), _(Z, null, me(t.list, (w, W) => (i(), A(M, {
          key: w.id,
          index: W,
          jetton: w,
          class: "item"
        }, null, 8, ["index", "jetton"]))), 128))], 544), (i(), A(D, {
          key: e(a).id,
          jetton: e(a),
          "move-direction": e(L),
  ...
  an = j({
    ...
    setup(p) {
      const t = p,
        ...
        s = I(() => t.jetton.pnlPercent ? It(t.jetton.pnlPercent) : void 0);
      return (u, L) => {
        const C = Bs,
          O = Q,
          S = ke;
        return i(), A(S, {
          ...
          default: K(() => {
            ...
            }, null, 8, ["image", "collected-percent", "is-released", "stream-online"]), o("div", Vs, [o("div", Gs, h(u.jetton.ticker), 1), u.mode === e(X).BASE ? (i(), _("div", xs, [u.jetton.stats.holdersCount !== void 0 ? (i(), _("div", Ws, [g(O, {
              name: "personal",
              class: "icon"
    ...
    setup(p) {
      return (t, r) => {
        ...
        return i(), A(ot, {
          ...
          default: K(() => [(i(!0), _(Z, null, me(t.items, a => (i(), A(n, {
            key: a.shortname,
            jetton: a,
    ...
    setup(p) {
      ...
      return (d, s) => {
        const u = Q,
          ...
          S = St,
          k = Et;
        return i(), _("div", cn, [o("div", rn, [g(L, {
          modelValue: t.value,
          ...
          type: e(Ne).LIGHT
        }, null, 8, ["type"])])) : d.items ? (i(), A(S, {
          key: 2,
          onEnd: s[3] || (s[3] = R => d.$emit("scrolled"))
        }, {
          default: K(() => [d.items.length ? (i(), A(O, {
            key: t.value,
            items: d.items,
    ...
    setup(p, {
      ...
      return ae(m, u), ie().memepad.memepadSearchOpen(), ct().initHandler(() => r("close"), "memepad-search"), (C, O) => {
        ...
        return i(), _("div", fn, [g(S, {
          ...
          key: 0
        }, [e(a).data.value.length === 0 ? (i(), _("div", In, h(("t" in C ? C.t : e(b))("memepad.search.empty_text")), 1)) : (i(), A(k, {
          key: 1,
          ...
          case "pagination-list":
            return {
              type: "pagination-list", pagination: kt(async f => {
                ...
                if (!Le(T)) throw ne("Failed to get list");
                return {
  ...
  Mn = j({
    ...
    setup(p) {
      const {
        ...
        isAiAgentStatusBannerLoading: L,
      ...
      return (v, f) => {
        ...
        const T = Rt,
          ...
          V = vt,
          w = kn;
        return i(), _(Z, null, [e(O) ? (i(), _("div", An, [e(S) ? (i(), A(T, {
          key: 0,
          title: e(S).title,
          loading: e(S).loading,
          class: "status-banner",
          ...
          onLaunch: R
        })]), e(t).eventAppearedItem.value ? (i(), A(D, {
          key: 1,
          event: e(t).eventAppearedItem.value,
          class: "event"
        }, null, 8, ["event"])) : P("", !0), (W = e(r).items.value) != null && W.length ? (i(), A(N, {
          key: 2,
        ...
        }, null, 8, ["modelValue", "items", "onScrolled"])])) : (i(), A(V, {
          key: 1
        })), e(k) ? (i(), A(w, {
          key: 2,
          onClose: y
    ...
    setup(p) {
      ...
      return ie().memepad.memepadExploreOpen(), (c, m) => {
        const d = He,
          s = wt,
          u = Nn;
        return i(), _("div", wn, [g(d), e(r) === "intro" ? (i(), A(s, {
          key: 0,
          onStart: n
        })) : e(r) === "explore" ? (i(), A(u, {
          key: 1
