...
const lt = e => {
  ...
  qt = e => e.instance === "token",
  Yt = (e, n) => {
    if (Mt(e)) return n.point(e);
    if (qt(e)) return n.token(e);
    ...
    setup(e) {
      ...
      return (a, o) => {
        ...
        return s(t) ? (l(), d("div", {
          ...
          name: s(t).icon,
          class: "icon"
        }, null, 8, ["name"]), _("div", We, f(s(t).label), 1)], 2)) : w("", !0)
      }
    }
  }),
  Ke = v(Ee, [
    ...
    setup(e) {
      return (n, t) => {
        ...
        return l(), d("div", Me, [(l(!0), d(I, null, A(e.history, (o, i) => (l(), d(I, {
          key: i
        }, [i === 0 || e.history[i - 1].date.stamp !== e.history[i].date.stamp ? (l(), d("div", qe, f(o.date.formatted), 1)) : w("", !0), y(a, {
          "history-item": o
...
const Is = g({
    ...
    setup(e) {
      ...
      return D(c, () => q().meta.key = c.value), (u, b) => {
        const m = Tt,
          C = jt,
          x = Gt,
          ht = ye,
