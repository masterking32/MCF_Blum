...
import {
  ...
  A as t$3,
  f as _export_sfc,
  dy as commonjsRequire,
  cE as getDefaultExportFromCjs,
  cc as Buffer,
  K as watch,
  z as createBlock,
  ...
  b as createVNode,
  aH as normalizeStyle,
  dz as Teleport,
  c8 as nextTick,
  _ as _sfc_main$3,
  G as createCommentVNode,
  x as __nuxt_component_0,
  bX as FILE_UPLOAD_STATUS,
  ah as client
} from "./Q7ZkUOCs.js";
const _hoisted_1$2 = ["disabled", "accept"],
  BYTES_IN_MB = 1e6,
  ...
  _sfc_main = defineComponent({
    ...
    setup(d, {
      ...
      return watch(l, w => f("update:progress", w), {
        ...
        }, null, 8, ["disabled", "accept", "max-file-size-mb"]), unref(b) ? (openBlock(), createBlock(A, {
          key: 1,
          file: unref(b),
          class: "cropper",
