    ...
    setup(h) {
      return (s, m) => {
        ...
        return t(), a("div", he, [s.errorMessage ? (t(), b(e, {
          ...
          inner: S(() => [r("div", Te, [(t(!0), a(L, null, U(s.details, (n, l) => (t(), a(L, {
            key: n.label
    ...
    setup(h) {
      ...
      return (e, u) => {
        ...
        return t(), a("div", Ce, [e.isReleased ? k("", !0) : (t(), a("div", Ae, [r("div", we, [r("div", Ee, [e.total !== void 0 && e.collected !== void 0 || e.percent ? (t(), a(L, {
          key: 1
        }, [e.percent !== void 0 ? (t(), a("span", Se, d(`${i(se)(e.percent)}%`), 1)) : k("", !0), e.total !== void 0 && e.collected !== void 0 ? (t(), a("span", De, d(`${("formatTon"in e?e.formatTon:i(V))(e.collected,{trim:!0})}/${("formatTon"in e?e.formatTon:i(V))(e.total,{trim:!0})} TON`), 1)) : k("", !0)], 64)) : (t(), b(o, {
          key: 0,
          class: "skeleton"
          ...
          key: 0
        }, [r("span", Ve, d(("t" in e ? e.t : i(v))("memepad.jetton.stats.market_cap")), 1), r("span", We, d(`$${("formatCount"in e?e.formatCount:i(w))(e.marketDetails.statistics.marketCap).full}`), 1)], 64)) : (t(), a("span", ze, "—"))])])) : (t(), b(l, {
          key: 1,
        ...
        }, null, 4)])])), i(m).length ? (t(), a("div", Pe, [r("div", Ge, [r("div", He, d(("t" in e ? e.t : i(v))("memepad.jetton.market_cap")), 1), (f = e.marketDetails) != null && f.marketCap ? (t(), a("div", qe, [u[0] || (u[0] = r("span", {
          class: "dollar"
...
export {
  Tt as _, bt as a, yt as b, Lt as c, Ct as d, At as e, wt as f, $t as g
};