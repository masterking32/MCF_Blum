    ...
    setup(b, {
      ...
      return (e, p) => {
        ...
        return a(), n("div", {
          ...
          [W, t(f)],
          [O, P]
        ]), l("div", ie, [g(e.$slots, "postfix", {}, void 0, !0)])], 10, oe), l("div", le, [C(j, {
          name: "change-item-transition"
        }, {
          default: R(() => [e.status === t(c).SUCCESS ? (a(), n("img", ue)) : o("", !0), e.status === t(c).ERROR ? (a(), n("img", pe)) : o("", !0), e.status === t(c).LOADING ? (a(), $(D, {
            key: 2,
            type: t(Y).DARK,
            size: 20,
            "track-dimmed": "",
