    ...
    setup(n, {
      ...
      return (d, p) => {
        ...
        return U(), q("div", cc, [H("div", lc, [$(o) ? (U(), q(xt, {
          ...
          key: 0,
          "error-message": $(r)
        }, null, 8, ["error-message"])) : (U(), q("div", dc, [st(I, {
          "text-min-width": 155,
          alignment: $(Ci).TOP
        }, {
          default: Dt(() => [st(P, {
...
(function(n) {
  ...
  function e(I) {
    return I != null && (I instanceof t || Object.getPrototypeOf(I).constructor.name === t.prototype.constructor.name)
  }
  n.isAddressObject = e;
  class s extends t {
    constructor(A) {
  ...
  const d = function() {
    ...
    if (typeof setTimeout == "function" || typeof setTimeout == "object") return function(I) {
      setTimeout(I, 0)
    };
  ...
  function p(I, A, h) {
    if (h.batchType === "old") return I.push(...A), I;
    if (I.length === 0) return I.push(...A), I;
    let m = 0;
    for (; m < I.length && n.LT_COLLATOR.compare(I[m].id.lt, h.maxLt) >= 0;) ++m;
    return I.splice(m, 0, ...A), I
  }
      ...
      i = l => {
        ...
        if (p != null) {
          ...
          if (f != null) {
            ...
            I.finished || (I.finished = !0, P.clear(), P.enqueue(async () => y(I.eof)))
          }
    ...
    return new qt((l, d) => {
      ...
      const A = this.provider.subscribe(t, {
        ...
        for (const {
          ...
          of I.values()) v.eof || v.finished || w.enqueue(async () => {
          await B(m) || (v.eof = !0, i(o))
        })
      }), h.on("unsubscribed", () => {
        for (const m of I.keys()) i(m)
      }), h)).catch(h => {
        console.error(h);
        for (const m of I.keys()) i(m);
        throw h
  ...
  constructor(t, e, s, r) {
    this.makeProducer = t, this.stopProducer = e, this.extractor = s, this.isFinite = r, this.fold = this.onlyFinite((i, o, l) => {
      ...
      return new Promise((p, f) => {
        const P = this.makeProducer(y => this.extractor(y, async I => (d = await o(d, I), !0)), y => {
          ...
          return {
            promise: (async () => {
              ...
              for (;;) {
                ...
                if (o.timeout = setTimeout(y, p), await I, o.stopped) return;
      ...
      if (f.length > 0) {
        const P = await Promise.all(f.map(async y => ({
          ...
          events: await this.decodeTransactionEvents({
            transaction: y
          }).then(I => (I.forEach(A => A.transaction = y), I))
        })));
        for (let {
            tx: y,
            events: I
          ...
          of P) {
          i != null && (I = await Promise.all(I.map(async A => await i(A) ? A : void 0)).then(A => A.filter(h => h != null))), l = y.id;
          for (const A of I) {
  ...
  async sendWithResult(t) {
    ...
    try {
      ...
      const o = new Promise(I => {
        ...
        l = [];
      e.transactions(this.address).flatMap(I => I.transactions).filter(I => {
        var A;
        return ((A = I.inMessage.src) === null || A === void 0 ? void 0 : A.equals(t.from)) || !1
      }).on(I => {
        r == null ? l.push(I) : r.possibleMessages.findIndex(A => A.hash == I.inMessage.hash) >= 0 && (i == null || i(I))
      });
      const d = await this.send(t),
        p = d.outMessages.filter(I => {
          var A;
          return ((A = I.dst) === null || A === void 0 ? void 0 : A.equals(this.address)) || !1
        });
      r = {
        transaction: d,
        possibleMessages: p
      };
      const f = l.find(I => p.findIndex(A => A.hash == I.inMessage.hash) >= 0);
      f != null && (i == null || i(f));
      const P = await o;
      let y;
      try {
        const I = await this.provider.rawApi.decodeTransaction({
          transaction: (0, Rt.serializeTransaction)(P),
          abi: this.abi,
          method: this.method
        });
        I != null && (y = this.functionAbi.outputs != null ? (0, Rt.parseTokensObject)(this.functionAbi.outputs, I.output) : {})
      } catch (I) {
        console.error(I)
      }
      return {
...
(function(n) {
  ...
  const I = () => P ? window.__ever || window.ton : void 0;
  async function A() {
  ...
  class h {
    constructor(b = {}) {
      ...
      this.Subscriber = x, this._api = new Proxy({}, {
        ...
        this._provider = u
      }) : Promise.resolve() : (this._provider = I(), this._provider != null ? this._initializationPromise = Promise.resolve() : this._initializationPromise = A().then(u => new Promise(_ => {
        if (!u) return _();
        if (this._provider = I(), this._provider != null) _();
        else {
...
var ms = {};
(function(n) {
  var t = rt && rt.__awaiter || function(f, P, y, I) {
      function A(h) {
    ...
    e = rt && rt.__generator || function(f, P) {
      var y = {
        ...
        I, A, h, m = Object.create((typeof Iterator == "function" ? Iterator : Object).prototype);
      ...
      function w(v) {
        ...
        for (; m && (m = 0, v[0] && (y = 0)), y;) try {
          if (I = 1, A && (h = v[0] & 2 ? A.return : v[0] ? A.throw || ((h = A.return) && h.call(A), 0) : A.next) && !(h = h.call(A, v[1])).done) return h;
    ...
    s = rt && rt.__spreadArray || function(f, P, y) {
      if (y || arguments.length === 2)
        for (var I = 0, A = P.length, h; I < A; I++)(h || !(I in P)) && (h || (h = Array.prototype.slice.call(P, 0, I)), h[I] = P[I]);
  ...
  n.checkQueue = l;
  var d = function(f, P) {
    for (var y = [], I = 2; I < arguments.length; I++) y[I - 2] = arguments[I];
  ...
  var p = function(f, P, y) {
    ...
    return t(void 0, s([f, P, y], I, !0), void 0, function(h, m, B, w) {
      var v, b, R, j, x, u, _, g;
...
function cl(n, t, e, s, r, i, o) {
  try {
    ...
    const P = Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      y = Q,
      I = Y(e, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q,
      h = Y(s, c.__wbindgen_malloc, c.__wbindgen_realloc),
      m = Q;
    c.runLocal(f, n.__wbg_ptr, P, y, I, A, h, m, Z(r), i, !At(o), At(o) ? 0 : o);
...
function pl(n, t, e, s, r, i, o) {
  try {
    ...
    var l = At(i) ? 0 : Y(i, c.__wbindgen_malloc, c.__wbindgen_realloc),
      d = Q;
    c.executeLocal(y, I, A, h, m, B, w, s, r, l, d, !At(o), At(o) ? 0 : o);
...
function fl(n, t, e, s, r) {
  try {
    const f = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      y = Q,
      I = Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q;
    var i = At(s) ? 0 : Y(s, c.__wbindgen_malloc, c.__wbindgen_realloc),
      o = Q;
    c.getExpectedAddress(f, P, y, I, A, e, i, o, Z(r));
    var l = D().getInt32(f + 4 * 0, !0),
      d = D().getInt32(f + 4 * 1, !0),
      p = D().getInt32(f + 4 * 2, !0);
    if (p) throw V(d);
...
function Cl(n, t, e) {
  ...
  try {
    const P = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      h = Q;
    c.encodeInternalInput(P, y, I, A, h, Z(e));
    var i = D().getInt32(P + 4 * 0, !0),
      o = D().getInt32(P + 4 * 1, !0),
      l = D().getInt32(P + 4 * 2, !0),
      d = D().getInt32(P + 4 * 3, !0),
...
function Pl(n, t, e, s, r, i, o) {
  ...
  try {
    ...
    var P = At(s) ? 0 : Y(s, c.__wbindgen_malloc, c.__wbindgen_realloc),
      y = Q,
      I = At(r) ? 0 : Y(r, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q;
    const u = Y(i, c.__wbindgen_malloc, c.__wbindgen_realloc),
      _ = Q;
    c.encodeInternalMessage(R, p, f, j, x, e, P, y, I, A, u, _, At(o) ? 16777215 : o ? 1 : 0);
...
function Fl(n, t, e) {
  ...
  try {
    const P = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      A = Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      h = Q;
    c.ed25519_sign(P, y, I, A, h, !At(e), At(e) ? 0 : e);
    var i = D().getInt32(P + 4 * 0, !0),
      o = D().getInt32(P + 4 * 1, !0),
      l = D().getInt32(P + 4 * 2, !0),
      d = D().getInt32(P + 4 * 3, !0),
...
function Bl(n, t, e, s) {
  try {
    const l = c.__wbindgen_add_to_stack_pointer(-16),
      ...
      I = Q;
    c.verifySignature(l, d, p, f, P, y, I, !At(s), At(s) ? 0 : s);
    var r = D().getInt32(l + 4 * 0, !0),
      i = D().getInt32(l + 4 * 1, !0),
      o = D().getInt32(l + 4 * 2, !0);
    if (o) throw V(i);
...
function jl(n, t, e, s) {
  try {
    ...
    var r = At(t) ? 0 : Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      ...
      l = Q;
    c.createRawExternalMessage(P, y, I, r, i, o, l, s);
...
function xl(n, t, e, s, r, i, o) {
  try {
    const y = c.__wbindgen_add_to_stack_pointer(-16);
    ue(n, we);
    const I = Y(t, c.__wbindgen_malloc, c.__wbindgen_realloc),
      A = Q,
    ...
    var l = At(r) ? 0 : Y(r, c.__wbindgen_malloc, c.__wbindgen_realloc),
      d = Q;
    c.createExternalMessageWithoutSignature(y, n.__wbg_ptr, I, A, h, m, B, w, l, d, Z(i), o);
    var p = D().getInt32(y + 4 * 0, !0),
      f = D().getInt32(y + 4 * 1, !0),
      P = D().getInt32(y + 4 * 2, !0);
    if (P) throw V(f);
...
function Ul(n, t, e, s, r, i, o, l) {
  try {
    ...
    const b = Y(o, c.__wbindgen_malloc, c.__wbindgen_realloc),
      R = Q;
    c.createExternalMessage(I, n.__wbg_ptr, A, h, m, B, w, v, d, p, Z(i), b, R, l);
    var f = D().getInt32(I + 4 * 0, !0),
      P = D().getInt32(I + 4 * 1, !0),
      y = D().getInt32(I + 4 * 2, !0);
    if (y) throw V(P);
    return jn.__wrap(f)
  } finally {
    c.__wbindgen_add_to_stack_pointer(16)
      ...
      async _selectQueryingEndpoint() {
        ...
        for (let o = 0; o < 5; ++o) {
          ...
          try {
            ...
            setTimeout(() => y(), Math.min(100 * o, 5e3)), await I
          }
        }
...
(function(n) {
  ...
  async function p(h) {
    ...
    try {
      const w = new y(B);
      await w._connect(m), w._initializedTransport != null && I(w._initializedTransport)
    } catch (w) {
  ...
  class y {
    ...
    async _connect(m) {
      this._initializedTransport != null && I(this._initializedTransport), this._initializedTransport = void 0;
      let B;
      (function(v) {
    ...
    return this._subscriptionsMutex.use(async () => {
      const r = f => {
          ...
          return Object.keys(P).map(y => {
            ...
            const I = e[y];
            if (typeof I == "boolean") P[y] = I;
            else {
              if (I == null) return;
              throw new Error(`Unknown subscription topic value ${y}: ${I}`)
            }
          }), P
        },
...
function qr(n) {
  ...
  w.clone = qr, w.ROUND_UP = 0, w.ROUND_DOWN = 1, w.ROUND_CEIL = 2, w.ROUND_FLOOR = 3, w.ROUND_HALF_UP = 4, w.ROUND_HALF_DOWN = 5, w.ROUND_HALF_EVEN = 6, w.ROUND_HALF_CEIL = 7, w.ROUND_HALF_FLOOR = 8, w.EUCLID = 9, w.config = w.set = function(u) {
    ...
    if (u != null)
      if (typeof u == "object") {
        ...
        if (u.hasOwnProperty(_ = "MODULO_MODE") && (g = u[_], Ot(g, 0, 9, _), I = g), u.hasOwnProperty(_ = "POW_PRECISION") && (g = u[_], Ot(g, 0, Wt, _), A = g), u.hasOwnProperty(_ = "FORMAT"))
    ...
    return function(E, T, O, F, k) {
      ...
      if (Tt[L] > (Ht[L] || 0) && K--, ne < 0) Lt.push(1), W = !0;
        ...
        for (Xe = Ht.length, ae = Tt.length, L = 0, ne += 2, it = ce(k / (Tt[0] + 1)), it > 1 && (Tt = u(Tt, it, k), Ht = u(Ht, it, k), ae = Tt.length, Xe = Ht.length), je = ae, pt = Ht.slice(0, ae), mt = pt.length; mt < ae; pt[mt++] = 0);
        Pe = Tt.slice(), Pe = [0].concat(Pe), Ze = Tt[0], Tt[1] >= k / 2 && Ze++;
        do {
          if (it = 0, M = _(Tt, pt, ae, mt), M < 0) {
            if (Ut = pt[0], ae != mt && (Ut = Ut * k + (pt[1] || 0)), it = ce(Ut / Ze), it > 1)
  ...
  return r.absoluteValue = r.abs = function() {
    ...
    var g, E, T = this;
    return u = new w(u, _), !T.c || !u.s || u.c && !u.c[0] ? new w(NaN) : !u.c || T.c && !T.c[0] ? new w(T) : (I == 9 ? (E = u.s, u.s = 1, g = t(T, u, 0, 3), u.s = E, g.s *= E) : g = t(T, u, 0, I), u = T.minus(g.times(u)), !u.c[0] && I == 1 && (u.s = T.s), u)
...
class Mn {
  ...
  async prepareMessage(t, e) {
    ...
    f.signatureHigh = I.high, f.signatureLow = I.low;
...
class On {
  ...
  async prepareMessage(t, e) {
    ...
    const y = e.packIntoCell({
      ...
      I = await i.sign(y, t.signatureId),
      {
        signatureParts: A
      } = e.extendSignature(I);
...
(function(n) {
  ...
  class l {
    constructor(f, P, y, I) {
      this.clock = f, this.connectionController = P, this.nekoton = y, this.keystore = I
    }
    async getSigner(f) {
...
(function(n) {
  var t = rt && rt.__createBinding || (Object.create ? function(y, I, A, h) {
      h === void 0 && (h = A);
      var m = Object.getOwnPropertyDescriptor(I, A);
      (!m || ("get" in m ? !I.__esModule : m.writable || m.configurable)) && (m = {
        enumerable: !0,
        get: function() {
          return I[A]
        }
      ...
      h === void 0 && (h = A), y[h] = I[A]
    }),
    e = rt && rt.__setModuleDefault || (Object.create ? function(y, I) {
    ...
    s = rt && rt.__importStar || function(y) {
      ...
      var I = {};
      if (y != null)
        for (var A in y) A !== "default" && Object.prototype.hasOwnProperty.call(y, A) && t(I, y, A);
      return e(I, y), I
    },
    r = rt && rt.__exportStar || function(y, I) {
      for (var A in y) A !== "default" && !Object.prototype.hasOwnProperty.call(I, A) && t(I, y, A)
    },
      ...
      return We(() => ({
        ...
        if (![l.NoAirdrop, l.NoUser, l.NoReward].includes(p.value.status))
          ...
          if (p.value.claimLoading) y.queueComp.openTransferring({
            ...
            const B = I.state.status !== y.state.status;
        ...
        else p.value.status === l.HasClaimed && (y.queueComp.openDone(), I.state.status !== l.HasClaimed && s.tonConnectUI.value.closeModal())
      }), ur(f), We(p, (y, I) => {
        ...
        return U(), q("div", Xu, [st(A), st(h, {
          ref_key: "queueComp",
          ref: r,
          onClose: I[0] || (I[0] = m => y.$emit("close"))
        }, null, 512)])
      }
    }
  }),
  ...
  sd = gt({
    ...
    setup(n) {
      ...
      const f = hr().state,
        P = kt(() => {
          const y = o.value,
            I = y == null ? void 0 : y.withdrawal;
          if (f.value.status !== ps.CONNECTED || !I) return {
            type: "loading"
          };
          const A = r(y);
          ...
          const h = Li(I.eligibleWalletAddress),
            m = f.value.address;
      ...
      return (y, I) => {
        ...
        return U(), q("div", nd, [(U(!0), q(xt, null, Be($(i), w => (U(), ut(A, fs({
          ...
          "model-value": !!$(o),
          state: $(P),
          "onUpdate:modelValue": I[0] || (I[0] = w => o.value = void 0)
        }, null, 8, ["model-value", "state"]), $(l) ? (U(), ut(m, fs({
          key: 0
        }, $(l), {
          onClose: I[1] || (I[1] = w => l.value = void 0)
        }), null, 16)) : Pt("", !0), st(B, {
          modelValue: $(d),
          "onUpdate:modelValue": I[2] || (I[2] = w => Ps(d) ? d.value = w : null)
        }, null, 8, ["modelValue"])])
      }
    }
  }),
    ...
    setup(n) {
      ...
      return We(l, () => ss().meta.key = l.value), (d, p) => {
        ...
        return U(), q("div", t_, [$(s).wallet.value.status === "loading" ? (U(), ut(f, {
          ...
          key: 0
        })) : $(s).wallet.value.status === "connected" ? (U(), ut(I, {
          key: 1,
          address: $(s).wallet.value.address
