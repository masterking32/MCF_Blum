    ...
    setup(r) {
      const e = r,
        ...
        c = () => {
          ...
          if (s.memepad.memepadClickTopupButton({
              flowType: e.flowType,
              source: e.source,
            ...
            const u = (() => {
              ...
              const P = new q(new q(e.needMoreValue).toFixed(1, q.ROUND_UP));
    ...
    setup(r, {
        ...
        h = os({
          ...
          set: k => {
            if (a.value && a.value.value !== s.modelValue) {
              const R = [...a.value.value].findIndex((K, H) => K !== s.modelValue[H]);
              R !== -1 && a.value.value[R] === "," && (k = k.slice(0, R) + "." + k.slice(R))
            }
            k = (s.modifier || (R => R))(k), a.value && a.value.value !== k && (a.value.value = k), n("update:modelValue", k)
          }
        });
      ...
      const f = os(() => {
          ...
          const k = parseInt(getComputedStyle(c.value).getPropertyValue("font-size")),
            I = parseInt(getComputedStyle(c.value).getPropertyValue("line-height")),
            R = `${s.modelValue} ${s.postfix}`,
      ...
      return (() => {
        ...
        ref: "input",
        "onUpdate:modelValue": I[0] || (I[0] = R => Tr(h) ? h.value = R : null),
        type: "text",
        inputmode: "decimal",
        style: is(Q(f)),
  ...
  constructor(e = {}) {
    ...
    d(this, "request", async ({
      ...
      const f = (typeof t == "boolean" ? t : this.baseApiParams.secure) && this.securityWorker && await this.securityWorker(this.securityData) || {},
        ...
        P = n ?? fe.Json,
        F = this.contentFormatters[P],
        k = a || u.format;
      return this.customFetch(`${c||this.baseUrl||""}${s}${$?`?${$}`:""}`, {
        ...u,
        headers: {
          ...u.headers || {},
          ...P && P !== fe.FormData ? {
        ...
        const K = k === "json" ? "text" : k,
          H = K ? await I[K]().then(O => (R.ok ? R.data = k === "json" ? sn(O) : O : R.error = O, R)).catch(O => (R.error = O, R)) : R;
        if (p && this.abortControllers.delete(p), !I.ok) throw H;
        return H.data
      })
    });
    if (e.apiKey) {
...
var pn = class {
  ...
  open(r) {
    return B.openContract(r, e => Mt(this.tonapi, e.address, e.init))
  }
  provider(r, e) {
...
function Mt(r, e, t) {
  return {
    ...
    async get(s, n) {
      ...
      return {
        stack: new B.TupleReader(o.stack)
      }
    },
    async external(s) {
      let n = null;
      ...
      const o = B.external({
        ...
        a = B.beginCell().store(B.storeMessage(o)).endCell();
    ...
    async internal(s, n) {
      ...
      let c;
      typeof n.value == "string" ? c = B.toNano(n.value) : c = n.value;
      let p = null;
      typeof n.body == "string" ? p = B.comment(n.body) : n.body && (p = n.body), await s.send({
        to: e,
        value: c,
        bounce: a,
        sendMode: n.sendMode,
    ...
    open(s) {
      return B.openContract(s, n => Mt(r, n.address, n.init))
    },
    getTransactions(s, n, o, a) {
      return console.info("hash param in getTransactions action ignored, beacause not supported", o.toString("hex")), r.blockchain.getBlockchainAccountTransactions(s, {
        ...
        transactions: c
      }) => c.map(p => B.loadTransaction(p.raw.asSlice())))
    }
  }
}
...
var fn = function() {
  ...
  te = function() {};
te.deployJettonGas = B.toNano(.05), te.initialGas = B.toNano(.015), te.buyGas = B.toNano(.08), te.sellGas = B.toNano(.08), te.unlockGas = B.toNano(.05);
var Me, Ws = function() {};
    ...
    return e.sendDeployJetton = function(t, s, n, o, a, c, p, h, f) {
      ...
      try {
        return p === void 0 && (p = 0n), Promise.resolve(t.internal(s, {
          value: n,
          body: B.beginCell().storeUint(Ws.deployJetton, 32).storeUint(f, 64).storeUint(o, 1).storeRef(a).storeBit(c).storeCoins(p).storeMaybeRef(h).endCell()
        })).then(function() {})
      } catch (u) {
    ...
    return e.getWalletAddress = function(t, s) {
      try {
        return Promise.resolve(t.get("get_wallet_address", [{
          type: "slice",
          cell: B.beginCell().storeAddress(s).endCell()
        }])).then(function(n) {
      ...
      try {
        return Promise.resolve(t.internal(s, {
          value: n + te.buyGas,
          body: B.beginCell().storeUint(Ks.buy, 32).storeUint(p, 64).storeCoins(o).storeAddress(a).storeMaybeRef(c).endCell()
        })).then(function() {})
      } catch (h) {
...
var Dt = function() {
    ...
    r.createFromAddress = function(t) {
      ...
      return n === void 0 && (n = null), o === void 0 && (o = 0), B.beginCell().storeUint(tt.sell, 32).storeUint(o, 64).storeCoins(t).storeCoins(s).storeMaybeRef(n).endCell()
    }, r.unlockMessage = function(t) {
      return t === void 0 && (t = 0), B.beginCell().storeUint(tt.unlock, 32).storeUint(t, 64).endCell()
    };
    var e = r.prototype;
    return e.getJettonBalance = function(t) {
      ...
      try {
        return Promise.resolve(t.internal(s, {
          sendMode: B.SendMode.PAY_GAS_SEPARATELY,
...
var An = function(r) {
    try {
      ...
      return Promise.resolve(r(s)).then(function() {
        ...
        return e.init && (o.stateInit = B.beginCell().store(B.storeStateInit(e.init)).endCell().toBoc().toString("base64")), {
    ...
    return e.sendDeployJetton = function(t, s, n, o, a, c, p, h) {
      ...
      try {
        ...
        return Promise.resolve(f.getConfig()).then(function(u) {
          var $ = u.deployFee + te.deployJettonGas + te.initialGas;
          a && ($ += u.agentDeployFee), c > 0n && ($ += c + te.buyGas);
          var P = Js(o);
          return Promise.resolve(f.sendDeployJetton(t, $, n, P, a, c, p, h)).then(function() {})
        })
      } catch (u) {
        return Promise.reject(u)
      }
...
const Vs = () => {
    const {
      ...
      isProd: f
    } = $r(), u = new Sn(n, !1, !f.value), $ = l => +String(l) / 1e4, P = {
      ...
      LAUNCH_FEE: new q(.0086),
      LAUNCH_BUY_FEE: new q(.009),
      BUY_FEE: new q(.0046),
      SELL_FEE: new q(.0044),
      UNLOCK_FEE: new q(.004)
    }, I = {
      ...
      hasShare: l
    }) => I.deployNetworkFee.plus(l ? 0 : I.initialNetworkFee), K = ({
      referrerToken: l
    }) => B.beginCell().storeUint(1675682413, 32).storeStringTail(l).endCell(), H = async l => {
      ...
      const {
        buyFeeBasis: E
      } = w.data, N = A.div(new q(1).minus($(E))).toDecimalPlaces(9, q.ROUND_UP), D = w.data, V = S(w.data.agentDeployFee);
      return x({
      ...
      const {
        buyFeeBasis: V
      } = D.data, Z = S(u.getBuyAmount(0n, _, V)), ke = Z, je = Z, Ne = w.minus(ke), pe = S(u.getTonSupply(U(ke))), ns = new q(u.getPrice(U(ke))), cr = new q(ns).times(N), pr = pe.div(A).times(100), lr = Z.div(w).times(100), mr = new q(m).minus(pe);
      return x({
        share: new q(m),
        tokenForDexWithFees: E,
        tokenForDex: A,
      ...
      const Z = y ? K({
        ...
        ke = m.aiAgentEnable,
        je = await W(async () => await u.sendDeployJetton(E, r(l), D, V, ke, U(new q(m.share)), Z, N))();
      if (!j(je)) return je;
    ...
    }, vt = t(o, P.LAUNCH_STATUS_CHECK), wt = async ({
      tons: l,
      jettonAddress: m,
      masterAddress: _
    }) => {
      ...
      const {
        buyFeeBasis: E
      } = w.data, N = S(u.getBuyAmount(U(A), U(l), E)), D = N, V = c(N), Z = l.times($(E));
      return x({
        maxReceive: D,
        minReceive: V,
        platformFee: Z,
      ...
      const {
        sellFeeBasis: E
      } = w.data, N = S(u.getSellAmount(U(A), U(l), E)), D = N, V = c(N), Z = N.div(1 - $(E)).minus(N);
      return x({
        maxReceive: D,
        minReceive: V,
        platformFee: Z,
      ...
      const w = e(y),
        ...
        N = await W(async () => await u.sendBuy(w, r(m), U(l), U(_.minReceive), E))();
      return j(N) ? x((await w.getResult()).hash) : N
    }, At = async ({
      jettons: l,
      jettonAddress: m,
      tradeInfoParams: _,
      ...
      if (!j(D)) return D;
      const V = D.data,
        Z = await W(async () => await u.sendSell(E, V, U(l), U(_.minReceive), N))();
      return j(Z) ? x((await E.getResult()).hash) : Z
    }, St = () => Ce(({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), () => {}, P.BUY_STATUS_CHECK), jt = () => Ce(({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), () => {}, P.SELL_STATUS_CHECK), qt = async ({
      jettonAddress: l,
      userAddress: m
    }) => {
      const _ = await a({
      ...
      if (!j(A)) return A;
      const w = A.data,
        E = await W(async () => await u.sendUnlock(y, w))();
      return j(E) ? x((await y.getResult()).hash) : E
    }, g = ({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), b = () => Ce(g, () => {}, P.UNLOCK_STATUS_CHECK), C = s({
      getFees: ({
        share: l,
        overview: m
      }) => {
        const _ = !new q(l).isZero(),
          {
            buyNetworkFee: y,
    ...
    return {
      ...
      getMaxShareAmount: ({
        ...
        const {
          ...
          hasShare: !0
        }), w = S(m.bclData.factoryConfig.deployFee), E = l.value.minus(A.plus(w).plus(y).plus(_)), N = m.bclData.tokenForDexWithFees;
        return N.lt(E) ? N : E.gte(0) ? E : new q(0)
      },
      getMaxBuyAmount: ({
        tokenBalance: l
      }) => {
  ...
  constructor(e = {}) {
    ...
    d(this, "request", async ({
      ...
      const f = (typeof t == "boolean" ? t : this.baseApiParams.secure) && this.securityWorker && await this.securityWorker(this.securityData) || {},
        u = this.mergeRequestParams(h, f),
        $ = o && this.toQueryString(o),
        P = this.contentFormatters[n || ge.Json],
        F = a || u.format;
      return this.customFetch(`${c||this.baseUrl||""}${s}${$?`?${$}`:""}`, {
        ...u,
        headers: {
        ...
        const R = F ? await k[F]().then(K => (I.ok ? I.data = K : I.error = K, I)).catch(K => (I.error = K, I)) : I;
        if (p && this.abortControllers.delete(p), !k.ok) throw R;
        return R.data
      })
    });
    Object.assign(this, e)
...
const ir = () => {
    const {
      ...
      LAUNCH_FEE: new q(.0114),
      LAUNCH_BUY_FEE: new q(.012),
      BUY_FEE: new q(.0062),
      SELL_FEE: new q(.0044),
      UNLOCK_FEE: new q(.0037)
    }, P = {
      ...
      return C.value.set(b, v), v
    }, k = g => new q(1).minus(S(g.fees)).div(S(g.coins)), R = p(({
      masterAddress: g
      ...
      tons: g,
      masterAddress: b
    }) => await W(async () => await F(b).getFirstCoinsForTons(U(new q(g))))()), z = p(({
      tons: g,
      masterAddress: b
      ...
      const {
        ...
        bclSupply: m,
        maxSupply: _
      } = T.data, y = await (async () => new q(C).isZero() ? x({
        fees: U(new q(0)),
        coins: U(new q(0))
      }) : await H({
        tons: g,
      ...
      const w = {
        ...
        N = e(T),
        D = await W(async () => await F(C).deployCoin(N, w, E))();
      return j(D) ? x({
        queryId: l.data.queryId,
      ...
      const C = await W(async () => await F(b).openCoin(r(g)))();
      if (!j(C)) return C;
      const T = await W(async () => await C.data.getBclData())();
      if (!j(T)) return T;
      ...
      var m, _, y;
      const T = await W(async () => await F(C).openCoin(r(g)).getUserWallet(r(b)))();
      if (!j(T)) return T;
      ...
      const v = await W(async () => await F(b).openCoin(r(C)).getCoinsForTons(U(g)))();
      if (!j(v)) return v;
      ...
      const v = await W(async () => await F(b).openCoin(r(C)).getTonsForCoins(U(g)))();
      if (!j(v)) return v;
      ...
      const T = await W(async () => await F(C).getUserCoinBalance(r(b), r(g)))();
      ...
      const l = {
        ...
        m = e(v),
        _ = await W(async () => await F(C).openCoin(r(T)).sendBuy(m, l))();
      return j(_) ? x((await m.getResult()).hash) : _
    }, Tt = async ({
      jettons: g,
      tradeInfoParams: b,
      ...
      const m = await F(T).openCoin(r(C)).getUserWallet(r(v)),
        _ = e(l),
      ...
      } = P, l = b.bclData.launchPlatformFee, m = g.value.minus(T.plus(l).plus(v).plus(C)), _ = b.bclData.tokenForDexWithFees;
      return _.lt(m) ? _ : m.gte(0) ? m : new q(0)
    }, qt = s({
      getFees: ({
        overview: g
      }) => {
    ...
    return {
      ...
      getMaxBuyAmount: ({
        ...
        return g.value.minus(b).minus(C)
      },
      getReviewInfo: qt,
      fees: P
    }
