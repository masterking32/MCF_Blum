...
const dl = {
  ...
  pl = nt({
    ...
    setup(s) {
      return (t, e) => {
        const i = Ot;
        return _(), E("div", dl, [R(i, {
          name: "wallet",
          class: "icon"
        }), S("span", fl, A(t.balance), 1)])
      }
    }
  }),
  ko = lt(pl, [
    ...
    setup(s) {
      return (t, e) => {
        const i = yo,
          n = Ot,
          o = _o;
        return _(), E("div", ml, [t.errorMessage ? (_(), B(i, {
          key: 0,
          "error-message": t.errorMessage
        }, null, 8, ["error-message"])) : t.details && t.totalLabel ? (_(), E("div", vl, [t.details.length ? (_(), B(o, {
          key: 0,
          "text-min-width": 155,
          alignment: m(Lr).TOP
        }, {
          ...
          inner: G(() => [S("div", gl, [(_(!0), E(dt, null, de(t.details, (r, l) => (_(), E(dt, {
            key: r.label
          }, [S("span", null, A(r.label), 1), l !== t.details.length - 1 ? (_(), E("br", bl)) : ht("", !0)], 64))), 128))])]),
          _: 1
        }, 8, ["alignment"])) : ht("", !0), S("span", yl, A(t.totalLabel), 1)])) : ht("", !0)])
      }
    }
  }),
  xo = lt(_l, [
    ...
    setup(s, {
      ...
      return We(() => {
        ...
        const f = ko,
          ...
          b = wo,
          y = te;
        return _(), E("div", wl, [S("div", Sl, [m(i).balanceLabel ? (_(), B(f, {
          key: 0,
          ...
          key: 3,
          class: "skeleton"
        }))]), ((x = m(i).error) == null ? void 0 : x.type) === ("MEMEPAD_UNLOCK_ERRORS" in u ? u.MEMEPAD_UNLOCK_ERRORS : m(ol)).NOT_ENOUGH_TOKEN ? (_(), B(b, {
          key: 0,
          ...
          "value-balance": (M = u.balances.tokenBalance) == null ? void 0 : M.value.toNumber()
          ...
          default: G(() => [S("div", Ml, A(("t" in u ? u.t : m(O))("memepad.jetton.unlock_btn", {
  ...
  $l = nt({
    ...
    setup(s) {
      const t = s,
        e = et(!1);
      return al("memepad-jetton-moving-to-dex"), (i, n) => {
        const o = Pr,
          r = jr,
          l = fo,
          a = Ts,
          ...
          u = ll,
          d = Rr;
        return _(), E("div", xl, [R(o), S("div", Cl, [S("div", El, [R(r, {
          size: 342,
          ...
          size: 80
        }, null, 8, ["src"])]), S("div", Tl, A(("t" in i ? i.t : m(O))("memepad.moving_to_dex.title")), 1), S("div", zl, A(("t" in i ? i.t : m(O))("memepad.moving_to_dex.subtitle", {
          ticker: i.jetton.ticker
        })), 1)]), R(u, null, {
          default: G(() => [S("div", Il, [R(c, {
            "force-loading": i.unlockEnabled === void 0
          }, {
            default: G(() => [i.unlockEnabled ? (_(), B(a, {
              key: 0,
              jetton: i.jetton,
  ...
  Fl = nt({
    ...
    setup(s) {
      const t = s,
        e = j(() => {
          const i = os(t.jetton.releaseTimestamp).label;
          return t.isReleased ? `${i} • STON.fi` : i
        });
      return (i, n) => {
        const o = hl,
          r = Ot;
        return _(), E("div", Ll, [S("div", jl, [R(o, {
          jetton: i.jetton
        }, null, 8, ["jetton"]), S("div", Rl, [S("div", Al, [S("div", Ol, A(i.jetton.ticker), 1), i.jettonInformation.stream.online ? (_(), E("div", Dl, n[2] || (n[2] = [S("div", {
          class: "dot"
        }, null, -1)]))) : ht("", !0), i.jettonInformation.inSpotlight ? (_(), E("div", Vl, [R(r, {
          name: "fire",
          class: "icon"
        }), n[3] || (n[3] = S("span", {
          class: "label"
        }, "Spotlight", -1))])) : ht("", !0)]), S("div", Wl, A(m(e)), 1)])]), S("div", Nl, [S("button", {
          type: "button",
          class: "reset copy",
          ...
          name: "edit-copy",
          class: "icon"
        }), S("span", Bl, A(("sliceWalletAddress" in i ? i.sliceWalletAddress : m(Ar))(i.jetton.address, 3)), 1)]), S("button", {
          type: "button",
          class: "reset share",
...
function Xl(s) {
  const t = s;
  tt.document = t.document, tt.DocumentFragment = t.DocumentFragment || se, tt.SVGElement = t.SVGElement || se, tt.SVGSVGElement = t.SVGSVGElement || se, tt.SVGElementInstance = t.SVGElementInstance || se, tt.Element = t.Element || se, tt.HTMLElement = t.HTMLElement || tt.Element, tt.Event = t.Event, tt.Touch = t.Touch || se, tt.PointerEvent = t.PointerEvent || t.MSPointerEvent
}
...
const Yl = s => s === ee || Co(s),
  Gl = s => _i(s) && s.nodeType === 11,
  _i = s => !!s && typeof s == "object",
  zo = s => typeof s == "function",
  Zl = s => typeof s == "number",
  ql = s => typeof s == "boolean",
  Ql = s => typeof s == "string",
  ta = s => {
  ...
  ea = s => _i(s) && !!s.constructor && /function Object\b/.test(s.constructor.toString()),
  ia = s => _i(s) && typeof s.length < "u" && zo(s.splice);
var w = {
  window: Yl,
  docFrag: Gl,
  object: _i,
...
function sa(s) {
  const t = tt.Element,
    e = s.navigator || {};
  st.supportsTouch = "ontouchstart" in s || w.func(s.DocumentTouch) && tt.document instanceof s.DocumentTouch, st.supportsPointerEvent = e.pointerEnabled !== !1 && !!tt.PointerEvent, st.isIOS = /iP(hone|od|ad)/.test(e.platform), st.isIOS7 = /iP(hone|od|ad)/.test(e.platform) && /OS 7[^\d]/.test(e.appVersion), st.isIe9 = /MSIE 9/.test(e.userAgent), st.isOperaMobile = e.appName === "Opera" && st.supportsTouch && /Presto/.test(e.userAgent), st.prefixedMatchesSelector = "matches" in t.prototype ? "matches" : "webkitMatchesSelector" in t.prototype ? "webkitMatchesSelector" : "mozMatchesSelector" in t.prototype ? "mozMatchesSelector" : "oMatchesSelector" in t.prototype ? "oMatchesSelector" : "msMatchesSelector", st.pEventTypes = st.supportsPointerEvent ? tt.PointerEvent === s.MSPointerEvent ? {
    up: "MSPointerUp",
    down: "MSPointerDown",
    over: "mouseover",
    out: "mouseout",
  ...
  } : null, st.wheelEvent = tt.document && "onmousewheel" in tt.document ? "mousewheel" : "wheel"
}
...
function $o(s) {
  const t = s instanceof tt.SVGElement ? s.getBoundingClientRect() : s.getClientRects()[0];
  return t && {
    left: t.left,
    right: t.right,
    top: t.top,
...
function sn(s) {
  return w.string(s) ? (tt.document.querySelector(s), !0) : !1
}
...
function oa(s) {
  ...
  }, "Interactable.allowFrom() has been deprecated. Use Interactble.draggable({allowFrom: newValue})."), t.prototype.actionChecker = aa, t.prototype.styleCursor = la
}

function ra(s, t, e, i, n) {
  const o = s.getRect(i),
    r = t.buttons || {
      0: 1,
      1: 4,
...
function ca(s) {
  ...
  s.usePlugin(ha), e.base.actionChecker = null, e.base.styleCursor = !0, P(e.perAction, {
    manualStart: !1,
    max: 1 / 0,
    maxPerElement: 1,
    allowFrom: null,
...
function fa(s, t) {
  ...
  n && i && (i.options[n].manualStart || !wi(i, e.element, e.prepared, t) ? e.stop() : (e.start(e.prepared, i, e.element), Oo(e, t)))
}
...
function Lo(s, t, e, i, n) {
  return t.testIgnoreAllow(t.options[s.name], e, i) && t.options[s.name].enabled && wi(t, e, s, n) ? s : null
}

function ma(s, t, e, i, n, o, r) {
...
const $s = {
  ...
  install: ca,
  listeners: {
    "interactions:down": ua,
    "interactions:move": (s, t) => {
      da(s, t), fa(s, t)
    },
    "interactions:stop": pa
  },
  maxInteractions: Ao,
  withinInteractionLimit: wi,
  validateAction: Lo
  ...
  if (e.prepared.axis = a.lockAxis === "start" ? c[0] : a.lockAxis, c !== "xy" && h !== "xy" && h !== c) {
    ...
    const d = function(f) {
      ...
      if (!p.manualStart && f.testIgnoreAllow(p, u, i)) {
        ...
        if (v && v.name === "drag" && ga(c, f) && $s.validateAction(v, f, u, i, t)) return f
      }
    };
    for (; w.element(u);) {
...
var wa = {
  id: "auto-start",
  install(s) {
    s.usePlugin($s), s.usePlugin(_a), s.usePlugin(ba)
  }
};
const Sa = (s, t) => s.splice(s.indexOf(t), 1),
  Do = (s, t) => {
...
function Ma(s) {
  if (kt = s.requestAnimationFrame, Nt = s.cancelAnimationFrame, !kt) {
    const t = ["ms", "moz", "webkit", "o"];
    for (const e of t) kt = s[`${e}RequestAnimationFrame`], Nt = s[`${e}CancelAnimationFrame`] || s[`${e}CancelRequestAnimationFrame`]
  }
  kt = kt && kt.bind(s), Nt = Nt && Nt.bind(s), kt || (kt = t => {
    const e = Date.now(),
...
function di(s, t) {
  s.__set || (s.__set = {});
  for (const e in t) ka.some(i => e.indexOf(i) === 0) || typeof s[e] != "function" && e !== "__set" && Object.defineProperty(s, e, {
    get() {
...
function Bo(s) {
  return s instanceof tt.Event || s instanceof tt.Touch
}
...
function Ea(s, t) {
  return t = t || {
    x: 0,
    y: 0
  }, st.isOperaMobile && Bo(s) ? (fi("screen", s, t), t.x += window.scrollX, t.y += window.scrollY) : fi("page", s, t), t
}

function Ta(s, t) {
  return t = t || {}, st.isOperaMobile && Bo(s) ? fi("screen", s, t) : fi("client", s, t), t
}
...
function za(s, t, e) {
  ...
  Ea(i, s.page), Ta(i, s.client), s.timeStamp = e
}
...
function Uo(s) {
  return w.string(s.pointerType) ? s.pointerType : w.number(s.pointerType) ? [void 0, void 0, "touch", "pen", "mouse"][s.pointerType] : /touch/.test(s.type || "") || s instanceof tt.Touch ? "touch" : "mouse"
}
...
function ja(s) {
  ...
  function l(d, f, p, v) {
    ...
    const b = Si(e, M => M.eventTarget === d),
      y = e[b];
    ...
    if (x)
      if (p === "all") {
        ...
        for (let L = 0; L < x.length; L++) {
          const W = x[L];
          if (W.func === p && Ke(W.options, M)) {
            d.removeEventListener(f, p, o.supportsOptions ? M : M.capture), x.splice(L, 1), x.length === 0 && (delete y.events[f], g = !0);
            break
          }
        }
  ...
  function a(d, f, p, v, b) {
    ...
    if (!i[p]) {
      i[p] = [];
      for (const M of n) r(M, p, c), r(M, p, u, !0)
    }
    const g = i[p];
    let x = Me(g, M => M.selector === d && M.context === f);
    x || (x = {
      selector: d,
      context: f,
      listeners: []
        ...
        if (L.selector === d && L.context === f) {
          ...
          for (let F = W.length - 1; F >= 0; F--) {
            ...
            if ($.func === v && Ke($.options, y)) {
              W.splice(F, 1), W.length || (g.splice(M, 1), l(f, p, c), l(f, p, u, !0)), x = !0;
              break
            }
          }
          if (x) break
  ...
  function c(d, f) {
    ...
    for (; w.element(g);) {
      for (let x = 0; x < b.length; x++) {
        ...
        if (Xt(g, L) && Kt(W, y) && Kt(W, g)) {
          const {
            listeners: F
          } = M;
          v.currentTarget = g;
          for (const $ of F) Ke($.options, p) && $.func(v)
        }
      }
      g = zt(g)
    }
...
class Ra {
  constructor(t) {
    this.currentTarget = void 0, this.originalEvent = void 0, this.type = void 0, this.originalEvent = t, di(this, t)
  }
...
function Wa(s) {
  ...
  t.prototype.preventDefault = Oa, t.prototype.checkAndPreventDefault = function(e) {
    return Da(this, s, e)
...
var Na = {
  ...
  install: Wa,
  listeners: ["down", "move", "up", "cancel"].reduce((s, t) => (s[`interactions:${t}`] = Va, s), {})
};
...
function je(s, t, e, i) {
  let n = s;
  return w.string(n) ? n = Ba(n, t, e) : w.func(n) && (n = n(...i)), w.element(n) && (n = zs(n)), n
}
...
class Ja {
  ...
  constructor(t) {
    ...
    const n = this;
    this._proxy = {};
    for (const o in Ka) Object.defineProperty(this._proxy, o, {
      get() {
        return n[o]
      }
    });
  ...
  pointerMove(t, e, i) {
    ...
    n || Ca(this.coords.velocity, this.coords.delta), this._scopeFire("interactions:move", a), !n && !this.simulation && (this.interacting() && (a.type = null, this.move(a)), this.pointerWasMoved && oi(this.coords.prev, this.coords.cur))
  }
  move(t) {
  ...
  getPointerIndex(t) {
    const e = Le(t);
    return this.pointerType === "mouse" || this.pointerType === "pen" ? this.pointers.length - 1 : Si(this.pointers, i => i.id === e)
  }
  getPointerInfo(t) {
  ...
  _doPhase(t) {
    ...
    if (r && i === "move" && (ki(this.edges, r, this.coords.delta[this.interactable.options.deltaSource]), r.width = r.right - r.left, r.height = r.bottom - r.top), this._scopeFire(`interactions:before-action-${i}`, t) === !1) return !1;
...
const Ya = {
  ...
  install: Xa,
  listeners: {
    "scope:add-document": s => Ai(s, "add"),
    "scope:remove-document": s => Ai(s, "remove"),
...
class Ga {
  ...
  updatePerActionListeners(t, e, i) {
    ...
    const o = (n = this._actions.map[t]) == null ? void 0 : n.filterEventType,
      r = l => (o == null || o(l)) && pi(l, this._actions);
  ...
  _onOff(t, e, i, n, o) {
    ...
    for (let l in r) {
      ...
      for (const a of r[l]) pi(l, this._actions) ? this.events[t === Pt.On ? "on" : "off"](l, a) : w.string(this.target) ? this._scopeEvents[t === Pt.On ? "addDelegate" : "removeDelegate"](this.target, this._context, l, a, n) : this._scopeEvents[t === Pt.On ? "add" : "remove"](this.target, l, a, n)
    }
    return this
  }
  on(t, e, i) {
  ...
  constructor(t) {
    this.list = [], this.selectorMap = {}, this.scope = void 0, this.scope = t, t.addListeners({
      "interactable:unset": e => {
        ...
        const {
          target: n
        } = i, o = w.string(n) ? this.selectorMap[n] : n[this.scope.id], r = Si(o, l => l === i);
        o.splice(r, 1)
      }
    })
  }
...
function qa(s) {
  ...
  return t.getPointerAverage = Fo, t.getTouchBBox = Ia, t.getTouchDistance = $a, t.getTouchAngle = Pa, t.getElementRect = zs, t.getElementClientRect = $o, t.matchesSelector = Xt, t.closest = Io, t.globalEvents = {}, t.version = "1.10.27", t.scope = s, t.use = function(e, i) {
    ...
    return pi(i, this.scope.actions) ? this.globalEvents[i] ? this.globalEvents[i].push(n) : this.globalEvents[i] = [n] : this.scope.events.add(this.scope.document, i, n, {
      options: o
    }), this
...
class Qa {
  constructor() {
    this.id = `__interact_scope_${Math.floor(Math.random()*100)}`, this.isInitialized = !1, this.listenerMaps = [], this.browser = st, this.defaults = me(Ho), this.Eventable = Wo, this.actions = {
      ...
      methodDict: {},
      phaselessTypes: {}
    }, this.interactStatic = qa(this), this.InteractEvent = js, this.Interactable = void 0, this.interactables = new Za(this), this._win = void 0, this.document = void 0, this.window = void 0, this.documents = [], this._plugins = {
      list: [],
      map: {}
    }, this.onWindowUnload = e => this.removeDocument(e.target);
    const t = this;
    this.Interactable = class extends Ga {
      get _defaults() {
        return t.defaults
      }
      set(e) {
  ...
  init(t) {
    return this.isInitialized ? this : th(this, t)
  }
  pluginIsInstalled(t) {
    const {
      id: e
...
function th(s, t) {
  return s.isInitialized = !0, w.window(t) && To(t), tt.init(t), st.init(t), ds.init(t), s.window = t, s.document = t.document, s.usePlugin(Ya), s.usePlugin(Aa), s
}
...
const Go = new Qa,
  ...
  eh = typeof globalThis < "u" ? globalThis : window;
Go.init(eh);
vt.use(wa);
class Rs {
  constructor(t) {
  ...
  start(t, e) {
    ...
    this.prepareStates(o), this.startEdges = P({}, n.edges), this.edges = P({}, this.startEdges), this.startOffset = sh(n.rect, e), this.startDelta = {
      x: 0,
      y: 0
    };
  ...
  setAll(t) {
    ...
    for (const d of l) {
      ...
      let v = null;
      (h = d.methods) != null && h.set && this.shouldDo(f, i, e) && (t.state = d, v = d.methods.set(t), ki(t.edges, t.rect, {
        x: t.coords.x - p.x,
        y: t.coords.y - p.y
      })), a.eventProps.push(v)
    }
...
function qo(s) {
  ...
  return ms(s.coords.cur, t), ms(s.coords.delta, t), ki(s.edges, s.rect, t), t.x = 0, t.y = 0, !0
}
...
const hh = {
  ...
  install(s) {
    s.Interaction.prototype.offsetBy = lh
  },
  listeners: {
    "interactions:new": s => {
      let {
    ...
    "interactions:before-action-end": oh,
    "interactions:stop": rh
  }
};
...
function ch(s) {
  ...
  s.usePlugin(hh), s.usePlugin(Zo), s.actions.phases.inertiastart = !0, s.actions.phases.resume = !0, t.perAction.inertia = {
    enabled: !1,
    resistance: 10,
    minSpeed: 100,
    endSpeed: 10,
...
class uh {
  ...
  inertiaTick() {
    ...
    if (n < this.te) {
      ...
      let r;
      this.isModified ? r = vh(0, 0, this.targetOffset.x, this.targetOffset.y, this.modifiedOffset.x, this.modifiedOffset.y, o) : r = {
...
const mh = {
  ...
  listeners: {
    ...
    "interactions:before-action-end": dh,
    "interactions:down": fh,
    "interactions:stop": ph,
...
const bh = function(t) {
  ...
  ri = {
    ...
    install: gh,
    listeners: {
      "interactions:before-action-move": Oi,
      "interactions:action-resume": Oi,
...
function yh(s) {
  ...
  Ct.cursors = Mh(e), Ct.defaultMargin = e.supportsTouch || e.supportsPointerEvent ? 20 : 10, i.prototype.resizable = function(o) {
    return wh(this, o, s)
...
function _h(s) {
  ...
  if (!(!(l && l.enabled) || t.pointerIsDown && /mouse|pointer/.test(t.pointerType) && !(o & l.mouseButtons))) {
    if (w.object(l.edges)) {
      ...
      for (const h in a) a[h] = Sh(h, l.edges[h], r, t._latestPointer.eventTarget, i, n, l.margin || Ct.defaultMargin);
...
const $h = {
    ...
    install(s) {
      ...
      t.snappers = P(t.snappers || {}, Ih), t.createSnapGrid = t.snappers.grid
    }
  },
  Ph = {
    start(s) {
...
function Gh(s) {
  ...
  if (!n) return;
  const r = fs(Yt(o.min, t, s.coords)) || Jh,
    l = fs(Yt(o.max, t, s.coords)) || Xh;
  e.options = {
    endOnly: o.endOnly,
    inner: P({}, xe.noInner),
    outer: P({}, xe.noOuter)
...
function ec(s) {
  const {
    ...
    options: n,
    offsets: o
  } = i, r = xi(t.interactable, t.element, t.prepared.name), l = P({}, e), a = [];
...
function ic(s) {
  ...
  return Mi(je(s.state.options.origin, null, null, [t])) || xi(s.interactable, t, s.interaction.prepared.name)
}
const sc = {
    range: 1 / 0,
    targets: null,
...
const dc = {
  ...
  install(s) {
    ...
    s.usePlugin(Zo), s.usePlugin($h), t.modifiers = Di;
    for (const e in Di) {
      const {
        _defaults: i,
        _methods: n
...
class er extends Ls {
  constructor(t, e, i, n, o, r) {
    if (super(o), di(this, i), i !== e && di(this, e), this.timeStamp = r, this.originalEvent = i, this.type = t, this.pointerId = Le(e), this.pointerType = Uo(e), this.target = n, this.currentTarget = null, t === "tap") {
...
const fc = {
  ...
  Ce = {
    ...
    listeners: {
      "interactions:new": pc,
      "interactions:update-pointer": mc,
      "interactions:move": vc,
...
const xc = {
  ...
  install: wc,
  listeners: ["move", "up", "cancel", "endall"].reduce((s, t) => (s[`pointerEvents:${t}`] = kc, s), {
    "pointerEvents:new": Sc,
    "pointerEvents:fired": Mc
  })
};
...
const Ec = {
  ...
  Tc = {
    id: "pointer-events",
    install(s) {
      s.usePlugin(_c), s.usePlugin(xc), s.usePlugin(Ec)
    }
  };
vt.use(Tc);
...
const Pc = {
  ...
  listeners: {
    "interactions:stop": (s, t) => {
      ...
      e.pointerType === "reflow" && (e._reflowResolve && e._reflowResolve(), Sa(t.interactions.list, e))
    }
  }
};
vt.use(Pc);
  ...
  jc = (s, t) => {
    ...
    const r = et(!1),
      ...
      M = () => {
        var Y;
        const z = W(),
          V = Math.ceil(((((Y = window.visualViewport) == null ? void 0 : Y.width) ?? window.innerWidth) - z) / 2);
        return {
          left: V,
          right: V
        }
      ...
      L = () => {
        const z = document.querySelector(".tabs"),
          V = document.querySelector(".memepad-jetton-header"),
          Y = (z == null ? void 0 : z.offsetHeight) ?? 0;
        return {
      ...
      W = () => {
        const z = document.querySelector(".page");
        return Math.ceil((z == null ? void 0 : z.offsetWidth) ?? 0)
      },
      F = () => {
        var Y;
        const {
        ...
        return Math.ceil((((Y = window.visualViewport) == null ? void 0 : Y.height) ?? window.innerHeight) - z - V)
      },
      $ = () => {
        const z = W(),
          V = F();
        return z < V ? z : z > V ? Math.ceil(V * x()) : Math.ceil(z / 2)
      },
      T = () => {
        const z = W(),
          V = F();
        return z < V ? Math.ceil(z / x()) : z > V ? V : Math.ceil(V / 2)
      },
      N = () => {
        var z, V;
        return (((z = s.value) == null ? void 0 : z.offsetWidth) ?? 174) > 174 && (((V = s.value) == null ? void 0 : V.offsetHeight) ?? 98) > 98
      },
      C = () => {
        ...
        const z = W(),
          ...
          Y = z - V < 0 ? 0 : Math.ceil(z - V),
          wt = 0;
        p.position.x = Y, p.position.y = wt, s.value.style.transform = `translate(${Y}px, ${wt}px)`
      },
      I = () => {
        s.value !== null && (s.value.style.height = "98px", s.value.style.width = "174px")
      },
      D = (z, V) => {
        s.value !== null && (z === void 0 && V === void 0 || (z !== void 0 && (s.value.style.width = z), V !== void 0 && (s.value.style.height = V)))
      },
      K = async () => {
        C(), await d(n)
      }, it = () => {
        requestAnimationFrame(async () => {
          N() ? (J(), await H(), D(`${$()}px`, `${T()}px`)) : I(), await d(n)
        })
      }, U = () => {
        window.addEventListener("resize", K), window.screen && "orientation" in window.screen ? window.screen.orientation.addEventListener("change", it) : window.addEventListener("orientationchange", it)
      }, q = () => {
        window.removeEventListener("resize", K), window.screen && "orientation" in window.screen ? window.screen.orientation.removeEventListener("change", it) : window.removeEventListener("orientationchange", it)
      }, X = l({
        ratio: x(),
        minHeight: 98,
        minWidth: 174
        ...
        modifiers: [ot],
        onmove(z) {
          p.position.x += z.dx, p.position.y += z.dy, z.target.style.transform = `translate(${p.position.x}px, ${p.position.y}px)`
        },
        onstart: u,
        onend: c
      }, at = {
        ...
        onmove(z) {
          var V, Y;
          p.position.x += ((V = z.deltaRect) == null ? void 0 : V.left) ?? 0, p.position.y += ((Y = z.deltaRect) == null ? void 0 : Y.top) ?? 0, z.target.style.height = `${z.rect.height}px`, z.target.style.transform = `translate(${p.position.x}px, ${p.position.y}px)`, z.target.style.width = `${z.rect.width}px`
        },
        onstart: u,
        onend(z) {
          const V = $(),
            Y = T();
          z.rect.width > V || z.rect.height > Y ? (z.target.style.height = `${Y}px`, z.target.style.width = `${V}px`, d(n).then(() => c(z))) : c(z)
        }
      }, H = async () => {
        var z, V, Y;
        b(), v(), I(), C(), n = (V = (z = a(s.value)) == null ? void 0 : z.draggable(ct)) == null ? void 0 : V.resizable(at), o = (Y = a(t.value)) == null ? void 0 : Y.on("doubletap", async wt => {
          N() ? I() : D(`${$()}px`, `${T()}px`), await d(n), wt.preventDefault()
        }), await d(n), U(), r.value = !0
      }, J = () => {
        q(), f(n), f(o), g(), y(), r.value = !1
      };
    return Or(J), {
      destroy: J,
      init: H,
  ...
  Fc = nt({
    ...
    setup(s, {
      ...
      const e = s,
        ...
        f = g => {
          var x, M;
          (M = (x = n.value) == null ? void 0 : x.contentWindow) == null || M.postMessage(g, "*")
        },
        p = () => {
          f({
            actionName: "mute"
      ...
      return (g, x) => {
        ...
        return _(), E("div", {
          ...
          ref: r,
          class: "bg"
        }, null, 512), S("div", Oc, [S("div", Dc, [R(M, {
          name: "user-voice",
          class: "icon"
        }), S("span", Vc, A(e.stream.viewers), 1)]), S("div", Wc, [R(M, {
          name: "calendar-clock",
          class: "icon"
        }), S("span", Nc, A(m(a).label), 1)])]), Ft(S("div", Bc, [S("button", {
          type: "button",
    ...
    setup(s) {
      ...
      return (r, l) => {
        ...
        return _(), E("div", Kc, [S("button", {
          ...
          default: G(() => [S("div", Hc, [S("div", Jc, A(("t" in r ? r.t : m(O))("memepad.jetton.steam.start_sheet.title")), 1), S("div", Xc, A(("t" in r ? r.t : m(O))("memepad.jetton.steam.start_sheet.subtitle")), 1), S("div", Yc, [m(e).status === "loaded" ? (_(), E("button", {
            key: 0,
            type: "button",
            class: "reset",
            onClick: l[0] || (l[0] = f => ("useCopy" in r ? r.useCopy : m(Vr))().copy(m(e).streamKey))
          }, [S("div", Gc, A(m(e).streamKey), 1), R(a, {
            name: "edit-copy",
            class: "icon"
          })])) : (_(), B(h, {
            key: 1,
  ...
  Qc = nt({
    ...
    setup(s) {
      const t = s,
        e = et(!1),
        i = async () => {
          if (t.jettonInformation.stream.key) return xt(t.jettonInformation.stream.key);
    ...
    setup(s) {
      ...
      return (i, n) => {
        ...
        const o = Ne,
          r = Ot,
          l = _o;
        return _(), E("div", eu, [i.isReleased ? ht("", !0) : (_(), E("div", iu, [S("div", su, [S("div", nu, [i.total !== void 0 && i.collected !== void 0 || i.percent ? (_(), E(dt, {
          key: 1
        }, [i.percent !== void 0 ? (_(), E("span", ou, A(`${i.percent.toFixed(2)}%`), 1)) : ht("", !0), i.total !== void 0 && i.collected !== void 0 ? (_(), E("span", ru, A(`${("formatTon"in i?i.formatTon:m(Ys))(i.collected,{trim:!0})}/${("formatTon"in i?i.formatTon:m(Ys))(i.total,{trim:!0})} TON`), 1)) : ht("", !0)], 64)) : (_(), B(o, {
          key: 0,
          class: "skeleton"
        }))]), (a = i.marketDetails) != null && a.statistics ? (_(), E("div", lu, [S("div", au, [R(r, {
          name: "personal",
          class: "icon"
        }), i.marketDetails.statistics.holdersCount ? (_(), E("span", hu, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.statistics.holdersCount, {
          accuracy: 0
        }).full), 1)) : (_(), E("span", cu, "—"))]), S("div", uu, [R(r, {
          name: "transfer",
          class: "icon"
        }), i.marketDetails.statistics.transactionsCount ? (_(), E("span", du, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.statistics.transactionsCount, {
          accuracy: 0
        }).full), 1)) : (_(), E("span", fu, "—"))]), S("div", pu, [i.marketDetails.statistics.marketCap ? (_(), E(dt, {
          key: 0
        }, [S("span", mu, A(("t" in i ? i.t : m(O))("memepad.jetton.stats.market_cap")), 1), S("span", vu, A(`$${("formatCount"in i?i.formatCount:m(Wt))(i.marketDetails.statistics.marketCap).full}`), 1)], 64)) : (_(), E("span", gu, "—"))])])) : (_(), B(l, {
          key: 1,
          text: ("t" in i ? i.t : m(O))("memepad.jetton.market_info_tooltip.text"),
          "text-min-width": 155,
          "text-max-width": 155
        }, {
          default: G(() => [S("button", bu, [R(r, {
            name: "circle-help",
            class: "icon"
          }), S("span", yu, A(("t" in i ? i.t : m(O))("memepad.jetton.market_info_tooltip.label")), 1)])]),
          _: 1
        }, 8, ["text"]))]), S("div", _u, [S("div", {
          class: "line",
          style: rs({
            width: `${i.percent}%`
          })
        }, null, 4)])])), m(e).length ? (_(), E("div", wu, [S("div", Su, [S("div", Mu, A(("t" in i ? i.t : m(O))("memepad.jetton.market_cap")), 1), (h = i.marketDetails) != null && h.marketCap ? (_(), E("div", ku, [n[0] || (n[0] = S("span", {
          class: "dollar"
        }, "$", -1)), S("span", null, A(("formatCount" in i ? i.formatCount : m(Wt))(i.marketDetails.marketCap).full), 1)])) : (_(), B(o, {
          key: 1,
          class: "skeleton"
        }))]), S("div", xu, [(_(!0), E(dt, null, de(m(e), c => (_(), E("div", {
          key: c.title,
          class: "item"
        }, [S("span", Cu, A(c.title), 1), c.value === void 0 ? (_(), B(o, {
          key: 0,
          class: "skeleton"
        })) : (_(), E("span", Eu, [typeof c.value == "string" ? (_(), E(dt, {
          key: 0
        }, [Gs(A(c.value), 1)], 64)) : c.value === null ? (_(), E(dt, {
          key: 1
        }, [Gs(" — ")], 64)) : (_(), E(dt, {
          key: 2
        }, [c.value.prefix ? (_(), E("span", Tu, A(c.value.prefix), 1)) : ht("", !0), S("span", null, A(c.value.value), 1), c.value.postfix ? (_(), E("span", zu, A(c.value.postfix), 1)) : ht("", !0)], 64))]))]))), 128))])])) : ht("", !0)])
      }
    }
  }),
  $u = lt(Iu, [
...
var ju = function() {
  function s(t, e, i) {
    var n;
    this._canvasElement = null, this._bitmapSizeChangedListeners = [], this._suggestedBitmapSize = null, this._suggestedBitmapSizeChangedListeners = [], this._devicePixelRatioObservable = null, this._canvasElementResizeObserver = null, this._canvasElement = t, this._canvasElementClientSize = Z({
  ...
  return s.prototype.dispose = function() {
    ...
    var e = this._suggestedBitmapSize,
      i = Z(this._transformBitmapSize(t, this._canvasElementClientSize)),
    ...
    if (this._canvasElement !== null) {
      ...
      this._devicePixelRatioObservable = Lu(e), this._devicePixelRatioObservable.subscribe(function() {
...
function Ru(s, t) {
  if (t.type === "device-pixel-content-box") return new ju(s, t.transform, t.options);
...
function Gt(s, t) {
  ...
  return n === null ? null : new Du(n, e, i)
}
/*!
 * @license
...
const Ku = /^#([0-9a-f])([0-9a-f])([0-9a-f])([0-9a-f])?$/i,
  Hu = /^#([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})([0-9a-f]{2})?$/i,
  Ju = /^rgb\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*\)$/,
  Xu = /^rgba\(\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d{1,10})\s*,\s*(-?\d*\.?\d+)\s*\)$/;

function Re(s) {
  (s = s.toLowerCase()) in bn && (s = bn[s]);
  {
    const t = Xu.exec(s) || Ju.exec(s);
...
class td {
  ...
  Mt() {
    ...
    e.forEach((o, r) => {
      ...
      const c = k(o.Ct());
      a.lt = h.Tt, a.ht = h.ht, a.et = h.Pt, a.it[0]._t = h._t, a.it[0].st = o.Dt().Rt(h._t, c.Vt), a.rt = (l = h.Ot) !== null && l !== void 0 ? l : this.F.Bt(a.it[0].st / o.Dt().At()), a.it[0].ot = i, a.it[0].nt = n.It(i), a.tt = Qu
    })
  }
}
class ed extends _t {
...
class id {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      nt: 0,
      st: 0
    }, this.Wt = new ed(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
...
class wn {
  ...
  Gt(t, e, i, n) {
    ...
    } = t, u = this.zt.hi || !this.zt.mi ? e.T : 0, d = this.zt.bi ? e.C : 0, f = e.L + this.Xt.wi, p = e.B + this.Xt.gi, v = e.A, b = e.I, y = this.zt.Kt, g = e.P, x = i.Mi(r, y), M = Math.ceil(i.xi(r, y)), L = g + f + p, W = e.C + v + b + M + u, F = Math.max(1, Math.floor(c));
    let $ = Math.round(L * c);
    $ % 2 != F % 2 && ($ += 1);
    const T = d > 0 ? Math.max(1, Math.floor(d * h)) : 0,
      ...
      D = Math.round(I * c) - Math.floor(.5 * c),
      K = Math.floor(D + F / 2 - $ / 2),
      it = K + $,
      U = n === "right",
      q = U ? a.width - d : d,
      X = U ? l.width - T : T;
    let ot, ct, at;
    return U ? (ot = X - N, ct = X - C, at = q - u - v - d) : (ot = X + N, ct = X + C, at = q + u + v), {
      Qt: U,
      Jt: {
        ii: K,
        li: D,
...
class nd extends Ti {
  ...
  zi(t, e, i) {
    ...
    const r = Ci(n.labelBackgroundColor);
    i.t = r.t, t.V = r.i;
...
class hr {
  ...
  X(t, e) {
    ...
    const i = t.useMediaCoordinateSpace(({
      context: d
    }) => (d.font = e.R, Math.round(e.Wi.xi(d, k(this.zt).Kt, od))));
    if (i <= 0) return;
    const n = e.ji,
      o = i + 2 * n,
      r = o / 2,
    ...
    t.useBitmapCoordinateSpace(({
      ...
      const b = Math.round(h * f),
        ...
        x = Math.round(u * p),
        M = Math.round(2 * f);
      if (d.beginPath(), d.moveTo(b, y), d.lineTo(b, x - M), d.arcTo(b, x, b + M, x, M), d.lineTo(g - M, x), d.arcTo(g, x, g, x - M, M), d.lineTo(g, y), d.fill(), v.hi) {
        const L = Math.round(v.ki * f),
          W = y,
          F = Math.round((W + e.T) * p);
        d.fillStyle = v.V;
        const $ = Math.max(1, Math.floor(f)),
          T = Math.floor(.5 * f);
        d.fillRect(L - T, W, $, F - W)
      }
    }), t.useMediaCoordinateSpace(({
      context: d
    }) => {
...
class rd {
  ...
  Mt() {
    ...
    t.Kt = i.qi(k(o)), t.yt = !0;
    const r = Ci(e.labelBackgroundColor);
...
class ld extends Vs {
  constructor(t, e) {
    super(), this.tn = null, this.nn = NaN, this.sn = 0, this.en = !0, this.rn = new Map, this.hn = !1, this.ln = NaN, this.an = NaN, this._n = NaN, this.un = NaN, this.$i = t, this.cn = e, this.dn = new td(t, this), this.fn = ((n, o) => r => {
      const l = o(),
        a = n();
      if (r === k(this.tn).vn()) return {
        _t: a,
        ki: l
      };
      {
    ...
    this.bn = new rd(this, t, i), this.wn = new id(this)
  }
  W() {
    return this.cn
  }
  ...
  Tn() {
    const t = this.$i.wt().map(i => i.In().An()).filter(Yu),
      e = t.length === 0 ? null : Math.max(...t);
    this.sn = e !== null ? e : NaN
  }
  Dn(t, e, i) {
    let n = t.get(e);
    return n === void 0 && (n = new nd(this, e, i), t.set(e, n)), n
  }
}
...
class Ii {
  constructor(t, e) {
    if (e || (e = 1), Mt(t) && Ae(t) || (t = 100), t < 0) throw new TypeError("invalid base");
...
function hd(s, t, e) {
  ...
  var o, r;
  return [(o = s[t], r = kn(Vi(s[e], s[i]), Mn), {
    nt: o.nt + r.nt,
    st: o.st + r.st
  }), Vi(s[e], kn(Vi(s[n], s[t]), Mn))]
}
...
class dr extends _t {
  ...
  K(t) {
    ...
    if (n === null) return;
    const c = t.context;
    c.lineCap = "butt", c.lineJoin = "round", c.lineWidth = r, Zt(c, l), c.lineWidth = 1, ur(t, i, a, n, o, this.ps.bind(this), cd.bind(null, h))
  }
}
...
class pr extends _t {
  ...
  K(t) {
    ...
    o !== void 0 && ur(t, e, o, i, n, c, dd), a && function(u, d, f, p, v) {
      const {
      ...
      let x = null;
      const M = Math.max(1, Math.floor(b)) % 2 / 2,
        L = f * y + M;
      for (let W = p.to - 1; W >= p.from; --W) {
        ...
        if (F) {
          ...
          const T = Math.round(F.nt * b) + M,
            N = F.st * y;
          g.moveTo(T, N), g.arc(T, N, L, 0, 2 * Math.PI)
        }
      }
      g.fill()
    }(t, e, a, i, c)
...
class md extends $i {
  constructor(t, e) {
    super(t, e), this.Ws = new Ds, this.ee = new ud, this.re = new mr, this.Ws.Z([this.ee, this.re])
  }
  ne(t, e, i) {
  ...
  K({
    ...
    for (let r = this.zt.tt.from; r < this.zt.tt.to; ++r) {
      ...
      if (o) {
        if (this.zt.fe) {
          const W = h - g;
          let F = Math.max(v, Math.round(l.ve * i) - a),
            $ = F + u - 1;
          $ > v + y - 1 && ($ = v + y - 1, F = $ - u + 1), t.fillRect(W, F, c - W, $ - F + 1)
        }
        const x = h + g;
        let M = Math.max(v, Math.round(l.pe * i) - a),
          L = M + u - 1;
        L > v + y - 1 && (L = v + y - 1, M = L - u + 1), t.fillRect(d + 1, M, x - d, L - M + 1)
      }
    }
  }
  oe(t) {
...
class gd extends yr {
  constructor() {
    super(...arguments), this.Ws = new vd
  }
  ne(t, e, i) {
...
class _d extends $i {
  constructor(t, e) {
    super(t, e), this.Ws = new Ds, this.De = new bd, this.Ve = new yd, this.Ws.Z([this.De, this.Ve])
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
...
class wd extends _t {
  ...
  Ae(t, e, i) {
    ...
    for (let c = i.from; c < i.to; c++) {
      ...
      if (h !== null && (d = Math.max(h + 1, d), d = Math.min(d, f)), this.zt.he * o > 2 * a) sd(n, d, p, f - d + 1, v - p + 1, a);
      else {
        const b = f - d + 1;
...
class Sd extends yr {
  constructor() {
    super(...arguments), this.Ws = new wd
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.be(t, e, i)), i.Hs(t))
  }
...
class Wi extends Ns {
  constructor(t, e, i) {
    super(t, e, !1), this.wn = i, this.Ws = new Md(this.wn.renderer(), n => {
      const o = t.Ct();
...
class Cd extends $i {
  constructor() {
    super(...arguments), this.Ws = new xd
  }
  ne(t, e, i) {
    return Object.assign(Object.assign({}, this.te(t, e)), i.Hs(t))
  }
  Gs() {
    const t = {
      ...
      he: this.Es.St().he(),
      tt: this.zs,
      qe: this.Ls.Dt().Rt(this.Ls.W().base, k(this.Ls.Ct()).Vt)
    };
    this.Ws.J(t)
  }
}
...
class _r {
  constructor(t, e, i) {
    this._r = t, this.lr = new De(50), this.ur = e, this.F = i, this.j = -1, this.Wt = new zd(this.lr)
  }
  gt() {
...
class Bs {
  constructor(t) {
    this.Mr = {
      ...
      Nt: 0,
      yt: !1
    }, this.Sr = new Id, this.ft = !0, this.Ls = t, this.Es = t.$t(), this.Sr.J(this.Mr)
  }
  bt() {
    this.ft = !0
  }
...
class jd {
  constructor(t) {
    this.Wt = new Pd, this.ft = !0, this.Er = !0, this.Nr = performance.now(), this.Fr = this.Nr - 1, this.Wr = t
  }
  jr() {
  ...
  K({
    ...
    if (this.zt !== null && this.zt.tt !== null) {
      ...
      for (let r = this.zt.tt.from; r < this.zt.tt.to; r++) {
        ...
        l.Kt !== void 0 && (l.Kt.Hi = this.lr.xi(t, l.Kt.th), l.Kt.At = this.j, l.Kt.nt = l.nt - l.Kt.Hi / 2), Od(l, t, e, i)
      }
    }
  }
}
...
function Dd(s, t, e) {
  return !(s.Kt === void 0 || ! function(i, n, o, r, l, a) {
    ...
    switch (i.ih) {
      case "arrowDown":
      case "arrowUp":
        return Rd(0, i.nt, i.st, i.Xs, n, o);
      case "circle":
...
class Wd {
  constructor(t, e) {
    this.ft = !0, this.eh = !0, this.rh = !0, this.hh = null, this.ah = null, this.Wt = new Ad, this.Wr = t, this.$i = e, this.zt = {
      it: [],
      tt: null
    }
  }
  ...
  oh() {
    ...
    for (let c = this.zt.tt.from; c < this.zt.tt.to; c++) {
      ...
      f !== null && Vd(d, u, f, h, n.fontSize, a, t, e, r.Vt)
    }
    this.ft = !1
  }
}
...
class bi {
  ...
  static Bh(t) {
    return t === null ? null : new bi(pt.Bh(t.priceRange), t.margins)
  }
}
class Fd extends Bs {
  constructor(t, e) {
...
class Ud extends Ti {
  ...
  zi(t, e, i) {
    ...
    const h = Ci(n.axisLabelColor || n.color);
    i.t = h.t;
...
class Kd {
  constructor(t, e) {
    this.Wr = t, this.cn = e, this.Wh = new Fd(t, this), this._r = new Ud(t, this), this.jh = new _r(this._r, t, t.$t())
  }
  Hh(t) {
...
const Jd = {
  ...
  Custom: (s, t, e, i) => {
    var n;
    return {
      ue: (n = k(s(e, i)).V) !== null && n !== void 0 ? n : t.color
    }
  },
  Area: (s, t, e, i) => {
    var n, o, r, l;
...
class Xd {
  constructor(t) {
    this.Xh = (e, i) => i !== void 0 ? i.Vt : this.Wr.In().Kh(e), this.Wr = t, this.Gh = Jd[t.Jh()]
  }
  Hs(t, e) {
...
class Fs extends Hd {
  constructor(t, e, i, n, o) {
    super(t), this.zt = new Yd, this.Wh = new Nd(this), this.Il = [], this.zl = new $d(this), this.Ll = null, this.El = null, this.Nl = [], this.Fl = [], this.Wl = null, this.jl = [], this.cn = e, this.Hl = i;
    const r = new Bd(this);
    this.rn = [r], this.jh = new _r(r, this, t), i !== "Area" && i !== "Line" && i !== "Baseline" || (this.Ll = new jd(this)), this.$l(), this.Ul(o)
  }
  S() {
  ...
  $s() {
    return this.El !== null || (this.El = new Xd(this)), this.El
  }
  W() {
    return this.cn
  }
  ...
  Pn() {
    ...
    return t.push(...e), Bi(this.jl, Fi, "normal", t), t
  }
  _a() {
    return this.ua(Fi, "bottom")
  }
  ca(t) {
    return this.ua(tf, t)
  }
  ...
  Sa(t) {
    this.jl.push(new Qd(t, this))
  }
  ka(t) {
    this.jl = this.jl.filter(e => e.Vl() !== t)
  }
  ya() {
    if (this.wn instanceof Wi) return t => this.wn.Fe(t)
  }
  Ca() {
    if (this.wn instanceof Wi) return t => this.wn.We(t)
  }
  oa() {
    return !zi(this.Dt().Ta())
  }
  va(t, e) {
  ...
  $l() {
    switch (this.cn.priceFormat.type) {
      case "custom":
        ...
        break;
      case "volume":
        this.ba = new ad(this.cn.priceFormat.precision);
        break;
      case "percent":
      ...
      default: {
        ...
        this.ba = new Ii(t, this.cn.priceFormat.minMove * t)
      }
    }
  ...
  Jl() {
    ...
    const e = k(this.zt.sl());
    this.Fl = this.Nl.map((i, n) => {
      const o = k(t.Da(i.time, !0)),
        r = o < e ? 1 : -1;
      return {
        time: k(this.zt.hl(o, r)).se,
        position: i.position,
        shape: i.shape,
        color: i.color,
        id: i.id,
  ...
  Ul(t) {
    switch (this.dn = new Wd(this, this.$t()), this.Hl) {
      case "Bar":
      ...
      case "Line":
        ...
        break;
      case "Custom":
        this.wn = new Wi(this, this.$t(), ft(t));
        break;
      case "Area":
        this.wn = new md(this, this.$t());
        break;
      case "Baseline":
        this.wn = new _d(this, this.$t());
        break;
      case "Histogram":
        this.wn = new Cd(this, this.$t());
        break;
      default:
...
class of {
  constructor(t) {
    this.Wt = new nf, this.ft = !0, this.tn = t
  }
  bt() {
    this.ft = !0
  }
...
class Pn {
  ...
  Za(t, e) {
    ...
    const i = this.Li.At(),
      n = (t - e) * this.Ja() / i,
      o = new Hi(this.Ua, [2, 2.5, 2]),
      r = new Hi(this.Ua, [2, 2, 2.5]),
      l = new Hi(this.Ua, [2.5, 2, 2]),
      a = [];
...
function kr(s) {
  return s.slice().sort((t, e) => k(t.Xi()) - k(e.Xi()))
}
var Ln;
(function(s) {
...
class hf {
  constructor(t, e, i, n) {
    this.ro = 0, this.ho = null, this.Ah = null, this.lo = null, this.ao = {
      oo: !1,
      _o: null
    }, this.uo = 0, this.co = 0, this.do = new rt, this.fo = new rt, this.vo = [], this.po = null, this.mo = null, this.bo = null, this.wo = null, this.ba = Rn, this.Mo = Ki(null), this.xo = t, this.cn = e, this.So = i, this.ko = n, this.yo = new Pn(this, 100, this.Co.bind(this), this.To.bind(this))
  }
  Ta() {
    return this.xo
  }
  ...
  me(t, e, i) {
    ...
    for (let p = u; p < d; p++) {
      ...
      let M = n + c * (b - r),
        L = h ? M : this.ro - 1 - M;
      v.ve = L, M = n + c * (y - r), L = h ? M : this.ro - 1 - M, v.ce = L, M = n + c * (g - r), L = h ? M : this.ro - 1 - M, v.de = L, M = n + c * (x - r), L = h ? M : this.ro - 1 - M, v.pe = L
    }
  }
  pn(t, e) {
    const i = this.Co(t, e);
  ...
  Ko(t) {
    this.gh() || this.Vo() || this.bo === null && this.lo === null && (this.Ni() || (this.bo = this.ro - t, this.lo = k(this.zh()).Ch()))
  }
  Go(t) {
  ...
  Qo(t) {
    this.Do() || this.wo === null && this.lo === null && (this.Ni() || (this.wo = t, this.lo = k(this.zh()).Ch()))
  }
  t_(t) {
    if (this.Do() || this.wo === null) return;
    const e = k(this.zh()).Rh() / (this.Lo() - 1);
    let i = t - this.wo;
    this.Oo() && (i *= -1);
    const n = i * e,
      o = k(this.lo).Ch();
  ...
  Pa() {
    ...
    const t = this.s_();
    let e = 100;
    t !== null && (e = Math.round(1 / t.pa())), this.ba = Rn, this.gh() ? (this.ba = jn, e = 100) : this.Vo() ? (this.ba = new Ii(100, 1), e = 100) : t !== null && (this.ba = t.ma()), this.yo = new Pn(this, e, this.Co.bind(this), this.To.bind(this)), this.yo.Qa()
  }
  qo() {
    this.po = null
  }
  ...
  h_() {
    ...
    if (n === this.uo && o === this.co || (this.uo = n, this.co = o, this.mo = null, this.Ro()), e !== null) {
      ...
      this.Bo(e)
    } else this.Ah === null && (this.Bo(new pt(-.5, .5)), this.Mo = Ki(null));
    var r, l;
    this.ao.oo = !0
  }
  jo() {
    return this.gh() ? le : this.Vo() ? Te : this.eo() ? t => yi(t, this.Mo) : null
  }
  l_(t, e, i) {
...
class cf {
  constructor(t, e) {
    this.vo = [], this.a_ = new Map, this.ro = 0, this.o_ = 0, this.__ = 1e3, this.po = null, this.u_ = new rt, this.kl = t, this.$i = e, this.c_ = new rf(this);
    const i = e.W();
  ...
  C_(t, e, i) {
    let n = this.b_(e);
    if (n === null && (n = this.f_(e, this.$i.W().overlayPriceScales)), this.vo.push(t), !zi(e)) {
  ...
  f_(t, e) {
    const i = Object.assign({
      ...
      n = new hf(t, i, this.$i.W().layout, this.$i.W().localization);
...
class pf {
  ...
  Vu(t) {
    const e = Math.round(t.from),
      ...
      o = k(this.Bu());
    return {
      from: k(this.Ui(Math.max(n, e))),
      to: k(this.Ui(Math.min(o, i)))
    }
  }
  Au(t) {
    return {
      from: k(this.Da(t.from, !0)),
      to: k(this.Da(t.to, !0))
    }
  }
  Hi() {
  ...
  Go(t) {
    ...
    const e = bs(this.o_ - t, 0, this.o_),
      i = bs(this.o_ - k(this.bo), 0, this.o_);
  ...
  t_(t) {
    ...
    this.Mu = k(this.bu).ju + e, this.fu = !0, this.zu()
  }
  i_() {
  ...
  $u(t) {
    ...
    return e === void 0 && (e = new uf(i => this.dc(i), this.U_), this.cu.set(t.weight, e)), e.q_(t)
  }
  dc(t) {
...
class gf {
  constructor(t) {
    this.ft = !0, this.Ft = {
      ...
      gc: "center",
      Mc: "center"
    }, this.Wt = new vf(this.Ft), this.jt = t
  }
  bt() {
    this.ft = !0
  }
...
class bf extends Vs {
  constructor(t, e) {
    super(), this.cn = e, this.wn = new gf(this)
  }
  Rn() {
    return []
  }
...
class yf {
  constructor(t, e, i) {
    this.kc = [], this.yc = [], this.o_ = 0, this.Cc = null, this.Tc = new rt, this.Pc = new rt, this.Rc = null, this.Dc = t, this.cn = e, this.U_ = i, this.Vc = new Gu(this), this.kl = new pf(this, e.timeScale, this.cn.localization, i), this.vt = new ld(this, e.crosshair), this.Oc = new sf(e.crosshair), this.Bc = new bf(this, e.watermark), this.Ac(), this.kc[0].M_(2e3), this.Ic = this.zc(0), this.Lc = this.zc(1)
  }
  Xl() {
    this.Ec(ut.es())
  }
  ...
  fd(t) {
    const e = this.cr(t),
      i = this.yc.indexOf(t);
    At(i !== -1, "Series not found"), this.yc.splice(i, 1), k(e).Yo(t), t.S && t.S()
  }
  Zl(t, e) {
    const i = k(this.cr(t));
    i.Yo(t);
...
class Mf {
  constructor(t = {}) {
    const e = Object.assign(Object.assign({}, Sf), t);
    this.Cd = new Cr(e.xd, e.yd), this.Td = new wf(e.Sd), this.Pd = e.kd
  }
  q_(t) {
...
class Jn {
  ...
  createConverterToInternalObj(t) {
    return k(function(e) {
      return e.length === 0 ? null : ys(e[0].time) || Fe(e[0].time) ? Xi : Kn
    }(t))
  }
  key(t) {
  ...
  convertHorzItemToInternal(t) {
    return xr(e = t) ? Kn(e) : ys(e) ? Xi(e) : Xi(Us(e));
    var e
  }
  updateFormatter(t) {
    if (!this.cn) return;
    const e = t.dateFormat;
    this.cn.timeScale.timeVisible ? this.Bd = new Mf({
      xd: e,
...
class kf {
  ...
  Dr(t, e) {
    ...
    let i = 0;
    const n = Zi(this.zd, this.Ld, this.$d),
      o = Gi(this.zd, this.Ld),
      r = [n],
      l = [o];
    if (i += o, this.Ed !== null) {
      const h = Zi(this.Ld, this.Ed, this.$d);
      if (Math.sign(h) === Math.sign(n)) {
        const c = Gi(this.Ld, this.Ed);
        if (r.push(h), l.push(c), i += c, this.Nd !== null) {
          const u = Zi(this.Ed, this.Nd, this.$d);
          if (Math.sign(u) === Math.sign(n)) {
            const d = Gi(this.Ed, this.Nd);
...
function qt(s, t) {
  const e = k(s.ownerDocument).createElement("canvas");
  s.appendChild(e);
  const i = Ru(e, {
...
class Ks {
  constructor(t, e, i) {
    this.rf = 0, this.hf = null, this.lf = {
      ...
      nt: Number.NEGATIVE_INFINITY,
      st: Number.POSITIVE_INFINITY
    }, this.cf = null, this.df = !1, this.ff = null, this.vf = null, this.pf = !1, this.mf = !1, this.bf = !1, this.wf = null, this.gf = null, this.Mf = null, this.xf = null, this.Sf = null, this.kf = null, this.yf = null, this.Cf = 0, this.Tf = !1, this.Pf = !1, this.Rf = !1, this.Df = 0, this.Vf = null, this.Of = !Yi(), this.Bf = n => {
      this.Af(n)
    }, this.If = n => {
      if (this.zf(n)) {
        const o = this.Lf(n);
  ...
  tv(t) {
    const e = qi(t.changedTouches, k(this.Vf));
    if (e === null || (this.Df = ti(t), this.yf !== null) || this.Pf) return;
    this.Tf = !0;
    const i = this.Nf(St(e), k(this.vf)),
      {
        iv: n,
        nv: o,
        Ef: r
  ...
  hv(t) {
    ...
    const e = this.Nf(St(t), k(this.ff)),
      {
        Ef: i
      } = e;
  ...
  av(t) {
    let e = qi(t.changedTouches, k(this.Vf));
  ...
  Zf() {
    ...
    Yi() && (this.Mf = () => {
      ...
      passive: !0
    }), Cf(this.Yf), this.Yf.addEventListener("mousedown", this.pv.bind(this)), this.gv(), this.Yf.addEventListener("touchmove", () => {}, {
      passive: !1
    })
  }
  gv() {
  ...
  wv(t) {
    ...
    const e = this.Lf(t);
    this.$f(e, this.jf.Tv), this.Of = !Yi()
  }
  fv(t) {
    const e = qi(t.touches, k(this.Vf));
    if (e === null) return;
    const i = this.Lf(t, e);
...
class Zn {
  constructor(t, e, i, n) {
    this.Li = null, this.Lv = null, this.Ev = !1, this.Nv = new De(200), this.Jr = null, this.Fv = 0, this.Wv = !1, this.jv = () => {
      ...
      this.Wv || this.tn.Hv().$t().$h()
    }, this.tn = t, this.cn = e, this.So = e.layout, this.Vc = i, this.Uv = n === "left", this.qv = Qi("normal", n), this.Yv = Qi("top", n), this.Zv = Qi("bottom", n), this.Xv = document.createElement("div"), this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Xv.style.width = "25px", this.Xv.style.left = "0", this.Xv.style.position = "relative", this.Kv = qt(this.Xv, Z({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const o = this.Kv.canvasElement;
    o.style.position = "absolute", o.style.zIndex = "1", o.style.left = "0", o.style.top = "0", this.Gv = qt(this.Xv, Z({
      width: 16,
      height: 16
  ...
  ap() {
    ...
    let t = 0;
    const e = this.lp(),
      i = k(this.Kv.canvasElement.getContext("2d"));
    i.save();
    const n = this.Li.ja();
  ...
  pp({
    ...
    r === l ? Ei(t, 0, 0, i, n, r) : ar(t, 0, 0, i, n, r, l)
  }
  Ae({
    context: t,
    bitmapSize: e,
  ...
  wp(t) {
    ...
    e.forEach(o => {
      o.Ai() && o.gt(k(this.Li)).X(t, i, this.Nv, n)
    })
  }
  gp(t) {
    if (this.Lv === null || this.Li === null) return;
    ...
    i.forEach(a => {
      a.forEach(h => {
        h.gt(k(this.Li)).X(t, r, this.Nv, l)
      })
    })
  }
  Sp(t) {
...
class Hs {
  constructor(t, e) {
    ...
    i.style.width = "100%", i.style.height = "100%", i.style.position = "relative", i.style.overflow = "hidden", this.Wp = document.createElement("td"), this.Wp.style.padding = "0", this.jp = document.createElement("td"), this.jp.style.padding = "0", this.Fp.appendChild(i), this.Kv = qt(i, Z({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv);
    const n = this.Kv.canvasElement;
    n.style.position = "absolute", n.style.zIndex = "1", n.style.left = "0", n.style.top = "0", this.Gv = qt(i, Z({
      width: 16,
      height: 16
    })), this.Gv.subscribeSuggestedBitmapSizeChanged(this.$v);
  ...
  Up(t) {
    var e, i;
    this.Ep !== null && this.Ep.F_().p(this), this.Ep = t, this.Ep !== null && this.Ep.F_().l(Hs.prototype.Np.bind(this), this, !0), this.$p(), this.Jd.qp().indexOf(this) === this.Jd.qp().length - 1 ? (this.Tp = (e = this.Tp) !== null && e !== void 0 ? e : new xf(this.Fp, this.Jd), this.Tp.bt()) : ((i = this.Tp) === null || i === void 0 || i.tf(), this.Tp = null)
  }
  Hv() {
    return this.Jd
  }
      ...
      const l = n.$o(),
        a = function(h, c, u) {
          ...
          for (const g of h) {
            ...
            for (const M of x) b = M.zOrder, (!(y = p == null ? void 0 : p.zOrder) || b === "top" && y !== "top" || b === "normal" && y === "bottom") && (p = M, v = g)
          }
          var b, y;
          return p && v ? {
            Iv: p,
  ...
  fp(t) {
    ...
    if (t > 1 && this.um(), this.yp !== null && this.yp.fp(t), this.Cp !== null && this.Cp.fp(t), t !== 1) {
      ...
      i !== null && (i.useBitmapCoordinateSpace(n => {
        this.pp(n)
      }), this.Ep && (this.dm(i, Tf), this.fm(i), this.vm(i), this.dm(i, ii), this.dm(i, zf)))
    }
    this.Gv.applySuggestedBitmapSize();
    const e = Gt(this.Gv);
    e !== null && (e.useBitmapCoordinateSpace(({
  ...
  pp({
    ...
    r === l ? Ei(t, 0, 0, i, n, l) : ar(t, 0, 0, i, n, r, l)
  }
  fm(t) {
    const e = k(this.Ep).W_().Uh().gt();
    e !== null && e.X(t, !1)
  }
  vm(t) {
    const e = this.$i().qc();
  ...
  Kp(t, e, i) {
    this.$i().hd(this.xm(t), this.Sm(e), i, k(this.Ep))
  }
  rm() {
    this.$i().ad()
  }
  ...
  Gp() {
    if (this.Ep) {
      if (this.$i().Un(), document.activeElement !== document.body && document.activeElement !== document.documentElement) k(document.activeElement).blur();
      else {
  ...
  im(t) {
    ...
    if (this.Pp !== null || this.Mm(t) || (this.Pp = {
      ...
      if (t.Rv && r.touch || !t.Rv && r.mouse) {
        const h = i.he();
        this.Lp = new kf(.2 / h, 7 / h, .997, 15 / h), this.Lp.qd(i.ju(), this.Pp.Vd)
      } else this.Lp = null;
...
class qn {
  constructor(t, e, i, n, o) {
    this.ft = !0, this.Lv = Z({
      width: 0,
      height: 0
    }), this.jv = () => this.fp(3), this.Uv = t === "left", this.Vc = i._d, this.cn = e, this.Cm = n, this.Tm = o, this.Xv = document.createElement("div"), this.Xv.style.width = "25px", this.Xv.style.height = "100%", this.Xv.style.overflow = "hidden", this.Kv = qt(this.Xv, Z({
      width: 16,
      height: 16
    })), this.Kv.subscribeSuggestedBitmapSizeChanged(this.jv)
  }
  ...
  pp({
    ...
    Ei(t, 0, 0, e.width, e.height, this.Tm())
  }
}
...
class jf {
  constructor(t, e) {
    this.Pm = null, this.Rm = null, this.k = null, this.Dm = !1, this.Lv = Z({
      width: 0,
      height: 0
  ...
  Nm(t, e, i) {
    Ht(this.Lv, t) || (this.Lv = t, this.Wv = !0, this.Kv.resizeCanvasElement(t), this.Gv.resizeCanvasElement(t), this.Wv = !1, this.Xv.style.width = `${t.width}px`, this.Xv.style.height = `${t.height}px`, this.Vm.m(t)), this.Pm !== null && this.Pm.up(Z({
      width: e,
      height: t.height
    })), this.Rm !== null && this.Rm.up(Z({
      width: i,
      height: t.height
    }))
  }
  ...
  fp(t) {
    ...
    if (t !== 1) {
      ...
      const i = Gt(this.Kv);
      i !== null && (i.useBitmapCoordinateSpace(n => {
        this.pp(n), this.Ae(n), this.Hm(i, Lf)
    ...
    e !== null && (e.useBitmapCoordinateSpace(({
      ...
      i.clearRect(0, 0, n.width, n.height)
    }), this.$m([...this.Jd.$t().wt(), this.Jd.$t().Yc()], e), this.Hm(e, Pf))
  }
  Hm(t, e) {
  ...
  pp({
    ...
    Ei(t, 0, 0, e.width, e.height, this.Jd.$t().md())
  }
  Ae({
    context: t,
    bitmapSize: e,
...
const Rf = !!ge && !!navigator.userAgentData && navigator.userAgentData.brands.some(s => s.brand.includes("Chromium")) && !!ge && (!((ts = navigator == null ? void 0 : navigator.userAgentData) === null || ts === void 0) && ts.platform ? navigator.userAgentData.platform === "Windows" : navigator.userAgent.toLowerCase().indexOf("win") >= 0);
var ts;
class Af {
  constructor(t, e, i) {
    var n;
    this.Zm = [], this.Xm = 0, this.ro = 0, this.o_ = 0, this.Km = 0, this.Gm = 0, this.Jm = null, this.Qm = !1, this.Dp = new rt, this.Vp = new rt, this.Pc = new rt, this.tb = null, this.ib = null, this.Gd = t, this.cn = e, this.U_ = i, this.Zd = document.createElement("div"), this.Zd.classList.add("tv-lightweight-charts"), this.Zd.style.overflow = "hidden", this.Zd.style.direction = "ltr", this.Zd.style.width = "100%", this.Zd.style.height = "100%", (n = this.Zd).style.userSelect = "none", n.style.webkitUserSelect = "none", n.style.msUserSelect = "none", n.style.MozUserSelect = "none", n.style.webkitTapHighlightColor = "transparent", this.nb = document.createElement("table"), this.nb.setAttribute("cellspacing", "0"), this.Zd.appendChild(this.nb), this.sb = this.eb.bind(this), es(this.cn) && this.rb(!0), this.$i = new yf(this.Dc.bind(this), this.cn, i), this.$t().Zc().l(this.hb.bind(this), this), this.lb = new jf(this, this.U_), this.nb.appendChild(this.lb.hp());
  ...
  S() {
    ...
    this.Zm = [], k(this.lb).S(), this.Zd.parentElement !== null && this.Zd.parentElement.removeChild(this.Zd), this.Pc.S(), this.Dp.S(), this.Vp.S(), this.fb()
  }
  ob(t, e, i = !1) {
    ...
    const o = this.ro + "px",
      r = this.o_ + "px";
    k(this.Zd).style.height = o, k(this.Zd).style.width = r, this.nb.style.height = o, this.nb.style.width = r, i ? this.pb(ut.es(), performance.now()) : this.$i.Xl()
  }
  fp(t) {
    t === void 0 && (t = ut.es());
  ...
  bb() {
    ...
    const i = k(e.getContext("2d"));
    return this.wb(i), e
  }
  gb(t) {
    return t === "left" && !this.Mb() || t === "right" && !this.xb() || this.Zm.length === 0 ? 0 : k(t === "left" ? this.Zm[0].bm() : this.Zm[0].wm()).cp()
  }
  Sb() {
    ...
    const n = this.Zm[0],
      o = (l, a) => {
        ...
        for (let c = 0; c < this.Zm.length; c++) {
          const u = this.Zm[c],
            d = k(l === "left" ? u.bm() : u.wm()),
            f = d.Mp();
          t !== null && d.xp(t, a, h), h += f.height
        }
      };
    this.Mb() && (o("left", 0), e += k(n.bm()).Mp().width);
    for (let l = 0; l < this.Zm.length; l++) {
      const a = this.Zm[l],
        h = a.Mp();
      t !== null && a.xp(t, e, i), i += h.height
    }
    e += n.Mp().width, this.xb() && (o("right", e), e += k(n.wm()).Mp().width);
    const r = (l, a, h) => {
      k(l === "left" ? this.lb.zm() : this.lb.Lm()).xp(k(t), a, h)
    };
    if (this.cn.timeScale.visible) {
      const l = this.lb.Mp();
      if (t !== null) {
        let a = 0;
        this.Mb() && (r("left", a, i), a = k(n.bm()).Mp().width), this.lb.xp(t, a, i), a += l.width, this.xb() && r("right", a, i)
      }
      i += l.height
    }
    return Z({
  ...
  Tb() {
    let t = 0,
      e = 0,
      i = 0;
    for (const p of this.Zm) this.Mb() && (e = Math.max(e, k(p.bm()).ap(), this.cn.leftPriceScale.minimumWidth)), this.xb() && (i = Math.max(i, k(p.wm()).ap(), this.cn.rightPriceScale.minimumWidth)), t += p.g_();
    e = _s(e), i = _s(i);
    const n = this.o_,
      o = this.ro,
      r = Math.max(n - e - i, 0),
    ...
    for (let p = 0; p < this.Zm.length; ++p) {
      ...
      let b = 0,
        y = 0;
      y = p === this.Zm.length - 1 ? u - f : Math.round(v.g_() * d), b = Math.max(y, 2), f += b, v.up(Z({
        width: r,
        height: b
  ...
  Pb(t) {
    ...
    return Rf ? 1 / window.devicePixelRatio : 1
  }
  eb(t) {
...
class Ff {
  ...
  tw(t, e) {
    ...
    for (let v = p; v < this.Zb.length; ++v) is(this.Zb[v].pointData, v);
  ...
  Jb(t) {
    ...
    for (let i = 0; i < this.Zb.length && i < t.length; ++i) {
      ...
      o.timeWeight = n.timeWeight, is(o.pointData, i)
    }
    if (e === -1 && this.Zb.length !== t.length && (e = Math.min(this.Zb.length, t.length)), e === -1) return -1;
    for (let i = e; i < t.length; ++i) is(t[i].pointData, i);
...
function ro() {
  return {
    ...
    crosshair: Yf,
    grid: Gf,
    overlayPriceScales: Object.assign({}, ss),
    leftPriceScale: Object.assign(Object.assign({}, ss), {
      visible: !1
    }),
    rightPriceScale: Object.assign(Object.assign({}, ss), {
      visible: !0
    }),
    timeScale: qf,
    watermark: Qf,
...
class tp {
  ...
  width() {
    return zi(this.aw) ? this.lw.gb(this.aw) : 0
  }
  Li() {
    return k(this.lw.$t().$c(this.aw)).Dt
  }
}
...
class rp {
  constructor(t, e, i) {
    this.xw = new Map, this.Sw = new Map, this.kw = new rt, this.yw = new rt, this.Cw = new rt, this.Tw = new Ff(e);
    const n = i === void 0 ? Et(ro()) : yt(Et(ro()), ao(i));
    this.U_ = e, this.lw = new Af(t, n, e), this.lw.hm().l(r => {
    ...
    const o = this.lw.$t();
    this.Rw = new np(o, this.lw.cb(), this.U_)
  }
  remove() {
  ...
  addAreaSeries(t) {
    return this.Dw("Area", Bu, t)
  }
  addBaselineSeries(t) {
    return this.Dw("Baseline", Fu, t)
  }
  addBarSeries(t) {
    return this.Dw("Bar", Wu, t)
  }
  addCandlestickSeries(t = {}) {
    ...
    }(t), this.Dw("Candlestick", Vu, t)
  }
  addHistogramSeries(t) {
    return this.Dw("Histogram", Uu, t)
  }
  addLineSeries(t) {
    return this.Dw("Line", Nu, t)
  }
  removeSeries(t) {
  ...
  Dw(t, e, i = {}, n) {
    ...
    const o = yt(Et(nr), Et(e), i),
      ...
      l = new sp(r, this, this, this, this.U_);
...
function lp(s, t, e) {
  ...
  const n = new rp(i, t, e);
  return t.setOptions(n.options()), n
}

function ap(s, t) {
  return lp(s, new Jn, Jn.Ad(t))
}
...
const ho = "chart-series-type-storage-key",
    ...
    const t = It("$iBkM1fJygO"),
      ...
      d = g => {
        const x = i.value,
          M = e.value,
          L = t.value;
        if (!L || L.type !== x || L.interval !== M) return {
          type: x,
          interval: M,
          data: g
        };
        const W = g.points.filter($ => L.data.points.some(T => T.timestamp === $.timestamp)),
          F = g.points.filter($ => !L.data.points.some(T => T.timestamp === $.timestamp));
        return {
          type: x,
          interval: M,
          data: {
            points: [...F, ...L.data.points.map($ => W.find(T => T.timestamp === $.timestamp) || $)]
          }
        }
      },
      f = async g => {
        ...
        const {
          signal: M
        } = l.value, L = await hi.getMemepadJettonCandleChart(o.value, {
          interval: e.value,
          type: i.value,
          fromTimestamp: g
        });
        M.aborted || (gt(L) ? t.value = d(L.data) : r.value = x)
      }, p = It(() => Nr(async () => {
        ...
        var g;
        return t.value && t.value.type === Lt.MARKET_CAP ? (g = [...t.value.data.points].sort((x, M) => x.timestamp - M.timestamp).at(-1)) == null ? void 0 : g.price : void 0
      });
    return {
      _flow: {
        init: async () => {
    ...
    setup(s) {
      const t = s,
        ...
        x = new ResizeObserver(() => {
          var N;
          const T = c.value;
          T && ((N = u.value) == null || N.resize(T.clientWidth, T.clientHeight))
        }),
        M = () => {
          const T = c.value;
          T && x.observe(T)
      ...
      const F = (T, N, C) => {
          var it;
          const I = (it = $e().$webApp.dataUnsafe.user) == null ? void 0 : it.language_code;
          u.value || (u.value = ap(N, {
            localization: {
              timeFormatter: U => {
                const q = ot => String(ot).padStart(2, "0"),
                  X = new Date(U * 1e3);
                return `${q(X.getUTCHours())}:${q(X.getUTCMinutes())}`
              },
              priceFormatter: U => {
                if (g.value === Lt.MARKET_CAP) return `$${Ut(U,{accuracy:0})}`;
                {
                  if (Math.abs(U) < 1e-9) return "$0";
                  const [q, X] = U.toFixed(9).split("."), ot = X[0], at = X.slice(1).match(/^0+/), H = at ? at[0].length : 0, J = H > 0 ? String.fromCharCode(8321 + H) : "", z = X.slice(H + 1).replace(/0+$/, "").slice(0, 3);
                  return `$${q}.${ot}${J}${z}`
                }
              },
              locale: I
          ...
          })).sort((U, q) => U.time - q.time);
          (!d.value || W !== C) && (d.value && u.value.removeSeries(d.value), C === oe.CANDLESTICK ? d.value = u.value.addCandlestickSeries({
            upColor: "#C4F85C",
            downColor: "#FF00C7",
            baseLineWidth: 2,
          ...
          }), W = C, u.value.timeScale().subscribeVisibleLogicalRangeChange(U => {
            var ct, at, H, J;
            if (!U || U.from >= 0) return;
            const q = (at = (ct = d.value) == null ? void 0 : ct.dataByIndex(0)) == null ? void 0 : at.time,
              X = (J = (H = u.value) == null ? void 0 : H.timeScale().getVisibleRange()) == null ? void 0 : J.from;
            if (!q || q !== X) return;
            const ot = (() => {
              const z = new Date(X * 1e3);
        ...
        $ = j(() => {
          ...
          const T = Fr(t.jettonPnl.pnlAbsoluteUSD, {
              accuracy: 2,
              trim: !0
            }),
            N = cl(t.jettonPnl.pnlPercent);
          return {
            label: `P&L ${T} ${N.formatted}`,
            cls: N.cls
          }
        });
      return he(() => {
        ...
        !T.container || !T.chart || F(T.chart.points, T.container, T.chartSeriesType)
      }, {
        immediate: !0
      }), he(c, T => T && M(), {
        immediate: !0
        ...
        const C = Ot;
        return _(), E("div", hp, [S("div", cp, [S("div", {
          class: "section",
          style: rs({
            "grid-template-columns": `repeat(${m(b).length}, 1fr)`
          })
        }, [(_(!0), E(dt, null, de(m(b), I => (_(), E("label", {
          key: I.value,
          class: ae(["item", {
            "is-active": m(n) === I.value
          }])
        }, [Ft(S("input", {
          "onUpdate:modelValue": N[0] || (N[0] = D => bt(g) ? g.value = D : null),
          type: "radio",
          name: "chart-type",
          value: I.value
        }, null, 8, up), [
          [ls, m(g)]
        ]), S("span", dp, A(I.label), 1)], 2))), 128))], 4), S("div", {
          class: "section",
          style: rs({
            "grid-template-columns": `repeat(${m(v).length}, 1fr)`
          })
        }, [(_(!0), E(dt, null, de(m(v), I => (_(), E("label", {
          key: I.value,
          class: ae(["item", {
            "is-active": m(i) === I.value
          }])
        }, [Ft(S("input", {
          "onUpdate:modelValue": N[1] || (N[1] = D => bt(y) ? y.value = D : null),
          type: "radio",
          name: "chart-interval",
          value: I.value
        }, null, 8, fp), [
          [ls, m(y)]
        ]), S("span", pp, A(I.label), 1)], 2))), 128))], 4), S("button", {
          type: "button",
          class: "reset chart-type",
          onClick: N[2] || (N[2] = I => m(a)(m(o) === m(oe).LINEAR ? m(oe).CANDLESTICK : m(oe).LINEAR))
          ...
          name: "candle-chart",
          class: "icon"
        }))])]), !m(e) || !m(e).data.points.length ? (_(), E("div", mp, [N[4] || (N[4] = S("img", {
          src: Zs,
          class: "lines"
        }, null, -1)), N[5] || (N[5] = S("img", {
          src: Ur,
          class: "empty"
        }, null, -1)), S("div", vp, [N[3] || (N[3] = S("div", {
          class: "dot"
        }, null, -1)), S("div", gp, A(("t" in T ? T.t : m(O))("memepad.jetton.chart.coming_text")), 1)])])) : (_(), E("div", bp, [m($) ? (_(), E("div", {
          key: 0,
    ...
    setup(s) {
      ...
      return (n, o) => {
        ...
        return _(), E(dt, null, [R(r, {
          ...
          default: G(() => [S("div", wp, A(("t" in n ? n.t : m(O))("memepad.jetton.unlock.btn")), 1)]),
          _: 1
        }, 8, ["type"]), R(h, {
          modelValue: m(e),
          "onUpdate:modelValue": o[1] || (o[1] = c => bt(e) ? e.value = c : null)
        }, {
          default: G(() => [S("div", Sp, [S("div", Mp, [R(l, {
            src: m(uo)(n.jetton.iconFileKey),
            size: 80
          }, null, 8, ["src"])]), S("div", kp, A(("t" in n ? n.t : m(O))("memepad.jetton.unlock.sheet.title", {
            ticker: n.jetton.ticker
          })), 1), S("div", xp, A(("t" in n ? n.t : m(O))("memepad.jetton.unlock.sheet.subtitle", {
            ticker: n.jetton.ticker
          })), 1), S("div", Cp, [R(a, {
            jetton: n.jetton,
  ...
  $p = nt({
    ...
    setup(s) {
      ...
      }, [S("span", zp, A(s.label), 1), Ft(S("input", {
  ...
  Lp = nt({
    ...
    setup(s) {
      ...
      return Hr(go, {
        ...
        }, [Ft((_(), E("div", Pp, [Yr(n.$slots, "default", {}, void 0, !0), (_(!0), E(dt, null, de(m(i), a => (_(), B(r, {
          key: a.value,
          label: a.label,
          value: a.value,
          type: s.type
    ...
    setup(s) {
      ...
      return (l, a) => {
        ...
        const h = ko,
          ...
          d = wo,
          f = te;
        return _(), E("div", Rp, [S("div", Ap, [l.inputState ? (_(), E(dt, {
          key: 0
          ...
          class: "skeleton"
        })], 64))]), ((g = (y = l.inputState) == null ? void 0 : y.error) == null ? void 0 : g.type) === ("MEMEPAD_TRADE_ERRORS" in l ? l.MEMEPAD_TRADE_ERRORS : m(rl)).NOT_ENOUGH_TOKEN ? (_(), B(d, {
          key: 0,
        ...
        }, null, 8, ["jetton-shortname", "jetton-address", "details", "input-value", "value-balance", "source"])) : (_(), E("div", {
          key: 1,
          ...
          loading: m(o),
          disabled: m(r),
          onClick: a[0] || (a[0] = M => l.$emit("trade"))
        }, {
          default: G(() => [S("div", Op, A(("t" in l ? l.t : m(O))("memepad.jetton.buy_button_label", {
          ...
          loading: m(o),
          disabled: m(r),
          onClick: a[1] || (a[1] = M => l.$emit("trade"))
        }, {
          default: G(() => [S("div", Dp, A(("t" in l ? l.t : m(O))("memepad.jetton.sell_button_label", {
            ticker: l.jetton.ticker
          })), 1)]),
          _: 1
  ...
  Fp = nt({
    ...
    setup(s) {
      ...
      return (n, o) => (_(), E("div", Np, [(_(!0), E(dt, null, de(m(i), r => (_(), E("button", {
        key: r.label,
        type: "button",
        class: "item reset",
  ...
  Yp = nt({
    ...
    emits: ci(["trade", "unlock-success", "open-slippage", "close"], ["update:modelValue", "update:tradePendings"]),
    setup(s, {
      emit: t
    }) {
      const e = s,
        i = t,
        n = ui(s, "modelValue"),
        o = ui(s, "tradePendings"),
        r = et(),
        l = et(e.jettonSdk.getSlippage()),
        a = et("0"),
        h = j(() => Cs(a.value)),
        c = j({
          get: () => a.value,
      ...
      const M = j(() => {
        ...
        L = j(() => {
          ...
          if (!C) return;
          const I = e.jettonSdk.getMaxBuyAmount({
            tokenBalance: C
          });
          return ni(I, "TON")
        });
      ...
      function T() {
        const C = j(() => e.jettonSdk.tradeStateControls.getImmediateState({
          ...
          I = et(e.jettonSdk.tradeStateControls.getEmptyState({
            operation: n.value
          })),
          D = j(() => C.value || I.value);
        ...
        const it = () => {
          ...
          },
          {
            ...
            if (it(), C.value) return;
            const {
              signal: X
            } = K, ot = await e.jettonSdk.tradeStateControls.getState({
              operation: n.value,
              amount: h.value
            });
            X.aborted || (I.value = ot)
          }, 600);
        return {
          state: D,
          updateInputState: () => {
      ...
      function N() {
        ...
        return async () => {
          ...
          await (async () => {
            o.value[D] = !0;
            const ct = () => {
                const V = ni(D === Q.BUY ? it.minReceive : K, U),
                  Y = ni(D === Q.BUY ? K : it.minReceive, "TON"),
                  wt = D === Q.BUY ? O("memepad.jetton.buy.failed_alert", {
                    askLabel: V.frontendWithSymbol,
                    offerLabel: Y.frontendWithSymbol
              ...
              at = await (D === Q.BUY ? e.jettonSdk.buyJetton({
                tons: K,
                tradeInfoParams: it
            ...
            if (at.err) {
              Zr().error("Memepad jetton trade error", at.extra), o.value[D] = !1, ct(), I({
                value: K.toFixed(),
                operation: D
              }, {
                source: D === Q.BUY ? fe.BUY : fe.SELL
              });
              return
            }
            i("trade"), W = D === Q.BUY ? e.jettonSdk.getWaitForBuyStatus() : e.jettonSdk.getWaitForSellStatus(), await co(5e3);
            const H = await W.exec({
                transactionHash: at.data
              }),
              J = H ? "success" : "failed";
            if (D === Q.BUY ? C.memepad.memepadJettonBuy({
                status: J,
                jettonId: q,
                jettonShortname: ot,
                jettonAddress: X,
                purchaseAmount: K.toNumber()
            ...
            const z = D === Q.BUY ? O("memepad.jetton.buy.success_alert", {
              ticker: U,
              label: `${qs(K)} TON`
            }) : O("memepad.jetton.sell.success_alert", {
              label: `${Wt(K).full} ${U}`
            });
            ai().success(z), o.value[D] = !1, e.tradeSuccessCallback()
          })()
        }
      }
      return (C, I) => {
        ...
        return _(), B(H, {
          ...
          inner: G(() => [S("div", Kp, [(_(), B(it, {
            ref_key: "actionControlsInputComp",
            ref: r,
            key: n.value,
            modelValue: m(c),
            "onUpdate:modelValue": I[1] || (I[1] = J => bt(c) ? c.value = J : null),
            postfix: n.value === "buy" ? "TON" : C.jetton.ticker,
            modifier: x,
            centered: "",
            onBlur: g
          }, null, 8, ["modelValue", "postfix"])), S("div", Hp, [m(M) ? (_(), E("span", Jp, A(m(M)), 1)) : m(M) === void 0 ? (_(), B(U, {
            key: 1,
            class: "skeleton"
          })) : ht("", !0)]), S("button", {
            type: "button",
            ...
            onClick: F
          }, [S("span", Xp, A(`${("t"in C?C.t:m(O))("memepad.jetton.slippage_btn")} ${m(l)}%`), 1), R(q, {
            name: "arrow-caret-down",
            class: "icon"
          })])])]),
          "bottom-action": G(() => [R(ct, {
            "force-loading": C.unlockEnabled === void 0 && C.isReleased
          }, {
            default: G(() => [C.unlockEnabled ? (_(), B(X, {
              key: 0,
              jetton: C.jetton,
              "jetton-information": C.jettonInformation,
              "jetton-sdk": C.jettonSdk,
              balances: C.balances,
              onUnlocked: I[2] || (I[2] = J => C.$emit("unlock-success"))
          ...
          "bottom-helpers": G(() => [R(at, {
            modelValue: m(u),
            "onUpdate:modelValue": I[3] || (I[3] = J => bt(u) ? u.value = J : null),
            tab: n.value,
            balances: C.balances,
            "token-balance": m(L),
  ...
  sm = nt({
    ...
    setup(s, {
      ...
      const e = s,
        ...
        r = et(e.jettonSdk.getSlippage().toString()),
        l = j(() => Cs(r.value)),
        a = j(() => l.value.lt(em) ? O("memepad.jetton.slippage.error_message.too_low") : l.value.gt(im) ? O("memepad.jetton.slippage.error_message.too_high") : ""),
        h = () => {
          if (a.value) return;
      ...
      return bo().initHandler(() => {
        ...
        return _(), B(v, {
          ...
          "top-center": G(() => [S("div", Zp, A(("t" in c ? c.t : m(O))("memepad.jetton.slippage.title")), 1)]),
          inner: G(() => [S("div", qp, [R(d, {
            ref_key: "actionControlsInputComp",
            ref: n,
            modelValue: m(r),
          ...
          "bottom-action": G(() => [S("div", Qp, [m(a) ? (_(), B(f, {
            key: 0,
            "error-message": m(a)
          }, null, 8, ["error-message"])) : (_(), E("div", tm, A(("t" in c ? c.t : m(O))("memepad.jetton.slippage.text")), 1)), R(p, {
  ...
  am = nt({
    ...
    setup(s, {
      ...
      return (r, l) => {
        const a = te;
        return _(), E("div", om, [R(a, {
          class: "buy-button",
          type: m(Rt).HIGHLIGHT,
          loading: r.tradePendings[m(Q).BUY],
          onClick: n
        }, {
          default: G(() => [S("span", rm, A(("t" in r ? r.t : m(O))("memepad.jetton.buy_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"]), R(a, {
          class: "sell-button",
          type: m(Rt).PINK,
          ...
          default: G(() => [S("span", lm, A(("t" in r ? r.t : m(O))("memepad.jetton.sell_button_preview_label")), 1)]),
          _: 1
        }, 8, ["type", "loading"])])
      }
    }
    ...
    setup(s, {
      ...
      return (c, u) => {
        const d = Tp,
          ...
          v = hm,
          b = xs;
        return _(), E("div", cm, [R(b, {
          "force-loading": c.unlockEnabled === void 0 && c.isReleased,
          "button-size": m(Jt).MEDIUM
        }, {
          default: G(() => [c.unlockEnabled ? (_(), B(d, {
            key: 0,
            jetton: c.jetton,
            "jetton-information": c.jettonInformation,
            "jetton-sdk": c.jettonSdk,
    ...
    setup(s) {
      ...
      return (n, o) => {
        ...
        return _(), E("div", fm, [R(r, {
          ...
          jetton: n.jetton,
          "jetton-information": n.jettonInformation
        }, null, 8, ["jetton", "jetton-information"]), R(a, Qr(tl(m(i))), null, 16), R(h, {
  ...
  Lm = nt({
    ...
    setup(s) {
      const t = el(),
        ...
        l = j(() => {
          var $;
          return ($ = il().getters.getUser.value) == null ? void 0 : $.referrerToken
        }),
        {
          addresses: a,
          getNetworkTokenBalance: h
        } = Es(),
        c = sl().state,
        {
          jettonBalance: u,
          jettonUnlockEnabled: d,
          jettonPnl: f,
          ...p
        } = F(),
        {
        ...
        y = () => p.update(),
        g = () => p.resetAndUpdateUnlocked(),
        x = j(() => ({
          jettonBalance: u.value ? ni(u.value, e.value.ticker) : void 0,
          tokenBalance: h(e.value.networkType)
        })),
        M = j(() => {
          if (!(!n.value || !a.value)) return nl({
            addresses: a.value,
            jetton: e.value,
      ...
      function F() {
        ...
        function it() {
          const ot = () => !M.value || c.value.status !== "connected" ? ie() : xt({
            jettonSdk: M.value
          });
          ns(ot, () => {
            C = ji(async () => {
              const H = ot();
              if (!gt(H)) return ie();
              const J = await H.data.jettonSdk.getUserJettonBalance();
              return xt((gt(J) ? J.data : $.value) || $.value)
            }, H => $.value = H, K.BALANCE_UPDATE), C.exec()
          });
          const ct = () => !M.value || !n.value || c.value.status !== "connected" || !$.value || !n.value.isReleased ? ie() : xt({
            jettonSdk: M.value,
            balance: $.value,
          ...
          ns(ct, () => {
            I = ji(async () => {
              if (T.value === !1) return xt(!1);
              const H = ct();
              if (!gt(H)) return ie();
              const J = await H.data.jettonSdk.getUnlockEnabled();
              return xt(gt(J) ? J.data : T.value)
            }, H => T.value = H, K.UNLOCK_ENABLED_UPDATE), I == null || I.exec()
          });
          const at = () => !n.value || c.value.status !== "connected" ? ie() : xt({
            walletAddress: c.value.address,
          ...
          ns(at, () => {
            D = ji(async () => {
              const H = at();
              if (!gt(H)) return ie();
              const J = await hi.getMemepadJettonPnl(H.data.jettonShortname, H.data.walletAddress);
              return xt((gt(J) ? J.data : N.value) || N.value)
            }, H => N.value = H, K.PNL_UPDATE), D == null || D.exec()
          })
        }
        return {
          init: it,
          destroy: () => {
            C == null || C.destroy(), I == null || I.destroy(), D == null || D.destroy(), $.value = void 0, T.value = void 0, N.value = void 0
          },
          update: () => {
            C == null || C.exec(), I == null || I.exec(), D == null || D.exec()
          },
          resetAndUpdateUnlocked: () => {
            T.value = void 0, I == null || I.exec()
          },
          jettonBalance: j(() => $.value),
          jettonUnlockEnabled: j(() => T.value),
          jettonPnl: j(() => N.value)
        }
      }
      return ($, T) => {
        const N = $r,
          C = Pl,
          I = mm;
        return !m(n) || !m(a) || !m(M) || m(n).status === m(tn).IN_PROGRESS ? (_(), B(N, {
          key: 0
        })) : m(n).status === m(tn).LISTED_TO_DEX ? (_(), B(C, {
          key: 1,
          jetton: m(e),
          ...
          "jetton-sdk": m(M),
          balances: m(x)
        }, null, 8, ["jetton", "jetton-information", "unlock-enabled", "jetton-sdk", "balances"])) : (_(), B(I, {
          key: 2,
          jetton: m(e),
          "jetton-information": m(n),
          "jetton-pnl": m(f),
          "chart-market-cap": m(b),
          "jetton-reactions": m(o),
          "update-jetton-reaction": m(r),
          ...
          onTradeSuccess: y,
          onUnlockSuccess: g,
          onShare: T[0] || (T[0] = D => $.$emit("share", "trade")),
          onCopy: T[1] || (T[1] = D => $.$emit("copy", "trade"))
