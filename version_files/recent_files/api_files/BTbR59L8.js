...
const Ce = h(Ie, [
  ...
  De = w({
    ...
    setup(e) {
      ...
      }, [m("div", We, S(e.label), 1), m("div", ze, [le(r.$slots, "default", {}, () => [P(S(e.value), 1)], !0)])], 2))
    }
  }),
  Ge = h(De, [
  ...
  Ze = w({
    ...
    setup(e, {
      ...
      const s = e,
        r = $(() => H(s.rank));
      $(() => ue(s.perk)), $(() => H(s.userRank)), $(() => v(`tribes.item.summary.perks.value_${(s.perk??W.FARMING10).toLowerCase()}`));
    ...
    setup(e) {
      ...
      return (t, l) => {
        ...
        return u(), k(o, {
          ...
          startapp: a(n),
          "share-text": a(r),
          onCopyLink: l[1] || (l[1] = d => ("useAnalytics" in t ? t.useAnalytics : a(z))().tribes.tribeInviteSent({
            method: "copy"
          })),
          onShareLink: l[2] || (l[2] = d => ("useAnalytics" in t ? t.useAnalytics : a(z))().tribes.tribeInviteSent({
            method: "share"
          }))
    ...
    setup(e, {
      ...
      return t.onEvent("popupClosed", () => l.value && l.value.resetSelection()), K(g, f => n("hideTribeContent", f)), i({
        ...
        return u(), _(B, null, [e.variant === "bottom-sheet" ? (u(), k(C, {
          key: 0,
          modelValue: a(d),
          "onUpdate:modelValue": p[0] || (p[0] = E => M(d) ? d.value = E : null),
          "my-tribe": e.myTribe,
          users: a(T),
  ...
  Ut = w({
    ...
    setup(e) {
      ...
      return Te().meta.back = () => U().push({
        ...
        const R = yt,
          A = Nt;
        return u(), _("div", Mt, [a(l) ? L("", !0) : (u(), k(R, {
          key: 0,
          tribe: a(i),
