...
function Sc(n, t, e, s, r, i, o) {
  try {
    ...
    var u = wt(r) ? 0 : V(r, c.__wbindgen_malloc, c.__wbindgen_realloc),
      _ = H;
    c.createExternalMessageWithoutSignature(A, n.__wbg_ptr, E, b, f, w, $, v, u, _, J(i), o);
    var h = L().getInt32(A + 4 * 0, !0),
      p = L().getInt32(A + 4 * 1, !0),
      C = L().getInt32(A + 4 * 2, !0);
    if (C) throw W(p);
...
function Cc(n, t, e, s, r, i, o, u) {
  try {
    ...
    const m = V(o, c.__wbindgen_malloc, c.__wbindgen_realloc),
      R = H;
    c.createExternalMessage(E, n.__wbg_ptr, b, f, w, $, v, y, _, h, J(i), m, R, u);
...
function xr(n) {
  ...
  return r.absoluteValue = r.abs = function() {
    ...
    var d, g, P, S, O, N, k, M, K, F, U, et, nt = this,
      _t = nt.c;
    if (l != null && (k = new v(l), !k.isInteger() && (k.c || k.s !== 1) || k.lt(i))) throw Error(Jt + "Argument " + (k.isInteger() ? "out of range: " : "not an integer: ") + B(k));
...
(function(n) {
  ...
  const w = async (I, a) => {
    ...
    let Ot;
    if (Z.type === "external")
      if (G == null || typeof G == "string") Ot = i.default.nekoton.createRawExternalMessage(St, x, G, $t + Qt).boc;
    ...
    try {
      ...
      Rt = await pt.prepareMessage({
        ...
        timeout: 60,
        signatureId: ft
      }, new h.AccountsStorageContext(It, $t, i.default.nekoton, Qt))
    } catch (pt) {
      throw Q(a, pt.toString())
    }
