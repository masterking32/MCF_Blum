    ...
    setup(t) {
      ...
      return (s, l) => {
        ...
        return o(e) ? (i(), r("div", {
          ...
          name: o(e).icon,
          class: "icon"
        }, null, 8, ["name"]), d("div", Ee, f(o(e).label), 1)], 2)) : $("", !0)
      }
    }
  }),
  Ce = y(Se, [
    ...
    setup(t) {
      ...
      return (a, u) => {
        ...
        return i(), r("div", Ae, [m(_, {
          ...
          key: 0
        }, [o(l).type === "text" ? (i(), r("div", We, f(o(l).text), 1)) : o(l).type === "status" ? (i(), p(v, {
          key: 1,
          status: o(l).status,
          class: "status"
    ...
    setup(t) {
      ...
      return (s, l) => {
        const a = Wn,
          u = st,
          _ = ot;
        return i(), r("div", Dn, [d("div", Bn, [d("div", Ln, f(("t" in s ? s.t : o(c))("wallet.history.title")), 1), t.address ? (i(), r("div", Rn, [l[1] || (l[1] = d("img", {
          src: O,
          alt: "Ton logo"
...
const qn = b({
    ...
    setup(t) {
      ...
      return B(_, () => D().meta.key = _.value), (v, w) => {
        const C = yt,
          ct = Vt,
          rt = qt,
          dt = ue,
