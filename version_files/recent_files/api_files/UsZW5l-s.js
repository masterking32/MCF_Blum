...
const Ae = h(Ie, [
  ...
  Fe = w({
    ...
    setup(e) {
      ...
      return (r, n) => {
        ...
        return u(), _("div", Ce, [n[2] || (n[2] = m("video", {
        ...
        }, null, 8, ["avatar-url", "default-avatar"]), m("div", Ne, [m("button", {
          ...
          default: V(() => [c(l, {
            ...
            class: "left-wing"
          }), m("span", Me, S(("formatFloatLine" in r ? r.formatFloatLine : a(W))(e.rank, {
            accuracy: 0
          })), 1), c(l, {
            name: "chevron-right",
            class: "icon"
  ...
  xe = w({
    ...
    setup(e, {
      ...
      return (t, l) => (u(), _("div", Pe, [m("div", je, [(u(!0), _(B, null, j(a(n), (o, d) => (u(), _("button", {
        ...
        src: o.icon,
        alt: `${o.label} icon`
      }, null, 8, Ke), m("span", null, S(o.label), 1)], 8, qe))), 128))])]))
    }
  }),
  ze = h(xe, [
  ...
  We = w({
    ...
    setup(e) {
      ...
      }, [m("div", Ge, S(e.label), 1), m("div", He, [le(r.$slots, "default", {}, () => [P(S(e.value), 1)], !0)])], 2))
    }
  }),
  De = h(We, [
  ...
  Xe = w({
    ...
    setup(e, {
      ...
      const s = e,
        r = $(() => z(s.rank));
      $(() => ue(s.perk)), $(() => z(s.userRank)), $(() => v(`tribes.item.summary.perks.value_${(s.perk??G.FARMING10).toLowerCase()}`));
      ...
      return (t, l) => {
        ...
        return u(), _("div", Je, [c(o, {
          ...
          value: ("t" in t ? t.t : a(v))(`tribes.item.summary.perks.value_${a(G).FARMING10.toLowerCase()}`)
          ...
          default: V(() => [c(T, {
            ...
            default: V(() => [m("span", Ze, S(a(r).label), 1), c(g, {
              name: "chevron-right",
              class: "chevron-icon"
            })]),
            _: 1
          ...
          default: V(() => [m("div", Qe, S(n(e.role)), 1)]),
          _: 1
    ...
    setup(e) {
      ...
      return (l, o) => {
        ...
        return u(), _("div", _t, [e.tribe ? (u(), _(B, {
          ...
          modelValue: a(r),
          "onUpdate:modelValue": o[7] || (o[7] = p => N(r) ? r.value = p : null)
        }, null, 8, ["modelValue"]), c(f, {
          modelValue: a(n),
          "onUpdate:modelValue": o[8] || (o[8] = p => N(n) ? n.value = p : null)
  ...
  Rt = w({
    ...
    setup(e, {
      ...
      return (T, b) => {
        ...
        return u(), k(p, {
          modelValue: n.value,
          "onUpdate:modelValue": b[3] || (b[3] = A => n.value = A),
          title: "Your tribe"
        }, pe({
          _: 2
        }, [e.myTribe ? {
  ...
  At = w({
    ...
    setup(e, {
      ...
      return i({
        ...
        const l = Le,
          o = ae;
        return u(), _("div", Bt, [e.users ? (u(), _("div", Et, [t[2] || (t[2] = m("div", {
          class: "title"
        }, "Select a new owner", -1)), c(o, {
          modelValue: a(s),
          "onUpdate:modelValue": t[0] || (t[0] = d => N(s) ? s.value = d : null),
          users: e.users,
          class: "list",
  ...
  Ut = w({
    ...
    setup(e, {
      ...
      return t.onEvent("popupClosed", () => l.value && l.value.resetSelection()), x(g, f => n("hideTribeContent", f)), i({
        run: R
      }), (f, p) => {
        const A = Vt,
          ne = Ct;
        return u(), _(B, null, [e.variant === "bottom-sheet" ? (u(), k(A, {
          key: 0,
          modelValue: a(d),
          "onUpdate:modelValue": p[0] || (p[0] = C => N(d) ? d.value = C : null),
          "my-tribe": e.myTribe,
          users: a(T),
  ...
  Mt = w({
    ...
    setup(e) {
      ...
      return Te().meta.back = () => M().push({
        ...
        const R = yt,
          E = Ut;
        return u(), _("div", Nt, [a(l) ? L("", !0) : (u(), k(R, {
          key: 0,
          tribe: a(i),
