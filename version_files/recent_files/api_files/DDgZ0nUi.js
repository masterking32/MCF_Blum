...
const Ce = h(Ie, [
    ...
    setup(e) {
      ...
      return (r, n) => {
        ...
        return u(), _("div", Ee, [n[2] || (n[2] = m("video", {
          ...
          key: 0,
          class: "score",
          to: ("useRouter" in r ? r.useRouter : a(O))().resolve({
            name: "tribe-top"
          })
        }, {
          default: V(() => [c(l, {
            ...
            class: "left-wing"
          }), m("span", Oe, S(("formatFloatLine" in r ? r.formatFloatLine : a(D))(e.rank, {
            accuracy: 0
          })), 1), c(l, {
            name: "chevron-right",
            class: "icon"
    ...
    setup(e, {
      ...
      return (t, l) => {
        ...
        return u(), _("div", Je, [c(o, {
          ...
          to: ("useRouter" in t ? t.useRouter : a(O))().resolve({
            name: "tribe-top"
          }).fullPath
  ...
  it = w({
    ...
    setup(e) {
      const i = e,
        ...
        r = $(() => {
          if (!(!i.leaderboard || !i.leaderboard.items.length)) return O().resolve({
  ...
  $t = w({
    ...
    emits: U(["select"], ["update:modelValue"]),
    setup(e, {
      emit: i
    }) {
      const s = i,
  ...
  Rt = w({
    ...
    emits: U(["leave"], ["update:modelValue"]),
    setup(e, {
      emit: i
    }) {
      const s = e,
