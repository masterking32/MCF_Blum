...
const Be = h(Se, [
    ...
    setup(e) {
      ...
      return (n, r) => {
        ...
        return d(), _("div", Ee, [m("div", Ae, [c(t), c(l, {
          ...
          key: 0,
          class: "score",
          to: ("useRouter" in n ? n.useRouter : a(N))().resolve({
            name: "tribe-top"
          })
        }, {
          default: V(() => [c(o, {
  ...
  qe = w({
    ...
    setup(e, {
      ...
      return (t, l) => (d(), _("div", Oe, [m("div", Me, [(d(!0), _(B, null, j(a(r), (o, u) => (d(), _("button", {
        key: u,
        class: "reset",
