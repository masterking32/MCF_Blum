...
const Te = {
  ...
  Me = Z({
    ...
    setup(o) {
      ...
      return (r, f) => (E(), V("div", Te, [q(h) ? (E(), V("div", De, [D(r.$slots, "header", {}, void 0, !0)])) : C("", !0), q(v) ? (E(), V("div", Le, [D(r.$slots, "title", {}, void 0, !0)])) : C("", !0), q(i) ? (E(), V("div", Pe, [D(r.$slots, "subTitle", {}, void 0, !0)])) : C("", !0), q(u) ? (E(), V("div", Be, [D(r.$slots, "footer", {}, void 0, !0)])) : C("", !0)]))
    }
  }),
  Xe = Y(Me, [
  ...
  He = Z({
    ...
    setup(o, {
      ...
      return se(u, () => {
        ...
        }, null, 8, ["title", "is-optional"]), c.errorCaption ? (E(), V("div", Oe, [s[3] || (s[3] = U("img", {
          src: de,
          alt: "Warning icon"
        }, null, -1)), U("div", null, _e(c.errorCaption), 1)])) : c.maxLength ? (E(), N(k, {
          key: 1,
          value: u.value,
...
const Ge = Z({
    ...
    setup(o, {
      ...
      return re(() => h("channel", {
        ...
        }, [(E(!0), V(xe, null, ye(v.value, s => {
          var S, k, e, t, _, p, b, F, $, g;
          return E(), V("div", {
            key: s.key,
            class: "field"
          }, [s.type === q(I).STRING ? (E(), N(w, ae({
            key: 0,
            modelValue: s.value,
            ...
            _: 2
          }, 1040, ["modelValue", "onUpdate:modelValue", "error-caption", "is-error", "max-length", "onChange", "onFocus", "onBlur", "onClick"])) : C("", !0), s.type === q(I).TEXTAREA ? (E(), N(c, ae({
            key: 1,
            modelValue: s.value,
            "onUpdate:modelValue": d => s.value = d,
            ref_for: !0
