...
const Ae = {
        ...
        return _(), X(I, {
          ...
          default: G(() => {
            ...
            return [B(k, {
              ...
              jetton: a.jetton
            }, () => [ce(g(a.jetton.ticker), 1)], !0)]), a.mode === r(U).BASE ? (_(), L("div", we, [w(a.$slots, "base-stats", {
              jetton: a.jetton,
              mCap: r(s),
              timeSince: r(d)
              ...
              name: "personal",
              class: "icon"
            }), v("span", be, g(("formatCount" in a ? a.formatCount : r(J))(a.jetton.stats.holdersCount, {
              accuracy: 0
            }).full), 1)])) : $("", !0), a.jetton.stats.transactionsCount !== void 0 ? (_(), L("div", Re, [B(C, {
              name: "transfer",
              class: "icon"
            }), v("span", Ue, g(("formatCount" in a ? a.formatCount : r(J))(a.jetton.stats.transactionsCount, {
              accuracy: 0
            }).full), 1)])) : $("", !0)], !0)])) : a.mode === r(U).MY_TOKENS ? (_(), L("div", Oe, [v("div", Be, g(r(n)), 1)])) : $("", !0)]), a.mode === r(U).BASE ? (_(), L("div", $e, [w(a.$slots, "base-values", {
              jetton: a.jetton,
              mCap: r(s),
              timeSince: r(d)
            }, () => [v("div", Ge, [v("span", Ve, g(("t" in a ? a.t : r(de))("memepad.jetton.stats.market_cap")), 1), v("span", We, g(r(s)), 1)]), v("div", Ye, [B(C, {
              name: "environment-leaf",
              class: "icon"
            }), v("span", Je, g(r(d)), 1)])], !0)])) : a.mode === r(U).MY_TOKENS ? (_(), L("div", Ke, [v("div", Xe, g(r(y)), 1), v("div", {
              class: ee(["pnl", r(p) && r(p).cls])
            }, g(((N = r(p)) == null ? void 0 : N.formatted) ?? "-"), 3)])) : $("", !0)]
          }),
          _: 3
        }, 8, ["to"])
      }
    ...
    const d = {
      ...
      n = async ({
        ...
        const f = {
          ...
          h = f[l],
          j = S[l];
        return await b.getMemepadJettonsSection(h, j, i, P)
  ...
  qe = () => {
    const i = D(),
      ...
      u = D(ge(async () => await b.getMemepadExploreEvents(), n => {
        o(n.transactions)
      }, 9e3));
    return {
      init: async () => {
