...
const _e = {
  ...
  Ae = L({
    ...
    setup(p) {
      return (t, l) => {
        const m = Le;
        return s(), r("div", we, [(s(!0), r(U, null, O(t.items, n => (s(), Q(m, V({
    ...
    setup(p) {
      ...
      return (o, a) => {
        ...
        return s(), r("div", je, [d("div", He, [(_ = o.user) != null && _.avatarUrl ? (s(), r("img", {
          ...
          src: i(P),
          class: "user-avatar-empty"
        }, null, 8, Se))]), d("div", qe, [(k = o.user) != null && k.nickname ? (s(), r("button", {
          key: 0,
          class: "user-name reset",
          type: "button",
          onClick: a[0] || (a[0] = I => u())
          ...
          type: "button",
          onClick: a[1] || (a[1] = I => u())
        }, [d("div", Oe, v(i(c)), 1), h(f, {
          name: "edit-copy",
          class: "icon"
        })])), i(l) ? (s(), r("div", Te, v(i(l)), 1)) : B("", !0)]), d("div", Re, [d("div", De, v(i(m)), 1), d("div", Ee, v(i(n)), 1)])])
      }
    }
  }),
  Ye = w(Fe, [
  ...
  xe = L({
    ...
    setup(p) {
      return (t, l) => {
        const m = Ye;
        return s(), r("div", Ne, [(s(!0), r(U, null, O(t.items, n => (s(), Q(m, V({
          key: n.holder.address,
          ref_for: !0
        }, n), null, 16))), 128))])
      }
      ...
      getHoldersInfo: n => {
        ...
        const o = y(() => {
          ...
          const f = (e, $) => R.Address.parse(e).equals(R.Address.parse($)),
            ...
            I = k.filter(e => e.affiliation !== A.LIQUIDITY_POOL).slice(0, q).reduce((e, $) => e.plus($.percent), new g(0)),
            j = I.gte(D),
            H = k.map(e => {
              const $ = (() => {
          ...
          b && M.push({
            ...
            color: "#166C3B",
            label: `${S(b.holder.percent,{accuracy:2,trim:!0})}%`,
            percent: b.holder.percent
          });
          const T = new g(100).minus(I).minus((b == null ? void 0 : b.holder.percent) ?? 0);
          return M.push({
            title: "",
            color: "#7C3EC3",
            label: `${S(T,{accuracy:2,trim:!0})}%`,
            percent: T,
            inChartOnly: !0
          }), {
            isRiskHolder: j,
  ...
  Ve = L({
    ...
    setup(p) {
      ...
      return (m, n) => {
        ...
        }, [(s(!0), r(U, null, O(m.preview ? 2 : 6, a => (s(), r("div", {
          key: a,
          class: "skeleton"
        }, [h(c, {
          class: "image",
