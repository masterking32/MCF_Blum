...
const Me = {
    ...
    setup(i) {
      ...
      return (t, o) => {
        ...
        return l(), d("div", Me, [t.myTribe ? (l(), d(N, {
          ...
          onClick: o[0] || (o[0] = k => n(t.myTribe.type))
        }, {
          ...
          onClick: o[1] || (o[1] = k => n(t.myTribe.type))
        }, {
          default: A(() => [_(r, {
            name: "plus",
            class: "icon center"
          ...
          onClick: o[2] || (o[2] = k => n(t.myTribe.type))
        }, {
          default: A(() => [_(r, {
            name: "warning",
            class: "icon center"
          ...
          to: a(s),
          class: "ok",
          onClick: o[3] || (o[3] = k => n(t.myTribe.type))
        }, {
          default: A(() => [_(y, {
      ...
      const e = i,
        ...
        n = (o, c) => async () => {
          ...
          ge(u, {
            ...
            Ok: r => {
              o === E.RESTORE && s.success(p("daily_reward.streak_restored", {
                days: c
              })), s.success(`You’ve got ${ke(r.claimedReward.points)} BP`), s.success(z("span", ["You’ve got ", z("i", {
                class: "ticket"
          ...
          const u = (() => {
            ...
            if (!y) return M();
            const k = ve(e.dailyReward.canClaimAt - y, "letters");
  ...
  wt = v({
    ...
    setup(i) {
      return (e, s) => {
        const n = Oe;
        return l(), d("div", gt, [e.background.type === "video" ? (l(), d("video", {
          key: 0,
          muted: "",
          autoplay: "",
          playsinline: "",
        ...
        }, null, 8, kt)) : e.background.type === "image" ? (l(), d("img", {
          key: 1,
          src: e.background.src
  ...
  Wt = v({
    ...
    setup(i, {
      ...
      const s = i,
        ...
        re = R => {
          if (C.value || D.value || !k.value) return;
          const {
            width: f,
            left: O
          } = k.value.getBoundingClientRect(), L = R.clientX - O, K = f / 3;
          L < K ? c() : L > K * 2 && o()
        };
      return se(() => {
    ...
    setup(i) {
      ...
      return e.init(), se(() => e.destroy()), (s, n) => {
        ...
        return l(), d("div", fs, [_(t, {
          ...
          bp: (k = a(e).symbols.value) == null ? void 0 : k.bp
        }, null, 8, ["mp", "bp"]), _(r, {
