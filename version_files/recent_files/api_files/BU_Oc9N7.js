...
const pt = {
    ...
    setup(S) {
      ...
      return (n, a) => {
        ...
        return o(), g(i, {
          ...
          default: B(() => [u(l, {
            src: e(Ee)(n.jetton.iconFileKey),
            size: 100,
            class: "icon"
          }, null, 8, ["src"]), s("span", Gt, p(n.jetton.ticker), 1), n.jetton.streamOnline ? (o(), r("div", Jt, [a[0] || (a[0] = s("div", {
            class: "dot"
          }, null, -1)), s("div", Wt, p(("t" in n ? n.t : e(k))("memepad.explore.spotlight.live")), 1)])) : (o(), r("div", Ht, [s("div", zt, [u(v, {
            name: "personal",
            class: "icon"
            ...
            name: "transfer",
            class: "icon"
          }), s("span", Zt, p(n.jetton.stats.transactionsCount ? ("formatCount" in n ? n.formatCount : e(ne))(n.jetton.stats.transactionsCount, {
            accuracy: 0
          }).full : "-"), 1)])]))]),
          _: 1
        }, 8, ["to"])
    ...
    setup(S) {
      ...
      return (h, _) => {
        ...
        return o(), r("div", pn, [s("div", _n, [e(d).isLowEndDevice.value ? I("", !0) : (o(), r("img", {
          ...
          size: 28
        }), s("div", yn, p(("t" in h ? h.t : e(k))("memepad.explore.spotlight.title")), 1)]), h.list.length > 1 ? (o(), g(E, {
          key: 0,
          "model-value": e(n),
          count: h.list.length,
          timer: 15e3,
        ...
        }, [(o(!0), r(W, null, ce(t.list, (b, Y) => (o(), g(M, {
          key: b.id,
          index: Y,
          jetton: b,
          class: "item"
  ...
  Dn = O({
    ...
    setup(S, {
      ...
      return Q(v, y), oe().memepad.memepadSearchOpen(), Xe().initHandler(() => d("close"), "memepad-search"), ($, K) => {
        const f = dt,
          C = Te;
        return o(), r("div", Pn, [u(f, {
        ...
        }, null, 8, ["modelValue", "placeholder", "activated", "is-loading"]), e(a).data.value ? (o(), r(W, {
          key: 0
        }, [e(a).data.value.length === 0 ? (o(), r("div", On, p(("t" in $ ? $.t : e(k))("memepad.search.empty_text")), 1)) : (o(), g(C, {
          key: 1,
    ...
    setup(S) {
      ...
      return (T, E) => {
        ...
        const M = Et,
          ...
          b = tt,
          Y = Kn;
        return o(), r(W, null, [e(K) ? (o(), r("div", Un, [e(f) ? (o(), g(M, {
          key: 0,
          title: e(f).title,
          loading: e(f).loading,
          class: "status-banner",
