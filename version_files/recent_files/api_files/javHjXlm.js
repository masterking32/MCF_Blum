...
const P = {
  ...
  H = g({
    ...
    setup(p) {
      ...
      return (t, d) => (a(), e("div", P, [r("div", V, [t.transaction.user.avatarUrl ? (a(), e("img", {
        key: 0,
      ...
      }, null, 8, F))]), r("div", J, [t.transaction.user.nickname ? (a(), e("div", O, c(t.transaction.user.nickname), 1)) : (a(), e("div", R, c(o(n)), 1)), r("div", W, [r("div", {
        class: N(["type", `is-${t.transaction.type.toLowerCase()}`])
      }, c(o(f)), 3), r("div", q, c(o(v)), 1)])]), r("div", E, [t.transaction.amount ? (a(), e("div", G, c(`${("formatTon"in t?t.formatTon:o(U))(t.transaction.amount,{accuracy:2,trim:!0})} TON`), 1)) : T("", !0), t.transaction.jettonAmount ? (a(), e("div", K, c(`${("formatCount"in t?t.formatCount:o(k))(t.transaction.jettonAmount).full} ${t.transaction.ticker}`), 1)) : T("", !0)])]))
    }
  }),
  Q = I(H, [
