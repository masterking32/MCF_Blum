...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function V(o, c) {
    ...
    x = F.join("@"), j = null, B = null;
    var H = x.match($);
    if (H ? (v = "", B = H[1], j = H[2] || null) : (F = x.split(":"), v = F.shift(), F.length && (j = F.join(":"))), j !== null && j.length > 0) {
...
const Gt = {
  ...
  Zt = N({
    ...
    setup(p) {
      ...
      return (_, m) => (d(), w("div", Jt, [f("div", Qt, E(e(n).step), 1), f("div", Ht, E(e(n).label), 1)]))
    }
  }),
  re = T(Zt, [
    ...
    setup(p, {
      ...
      return ae(() => {
        ...
        return d(), w("div", Mn, [f("div", Rn, [k(at, {
          ...
          default: O(() => [(d(!0), w(K, null, Z(e(t), (b, $) => (d(), M(l, {
            key: b.provider,
          ...
          default: O(() => [e(r).length > 0 ? (d(), w("div", Vn, [k(y, {
            name: "plus",
            class: "plus-icon"
          }), f("div", Un, [(d(!0), w(K, null, Z(e(r), b => (d(), w("div", {
            key: b,
            class: "provider"
          }, [k(y, {
            name: e(n)[b].icon,
  ...
  Dn = N({
    ...
    setup(p) {
      ...
      return (n, _) => {
        const m = On,
          t = Pt;
        return d(), w("div", Bn, [f("div", qn, [f("div", Kn, E(("t" in n ? n.t : e(A))("memepad.new.step_1.field_nsfw.label")), 1), k(m, {
          modelValue: s.value,
  ...
  na = N({
    ...
    setup(p, {
      ...
      const n = p,
        ...
        a = v => new W(v.replaceAll(",", "") || "0").toNumber(),
        i = C({
      ...
      const b = R(!1),
        $ = C(() => {
          var v;
          return {
            jettonBalance: te(new W(0), n.state.step1.ticker),
        ...
        g = C(() => {
          ...
          if (!t.value.overview) {
            if (new W(t.value.share).isZero()) {
              const x = te(new W(0), n.state.step1.ticker);
          ...
          const v = te(new W(t.value.overview.minReceive), n.state.step1.ticker);
        ...
        P = C(() => {
          ...
          const v = (() => {
            ...
            U = (() => {
              if (!v.value) return;
              const B = x.value.plus(t.value.share);
        ...
        c = async () => {
          ...
          const v = new W(t.value.share),
            x = await n.jettonManagement.getJettonOverview(v.toNumber());
          v.eq(t.value.share) && ne(x) && (t.value = {
            status: "loaded",
            share: v.toNumber(),
            overview: x.data
          }, _("update", {
      ...
      return ke(() => t.value.share, () => {
        ...
        return d(), M(H, {
          ...
          "bottom-action": O(() => [f("div", Xn, [e(P).showInfo ? (d(), w("div", ea, [e(P).tonBalance.label && !e(P).loading ? (d(), M(B, {
            key: 0,
  ...
  ka = N({
    ...
    setup(p) {
      return (s, n) => {
        const _ = X,
          m = Nt;
        return d(), w("div", da, [(d(!0), w(K, null, Z(s.details.sections, t => (d(), w("div", {
          key: t.title,
          class: "row"
          ...
          inner: O(() => [f("div", _a, [(d(!0), w(K, null, Z(t.details, r => (d(), w("span", {
            key: r.label,
            class: Te({
          ...
          _: 2
        }, 1024), f("span", fa, E(t.label), 1)])]))), 128)), s.details.totalSection ? (d(), w(K, {
          key: 0
        }, [n[0] || (n[0] = f("div", {
          class: "divider"
    ...
    setup(p, {
      ...
      return mt(() => {
        ...
        const y = Tt,
          ...
          g = le,
          P = vt;
        return d(), w("div", Ia, [k(y), e(m) === "ERROR" ? (d(), w(K, {
          key: 0
          ...
          default: O(() => [f("div", Ba, [f("div", qa, [f("div", Ka, E(("t" in u ? u.t : e(A))("cabal_arena_banner.title")), 1), f("div", Da, E(("t" in u ? u.t : e(A))("cabal_arena_banner.subtitle")), 1), f("button", {
            type: "button",
            class: "reset",
            onClick: h
  ...
  Qa = N({
    ...
    setup(p) {
      ...
      return (o, c) => {
        ...
        }, null, 8, ["form", "jetton-management", "ton-usd-rate"])) : L("", !0), e(i).step === 5 ? (d(), M(j, {
          key: 5,
