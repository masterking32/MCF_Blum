    ...
    setup(e) {
      ...
      return (i, s) => {
        ...
        return a(t) ? (r(), S(v, {
          ...
          default: B(() => [J(i.$slots, "default", {}, void 0, !0)]),
          _: 3
    ...
    setup(e, {
      ...
      const t = e,
        ...
        k = A(() => {
          ...
          if (t.status === V.STARTED) return t.kind === F.ONGOING ? c.claimDisabled : t.isQuestButton ? c.questDisabled : z(t.kind) ? c.subtasksModalOpen : s.value === W.STARTED ? {
            loader: !0,
      ...
      return (l, c) => {
        ...
        return r(), S(o, {
          ...
          default: B(() => [a(k).label ? (r(), O("div", Nt, _(a(k).label), 1)) : a(k).icon ? (r(), S(T, {
            key: 1,
            name: a(k).icon,
            class: "icon"
...
`).reduce((o, n) => {
      ...
      return (b, o) => {
        ...
        return r(), S(d, {
          ...
          title: B(() => [a(k).state === "general" ? (r(), O("span", Bt, [se(C("img", {
            src: e.iconUrl,
            alt: "Task icon"
          }, null, 8, Dt), [
            [g]
          ]), C("span", null, _(e.productName), 1)])) : $("", !0), a(k).state === "details" ? (r(), O("span", Mt, "Disclaimer")) : $("", !0)]),
          default: B(() => [a(k).state === "general" ? (r(), O("div", _t, [o[8] || (o[8] = C("div", {
            class: "text"
          ...
          footer: B(() => [a(k).state === "general" ? (r(), S(u, {
            key: 0,
    ...
    setup(e, {
      ...
      return (c, T) => {
        const b = X,
          ...
          g = ae("img-error");
        return r(), S(d, null, {
          default: B(() => [C("div", xt, [C("div", Vt, [se(C("img", {
  ...
  we = q({
    ...
    setup(e, {
      ...
      return me(I, f => Re().meta.back = f), (f, y) => {
        ...
        const h = Ft,
          N = Wt;
        return r(), O(P, null, [J(f.$slots, "default", We(He(a(p)))), R(h, {
          "model-value": !!a(o),
  ...
  fa = q({
    ...
    setup(e) {
      ...
      return Be().onOpenTaskSheet(m.task, () => {
        t.value = !0
      }), (o, n) => {
        const u = X,
          d = pt,
        ...
        return r(), O(P, null, [R(I, {
          ...
          default: B(() => [C("div", {
            ...
            default: B(() => [(r(!0), O(P, null, Y(e.task.subTasks, (y, h) => (r(), S(g, {
              key: y.id,
          ...
          name: "footer",
          fn: B(() => [e.task.status && !a(j)(e.task.status, i.value[e.task.id]) ? (r(), S(p, {
            key: 0,
    ...
    setup(e) {
      ...
      return ke(() => T.disconnect()), (n, u) => {
        ...
        return se((r(), S(ge, {
          ...
          default: B(() => [(r(!0), O(P, null, Y(e.tasks, (p, I) => (r(), S(d, {
            key: p.id,
    ...
    setup(e) {
      ...
      return (l, c) => {
        ...
        return a(v).length ? (r(), O("div", ga, [R(T, {
          ...
          default: B(() => [(r(!0), O(P, null, Y(a(v), n => (r(), S(o, {
            key: n.id,
            "tasks-claim-override": t.value,
