    ...
    setup(a) {
      ...
      return (n, o) => {
        const d = S,
          ...
          _ = H,
          g = q;
        return i(), p(B, null, [l("div", X, [l("div", J, [b(d), o[2] || (o[2] = l("img", {
          src: j,
          alt: "Dizzy emoji"
        }, null, -1)), l("div", {
          class: "title",
        ...
        }, null, 8, ["label", "to"]), l("div", ne, [(i(!0), p(B, null, N(a.leaderboard.slice(0, 3), (u, f) => (i(), c(_, {
          key: u.id,
          tribe: u,
          rank: f + 1
    ...
    setup(a) {
      ...
      return M(() => n.tribeOrUndefined.value && !r.value && v().replace({
        ...
        const g = ie,
          u = be,
          f = Z;
        return i(), p("div", ce, [e(d) && e(t) ? (i(), p(B, {
          key: 0
