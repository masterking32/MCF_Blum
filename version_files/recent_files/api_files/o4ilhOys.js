...
(function(f, G) {
  typeof exports == "object" && typeof module < "u" ? G(exports) : typeof define == "function" && define.amd ? define(["exports"], G) : (f = typeof globalThis < "u" ? globalThis : f || self, G(f.UnicornStudio = {}))
})(void 0, function(f) {
  var G = Object.defineProperty,
    U = (a, e, t) => e in a ? G(a, e, {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: t
    }) : a[e] = t,
    _ = (a, e, t) => (U(a, typeof e != "symbol" ? e + "" : e, t), t);
  let j = 0;

  function g() {
    if (!(j > 100)) {
      if (j === 100) console.warn("Curtains: too many warnings thrown, stop logging.");
      else {
  ...
  let Ne = class {
    constructor(a) {
      if (this.type = "Scene", !a || a.type !== "Renderer") v(this.type + ": Renderer not passed as first argument", a);
      else if (!a.gl) {
        v(this.type + ": Renderer WebGL context is undefined", a);
        return
      }
  ...
  class We {
    constructor({
      ...
      if (this.gl = this.canvas.getContext("webgl2", R), this._isWebGL2 = !!this.gl, this.gl || (this.gl = this.canvas.getContext("webgl", R) || this.canvas.getContext("experimental-webgl", R)), this.gl) this.onSuccess && this.onSuccess();
      else {
  ...
  class Ge {
    constructor(e, t, s) {
      if (this.type = "Uniforms", !e || e.type !== "Renderer") v(this.type + ": Renderer not passed as first argument", e);
      else if (!e.gl) {
        v(this.type + ": Renderer WebGL context is undefined", e);
        return
      }
...
`).replace(/\n/g, "");
  ...
  class nt {
    constructor(e, {
      ...
      if (this.type = "Program", !e || e.type !== "Renderer") v(this.type + ": Renderer not passed as first argument", e);
      else if (!e.gl) {
        v(this.type + ": Renderer WebGL context is undefined", e);
        return
      }
      this.renderer = e, this.gl = this.renderer.gl, this.parent = t, this.defaultVsCode = this.parent.type === "Plane" ? Tt : Rt, this.defaultFsCode = this.parent.type === "Plane" ? St : Et, s ? this.vsCode = s : (!this.renderer.production && this.parent.type === "Plane" && g(this.parent.type + ": No vertex shader provided, will use a default one"), this.vsCode = this.defaultVsCode), i ? this.fsCode = i : (this.renderer.production || g(this.parent.type + ": No fragment shader provided, will use a default one"), this.fsCode = this.defaultFsCode), this.compiled = !0, this.setupProgram()
    }
    createShader(e, t) {
...
`, this.gl.getShaderInfoLog(s)), v(r), g(this.type + ": Will use a default", i), this.createShader(t === this.gl.VERTEX_SHADER ? this.defaultVsCode : this.defaultFsCode, t)
      }
      return s
    }
    useNewShaders() {
    ...
    createProgram() {
      if (at++, this.id = at, this.program = this.gl.createProgram(), this.gl.attachShader(this.program, this.vertexShader), this.gl.attachShader(this.program, this.fragmentShader), this.gl.linkProgram(this.program), !this.renderer.production && !this.gl.getProgramParameter(this.program, this.gl.LINK_STATUS)) {
  ...
  class Mt {
    constructor(e, {
      ...
      if (this.type = "Geometry", !e || e.type !== "Renderer") v(this.type + ": Renderer not passed as first argument", e);
      else if (!e.gl) {
        v(this.type + ": Renderer WebGL context is undefined", e);
        return
      }
  ...
  class K {
    ...
    getInverse() {
      ...
      let i = e[0],
        ...
        V = p * O - P * C,
        F = m * O - P * R,
        w = L * F - z * V + T * A + k * E - Q * S + x * y;
      return w ? (w = 1 / w, s[0] = (l * F - d * V + u * A) * w, s[1] = (n * V - r * F - o * A) * w, s[2] = (C * x - R * Q + O * k) * w, s[3] = (m * Q - p * x - P * k) * w, s[4] = (d * E - h * F - u * S) * w, s[5] = (i * F - n * E + o * S) * w, s[6] = (R * T - M * x - O * z) * w, s[7] = (c * x - m * T + P * z) * w, s[8] = (h * V - l * E + u * y) * w, s[9] = (r * E - i * V - o * y) * w, s[10] = (M * Q - C * T + O * L) * w, s[11] = (p * T - c * Q - P * L) * w, s[12] = (l * S - h * A - d * y) * w, s[13] = (i * A - r * S + n * y) * w, s[14] = (C * z - M * k - R * L) * w, s[15] = (c * k - p * z + m * L) * w, t) : null
    }
    scale(e) {
      let t = this.elements;
    ...
    compose(e, t, s) {
      ...
      const r = t.elements[0],
        ...
        T = s.y,
        k = s.z;
      return i[0] = (1 - (P + C)) * z, i[1] = (p + L) * z, i[2] = (m - O) * z, i[3] = 0, i[4] = (p - L) * T, i[5] = (1 - (c + C)) * T, i[6] = (M + R) * T, i[7] = 0, i[8] = (m + O) * k, i[9] = (M - R) * k, i[10] = (1 - (c + P)) * k, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this
    }
    composeFromOrigin(e, t, s, i) {
      ...
      const n = t.elements[0],
        ...
        oe = (C - O) * Q,
        Ue = (1 - (p + M)) * Q;
      return r[0] = E, r[1] = A, r[2] = V, r[3] = 0, r[4] = F, r[5] = w, r[6] = B, r[7] = 0, r[8] = I, r[9] = oe, r[10] = Ue, r[11] = 0, r[12] = e.x + x - (E * x + F * y + I * S), r[13] = e.y + y - (A * x + w * y + oe * S), r[14] = e.z + S - (V * x + B * y + Ue * S), r[15] = 1, this
    }
  }
  class D {
    constructor(e = 0, t = e) {
  ...
  class de {
    constructor(e, {
      ...
      if (this.type = "Texture", e = e && e.renderer || e, !e || e.type !== "Renderer") v(this.type + ": Renderer not passed as first argument", e);
      else if (!e.gl) {
        e.production || v(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined");
        return
      }
      if (this.renderer = e, this.gl = this.renderer.gl, this.uuid = _e(), this._globalParameters = {
          unpackAlignment: 4,
          flipY: !t,
          premultiplyAlpha: !1,
          ...
          width: 1,
          height: 1
        }, this.scale = new D(1), this.scale.onChange(() => this.resize()), this.offset = new D, this.offset.onChange(() => this.resize()), this._loader = i, this._sourceLoaded = !1, this._uploaded = !1, this._willUpdate = !1, this.shouldUpdate = !1, this._forceUpdate = !1, this.userData = {}, this._canDraw = !1, s) {
...
gl.LINEAR filtering will be used instead`), this.parameters.magFilter = this.gl.LINEAR), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.parameters.magFilter), this._state.magFilter = this.parameters.magFilter);
    ...
    _getSizes() {
      ...
      const e = this._parent.scale ? je.set(this._parent.scale.x, this._parent.scale.y) : je.set(1, 1),
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(je.set(.001, .001)), e.equals(this.scale) || (this.scale.copy(e), this.resize())
    }
    setOffset(e) {
      if (!e.type || e.type !== "Vec2") {
    ...
    _updateTextureMatrix(e) {
      const t = Ct.set(e.parentWidth / (e.parentWidth - e.xOffset), e.parentHeight / (e.parentHeight - e.yOffset), 1);
      t.x /= this.scale.x, t.y /= this.scale.y, this._textureMatrix.matrix = kt.setFromArray([t.x, 0, 0, 0, 0, t.y, 0, 0, 0, 0, 1, 0, (1 - t.x) / 2 + this.offset.x, (1 - t.y) / 2 + this.offset.y, 0, 1]), this._updateMatrixUniform()
    }
  ...
  class ot {
    constructor(e, t = "anonymous") {
      if (this.type = "TextureLoader", e = e && e.renderer || e, !e || e.type !== "Renderer") v(this.type + ": Renderer not passed as first argument", e);
      else if (!e.gl) {
        v(this.type + ": Renderer WebGL context is undefined", e);
        return
      }
  ...
  class Ft {
    constructor(e, t = "Mesh", {
      ...
      if (this.type = t, e = e && e.renderer || e, (!e || e.type !== "Renderer") && (v(this.type + ": Curtains not passed as first argument or Curtains Renderer is missing", e), setTimeout(() => {
          this._onErrorCallback && this._onErrorCallback()
        }, 0)), this.renderer = e, this.gl = this.renderer.gl, !this.gl) {
        this.renderer.production || v(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined"), setTimeout(() => {
          this._onErrorCallback && this._onErrorCallback()
        }, 0);
        return
      }
      this._canDraw = !1, this.renderOrder = d, this._depthTest = u, this.cullFace = c, this.cullFace !== "back" && this.cullFace !== "front" && this.cullFace !== "none" && (this.cullFace = "back"), this.textures = [], this._texturesOptions = Object.assign({
        ...
        magFilter: this.gl.LINEAR
      }, p), this.crossOrigin = m, !r && s && document.getElementById(s) && (r = document.getElementById(s).innerHTML), !n && i && document.getElementById(i) && (n = document.getElementById(i).innerHTML), this._initMesh(), h = parseInt(h), l = parseInt(l), this._geometry = new Mt(this.renderer, {
        width: h,
        height: l
      }), this._program = new nt(this.renderer, {
        parent: this,
        vertexShader: r,
        fragmentShader: n
    ...
    _initMesh() {
      this.uuid = _e(), this.loader = new At(this.renderer, this, {
        sourcesLoaded: 0,
        initSourcesToLoad: 0,
        complete: !1,
        onComplete: () => {
    ...
    _restoreContext() {
      this._canDraw = !1, this._matrices && (this._matrices = null), this._program = new nt(this.renderer, {
        parent: this,
...
`, r), i && i(r, n)
  ...
  class Dt extends Ft {
    ...
    mouseToPlaneCoords(e) {
      const t = this.scale ? this.scale : It.set(1, 1),
        s = ht.set((this._boundingRect.document.width - this._boundingRect.document.width * t.x) / 2, (this._boundingRect.document.height - this._boundingRect.document.height * t.y) / 2),
        i = {
      ...
      return ht.set((e.x - i.left) / i.width * 2 - 1, 1 - (e.y - i.top) / i.height * 2)
    }
    onAfterResize(e) {
      return e && (this._onAfterResizeCallback = e), this
    }
  ...
  class Ot {
    constructor({
      ...
      this.position = new b, this.projectionMatrix = new K, this.worldMatrix = new K, this.viewMatrix = new K, this._shouldUpdate = !1, this.setSize(), this.setPerspective(e, t, s, i, r, n)
    }
    setFov(e) {
  ...
  class dt extends Dt {
    constructor(e, t, {
      ...
      super(e, t, "Plane", {
        ...
        texturesOptions: p,
        crossOrigin: m
      }), this.gl && (this.index = this.renderer.planes.length, this.target = null, this.alwaysDraw = P, this._shouldDraw = !0, this.visible = M, this._transparent = C, this.drawCheckMargins = R, this.autoloadSources = O, this.watchScroll = L, this._updateMVMatrix = !1, this.camera = new Ot({
        fov: z,
    ...
    _initTransformValues() {
      this.rotation = new b, this.rotation.onChange(() => this._applyRotation()), this.quaternion = new ke, this.relativeTranslation = new b, this.relativeTranslation.onChange(() => this._setTranslation()), this._translation = new b, this.scale = new b(1), this.scale.onChange(() => {
        this.scale.z = 1, this._applyScale()
      }), this.transformOrigin = new b(.5, .5, 0), this.transformOrigin.onChange(() => {
    ...
    _setWorldTransformOrigin() {
      this._boundingRect.world.transformOrigin = new b((this.transformOrigin.x * 2 - 1) * this._boundingRect.world.width, -(this.transformOrigin.y * 2 - 1) * this._boundingRect.world.height, this.transformOrigin.z)
    }
    _documentToWorldSpace(e) {
      return Ut.set(e.x * this.renderer.pixelRatio / this.renderer._boundingRect.width * this._boundingRect.world.ratios.width, -(e.y * this.renderer.pixelRatio / this.renderer._boundingRect.height) * this._boundingRect.world.ratios.height, e.z)
    }
    _setWorldSizes() {
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(Lt.set(.001, .001)), (e.x !== this.scale.x || e.y !== this.scale.y) && (this.scale.set(e.x, e.y, 1), this._applyScale())
    }
    _applyScale() {
      for (let e = 0; e < this.textures.length; e++) this.textures[e].resize();
    ...
    _getNearPlaneIntersections(e, t, s) {
      ...
      if (s.length === 1) s[0] === 0 ? (t[0] = this._getIntersection(t[1], q.set(.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[3], $.set(-1, -.95, 0).applyMat4(i)))) : s[0] === 1 ? (t[1] = this._getIntersection(t[0], q.set(-.95, 1, 0).applyMat4(i)), t.push(this._getIntersection(t[2], $.set(1, -.95, 0).applyMat4(i)))) : s[0] === 2 ? (t[2] = this._getIntersection(t[3], q.set(-.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[1], $.set(1, .95, 0).applyMat4(i)))) : s[0] === 3 && (t[3] = this._getIntersection(t[2], q.set(.95, -1, 0).applyMat4(i)), t.push(this._getIntersection(t[0], $.set(-1, .95, 0).applyMat4(i))));
      else if (s.length === 2) s[0] === 0 && s[1] === 1 ? (t[0] = this._getIntersection(t[3], q.set(-1, -.95, 0).applyMat4(i)), t[1] = this._getIntersection(t[2], $.set(1, -.95, 0).applyMat4(i))) : s[0] === 1 && s[1] === 2 ? (t[1] = this._getIntersection(t[0], q.set(-.95, 1, 0).applyMat4(i)), t[2] = this._getIntersection(t[3], $.set(-.95, -1, 0).applyMat4(i))) : s[0] === 2 && s[1] === 3 ? (t[2] = this._getIntersection(t[1], q.set(1, .95, 0).applyMat4(i)), t[3] = this._getIntersection(t[0], $.set(-1, .95, 0).applyMat4(i))) : s[0] === 0 && s[1] === 3 && (t[0] = this._getIntersection(t[1], q.set(.95, 1, 0).applyMat4(i)), t[3] = this._getIntersection(t[2], $.set(.95, -1, 0).applyMat4(i)));
      else if (s.length === 3) {
        let r = 0;
        for (let n = 0; n < e.length; n++) s.includes(n) || (r = n);
        t = [t[r]], r === 0 ? (t.push(this._getIntersection(t[0], q.set(-.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], $.set(-1, .95, 0).applyMat4(i)))) : r === 1 ? (t.push(this._getIntersection(t[0], q.set(.95, 1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], $.set(1, .95, 0).applyMat4(i)))) : r === 2 ? (t.push(this._getIntersection(t[0], q.set(.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], $.set(1, -.95, 0).applyMat4(i)))) : r === 3 && (t.push(this._getIntersection(t[0], q.set(-.95, -1, 0).applyMat4(i))), t.push(this._getIntersection(t[0], $.set(-1 - .95, 0).applyMat4(i))))
      } else
        for (let r = 0; r < e.length; r++) t[r][0] = 1e4, t[r][1] = 1e4;
      return t
    }
    _getWorldCoords() {
      const e = [Vt.set(-1, 1, 0), Bt.set(1, 1, 0), Nt.set(1, -1, 0), Wt.set(-1, -1, 0)];
      let t = [],
        s = [];
    ...
    mouseToPlaneCoords(e) {
      if (lt.setAxisOrder(this.quaternion.axisOrder), lt.equals(this.quaternion) && Ht.equals(this.transformOrigin)) return super.mouseToPlaneCoords(e);
      {
        const t = {
        ...
        const r = jt.set(0, 0, -1);
        r.applyQuat(this.quaternion).normalize();
        const n = Yt.set(0, 0, 0),
          o = r.dot(i);
        if (Math.abs(o) >= 1e-4) {
          const h = this._matrices.world.matrix.getInverse().multiply(this.camera.viewMatrix),
            ...
            d = Xt.set(this._translation.x - l.x, this._translation.y - l.y, this._translation.z - l.z);
  ...
  class Xe {
    constructor(e, {
      ...
      if (this.type = "RenderTarget", e = e && e.renderer || e, !e || e.type !== "Renderer") v(this.type + ": Renderer not passed as first argument", e);
      else if (!e.gl) {
        e.production || v(this.type + ": Unable to create a " + this.type + " because the Renderer WebGL context is not defined");
        return
      }
      this.renderer = e, this.gl = this.renderer.gl, this.index = this.renderer.renderTargets.length, this._shaderPass = t, this._depth = s, this._shouldClear = i, this._maxSize = {
        ...
        minFilter: this.gl.LINEAR,
        magFilter: this.gl.LINEAR
      }, l), this._texturesOptions = l, this.userData = {}, this.uuid = _e(), this.renderer.renderTargets.push(this), this.renderer.onSceneChange(), this._initRenderTarget()
    }
    _initRenderTarget() {
  ...
  class $t extends dt {
    constructor(e, t, {
      ...
      this.renderer.scene.removePlane(this), this.type = "PingPongPlane", this.renderer.scene.addPlane(this), this.readPass = new Xe(e, {
        depth: !1,
        clear: !1,
        texturesOptions: m
      }), this.writePass = new Xe(e, {
        depth: !1,
        clear: !1,
        texturesOptions: m
      }), this.createTexture({
  ...
  let Ae, xe, Ye, qe = !1,
    ...
    Z = window.scrollY || window.pageYOffset,
    $e = 0,
    ye = 0,
    ve = 0,
    be, ue;
  typeof document.hidden < "u" ? (Ae = "hidden", xe = "visibilitychange") : typeof document.msHidden < "u" ? (Ae = "msHidden", xe = "msvisibilitychange") : typeof document.webkitHidden < "u" && (Ae = "webkitHidden", xe = "webkitvisibilitychange");
  ...
  function pe(a) {
    const e = a.hasOwnProperty("trackMouse") && a.trackMouse !== 0 || a.hasOwnProperty("axisTilt") && a.axisTilt !== 0 || a.hasOwnProperty("trackMouseMove") && a.trackMouseMove !== 0,
      ...
      s = a.layerType === "effect" && (a.animating || Ie(a)),
      i = a.type === "video";
    return e || t || s || i
  }
  ...
  function Qt(a, e, t) {
    ...
    return a.forEach(i => {
      switch (i.layerType) {
        case "text":
          s.push(new os(i, e, null, t).unpackage());
          break;
        case "image":
          s.push(new ns(i, e, t).unpackage());
          break;
        case "shape":
  ...
  function Kt(a, e) {
    ...
    s.src = we("aHR0cHM6Ly9hc3NldHMudW5pY29ybi5zdHVkaW8vbWVkaWEvbWFkZV9pbl91c19zbWFsbF93ZWIuc3Zn"), s.alt = we("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv"), s.style = "width: 170px; height: auto;", t.appendChild(s), e.appendChild(t)
  }
  ...
  function Qe() {
    ...
    const e = t => {
      ...
      }), (!ve || t - ve > 64) && (Z = window.scrollY || window.pageYOffset, ye = Z - $e, $e = Z, ve = t, (ye > 1e3 || ye < 0 && !$e && !Z) && Je()), s ? (ls(), be = requestAnimationFrame(e)) : cancelAnimationFrame(be)
    };
    a.length && (be = requestAnimationFrame(e))
  }

  function De(a, e, t) {
    return (a == null ? void 0 : a.type) === "Vec3" && (e == null ? void 0 : e.type) === "Vec3" ? new b(a._x + (e._x - a._x) * t, a._y + (e._y - a._y) * t, a._z + (e._z - a._z) * t) : (a == null ? void 0 : a.type) === "Vec2" && (e == null ? void 0 : e.type) === "Vec2" ? new D(a._x + (e._x - a._x) * t, a._y + (e._y - a._y) * t) : a + (e - a) * t
  }

  function Oe(a, e) {
    return a.type === "Vec2" ? a = new D(a._x, a._y) : a.type === "Vec3" && (a = new b(a._x, a._y, a._z)), a
  }
  ...
  class es {
    constructor({
      ...
      _(this, "id", Pe()), this.prop = e, this.transition = i, this.complete = !1, this.progress = 0, this.uniformData = n, this.value = Oe(t), this.endValue = s !== void 0 ? Oe(s || 0) : null, this.lastTick = void 0, this.initialized = !1, this.startTime = null, this.breakpoints = r || []
    }
    updateEffect(e, t) {
      if (e = this.endValue ?? e, e === void 0) return !1;
      const s = performance.now(),
        i = ut(this.transition.ease),
        r = (this.startTime || t) + this.transition.delay,
        n = Math.max(0, Math.min(1, (s - r) / this.transition.duration));
      return this.progress = i(n), this.progress === 0 ? !1 : (n >= 1 && (this.complete = !0, this.progress = 0), this.lastTick = s, this.complete ? !1 : De(this.value, e, this.progress))
    }
    resetState() {
  ...
  class ts {
    constructor({
      ...
      _(this, "id", Pe()), this.prop = e, this.progress = 0, this.momentum = r, this.range = s, this.offset = i, this.mode = o, this.delta = h, this.absScrollValue = l, this.uniformData = n, this.value = Oe(t), this.lastTick = void 0, this.breakpoints = d || []
    }
    updateEffect(e, {
      top: t,
      height: s,
      ...
      if (i && (t -= Z), this.mode === "scrollIntoView") {
        const r = t + Z - ne * this.offset,
          n = r + (ne + s) * this.range;
        let o = (Z - r) / (n - r),
          h = Math.max(0, Math.min(1, o));
        return this.lastTick !== void 0 && (h = ce(h, this.lastTick, this.momentum * 2)), this.lastTick !== void 0 && Math.abs(this.lastTick - h) < 1e-4 ? !1 : (this.lastTick = h, De(e, this.value, h))
      } else if (this.mode === "whileScrolling") {
        let r = ye * this.delta;
        return this.absScrollValue && (r = Math.abs(r)), this.lastTick !== void 0 && (r = ce(r, this.lastTick, this.momentum * 2), Math.abs(r) < .001) ? !1 : (this.lastScrollPos = Z, this.lastTick = r, De(e, this.value, r))
      }
      return !1
    }
    resetState() {
  ...
  class ss {
    constructor({
      ...
      _(this, "id", Pe()), this.prop = e, this.transition = s, this.progress = 0, this.rawProgress = 0, this.lastProgress = null, this.value = Oe(t), this.uniformData = r, this.triggerOnElement = n !== void 0 ? n : 1, this.breakpoints = i || []
    }
    updateEffect(e, t, s) {
      var i;
      if (e === void 0) return !1;
      ...
      const u = ut(this.transition.ease)(this.rawProgress),
        c = Math.abs(this.progress - u) > 1e-7;
      return this.progress = u, !t && !c ? !1 : (!t && this.transition.forwardsOnly && (this.progress = 0, this.rawProgress = 0), this.lastTick = n, this.lastEnterTime = t, c ? De(e, this.value, this.progress) : !1)
    }
    resetState() {
      this.progress = 0
    }
  ...
  function is(a) {
    return a.forEach(e => {
      var t, s;
      for (let i in e.props)((t = e.props[i]) == null ? void 0 : t.type) === "Vec2" ? e.props[i] = new D(e.props[i]._x, e.props[i]._y) : ((s = e.props[i]) == null ? void 0 : s.type) === "Vec3" ? e.props[i] = new b(e.props[i]._x, e.props[i]._y, e.props[i]._z) : typeof e.props[i] == "object" && (e.props[i] = se(e.props[i]))
    }), a
  }
  class mt {
    constructor(e, t) {
      _(this, "local", {
        ...
        createdAt: null
      }), this.locked = e.locked || !1, this.aspectRatio = e.aspectRatio || 1, this.layerName = e.layerName || "", this.userDownsample = e.userDownsample || 1, this.breakpoints = is(e.breakpoints || []), this.local.sceneId = t, this.local.id = Pe(), this.states = {
        appear: e.states && e.states.appear ? e.states.appear.map(s => new es(s)) : [],
        scroll: e.states && e.states.scroll ? e.states.scroll.map(s => new ts(s)) : [],
        hover: e.states && e.states.hover ? e.states.hover.map(s => new ss(s)) : []
      }
    }
    state() {
    ...
    updateStateEffects() {
      ...
      s.isInView && (this.local.createdAt === null && (this.local.createdAt = performance.now()), this.states.appear.forEach(r => {
        ...
        for (let o in this.local.uniformUpdatesPool) {
          ...
          h !== void 0 && ((n = r.uniforms[o]) == null ? void 0 : n.lastValue) !== h && (r.uniforms[o] && Le(h, r.uniforms[o], o), this.updateStateEffectProperty(o, h))
        }
  ...
  let Ke = class extends mt {
    constructor(a, e, t) {
      super(a, e), _(this, "isElement", !0), this.anchorPoint = a.anchorPoint || "topLeft", this.initOptions = t, this.data = a.data || {}, this.opacity = a.opacity ?? 1, this.displace = a.displace || 0, this.effects = a.effects || [], this.trackMouse = a.trackMouse || 0, this.axisTilt = a.axisTilt || 0, this.bgDisplace = a.bgDisplace || 0, this.dispersion = a.dispersion || 0, this.rotation = a.rotation || 0, this.mouseMomentum = a.mouseMomentum || 0, this.maskAlpha = a.maskAlpha || 0, this.maskDepth = a.maskDepth || 0, this.maskBackground = a.maskBackground || {}, this.mask = a.mask || 0, this.blendMode = a.blendMode || "NORMAL", this.compiledFragmentShaders = a.compiledFragmentShaders || [], this.compiledVertexShaders = a.compiledVertexShaders || [], this.width = a.width || 0, this.height = a.height || 0, this.widthMode = a.widthMode || "fixed", this.heightMode = a.heightMode || "fixed", this.left = a.left || 0, this.top = a.top || 0, this.leftMode = a.leftMode || "relative", this.topMode = a.topMode || "relative"
    }
    unpackage() {
      return this.effects = se(this.effects), this.maskBackground = new b(this.maskBackground._x, this.maskBackground._y, this.maskBackground._z), this.unpackageType(), this
    }
    getPixelRatio() {
      const a = this.state();
    ...
    resize() {
      ...
      this.render(), this.layerType === "text" && ct(this, this.state().element)
    }
    dispose() {
  ...
  class rs extends Ke {
    constructor(e, t, s) {
      super(e, t), _(this, "layerType", "shape"), _(this, "isElement", !0), this.initOptions = s;
    ...
    unpackageType() {
      return this.fill = se(this.fill), this.stroke = se(this.stroke), this.render(), this
    }
    render() {
      var e, t;
      ...
      let d = ((e = this.local.stateEffectProps) == null ? void 0 : e.borderRadius) ?? this.borderRadius,
        ...
        c = r - l.x * o,
        p = n - l.y * h;
      if (s.clearRect(0, 0, i.canvasWidth, i.canvasHeight), s.beginPath(), this.fitToCanvas) s.rect(0, 0, i.canvasWidth, i.canvasHeight), s.fillStyle = Ze(s, {
        width: i.canvasWidth,
        ...
        s.fillStyle = Ze(s, this.box(), this.fill, this.gradientAngle, this.gradientType)
      }
  ...
  class ns extends Ke {
    constructor(e, t, s) {
      super(e, t), _(this, "layerType", "image"), _(this, "isElement", !0), this.initOptions = s;
      let i = this.default(e || {});
      for (let r in i) this[r] = i[r];
    ...
    unpackage() {
      return this.effects = se(this.effects), this
    }
    loadImage() {
      const e = new Image;
    ...
    renderImage() {
      ...
      if (this.fitToCanvas) {
        ...
        let P = o / 2,
          ...
          C = r - p + P,
          R = n - m + M;
        s.translate(C, R), s.rotate(c), s.drawImage(this.local.img, -P, -M, o, h), s.restore()
      }
    }
    render() {}
  }
  class os extends Ke {
    constructor(e, t, s, i) {
      super(e, t), _(this, "layerType", "text"), this.initOptions = i;
    ...
    unpackage() {
      return this.fill = se(this.fill), this.effects = se(this.effects), this
    }
    loadFont() {
    ...
    handleFontLoaded() {
      ...
      const e = this.state();
      e.renderFrame && e.renderFrame(), ct(this, this.state().element)
    }
    ...
    render() {
      ...
      let R = l + r / 2,
        O = d + h / 2;
      t.translate(R, O), t.rotate(this.rotation * 360 * Math.PI / 180), t.translate(-R, -O), this.textAlign === "center" && (l += r / 2), this.textAlign === "right" && (l += r), t.fillStyle = Ze(t, this.box(), this.fill, this.gradientAngle, this.gradientType);
      const L = (x, y, S, E, A, V, F) => {
          let w = y.split("").reduce((I, oe, Ue) => I + x.measureText(oe).width + (Ue < y.length - 1 ? A : 0), 0),
            B;
          if (V === "center" ? B = S + (F - w) / 2 - F / 2 : B = S, V === "right")
            for (let I = y.length - 1; I >= 0; I--) {
              const oe = y[I];
              B -= x.measureText(oe).width, x.fillText(oe, B, E), I > 0 && (B -= A)
            } else
              for (let I = 0; I < y.length; I++) x.fillText(y[I], B, E), B += x.measureText(y[I]).width + A
        },
        z = (x, y) => {
          let S = d + p * y + p / 2 + c / 3;
          this.isSafari ? L(t, x, l, S, m, this.textAlign, r) : t.fillText(x, l, S)
        },
        T = this.textContent ? this.textContent.split(`
`) : [""];
      let k = T.length;
      const Q = (x, y, S) => y.split("").reduce((E, A, V) => (E += x.measureText(A).width, V < y.length - 1 && (E += S), E), 0);
      for (let x = 0; x < k; x++) {
        let y = "",
          S = T[x].split(/(\s|\n)/);
        for (let E = 0; E < S.length; E++) {
          const A = S[E],
            V = y + A;
          if ((this.isSafari && m ? Q(t, V, m) : t.measureText(V).width) > r || A === `
`) {
            if (y !== "") T[x] = y.trim(), E !== S.length - 1 ? (T.splice(x + 1, 0, S.slice(E).join("")), k++) : A !== `
` && T.push(A);
            else {
              let F = A,
                w = x;
              for (; F.length > 0;) {
                let B = "";
                for (let I = 0; I < F.length && (t.measureText(B + F[I]).width <= r || I == 0); I++) B += F[I];
                F = F.slice(B.length), T[w] = B.trim(), F.length > 0 && (T.splice(w + 1, 0, F), w++, k++)
              }
              S.slice(E + 1).length > 0 && (T[w] += S.slice(E + 1).join(""))
            }
            break
          } else y = V;
          E === S.length - 1 && (T[x] = y.trim())
        }
      }
      T.forEach((x, y) => {
        z(x, u), y < T.length - 1 && u++
      }), t.translate(-(l + r / 2), -(d + h / 2)), t.restore(), this.height = p * u + p
    }
  }

  function ft() {
    document[Ae] ? (cancelAnimationFrame(be), f.scenes.forEach(a => {
      a.pauseTime = performance.now()
    })) : (Qe(), f.scenes.forEach(a => {
  ...
  function hs() {
    ne = window.innerHeight || document.documentElement.clientHeight, J = window.innerWidth || document.documentElement.clientWidth, f.scenes.filter(a => a.initialized).forEach(a => {
      a.refresh()
    }), Je()
  }

  function _t(a, e, t = 50) {
  ...
  function Je() {
    f.scenes.filter(a => a.getDynamicLayers().length).forEach(a => {
      ...
      a.scrollY = Z, a.lastBbox && (Math.abs(e.top - a.lastBbox.top) === 0 && ye > 0 ? (a.fixedCounter = (a.fixedCounter || 0) + 1, a.fixedCounter > 3 && (a.isFixed = !0)) : a.fixedCounter = 0), a.lastBbox = a.bbox, a.bbox = e
    })
  }
  ...
  function xt(a) {
    ...
    e.length && !t.length && Qe();
    const s = performance.now();
    (!ve || s - ve > 64) && Je(), e.forEach(i => {
      _t(i.element, i.bbox, 100) ? i.isInView || (i.isInView = !0, i.pauseTime = i.pauseTime - performance.now(), i.curtain.resize(), i.lazyLoad && !i.initialized && !i.initializing && i.initializePlanes()) : i.isInView && (i.isInView = !1, i.pauseTime = performance.now())
    })
  }
  ...
  function ls() {
    f.scenes.forEach(a => {
      var e, t, s, i;
      if (a.isInView && (t = (e = a.curtain) == null ? void 0 : e.planes) != null && t.find(r => r.uniforms.mousePos) && !(Fe() && (i = (s = a.interactivity) == null ? void 0 : s.mouse) != null && i.disableMobile)) {
  ...
  class ds {
    constructor(e) {
      _(this, "local", {
        preloadedTextures: {}
      }), _(this, "scrollY", 0), this.id = e.id, this.breakpoints = [{
        name: "Desktop",
        max: 1 / 0,
        min: 992
      }, {
        ...
        max: 575,
        min: 0
      }], this.projectId = e.projectId, this.canvasWidth = e.width || e.element.offsetWidth || J, this.canvasHeight = e.height || e.element.offsetHeight || ne, this.curtain = void 0, this.curtainRafId = void 0, this.dpi = +e.dpi || Math.min(1.5, window.devicePixelRatio), this.element = e.element, this.fps = e.fps || 60, this.name = e.name, this.frameDuration = Math.floor(1e3 / (e.fps || 60)), this.layers = e.layers, this.lazyLoad = e.lazyLoad, this.initialized = !1, this.lasTick = null, this.lastTime = 0, this.rendering = !1, this.bbox = {}, this.isFixed = window.getComputedStyle(this.element).position === "fixed", this.interactivity = {
        mouse: {
          disableMobile: !1
        }
      }, this.mouse = {
      ...
      this.layers.forEach(e => {
        ...
        if (e.isElement) e.local.canvas ? this.textureLoader.loadCanvas(e.local.canvas, {
          ...
          if (e.type === "video" && e.src) {
            const u = e.src.includes(", ") ? pt(e.src) : e.src,
              c = u;
    ...
    destroy() {
      ...
      (e = this.curtain) != null && e.gl && (this.curtain.dispose(), this.curtain = null), this.element && (this.element.removeAttribute("data-us-initialized"), this.element.removeAttribute("data-scene-id"), (t = this.element.querySelector("canvas")) == null || t.remove(), this.element.querySelectorAll("[data-us-text]").forEach(s => {
        s.remove()
      })), this.layers.filter(s => s.dispose).forEach(s => s.dispose()), this.layers = [], f.scenes = f.scenes.filter(s => s.id !== this.id), f.scenes.length || et()
    }
    resize() {
      this.setCanvasScale(), this.layers.filter(e => e.isElement).forEach(e => {
        e.resize()
      }), this.lastBbox = this.bbox, this.bbox = this.element.getBoundingClientRect(), this.currentBreakpoint = this.breakpoints.find(e => J >= e.min && J <= e.max), this.curtain && (this.curtain.resize(), this.curtain.planes.forEach(e => {
      ...
      this.initialized = !1, this.layers.forEach(e => {
        ...
        (t = e.states) == null || t.scroll.forEach(i => i.resetState()), (s = e.states) == null || s.appear.forEach(i => {
          ...
          e.getPlanes().forEach(r => {
            r.uniforms[i] && Le(e.local.bpProps[i], r.uniforms[i], i)
          })
        ...
        this.curtain.planes.forEach(e => {
          e._canDraw = !0
        }), this.scrollY = Z, this.resize(), this.handlePlaneCreation()
      })
    }
    updateMouseTrail() {
      Ye && (this.mouse.trail.unshift([this.mouse.pos.x / (this.lastBbox.width * .5), 1 - this.mouse.pos.y / (this.lastBbox.height * .5)]), this.mouse.trail.length > 4 && this.mouse.trail.pop())
    }
    getDynamicLayers() {
    ...
    renderFrame() {
      Jt(this.curtain) ? (this.layers.forEach(e => {
    ...
    getPlaneParams(e, t) {
      ...
      const o = {
        resolution: {
          name: "uResolution",
          type: "2f",
          value: new D(this.canvasWidth, this.canvasHeight)
        },
        mousePos: {
          name: "uMousePos",
          type: "2f",
      ...
      if (e.states && [...e.states.appear, ...e.states.scroll, ...e.states.hover].forEach(d => {
        ...
        for (let d in e.data.uniforms) {
          ...
          o[d] = e.data.uniforms[d], ((i = u.value) == null ? void 0 : i.type) === "Vec3" ? o[d].value = new b(u.value._x, u.value._y, u.value._z) : ((r = u.value) == null ? void 0 : r.type) === "Vec2" ? o[d].value = new D(u.value._x, u.value._y) : typeof u.value == "object" && (o[d].value = se(u.value))
        }
      return {
        fragmentShader: h,
        vertexShader: l,
    ...
    createPlane(e, t, s) {
      ...
      try {
        ...
        if (h = new dt(this.curtain, this.curtain.container, r), !h || !h.userData || !h.textures) throw new Error("Plane not properly initialized");
    ...
    createPingPongPlane(e, t, s) {
      ...
      if (r) r.setRenderOrder(t);
        ...
        if (r = new $t(this.curtain, this.curtain.container, i), !r) return;
    ...
    handleMediaTextures(e, t, s) {
      ...
      if ([t.texture, (i = t.data) == null ? void 0 : i.texture].filter(r => r == null ? void 0 : r.src).forEach(r => {
          ...
          if ((n = t.compiledFragmentShaders[s.passIndex ?? 0]) != null && n.includes(r.sampler)) {
            ...
            o ? (e.addTexture(o), W(e, r.sampler, o), e.userData.textureLoaded = !0) : this.textureLoader.loadImage(r.src, {
              premultipliedAlpha: !1,
              sampler: r.sampler
            }, h => {
              W(e, r.sampler, h), e.userData.textureLoaded = !0
            })
          }
        }), t.type === "video") {
        const r = t.src.includes(", ") ? pt(t.src) : t.src,
    ...
    handleEffectPlane(e, t, s) {
      ...
      if (!i) return !1;
      n && o != null && o.includes("uPingPongTexture") && W(i, "uPingPongTexture", n.getTexture()), r ? W(i, "uTexture", r.getTexture()) : W(i, "uTexture"), o != null && o.includes("uBgTexture") && i && this.getRenderTargets()[t - (1 + s.passIndex)] && W(i, "uBgTexture", this.getRenderTargets()[t - (1 + s.passIndex)].getTexture()), this.handleMediaTextures(i, e, s)
    }
    handleElementPlane(e, t) {
      ...
      let n = this.getRenderTargets()[t - 1],
        o = r[r.indexOf(e) - 2],
        h;
      if (e.mask && o && (h = o.local.lastTarget), i.length || (s.textures.length = 0), n && i.length && s ? W(s, "uTexture", n.getTexture()) : s && s.addTexture(e.preloadedCanvasTexture), n) {
        if (i.length) {
          let l = i.reduce((d, u) => d + u.getPlanes().length, 0);
          n = this.getRenderTargets()[t - (1 + l)]
        }
        n && (W(s, "uBgTexture", n.getTexture()), h && e.mask && W(s, "uPreviousLayerTexture", h.getTexture()))
      }
    }
    ...
    createEffectPlanes(e, t) {
      ...
      }), Ie(e) && this.createPingPongPlane(e, t, s.passes)) : (this.createEffectPlane(e, t), Ie(e) && this.createPingPongPlane(e, t))
    }
    createTextures() {
    ...
    assignRenderTargetToPlane(e, t, s, i) {
      let r = this.getTextureParams(e, t, s),
        n = this.getRenderTargets()[t] || new Xe(this.curtain, r);
    ...
    setInitialEffectPlaneUniforms(e, t, s, i) {
      ...
      if (!e.userData.initialUniformsSet || !e.userData.isReady) {
        for (let n in e.uniforms)(r = t.states) != null && r.scroll.some(o => o.prop === n) || (t.local.bpProps && n in t.local.bpProps ? Le(t.local.bpProps[n], e.uniforms[n], n) : n in t && Le(t[n], e.uniforms[n], n));
    ...
    setEffectPlaneUniforms(e, t) {
      ...
      if (t.animating && e.uniforms.time && (e.uniforms.time.value += n * 60 / this.fps), Fe() && (r = (i = this.interactivity) == null ? void 0 : i.mouse) != null && r.disableMobile) return !1;
    ...
    handlePlaneCreation() {
      this.initialized = !0, this.initializing = !1, this.rendering || this.renderNFrames(2), this.waitForAssetsAndDisablePlanes(), Qe()
    }
  ...
  function cs() {
    ie(window, "scroll", xt), Fe() ? ie(window, "touchmove", ze) : ie(window, "mousemove", ze), ie(window, "routeChange", gt), ie(document, "mouseleave", yt), ue = Zt(hs, 16), Fe() ? ie(window, "orientationchange", ue) : ie(window, "resize", ue), ie(document, xe, ft), qe = !0
  }

  function et() {
    re(window, "mousemove", ze), re(window, "touchmove", ze), re(window, "scroll", xt), re(window, "routeChange", gt), re(document, "mouseleave", yt), ue && (re(window, "resize", ue), re(window, "orientationchange", ue)), re(document, xe, ft), qe = !1
  }
  ...
  function gs() {
    f.scenes.forEach(a => {
      a.destroy()
    }), f.scenes.length = 0, et()
  }

  function ms(a, e, t, s, i) {
    let r;
    if (t) {
      r = t;
  ...
  function vt(a) {
    ...
    return new Promise((s, i) => {
      ms(e, t, a.filePath, i, a.production).then(r => {
        (!r || !r.history || !r.options) && i(new Error(`Error fetching data for project id '${a.projectId}'`));
        const n = r.options || {},
          o = us(a.element) ? a.element : document.getElementById(a.elementId);
        if (!o) {
        ...
        const u = Qt(r.history, h, ps(o, l, d)),
          c = new ds({
            id: h,
            fps: a.fps || n.fps || 60,
            dpi: d,
        ...
        let p = n[we("ZnJlZVBsYW4=")];
        (p || n[we("aW5jbHVkZUxvZ28=")]) && Kt(h, o), p && console.log(we("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")), f.scenes.push(c), c.layers = u, c.preloadTextures(), c.mouse.recordTrail = !!c.layers.find(m => m.type == "mouse"), c.setInteractiveParams(a, n), c.isInView = c.isFixed || _t(c.element, c.bbox, 50), (!c.lazyLoad || c.isInView) && c.initializePlanes(), console.log(c.getDynamicLayers(), c.layers), qe || cs(), s(c)
      }).catch(r => {
        console.error(r), i(r)
      })
    })
  ...
  function _s() {
    return fs() ? new Promise((a, e) => {
      ...
      t.filter(s => !s.getAttribute("data-us-initialized")).forEach((s, i) => {
        const r = ee(s, "data-us-project"),
          n = ee(s, "data-us-project-src"),
          o = ee(s, "data-us-dpi"),
          h = ee(s, "data-us-scale"),
          l = ee(s, "data-us-lazyload"),
          d = ee(s, "data-us-production"),
          u = ee(s, "data-us-fps"),
          c = ee(s, "data-us-alttext"),
          p = ee(s, "data-us-arialabel"),
          m = ee(s, "data-us-disablemobile");
        s.setAttribute("data-us-initialized", !0), vt({
          projectId: n ? null : r,
          filePath: n,
          element: s,
          dpi: +o,
  ...
  f.addScene = vt, f.destroy = gs, f.init = _s, f.unbindEvents = et, Object.defineProperty(f, Symbol.toStringTag, {
    value: "Module"
  })
});
const Us = {
  ...
  Bs = f => {
    switch (f) {
      case Te.BP:
        return {
          text: X("tge.criteria_bp.text", {
            amount: "100k"
          })
        };
      case Te.MP:
        return {
          text: X("tge.criteria_mp.text", {
            amount: "750"
          })
        };
      case Te.FRIENDS:
        return {
          text: X("tge.criteria_friends.text", {
            count: 2
          })
        };
      case Te.NON_SYBIL:
        return {
          text: X("tge.criteria_non_sybil.text")
        };
      default:
  ...
  Hs = Ve({
    ...
    setup(f) {
      const G = Se(() => Object.values(Te).map(U => {
        const _ = Bs(U),
          j = (() => {
            var v;
            return f.type === "info" ? "info" : f.type === "loading" ? "loading" : f.type === "success" || !!((v = f.values) != null && v[U]) ? "success" : "error"
          })();
        return {
          ..._,
          criteria: U,
      ...
      return (U, _) => {
        const j = wt,
          g = Ps;
        return N(), te("div", Ns, [(N(!0), te(vs, null, bs(H(G), v => (N(), te("div", {
          key: v.criteria,
          class: bt(["item", `is-state-${v.state}`])
        }, [v.state === "info" ? (N(), fe(j, {
          key: 0,
          name: "arrow-right",
          class: "icon"
        })) : v.state === "success" ? (N(), fe(j, {
          key: 1,
          name: "check-big-2",
          class: "icon"
        })) : v.state === "error" ? (N(), fe(j, {
          key: 2,
          name: "close-md",
          class: "icon"
        })) : v.state === "loading" ? (N(), fe(g, {
          key: 3,
          class: "spinner",
          size: 24,
          type: H(ws).LIGHT
        }, null, 8, ["type"])) : tt("", !0), Re("div", {
          class: "text",
          innerHTML: v.text
        }, null, 8, Ws)], 2))), 128))])
      }
  ...
  Qs = Ve({
    __name: "Eligibility",
    setup(f) {
      const U = Pt().mustEligibilityState,
        _ = Ts({
          status: "idle"
        }),
        j = Se(() => {
          switch (_.value.status) {
            case "idle":
              return X("tge.eligibility.state_idle.title");
            case "checking":
              return X("tge.eligibility.state_checking.title");
            case "eligible":
              return X("tge.eligibility.state_eligible.title");
            case "not-eligible":
              return X("tge.eligibility.state_not_eligible.title");
            default:
        ...
        g = Se(() => {
          switch (_.value.status) {
            ...
            case "checking":
              return;
            case "eligible":
              return X("tge.eligibility.state_eligible.subtitle");
            case "not-eligible":
              return X("tge.eligibility.state_not_eligible.subtitle");
            default:
              throw he("Unknown status")
          }
        }),
        v = Se(() => {
          switch (_.value.status) {
            case "idle":
            case "checking":
              return X("tge.eligibility.check_btn");
            case "eligible":
              return X("tge.eligibility.news_btn");
            case "not-eligible":
              return X("tge.eligibility.do_more");
            default:
              throw he("Unknown status")
          }
        }),
        _e = Se(() => {
          switch (_.value.status) {
            ...
            case "not-eligible":
              return {
                type: "values", values: _.value.eligibility
              };
            default:
              throw he("Unknown status")
          }
        ...
        Y = async () => {
          if (_.value.status === "idle") {
            if (_.value = {
                status: "checking"
              }, await As(500), U.value.status === "restricted") throw he("invalid state");
            U.value.value.eligible ? _.value = {
              status: "eligible"
            } : _.value = {
              status: "not-eligible",
              eligibility: U.value.value
            }
          }
        }, Be = () => {
          Fs().$webApp.openTelegramLink("https://t.me/blumcrypto")
        }, Ne = () => {
          switch (_.value.status) {
            case "idle":
              return Y();
      ...
      return (ae, Ee) => {
        const We = Vs,
          ...
          le = Ls;
        return N(), te("div", {
          class: bt(["tge-eligible", `is-state-${H(_).status}`])
        }, [me(We, {
          class: "animation"
        }), Re("div", js, [Re("div", Xs, [H(_).status === "eligible" ? (N(), te("div", Ys, [me(Me, {
          name: "check-big-2",
          class: "icon"
        })])) : H(_).status === "not-eligible" ? (N(), te("div", qs, [me(Me, {
          name: "close-sm",
          class: "icon"
        })])) : tt("", !0), Re("div", {
          class: "title",
          innerHTML: H(j)
        }, null, 8, $s)]), H(g) ? (N(), te("div", Zs, Ss(H(g)), 1)) : tt("", !0)]), me(He, Rs(Es(H(_e))), null, 16), me(le, {
          class: "wrapper"
        }, {
          default: Ms(() => [Ee[0] || (Ee[0] = Re("div", {
            class: "shadow"
          }, null, -1)), me(Ge, {
            size: H(Cs).LARGE,
            label: H(v),
            loading: H(_).status === "checking",
            fill: "",
            onClick: Ne
  ...
  ei = Ve({
    ...
    setup(f) {
      const G = Pt();
      return zs("tge"), Is().initHandler(() => {
        st().push("/")
      }, "tge"), Ds(() => {
        var U;
        return (U = G.eligibilityState.value) == null ? void 0 : U.status
      }, U => {
        U === "restricted" && st().replace({
          name: "index"
        })
      }), (U, _) => {
        const j = Os,
          g = Ks;
        return N(), te("div", Js, [!H(G).eligibilityState.value || H(G).eligibilityState.value.status !== "available" ? (N(), fe(j, {
          key: 0
        })) : (N(), fe(g, {
          key: 1
        }))])
