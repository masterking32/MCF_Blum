...
`).reduce((m, c) => {
      ...
      return (b, m) => {
        ...
        return d(), A(p, {
          ...
          title: N(() => [n(l).state === "general" ? (d(), C("span", Wt, [oe(h("img", {
            src: e.iconUrl,
            alt: "Task icon"
          }, null, 8, Yt), [
            [T]
          ]), h("span", null, U(e.productName), 1)])) : I("", !0), n(l).state === "details" ? (d(), C("span", Qt, "Disclaimer")) : I("", !0)]),
          default: N(() => [n(l).state === "general" ? (d(), C("div", zt, [m[8] || (m[8] = h("div", {
            class: "text"
    ...
    setup(e, {
      ...
      return (u, v) => {
        const b = J,
          ...
          T = ie("img-error");
        return d(), A(p, null, {
          default: N(() => [h("div", ea, [h("div", ta, [oe(h("img", {
      ...
      return xe().onOpenTaskSheet(o.task, () => {
        ...
        return d(), C(F, null, [R(S, {
          ...
          default: N(() => [h("div", {
            ...
            default: N(() => [(d(!0), C(F, null, W(e.task.subTasks, (f, g) => (d(), A(T, {
              key: f.id,
