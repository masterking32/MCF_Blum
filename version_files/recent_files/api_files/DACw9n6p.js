    ...
    setup(t) {
      ...
      return (l, d) => {
        ...
        return a(), r("div", Ce, [p(y, {
          icon: o(e).icon
        }, null, 8, ["icon"]), _("div", Oe, [_("div", De, v(o(e).title), 1), o(i) ? (a(), r("div", We, v(o(i)), 1)) : g("", !0)]), o(s) ? (a(), r(I, {
          key: 0
    ...
    setup(t) {
      ...
      return (i, s) => {
        ...
        return a(), r("div", qe, [_("div", {
          ...
          src: t.image,
          alt: "Image"
        }, null, 8, Qe)) : g("", !0)], !0)])) : g("", !0), _("div", ze, v(t.text), 1), p(l, {
          name: "chevron-right",
          class: "icon"
        })], 2), p(d, {
          modelValue: o(n),
    ...
    setup(t) {
      ...
      return (i, s) => {
        ...
        return a(), r("div", Wn, [_("div", Ln, [_("div", xn, v(("t" in i ? i.t : o(c))("wallet.history.title")), 1), t.address ? (a(), r("div", Rn, [s[1] || (s[1] = _("img", {
          src: K,
          alt: "Ton logo"
        }, null, -1)), _("div", Bn, v(t.address.short), 1)])) : g("", !0)]), p(y, {
          onEnd: s[0] || (s[0] = b => o(e).load())
        }, {
          default: T(() => [o(e).isEmpty.value ? (a(), u(l, {
            key: 0,
