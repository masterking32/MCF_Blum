...
const X = t => {
    ...
    setup(t) {
      ...
      return i(() => n.value = !1), (s, l) => {
        ...
        return a(), u(g, {
          ...
          default: T(() => [_("div", jt, [_("div", Qt, [_("div", zt, v(t.address.short), 1), _("div", Gt, [p(d, {
  ...
  le = f({
    ...
    setup(t) {
      return (n, e) => {
        const i = E;
        return a(), r("div", oe, [(a(!0), r(I, null, C(t.items, s => (a(), r("div", {
          key: s.text,
          class: A(["item", {
            "is-active": s.active
          }])
...
const Ne = h(ge, [
    ...
    setup(t) {
      ...
      return (i, s) => {
        ...
        return o(e) ? (a(), r("div", {
          ...
          name: o(e).icon,
          class: "icon"
        }, null, 8, ["name"]), _("div", Se, v(o(e).label), 1)], 2)) : b("", !0)
      }
    }
  }),
  Ke = h(Ue, [
  ...
  xe = f({
    ...
    setup(t) {
      ...
      return (l, d) => {
        const y = Ae,
          g = Ke;
        return a(), r("div", Ce, [p(y, {
          icon: o(e).icon
        }, null, 8, ["icon"]), _("div", Oe, [_("div", De, v(o(e).title), 1), o(i) ? (a(), r("div", We, v(o(i)), 1)) : b("", !0)]), o(s) ? (a(), r(I, {
          key: 0
        }, [o(s).type === "text" ? (a(), r("div", Le, v(o(s).text), 1)) : o(s).type === "status" ? (a(), u(g, {
          key: 1,
          status: o(s).status,
          class: "status"
        }, null, 8, ["status"])) : b("", !0)], 64)) : b("", !0)])
      }
    }
  }),
  Re = h(xe, [
  ...
  Me = f({
    ...
    setup(t) {
      return (n, e) => {
        const i = Re;
        return a(), r("div", Be, [(a(!0), r(I, null, C(t.history, (s, l) => (a(), r(I, {
          key: l
        }, [l === 0 || t.history[l - 1].date.stamp !== t.history[l].date.stamp ? (a(), r("div", He, v(s.date.formatted), 1)) : b("", !0), p(i, {
          "history-item": s
  ...
  Ve = f({
    ...
    setup(t) {
      const e = G(async i => {
        const s = await Q.getPointsHistory(i);
    ...
    setup(t) {
      ...
      return (i, s) => {
        ...
        return a(), r("div", qe, [_("div", {
          ...
          src: t.image,
          alt: "Image"
        }, null, 8, Qe)) : b("", !0)], !0)])) : b("", !0), _("div", ze, v(t.text), 1), p(l, {
          name: "chevron-right",
          class: "icon"
        })], 2), p(d, {
          modelValue: o(n),
...
const Je = h(Ze, [
  ...
  vn = f({
    ...
    setup(t, {
      ...
      return (s, l) => (a(), r("div", un, [(a(!0), r(I, null, C(o(i), (d, y) => (a(), r("button", {
        key: y,
        ...
        src: ("imgResolver" in s ? s.imgResolver : o(z))(d.icon, "svg"),
        alt: `${d.label} icon`
      ...
      return (n, e) => {
        ...
        return a(), u(s, {
          ...
          default: T(({
            ...
            src: K,
            alt: "Ton logo"
          }, null, -1)), _("div", bn, v(("t" in n ? n.t : o(c))("wallet.only_ton_notification.title")), 1), _("div", gn, v(("t" in n ? n.t : o(c))("wallet.only_ton_notification.text")), 1), p(i, {
  ...
  Tn = f({
    ...
    setup(t) {
      ...
      return (i, s) => {
        const l = Ct;
        return a(), r("div", Nn, [(a(!0), r(I, null, C(o(e), d => (a(), u(l, Nt({
          key: d.id,
          ref_for: !0
        }, d), null, 16))), 128))])
      }
    ...
    setup(t) {
      return (n, e) => {
        ...
        return a(), r("div", En, [p(i, {
          address: n.address,
          "fiat-value": (g = n.balance) == null ? void 0 : g.totalFiatValue,
...
function On(t, n) {
  ...
  return a(), r("div", Kn, [p(e, {
    name: "note-search",
    class: "icon"
  }), _("div", Cn, v(("t" in t ? t.t : o(c))("wallet.history.no_records")), 1)])
}
const Dn = h(Un, [
    ["render", On],
  ...
  Hn = f({
    ...
    setup(t) {
      const e = G(async i => {
        const s = await Q.getTokensHistory(i);
      ...
      return (i, s) => {
        const l = Dn,
          d = at,
          y = Z;
        return a(), r("div", Wn, [_("div", Ln, [_("div", xn, v(("t" in i ? i.t : o(c))("wallet.history.title")), 1), t.address ? (a(), r("div", Rn, [s[1] || (s[1] = _("img", {
          src: K,
          alt: "Ton logo"
        }, null, -1)), _("div", Bn, v(t.address.short), 1)])) : b("", !0)]), p(y, {
          onEnd: s[0] || (s[0] = g => o(e).load())
        }, {
          default: T(() => [o(e).isEmpty.value ? (a(), u(l, {
            key: 0,
...
const Vn = f({
    ...
    setup(t) {
      ...
      return Y(l, () => At().meta.key = l.value), (d, y) => {
        ...
        }), o(e).points.value ? (a(), u(R, {
          key: 0,
          points: o(e).points.value,
          notification: o(e).walletNotification.value
        }, null, 8, ["points", "notification"])) : b("", !0)], 64)) : o(e).wallet.value.status === "connected" ? (a(), u(_t, {
          key: 1,
        ...
        }, null, 8, ["address", "balance", "notification"])) : b("", !0)], 64)) : o(s) === "points" ? (a(), r(I, {
          key: 1
