    ...
    setup(t) {
      ...
      return i(() => n.value = !1), (s, l) => {
        ...
        return a(), u(b, {
          ...
          default: T(() => [d("div", jt, [d("div", Qt, [d("div", zt, v(t.address.short), 1), d("div", Gt, [p(_, {
  ...
  xe = f({
    ...
    setup(t) {
      ...
      return (l, _) => {
        const m = Se,
          b = Ke;
        return a(), r("div", Ce, [p(m, {
          icon: o(e).icon
        }, null, 8, ["icon"]), d("div", Oe, [d("div", We, v(o(e).title), 1), o(i) ? (a(), r("div", De, v(o(i)), 1)) : g("", !0)]), o(s) ? (a(), r(I, {
          key: 0
    ...
    setup(t) {
      ...
      return (i, s) => {
        ...
        return a(), r("div", qe, [d("div", {
          ...
          src: t.image,
          alt: "Image"
        }, null, 8, Qe)) : g("", !0)], !0)])) : g("", !0), d("div", ze, v(t.text), 1), p(l, {
          name: "chevron-right",
          class: "icon"
        })], 2), p(_, {
          modelValue: o(n),
...
const Je = h(Ze, [
  ...
  vn = f({
    ...
    setup(t, {
      ...
      return (s, l) => (a(), r("div", un, [(a(!0), r(I, null, C(o(i), (_, m) => (a(), r("button", {
        key: m,
        ...
        src: ("imgResolver" in s ? s.imgResolver : o(Q))(_.icon, "svg"),
        alt: `${_.label} icon`
    ...
    setup(t) {
      return (n, e) => {
        ...
        return a(), u(s, {
          ...
          default: T(({
            close: l
          }) => [d("div", wn, [e[0] || (e[0] = d("img", {
            src: K,
            alt: "Ton logo"
          }, null, -1)), d("div", gn, v(("t" in n ? n.t : o(c))("wallet.only_ton_notification.title")), 1), d("div", bn, v(("t" in n ? n.t : o(c))("wallet.only_ton_notification.text")), 1), p(i, {
  ...
  Tn = f({
    ...
    setup(t) {
      ...
      return (i, s) => {
        const l = Ct;
        return a(), r("div", Nn, [(a(!0), r(I, null, C(o(e), _ => (a(), u(l, Nt({
          key: _.id,
          ref_for: !0
        }, _), null, 16))), 128))])
      }
...
function On(t, n) {
  ...
  return a(), r("div", Kn, [p(e, {
    name: "note-search",
    class: "icon"
  }), d("div", Cn, v(("t" in t ? t.t : o(c))("wallet.history.no_records")), 1)])
}
const Wn = h(Un, [
    ["render", On],
    ...
    setup(t) {
      ...
      return (i, s) => {
        const l = Wn,
          _ = at,
          m = Z;
        return a(), r("div", Dn, [d("div", Ln, [d("div", xn, v(("t" in i ? i.t : o(c))("wallet.history.title")), 1), t.address ? (a(), r("div", Rn, [s[1] || (s[1] = d("img", {
          src: K,
          alt: "Ton logo"
        }, null, -1)), d("div", Bn, v(t.address.short), 1)])) : g("", !0)]), p(m, {
          onEnd: s[0] || (s[0] = b => o(e).load())
        }, {
          default: T(() => [o(e).isEmpty.value ? (a(), u(l, {
            key: 0,
