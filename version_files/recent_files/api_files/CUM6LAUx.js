  ...
  La = (r, s, e, t) => {
    if (s && typeof s == "object" || typeof s == "function")
      for (let n of eo(s)) !Ur.call(r, n) && n !== e && Mr(r, n, {
        get: () => s[n],
        enumerable: !(t = Ca(s, n)) || t.enumerable
      });
    return r
  },
  Fa = (r, s, e) => (e = r != null ? Ia(Na(r)) : {}, La(Mr(e, "default", {
    value: r,
    enumerable: !0
  }), r)),
...
var Ga = /[\p{Lu}]/u,
  ...
  Ja = (r, s, e, t) => {
    ...
    for (let l = 0; l < r.length; l++) {
      const d = r[l];
      c = l > 2 ? r[l - 3] === "-" : !0, n && Ga.test(d) ? (r = r.slice(0, l) + "-" + r.slice(l), n = !1, i = o, o = !0, l++) : o && i && Ma.test(d) && (!c || t) ? (r = r.slice(0, l - 1) + "-" + r.slice(l - 1), i = o, o = !1, n = !0) : (n = s(d) === d && e(d) !== d, i = o, o = e(d) === d && s(d) !== d)
    }
    return r
  },
  Wa = (r, s) => (qs.lastIndex = 0, r.replaceAll(qs, e => s(e))),
  Va = (r, s) => (js.lastIndex = 0, Ps.lastIndex = 0, r.replaceAll(Ps, (e, t, n) => ["_", "-"].includes(r.charAt(n + e.length)) ? e : s(e)).replaceAll(js, (e, t) => s(t)));
...
function za(r, s) {
  ...
  return r.length === 1 ? Jr.test(r) ? "" : s.pascalCase ? t(r) : e(r) : (r !== e(r) && (r = Ja(r, e, t, s.preserveConsecutiveUppercase)), r = r.replace(Ua, ""), r = s.preserveConsecutiveUppercase ? Wa(r, e) : e(r), s.pascalCase && (r = t(r.charAt(0)) + r.slice(1)), Va(r, t))
}
var Ka = (r, s) => r.some(e => typeof e == "string" ? e === s : (e.lastIndex = 0, e.test(s))),
  Mt = new Zn({
    maxSize: 1e5
  }),
...
var lt = r => r.toISOString().split(".")[0],
  ...
  xs = Fa(Qa()),
  Xa = (r, s) => (r = r.replace(new RegExp("((?<![\\p{Uppercase_Letter}\\d])[\\p{Uppercase_Letter}\\d](?![\\p{Uppercase_Letter}\\d]))", "gu"), e => e.toLowerCase()), r.replace(new RegExp("(\\p{Uppercase_Letter}+)(\\p{Uppercase_Letter}\\p{Lowercase_Letter}+)", "gu"), (e, t, n) => t + s + n.toLowerCase()));
...
function Za(r, {
  ...
  return e ? Xa(n, s) : n.replace(new RegExp("(\\p{Uppercase_Letter})(\\p{Uppercase_Letter}\\p{Lowercase_Letter}+)", "gu"), t).toLowerCase()
}
var ei = (r, s) => r.some(e => typeof e == "string" ? e === s : (e.lastIndex = 0, e.test(s))),
  Ut = new Zn({
    maxSize: 1e5
  }),
  ...
  Os = (r, s = {}) => {
    ...
    const {
      ...
      if (n && Is(l) && (l = (0, xs.default)(l, o())), !(t && ei(t, c))) {
        const d = `${e}${c}`;
...
const oi = new Set(Object.freeze(["PATCH", "POST", "PUT", "DELETE"]));

function Rs(r = "GET") {
  return oi.has(r.toUpperCase())
}
...
const ii = new Set(["image/svg", "application/xml", "application/xhtml", "application/html"]),
  ci = /^application\/(?:[\w!#$%&*.^`~-]*\+)?json(;.+)?$/i;

function di(r = "") {
  if (!r) return "json";
  const s = r.split(";").shift() || "";
  return ci.test(s) ? "json" : ii.has(s) || s.startsWith("text/") ? "text" : "blob"
}

function li(r, s, e, t) {
  const n = pi((s == null ? void 0 : s.headers) ?? (r == null ? void 0 : r.headers), e == null ? void 0 : e.headers, t);
  let o;
...
const ui = new Set([408, 409, 425, 429, 500, 502, 503, 504]),
  mi = new Set([101, 204, 205, 304]);
...
function oo(r = {}) {
  ...
  async function n(c) {
    ...
    if (c.options.retry !== !1 && !l) {
      ...
      if (a > 0 && (Array.isArray(c.options.retryStatusCodes) ? c.options.retryStatusCodes.includes(y) : ui.has(y))) {
  ...
  const o = async function(l, d = {}) {
    const a = {
      request: l,
      options: li(l, d, r.defaults, e),
      response: void 0,
      error: void 0
    };
    a.options.method && (a.options.method = a.options.method.toUpperCase()), a.options.onRequest && await pt(a, a.options.onRequest), typeof a.request == "string" && (a.options.baseURL && (a.request = wa(a.request, a.options.baseURL)), a.options.query && (a.request = Ta(a.request, a.options.query), delete a.options.query), "query" in a.options && delete a.options.query, "params" in a.options && delete a.options.params), a.options.body && Rs(a.options.method) && (ai(a.options.body) ? (a.options.body = typeof a.options.body == "string" ? a.options.body : JSON.stringify(a.options.body), a.options.headers = new e(a.options.headers || {}), a.options.headers.has("content-type") || a.options.headers.set("content-type", "application/json"), a.options.headers.has("accept") || a.options.headers.set("accept", "application/json")) : ("pipeTo" in a.options.body && typeof a.options.body.pipeTo == "function" || typeof a.options.body.pipe == "function") && ("duplex" in a.options || (a.options.duplex = "half")));
    let y;
    ...
    if ((a.response.body || a.response._bodyInit) && !mi.has(a.response.status) && a.options.method !== "HEAD") {
      const f = (a.options.parseResponse ? "json" : a.options.responseType) || di(a.response.headers.get("content-type") || "");
      switch (f) {
        case "json": {
...
const qt = function() {
  ...
  fi = qt.fetch ? (...r) => qt.fetch(...r) : () => Promise.reject(new Error("[ofetch] global.fetch is not supported!")),
  yi = qt.Headers,
  hi = qt.AbortController,
  gi = oo({
    fetch: fi,
    Headers: yi,
    AbortController: hi
...
`));
  ...
  gt, bi = (gt = class extends It {}, u(gt, "CPI", lo), u(gt, "Stable", po), gt),
  _t, Ai = (_t = class extends rt {}, u(_t, "CPI", Vr), u(_t, "Stable", Kr), _t),
  wi = {
  ...
  re, Hr = (re = class extends R {
    ...
    async createDeployWalletBody(e) {
      return m.beginCell().storeUint(wi.DEPLOY_WALLET, 32).storeUint(e.queryId ?? 0, 64).storeAddress(w(e.ownerAddress)).endCell()
    }
  ...
  vt, ji = (vt = class extends $i {}, u(vt, "CPI", Si), u(vt, "Stable", qi), vt),
  bt, Pi = (bt = class extends uo {}, u(bt, "CPI", mo), u(bt, "Stable", fo), bt),
  ki = {
    Router: ji,
    Pool: Pi,
    LpAccount: Ot,
  ...
  Bs = go.apply,
  Ls = go.call,
  Qr = typeof Reflect == "object" && Reflect.apply || (Ri ? Ls.bind(Bs) : function() {
    return Ls.apply(Bs, arguments)
  }),
  _o = Rt,
  vo = Function.prototype,
  kr = vo.call,
  Ni = _o && vo.bind.bind(kr, kr),
  V = _o ? Ni : function(r) {
    return function() {
...
var Xr = function(r, s) {
  ...
  Yi = TypeError,
  Nt = function(r) {
    if (Hi(r)) throw new Yi("Can't call method on " + r);
    return r
  },
  Qi = Ki,
  Xi = Nt,
  ...
  Zi = Q,
  ie = function(r) {
    return typeof r == "object" ? r !== null : Zi(r)
  },
  nt = {},
  Vt = nt,
  zt = ee,
...
var oc = jt,
  ...
  ic = ee,
  cc = ic.String,
  Bt = !!Object.getOwnPropertySymbols && !ac(function() {
    var r = Symbol("symbol detection");
    return !cc(r) || !(Object(r) instanceof Symbol) || !Symbol.sham && Vs && Vs < 41
  }),
  dc = Bt,
  Po = dc && !Symbol.sham && typeof Symbol.iterator == "symbol",
  lc = ot,
  pc = Q,
  uc = rc,
  mc = Po,
  ...
  Zr = mc ? function(r) {
    ...
    var s = lc("Symbol");
    return pc(s) && uc(s.prototype, fc(r))
  },
  yc = String,
  hc = function(r) {
    try {
  ...
  ko = function(r) {
    if (gc(r)) return r;
    throw new vc(_c(r) + " is not a function")
  },
  bc = ko,
  Ac = qo,
  wc = function(r, s) {
    var e = r[s];
    return Ac(e) ? void 0 : bc(e)
  },
  Ht = Le,
  Yt = Q,
  Qt = ie,
  ...
  $c = function(r, s) {
    ...
    throw new Tc("Can't convert object to primitive value")
  },
  Eo = {
    exports: {}
  },
...
var xo = Eo.exports,
  ...
  Bc = Cc(1 .toString),
  Lt = function(r) {
    return "Symbol(" + (r === void 0 ? "" : r) + ")_" + Bc(++Rc + Nc, 36)
  },
  Lc = ee,
  Fc = Io,
  Qs = ke,
  ...
  Ke = Lc.Symbol,
  Xt = Fc("wks"),
  Uc = Mc ? Ke.for || Ke : Ke && Ke.withoutSetter || Dc,
  ts = function(r) {
    return Qs(Xt, r) || (Xt[r] = Gc && Qs(Ke, r) ? Ke[r] : Uc("Symbol." + r)), Xt[r]
  },
  Jc = Le,
  Xs = ie,
  Zs = Zr,
  ...
  Oo = function(r, s) {
    ...
    var e = Wc(r, Hc),
      t;
    if (e) {
      if (s === void 0 && (s = "default"), t = Jc(e, r, s), !Xs(t) || Zs(t)) return t;
      throw new Kc("Can't convert object to primitive value")
    }
    return s === void 0 && (s = "number"), Vc(r, s)
  },
  Yc = Oo,
  Qc = Zr,
  Co = function(r) {
  ...
  en = ie,
  Er = Xc.document,
  Zc = en(Er) && en(Er.createElement),
  Ro = function(r) {
    return Zc ? Er.createElement(r) : {}
  },
  ed = me,
  td = J,
  rd = Ro,
...
wo.f = sd ? tn : function(s, e) {
  if (s = id(s), e = cd(e), ld) try {
    return tn(s, e)
  } catch {}
  if (dd(s, e)) return ad(!nd(od.f, s, e), s[e])
};
var pd = J,
  ud = Q,
  md = /#|\.prototype\./,
  at = function(r, s) {
    var e = yd[fd(r)];
    return e === gd ? !0 : e === hd ? !1 : ud(s) ? pd(s) : !!s
  },
  fd = at.normalize = function(r) {
    return String(r).replace(md, ".").toLowerCase()
  },
  yd = at.data = {},
  hd = at.NATIVE = "N",
  gd = at.POLYFILL = "P",
  ...
  Ad = rn(rn.bind),
  wd = function(r, s) {
    return vd(r), s === void 0 ? r : bd ? Ad(r, s) : function() {
  ...
  rs = function(r) {
    if (Sd(r)) return r;
    throw new jd(qd(r) + " is not an object")
  },
  Pd = me,
  kd = No,
  Ed = Bo,
...
it.f = Pd ? Ed ? function(s, e, t) {
  ...
  if (mt(s), e = sn(e), mt(t), kd) try {
    return Zt(s, e, t)
  } catch {}
  if ("get" in t || "set" in t) throw new xd("Accessors not supported");
  return "value" in t && (s[e] = t.value), s
};
var Od = me,
  Cd = it,
  Rd = Xr,
  Lo = Od ? function(r, s, e) {
    return Cd.f(r, s, Rd(1, e))
  } : function(r, s, e) {
    return r[s] = e, r
  },
  Ye = ee,
  ...
  Ee = function(r, s) {
    var e = r.target,
      ...
      l = c.prototype,
      d, a, y, g, f, v, h, _, S;
    for (g in s) d = Dd(t ? g : e + (n ? "." : "#") + g, r.forced), a = !d && i && nn(i, g), v = c[g], a && (r.dontCallGetSet ? (S = Fd(i, g), h = S && S.value) : h = i[g]), f = a && h ? h : s[g], !(!d && !o && typeof v == typeof f) && (r.bind && a ? _ = Gd(f, Ye) : r.wrap && a ? _ = Md(f) : o && Ld(f) ? _ = Bd(f) : _ = f, (r.sham || f && f.sham || v && v.sham) && Me(_, "sham", !0), Me(c, g, _), o && (y = e + "Prototype", nn(Ge, y) || Me(Ge, y, {}), Me(Ge[y], g, f), r.real && l && (d || !l[g]) && Me(l, g, f)))
  },
  Ud = Math.ceil,
  Jd = Math.floor,
  Wd = Math.trunc || function(s) {
    var e = +s;
    return (e > 0 ? Jd : Ud)(e)
  },
  Vd = Wd,
  ...
  Yd = function(r, s) {
    var e = zd(r);
    return e < 0 ? Kd(e + s, 0) : Hd(e, s)
  },
  Qd = ss,
  Xd = Math.min,
  Fo = function(r) {
    var s = Qd(r);
    return s > 0 ? Xd(s, 9007199254740991) : 0
  },
  Zd = Fo,
  Do = function(r) {
    return Zd(r.length)
  ...
  Go = function(r, s) {
    var e = ol(r),
      ...
      n = [],
      o;
    for (o in e) !sr(il, o) && sr(e, o) && an(n, o);
    for (; s.length > t;) sr(e, o = s[t++]) && (~al(n, o) || an(n, o));
    return n
  },
...
var gl = String(Wo) === "[object z]",
  ...
  Sl = _l ? At : function(r) {
    var s, e, t;
    return r === void 0 ? "Undefined" : r === null ? "Null" : typeof(e = $l(s = wl(r), Al)) == "string" ? e : Tl ? At(s) : (t = At(s)) === "Object" && vl(s.callee) ? "Arguments" : t
  },
  ql = Sl,
  jl = String,
  ct = function(r) {
    if (ql(r) === "Symbol") throw new TypeError("Cannot convert a Symbol value to a string");
    return jl(r)
  },
  Pl = me,
  kl = it,
...
`,
  ...
  zo = function(r, s) {
    for (var e = !0, t = ""; s < r.length;) {
      ...
      if (n === "\\") {
        var o = cn(r, s, s + 2);
        if (xl(ln, o)) t += ln[o], s += 2;
        else if (o === "\\u") {
          s += 2;
          var i = cn(r, s, s + 4);
          if (!dn(Rl, i)) throw new ft("Bad Unicode escape at: " + s);
          t += Ol(Il(i, 16)), s += 4
        ...
        if (dn(Nl, n)) throw new ft("Bad control character in string literal at: " + s);
        t += n, s++
      }
    }
  ...
  Ir = function(r, s, e, t) {
    ...
    if (Gl(n)) {
      ...
      if (g)
        ...
        for (l = Kl(n), d = pn(l), a = 0; a < d; a++) y = l[a], yn(n, y, Ir(n, y, e, Ul(f, y) ? f[y] : void 0))
    }
    return Dl(e, r, s, n, i)
  },
  yn = function(r, s, e) {
...
Or.prototype = {
  ...
  node: function(r, s, e, t, n) {
    return new Zl(s, t, r ? null : nr(this.source, e, t), n)
  },
  object: function() {
  ...
  number: function() {
    ...
    else if (or(Yl, M(r, e))) e = this.skip(ar, e + 1);
    ...
    return this.node(ir, zl(nr(r, s, e)), s, e)
  },
  keyword: function(r) {
    var s = "" + r,
      e = this.index,
...
var rp = nt,
  ...
  cp = st,
  dp = Mo;
Yo.f = np && !op ? Object.defineProperties : function(s, e) {
  ip(s);
  for (var t = cp(e), n = dp(e), o = n.length, i = 0, c; o > i;) ap.f(s, c = n[i++], t[c]);
  return s
};
var lp = ot,
  pp = lp("document", "documentElement"),
  up = Io,
  mp = Lt,
  hn = up("keys"),
  Qo = function(r) {
    return hn[r] || (hn[r] = mp(r))
  },
  fp = rs,
  yp = Yo,
  gn = ns,
  ...
  bp = function() {
    var r = _p("iframe"),
      s = "java" + Rr + ":",
      e;
    return r.style.display = "none", gp.appendChild(r), r.src = String(s), e = r.contentWindow.document, e.open(), e.write(Zo("document.F=Object")), e.close(), e.F
  },
  yt, wt = function() {
    try {
      yt = new ActiveXObject("htmlfile")
    } catch {}
    wt = typeof document < "u" ? document.domain && yt ? bn(yt) : bp() : bn(yt);
    for (var r = gn.length; r--;) delete wt[Cr][gn[r]];
    return wt()
  };
hp[Xo] = !0;
var Ap = Object.create || function(s, e) {
    var t;
    return s !== null ? (cr[Cr] = fp(s), t = new cr, cr[Cr] = null, t[Xo] = s) : t = wt(), e === void 0 ? t : yp.f(t, e)
  },
  wp = Ee,
  Tp = me,
  $p = Ap;
...
ta.f = function(s) {
  return na && Ep(s) === "Window" ? Op(s) : sa(xp(s))
};
var Cp = J,
  Rp = Cp(function() {
  ...
  Dp = Fp || An ? function(s) {
    return !Bp(s) || An && Lp(s) === "ArrayBuffer" ? !1 : Tt ? Tt(s) : !0
  } : Tt,
  Gp = Ee,
  Mp = V,
  Up = Ft,
  ...
  Yp = function(r, s) {
    if (!Jp(r)) return typeof r == "symbol" ? r : (typeof r == "string" ? "S" : "P") + r;
    if (!ls(r, ue)) {
      if (!ps(r)) return "F";
      if (!s) return "E";
      us(r)
  ...
  Xp = function(r) {
    return Kp && oa && ps(r) && !ls(r, ue) && us(r), r
  },
  Zp = function() {
    eu.enable = function() {}, oa = !0;
    var r = wn.f,
      s = Mp([].splice),
      e = {};
...
var cu = J,
  ...
  pu = Q,
  Tn = lu.WeakMap,
  uu = pu(Tn) && /native code/.test(String(Tn)),
  mu = uu,
  aa = ee,
  fu = ie,
  yu = Lo,
  ...
  Br = aa.TypeError,
  _u = aa.WeakMap,
  Pt, tt, kt, vu = function(r) {
    return kt(r) ? tt(r) : Pt(r, {})
  },
  bu = function(r) {
    return function(s) {
      var e;
      if (!fu(s) || (e = tt(s)).type !== r) throw new Br("Incompatible receiver, " + r + " required");
      return e
    }
  };
if (mu || lr.state) {
  var ne = lr.state || (lr.state = new _u);
  ...
  var Ue = hu("state");
  gu[Ue] = !0, Pt = function(r, s) {
    if (dr(r, Ue)) throw new Br($n);
    return s.facade = r, yu(r, Ue, s), s
  }, tt = function(r) {
    return dr(r, Ue) ? r[Ue] : {}
  }, kt = function(r) {
    return dr(r, Ue)
  ...
  ca = function(r) {
    ...
    if (Sn(r)) {
      for (var s = r.length, e = [], t = 0; t < s; t++) {
        var n = r[t];
        typeof n == "string" ? jn(e, n) : (typeof n == "number" || qn(n) === "Number" || qn(n) === "String") && jn(e, qu(n))
      }
      var o = e.length,
        i = !0;
      return function(c, l) {
...
kn && da({
  ...
  stringify: function(s, e, t) {
    var n = Cu(e),
      o = [],
      i = kn(s, function(f, v) {
        var h = ku(n) ? Pu(n, this, Bu(f), v) : v;
        return Eu(h) ? Fr + (Gu(o, h.rawJSON) - 1) : h
      }, t);
...
var Mu = nt,
  ...
  Ku = function(s) {
    var e = Wu(Vu(this)),
      t = "",
      n = Ju(s);
    if (n < 0 || n === 1 / 0) throw new zu("Wrong number of repetitions");
    for (; n > 0;
      (n >>>= 1) && (e += e)) n & 1 && (t += e);
    return t
  },
  ...
  Cn = function(r) {
    return function(s, e, t) {
      var n = On(Qu(s)),
        ...
        c = t === void 0 ? " " : On(t),
        l, d;
      return o <= i || c === "" ? n : (l = o - i, d = Xu(c, em(l / c.length)), d.length > l && (d = Zu(d, 0, l)), r ? n + d : d + n)
    }
  },
  tm = {
    start: Cn(!1),
  ...
  om = xe(fe.getTime),
  am = xe(fe.getUTCDate),
  im = xe(fe.getUTCFullYear),
  cm = xe(fe.getUTCHours),
  dm = xe(fe.getUTCMilliseconds),
  lm = xe(fe.getUTCMinutes),
  pm = xe(fe.getUTCMonth),
  um = xe(fe.getUTCSeconds),
  mm = Rn(function() {
    return ur.call(new Date(-5e13 - 1)) !== "0385-07-25T07:06:39.999Z"
  }) || !Rn(function() {
    ur.call(new Date(NaN))
  }) ? function() {
    if (!sm(om(this))) throw new rm("Invalid time value");
    var s = this,
      e = im(s),
      t = dm(s),
      n = e < 0 ? "-" : e > 9999 ? "+" : "";
    return n + Re(nm(e), n ? 6 : 4, 0) + "-" + Re(pm(s) + 1, 2, 0) + "-" + Re(am(s), 2, 0) + "T" + Re(cm(s), 2, 0) + ":" + Re(lm(s), 2, 0) + ":" + Re(um(s), 2, 0) + "." + Re(t, 3, 0) + "Z"
  } : ur,
  fm = Ee,
  ua = Le,
  ym = es,
...
fm({
  ...
  toJSON: function(s) {
    var e = ym(this),
      t = hm(e, "number");
    return typeof t == "number" && !isFinite(t) ? null : !("toISOString" in e) && _m(e) === "Date" ? ua(gm, e) : e.toISOString()
  }
});
var Am = Ee,
  ma = ot,
  ...
  Em = function(r, s) {
    ...
    if (!(!Nn(t) && (r === void 0 || Bn(r)))) return e[1] = function(n, o) {
      if (Nn(t) && (o = wm(t, this, Sm(n), o)), !Bn(o)) return o
    }, fa(qe, null, e)
  },
  xm = function(r, s, e) {
    var t = Ln(e, s - 1),
      n = Ln(e, s + 1);
    return ht(Fn, r) && !ht(Dn, n) || ht(Dn, r) && !ht(Fn, t) ? "\\u" + Pm(qm(r, 0), 16) : r
  };
qe && Am({
  target: "JSON",
  stat: !0,
  ...
  stringify: function(s, e, t) {
    var n = ha(arguments),
      o = fa(Gn ? Em : qe, null, n);
    return Mn && typeof o == "string" ? jm(o, km, xm) : o
  }
});
var Dr = nt,
  Im = Qr;
...
var Om = function(s, e, t) {
    return Im(Dr.JSON.stringify, null, arguments)
  },
  Cm = Om,
  Rm = Cm,
  Nm = Rm,
...
const Gr = le,
  ...
  mr = r => (0, Dm.default)(r, (s, e) => typeof e == "bigint" ? (0, Fm.default)(e.toString()) : e);
class Mm {
  constructor(s = {}) {
    ...
    u(this, "request", async ({
      ...
      return this.customFetch(`${c||this.baseUrl||""}${t}${y?`?${y}`:""}`, {
        ...
        const S = v === "json" ? "text" : v,
          F = S ? await h[S]().then($ => (_.ok ? _.data = v === "json" ? Gm($) : $ : _.error = $, _)).catch($ => (_.error = $, _)) : _;
...
const zm = () => {
  ...
  hs = () => {
    ...
    return {
      ...
      createGetReviewStepInfo: ({
        ...
        const h = !new Z(y).isZero() && new Z(y).lt(e),
              ...
              D.isZero() ? X.push({
                ...
                tooltip: {
                  ...
                  label: b("memepad.new.price_details.ai_agent.tooltip", {
                    date: new Date("04-15-2025").toLocaleDateString(qa().currentLocale.value, {
                      month: "long",
                      day: "numeric"
                    })
                  }),
          ...
          B = (() => {
            ...
            const X = ja(new Z(a.minReceive), g);
      ...
      mustGetUserWalletAddress: () => {
        const d = Pa().state.value;
        if (d.status === ka.CONNECTED) return d.address
      }
    }
  },
  Ym = () => {
  ...
  Qm = () => {
    const {
      ...
      wrapWithCache: n,
      slippage: o
    } = ys(), i = "EQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAM9c", c = 1, l = Xn().public.STONFI_REFERRAL_ADDRESS, d = new _i, a = {
      ...
      const q = (() => {
        ...
        D = Oi[K].create(T.ptonMasterAddress);
      return {
        routerInstance: A,
        router: I,
        proxyTon: D
  ...
  tf = ({
    ...
    const {
      ...
      getMaxBuyAmount: f,
      fees: v
    } = Qm(), h = r.address, _ = Ea().tonConnectUI.value, S = (F = xa().getters.getUser.value) == null ? void 0 : F.referrerToken;
    return {
      getUserJettonBalance: () => o({
        jettonAddress: h,
        userAddress: t()
...
export {
  va as M, We as a, Ve as b, hs as c, Ym as d, ys as e, tf as g, sp as p, Uu as r, Bm as s, Qm as u
};