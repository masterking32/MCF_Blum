...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
  ...
  function R(o, c) {
    ...
    E = P.join("@"), O = null, B = null;
    var Q = E.match(F);
    if (Q ? (v = "", B = Q[1], O = Q[2] || null) : (P = E.split(":"), v = P.shift(), P.length && (O = P.join(":"))), O !== null && O.length > 0) {
      ...
      return Se(() => t.value.share, () => {
        ...
        return d(), x(Q, {
          ...
          default: L(() => [f("div", Qn, [k(O, {
            ...
            modifier: n,
            onBlur: R
          }, null, 8, ["modelValue"]), f("div", Hn, [e(g) ? (d(), w("span", Zn, V(e(g)), 1)) : e(g) === void 0 ? (d(), x(P, {
            key: 1,
            class: "skeleton"
          })) : T("", !0)])])]),
          "bottom-action": L(() => [f("div", Yn, [e(I).showInfo ? (d(), w("div", Xn, [e(I).tonBalance.label && !e(I).loading ? (d(), x(B, {
            key: 0,
            balance: e(I).tonBalance.label
          }, null, 8, ["balance"])) : (d(), x(P, {
            key: 1,
            class: "skeleton"
          })), e(I).loading ? (d(), x(P, {
            key: 3,
          ...
          }, null, 8, ["details", "total-label", "error-message"]))])) : T("", !0), e(I).isEnoughTon ? (d(), x(re, {
            key: 2,
            fill: "",
            size: e(J).LARGE,
            loading: e(I).loading,
    ...
    setup(p, {
      ...
      return mt(() => {
        ...
        return d(), w("div", Ia, [k(y), e(_) === "ERROR" ? (d(), w(D, {
          ...
          class: "dot"
        }, null, -1)), f("div", Ta, V(("t" in i ? i.t : e(A))("memepad.new.step_launch.title")), 1)]), f("div", La, V(("t" in i ? i.t : e(A))("memepad.new.step_launch.subtitle")), 1)]), e(_) === "ROCKET" ? (d(), w("div", ja, [k(I, {
