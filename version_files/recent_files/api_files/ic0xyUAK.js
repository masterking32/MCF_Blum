...
(function(f, R) {
  ...
  var R = Object.defineProperty,
    J = (a, e, t) => e in a ? R(a, e, {
      enumerable: !0,
      configurable: !0,
      writable: !0,
      value: t
    }) : a[e] = t,
    A = (a, e, t) => (J(a, typeof e != "symbol" ? e + "" : e, t), t);
  let $ = 0;
  ...
  class K {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      const n = t.elements[0],
        ...
        oe = (C - L) * Q,
        ze = (1 - (p + M)) * Q;
      return r[0] = E, r[1] = F, r[2] = V, r[3] = 0, r[4] = I, r[5] = b, r[6] = B, r[7] = 0, r[8] = D, r[9] = oe, r[10] = ze, r[11] = 0, r[12] = e.x + _ - (E * _ + I * x + D * T), r[13] = e.y + x - (F * _ + b * x + oe * T), r[14] = e.z + T - (V * _ + B * x + ze * T), r[15] = 1, this
    }
  }
  class O {
    constructor(e = 0, t = e) {
...
gl.LINEAR filtering will be used instead`), this.parameters.magFilter = this.gl.LINEAR), this.gl.texParameteri(this.gl.TEXTURE_2D, this.gl.TEXTURE_MAG_FILTER, this.parameters.magFilter), this._state.magFilter = this.parameters.magFilter);
    ...
    _getSizes() {
      ...
      const e = this._parent.scale ? Ge.set(this._parent.scale.x, this._parent.scale.y) : Ge.set(1, 1),
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(Ge.set(.001, .001)), e.equals(this.scale) || (this.scale.copy(e), this.resize())
    }
    setOffset(e) {
      if (!e.type || e.type !== "Vec2") {
...
`, r), i && i(r, n)
  ...
  class Dt {
    constructor({
      ...
      this.position = new v, this.projectionMatrix = new K, this.worldMatrix = new K, this.viewMatrix = new K, this._shouldUpdate = !1, this.setSize(), this.setPerspective(e, t, s, i, r, n)
    }
    setFov(e) {
  ...
  class ht extends It {
    ...
    _initTransformValues() {
      this.rotation = new v, this.rotation.onChange(() => this._applyRotation()), this.quaternion = new Ce, this.relativeTranslation = new v, this.relativeTranslation.onChange(() => this._setTranslation()), this._translation = new v, this.scale = new v(1), this.scale.onChange(() => {
  ...
  class qt extends ht {
    constructor(e, t, {
      ...
      this.renderer.scene.removePlane(this), this.type = "PingPongPlane", this.renderer.scene.addPlane(this), this.readPass = new je(e, {
        depth: !1,
        clear: !1,
        texturesOptions: m
      }), this.writePass = new je(e, {
        depth: !1,
        clear: !1,
        texturesOptions: m
      }), this.createTexture({
  ...
  let ke, fe, Xe, Ye = !1,
    ...
    xe = 0,
    ye, ue;
  typeof document.hidden < "u" ? (ke = "hidden", fe = "visibilitychange") : typeof document.msHidden < "u" ? (ke = "msHidden", fe = "msvisibilitychange") : typeof document.webkitHidden < "u" && (ke = "webkitHidden", fe = "webkitvisibilitychange");
  ...
  function pe(a) {
    const e = a.hasOwnProperty("trackMouse") && a.trackMouse !== 0 || a.hasOwnProperty("axisTilt") && a.axisTilt !== 0 || a.hasOwnProperty("trackMouseMove") && a.trackMouseMove !== 0,
      ...
      s = a.layerType === "effect" && (a.animating || Fe(a)),
      i = a.type === "video";
    return e || t || s || i
  }
  ...
  function Ze() {
    ...
    const e = t => {
      ...
      }), (!xe || t - xe > 64) && (Y = window.scrollY || window.pageYOffset, _e = Y - qe, qe = Y, xe = t, (_e > 1e3 || _e < 0 && !qe && !Y) && Je()), s ? (hs(), ye = requestAnimationFrame(e)) : cancelAnimationFrame(ye)
    };
  ...
  class Kt {
    constructor({
      ...
      A(this, "id", be()), this.prop = e, this.transition = i, this.complete = !1, this.progress = 0, this.uniformData = n, this.value = De(t), this.endValue = s !== void 0 ? De(s || 0) : null, this.lastTick = void 0, this.initialized = !1, this.startTime = null, this.breakpoints = r || []
    }
    updateEffect(e, t) {
      ...
      return this.progress = i(n), this.progress === 0 ? !1 : (n >= 1 && (this.complete = !0, this.progress = 0), this.lastTick = s, this.complete ? !1 : Ie(this.value, e, this.progress))
    }
    resetState() {
  ...
  class es {
    constructor({
      ...
      A(this, "id", be()), this.prop = e, this.progress = 0, this.momentum = r, this.range = s, this.offset = i, this.mode = o, this.delta = h, this.absScrollValue = l, this.uniformData = n, this.value = De(t), this.lastTick = void 0, this.breakpoints = d || []
    }
    updateEffect(e, {
      top: t,
      height: s,
      ...
      if (i && (t -= Y), this.mode === "scrollIntoView") {
        ...
        return this.lastTick !== void 0 && (h = ce(h, this.lastTick, this.momentum * 2)), this.lastTick !== void 0 && Math.abs(this.lastTick - h) < 1e-4 ? !1 : (this.lastTick = h, Ie(e, this.value, h))
      } else if (this.mode === "whileScrolling") {
        let r = _e * this.delta;
        return this.absScrollValue && (r = Math.abs(r)), this.lastTick !== void 0 && (r = ce(r, this.lastTick, this.momentum * 2), Math.abs(r) < .001) ? !1 : (this.lastScrollPos = Y, this.lastTick = r, Ie(e, this.value, r))
      }
      return !1
    }
    resetState() {
  ...
  class ts {
    constructor({
      ...
      A(this, "id", be()), this.prop = e, this.transition = s, this.progress = 0, this.rawProgress = 0, this.lastProgress = null, this.value = De(t), this.uniformData = r, this.triggerOnElement = n !== void 0 ? n : 1, this.breakpoints = i || []
    }
    updateEffect(e, t, s) {
      var i;
      if (e === void 0) return !1;
      ...
      return this.progress = u, !t && !c ? !1 : (!t && this.transition.forwardsOnly && (this.progress = 0, this.rawProgress = 0), this.lastTick = n, this.lastEnterTime = t, c ? Ie(e, this.value, this.progress) : !1)
    }
    resetState() {
      this.progress = 0
    }
  ...
  class pt {
    constructor(e, t) {
      A(this, "local", {
        ...
        appear: e.states && e.states.appear ? e.states.appear.map(s => new Kt(s)) : [],
    ...
    updateStateEffects() {
      ...
      s.isInView && (this.local.createdAt === null && (this.local.createdAt = performance.now()), this.states.appear.forEach(r => {
        ...
        for (let o in this.local.uniformUpdatesPool) {
          ...
          h !== void 0 && ((n = r.uniforms[o]) == null ? void 0 : n.lastValue) !== h && (r.uniforms[o] && Oe(h, r.uniforms[o], o), this.updateStateEffectProperty(o, h))
        }
  ...
  class is extends Qe {
    ...
    render() {
      ...
      let d = ((e = this.local.stateEffectProps) == null ? void 0 : e.borderRadius) ?? this.borderRadius,
        ...
        c = r - l.x * o,
        p = n - l.y * h;
      if (s.clearRect(0, 0, i.canvasWidth, i.canvasHeight), s.beginPath(), this.fitToCanvas) s.rect(0, 0, i.canvasWidth, i.canvasHeight), s.fillStyle = $e(s, {
        width: i.canvasWidth,
        ...
        s.fillStyle = $e(s, this.box(), this.fill, this.gradientAngle, this.gradientType)
      }
  ...
  class ns extends Qe {
    ...
    render() {
      ...
      let S = l + r / 2,
        L = d + h / 2;
      t.translate(S, L), t.rotate(this.rotation * 360 * Math.PI / 180), t.translate(-S, -L), this.textAlign === "center" && (l += r / 2), this.textAlign === "right" && (l += r), t.fillStyle = $e(t, this.box(), this.fill, this.gradientAngle, this.gradientType);
      const z = (_, x, T, E, F, V, I) => {
          let b = x.split("").reduce((D, oe, ze) => D + _.measureText(oe).width + (ze < x.length - 1 ? F : 0), 0),
            B;
...
` && w.push(F);
  ...
  function gt() {
    document[ke] ? (cancelAnimationFrame(ye), f.scenes.forEach(a => {
      a.pauseTime = performance.now()
    })) : (Ze(), f.scenes.forEach(a => {
  ...
  function ft(a) {
    ...
    e.length && !t.length && Ze();
    const s = performance.now();
    (!xe || s - xe > 64) && Je(), e.forEach(i => {
  ...
  function hs() {
    f.scenes.forEach(a => {
      var e, t, s, i;
      if (a.isInView && (t = (e = a.curtain) == null ? void 0 : e.planes) != null && t.find(r => r.uniforms.mousePos) && !(Ae() && (i = (s = a.interactivity) == null ? void 0 : s.mouse) != null && i.disableMobile)) {
  ...
  class ls {
      ...
      this.initialized = !1, this.layers.forEach(e => {
        ...
        (t = e.states) == null || t.scroll.forEach(i => i.resetState()), (s = e.states) == null || s.appear.forEach(i => {
          ...
          e.getPlanes().forEach(r => {
            r.uniforms[i] && Oe(e.local.bpProps[i], r.uniforms[i], i)
          })
    ...
    updateMouseTrail() {
      Xe && (this.mouse.trail.unshift([this.mouse.pos.x / (this.lastBbox.width * .5), 1 - this.mouse.pos.y / (this.lastBbox.height * .5)]), this.mouse.trail.length > 4 && this.mouse.trail.pop())
    }
    getDynamicLayers() {
    ...
    createEffectPlanes(e, t) {
      ...
      }), Fe(e) && this.createPingPongPlane(e, t, s.passes)) : (this.createEffectPlane(e, t), Fe(e) && this.createPingPongPlane(e, t))
    }
    createTextures() {
    ...
    assignRenderTargetToPlane(e, t, s, i) {
      let r = this.getTextureParams(e, t, s),
        n = this.getRenderTargets()[t] || new je(this.curtain, r);
    ...
    setInitialEffectPlaneUniforms(e, t, s, i) {
      ...
      if (!e.userData.initialUniformsSet || !e.userData.isReady) {
        for (let n in e.uniforms)(r = t.states) != null && r.scroll.some(o => o.prop === n) || (t.local.bpProps && n in t.local.bpProps ? Oe(t.local.bpProps[n], e.uniforms[n], n) : n in t && Oe(t[n], e.uniforms[n], n));
    ...
    setEffectPlaneUniforms(e, t) {
      ...
      if (t.animating && e.uniforms.time && (e.uniforms.time.value += n * 60 / this.fps), Ae() && (r = (i = this.interactivity) == null ? void 0 : i.mouse) != null && r.disableMobile) return !1;
    ...
    handlePlaneCreation() {
      this.initialized = !0, this.initializing = !1, this.rendering || this.renderNFrames(2), this.waitForAssetsAndDisablePlanes(), Ze()
    }
  ...
  function us() {
    re(window, "scroll", ft), Ae() ? re(window, "touchmove", Le) : re(window, "mousemove", Le), re(window, "routeChange", ct), re(document, "mouseleave", _t), ue = $t(os, 16), Ae() ? re(window, "orientationchange", ue) : re(window, "resize", ue), re(document, fe, gt), Ye = !0
  }

  function Ke() {
    ae(window, "mousemove", Le), ae(window, "touchmove", Le), ae(window, "scroll", ft), ae(window, "routeChange", ct), ae(document, "mouseleave", _t), ue && (ae(window, "resize", ue), ae(window, "orientationchange", ue)), ae(document, fe, gt), Ye = !1
  }
  ...
  function xt(a) {
    ...
    return new Promise((s, i) => {
      gs(e, t, a.filePath, i, a.production).then(r => {
        ...
        (p || n[ve("aW5jbHVkZUxvZ28=")]) && Qt(h, o), p && console.log(ve("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")), f.scenes.push(c), c.layers = u, c.preloadTextures(), c.mouse.recordTrail = !!c.layers.find(m => m.type == "mouse"), c.setInteractiveParams(a, n), c.isInView = c.isFixed || mt(c.element, c.bbox, 50), (!c.lazyLoad || c.isInView) && c.initializePlanes(), console.log(c.getDynamicLayers(), c.layers), Ye || us(), s(c)
      }).catch(r => {
        console.error(r), i(r)
      })
    })
...
const zs = {
  ...
  Ws = Ve({
    ...
    setup(f) {
      const R = we(() => Object.values(Pe).map(J => {
        const A = Vs(J),
          $ = (() => {
            var y;
            return f.type === "info" ? "info" : f.type === "loading" ? "loading" : f.type === "success" || !!((y = f.values) != null && y[J]) ? "success" : "error"
          })();
        return {
          ...A,
          criteria: J,
      ...
      return (J, A) => {
        ...
        return H(), se("div", Bs, [(H(!0), se(ys, null, vs(q(R), y => (H(), se("div", {
          ...
          name: "close-md",
          class: "icon"
        })) : y.state === "loading" ? (H(), Ue(g, {
          key: 3,
          class: "spinner",
          size: 24,
          type: q(bs).LIGHT
        }, null, 8, ["type"])) : et("", !0), Te("div", {
          class: "text",
          innerHTML: y.text
        }, null, 8, Ns)], 2))), 128))])
      }
    ...
    setup(f) {
      ...
      return (Z, Se) => {
        ...
        return H(), se("div", {
          ...
          class: "animation"
        }), Te("div", Gs, [Te("div", js, [q(R).status === "eligible" ? (H(), se("div", Xs, [le(Re, {
          name: "check-big-2",
          class: "icon"
        })])) : q(R).status === "not-eligible" ? (H(), se("div", Ys, [le(Re, {
          name: "close-sm",
          class: "icon"
        })])) : et("", !0), Te("div", {
          class: "title",
          innerHTML: q(J)
        }, null, 8, qs)]), q(A) ? (H(), se("div", $s, Ts(q(A)), 1)) : et("", !0)]), le(Ne, Ss(Rs(q(g))), null, 16), le(He, {
          class: "wrapper"
        }, {
          default: Es(() => [Se[0] || (Se[0] = Te("div", {
            class: "shadow"
          }, null, -1)), le(We, {
            size: q(Ms).LARGE,
            label: q($),
