  ...
  y = d({
    ...
    setup(a) {
      return (t, e) => {
        const s = h,
          _ = B;
        return m(), b("div", x, [n("div", C, i(a.label), 1), r(_, {
          class: v(["see-all", {
            "is-disabled": !a.to
          }]),
          to: a.to
        }, {
          default: u(() => [n("div", I, i(("t" in t ? t.t : o(l))("tribes.item.see_all")), 1), r(s, {
            name: "chevron-right",
            class: "see-all-icon"
          })]),
          _: 1
    ...
    setup(a) {
      ...
      return (e, s) => {
        ...
        return m(), S(f, {
          ...
          default: u(() => [n("div", N, [n("div", z, i(("t" in e ? e.t : o(l))("tribes.farm_faster_sheet.title")), 1), n("div", E, i(("t" in e ? e.t : o(l))("tribes.farm_faster_sheet.subtitle")), 1), r(_, {
