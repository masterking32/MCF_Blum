  ...
  ie = w({
    ...
    setup(v) {
      const f = [{
        ...
        L = a => {
          var c, p;
          const t = (p = (c = s.value) == null ? void 0 : c.props) == null ? void 0 : p.find(e => e.key === U);
      ...
      return P(() => _.value, a => {
        ...
        var c, p;
        return o(), l("div", ee, [y("div", te, [(o(), l(d, null, k(f, e => y("div", {
          key: e.key,
          class: F(["menu-components-item", {
            "is-current": n(_) === e.key
          }]),
          onClick: m => _.value = e.key
        }, r(x(e.key)), 11, ae)), 64))]), y("div", oe, [(c = n(s)) != null && c.key ? (o(), O(C(n(s).component), Y({
          key: 0,
