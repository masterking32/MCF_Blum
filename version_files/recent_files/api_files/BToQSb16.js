...
const Ee = h(Le, [
    ...
    setup(e) {
      ...
      return (r, n) => {
        ...
        return u(), _("div", Ce, [n[2] || (n[2] = m("video", {
          ...
          key: 0,
          class: "score",
          to: ("useRouter" in r ? r.useRouter : a(F))().resolve({
            name: "tribe-top"
          })
        }, {
          default: V(() => [c(l, {
            ...
            class: "left-wing"
          }), m("span", Fe, S(("formatFloatLine" in r ? r.formatFloatLine : a(D))(e.rank, {
            accuracy: 0
          })), 1), c(l, {
            name: "chevron-right",
            class: "icon"
  ...
  De = w({
    ...
    setup(e) {
      ...
      }, [m("div", He, S(e.label), 1), m("div", We, [le(r.$slots, "default", {}, () => [P(S(e.value), 1)], !0)])], 2))
    }
  }),
  Ge = h(De, [
    ...
    setup(e) {
      ...
      return (t, l) => {
        ...
        return u(), k(o, {
          ...
          startapp: a(n),
          "share-text": a(r),
          onCopyLink: l[1] || (l[1] = d => ("useAnalytics" in t ? t.useAnalytics : a(W))().tribes.tribeInviteSent({
            method: "copy"
          })),
          onShareLink: l[2] || (l[2] = d => ("useAnalytics" in t ? t.useAnalytics : a(W))().tribes.tribeInviteSent({
            method: "share"
          }))
  ...
  Ft = w({
    ...
    setup(e) {
      ...
      return Te().meta.back = () => F().push({
        name: r.value ? "index" : "tribe-join"
      }), (b, y) => {
        const R = yt,
          A = Ut;
        return u(), _("div", Nt, [a(l) ? I("", !0) : (u(), k(R, {
          key: 0,
          tribe: a(i),
