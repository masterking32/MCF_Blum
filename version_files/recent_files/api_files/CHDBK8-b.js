  ...
  q = L({
    ...
    setup(a) {
      ...
      return (e, u) => {
        const i = O,
          n = I;
        return s(o) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in e ? e.WALLET_LOCAL_AND_REMOTE_STATUS : s(E)).DISCONNECTED ? (t(), T(i, {
          key: 0,
          label: ("t" in e ? e.t : s(c))("wallet.connect.btn"),
          fill: "",
          size: e.buttonSize,
          onClick: u[0] || (u[0] = p => s(m).runConnectionFlow())
        }, null, 8, ["label", "size"])) : s(o) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in e ? e.WALLET_LOCAL_AND_REMOTE_STATUS : s(E)).MUST_RECONNECT ? (t(), T(i, {
          key: 1,
          label: ("t" in e ? e.t : s(c))("wallet.reconnect.btn"),
          fill: "",
          size: e.buttonSize,
          onClick: u[1] || (u[1] = p => s(m).runConnectionFlow())
        }, null, 8, ["label", "size"])) : s(o) === ("WALLET_LOCAL_AND_REMOTE_STATUS" in e ? e.WALLET_LOCAL_AND_REMOTE_STATUS : s(E)).LOADING || e.forceLoading ? (t(), T(n, {
          key: 2,
    ...
    setup(a) {
      ...
      return (e, u) => {
        ...
        return t(), l("div", ae, [e.isReleased ? y("", !0) : (t(), l("div", oe, [r("div", ne, [r("div", le, [e.total !== void 0 && e.collected !== void 0 || e.percent ? (t(), l(h, {
          key: 1
        }, [e.percent !== void 0 ? (t(), l("span", ie, d(`${s(G)(e.percent)}%`), 1)) : y("", !0), e.total !== void 0 && e.collected !== void 0 ? (t(), l("span", re, d(`${("formatTon"in e?e.formatTon:s(w))(e.collected,2)}/${("formatTon"in e?e.formatTon:s(w))(e.total,2)} TON`), 1)) : y("", !0)], 64)) : (t(), T(i, {
          key: 0,
          class: "skeleton"
        }))]), (_ = e.marketDetails) != null && _.statistics ? (t(), l("div", ce, [r("div", pe, [S(n, {
          name: "personal",
          class: "icon"
        }), e.marketDetails.statistics.holdersCount ? (t(), l("span", de, d(("formatCount" in e ? e.formatCount : s(f))(e.marketDetails.statistics.holdersCount, 0).full), 1)) : (t(), l("span", me, "—"))]), r("div", ue, [S(n, {
          name: "transfer",
          class: "icon"
        }), e.marketDetails.statistics.transactionsCount ? (t(), l("span", _e, d(("formatCount" in e ? e.formatCount : s(f))(e.marketDetails.statistics.transactionsCount, 0).full), 1)) : (t(), l("span", ve, "—"))]), r("div", ke, [e.marketDetails.statistics.marketCap ? (t(), l(h, {
          key: 0
        }, [r("span", ye, d(("t" in e ? e.t : s(c))("memepad.jetton.stats.market_cap")), 1), r("span", Te, d(`$${("formatCount"in e?e.formatCount:s(f))(e.marketDetails.statistics.marketCap).full}`), 1)], 64)) : (t(), l("span", fe, "—"))])])) : (t(), T(p, {
          key: 1,
          ...
          class: "dollar"
        }, "$", -1)), r("span", null, d(("formatCount" in e ? e.formatCount : s(f))(e.marketDetails.marketCap).full), 1)])) : (t(), T(i, {
          key: 1,
          class: "skeleton"
        }))]), r("div", we, [(t(!0), l(h, null, J(s(m), v => (t(), l("div", {
          key: v.title,
          class: "item"
        }, [r("span", De, d(v.title), 1), v.value === void 0 ? (t(), T(i, {
          key: 0,
          class: "skeleton"
