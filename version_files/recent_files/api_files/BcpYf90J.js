    ...
    setup(b, {
      ...
      return (e, p) => {
        ...
        return a(), n("div", {
          ...
          [Y, t(f)],
          [O, P]
        ]), l("div", ie, [g(e.$slots, "postfix", {}, void 0, !0)])], 10, oe), l("div", le, [T(W, {
          name: "change-item-transition"
        }, {
          default: I(() => [e.status === t(c).SUCCESS ? (a(), n("img", ue)) : o("", !0), e.status === t(c).ERROR ? (a(), n("img", pe)) : o("", !0), e.status === t(c).LOADING ? (a(), C(D, {
            key: 2,
            type: t(q).DARK,
            size: 20,
            "track-dimmed": "",
