...
const E = {
  ...
  A = u({
    ...
    setup(e) {
      return (r, s) => (t(), a("div", E, [$("div", L, f(("t" in r ? r.t : i(h))("tribes.search.no_results.title")), 1), e.noSubtitle ? g("", !0) : (t(), a("div", w, f(("t" in r ? r.t : i(h))("tribes.search.no_results.subtitle")), 1))]))
    }
  }),
  D = _(A, [
