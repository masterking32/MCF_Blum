    ...
    setup(e) {
      ...
      return (n, r) => {
        const t = oe,
          ...
          o = Y,
          u = J;
        return d(), _("div", Ae, [m("div", Ce, [c(t), c(l, {
          "avatar-url": e.avatarUrl,
          "default-avatar": e.defaultAvatar
        }, null, 8, ["avatar-url", "default-avatar"]), m("div", Ee, [m("button", {
  ...
  It = w({
    ...
    setup(e, {
      ...
      return (T, b) => {
        ...
        return d(), k(p, {
          modelValue: r.value,
          "onUpdate:modelValue": b[3] || (b[3] = C => r.value = C),
          title: "Your tribe"
        }, pe({
          _: 2
        }, [e.myTribe ? {
  ...
  Ct = w({
    ...
    setup(e, {
      ...
      return t.onEvent("popupClosed", () => l.value && l.value.resetSelection()), K(g, f => r("hideTribeContent", f)), i({
        ...
        const C = Lt,
          ne = At;
        return d(), _(B, null, [e.variant === "bottom-sheet" ? (d(), k(C, {
          key: 0,
          modelValue: a(u),
          "onUpdate:modelValue": p[0] || (p[0] = E => U(u) ? u.value = E : null),
          "my-tribe": e.myTribe,
          users: a(T),
  ...
  Nt = w({
    ...
    setup(e) {
      ...
      return Te().initHandler(() => F().push({
        ...
        const R = _t,
          A = Ct;
        return d(), _("div", Et, [a(l) ? I("", !0) : (d(), k(R, {
          key: 0,
          tribe: a(i),
