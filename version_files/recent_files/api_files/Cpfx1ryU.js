...
`));
    ...
    assertProxyTon(e) {
      if (e.version !== je.v2_1) throw new ao({
        expected: je.v2_1,
        received: e.version
      })
    }
  ...
  re, Hr = (re = class extends R {
    ...
    async createDeployWalletBody(e) {
      return m.beginCell().storeUint(bi.DEPLOY_WALLET, 32).storeUint(e.queryId ?? 0, 64).storeAddress(w(e.ownerAddress)).endCell()
    }
  ...
  de, Yr = (de = class extends Hr {
    ...
    async createTonTransferBody(e) {
      const t = m.beginCell();
      return t.storeUint(Cs.TON_TRANSFER, 32), t.storeUint(e.queryId ?? 0, 64), t.storeCoins(BigInt(e.tonAmount)), t.storeAddress(w(e.refundAddress)), e.forwardPayload && (t.storeBit(!0), t.storeRef(e.forwardPayload)), t.endCell()
    }
    async getTonTransferTxParams(e, t) {
      const n = await this.getWalletAddress(e, t.destinationAddress),
    ...
    async createDeployWalletBody(e) {
      return m.beginCell().storeUint(Cs.DEPLOY_WALLET, 32).storeUint(e.queryId ?? 0, 64).storeAddress(w(e.ownerAddress)).storeAddress(w(e.excessAddress)).endCell()
    }
    async getDeployWalletTxParams(e, t) {
      const n = this.address,
        o = await this.createDeployWalletBody({
  ...
  ae, Pi = (ae = class extends Be {
    ...
    assertProxyTon(e) {
      if (e.version !== je.v1) throw new ao({
        expected: je.v1,
        received: e.version
      })
    }
  ...
  }, u(ae, "version", G.v1), u(ae, "address", m.address(oo)), u(ae, "gasConstants", {
    swapJettonToJetton: {
...
var Xr = function(r, s) {
  ...
  Us = Ms && Ms.v8,
  te, jt;
Us && (te = Us.split("."), jt = te[0] > 0 && te[0] < 4 ? 1 : +(te[0] + te[1]));
...
Or.prototype = {
  ...
  array: function() {
    for (var r = this.source, s = this.index + 1, e = !1, t = [], n = []; s < r.length;) {
      ...
      if (pn(n, o), pn(t, o.value), s = this.until([",", "]"], o.end), M(r, s) === ",") e = !0, s++;
      else if (M(r, s) === "]") {
        s++;
        break
      }
  ...
  number: function() {
    ...
    else if (or(Kl, M(r, e))) e = this.skip(ar, e + 1);
...
if (pu || lr.state) {
  var ne = lr.state || (lr.state = new hu);
  ne.get = ne.get, ne.has = ne.has, ne.set = ne.set, Pt = function(r, s) {
    if (ne.has(r)) throw new Br(wn);
...
var Du = nt,
  ...
  sm = xe(fe.getTime),
  nm = xe(fe.getUTCDate),
  om = xe(fe.getUTCFullYear),
  am = xe(fe.getUTCHours),
  im = xe(fe.getUTCMilliseconds),
  cm = xe(fe.getUTCMinutes),
  dm = xe(fe.getUTCMonth),
  lm = xe(fe.getUTCSeconds),
  pm = On(function() {
    ...
    u(this, "request", async ({
      ...
      return this.customFetch(`${c||this.baseUrl||""}${t}${y?`?${y}`:""}`, {
        ...
        const S = _ === "json" ? "text" : _,
          F = S ? await g[S]().then($ => (v.ok ? v.data = _ === "json" ? Fm($) : $ : v.error = $, v)).catch($ => (v.error = $, v)) : v;
        if (l && this.abortControllers.delete(l), !g.ok) throw F;
        return F.data
      })
    });
...
const Wm = () => {
  ...
  hs = () => {
    ...
    return {
      ...
      createGetReviewStepInfo: ({
        ...
        const g = !new Z(y).isZero() && new Z(y).lt(e),
          ...
          I = (() => {
            ...
            if (X.push({
              ...
              const D = new Z(a.share.plus(S)),
                W = v ? `${b("memepad.share_label")} ${b("memepad.new.step_review.subtitle_of_supply",{percentAmount:">100%"})}` : g ? `${b("memepad.share_label")} ${b("memepad.new.step_review.subtitle_of_supply",{percentAmount:"<0.01%"})}` : `${b("memepad.share_label")} ${bs(a.jettonReceivePercent)}%`;
              X.push({
                title: W,
                tooltip: {
                  details: [{
            ...
            const O = X.reduce((D, W) => D.plus(W.total), new Z(0)),
              z = {
                title: `${b("memepad.new.price_details.total_label")} ${j(O)} TON`,
                value: O
              };
            return {
              sections: X,
          ...
          B = (() => {
            ...
            const X = Sa(new Z(a.minReceive), h);
      ...
      createGetUnlockInfo: ({
        ...
        const {
          ...
          details: [{
            label: `${b("memepad.jetton.fees_network")}: ${j(h)} TON`,
            value: h
          }, {
          ...
          total: _,
          totalLabel: `${b("memepad.jetton.fees_base")}: ${j(_)} TON`
        };
        return !a || !y ? {
          balanceLabel: void 0,
          feesInfo: void 0,
      ...
      getTradeStateControls: () => {
        const d = ({
            ...
            if (_ === Oe.BUY) {
              ...
              return {
                details: [{
                  label: `${b("memepad.jetton.fees_network")}: ${j(C)} TON`,
                  value: C
                }, {
                  label: `${b("memepad.jetton.fees_wallet")}: ${j(I)} TON`,
                  value: I
                }, {
            ...
            if (_ === Oe.BUY) {
              ...
              return {
                details: [{
                  ...
                  label: `${b("memepad.jetton.fees_platform")}: ${j(I)} TON`,
                  value: I
                }],
                total: Y,
        ...
        return {
          ...
          getState: async ({
            ...
            if (I) return I;
            const x = _ === Oe.BUY ? v.frontendWithSymbol : S.frontendWithSymbol;
            if (g.isZero()) return {
              tradeInfo: void 0,
              balanceLabel: x,
              feesInfo: d({
  ...
  Km = () => {
    ...
    return {
      ...
      getUserJettonBalance: async ({
        ...
        return K(l) ? H(ge(l.data.balance)) : H(new Z(0))
      },
  ...
  Hm = () => {
    const {
    ...
    }, g = n(T => `stonfiSdk:router:${T.toString()}`, async T => await _e(async () => await d.getRouter(T.toString()))()), v = T => {
      const q = (() => {
          const W = "v2_2",
            se = ["v2_1", "v2_2"],
        ...
        D = xi[z].create(T.ptonMasterAddress);
      return {
        routerInstance: A,
        router: O,
        proxyTon: D
      ...
      var q, A, O;
      return ((q = T.extra) == null ? void 0 : q.statusCode) === 400 && ((O = (A = T.extra) == null ? void 0 : A.data) == null ? void 0 : O.startsWith("1012"))
    }, N = T => {
      var q, A, O;
      return ((q = T.extra) == null ? void 0 : q.statusCode) === 400 && ((O = (A = T.extra) == null ? void 0 : A.data) == null ? void 0 : O.startsWith("1040"))
    }, C = async ({
      tons: T,
      jettonAddress: q
    }) => {
      ...
      if (!K(A)) return $(A) ? Ze(Et.TOO_LOW_AMOUNT) : A;
      const O = await g(A.data.routerAddress);
      if (!K(O)) return O;
      const z = ge(A.data.minAskUnits),
        D = ge(A.data.askUnits),
        W = ge(A.data.feeUnits),
        se = W.div(z.plus(W)).times(T);
      return H({
        minReceive: z,
        maxReceive: D,
        platformFee: se,
      ...
      return K(A) ? A.data.balance === void 0 ? H(new Z(0)) : H(ge(A.data.balance)) : N(A) ? Ze("Failed to get balance") : A
    }, B = async ({
      tons: T,
      tradeInfoParams: q,
      userAddress: A,
      ...
      const {
        router: W,
        proxyTon: se
      } = v(q.additionalInfo.routerInfo), ce = {
        userWalletAddress: A,
        proxyTon: se,
        offerAmount: Fe(T),
        askJettonAddress: O,
        ...
        referralAddress: l,
        referralValue: c * 100,
        dexCustomPayload: z ? le.beginCell().storeUint(10001, 32).storeStringTail(z).endCell() : void 0
      }, Ie = r(D), he = await _e(async () => await W.sendSwapTonToJetton(Ie, ce))();
      return K(he) ? H((await Ie.getResult()).hash) : he
    }, Y = async ({
      jettons: T,
      tradeInfoParams: q,
      userAddress: A,
  ...
  Zm = ({
    ...
    const {
      ...
      getMaxBuyAmount: f,
      fees: _
    } = Hm(), g = r.address, v = Pa().tonConnectUI.value, S = (F = ka().getters.getUser.value) == null ? void 0 : F.referrerToken;
    return {
      getUserJettonBalance: () => o({
        jettonAddress: g,
        userAddress: t()
