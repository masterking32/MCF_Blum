...
var u = (s, e, t) => ys(s, typeof e != "symbol" ? e + "" : e, t);
import {
  d as lt,
  h as fs,
  X as gs,
...
const vo = lt({
    ...
    setup(s) {
      const e = s,
        ...
        n = _s(),
        o = () => {
          const c = Je().tonConnectUI.value,
            y = (c.walletInfo || c.wallet).universalLink;
          if (vs(y)) {
            const h = "https://t.me/wallet/start?startapp=main-rc__a0646df863";
            ["ios", "weba", "android", "tdesktop", "webk"].includes(t.platform) ? t.openTelegramLink(h) : t.openLink(h)
          } else t.openLink(y)
        },
        a = () => {
          var d;
          const c = (d = n.availableInfo.value) == null ? void 0 : d.available;
      ...
      return xr(() => {
        ...
        const y = Mr;
        return ve(), De(y, {
          label: ("t" in c ? c.t : ee(Mt))("memepad.top_up_wallet_button"),
          fill: "",
          size: ee(Or).LARGE,
          onClick: a
        }, null, 8, ["label", "size"])
  ...
  Hs = lt({
    ...
    setup(s, {
        ...
        d = ir({
          ...
          set: k => {
            if (a.value && a.value.value !== r.modelValue) {
              const R = [...a.value.value].findIndex((H, z) => H !== r.modelValue[z]);
              R !== -1 && a.value.value[R] === "," && (k = k.slice(0, R) + "." + k.slice(R))
            }
            k = (r.modifier || (R => R))(k), a.value && a.value.value !== k && (a.value.value = k), n("update:modelValue", k)
          }
        });
      cr(() => r.modelValue, c), cr(() => a.value, c);
      const y = ir(() => {
          ...
          const k = parseInt(getComputedStyle(i.value).getPropertyValue("font-size")),
            ...
            R = `${r.modelValue} ${r.postfix}`,
            H = o.value.offsetWidth,
            M = (ae => {
              const ie = document.createElement("canvas").getContext("2d");
              return ie ? (ie.font = `700 ${k}px RoobertPro`, ie.measureText(ae).width) : void 0
            })(R.trim());
          if (!M) return;
      ...
      return (() => {
        ...
        ref: "input",
        "onUpdate:modelValue": I[0] || (I[0] = R => Ss(d) ? d.value = R : null),
        type: "text",
        inputmode: "decimal",
        style: pr(ee(y)),
        onBlur: I[1] || (I[1] = R => n("blur"))
      }, null, 36), [
        [As, ee(d)]
      ]), he("input", {
        ref: "hiddenInput",
        ...
        class: "hidden",
        onFocus: P
      }, null, 544), k.postfix ? (ve(), Dt("span", {
        key: 0,
        class: "label",
        style: pr(ee(y))
      }, js(k.postfix), 5)) : Kt("", !0)], 2))
    }
  }),
  ko = Ht(Hs, [
...
class on {
  constructor(e = {}) {
    ...
    u(this, "request", async ({
      ...
      const y = (typeof t == "boolean" ? t : this.baseApiParams.secure) && this.securityWorker && await this.securityWorker(this.securityData) || {},
        h = this.mergeRequestParams(d, y),
        P = o && this.toQueryString(o),
        F = n ?? ge.Json,
        x = this.contentFormatters[F],
        k = a || h.format;
      return this.customFetch(`${i||this.baseUrl||""}${r}${P?`?${P}`:""}`, {
        ...h,
        headers: {
          ...h.headers || {},
          ...F && F !== ge.FormData ? {
        ...
        const H = k === "json" ? "text" : k,
          z = H ? await I[H]().then(M => (R.ok ? R.data = k === "json" ? nn(M) : M : R.error = M, R)).catch(M => (R.error = M, R)) : R;
        if (c && this.abortControllers.delete(c), !I.ok) throw z;
        return z.data
      })
    });
    if (e.apiKey) {
...
function Gt(s, e, t) {
  return {
    ...
    async internal(r, n) {
      ...
      let c = null;
      typeof n.body == "string" ? c = q.comment(n.body) : n.body && (c = n.body), await r.send({
        to: e,
        value: i,
        bounce: a,
        sendMode: n.sendMode,
    ...
    getTransactions(r, n, o, a) {
      return console.info("hash param in getTransactions action ignored, beacause not supported", o.toString("hex")), s.blockchain.getBlockchainAccountTransactions(r, {
        ...
        transactions: i
      }) => i.map(c => q.loadTransaction(c.raw.asSlice())))
    }
  }
}
...
var vr, wr = function() {
    ...
    var e = s.prototype;
    return e.sendDeployJetton = function(t, r, n, o, a, i, c, d, y) {
      d === void 0 && (d = null), y === void 0 && (y = 0);
      try {
        return c === void 0 && (c = 0n), Promise.resolve(t.internal(r, {
          value: n,
          body: q.beginCell().storeUint(Hr.deployJetton, 32).storeUint(y, 64).storeUint(o, 1).storeRef(a).storeBit(i).storeCoins(c).storeMaybeRef(d).endCell()
        })).then(function() {})
      } catch (h) {
...
var Vr = function() {
    ...
    }, e.sendBuy = function(t, r, n, o, a, i, c) {
      a === void 0 && (a = null), i === void 0 && (i = null), c === void 0 && (c = 0);
      try {
        return Promise.resolve(t.internal(r, {
          value: n + re.buyGas,
          body: q.beginCell().storeUint(zr.buy, 32).storeUint(c, 64).storeCoins(o).storeAddress(a).storeMaybeRef(i).endCell()
        })).then(function() {})
      } catch (d) {
  ...
  vn = function() {
    ...
    return e.calculateJettonAmount = function(t, r) {
      var n = j.fp.to(oe - t),
        ...
        c = j.fp.mul(rt, j.fp.to(this.thresholdTons)) + j.fp.to(r) + o;
      return j.fp.from(j.fp.div(i, c))
    }, e.calculateTonAmount = function(t, r) {
      var n = j.fp.to(r),
        o = j.fp.to(oe) - j.fp.to(t),
        a = D(this, Ae)[Ae](o),
        i = j.fp.mul(rt, j.fp.to(this.thresholdTons)),
        c = j.fp.mul(st, j.fp.to(oe)),
        d = j.fp.mul(n, i + a);
      return j.fp.from(j.fp.div(d, c + n + o))
...
var An = function(s) {
  ...
  qn = function() {
    ...
    var e = s.prototype;
    return e.sendDeployJetton = function(t, r, n, o, a, i, c, d) {
      c === void 0 && (c = null), d === void 0 && (d = 0);
      try {
        var y = this.client.open(wr.createFromAddress(r));
        return Promise.resolve(y.getConfig()).then(function(h) {
          var P = h.deployFee + re.deployJettonGas + re.initialGas;
          a && (P += h.agentDeployFee), i > 0n && (P += i + re.buyGas);
          var F = Kr(o);
          return Promise.resolve(y.sendDeployJetton(t, P, n, F, a, i, c, d)).then(function() {})
        })
      } catch (h) {
        return Promise.reject(h)
      }
      ...
      a === void 0 && (a = null), i === void 0 && (i = 0);
      try {
        var c = Lt.createFromAddress(r),
          d = this.client.open(c);
        return Promise.resolve(d.sendSell(t, re.sellGas, n, o, a, i)).then(function() {})
      } catch (y) {
    ...
    }, e.getDeployJettonRequest = function(t, r, n, o, a, i, c) {
      i === void 0 && (i = null), c === void 0 && (c = 0);
      try {
        var d = this;
        return Promise.resolve(D(d, ue)[ue](function(y) {
          return d.sendDeployJetton(y, t, r, n, o, a, i, c)
        }))
      } catch (y) {
        return Promise.reject(y)
      }
      ...
      try {
        var i = this;
        return Promise.resolve(D(i, ue)[ue](function(c) {
          return i.sendBuy(c, t, r, n, o, a)
        }))
      } catch (c) {
        return Promise.reject(c)
      }
...
const Qr = () => {
    const {
      ...
      isProd: y
    } = Bs(), h = new qn(n, !1, !y.value), P = l => +String(l) / 1e4, F = {
      ...
      hasShare: l
    }) => I.deployNetworkFee.plus(l ? 0 : I.initialNetworkFee), H = ({
      referrerToken: l
    }) => q.beginCell().storeUint(1675682413, 32).storeStringTail(l).endCell(), z = async l => {
      const m = await K(async () => await h.getTotalSupply(s(l)))();
      ...
      const m = await K(async () => await h.getFactoryConfig(s(l)))();
      ...
      const {
        buyFeeBasis: $
      } = w.data, N = A.div(new C(1).minus(P($))).toDecimalPlaces(9, C.ROUND_UP), U = w.data, Y = S(w.data.agentDeployFee);
      return O({
      ...
      const {
        buyFeeBasis: Y
      } = U.data, Z = S(h.getBuyAmount(0n, _, Y)), Te = Z, Ce = Z, xe = w.minus(Te), le = S(h.getTonSupply(G(Te))), ar = new C(h.getPrice(G(Te))), ls = new C(ar).times(N), ms = le.div(A).times(100), us = Z.div(w).times(100), ds = new C(m).minus(le);
      return O({
        share: new C(m),
        tokenForDexWithFees: $,
        tokenForDex: A,
      ...
      jettonAddress: l,
      userAddress: m
    }) => await K(async () => await h.getJettonWalletAddress(s(l), s(m)))()), ke = async ({
      masterAddress: l,
      form: m,
      tonConnectUI: _,
      referrerToken: f
      ...
      const A = Dr(m, mt.STONFI),
        w = await d.saveMemepadJettonInfo(A);
      if (!E(w)) return w;
      const $ = e(_),
        N = w.data.queryId,
        U = Le.STONFI,
      ...
      const Z = f ? H({
        ...
        Te = m.aiAgentEnable,
        Ce = await K(async () => await h.sendDeployJetton($, s(l), U, Y, Te, G(new C(m.share)), Z, N))();
      if (!E(Ce)) return Ce;
      const xe = (await $.getResult()).hash;
      return O({
        queryId: N,
        transactionHash: xe
      })
    }, St = t(o, F.LAUNCH_STATUS_CHECK), jt = async ({
      tons: l,
      jettonAddress: m,
      masterAddress: _
    }) => {
      ...
      const {
        buyFeeBasis: $
      } = w.data, N = S(h.getBuyAmount(G(A), G(l), $)), U = N, Y = i(N), Z = l.times(P($));
      return O({
        maxReceive: U,
        minReceive: Y,
        platformFee: Z,
      ...
      const {
        sellFeeBasis: $
      } = w.data, N = S(h.getSellAmount(G(A), G(l), $)), U = N, Y = i(N), Z = N.div(1 - P($)).minus(N);
      return O({
        maxReceive: U,
        minReceive: Y,
        platformFee: Z,
      ...
      const w = e(f),
        ...
        N = await K(async () => await h.sendBuy(w, s(m), G(l), G(_.minReceive), $))();
      return E(N) ? O((await w.getResult()).hash) : N
    }, Ct = async ({
      jettons: l,
      jettonAddress: m,
      tradeInfoParams: _,
      ...
      if (!E(U)) return U;
      const Y = U.data,
        Z = await K(async () => await h.sendSell($, Y, G(l), G(_.minReceive), N))();
      return E(Z) ? O((await $.getResult()).hash) : Z
    }, $t = () => Re(({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), () => {}, F.BUY_STATUS_CHECK), Bt = () => Re(({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), () => {}, F.SELL_STATUS_CHECK), Pt = async ({
      jettonAddress: l,
      userAddress: m
    }) => {
      const _ = await a({
      ...
      if (!E(f)) return f;
      const A = f.data,
        w = await K(async () => await h.getUnlocked(A))();
      if (!E(w)) return w;
      const $ = !w.data;
      return O($)
    }, or = async ({
      ...
      if (!E(A)) return A;
      const w = A.data,
        $ = await K(async () => await h.sendUnlock(f, w))();
      return E($) ? O((await f.getResult()).hash) : $
    }, g = ({
      transactionHash: l
    }) => o({
      transactionHash: l
    }), b = () => Re(g, () => {}, F.UNLOCK_STATUS_CHECK), B = r({
      getFees: ({
        share: l,
        overview: m
      }) => {
    ...
    return {
      ...
      getMaxShareAmount: ({
        ...
        const {
          ...
          hasShare: !0
        }), w = S(m.bclData.factoryConfig.deployFee), $ = l.value.minus(A.plus(w).plus(f).plus(_)), N = m.bclData.tokenForDexWithFees;
        return N.lt($) ? N : $.gte(0) ? $ : new C(0)
      },
      getMaxBuyAmount: ({
        tokenBalance: l
      }) => {
  ...
  $n = ({
    ...
    const {
      ...
      getMaxShareAmount: a,
      getReviewInfo: i
    } = Qr(), c = s.masterAddresses[mt.STONFI], d = Je().tonConnectUI.value;
    return {
      getJettonOverview: ({
        tons: y
      }) => r({
...
class er {
  ...
  async sendDeployCoin(e, t, r, n) {
    ...
    if (n != null && n.firstBuy) {
      let y = (0, Be.beginCell)().storeUint((0, qr.crc32str)("op::buy"), 32).storeUint(n.firstBuy.queryId ?? 0, 64).storeCoins(n.firstBuy.minReceive).storeMaybeRef(n.firstBuy.referral);
      n.firstBuy.buyerAddress && y.storeAddress(n.firstBuy.buyerAddress), i = y.endCell()
    }
    a.storeMaybeRef(i);
    let c;
    n != null && n.forceDeploymentFee ? c = n.forceDeploymentFee : c = (await this.getMasterData(e)).deploymentFee;
    let d = c + jr.Constants.CoinDeploymentGas;
    n != null && n.firstBuy && (d += jr.Constants.CoinBuyGas + n.firstBuy.tons), await e.internal(t, {
      value: d,
  ...
  constructor(e = {}) {
    ...
    u(this, "request", async ({
      ...
      const y = (typeof t == "boolean" ? t : this.baseApiParams.secure) && this.securityWorker && await this.securityWorker(this.securityData) || {},
        h = this.mergeRequestParams(d, y),
        P = o && this.toQueryString(o),
        F = this.contentFormatters[n || _e.Json],
        x = a || h.format;
      return this.customFetch(`${i||this.baseUrl||""}${r}${P?`?${P}`:""}`, {
        ...h,
        headers: {
        ...
        const R = x ? await k[x]().then(H => (I.ok ? I.data = H : I.error = H, I)).catch(H => (I.error = H, I)) : I;
        if (c && this.abortControllers.delete(c), !k.ok) throw R;
        return R.data
      })
    });
    Object.assign(this, e)
  ...
  return {
    ...
    async send(r) {
      ...
      const n = (0, no.unixtime)() + 600,
        ...
        i = r.value.toString();
      let c;
      r.init && (c = (0, tt.beginCell)().store((0, tt.storeStateInit)(r.init)).endCell().toBoc().toString("base64"));
      let d;
      r.body && (d = r.body.toBoc().toString("base64"));
...
function co(s) {
  ...
  var e = Pe && Pe.__createBinding || (Object.create ? function(o, a, i, c) {
      c === void 0 && (c = i);
...
const ps = () => {
    const {
      ...
      const v = ce.BclSDK.create({
        apiProvider: ce.simpleTonapiProvider(d),
        clientOptions: {
          endpoint: ""
        },
        masterAddress: s(g)
      });
      return B.value.set(b, v), v
    }, k = g => new C(1).minus(S(g.fees)).div(S(g.coins)), R = c(({
      masterAddress: g
      ...
      tons: g,
      masterAddress: b
    }) => await K(async () => await x(b).getFirstCoinsForTons(G(new C(g))))()), V = c(({
      tons: g,
      masterAddress: b
      ...
      const {
        ...
        bclSupply: m,
        maxSupply: _
      } = T.data, f = await (async () => new C(B).isZero() ? O({
        fees: G(new C(0)),
        coins: G(new C(0))
      }) : await z({
        tons: g,
      ...
      const v = Dr(g, mt.STONFI_TON_FUN),
      ...
      const m = new C(g.share),
        ...
        A = {};
      v.socials.length && (A.social_links = JSON.stringify(v.socials.map(Y => Y.url))), v.bannerFileKey && (A.cover_image = ot(v.bannerFileKey));
      const w = {
          authorAddress: s(b),
          name: f.name,
          ...
          referral: ce.packReferralConfig({
            partner: s(f.partnerAddress),
            platformTag: s(f.referral)
          }),
          queryId: q.toNano(f.queryId),
          extraMetadata: A
        },
        $ = {
        ...
        N = e(T),
        U = await K(async () => await x(B).deployCoin(N, w, $))();
      return E(U) ? O({
        queryId: l.data.queryId,
        transactionHash: (await N.getResult()).hash
      }) : U
    }, se = () => t(o, y.LAUNCH_STATUS_CHECK), ie = async ({
      jettonAddress: g,
      masterAddress: b
    }) => {
      const B = await K(async () => await x(b).openCoin(s(g)))();
      if (!E(B)) return B;
      const T = await K(async () => await B.data.getBclData())();
      if (!E(T)) return T;
      const v = S(T.data.totalSupply),
        l = S(T.data.fullPriceTon).minus(S(T.data.fullPriceTonFees)),
        m = S(T.data.tonLiqCollected),
        _ = m.div(l).times(100),
        f = S(T.data.bclSupply),
      ...
      var m, _, f;
      const T = await K(async () => await x(B).openCoin(s(g)).getUserWallet(s(b)))();
      if (!E(T)) return T;
      const v = await K(async () => !await T.data.getTransfersEnabled())();
      if (!E(v)) return ((m = v.extra) == null ? void 0 : m.status) === 404 && ((f = (_ = v.extra) == null ? void 0 : _.error) == null ? void 0 : f.error) === "entity not found" ? O(!1) : v;
      const l = v.data;
      return O(l)
    }, W = async ({
      jettonAddress: g,
      ...
      const v = x(B).openCoin(s(g)),
        l = await K(async () => await v.getUserWallet(s(b)))();
      if (!E(l)) return l;
      const m = e(T),
      ...
      transactionHash: g
    }), () => {}, y.UNLOCK_STATUS_CHECK), ke = async ({
      tons: g,
      masterAddress: b,
      jettonAddress: B,
      partnerAddress: T
    }) => {
      const v = await K(async () => await x(b).openCoin(s(B)).getCoinsForTons(G(g)))();
      if (!E(v)) return v;
      ...
      const v = await K(async () => await x(b).openCoin(s(B)).getTonsForCoins(G(g)))();
      if (!E(v)) return v;
      ...
      const T = await K(async () => await x(B).getUserCoinBalance(s(b), s(g)))();
      ...
      const l = {
        ...
        m = e(v),
        _ = await K(async () => await x(B).openCoin(s(T)).sendBuy(m, l))();
      return E(_) ? O((await m.getResult()).hash) : _
    }, Et = async ({
      jettons: g,
      tradeInfoParams: b,
      ...
      const m = await x(T).openCoin(s(B)).getUserWallet(s(v)),
        _ = e(l),
        f = await K(async () => await m.sendSellCoins(_, {
          amount: G(g),
          minReceive: G(b.minReceive),
          referral: ce.packReferralConfig({
            partner: s(b.additionalInfo.partnerAddress)
      ...
      return E(f) ? O((await _.getResult()).hash) : f
    }, Ct = () => Re(({
      transactionHash: g
    }) => o({
      transactionHash: g
    }), () => {}, y.BUY_STATUS_CHECK), $t = () => Re(({
      transactionHash: g
    }) => o({
      transactionHash: g
    }), () => {}, y.SELL_STATUS_CHECK), Bt = ({
      tokenBalance: g,
      overview: b
    }) => {
      const {
      ...
      } = F, l = b.bclData.launchPlatformFee, m = g.value.minus(T.plus(l).plus(v).plus(B)), _ = b.bclData.tokenForDexWithFees;
      ...
      getFees: ({
        ...
        } = F, l = g.bclData.launchPlatformFee;
        return {
          buyNetworkFee: b,
          launchNetworkFee: B,
          launchPlatformFee: l,
    ...
    return {
      ...
      getMaxBuyAmount: ({
        ...
        const {
          buyNetworkFee: b,
          walletNetworkBuyFee: B
        } = F;
        return g.value.minus(b).minus(B)
      },
      getReviewInfo: Pt,
      fees: F
    }
  ...
  po = ({
    ...
    const {
      ...
      getMaxShareAmount: a,
      getReviewInfo: i
    } = ps(), c = s.masterAddresses[mt.STONFI_TON_FUN], d = Je().tonConnectUI.value;
    return {
      getJettonOverview: ({
        tons: y
      }) => r({
